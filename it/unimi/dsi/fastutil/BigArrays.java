...
public class BigArrays {
    ...
    public static void ensureFromTo(final long bigArrayLength, final long from, final long to) {
        if (from < 0L) {
            throw new ArrayIndexOutOfBoundsException(new StringBuilder().append("Start index (").append(from).append(") is negative").toString());
        }
        if (from > to) {
        ...
        if (to > bigArrayLength) {
            throw new ArrayIndexOutOfBoundsException(new StringBuilder().append("End index (").append(to).append(") is greater than big-array length (").append(bigArrayLength).append(")").toString());
        }
    }
    ...
    public static void ensureOffsetLength(final long bigArrayLength, final long offset, final long length) {
        ...
        if (length < 0L) {
            throw new IllegalArgumentException(new StringBuilder().append("Length (").append(length).append(") is negative").toString());
        }
        if (offset + length > bigArrayLength) {
            throw new ArrayIndexOutOfBoundsException(new StringBuilder().append("Last index (").append(offset + length).append(") is greater than big-array length (").append(bigArrayLength).append(")").toString());
        }
    }
    
    public static void ensureLength(final long bigArrayLength) {
        if (bigArrayLength < 0L) {
            throw new IllegalArgumentException(new StringBuilder().append("Negative big-array size: ").append(bigArrayLength).toString());
        }
        if (bigArrayLength >= 288230376017494016L) {
            throw new IllegalArgumentException(new StringBuilder().append("Big-array size too big: ").append(bigArrayLength).toString());
        }
    }
    ...
    public static void main(final String[] arg) {
        ...
        while (k-- != 0) {
            ...
            System.out.println(new StringBuilder().append("Single loop: ").append(start + System.currentTimeMillis()).append("ms").toString());
            ...
            System.out.println(new StringBuilder().append("Double loop: ").append(start + System.currentTimeMillis()).append("ms").toString());
            final long z = 0L;
            ...
            System.out.println(new StringBuilder().append("Double loop (with additional index): ").append(start + System.currentTimeMillis()).append("ms").toString());
        }
    }
}
