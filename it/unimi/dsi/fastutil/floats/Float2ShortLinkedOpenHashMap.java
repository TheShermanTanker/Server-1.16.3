...
public class Float2ShortLinkedOpenHashMap extends AbstractFloat2ShortSortedMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Float2ShortLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Float2ShortLinkedOpenHashMap.this.value[Float2ShortLinkedOpenHashMap.this.n]);
                    }
                    int pos = Float2ShortLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[pos]) != 0) {
                            consumer.accept((int)Float2ShortLinkedOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Float2ShortMap.Entry, Map.Entry<Float, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Float2ShortLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits((float)e.getKey()) && Float2ShortLinkedOpenHashMap.this.value[this.index] == (short)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2ShortLinkedOpenHashMap.this.key[this.index]).append("=>").append((int)Float2ShortLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final float from) {
            ...
            if (Float.floatToIntBits(from) == 0) {
                ...
                for (int pos = HashCommon.mix(HashCommon.float2int(from)) & Float2ShortLinkedOpenHashMap.this.mask; Float.floatToIntBits(Float2ShortLinkedOpenHashMap.this.key[pos]) != 0; pos = (pos + 1 & Float2ShortLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Float2ShortLinkedOpenHashMap this$0 = Float2ShortLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Float2ShortLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Float2ShortLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Float2ShortLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Float2ShortLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Float2ShortLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Float2ShortLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Float2ShortLinkedOpenHashMap.this.mask);
                float curr;
                while (Float.floatToIntBits(curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2ShortLinkedOpenHashMap.this.mask;
                    Label_0360: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0360;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Float2ShortMap.Entry> implements Float2ShortSortedMap.FastSortedEntrySet {
        ...
        @Override
        public ObjectSortedSet<Float2ShortMap.Entry> subSet(final Float2ShortMap.Entry fromElement, final Float2ShortMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Float2ShortMap.Entry> headSet(final Float2ShortMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Float2ShortMap.Entry> tailSet(final Float2ShortMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractFloatSortedSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Float2ShortLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2ShortLinkedOpenHashMap.this.key[pos];
                if (Float.floatToIntBits(k) != 0) {
        ...
        public boolean remove(final float k) {
            final int oldSize = Float2ShortLinkedOpenHashMap.this.size;
