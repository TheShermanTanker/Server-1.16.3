...
public class Float2IntRBTreeMap extends AbstractFloat2IntSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Float2IntRBTreeMap.this.findKey((float)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final float k) {
            this.index = 0;
            final Entry locateKey = Float2IntRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractFloat2IntSortedMap implements Serializable {
        ...
        protected transient FloatSortedSet keys;
        protected transient IntCollection values;
        final /* synthetic */ Float2IntRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Float2IntRBTreeMap.Entry f = Float2IntRBTreeMap.this.findKey((float)e.getKey());
        ...
        public float firstFloatKey() {
            final Float2IntRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public float lastFloatKey() {
            final Float2IntRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final float k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Float2IntRBTreeMap this$0 = submap.this$0;
                            final Float2IntRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
