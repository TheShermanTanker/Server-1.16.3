...
public final class Float2ShortFunctions {
    ...
    public static Float2ShortFunction primitive(final Function<? super Float, ? extends Short> f) {
        Objects.requireNonNull(f);
        if (f instanceof Float2ShortFunction) {
            return (Float2ShortFunction)f;
        }
        if (f instanceof DoubleToIntFunction) {
            return key -> SafeMath.safeIntToShort(((DoubleToIntFunction)f).applyAsInt((double)key));
        }
    ...
    public static class PrimitiveFunction implements Float2ShortFunction {
        ...
        protected PrimitiveFunction(final java.util.function.Function<? super Float, ? extends Short> function) {
