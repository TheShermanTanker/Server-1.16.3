...
public class Float2ReferenceLinkedOpenHashMap<V> extends AbstractFloat2ReferenceSortedMap<V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Float2ReferenceMap.Entry<V>, Map.Entry<Float, V> {
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(Float2ReferenceLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits((float)e.getKey()) && Float2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2ReferenceLinkedOpenHashMap.this.key[this.index]).append("=>").append(Float2ReferenceLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractFloatSortedSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Float2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2ReferenceLinkedOpenHashMap.this.key[pos];
                if (Float.floatToIntBits(k) != 0) {
