...
public final class Float2BooleanSortedMaps {
    ...
    public static ObjectBidirectionalIterator<Float2BooleanMap.Entry> fastIterator(final Float2BooleanSortedMap map) {
    ...
    public static ObjectBidirectionalIterable<Float2BooleanMap.Entry> fastIterable(final Float2BooleanSortedMap map) {
        final ObjectSortedSet<Float2BooleanMap.Entry> entries = map.float2BooleanEntrySet();
        ObjectBidirectionalIterable<Float2BooleanMap.Entry> objectBidirectionalIterable;
        if (entries instanceof Float2BooleanSortedMap.FastSortedEntrySet) {
            final Float2BooleanSortedMap.FastSortedEntrySet set = (Float2BooleanSortedMap.FastSortedEntrySet)entries;
    ...
    public static class EmptySortedMap extends Float2BooleanMaps.EmptyMap implements Float2BooleanSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
            return (ObjectSortedSet<Float2BooleanMap.Entry>)ObjectSortedSets.EMPTY_SET;
        }
        
        @Deprecated
        @Override
        public ObjectSortedSet<Map.Entry<Float, Boolean>> entrySet() {
            return (ObjectSortedSet<Map.Entry<Float, Boolean>>)ObjectSortedSets.EMPTY_SET;
        }
    ...
    public static class Singleton extends Float2BooleanMaps.Singleton implements Float2BooleanSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractFloat2BooleanMap.BasicEntry(this.key, this.value), (java.util.Comparator<? super AbstractFloat2BooleanMap.BasicEntry>)Float2BooleanSortedMaps.entryComparator(this.comparator));
            }
            return (ObjectSortedSet<Float2BooleanMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class SynchronizedSortedMap extends Float2BooleanMaps.SynchronizedMap implements Float2BooleanSortedMap, Serializable {
        ...
        public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Float2BooleanMap.Entry>synchronize(this.sortedMap.float2BooleanEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Float2BooleanMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class UnmodifiableSortedMap extends Float2BooleanMaps.UnmodifiableMap implements Float2BooleanSortedMap, Serializable {
        ...
        public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Float2BooleanMap.Entry>unmodifiable(this.sortedMap.float2BooleanEntrySet());
            }
            return (ObjectSortedSet<Float2BooleanMap.Entry>)(ObjectSortedSet)this.entries;
        }
