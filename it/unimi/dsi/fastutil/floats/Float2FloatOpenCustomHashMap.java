...
public class Float2FloatOpenCustomHashMap extends AbstractFloat2FloatMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractFloatCollection() {
                ...
                public void forEach(final DoubleConsumer consumer) {
                    if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((double)Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n]);
                    }
                    int pos = Float2FloatOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.key[pos]) != 0) {
                            consumer.accept((double)Float2FloatOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Float2FloatMap.Entry, Map.Entry<Float, Float> {
        ...
        public boolean equals(final Object o) {
            ...
            return Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[this.index], (float)e.getKey()) && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((float)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2FloatOpenCustomHashMap.this.key[this.index]).append("=>").append(Float2FloatOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements Float2FloatMap.FastEntrySet {
        ...
        public boolean remove(final Object o) {
            ...
            if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                ...
                if (!Float2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (Float.floatToIntBits(curr = key[pos = (pos + 1 & Float2FloatOpenCustomHashMap.this.mask)]) != 0) {
                        if (Float2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
        ...
        public void forEach(final Consumer<? super Float2FloatMap.Entry> consumer) {
            if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Float2FloatOpenCustomHashMap.this.key[Float2FloatOpenCustomHashMap.this.n], Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n]));
            }
            int pos = Float2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.key[pos]) != 0) {
                    consumer.accept(new BasicEntry(Float2FloatOpenCustomHashMap.this.key[pos], Float2FloatOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((double)Float2FloatOpenCustomHashMap.this.key[Float2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Float2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2FloatOpenCustomHashMap.this.key[pos];
