...
public class Float2BooleanOpenCustomHashMap extends AbstractFloat2BooleanMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Float2BooleanMap.Entry, Map.Entry<Float, Boolean> {
        ...
        public boolean equals(final Object o) {
            ...
            return Float2BooleanOpenCustomHashMap.this.strategy.equals(Float2BooleanOpenCustomHashMap.this.key[this.index], (float)e.getKey()) && Float2BooleanOpenCustomHashMap.this.value[this.index] == (boolean)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2BooleanOpenCustomHashMap.this.key[this.index]).append("=>").append(Float2BooleanOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements Float2BooleanMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Float2BooleanMap.Entry> consumer) {
            if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Float2BooleanOpenCustomHashMap.this.key[Float2BooleanOpenCustomHashMap.this.n], Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n]));
            }
            int pos = Float2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2BooleanOpenCustomHashMap.this.key[pos]) != 0) {
                    consumer.accept(new BasicEntry(Float2BooleanOpenCustomHashMap.this.key[pos], Float2BooleanOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((double)Float2BooleanOpenCustomHashMap.this.key[Float2BooleanOpenCustomHashMap.this.n]);
            }
            int pos = Float2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2BooleanOpenCustomHashMap.this.key[pos];
