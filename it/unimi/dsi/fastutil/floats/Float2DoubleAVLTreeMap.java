...
public class Float2DoubleAVLTreeMap extends AbstractFloat2DoubleSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Float2DoubleAVLTreeMap.this.findKey((float)e.getKey());
                    return e.equals(f);
                }
    ...
    private static final class Entry extends BasicEntry implements Cloneable {
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(this.key) == Float.floatToIntBits((float)e.getKey()) && Double.doubleToLongBits(this.value) == Double.doubleToLongBits((double)e.getValue());
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final float k) {
            this.index = 0;
            final Entry locateKey = Float2DoubleAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractFloat2DoubleSortedMap implements Serializable {
        ...
        protected transient FloatSortedSet keys;
        protected transient DoubleCollection values;
        final /* synthetic */ Float2DoubleAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2DoubleMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Float2DoubleAVLTreeMap.Entry f = Float2DoubleAVLTreeMap.this.findKey((float)e.getKey());
        ...
        public float firstFloatKey() {
            final Float2DoubleAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public float lastFloatKey() {
            final Float2DoubleAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final float k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Float2DoubleAVLTreeMap this$0 = submap.this$0;
                            final Float2DoubleAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
