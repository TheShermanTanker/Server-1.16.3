...
public class Float2LongRBTreeMap extends AbstractFloat2LongSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Float2LongRBTreeMap.this.findKey((float)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Float2LongMap.Entry> subSet(final Float2LongMap.Entry from, final Float2LongMap.Entry to) {
                    return Float2LongRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Float2LongMap.Entry> headSet(final Float2LongMap.Entry to) {
                    return Float2LongRBTreeMap.this.headMap(to.getFloatKey()).float2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Float2LongMap.Entry> tailSet(final Float2LongMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final float k) {
            this.index = 0;
            final Entry locateKey = Float2LongRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractFloat2LongSortedMap implements Serializable {
        ...
        protected transient FloatSortedSet keys;
        protected transient LongCollection values;
        final /* synthetic */ Float2LongRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2LongMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Float2LongRBTreeMap.Entry f = Float2LongRBTreeMap.this.findKey((float)e.getKey());
        ...
        public float firstFloatKey() {
            final Float2LongRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public float lastFloatKey() {
            final Float2LongRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        private class KeySet extends AbstractFloat2LongSortedMap.KeySet {
            ...
            private KeySet(final Submap submap) {
                // 
                ...
                // 
                //     1: aload_1        
                //     2: putfield        it/unimi/dsi/fastutil/floats/Float2LongRBTreeMap$Submap$KeySet.this$1:Lit/unimi/dsi/fastutil/floats/Float2LongRBTreeMap$Submap;
                //     5: aload_0         /* this */
                //     6: aload_1        
                //     7: invokespecial   it/unimi/dsi/fastutil/floats/AbstractFloat2LongSortedMap$KeySet.<init>:(Lit/unimi/dsi/fastutil/floats/AbstractFloat2LongSortedMap;)V
                //    10: return         
                //    MethodParameters:
                //  Name    Flags  
                //  ------  -----
            ...
            SubmapIterator(final Submap submap, final float k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Float2LongRBTreeMap this$0 = submap.this$0;
                            final Float2LongRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
