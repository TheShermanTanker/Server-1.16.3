...
public class Float2BooleanLinkedOpenHashMap extends AbstractFloat2BooleanSortedMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Float2BooleanMap.Entry, Map.Entry<Float, Boolean> {
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(Float2BooleanLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits((float)e.getKey()) && Float2BooleanLinkedOpenHashMap.this.value[this.index] == (boolean)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2BooleanLinkedOpenHashMap.this.key[this.index]).append("=>").append(Float2BooleanLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractFloatSortedSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Float2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2BooleanLinkedOpenHashMap.this.key[pos];
                if (Float.floatToIntBits(k) != 0) {
