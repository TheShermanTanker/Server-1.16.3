...
public final class Float2IntSortedMaps {
    ...
    public static ObjectBidirectionalIterator<Float2IntMap.Entry> fastIterator(final Float2IntSortedMap map) {
    ...
    public static ObjectBidirectionalIterable<Float2IntMap.Entry> fastIterable(final Float2IntSortedMap map) {
        final ObjectSortedSet<Float2IntMap.Entry> entries = map.float2IntEntrySet();
        ObjectBidirectionalIterable<Float2IntMap.Entry> objectBidirectionalIterable;
        if (entries instanceof Float2IntSortedMap.FastSortedEntrySet) {
            final Float2IntSortedMap.FastSortedEntrySet set = (Float2IntSortedMap.FastSortedEntrySet)entries;
    ...
    public static class EmptySortedMap extends Float2IntMaps.EmptyMap implements Float2IntSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
            return (ObjectSortedSet<Float2IntMap.Entry>)ObjectSortedSets.EMPTY_SET;
        }
        
        @Deprecated
        @Override
        public ObjectSortedSet<Map.Entry<Float, Integer>> entrySet() {
            return (ObjectSortedSet<Map.Entry<Float, Integer>>)ObjectSortedSets.EMPTY_SET;
        }
    ...
    public static class Singleton extends Float2IntMaps.Singleton implements Float2IntSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractFloat2IntMap.BasicEntry(this.key, this.value), (java.util.Comparator<? super AbstractFloat2IntMap.BasicEntry>)Float2IntSortedMaps.entryComparator(this.comparator));
            }
            return (ObjectSortedSet<Float2IntMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class SynchronizedSortedMap extends Float2IntMaps.SynchronizedMap implements Float2IntSortedMap, Serializable {
        ...
        public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Float2IntMap.Entry>synchronize(this.sortedMap.float2IntEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Float2IntMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class UnmodifiableSortedMap extends Float2IntMaps.UnmodifiableMap implements Float2IntSortedMap, Serializable {
        ...
        public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Float2IntMap.Entry>unmodifiable(this.sortedMap.float2IntEntrySet());
            }
            return (ObjectSortedSet<Float2IntMap.Entry>)(ObjectSortedSet)this.entries;
        }
