...
public class Float2ObjectOpenHashMap<V> extends AbstractFloat2ObjectMap<V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Float2ObjectMap.Entry<V>, Map.Entry<Float, V> {
        ...
        public V setValue(final V v) {
            final V oldValue = Float2ObjectOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(Float2ObjectOpenHashMap.this.key[this.index]) == Float.floatToIntBits((float)e.getKey()) && Objects.equals(Float2ObjectOpenHashMap.this.value[this.index], e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2ObjectOpenHashMap.this.key[this.index]).append("=>").append(Float2ObjectOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            float k;
            int p;
            for (k = this.wrapped.getFloat(-this.pos - 1), p = (HashCommon.mix(HashCommon.float2int(k)) & Float2ObjectOpenHashMap.this.mask); Float.floatToIntBits(k) != Float.floatToIntBits(key[p]); p = (p + 1 & Float2ObjectOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Float2ObjectOpenHashMap.this.mask);
                float curr;
                while (Float.floatToIntBits(curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2ObjectOpenHashMap.this.mask;
                    Label_0115: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0115;
        ...
        public void remove() {
            ...
            final Float2ObjectOpenHashMap this$0 = Float2ObjectOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Float2ObjectMap.Entry<V>> implements Float2ObjectMap.FastEntrySet<V> {
        ...
        public void forEach(final Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
            if (Float2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Float2ObjectOpenHashMap.this.key[Float2ObjectOpenHashMap.this.n], Float2ObjectOpenHashMap.this.value[Float2ObjectOpenHashMap.this.n]));
            }
            int pos = Float2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2ObjectOpenHashMap.this.key[pos]) != 0) {
                    consumer.accept(new BasicEntry(Float2ObjectOpenHashMap.this.key[pos], Float2ObjectOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            if (Float2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept((double)Float2ObjectOpenHashMap.this.key[Float2ObjectOpenHashMap.this.n]);
            }
            int pos = Float2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2ObjectOpenHashMap.this.key[pos];
                if (Float.floatToIntBits(k) != 0) {
        ...
        public boolean remove(final float k) {
            final int oldSize = Float2ObjectOpenHashMap.this.size;
