...
public class Float2IntOpenCustomHashMap extends AbstractFloat2IntMap implements Serializable, Cloneable, Hash {
    ...
    public Float2IntOpenCustomHashMap(final int expected, final float f, final FloatHash.Strategy strategy) {
    ...
    public Float2IntOpenCustomHashMap(final int expected, final FloatHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Float2IntOpenCustomHashMap(final FloatHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Float2IntOpenCustomHashMap(final Map<? extends Float, ? extends Integer> m, final float f, final FloatHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Float2IntOpenCustomHashMap(final Map<? extends Float, ? extends Integer> m, final FloatHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Float2IntOpenCustomHashMap(final Float2IntMap m, final float f, final FloatHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Float2IntOpenCustomHashMap(final Float2IntMap m, final FloatHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Float2IntOpenCustomHashMap(final float[] k, final int[] v, final float f, final FloatHash.Strategy strategy) {
    ...
    public Float2IntOpenCustomHashMap(final float[] k, final int[] v, final FloatHash.Strategy strategy) {
    ...
    final class MapEntry implements Float2IntMap.Entry, Map.Entry<Float, Integer> {
        ...
        public int setValue(final int v) {
            final int oldValue = Float2IntOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Float2IntOpenCustomHashMap.this.strategy.equals(Float2IntOpenCustomHashMap.this.key[this.index], (float)e.getKey()) && Float2IntOpenCustomHashMap.this.value[this.index] == (int)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2IntOpenCustomHashMap.this.key[this.index]).append("=>").append(Float2IntOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            float k;
            int p;
            for (k = this.wrapped.getFloat(-this.pos - 1), p = (HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Float2IntOpenCustomHashMap.this.mask); !Float2IntOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Float2IntOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Float2IntOpenCustomHashMap.this.mask);
                float curr;
                while (Float.floatToIntBits(curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(curr)) & Float2IntOpenCustomHashMap.this.mask;
                    Label_0114: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0114;
        ...
        public void remove() {
            ...
            final Float2IntOpenCustomHashMap this$0 = Float2IntOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Float2IntMap.Entry> implements Float2IntMap.FastEntrySet {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            float curr;
            if (Float.floatToIntBits(curr = key[pos = (HashCommon.mix(Float2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Float2IntOpenCustomHashMap.this.mask)]) == 0) {
                return false;
            }
        ...
        public void forEach(final Consumer<? super Float2IntMap.Entry> consumer) {
            if (Float2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Float2IntOpenCustomHashMap.this.key[Float2IntOpenCustomHashMap.this.n], Float2IntOpenCustomHashMap.this.value[Float2IntOpenCustomHashMap.this.n]));
            }
            int pos = Float2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2IntOpenCustomHashMap.this.key[pos]) != 0) {
    ...
    private final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Float2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2IntOpenCustomHashMap.this.key[pos];
        ...
        public boolean remove(final float k) {
            final int oldSize = Float2IntOpenCustomHashMap.this.size;
