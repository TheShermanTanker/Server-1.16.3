...
public final class Float2FloatMaps {
    ...
    public static ObjectIterator<Float2FloatMap.Entry> fastIterator(final Float2FloatMap map) {
    ...
    public static void fastForEach(final Float2FloatMap map, final Consumer<? super Float2FloatMap.Entry> consumer) {
        final ObjectSet<Float2FloatMap.Entry> entries = map.float2FloatEntrySet();
    ...
    public static ObjectIterable<Float2FloatMap.Entry> fastIterable(final Float2FloatMap map) {
        final ObjectSet<Float2FloatMap.Entry> entries = map.float2FloatEntrySet();
    ...
    public static class SynchronizedMap extends Float2FloatFunctions.SynchronizedFunction implements Float2FloatMap, Serializable {
        ...
        public ObjectSet<Entry> float2FloatEntrySet() {
            synchronized (this.sync) {
                if (this.entries == null) {
                    this.entries = ObjectSets.<Entry>synchronize(this.map.float2FloatEntrySet(), this.sync);
                }
                return this.entries;
            }
        }
        ...
        public void forEach(final BiConsumer<? super Float, ? super Float> action) {
            synchronized (this.sync) {
                this.map.forEach((BiConsumer)action);
            }
        }
        
        public void replaceAll(final BiFunction<? super Float, ? super Float, ? extends Float> function) {
            synchronized (this.sync) {
        ...
        @Override
        public float computeIfAbsent(final float key, final DoubleUnaryOperator mappingFunction) {
            synchronized (this.sync) {
        ...
        @Override
        public float computeIfAbsentNullable(final float key, final DoubleFunction<? extends Float> mappingFunction) {
            synchronized (this.sync) {
        ...
        @Override
        public float computeIfPresent(final float key, final BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
            synchronized (this.sync) {
        ...
        @Override
        public float compute(final float key, final BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
            synchronized (this.sync) {
        ...
        @Override
        public float merge(final float key, final float value, final BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
            synchronized (this.sync) {
        ...
        @Deprecated
        @Override
        public Float computeIfAbsent(final Float key, final java.util.function.Function<? super Float, ? extends Float> mappingFunction) {
            synchronized (this.sync) {
                return this.map.computeIfAbsent(key, mappingFunction);
            }
        }
    ...
    public static class UnmodifiableMap extends Float2FloatFunctions.UnmodifiableFunction implements Float2FloatMap, Serializable {
        ...
        public ObjectSet<Entry> float2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.<Entry>unmodifiable(this.map.float2FloatEntrySet());
            }
            return this.entries;
        }
