...
public class Float2DoubleLinkedOpenHashMap extends AbstractFloat2DoubleSortedMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Float2DoubleMap.Entry, Map.Entry<Float, Double> {
        ...
        public double setValue(final double v) {
            final double oldValue = Float2DoubleLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(Float2DoubleLinkedOpenHashMap.this.key[this.index]) == Float.floatToIntBits((float)e.getKey()) && Double.doubleToLongBits(Float2DoubleLinkedOpenHashMap.this.value[this.index]) == Double.doubleToLongBits((double)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2DoubleLinkedOpenHashMap.this.key[this.index]).append("=>").append(Float2DoubleLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final float from) {
            ...
            if (Float.floatToIntBits(from) == 0) {
                ...
                for (int pos = HashCommon.mix(HashCommon.float2int(from)) & Float2DoubleLinkedOpenHashMap.this.mask; Float.floatToIntBits(Float2DoubleLinkedOpenHashMap.this.key[pos]) != 0; pos = (pos + 1 & Float2DoubleLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Float2DoubleLinkedOpenHashMap this$0 = Float2DoubleLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Float2DoubleLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Float2DoubleLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Float2DoubleLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Float2DoubleLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Float2DoubleLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Float2DoubleLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Float2DoubleLinkedOpenHashMap.this.mask);
                float curr;
                while (Float.floatToIntBits(curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(HashCommon.float2int(curr)) & Float2DoubleLinkedOpenHashMap.this.mask;
                    Label_0360: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0360;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Float2DoubleMap.Entry> implements Float2DoubleSortedMap.FastSortedEntrySet {
        ...
        @Override
        public ObjectSortedSet<Float2DoubleMap.Entry> subSet(final Float2DoubleMap.Entry fromElement, final Float2DoubleMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Float2DoubleMap.Entry> headSet(final Float2DoubleMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Float2DoubleMap.Entry> tailSet(final Float2DoubleMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean remove(final Object o) {
            ...
            if (Float.floatToIntBits(k) == 0) {
                ...
                if (Float.floatToIntBits(curr) != Float.floatToIntBits(k)) {
                    while (Float.floatToIntBits(curr = key[pos = (pos + 1 & Float2DoubleLinkedOpenHashMap.this.mask)]) != 0) {
                        if (Float.floatToIntBits(curr) == Float.floatToIntBits(k) && Double.doubleToLongBits(Float2DoubleLinkedOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
    ...
    private final class KeySet extends AbstractFloatSortedSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Float2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2DoubleLinkedOpenHashMap.this.key[pos];
                if (Float.floatToIntBits(k) != 0) {
        ...
        public boolean remove(final float k) {
            final int oldSize = Float2DoubleLinkedOpenHashMap.this.size;
