...
public class Float2DoubleOpenCustomHashMap extends AbstractFloat2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    public Float2DoubleOpenCustomHashMap(final int expected, final float f, final FloatHash.Strategy strategy) {
    ...
    public Float2DoubleOpenCustomHashMap(final int expected, final FloatHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Float2DoubleOpenCustomHashMap(final FloatHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Float2DoubleOpenCustomHashMap(final Map<? extends Float, ? extends Double> m, final float f, final FloatHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Float2DoubleOpenCustomHashMap(final Map<? extends Float, ? extends Double> m, final FloatHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Float2DoubleOpenCustomHashMap(final Float2DoubleMap m, final float f, final FloatHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Float2DoubleOpenCustomHashMap(final Float2DoubleMap m, final FloatHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Float2DoubleOpenCustomHashMap(final float[] k, final double[] v, final float f, final FloatHash.Strategy strategy) {
    ...
    public Float2DoubleOpenCustomHashMap(final float[] k, final double[] v, final FloatHash.Strategy strategy) {
    ...
    final class MapEntry implements Float2DoubleMap.Entry, Map.Entry<Float, Double> {
        ...
        public double setValue(final double v) {
            final double oldValue = Float2DoubleOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Float2DoubleOpenCustomHashMap.this.strategy.equals(Float2DoubleOpenCustomHashMap.this.key[this.index], (float)e.getKey()) && Double.doubleToLongBits(Float2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((double)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2DoubleOpenCustomHashMap.this.key[this.index]).append("=>").append(Float2DoubleOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            float k;
            int p;
            for (k = this.wrapped.getFloat(-this.pos - 1), p = (HashCommon.mix(Float2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Float2DoubleOpenCustomHashMap.this.mask); !Float2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Float2DoubleOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Float2DoubleOpenCustomHashMap.this.mask);
                float curr;
                while (Float.floatToIntBits(curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Float2DoubleOpenCustomHashMap.this.strategy.hashCode(curr)) & Float2DoubleOpenCustomHashMap.this.mask;
                    Label_0114: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0114;
        ...
        public void remove() {
            ...
            final Float2DoubleOpenCustomHashMap this$0 = Float2DoubleOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry> implements Float2DoubleMap.FastEntrySet {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            float curr;
            if (Float.floatToIntBits(curr = key[pos = (HashCommon.mix(Float2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Float2DoubleOpenCustomHashMap.this.mask)]) == 0) {
                return false;
            }
        ...
        public boolean remove(final Object o) {
            ...
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                ...
                if (!Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (Float.floatToIntBits(curr = key[pos = (pos + 1 & Float2DoubleOpenCustomHashMap.this.mask)]) != 0) {
                        if (Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && Double.doubleToLongBits(Float2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
        ...
        public void forEach(final Consumer<? super Float2DoubleMap.Entry> consumer) {
            if (Float2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Float2DoubleOpenCustomHashMap.this.key[Float2DoubleOpenCustomHashMap.this.n], Float2DoubleOpenCustomHashMap.this.value[Float2DoubleOpenCustomHashMap.this.n]));
            }
            int pos = Float2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2DoubleOpenCustomHashMap.this.key[pos]) != 0) {
                    consumer.accept(new BasicEntry(Float2DoubleOpenCustomHashMap.this.key[pos], Float2DoubleOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            if (Float2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((double)Float2DoubleOpenCustomHashMap.this.key[Float2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Float2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2DoubleOpenCustomHashMap.this.key[pos];
        ...
        public boolean remove(final float k) {
            final int oldSize = Float2DoubleOpenCustomHashMap.this.size;
