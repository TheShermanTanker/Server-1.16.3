...
public class Float2FloatRBTreeMap extends AbstractFloat2FloatSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Float2FloatRBTreeMap.this.findKey((float)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final float k) {
            this.index = 0;
            final Entry locateKey = Float2FloatRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractFloat2FloatSortedMap implements Serializable {
        ...
        protected transient FloatSortedSet keys;
        protected transient FloatCollection values;
        final /* synthetic */ Float2FloatRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Float2FloatRBTreeMap.Entry f = Float2FloatRBTreeMap.this.findKey((float)e.getKey());
        ...
        public float firstFloatKey() {
            final Float2FloatRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public float lastFloatKey() {
            final Float2FloatRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final float k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Float2FloatRBTreeMap this$0 = submap.this$0;
                            final Float2FloatRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
