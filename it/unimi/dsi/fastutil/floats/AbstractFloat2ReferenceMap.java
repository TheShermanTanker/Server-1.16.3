...
public abstract class AbstractFloat2ReferenceMap<V> extends AbstractFloat2ReferenceFunction<V> implements Float2ReferenceMap<V>, Serializable {
    ...
    public boolean containsKey(final float k) {
        final ObjectIterator<Entry<V>> i = this.float2ReferenceEntrySet().iterator();
        while (i.hasNext()) {
        ...
        return new AbstractFloatSet() {
            ...
            public FloatIterator iterator() {
                return new FloatIterator() {
                    private final ObjectIterator<Entry<V>> i = Float2ReferenceMaps.<V>fastIterator((Float2ReferenceMap<V>)AbstractFloat2ReferenceMap.this);
    ...
    public void putAll(final Map<? extends Float, ? extends V> m) {
        if (m instanceof Float2ReferenceMap) {
            final ObjectIterator<Entry<V>> i = Float2ReferenceMaps.<V>fastIterator((Float2ReferenceMap<V>)(Float2ReferenceMap)m);
            while (i.hasNext()) {
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry<V>> i = Float2ReferenceMaps.<V>fastIterator((Float2ReferenceMap<V>)this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.float2ReferenceEntrySet().containsAll((Collection)m.entrySet());
    }
