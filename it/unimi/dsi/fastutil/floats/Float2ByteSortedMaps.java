...
public final class Float2ByteSortedMaps {
    ...
    public static ObjectBidirectionalIterator<Float2ByteMap.Entry> fastIterator(final Float2ByteSortedMap map) {
    ...
    public static ObjectBidirectionalIterable<Float2ByteMap.Entry> fastIterable(final Float2ByteSortedMap map) {
        final ObjectSortedSet<Float2ByteMap.Entry> entries = map.float2ByteEntrySet();
        ObjectBidirectionalIterable<Float2ByteMap.Entry> objectBidirectionalIterable;
        if (entries instanceof Float2ByteSortedMap.FastSortedEntrySet) {
            final Float2ByteSortedMap.FastSortedEntrySet set = (Float2ByteSortedMap.FastSortedEntrySet)entries;
    ...
    public static Float2ByteSortedMap singleton(final Float key, final Byte value, final FloatComparator comparator) {
    ...
    public static class EmptySortedMap extends Float2ByteMaps.EmptyMap implements Float2ByteSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
            return (ObjectSortedSet<Float2ByteMap.Entry>)ObjectSortedSets.EMPTY_SET;
        }
        
        @Deprecated
        @Override
        public ObjectSortedSet<Map.Entry<Float, Byte>> entrySet() {
            return (ObjectSortedSet<Map.Entry<Float, Byte>>)ObjectSortedSets.EMPTY_SET;
        }
        ...
        @Deprecated
        @Override
        public Float2ByteSortedMap headMap(final Float oto) {
            return this.headMap((float)oto);
        }
        
        @Deprecated
        @Override
        public Float2ByteSortedMap tailMap(final Float ofrom) {
            return this.tailMap((float)ofrom);
        }
        
        @Deprecated
        @Override
        public Float2ByteSortedMap subMap(final Float ofrom, final Float oto) {
    ...
    public static class Singleton extends Float2ByteMaps.Singleton implements Float2ByteSortedMap, Serializable, Cloneable {
        ...
        protected Singleton(final float key, final byte value, final FloatComparator comparator) {
            super(key, value);
        ...
        public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractFloat2ByteMap.BasicEntry(this.key, this.value), (java.util.Comparator<? super AbstractFloat2ByteMap.BasicEntry>)Float2ByteSortedMaps.entryComparator(this.comparator));
            }
            return (ObjectSortedSet<Float2ByteMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class SynchronizedSortedMap extends Float2ByteMaps.SynchronizedMap implements Float2ByteSortedMap, Serializable {
        ...
        public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Float2ByteMap.Entry>synchronize(this.sortedMap.float2ByteEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Float2ByteMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class UnmodifiableSortedMap extends Float2ByteMaps.UnmodifiableMap implements Float2ByteSortedMap, Serializable {
        ...
        public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Float2ByteMap.Entry>unmodifiable(this.sortedMap.float2ByteEntrySet());
            }
            return (ObjectSortedSet<Float2ByteMap.Entry>)(ObjectSortedSet)this.entries;
        }
