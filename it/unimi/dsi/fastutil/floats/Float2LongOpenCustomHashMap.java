...
public class Float2LongOpenCustomHashMap extends AbstractFloat2LongMap implements Serializable, Cloneable, Hash {
    ...
    public long computeIfAbsent(final float k, final DoubleToLongFunction mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int pos = this.find(k);
        if (pos >= 0) {
            return this.value[pos];
        }
        final long newValue = mappingFunction.applyAsLong((double)k);
        this.insert(-pos - 1, k, newValue);
        return newValue;
    }
    
    public long computeIfAbsentNullable(final float k, final DoubleFunction<? extends Long> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int pos = this.find(k);
        if (pos >= 0) {
            return this.value[pos];
        }
        final Long newValue = (Long)mappingFunction.apply((double)k);
        if (newValue == null) {
            return this.defRetValue;
        }
    ...
    public long computeIfPresent(final float k, final BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) {
    ...
    public long compute(final float k, final BiFunction<? super Float, ? super Long, ? extends Long> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
    ...
    public long merge(final float k, final long v, final BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
        if (pos < 0) {
            this.insert(-pos - 1, k, v);
    ...
    final class MapEntry implements Float2LongMap.Entry, Map.Entry<Float, Long> {
        ...
        public boolean equals(final Object o) {
            ...
            return Float2LongOpenCustomHashMap.this.strategy.equals(Float2LongOpenCustomHashMap.this.key[this.index], (float)e.getKey()) && Float2LongOpenCustomHashMap.this.value[this.index] == (long)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2LongOpenCustomHashMap.this.key[this.index]).append("=>").append(Float2LongOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Float2LongMap.Entry> implements Float2LongMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Float2LongMap.Entry> consumer) {
            if (Float2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Float2LongOpenCustomHashMap.this.key[Float2LongOpenCustomHashMap.this.n], Float2LongOpenCustomHashMap.this.value[Float2LongOpenCustomHashMap.this.n]));
            }
            int pos = Float2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2LongOpenCustomHashMap.this.key[pos]) != 0) {
    ...
    private final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Float2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2LongOpenCustomHashMap.this.key[pos];
