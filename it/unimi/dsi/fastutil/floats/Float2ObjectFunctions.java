...
public final class Float2ObjectFunctions {
    ...
    public static <V> Float2ObjectFunction<V> primitive(final Function<? super Float, ? extends V> f) {
        Objects.requireNonNull(f);
        if (f instanceof Float2ObjectFunction) {
            return (Float2ObjectFunction<V>)(Float2ObjectFunction)f;
        }
        if (f instanceof DoubleFunction) {
            final DoubleFunction doubleFunction = (DoubleFunction)f;
            Objects.requireNonNull(doubleFunction);
            return (Float2ObjectFunction<V>)doubleFunction::apply;
        }
