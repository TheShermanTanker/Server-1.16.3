...
public final class Float2ReferenceMaps {
    ...
    public static <V> ObjectIterator<Float2ReferenceMap.Entry<V>> fastIterator(final Float2ReferenceMap<V> map) {
    ...
    public static <V> void fastForEach(final Float2ReferenceMap<V> map, final Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
        final ObjectSet<Float2ReferenceMap.Entry<V>> entries = map.float2ReferenceEntrySet();
    ...
    public static <V> ObjectIterable<Float2ReferenceMap.Entry<V>> fastIterable(final Float2ReferenceMap<V> map) {
        final ObjectSet<Float2ReferenceMap.Entry<V>> entries = map.float2ReferenceEntrySet();
    ...
    public static <V> Float2ReferenceMap<V> emptyMap() {
        return (Float2ReferenceMap<V>)Float2ReferenceMaps.EMPTY_MAP;
    }
    ...
    public static class Singleton<V> extends Float2ReferenceFunctions.Singleton<V> implements Float2ReferenceMap<V>, Serializable, Cloneable {
        ...
        public ObjectSet<Entry<V>> float2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.singleton(new AbstractFloat2ReferenceMap.BasicEntry<V>(this.key, this.value));
            }
            return this.entries;
        }
    ...
    public static class SynchronizedMap<V> extends Float2ReferenceFunctions.SynchronizedFunction<V> implements Float2ReferenceMap<V>, Serializable {
        ...
        public ObjectSet<Entry<V>> float2ReferenceEntrySet() {
            synchronized (this.sync) {
                if (this.entries == null) {
                    this.entries = ObjectSets.<Entry<V>>synchronize(this.map.float2ReferenceEntrySet(), this.sync);
                }
                return this.entries;
            }
        }
    ...
    public static class UnmodifiableMap<V> extends Float2ReferenceFunctions.UnmodifiableFunction<V> implements Float2ReferenceMap<V>, Serializable {
        ...
        public ObjectSet<Entry<V>> float2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.<Entry<V>>unmodifiable(this.map.float2ReferenceEntrySet());
            }
            return this.entries;
        }
