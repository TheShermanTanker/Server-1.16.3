...
public class Float2ReferenceAVLTreeMap<V> extends AbstractFloat2ReferenceSortedMap<V> implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey((float)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final float k) {
            this.index = 0;
            final Entry<V> locateKey = Float2ReferenceAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractFloat2ReferenceSortedMap<V> implements Serializable {
        ...
        protected transient FloatSortedSet keys;
        protected transient ReferenceCollection<V> values;
        final /* synthetic */ Float2ReferenceAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Float2ReferenceAVLTreeMap.Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey((float)e.getKey());
        ...
        public float firstFloatKey() {
            final Float2ReferenceAVLTreeMap.Entry<V> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public float lastFloatKey() {
            final Float2ReferenceAVLTreeMap.Entry<V> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final float k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Float2ReferenceAVLTreeMap this$0 = submap.this$0;
                            final Float2ReferenceAVLTreeMap.Entry<V> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
