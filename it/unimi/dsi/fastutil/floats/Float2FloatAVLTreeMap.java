...
public class Float2FloatAVLTreeMap extends AbstractFloat2FloatSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Float2FloatAVLTreeMap.this.findKey((float)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Float2FloatMap.Entry> subSet(final Float2FloatMap.Entry from, final Float2FloatMap.Entry to) {
                    return Float2FloatAVLTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2FloatEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Float2FloatMap.Entry> headSet(final Float2FloatMap.Entry to) {
                    return Float2FloatAVLTreeMap.this.headMap(to.getFloatKey()).float2FloatEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Float2FloatMap.Entry> tailSet(final Float2FloatMap.Entry from) {
    ...
    private static final class Entry extends BasicEntry implements Cloneable {
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(this.key) == Float.floatToIntBits((float)e.getKey()) && Float.floatToIntBits(this.value) == Float.floatToIntBits((float)e.getValue());
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final float k) {
            this.index = 0;
            final Entry locateKey = Float2FloatAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private class EntryIterator extends TreeIterator implements ObjectListIterator<Float2FloatMap.Entry> {
        ...
        @Override
        public void set(final Float2FloatMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public void add(final Float2FloatMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class Submap extends AbstractFloat2FloatSortedMap implements Serializable {
        ...
        protected transient FloatSortedSet keys;
        protected transient FloatCollection values;
        final /* synthetic */ Float2FloatAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2FloatMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Float2FloatAVLTreeMap.Entry f = Float2FloatAVLTreeMap.this.findKey((float)e.getKey());
        ...
        public float firstFloatKey() {
            final Float2FloatAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public float lastFloatKey() {
            final Float2FloatAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final float k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Float2FloatAVLTreeMap this$0 = submap.this$0;
                            final Float2FloatAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
