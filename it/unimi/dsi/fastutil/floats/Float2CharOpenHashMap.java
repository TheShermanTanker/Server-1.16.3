...
public class Float2CharOpenHashMap extends AbstractFloat2CharMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractCharCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Float2CharOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Float2CharOpenHashMap.this.value[Float2CharOpenHashMap.this.n]);
                    }
                    int pos = Float2CharOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Float.floatToIntBits(Float2CharOpenHashMap.this.key[pos]) != 0) {
                            consumer.accept((int)Float2CharOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Float2CharMap.Entry, Map.Entry<Float, Character> {
        ...
        public boolean equals(final Object o) {
            ...
            return Float.floatToIntBits(Float2CharOpenHashMap.this.key[this.index]) == Float.floatToIntBits((float)e.getKey()) && Float2CharOpenHashMap.this.value[this.index] == (char)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Float2CharOpenHashMap.this.key[this.index]).append("=>").append(Float2CharOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry> implements Float2CharMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Float2CharMap.Entry> consumer) {
            if (Float2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Float2CharOpenHashMap.this.key[Float2CharOpenHashMap.this.n], Float2CharOpenHashMap.this.value[Float2CharOpenHashMap.this.n]));
            }
            int pos = Float2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Float.floatToIntBits(Float2CharOpenHashMap.this.key[pos]) != 0) {
    ...
    private final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Float2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                final float k = Float2CharOpenHashMap.this.key[pos];
                if (Float.floatToIntBits(k) != 0) {
