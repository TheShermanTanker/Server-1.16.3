...
public class Float2ByteRBTreeMap extends AbstractFloat2ByteSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Float2ByteRBTreeMap.this.findKey((float)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Float2ByteMap.Entry> subSet(final Float2ByteMap.Entry from, final Float2ByteMap.Entry to) {
                    return Float2ByteRBTreeMap.this.subMap(from.getFloatKey(), to.getFloatKey()).float2ByteEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Float2ByteMap.Entry> headSet(final Float2ByteMap.Entry to) {
                    return Float2ByteRBTreeMap.this.headMap(to.getFloatKey()).float2ByteEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Float2ByteMap.Entry> tailSet(final Float2ByteMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final float k) {
            this.index = 0;
            final Entry locateKey = Float2ByteRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractFloat2ByteSortedMap implements Serializable {
        ...
        protected transient FloatSortedSet keys;
        protected transient ByteCollection values;
        final /* synthetic */ Float2ByteRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey((float)e.getKey());
        ...
        public float firstFloatKey() {
            final Float2ByteRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public float lastFloatKey() {
            final Float2ByteRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final float k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Float2ByteRBTreeMap this$0 = submap.this$0;
                            final Float2ByteRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
