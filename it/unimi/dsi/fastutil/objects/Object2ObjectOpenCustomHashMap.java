...
public class Object2ObjectOpenCustomHashMap<K, V> extends AbstractObject2ObjectMap<K, V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Object2ObjectMap.Entry<K, V>, Map.Entry<K, V> {
        ...
        public boolean equals(final Object o) {
            ...
            return Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Objects.equals(Object2ObjectOpenCustomHashMap.this.value[this.index], e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Object2ObjectOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2ObjectOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Object2ObjectMap.Entry<K, V>> implements Object2ObjectMap.FastEntrySet<K, V> {
        ...
        public void forEach(final Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
            if (Object2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Object2ObjectOpenCustomHashMap.this.key[Object2ObjectOpenCustomHashMap.this.n], Object2ObjectOpenCustomHashMap.this.value[Object2ObjectOpenCustomHashMap.this.n]));
            }
            int pos = Object2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ObjectOpenCustomHashMap.this.key[pos] != null) {
                    consumer.accept(new BasicEntry(Object2ObjectOpenCustomHashMap.this.key[pos], Object2ObjectOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractObjectSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2ObjectOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
