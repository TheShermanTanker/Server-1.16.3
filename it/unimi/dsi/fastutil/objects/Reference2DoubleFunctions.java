...
public final class Reference2DoubleFunctions {
    ...
    public static <K> Reference2DoubleFunction<K> primitive(final Function<? super K, ? extends Double> f) {
        Objects.requireNonNull(f);
        if (f instanceof Reference2DoubleFunction) {
            return (Reference2DoubleFunction<K>)(Reference2DoubleFunction)f;
        }
