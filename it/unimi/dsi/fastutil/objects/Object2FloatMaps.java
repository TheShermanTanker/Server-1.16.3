...
public final class Object2FloatMaps {
    ...
    public static <K> ObjectIterator<Object2FloatMap.Entry<K>> fastIterator(final Object2FloatMap<K> map) {
    ...
    public static <K> void fastForEach(final Object2FloatMap<K> map, final Consumer<? super Object2FloatMap.Entry<K>> consumer) {
        final ObjectSet<Object2FloatMap.Entry<K>> entries = map.object2FloatEntrySet();
    ...
    public static <K> ObjectIterable<Object2FloatMap.Entry<K>> fastIterable(final Object2FloatMap<K> map) {
        final ObjectSet<Object2FloatMap.Entry<K>> entries = map.object2FloatEntrySet();
    ...
    public static <K> Object2FloatMap<K> emptyMap() {
        return (Object2FloatMap<K>)Object2FloatMaps.EMPTY_MAP;
    }
    ...
    public static class Singleton<K> extends Object2FloatFunctions.Singleton<K> implements Object2FloatMap<K>, Serializable, Cloneable {
        ...
        public ObjectSet<Entry<K>> object2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.singleton(new AbstractObject2FloatMap.BasicEntry<K>(this.key, this.value));
            }
            return this.entries;
        }
    ...
    public static class SynchronizedMap<K> extends Object2FloatFunctions.SynchronizedFunction<K> implements Object2FloatMap<K>, Serializable {
        ...
        public ObjectSet<Entry<K>> object2FloatEntrySet() {
            synchronized (this.sync) {
                if (this.entries == null) {
                    this.entries = ObjectSets.<Entry<K>>synchronize(this.map.object2FloatEntrySet(), this.sync);
                }
                return this.entries;
            }
        }
    ...
    public static class UnmodifiableMap<K> extends Object2FloatFunctions.UnmodifiableFunction<K> implements Object2FloatMap<K>, Serializable {
        ...
        public ObjectSet<Entry<K>> object2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.<Entry<K>>unmodifiable(this.map.object2FloatEntrySet());
            }
            return this.entries;
        }
