    ...
    public ObjectSet<K> keySet() {
        return new AbstractObjectSet<K>() {
            ...
            public boolean remove(final Object k) {
                ...
                final int tail = Object2ReferenceArrayMap.this.size - oldPos - 1;
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>() {
                    ...
                    public void remove() {
                        ...
                        final int tail = Object2ReferenceArrayMap.this.size - this.pos;
        ...
        public ObjectIterator<Object2ReferenceMap.Entry<K, V>> iterator() {
            return new ObjectIterator<Object2ReferenceMap.Entry<K, V>>() {
                ...
                public Object2ReferenceMap.Entry<K, V> next() {
                    ...
                    final Object[] access$100 = Object2ReferenceArrayMap.this.key;
                    final int next = this.next;
                    this.curr = next;
                    return new BasicEntry<K, V>(access$100[next], Object2ReferenceArrayMap.this.value[this.next++]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    final int tail = Object2ReferenceArrayMap.this.size-- - this.next--;
