        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() {
                ...
                public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(final Object2BooleanMap.Entry<K> from, final Object2BooleanMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2BooleanMap.Entry<K>>)Object2BooleanAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2BooleanEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(final Object2BooleanMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2BooleanMap.Entry<K>>)Object2BooleanAVLTreeMap.this.headMap(to.getKey()).object2BooleanEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(final Object2BooleanMap.Entry<K> from) {
                    return (ObjectSortedSet<Object2BooleanMap.Entry<K>>)Object2BooleanAVLTreeMap.this.tailMap(from.getKey()).object2BooleanEntrySet();
                }
            };
        }
        return this.entries;
        ...
        public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() {
                    ...
                    @Override
                    public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(final Object2BooleanMap.Entry<K> from, final Object2BooleanMap.Entry<K> to) {
                        return (ObjectSortedSet<Object2BooleanMap.Entry<K>>)Submap.this.subMap(from.getKey(), to.getKey()).object2BooleanEntrySet();
                    }
                    
                    @Override
                    public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(final Object2BooleanMap.Entry<K> to) {
                        return (ObjectSortedSet<Object2BooleanMap.Entry<K>>)Submap.this.headMap(to.getKey()).object2BooleanEntrySet();
                    }
                    
                    @Override
                    public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(final Object2BooleanMap.Entry<K> from) {
                        return (ObjectSortedSet<Object2BooleanMap.Entry<K>>)Submap.this.tailMap(from.getKey()).object2BooleanEntrySet();
                    }
                };
            }
            return this.entries;
