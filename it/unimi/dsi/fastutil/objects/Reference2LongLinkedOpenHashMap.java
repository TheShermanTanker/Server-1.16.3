...
public class Reference2LongLinkedOpenHashMap<K> extends AbstractReference2LongSortedMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Reference2LongMap.Entry<K>, Map.Entry<K, Long> {
        ...
        public long setValue(final long v) {
            final long oldValue = Reference2LongLinkedOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Reference2LongLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2LongLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final K from) {
            ...
            if (from == null) {
                ...
                for (int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2LongLinkedOpenHashMap.this.mask; Reference2LongLinkedOpenHashMap.this.key[pos] != null; pos = (pos + 1 & Reference2LongLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Reference2LongLinkedOpenHashMap this$0 = Reference2LongLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Reference2LongLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Reference2LongLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Reference2LongLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Reference2LongLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Reference2LongLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Reference2LongLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Reference2LongLinkedOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2LongLinkedOpenHashMap.this.mask;
                    Label_0374: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0374;
        ...
        public void set(final Reference2LongMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
        
        public void add(final Reference2LongMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Reference2LongMap.Entry<K>> implements Reference2LongSortedMap.FastSortedEntrySet<K> {
        ...
        @Override
        public ObjectSortedSet<Reference2LongMap.Entry<K>> subSet(final Reference2LongMap.Entry<K> fromElement, final Reference2LongMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2LongMap.Entry<K>> headSet(final Reference2LongMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2LongMap.Entry<K>> tailSet(final Reference2LongMap.Entry<K> fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public void forEach(final Consumer<? super Reference2LongMap.Entry<K>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Reference2LongLinkedOpenHashMap.this.key[curr], Reference2LongLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractReferenceSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2LongLinkedOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2LongLinkedOpenHashMap.this.size;
