...
public class Object2LongLinkedOpenHashMap<K> extends AbstractObject2LongSortedMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Object2LongMap.Entry<K>, Map.Entry<K, Long> {
        ...
        public long setValue(final long v) {
            final long oldValue = Object2LongLinkedOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Object2LongLinkedOpenHashMap.this.key[this.index]).append("=>").append(Object2LongLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final K from) {
            ...
            if (from == null) {
                ...
                for (int pos = HashCommon.mix(from.hashCode()) & Object2LongLinkedOpenHashMap.this.mask; Object2LongLinkedOpenHashMap.this.key[pos] != null; pos = (pos + 1 & Object2LongLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Object2LongLinkedOpenHashMap this$0 = Object2LongLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Object2LongLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Object2LongLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Object2LongLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Object2LongLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Object2LongLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Object2LongLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Object2LongLinkedOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(curr.hashCode()) & Object2LongLinkedOpenHashMap.this.mask;
                    Label_0373: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0373;
    ...
    private final class KeySet extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2LongLinkedOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Object2LongLinkedOpenHashMap.this.size;
