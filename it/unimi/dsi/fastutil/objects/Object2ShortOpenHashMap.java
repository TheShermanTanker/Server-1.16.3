...
public class Object2ShortOpenHashMap<K> extends AbstractObject2ShortMap<K> implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Object2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Object2ShortOpenHashMap.this.value[Object2ShortOpenHashMap.this.n]);
                    }
                    int pos = Object2ShortOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Object2ShortOpenHashMap.this.key[pos] != null) {
                            consumer.accept((int)Object2ShortOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Object2ShortMap.Entry<K>, Map.Entry<K, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Object2ShortOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Object2ShortOpenHashMap.this.key[this.index]).append("=>").append((int)Object2ShortOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(k.hashCode()) & Object2ShortOpenHashMap.this.mask); !k.equals(key[p]); p = (p + 1 & Object2ShortOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Object2ShortOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(curr.hashCode()) & Object2ShortOpenHashMap.this.mask;
                    Label_0102: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0102;
        ...
        public void remove() {
            ...
            final Object2ShortOpenHashMap this$0 = Object2ShortOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<K>> implements Object2ShortMap.FastEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Object2ShortMap.Entry<K>> consumer) {
            if (Object2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Object2ShortOpenHashMap.this.key[Object2ShortOpenHashMap.this.n], Object2ShortOpenHashMap.this.value[Object2ShortOpenHashMap.this.n]));
            }
            int pos = Object2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ShortOpenHashMap.this.key[pos] != null) {
    ...
    private final class KeySet extends AbstractObjectSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2ShortOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Object2ShortOpenHashMap.this.size;
