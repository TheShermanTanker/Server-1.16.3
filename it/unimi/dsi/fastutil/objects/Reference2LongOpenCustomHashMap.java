...
public class Reference2LongOpenCustomHashMap<K> extends AbstractReference2LongMap<K> implements Serializable, Cloneable, Hash {
    ...
    public Reference2LongOpenCustomHashMap(final int expected, final float f, final Strategy<K> strategy) {
    ...
    public Reference2LongOpenCustomHashMap(final int expected, final Strategy<K> strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Reference2LongOpenCustomHashMap(final Strategy<K> strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Reference2LongOpenCustomHashMap(final Map<? extends K, ? extends Long> m, final float f, final Strategy<K> strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Reference2LongOpenCustomHashMap(final Map<? extends K, ? extends Long> m, final Strategy<K> strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Reference2LongOpenCustomHashMap(final Reference2LongMap<K> m, final float f, final Strategy<K> strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Reference2LongOpenCustomHashMap(final Reference2LongMap<K> m, final Strategy<K> strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Reference2LongOpenCustomHashMap(final K[] k, final long[] v, final float f, final Strategy<K> strategy) {
    ...
    public Reference2LongOpenCustomHashMap(final K[] k, final long[] v, final Strategy<K> strategy) {
    ...
    final class MapEntry implements Reference2LongMap.Entry<K>, Map.Entry<K, Long> {
        ...
        public long setValue(final long v) {
            final long oldValue = Reference2LongOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2LongOpenCustomHashMap.this.strategy.equals(Reference2LongOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Reference2LongOpenCustomHashMap.this.value[this.index] == (long)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Reference2LongOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2LongOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(Reference2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2LongOpenCustomHashMap.this.mask); !Reference2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Reference2LongOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Reference2LongOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Reference2LongOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2LongOpenCustomHashMap.this.mask;
                    Label_0112: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0112;
        ...
        public void remove() {
            ...
            final Reference2LongOpenCustomHashMap this$0 = Reference2LongOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2LongMap.Entry<K>> implements Reference2LongMap.FastEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Reference2LongMap.Entry<K>> consumer) {
            if (Reference2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Reference2LongOpenCustomHashMap.this.key[Reference2LongOpenCustomHashMap.this.n], Reference2LongOpenCustomHashMap.this.value[Reference2LongOpenCustomHashMap.this.n]));
            }
            int pos = Reference2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2LongOpenCustomHashMap.this.key[pos] != null) {
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2LongOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2LongOpenCustomHashMap.this.size;
