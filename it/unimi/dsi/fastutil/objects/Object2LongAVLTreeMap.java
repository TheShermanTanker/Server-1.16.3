...
public class Object2LongAVLTreeMap<K> extends AbstractObject2LongSortedMap<K> implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<K> f = (Entry<K>)Object2LongAVLTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(final Object2LongMap.Entry<K> from, final Object2LongMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2LongMap.Entry<K>>)Object2LongAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(final Object2LongMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2LongMap.Entry<K>>)Object2LongAVLTreeMap.this.headMap(to.getKey()).object2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(final Object2LongMap.Entry<K> from) {
                    return (ObjectSortedSet<Object2LongMap.Entry<K>>)Object2LongAVLTreeMap.this.tailMap(from.getKey()).object2LongEntrySet();
                }
            };
        }
        return this.entries;
    ...
    private class TreeIterator {
        ...
        TreeIterator(final K k) {
            this.index = 0;
            final Entry<K> locateKey = Object2LongAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractObject2LongSortedMap<K> implements Serializable {
        ...
        protected transient ObjectSortedSet<K> keys;
        protected transient LongCollection values;
        final /* synthetic */ Object2LongAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Object2LongAVLTreeMap.Entry<K> f = (Object2LongAVLTreeMap.Entry<K>)Object2LongAVLTreeMap.this.findKey(e.getKey());
        ...
        public K firstKey() {
            final Object2LongAVLTreeMap.Entry<K> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public K lastKey() {
            final Object2LongAVLTreeMap.Entry<K> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final K k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Object2LongAVLTreeMap this$0 = submap.this$0;
                            final Object2LongAVLTreeMap.Entry<K> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
