...
public class Object2FloatOpenHashMap<K> extends AbstractObject2FloatMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Object2FloatMap.Entry<K>, Map.Entry<K, Float> {
        ...
        public float setValue(final float v) {
            final float oldValue = Object2FloatOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Objects.equals(Object2FloatOpenHashMap.this.key[this.index], e.getKey()) && Float.floatToIntBits(Object2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits((float)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Object2FloatOpenHashMap.this.key[this.index]).append("=>").append(Object2FloatOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(k.hashCode()) & Object2FloatOpenHashMap.this.mask); !k.equals(key[p]); p = (p + 1 & Object2FloatOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Object2FloatOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(curr.hashCode()) & Object2FloatOpenHashMap.this.mask;
                    Label_0102: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0102;
        ...
        public void remove() {
            ...
            final Object2FloatOpenHashMap this$0 = Object2FloatOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Object2FloatMap.Entry<K>> implements Object2FloatMap.FastEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Object2FloatMap.Entry<K>> consumer) {
            if (Object2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Object2FloatOpenHashMap.this.key[Object2FloatOpenHashMap.this.n], Object2FloatOpenHashMap.this.value[Object2FloatOpenHashMap.this.n]));
            }
            int pos = Object2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2FloatOpenHashMap.this.key[pos] != null) {
    ...
    private final class KeySet extends AbstractObjectSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2FloatOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Object2FloatOpenHashMap.this.size;
