...
public abstract class AbstractObject2ObjectMap<K, V> extends AbstractObject2ObjectFunction<K, V> implements Object2ObjectMap<K, V>, Serializable {
        ...
        return new AbstractObjectSet<K>() {
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>() {
                    private final ObjectIterator<Entry<K, V>> i = Object2ObjectMaps.<K, V>fastIterator((Object2ObjectMap<K, V>)AbstractObject2ObjectMap.this);
    ...
    public void putAll(final Map<? extends K, ? extends V> m) {
        if (m instanceof Object2ObjectMap) {
            final ObjectIterator<Entry<K, V>> i = Object2ObjectMaps.<K, V>fastIterator((Object2ObjectMap<K, V>)(Object2ObjectMap)m);
            while (i.hasNext()) {
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry<K, V>> i = Object2ObjectMaps.<K, V>fastIterator((Object2ObjectMap<K, V>)this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.object2ObjectEntrySet().containsAll((Collection)m.entrySet());
    }
