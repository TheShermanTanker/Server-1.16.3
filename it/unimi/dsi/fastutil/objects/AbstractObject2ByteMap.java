...
public abstract class AbstractObject2ByteMap<K> extends AbstractObject2ByteFunction<K> implements Object2ByteMap<K>, Serializable {
    ...
    public boolean containsKey(final Object k) {
        final ObjectIterator<Entry<K>> i = this.object2ByteEntrySet().iterator();
        while (i.hasNext()) {
        ...
        return new AbstractObjectSet<K>() {
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>() {
                    private final ObjectIterator<Entry<K>> i = Object2ByteMaps.<K>fastIterator((Object2ByteMap<K>)AbstractObject2ByteMap.this);
    ...
    public void putAll(final Map<? extends K, ? extends Byte> m) {
        if (m instanceof Object2ByteMap) {
            final ObjectIterator<Entry<K>> i = Object2ByteMaps.<K>fastIterator((Object2ByteMap<K>)(Object2ByteMap)m);
            while (i.hasNext()) {
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry<K>> i = Object2ByteMaps.<K>fastIterator((Object2ByteMap<K>)this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.object2ByteEntrySet().containsAll((Collection)m.entrySet());
    }
    ...
    public static class BasicEntry<K> implements Entry<K> {
        ...
        public boolean equals(final Object o) {
            ...
            return value != null && value instanceof Byte && Objects.equals(this.key, key) && this.value == (byte)value;
        }
