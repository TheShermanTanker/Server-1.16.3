...
public final class Reference2ByteSortedMaps {
    ...
    public static <K> ObjectBidirectionalIterator<Reference2ByteMap.Entry<K>> fastIterator(final Reference2ByteSortedMap<K> map) {
    ...
    public static <K> ObjectBidirectionalIterable<Reference2ByteMap.Entry<K>> fastIterable(final Reference2ByteSortedMap<K> map) {
        final ObjectSortedSet<Reference2ByteMap.Entry<K>> entries = map.reference2ByteEntrySet();
        ObjectBidirectionalIterable<Reference2ByteMap.Entry<K>> objectBidirectionalIterable;
        if (entries instanceof Reference2ByteSortedMap.FastSortedEntrySet) {
            final Reference2ByteSortedMap.FastSortedEntrySet set = (Reference2ByteSortedMap.FastSortedEntrySet)entries;
    ...
    public static <K> Reference2ByteSortedMap<K> emptyMap() {
        return (Reference2ByteSortedMap<K>)Reference2ByteSortedMaps.EMPTY_MAP;
    }
    ...
    public static class EmptySortedMap<K> extends Reference2ByteMaps.EmptyMap<K> implements Reference2ByteSortedMap<K>, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Reference2ByteMap.Entry<K>> reference2ByteEntrySet() {
            return (ObjectSortedSet<Reference2ByteMap.Entry<K>>)ObjectSortedSets.EMPTY_SET;
        }
    ...
    public static class Singleton<K> extends Reference2ByteMaps.Singleton<K> implements Reference2ByteSortedMap<K>, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Reference2ByteMap.Entry<K>> reference2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractReference2ByteMap.BasicEntry<K>(this.key, this.value), (java.util.Comparator<? super AbstractReference2ByteMap.BasicEntry<K>>)Reference2ByteSortedMaps.entryComparator((java.util.Comparator<? super Object>)this.comparator));
            }
            return (ObjectSortedSet<Reference2ByteMap.Entry<K>>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class SynchronizedSortedMap<K> extends Reference2ByteMaps.SynchronizedMap<K> implements Reference2ByteSortedMap<K>, Serializable {
        ...
        public ObjectSortedSet<Reference2ByteMap.Entry<K>> reference2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Reference2ByteMap.Entry<K>>synchronize(this.sortedMap.reference2ByteEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Reference2ByteMap.Entry<K>>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class UnmodifiableSortedMap<K> extends Reference2ByteMaps.UnmodifiableMap<K> implements Reference2ByteSortedMap<K>, Serializable {
        ...
        public ObjectSortedSet<Reference2ByteMap.Entry<K>> reference2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Reference2ByteMap.Entry<K>>unmodifiable(this.sortedMap.reference2ByteEntrySet());
            }
            return (ObjectSortedSet<Reference2ByteMap.Entry<K>>)(ObjectSortedSet)this.entries;
        }
