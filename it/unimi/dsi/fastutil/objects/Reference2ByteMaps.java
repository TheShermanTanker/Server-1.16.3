...
public final class Reference2ByteMaps {
    ...
    public static <K> ObjectIterator<Reference2ByteMap.Entry<K>> fastIterator(final Reference2ByteMap<K> map) {
    ...
    public static <K> void fastForEach(final Reference2ByteMap<K> map, final Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
        final ObjectSet<Reference2ByteMap.Entry<K>> entries = map.reference2ByteEntrySet();
    ...
    public static <K> ObjectIterable<Reference2ByteMap.Entry<K>> fastIterable(final Reference2ByteMap<K> map) {
        final ObjectSet<Reference2ByteMap.Entry<K>> entries = map.reference2ByteEntrySet();
    ...
    public static <K> Reference2ByteMap<K> emptyMap() {
        return (Reference2ByteMap<K>)Reference2ByteMaps.EMPTY_MAP;
    }
    ...
    public static class Singleton<K> extends Reference2ByteFunctions.Singleton<K> implements Reference2ByteMap<K>, Serializable, Cloneable {
        ...
        public ObjectSet<Entry<K>> reference2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.singleton(new AbstractReference2ByteMap.BasicEntry<K>(this.key, this.value));
            }
            return this.entries;
        }
    ...
    public static class SynchronizedMap<K> extends Reference2ByteFunctions.SynchronizedFunction<K> implements Reference2ByteMap<K>, Serializable {
        ...
        public ObjectSet<Entry<K>> reference2ByteEntrySet() {
            synchronized (this.sync) {
                if (this.entries == null) {
                    this.entries = ObjectSets.<Entry<K>>synchronize(this.map.reference2ByteEntrySet(), this.sync);
                }
                return this.entries;
            }
        }
    ...
    public static class UnmodifiableMap<K> extends Reference2ByteFunctions.UnmodifiableFunction<K> implements Reference2ByteMap<K>, Serializable {
        ...
        public ObjectSet<Entry<K>> reference2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.<Entry<K>>unmodifiable(this.map.reference2ByteEntrySet());
            }
            return this.entries;
        }
