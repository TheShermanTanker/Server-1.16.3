...
public class Object2ObjectRBTreeMap<K, V> extends AbstractObject2ObjectSortedMap<K, V> implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Map.Entry<?, ?> e = o;
                    final Entry<K, V> f = (Entry<K, V>)Object2ObjectRBTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(final Object2ObjectMap.Entry<K, V> from, final Object2ObjectMap.Entry<K, V> to) {
                    return (ObjectSortedSet<Object2ObjectMap.Entry<K, V>>)Object2ObjectRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2ObjectEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(final Object2ObjectMap.Entry<K, V> to) {
                    return (ObjectSortedSet<Object2ObjectMap.Entry<K, V>>)Object2ObjectRBTreeMap.this.headMap(to.getKey()).object2ObjectEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(final Object2ObjectMap.Entry<K, V> from) {
                    return (ObjectSortedSet<Object2ObjectMap.Entry<K, V>>)Object2ObjectRBTreeMap.this.tailMap(from.getKey()).object2ObjectEntrySet();
                }
            };
        }
        return this.entries;
    ...
    private class TreeIterator {
        ...
        TreeIterator(final K k) {
            this.index = 0;
            final Entry<K, V> locateKey = Object2ObjectRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractObject2ObjectSortedMap<K, V> implements Serializable {
        ...
        protected transient ObjectSortedSet<K> keys;
        protected transient ObjectCollection<V> values;
        final /* synthetic */ Object2ObjectRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Map.Entry<?, ?> e = o;
                        final Object2ObjectRBTreeMap.Entry<K, V> f = (Object2ObjectRBTreeMap.Entry<K, V>)Object2ObjectRBTreeMap.this.findKey(e.getKey());
        ...
        public K firstKey() {
            final Object2ObjectRBTreeMap.Entry<K, V> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public K lastKey() {
            final Object2ObjectRBTreeMap.Entry<K, V> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final K k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Object2ObjectRBTreeMap this$0 = submap.this$0;
                            final Object2ObjectRBTreeMap.Entry<K, V> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
