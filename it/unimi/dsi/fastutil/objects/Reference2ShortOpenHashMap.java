...
public class Reference2ShortOpenHashMap<K> extends AbstractReference2ShortMap<K> implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Reference2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Reference2ShortOpenHashMap.this.value[Reference2ShortOpenHashMap.this.n]);
                    }
                    int pos = Reference2ShortOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Reference2ShortOpenHashMap.this.key[pos] != null) {
                            consumer.accept((int)Reference2ShortOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Reference2ShortMap.Entry<K>, Map.Entry<K, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Reference2ShortOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Reference2ShortOpenHashMap.this.key[this.index]).append("=>").append((int)Reference2ShortOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(System.identityHashCode(k)) & Reference2ShortOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Reference2ShortOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Reference2ShortOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ShortOpenHashMap.this.mask;
                    Label_0103: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0103;
        ...
        public void remove() {
            ...
            final Reference2ShortOpenHashMap this$0 = Reference2ShortOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2ShortMap.Entry<K>> implements Reference2ShortMap.FastEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
            if (Reference2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Reference2ShortOpenHashMap.this.key[Reference2ShortOpenHashMap.this.n], Reference2ShortOpenHashMap.this.value[Reference2ShortOpenHashMap.this.n]));
            }
            int pos = Reference2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ShortOpenHashMap.this.key[pos] != null) {
                    consumer.accept(new BasicEntry(Reference2ShortOpenHashMap.this.key[pos], Reference2ShortOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2ShortOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2ShortOpenHashMap.this.size;
