...
public class ReferenceBigArrayBigList<K> extends AbstractReferenceBigList<K> implements RandomAccess, Cloneable, Serializable {
    ...
    protected ReferenceBigArrayBigList(final K[][] a, final boolean dummy) {
        this.a = a;
        this.wrapped = true;
    }
    ...
    public static <K> ReferenceBigArrayBigList<K> wrap(final K[][] a) {
        return ReferenceBigArrayBigList.<K>wrap(a, ObjectBigArrays.<K>length(a));
    }
    ...
    public long indexOf(final Object k) {
        for (long i = 0L; i < this.size; ++i) {
            if (k == ObjectBigArrays.<K>get(this.a, i)) {
                return i;
            }
        }
        return -1L;
    ...
    public ObjectBigListIterator<K> listIterator(final long index) {
        ...
        return new ObjectBigListIterator<K>() {
            ...
            public K next() {
                ...
                final K[][] a = ReferenceBigArrayBigList.this.a;
    ...
    public ReferenceBigArrayBigList<K> clone() {
        final ReferenceBigArrayBigList<K> c = new ReferenceBigArrayBigList<K>(this.size);
    ...
    public boolean equals(final ReferenceBigArrayBigList<K> l) {
        ...
        final K[][] a2 = l.a;
        while (s-- != 0L) {
            if (ObjectBigArrays.<K>get(a1, s) != ObjectBigArrays.<K>get(a2, s)) {
                return false;
            }
        }
        return true;
