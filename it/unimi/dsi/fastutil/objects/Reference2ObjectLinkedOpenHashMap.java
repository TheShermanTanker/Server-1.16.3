...
public class Reference2ObjectLinkedOpenHashMap<K, V> extends AbstractReference2ObjectSortedMap<K, V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Reference2ObjectMap.Entry<K, V>, Map.Entry<K, V> {
        ...
        public V setValue(final V v) {
            final V oldValue = Reference2ObjectLinkedOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Reference2ObjectLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2ObjectLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public void remove() {
            ...
            final Reference2ObjectLinkedOpenHashMap this$0 = Reference2ObjectLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Reference2ObjectLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Reference2ObjectLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Reference2ObjectLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Reference2ObjectLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Reference2ObjectLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Reference2ObjectLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0296:
            while (true) {
                pos = ((last = pos) + 1 & Reference2ObjectLinkedOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ObjectLinkedOpenHashMap.this.mask;
                    Label_0400: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0400;
        ...
        public void set(final Reference2ObjectMap.Entry<K, V> ok) {
            throw new UnsupportedOperationException();
        }
        
        public void add(final Reference2ObjectMap.Entry<K, V> ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectSortedMap.FastSortedEntrySet<K, V> {
        ...
        @Override
        public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> subSet(final Reference2ObjectMap.Entry<K, V> fromElement, final Reference2ObjectMap.Entry<K, V> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> headSet(final Reference2ObjectMap.Entry<K, V> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> tailSet(final Reference2ObjectMap.Entry<K, V> fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractReferenceSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2ObjectLinkedOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2ObjectLinkedOpenHashMap.this.size;
