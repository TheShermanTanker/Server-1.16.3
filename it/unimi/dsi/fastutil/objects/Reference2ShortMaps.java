...
public final class Reference2ShortMaps {
    ...
    public static <K> ObjectIterator<Reference2ShortMap.Entry<K>> fastIterator(final Reference2ShortMap<K> map) {
    ...
    public static <K> void fastForEach(final Reference2ShortMap<K> map, final Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
        final ObjectSet<Reference2ShortMap.Entry<K>> entries = map.reference2ShortEntrySet();
    ...
    public static <K> ObjectIterable<Reference2ShortMap.Entry<K>> fastIterable(final Reference2ShortMap<K> map) {
        final ObjectSet<Reference2ShortMap.Entry<K>> entries = map.reference2ShortEntrySet();
    ...
    public static <K> Reference2ShortMap<K> emptyMap() {
        return (Reference2ShortMap<K>)Reference2ShortMaps.EMPTY_MAP;
    }
    ...
    public static class Singleton<K> extends Reference2ShortFunctions.Singleton<K> implements Reference2ShortMap<K>, Serializable, Cloneable {
        ...
        public ObjectSet<Entry<K>> reference2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.singleton(new AbstractReference2ShortMap.BasicEntry<K>(this.key, this.value));
            }
            return this.entries;
        }
    ...
    public static class SynchronizedMap<K> extends Reference2ShortFunctions.SynchronizedFunction<K> implements Reference2ShortMap<K>, Serializable {
        ...
        public ObjectSet<Entry<K>> reference2ShortEntrySet() {
            synchronized (this.sync) {
                if (this.entries == null) {
                    this.entries = ObjectSets.<Entry<K>>synchronize(this.map.reference2ShortEntrySet(), this.sync);
                }
                return this.entries;
            }
        }
        ...
        @Override
        public short computeShortIfAbsentPartial(final K key, final Reference2ShortFunction<? super K> mappingFunction) {
            synchronized (this.sync) {
    ...
    public static class UnmodifiableMap<K> extends Reference2ShortFunctions.UnmodifiableFunction<K> implements Reference2ShortMap<K>, Serializable {
        ...
        public ObjectSet<Entry<K>> reference2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.<Entry<K>>unmodifiable(this.map.reference2ShortEntrySet());
            }
            return this.entries;
        }
