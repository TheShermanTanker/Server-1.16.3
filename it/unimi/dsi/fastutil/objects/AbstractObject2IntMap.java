...
public abstract class AbstractObject2IntMap<K> extends AbstractObject2IntFunction<K> implements Object2IntMap<K>, Serializable {
        ...
        return new AbstractObjectSet<K>() {
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>() {
                    private final ObjectIterator<Entry<K>> i = Object2IntMaps.<K>fastIterator((Object2IntMap<K>)AbstractObject2IntMap.this);
    ...
    public void putAll(final Map<? extends K, ? extends Integer> m) {
        if (m instanceof Object2IntMap) {
            final ObjectIterator<Entry<K>> i = Object2IntMaps.<K>fastIterator((Object2IntMap<K>)(Object2IntMap)m);
            while (i.hasNext()) {
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry<K>> i = Object2IntMaps.<K>fastIterator((Object2IntMap<K>)this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.object2IntEntrySet().containsAll((Collection)m.entrySet());
    }
