...
public final class Reference2ReferenceFunctions {
    ...
    public static <K, V> Reference2ReferenceFunction<K, V> singleton(final K key, final V value) {
    ...
    public static <K, V> Reference2ReferenceFunction<K, V> synchronize(final Reference2ReferenceFunction<K, V> f, final Object sync) {
