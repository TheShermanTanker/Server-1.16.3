...
public class ObjectArrayFIFOQueue<K> implements PriorityQueue<K>, Serializable {
    ...
    public void clear() {
        if (this.start <= this.end) {
            Arrays.fill((Object[])this.array, this.start, this.end, null);
        }
        else {
            Arrays.fill((Object[])this.array, this.start, this.length, null);
            Arrays.fill((Object[])this.array, 0, this.end, null);
        }
        final int n = 0;
        this.end = n;
        this.start = n;
