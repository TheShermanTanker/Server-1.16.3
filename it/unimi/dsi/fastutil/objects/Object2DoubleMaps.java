...
public final class Object2DoubleMaps {
    ...
    public static <K> ObjectIterator<Object2DoubleMap.Entry<K>> fastIterator(final Object2DoubleMap<K> map) {
    ...
    public static <K> void fastForEach(final Object2DoubleMap<K> map, final Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
        final ObjectSet<Object2DoubleMap.Entry<K>> entries = map.object2DoubleEntrySet();
    ...
    public static <K> ObjectIterable<Object2DoubleMap.Entry<K>> fastIterable(final Object2DoubleMap<K> map) {
        final ObjectSet<Object2DoubleMap.Entry<K>> entries = map.object2DoubleEntrySet();
    ...
    public static <K> Object2DoubleMap<K> emptyMap() {
        return (Object2DoubleMap<K>)Object2DoubleMaps.EMPTY_MAP;
    }
    ...
    public static class Singleton<K> extends Object2DoubleFunctions.Singleton<K> implements Object2DoubleMap<K>, Serializable, Cloneable {
        ...
        public ObjectSet<Entry<K>> object2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.singleton(new AbstractObject2DoubleMap.BasicEntry<K>(this.key, this.value));
            }
            return this.entries;
        }
    ...
    public static class SynchronizedMap<K> extends Object2DoubleFunctions.SynchronizedFunction<K> implements Object2DoubleMap<K>, Serializable {
        ...
        public ObjectSet<Entry<K>> object2DoubleEntrySet() {
            synchronized (this.sync) {
                if (this.entries == null) {
                    this.entries = ObjectSets.<Entry<K>>synchronize(this.map.object2DoubleEntrySet(), this.sync);
                }
                return this.entries;
            }
        }
        ...
        @Override
        public double computeDoubleIfAbsentPartial(final K key, final Object2DoubleFunction<? super K> mappingFunction) {
            synchronized (this.sync) {
    ...
    public static class UnmodifiableMap<K> extends Object2DoubleFunctions.UnmodifiableFunction<K> implements Object2DoubleMap<K>, Serializable {
        ...
        public ObjectSet<Entry<K>> object2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.<Entry<K>>unmodifiable(this.map.object2DoubleEntrySet());
            }
            return this.entries;
        }
