...
public class Reference2ObjectOpenHashMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Reference2ObjectMap.Entry<K, V>, Map.Entry<K, V> {
        ...
        public V setValue(final V v) {
            final V oldValue = Reference2ObjectOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Reference2ObjectOpenHashMap.this.key[this.index]).append("=>").append(Reference2ObjectOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(System.identityHashCode(k)) & Reference2ObjectOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Reference2ObjectOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Reference2ObjectOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2ObjectOpenHashMap.this.mask;
                    Label_0113: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0113;
        ...
        public void remove() {
            ...
            final Reference2ObjectOpenHashMap this$0 = Reference2ObjectOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectMap.FastEntrySet<K, V> {
        ...
        public void forEach(final Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
            if (Reference2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Reference2ObjectOpenHashMap.this.key[Reference2ObjectOpenHashMap.this.n], Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n]));
            }
            int pos = Reference2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ObjectOpenHashMap.this.key[pos] != null) {
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2ObjectOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2ObjectOpenHashMap.this.size;
