...
public abstract class AbstractObject2BooleanMap<K> extends AbstractObject2BooleanFunction<K> implements Object2BooleanMap<K>, Serializable {
    ...
    public boolean containsKey(final Object k) {
        final ObjectIterator<Entry<K>> i = this.object2BooleanEntrySet().iterator();
        while (i.hasNext()) {
        ...
        return new AbstractObjectSet<K>() {
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>() {
                    private final ObjectIterator<Entry<K>> i = Object2BooleanMaps.<K>fastIterator((Object2BooleanMap<K>)AbstractObject2BooleanMap.this);
    ...
    public void putAll(final Map<? extends K, ? extends Boolean> m) {
        if (m instanceof Object2BooleanMap) {
            final ObjectIterator<Entry<K>> i = Object2BooleanMaps.<K>fastIterator((Object2BooleanMap<K>)(Object2BooleanMap)m);
            while (i.hasNext()) {
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry<K>> i = Object2BooleanMaps.<K>fastIterator((Object2BooleanMap<K>)this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.object2BooleanEntrySet().containsAll((Collection)m.entrySet());
    }
    ...
    public static class BasicEntry<K> implements Entry<K> {
        ...
        public boolean equals(final Object o) {
            ...
            return value != null && value instanceof Boolean && Objects.equals(this.key, key) && this.value == (boolean)value;
        }
