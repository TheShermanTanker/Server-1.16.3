...
public class Reference2FloatOpenCustomHashMap<K> extends AbstractReference2FloatMap<K> implements Serializable, Cloneable, Hash {
    ...
    public Reference2FloatOpenCustomHashMap(final int expected, final float f, final Strategy<K> strategy) {
    ...
    public Reference2FloatOpenCustomHashMap(final int expected, final Strategy<K> strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Reference2FloatOpenCustomHashMap(final Strategy<K> strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Reference2FloatOpenCustomHashMap(final Map<? extends K, ? extends Float> m, final float f, final Strategy<K> strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Reference2FloatOpenCustomHashMap(final Map<? extends K, ? extends Float> m, final Strategy<K> strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Reference2FloatOpenCustomHashMap(final Reference2FloatMap<K> m, final float f, final Strategy<K> strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Reference2FloatOpenCustomHashMap(final Reference2FloatMap<K> m, final Strategy<K> strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Reference2FloatOpenCustomHashMap(final K[] k, final float[] v, final float f, final Strategy<K> strategy) {
    ...
    public Reference2FloatOpenCustomHashMap(final K[] k, final float[] v, final Strategy<K> strategy) {
            ...
            this.values = new AbstractFloatCollection() {
                ...
                public void forEach(final DoubleConsumer consumer) {
                    if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((double)Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n]);
                    }
                    int pos = Reference2FloatOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Reference2FloatOpenCustomHashMap.this.key[pos] != null) {
                            consumer.accept((double)Reference2FloatOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Reference2FloatMap.Entry<K>, Map.Entry<K, Float> {
        ...
        public float setValue(final float v) {
            final float oldValue = Reference2FloatOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((float)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Reference2FloatOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2FloatOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2FloatOpenCustomHashMap.this.mask); !Reference2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Reference2FloatOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Reference2FloatOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2FloatOpenCustomHashMap.this.mask;
                    Label_0112: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0112;
        ...
        public void remove() {
            ...
            final Reference2FloatOpenCustomHashMap this$0 = Reference2FloatOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2FloatMap.Entry<K>> implements Reference2FloatMap.FastEntrySet<K> {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            K curr;
            if ((curr = key[pos = (HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2FloatOpenCustomHashMap.this.mask)]) == null) {
                return false;
            }
        ...
        public boolean remove(final Object o) {
            ...
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
                ...
                if (!Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Reference2FloatOpenCustomHashMap.this.mask)]) != null) {
                        if (Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
        ...
        public void forEach(final Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
            if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Reference2FloatOpenCustomHashMap.this.key[Reference2FloatOpenCustomHashMap.this.n], Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n]));
            }
            int pos = Reference2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2FloatOpenCustomHashMap.this.key[pos] != null) {
                    consumer.accept(new BasicEntry(Reference2FloatOpenCustomHashMap.this.key[pos], Reference2FloatOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2FloatOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2FloatOpenCustomHashMap.this.size;
