...
public class Reference2BooleanOpenHashMap<K> extends AbstractReference2BooleanMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Reference2BooleanMap.Entry<K>, Map.Entry<K, Boolean> {
        ...
        public boolean setValue(final boolean v) {
            final boolean oldValue = Reference2BooleanOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Reference2BooleanOpenHashMap.this.key[this.index]).append("=>").append(Reference2BooleanOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(System.identityHashCode(k)) & Reference2BooleanOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Reference2BooleanOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Reference2BooleanOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2BooleanOpenHashMap.this.mask;
                    Label_0103: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0103;
        ...
        public void remove() {
            ...
            final Reference2BooleanOpenHashMap this$0 = Reference2BooleanOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2BooleanMap.Entry<K>> implements Reference2BooleanMap.FastEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            if (Reference2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Reference2BooleanOpenHashMap.this.key[Reference2BooleanOpenHashMap.this.n], Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.n]));
            }
            int pos = Reference2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2BooleanOpenHashMap.this.key[pos] != null) {
                    consumer.accept(new BasicEntry(Reference2BooleanOpenHashMap.this.key[pos], Reference2BooleanOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2BooleanOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2BooleanOpenHashMap.this.size;
