...
public abstract class AbstractObject2LongMap<K> extends AbstractObject2LongFunction<K> implements Object2LongMap<K>, Serializable {
    ...
    public boolean containsKey(final Object k) {
        final ObjectIterator<Entry<K>> i = this.object2LongEntrySet().iterator();
        while (i.hasNext()) {
        ...
        return new AbstractObjectSet<K>() {
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>() {
                    private final ObjectIterator<Entry<K>> i = Object2LongMaps.<K>fastIterator((Object2LongMap<K>)AbstractObject2LongMap.this);
    ...
    public void putAll(final Map<? extends K, ? extends Long> m) {
        if (m instanceof Object2LongMap) {
            final ObjectIterator<Entry<K>> i = Object2LongMaps.<K>fastIterator((Object2LongMap<K>)(Object2LongMap)m);
            while (i.hasNext()) {
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry<K>> i = Object2LongMaps.<K>fastIterator((Object2LongMap<K>)this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.object2LongEntrySet().containsAll((Collection)m.entrySet());
    }
    ...
    public static class BasicEntry<K> implements Entry<K> {
        ...
        public boolean equals(final Object o) {
            ...
            return value != null && value instanceof Long && Objects.equals(this.key, key) && this.value == (long)value;
        }
