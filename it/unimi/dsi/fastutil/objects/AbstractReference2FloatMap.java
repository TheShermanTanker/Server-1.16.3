...
public abstract class AbstractReference2FloatMap<K> extends AbstractReference2FloatFunction<K> implements Reference2FloatMap<K>, Serializable {
    ...
    public boolean containsKey(final Object k) {
        final ObjectIterator<Entry<K>> i = this.reference2FloatEntrySet().iterator();
        while (i.hasNext()) {
        ...
        return new AbstractReferenceSet<K>() {
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>() {
                    private final ObjectIterator<Entry<K>> i = Reference2FloatMaps.<K>fastIterator((Reference2FloatMap<K>)AbstractReference2FloatMap.this);
    ...
    public void putAll(final Map<? extends K, ? extends Float> m) {
        if (m instanceof Reference2FloatMap) {
            final ObjectIterator<Entry<K>> i = Reference2FloatMaps.<K>fastIterator((Reference2FloatMap<K>)(Reference2FloatMap)m);
            while (i.hasNext()) {
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry<K>> i = Reference2FloatMaps.<K>fastIterator((Reference2FloatMap<K>)this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.reference2FloatEntrySet().containsAll((Collection)m.entrySet());
    }
    ...
    public static class BasicEntry<K> implements Entry<K> {
        ...
        public boolean equals(final Object o) {
            ...
            return value != null && value instanceof Float && this.key == key && Float.floatToIntBits(this.value) == Float.floatToIntBits((float)value);
        }
