...
public class Object2LongLinkedOpenCustomHashMap<K> extends AbstractObject2LongSortedMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Object2LongMap.Entry<K>, Map.Entry<K, Long> {
        ...
        public long setValue(final long v) {
            final long oldValue = Object2LongLinkedOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Object2LongLinkedOpenCustomHashMap.this.strategy.equals(Object2LongLinkedOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Object2LongLinkedOpenCustomHashMap.this.value[this.index] == (long)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Object2LongLinkedOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2LongLinkedOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final K from) {
            ...
            if (Object2LongLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
                ...
                for (int pos = HashCommon.mix(Object2LongLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2LongLinkedOpenCustomHashMap.this.mask; Object2LongLinkedOpenCustomHashMap.this.key[pos] != null; pos = (pos + 1 & Object2LongLinkedOpenCustomHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Object2LongLinkedOpenCustomHashMap this$0 = Object2LongLinkedOpenCustomHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Object2LongLinkedOpenCustomHashMap.this.first = this.next;
            }
            else {
                final long[] link = Object2LongLinkedOpenCustomHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Object2LongLinkedOpenCustomHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Object2LongLinkedOpenCustomHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Object2LongLinkedOpenCustomHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Object2LongLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Object2LongLinkedOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Object2LongLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2LongLinkedOpenCustomHashMap.this.mask;
                    Label_0382: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0382;
        ...
        public void set(final Object2LongMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
        
        public void add(final Object2LongMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Object2LongMap.Entry<K>> implements Object2LongSortedMap.FastSortedEntrySet<K> {
        ...
        @Override
        public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(final Object2LongMap.Entry<K> fromElement, final Object2LongMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(final Object2LongMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(final Object2LongMap.Entry<K> fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            K curr;
            if ((curr = key[pos = (HashCommon.mix(Object2LongLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2LongLinkedOpenCustomHashMap.this.mask)]) == null) {
                return false;
            }
    ...
    private final class KeySet extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2LongLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2LongLinkedOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Object2LongLinkedOpenCustomHashMap.this.size;
