        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>() {
                ...
                public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(final Object2ReferenceMap.Entry<K, V> from, final Object2ReferenceMap.Entry<K, V> to) {
                    return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>)Object2ReferenceAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2ReferenceEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(final Object2ReferenceMap.Entry<K, V> to) {
                    return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>)Object2ReferenceAVLTreeMap.this.headMap(to.getKey()).object2ReferenceEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(final Object2ReferenceMap.Entry<K, V> from) {
                    return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>)Object2ReferenceAVLTreeMap.this.tailMap(from.getKey()).object2ReferenceEntrySet();
                }
            };
        }
        return this.entries;
        ...
        public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>() {
                    ...
                    @Override
                    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(final Object2ReferenceMap.Entry<K, V> from, final Object2ReferenceMap.Entry<K, V> to) {
                        return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>)Submap.this.subMap(from.getKey(), to.getKey()).object2ReferenceEntrySet();
                    }
                    
                    @Override
                    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(final Object2ReferenceMap.Entry<K, V> to) {
                        return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>)Submap.this.headMap(to.getKey()).object2ReferenceEntrySet();
                    }
                    
                    @Override
                    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(final Object2ReferenceMap.Entry<K, V> from) {
                        return (ObjectSortedSet<Object2ReferenceMap.Entry<K, V>>)Submap.this.tailMap(from.getKey()).object2ReferenceEntrySet();
                    }
                };
            }
            return this.entries;
