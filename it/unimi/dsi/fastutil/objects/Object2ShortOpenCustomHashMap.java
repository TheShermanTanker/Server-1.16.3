...
public class Object2ShortOpenCustomHashMap<K> extends AbstractObject2ShortMap<K> implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Object2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Object2ShortOpenCustomHashMap.this.value[Object2ShortOpenCustomHashMap.this.n]);
                    }
                    int pos = Object2ShortOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Object2ShortOpenCustomHashMap.this.key[pos] != null) {
                            consumer.accept((int)Object2ShortOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Object2ShortMap.Entry<K>, Map.Entry<K, Short> {
        ...
        public boolean equals(final Object o) {
            ...
            return Object2ShortOpenCustomHashMap.this.strategy.equals(Object2ShortOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Object2ShortOpenCustomHashMap.this.value[this.index] == (short)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Object2ShortOpenCustomHashMap.this.key[this.index]).append("=>").append((int)Object2ShortOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<K>> implements Object2ShortMap.FastEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Object2ShortMap.Entry<K>> consumer) {
            if (Object2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Object2ShortOpenCustomHashMap.this.key[Object2ShortOpenCustomHashMap.this.n], Object2ShortOpenCustomHashMap.this.value[Object2ShortOpenCustomHashMap.this.n]));
            }
            int pos = Object2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ShortOpenCustomHashMap.this.key[pos] != null) {
    ...
    private final class KeySet extends AbstractObjectSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2ShortOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
