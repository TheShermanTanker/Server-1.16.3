...
public abstract class AbstractObject2ShortMap<K> extends AbstractObject2ShortFunction<K> implements Object2ShortMap<K>, Serializable {
    ...
    public boolean containsKey(final Object k) {
        final ObjectIterator<Entry<K>> i = this.object2ShortEntrySet().iterator();
        while (i.hasNext()) {
        ...
        return new AbstractObjectSet<K>() {
            ...
            public ObjectIterator<K> iterator() {
                return new ObjectIterator<K>() {
                    private final ObjectIterator<Entry<K>> i = Object2ShortMaps.<K>fastIterator((Object2ShortMap<K>)AbstractObject2ShortMap.this);
    ...
    public void putAll(final Map<? extends K, ? extends Short> m) {
        if (m instanceof Object2ShortMap) {
            final ObjectIterator<Entry<K>> i = Object2ShortMaps.<K>fastIterator((Object2ShortMap<K>)(Object2ShortMap)m);
            while (i.hasNext()) {
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry<K>> i = Object2ShortMaps.<K>fastIterator((Object2ShortMap<K>)this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.object2ShortEntrySet().containsAll((Collection)m.entrySet());
    }
    ...
    public static class BasicEntry<K> implements Entry<K> {
        ...
        public boolean equals(final Object o) {
            ...
            return value != null && value instanceof Short && Objects.equals(this.key, key) && this.value == (short)value;
        }
