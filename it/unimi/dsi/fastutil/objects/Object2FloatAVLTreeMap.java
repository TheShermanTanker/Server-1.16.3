...
public class Object2FloatAVLTreeMap<K> extends AbstractObject2FloatSortedMap<K> implements Serializable, Cloneable {
    ...
    public Object2FloatAVLTreeMap(final SortedMap<K, Float> m) {
        this(m.comparator());
        this.putAll((java.util.Map<? extends K, ? extends Float>)m);
    }
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
                ...
                public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(final Object2FloatMap.Entry<K> from, final Object2FloatMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2FloatMap.Entry<K>>)Object2FloatAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2FloatEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(final Object2FloatMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2FloatMap.Entry<K>>)Object2FloatAVLTreeMap.this.headMap(to.getKey()).object2FloatEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(final Object2FloatMap.Entry<K> from) {
                    return (ObjectSortedSet<Object2FloatMap.Entry<K>>)Object2FloatAVLTreeMap.this.tailMap(from.getKey()).object2FloatEntrySet();
                }
            };
        }
        return this.entries;
        ...
        public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
                    ...
                    @Override
                    public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(final Object2FloatMap.Entry<K> from, final Object2FloatMap.Entry<K> to) {
                        return (ObjectSortedSet<Object2FloatMap.Entry<K>>)Submap.this.subMap(from.getKey(), to.getKey()).object2FloatEntrySet();
                    }
                    
                    @Override
                    public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(final Object2FloatMap.Entry<K> to) {
                        return (ObjectSortedSet<Object2FloatMap.Entry<K>>)Submap.this.headMap(to.getKey()).object2FloatEntrySet();
                    }
                    
                    @Override
                    public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(final Object2FloatMap.Entry<K> from) {
                        return (ObjectSortedSet<Object2FloatMap.Entry<K>>)Submap.this.tailMap(from.getKey()).object2FloatEntrySet();
                    }
                };
            }
            return this.entries;
