...
public class Object2DoubleLinkedOpenCustomHashMap<K> extends AbstractObject2DoubleSortedMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Object2DoubleMap.Entry<K>, Map.Entry<K, Double> {
        ...
        public boolean equals(final Object o) {
            ...
            return Object2DoubleLinkedOpenCustomHashMap.this.strategy.equals(Object2DoubleLinkedOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Double.doubleToLongBits(Object2DoubleLinkedOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((double)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Object2DoubleLinkedOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2DoubleLinkedOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
        ...
        public boolean remove(final Object o) {
            ...
            if (Object2DoubleLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
                ...
                if (!Object2DoubleLinkedOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Object2DoubleLinkedOpenCustomHashMap.this.mask)]) != null) {
                        if (Object2DoubleLinkedOpenCustomHashMap.this.strategy.equals(curr, k) && Double.doubleToLongBits(Object2DoubleLinkedOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
    ...
    private final class KeySet extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2DoubleLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2DoubleLinkedOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
