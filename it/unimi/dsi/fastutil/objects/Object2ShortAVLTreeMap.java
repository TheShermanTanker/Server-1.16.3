        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>() {
                ...
                public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(final Object2ShortMap.Entry<K> from, final Object2ShortMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2ShortMap.Entry<K>>)Object2ShortAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2ShortEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(final Object2ShortMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2ShortMap.Entry<K>>)Object2ShortAVLTreeMap.this.headMap(to.getKey()).object2ShortEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(final Object2ShortMap.Entry<K> from) {
                    return (ObjectSortedSet<Object2ShortMap.Entry<K>>)Object2ShortAVLTreeMap.this.tailMap(from.getKey()).object2ShortEntrySet();
                }
            };
        }
        return this.entries;
        ...
        public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>() {
                    ...
                    @Override
                    public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(final Object2ShortMap.Entry<K> from, final Object2ShortMap.Entry<K> to) {
                        return (ObjectSortedSet<Object2ShortMap.Entry<K>>)Submap.this.subMap(from.getKey(), to.getKey()).object2ShortEntrySet();
                    }
                    
                    @Override
                    public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(final Object2ShortMap.Entry<K> to) {
                        return (ObjectSortedSet<Object2ShortMap.Entry<K>>)Submap.this.headMap(to.getKey()).object2ShortEntrySet();
                    }
                    
                    @Override
                    public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(final Object2ShortMap.Entry<K> from) {
                        return (ObjectSortedSet<Object2ShortMap.Entry<K>>)Submap.this.tailMap(from.getKey()).object2ShortEntrySet();
                    }
                };
            }
            return this.entries;
