...
public class Object2ShortLinkedOpenHashMap<K> extends AbstractObject2ShortSortedMap<K> implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Object2ShortLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Object2ShortLinkedOpenHashMap.this.value[Object2ShortLinkedOpenHashMap.this.n]);
                    }
                    int pos = Object2ShortLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Object2ShortLinkedOpenHashMap.this.key[pos] != null) {
                            consumer.accept((int)Object2ShortLinkedOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Object2ShortMap.Entry<K>, Map.Entry<K, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Object2ShortLinkedOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Object2ShortLinkedOpenHashMap.this.key[this.index]).append("=>").append((int)Object2ShortLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final K from) {
            ...
            if (from == null) {
                ...
                for (int pos = HashCommon.mix(from.hashCode()) & Object2ShortLinkedOpenHashMap.this.mask; Object2ShortLinkedOpenHashMap.this.key[pos] != null; pos = (pos + 1 & Object2ShortLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Object2ShortLinkedOpenHashMap this$0 = Object2ShortLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Object2ShortLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Object2ShortLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Object2ShortLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Object2ShortLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Object2ShortLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Object2ShortLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Object2ShortLinkedOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(curr.hashCode()) & Object2ShortLinkedOpenHashMap.this.mask;
                    Label_0373: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0373;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Object2ShortMap.Entry<K>> implements Object2ShortSortedMap.FastSortedEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Object2ShortMap.Entry<K>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Object2ShortLinkedOpenHashMap.this.key[curr], Object2ShortLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2ShortLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2ShortLinkedOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Object2ShortLinkedOpenHashMap.this.size;
