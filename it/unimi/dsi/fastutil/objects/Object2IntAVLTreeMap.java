...
public class Object2IntAVLTreeMap<K> extends AbstractObject2IntSortedMap<K> implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<K> f = (Entry<K>)Object2IntAVLTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(final Object2IntMap.Entry<K> from, final Object2IntMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2IntMap.Entry<K>>)Object2IntAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2IntEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(final Object2IntMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2IntMap.Entry<K>>)Object2IntAVLTreeMap.this.headMap(to.getKey()).object2IntEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(final Object2IntMap.Entry<K> from) {
                    return (ObjectSortedSet<Object2IntMap.Entry<K>>)Object2IntAVLTreeMap.this.tailMap(from.getKey()).object2IntEntrySet();
                }
            };
        }
        return this.entries;
    ...
    private class TreeIterator {
        ...
        TreeIterator(final K k) {
            this.index = 0;
            final Entry<K> locateKey = Object2IntAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractObject2IntSortedMap<K> implements Serializable {
        ...
        protected transient ObjectSortedSet<K> keys;
        protected transient IntCollection values;
        final /* synthetic */ Object2IntAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Object2IntAVLTreeMap.Entry<K> f = (Object2IntAVLTreeMap.Entry<K>)Object2IntAVLTreeMap.this.findKey(e.getKey());
        ...
        public K firstKey() {
            final Object2IntAVLTreeMap.Entry<K> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public K lastKey() {
            final Object2IntAVLTreeMap.Entry<K> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final K k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Object2IntAVLTreeMap this$0 = submap.this$0;
                            final Object2IntAVLTreeMap.Entry<K> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
