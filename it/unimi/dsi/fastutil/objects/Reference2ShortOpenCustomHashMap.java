...
public class Reference2ShortOpenCustomHashMap<K> extends AbstractReference2ShortMap<K> implements Serializable, Cloneable, Hash {
    ...
    public Reference2ShortOpenCustomHashMap(final int expected, final float f, final Strategy<K> strategy) {
    ...
    public Reference2ShortOpenCustomHashMap(final int expected, final Strategy<K> strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Reference2ShortOpenCustomHashMap(final Strategy<K> strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Reference2ShortOpenCustomHashMap(final Map<? extends K, ? extends Short> m, final float f, final Strategy<K> strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Reference2ShortOpenCustomHashMap(final Map<? extends K, ? extends Short> m, final Strategy<K> strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Reference2ShortOpenCustomHashMap(final Reference2ShortMap<K> m, final float f, final Strategy<K> strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Reference2ShortOpenCustomHashMap(final Reference2ShortMap<K> m, final Strategy<K> strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Reference2ShortOpenCustomHashMap(final K[] k, final short[] v, final float f, final Strategy<K> strategy) {
    ...
    public Reference2ShortOpenCustomHashMap(final K[] k, final short[] v, final Strategy<K> strategy) {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Reference2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Reference2ShortOpenCustomHashMap.this.value[Reference2ShortOpenCustomHashMap.this.n]);
                    }
                    int pos = Reference2ShortOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Reference2ShortOpenCustomHashMap.this.key[pos] != null) {
                            consumer.accept((int)Reference2ShortOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Reference2ShortMap.Entry<K>, Map.Entry<K, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Reference2ShortOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2ShortOpenCustomHashMap.this.strategy.equals(Reference2ShortOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Reference2ShortOpenCustomHashMap.this.value[this.index] == (short)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Reference2ShortOpenCustomHashMap.this.key[this.index]).append("=>").append((int)Reference2ShortOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ShortOpenCustomHashMap.this.mask); !Reference2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Reference2ShortOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Reference2ShortOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2ShortOpenCustomHashMap.this.mask;
                    Label_0112: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0112;
        ...
        public void remove() {
            ...
            final Reference2ShortOpenCustomHashMap this$0 = Reference2ShortOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2ShortMap.Entry<K>> implements Reference2ShortMap.FastEntrySet<K> {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            K curr;
            if ((curr = key[pos = (HashCommon.mix(Reference2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ShortOpenCustomHashMap.this.mask)]) == null) {
                return false;
            }
        ...
        public void forEach(final Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
            if (Reference2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Reference2ShortOpenCustomHashMap.this.key[Reference2ShortOpenCustomHashMap.this.n], Reference2ShortOpenCustomHashMap.this.value[Reference2ShortOpenCustomHashMap.this.n]));
            }
            int pos = Reference2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ShortOpenCustomHashMap.this.key[pos] != null) {
                    consumer.accept(new BasicEntry(Reference2ShortOpenCustomHashMap.this.key[pos], Reference2ShortOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2ShortOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2ShortOpenCustomHashMap.this.size;
