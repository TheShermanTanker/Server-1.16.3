...
public class Object2ObjectLinkedOpenHashMap<K, V> extends AbstractObject2ObjectSortedMap<K, V> implements Serializable, Cloneable, Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>() {
                ...
                public void forEach(final Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Object2ObjectLinkedOpenHashMap.this.key[pos] != null) {
    ...
    final class MapEntry implements Object2ObjectMap.Entry<K, V>, Map.Entry<K, V> {
        ...
        public String toString() {
            return new StringBuilder().append(Object2ObjectLinkedOpenHashMap.this.key[this.index]).append("=>").append(Object2ObjectLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>> implements Object2ObjectSortedMap.FastSortedEntrySet<K, V> {
        ...
        public void forEach(final Consumer<? super Object2ObjectMap.Entry<K, V>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Object2ObjectLinkedOpenHashMap.this.key[curr], Object2ObjectLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2ObjectLinkedOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
