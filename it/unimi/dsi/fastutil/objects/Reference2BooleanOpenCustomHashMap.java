...
public class Reference2BooleanOpenCustomHashMap<K> extends AbstractReference2BooleanMap<K> implements Serializable, Cloneable, Hash {
    ...
    public Reference2BooleanOpenCustomHashMap(final int expected, final float f, final Strategy<K> strategy) {
    ...
    public Reference2BooleanOpenCustomHashMap(final int expected, final Strategy<K> strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Reference2BooleanOpenCustomHashMap(final Strategy<K> strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Reference2BooleanOpenCustomHashMap(final Map<? extends K, ? extends Boolean> m, final float f, final Strategy<K> strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Reference2BooleanOpenCustomHashMap(final Map<? extends K, ? extends Boolean> m, final Strategy<K> strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Reference2BooleanOpenCustomHashMap(final Reference2BooleanMap<K> m, final float f, final Strategy<K> strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Reference2BooleanOpenCustomHashMap(final Reference2BooleanMap<K> m, final Strategy<K> strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Reference2BooleanOpenCustomHashMap(final K[] k, final boolean[] v, final float f, final Strategy<K> strategy) {
    ...
    public Reference2BooleanOpenCustomHashMap(final K[] k, final boolean[] v, final Strategy<K> strategy) {
    ...
    final class MapEntry implements Reference2BooleanMap.Entry<K>, Map.Entry<K, Boolean> {
        ...
        public boolean setValue(final boolean v) {
            final boolean oldValue = Reference2BooleanOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2BooleanOpenCustomHashMap.this.strategy.equals(Reference2BooleanOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Reference2BooleanOpenCustomHashMap.this.value[this.index] == (boolean)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Reference2BooleanOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2BooleanOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(Reference2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2BooleanOpenCustomHashMap.this.mask); !Reference2BooleanOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Reference2BooleanOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Reference2BooleanOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Reference2BooleanOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2BooleanOpenCustomHashMap.this.mask;
                    Label_0112: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0112;
        ...
        public void remove() {
            ...
            final Reference2BooleanOpenCustomHashMap this$0 = Reference2BooleanOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2BooleanMap.Entry<K>> implements Reference2BooleanMap.FastEntrySet<K> {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            K curr;
            if ((curr = key[pos = (HashCommon.mix(Reference2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2BooleanOpenCustomHashMap.this.mask)]) == null) {
                return false;
            }
        ...
        public void forEach(final Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            if (Reference2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Reference2BooleanOpenCustomHashMap.this.key[Reference2BooleanOpenCustomHashMap.this.n], Reference2BooleanOpenCustomHashMap.this.value[Reference2BooleanOpenCustomHashMap.this.n]));
            }
            int pos = Reference2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2BooleanOpenCustomHashMap.this.key[pos] != null) {
                    consumer.accept(new BasicEntry(Reference2BooleanOpenCustomHashMap.this.key[pos], Reference2BooleanOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2BooleanOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2BooleanOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2BooleanOpenCustomHashMap.this.size;
