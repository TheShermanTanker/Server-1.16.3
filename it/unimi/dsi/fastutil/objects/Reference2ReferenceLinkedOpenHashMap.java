...
public class Reference2ReferenceLinkedOpenHashMap<K, V> extends AbstractReference2ReferenceSortedMap<K, V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Reference2ReferenceMap.Entry<K, V>, Map.Entry<K, V> {
        ...
        public String toString() {
            return new StringBuilder().append(Reference2ReferenceLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2ReferenceLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceSortedMap.FastSortedEntrySet<K, V> {
        ...
        public void forEach(final Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Reference2ReferenceLinkedOpenHashMap.this.key[curr], Reference2ReferenceLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractReferenceSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2ReferenceLinkedOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
