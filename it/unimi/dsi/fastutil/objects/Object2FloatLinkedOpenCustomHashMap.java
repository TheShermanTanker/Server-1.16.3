...
public class Object2FloatLinkedOpenCustomHashMap<K> extends AbstractObject2FloatSortedMap<K> implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractFloatCollection() {
                ...
                public void forEach(final DoubleConsumer consumer) {
                    if (Object2FloatLinkedOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((double)Object2FloatLinkedOpenCustomHashMap.this.value[Object2FloatLinkedOpenCustomHashMap.this.n]);
                    }
                    int pos = Object2FloatLinkedOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Object2FloatLinkedOpenCustomHashMap.this.key[pos] != null) {
                            consumer.accept((double)Object2FloatLinkedOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Object2FloatMap.Entry<K>, Map.Entry<K, Float> {
        ...
        public float setValue(final float v) {
            final float oldValue = Object2FloatLinkedOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Object2FloatLinkedOpenCustomHashMap.this.strategy.equals(Object2FloatLinkedOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Float.floatToIntBits(Object2FloatLinkedOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((float)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Object2FloatLinkedOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2FloatLinkedOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final K from) {
            ...
            if (Object2FloatLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
                ...
                for (int pos = HashCommon.mix(Object2FloatLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2FloatLinkedOpenCustomHashMap.this.mask; Object2FloatLinkedOpenCustomHashMap.this.key[pos] != null; pos = (pos + 1 & Object2FloatLinkedOpenCustomHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Object2FloatLinkedOpenCustomHashMap this$0 = Object2FloatLinkedOpenCustomHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Object2FloatLinkedOpenCustomHashMap.this.first = this.next;
            }
            else {
                final long[] link = Object2FloatLinkedOpenCustomHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Object2FloatLinkedOpenCustomHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Object2FloatLinkedOpenCustomHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Object2FloatLinkedOpenCustomHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Object2FloatLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Object2FloatLinkedOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Object2FloatLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2FloatLinkedOpenCustomHashMap.this.mask;
                    Label_0382: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0382;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Object2FloatMap.Entry<K>> implements Object2FloatSortedMap.FastSortedEntrySet<K> {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            K curr;
            if ((curr = key[pos = (HashCommon.mix(Object2FloatLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2FloatLinkedOpenCustomHashMap.this.mask)]) == null) {
                return false;
            }
        ...
        public boolean remove(final Object o) {
            ...
            if (Object2FloatLinkedOpenCustomHashMap.this.strategy.equals(k, null)) {
                ...
                if (!Object2FloatLinkedOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Object2FloatLinkedOpenCustomHashMap.this.mask)]) != null) {
                        if (Object2FloatLinkedOpenCustomHashMap.this.strategy.equals(curr, k) && Float.floatToIntBits(Object2FloatLinkedOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
        ...
        public void forEach(final Consumer<? super Object2FloatMap.Entry<K>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Object2FloatLinkedOpenCustomHashMap.this.key[curr], Object2FloatLinkedOpenCustomHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2FloatLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2FloatLinkedOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Object2FloatLinkedOpenCustomHashMap.this.size;
