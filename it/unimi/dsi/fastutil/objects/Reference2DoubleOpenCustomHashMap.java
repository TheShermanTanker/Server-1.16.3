...
public class Reference2DoubleOpenCustomHashMap<K> extends AbstractReference2DoubleMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Reference2DoubleMap.Entry<K>, Map.Entry<K, Double> {
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2DoubleOpenCustomHashMap.this.strategy.equals(Reference2DoubleOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((double)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Reference2DoubleOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2DoubleOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry<K>> implements Reference2DoubleMap.FastEntrySet<K> {
        ...
        public boolean remove(final Object o) {
            ...
            if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(k, null)) {
                ...
                if (!Reference2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask)]) != null) {
                        if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && Double.doubleToLongBits(Reference2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
        ...
        public void forEach(final Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
            if (Reference2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Reference2DoubleOpenCustomHashMap.this.key[Reference2DoubleOpenCustomHashMap.this.n], Reference2DoubleOpenCustomHashMap.this.value[Reference2DoubleOpenCustomHashMap.this.n]));
            }
            int pos = Reference2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2DoubleOpenCustomHashMap.this.key[pos] != null) {
                    consumer.accept(new BasicEntry(Reference2DoubleOpenCustomHashMap.this.key[pos], Reference2DoubleOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2DoubleOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
