...
public class Reference2ReferenceOpenCustomHashMap<K, V> extends AbstractReference2ReferenceMap<K, V> implements Serializable, Cloneable, Hash {
    ...
    public Reference2ReferenceOpenCustomHashMap(final int expected, final float f, final Strategy<K> strategy) {
    ...
    public Reference2ReferenceOpenCustomHashMap(final int expected, final Strategy<K> strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Reference2ReferenceOpenCustomHashMap(final Strategy<K> strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Reference2ReferenceOpenCustomHashMap(final Map<? extends K, ? extends V> m, final float f, final Strategy<K> strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Reference2ReferenceOpenCustomHashMap(final Map<? extends K, ? extends V> m, final Strategy<K> strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Reference2ReferenceOpenCustomHashMap(final Reference2ReferenceMap<K, V> m, final float f, final Strategy<K> strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Reference2ReferenceOpenCustomHashMap(final Reference2ReferenceMap<K, V> m, final Strategy<K> strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Reference2ReferenceOpenCustomHashMap(final K[] k, final V[] v, final float f, final Strategy<K> strategy) {
    ...
    public Reference2ReferenceOpenCustomHashMap(final K[] k, final V[] v, final Strategy<K> strategy) {
    ...
    final class MapEntry implements Reference2ReferenceMap.Entry<K, V>, Map.Entry<K, V> {
        ...
        public V setValue(final V v) {
            final V oldValue = Reference2ReferenceOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Reference2ReferenceOpenCustomHashMap.this.strategy.equals(Reference2ReferenceOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Reference2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Reference2ReferenceOpenCustomHashMap.this.key[this.index]).append("=>").append(Reference2ReferenceOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            K k;
            int p;
            for (k = this.wrapped.get(-this.pos - 1), p = (HashCommon.mix(Reference2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ReferenceOpenCustomHashMap.this.mask); !Reference2ReferenceOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Reference2ReferenceOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Reference2ReferenceOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Reference2ReferenceOpenCustomHashMap.this.strategy.hashCode(curr)) & Reference2ReferenceOpenCustomHashMap.this.mask;
                    Label_0122: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0122;
        ...
        public void remove() {
            ...
            final Reference2ReferenceOpenCustomHashMap this$0 = Reference2ReferenceOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceMap.FastEntrySet<K, V> {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            K curr;
            if ((curr = key[pos = (HashCommon.mix(Reference2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ReferenceOpenCustomHashMap.this.mask)]) == null) {
                return false;
            }
        ...
        public void forEach(final Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
            if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Reference2ReferenceOpenCustomHashMap.this.key[Reference2ReferenceOpenCustomHashMap.this.n], Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.n]));
            }
            int pos = Reference2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2ReferenceOpenCustomHashMap.this.key[pos] != null) {
                    consumer.accept(new BasicEntry(Reference2ReferenceOpenCustomHashMap.this.key[pos], Reference2ReferenceOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2ReferenceOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2ReferenceOpenCustomHashMap.this.size;
