...
public class Object2ReferenceLinkedOpenCustomHashMap<K, V> extends AbstractObject2ReferenceSortedMap<K, V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Object2ReferenceMap.Entry<K, V>, Map.Entry<K, V> {
        ...
        public V setValue(final V v) {
            final V oldValue = Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Object2ReferenceLinkedOpenCustomHashMap.this.key[this.index]).append("=>").append(Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final K from) {
            ...
            if (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(from, null)) {
                ...
                for (int pos = HashCommon.mix(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2ReferenceLinkedOpenCustomHashMap.this.mask; Object2ReferenceLinkedOpenCustomHashMap.this.key[pos] != null; pos = (pos + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Object2ReferenceLinkedOpenCustomHashMap this$0 = Object2ReferenceLinkedOpenCustomHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Object2ReferenceLinkedOpenCustomHashMap.this.first = this.next;
            }
            else {
                final long[] link = Object2ReferenceLinkedOpenCustomHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Object2ReferenceLinkedOpenCustomHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Object2ReferenceLinkedOpenCustomHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Object2ReferenceLinkedOpenCustomHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Object2ReferenceLinkedOpenCustomHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0296:
            while (true) {
                pos = ((last = pos) + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(curr)) & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
                    Label_0408: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0408;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>> implements Object2ReferenceSortedMap.FastSortedEntrySet<K, V> {
        ...
        @Override
        public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(final Object2ReferenceMap.Entry<K, V> fromElement, final Object2ReferenceMap.Entry<K, V> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(final Object2ReferenceMap.Entry<K, V> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(final Object2ReferenceMap.Entry<K, V> fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            K curr;
            if ((curr = key[pos = (HashCommon.mix(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ReferenceLinkedOpenCustomHashMap.this.mask)]) == null) {
                return false;
            }
    ...
    private final class KeySet extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2ReferenceLinkedOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2ReferenceLinkedOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Object2ReferenceLinkedOpenCustomHashMap.this.size;
