...
public class Reference2BooleanLinkedOpenHashMap<K> extends AbstractReference2BooleanSortedMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Reference2BooleanMap.Entry<K>, Map.Entry<K, Boolean> {
        ...
        public boolean setValue(final boolean v) {
            final boolean oldValue = Reference2BooleanLinkedOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Reference2BooleanLinkedOpenHashMap.this.key[this.index]).append("=>").append(Reference2BooleanLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final K from) {
            ...
            if (from == null) {
                ...
                for (int pos = HashCommon.mix(System.identityHashCode(from)) & Reference2BooleanLinkedOpenHashMap.this.mask; Reference2BooleanLinkedOpenHashMap.this.key[pos] != null; pos = (pos + 1 & Reference2BooleanLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Reference2BooleanLinkedOpenHashMap this$0 = Reference2BooleanLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Reference2BooleanLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Reference2BooleanLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Reference2BooleanLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Reference2BooleanLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Reference2BooleanLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Reference2BooleanLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Reference2BooleanLinkedOpenHashMap.this.mask);
                K curr;
                while ((curr = key[pos]) != null) {
                    final int slot = HashCommon.mix(System.identityHashCode(curr)) & Reference2BooleanLinkedOpenHashMap.this.mask;
                    Label_0374: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0374;
        ...
        public void set(final Reference2BooleanMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
        
        public void add(final Reference2BooleanMap.Entry<K> ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Reference2BooleanMap.Entry<K>> implements Reference2BooleanSortedMap.FastSortedEntrySet<K> {
        ...
        @Override
        public ObjectSortedSet<Reference2BooleanMap.Entry<K>> subSet(final Reference2BooleanMap.Entry<K> fromElement, final Reference2BooleanMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2BooleanMap.Entry<K>> headSet(final Reference2BooleanMap.Entry<K> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Reference2BooleanMap.Entry<K>> tailSet(final Reference2BooleanMap.Entry<K> fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public void forEach(final Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Reference2BooleanLinkedOpenHashMap.this.key[curr], Reference2BooleanLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractReferenceSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2BooleanLinkedOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final Object k) {
            final int oldSize = Reference2BooleanLinkedOpenHashMap.this.size;
