...
public final class Reference2LongMaps {
    ...
    public static <K> ObjectIterator<Reference2LongMap.Entry<K>> fastIterator(final Reference2LongMap<K> map) {
    ...
    public static <K> void fastForEach(final Reference2LongMap<K> map, final Consumer<? super Reference2LongMap.Entry<K>> consumer) {
        final ObjectSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
    ...
    public static <K> ObjectIterable<Reference2LongMap.Entry<K>> fastIterable(final Reference2LongMap<K> map) {
        final ObjectSet<Reference2LongMap.Entry<K>> entries = map.reference2LongEntrySet();
    ...
    public static <K> Reference2LongMap<K> emptyMap() {
        return (Reference2LongMap<K>)Reference2LongMaps.EMPTY_MAP;
    }
    ...
    public static class Singleton<K> extends Reference2LongFunctions.Singleton<K> implements Reference2LongMap<K>, Serializable, Cloneable {
        ...
        public ObjectSet<Entry<K>> reference2LongEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.singleton(new AbstractReference2LongMap.BasicEntry<K>(this.key, this.value));
            }
            return this.entries;
        }
    ...
    public static class SynchronizedMap<K> extends Reference2LongFunctions.SynchronizedFunction<K> implements Reference2LongMap<K>, Serializable {
        ...
        public ObjectSet<Entry<K>> reference2LongEntrySet() {
            synchronized (this.sync) {
                if (this.entries == null) {
                    this.entries = ObjectSets.<Entry<K>>synchronize(this.map.reference2LongEntrySet(), this.sync);
                }
                return this.entries;
            }
        }
    ...
    public static class UnmodifiableMap<K> extends Reference2LongFunctions.UnmodifiableFunction<K> implements Reference2LongMap<K>, Serializable {
        ...
        public ObjectSet<Entry<K>> reference2LongEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.<Entry<K>>unmodifiable(this.map.reference2LongEntrySet());
            }
            return this.entries;
        }
