...
public class Reference2DoubleOpenHashMap<K> extends AbstractReference2DoubleMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Reference2DoubleMap.Entry<K>, Map.Entry<K, Double> {
        ...
        public String toString() {
            return new StringBuilder().append(Reference2DoubleOpenHashMap.this.key[this.index]).append("=>").append(Reference2DoubleOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry<K>> implements Reference2DoubleMap.FastEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
            if (Reference2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Reference2DoubleOpenHashMap.this.key[Reference2DoubleOpenHashMap.this.n], Reference2DoubleOpenHashMap.this.value[Reference2DoubleOpenHashMap.this.n]));
            }
            int pos = Reference2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Reference2DoubleOpenHashMap.this.key[pos] != null) {
    ...
    private final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Reference2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Reference2DoubleOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
