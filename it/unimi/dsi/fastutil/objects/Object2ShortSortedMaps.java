...
public final class Object2ShortSortedMaps {
    ...
    public static <K> ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator(final Object2ShortSortedMap<K> map) {
    ...
    public static <K> ObjectBidirectionalIterable<Object2ShortMap.Entry<K>> fastIterable(final Object2ShortSortedMap<K> map) {
        final ObjectSortedSet<Object2ShortMap.Entry<K>> entries = map.object2ShortEntrySet();
        ObjectBidirectionalIterable<Object2ShortMap.Entry<K>> objectBidirectionalIterable;
        if (entries instanceof Object2ShortSortedMap.FastSortedEntrySet) {
            final Object2ShortSortedMap.FastSortedEntrySet set = (Object2ShortSortedMap.FastSortedEntrySet)entries;
    ...
    public static <K> Object2ShortSortedMap<K> emptyMap() {
        return (Object2ShortSortedMap<K>)Object2ShortSortedMaps.EMPTY_MAP;
    }
    ...
    public static <K> Object2ShortSortedMap<K> singleton(final K key, final Short value, final Comparator<? super K> comparator) {
    ...
    public static class EmptySortedMap<K> extends Object2ShortMaps.EmptyMap<K> implements Object2ShortSortedMap<K>, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
            return (ObjectSortedSet<Object2ShortMap.Entry<K>>)ObjectSortedSets.EMPTY_SET;
        }
    ...
    public static class Singleton<K> extends Object2ShortMaps.Singleton<K> implements Object2ShortSortedMap<K>, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractObject2ShortMap.BasicEntry<K>(this.key, this.value), (java.util.Comparator<? super AbstractObject2ShortMap.BasicEntry<K>>)Object2ShortSortedMaps.entryComparator((java.util.Comparator<? super Object>)this.comparator));
            }
            return (ObjectSortedSet<Object2ShortMap.Entry<K>>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class SynchronizedSortedMap<K> extends Object2ShortMaps.SynchronizedMap<K> implements Object2ShortSortedMap<K>, Serializable {
        ...
        public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Object2ShortMap.Entry<K>>synchronize(this.sortedMap.object2ShortEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Object2ShortMap.Entry<K>>)(ObjectSortedSet)this.entries;
        }
        ...
        @Override
        public Object2ShortSortedMap<K> subMap(final K from, final K to) {
            return new SynchronizedSortedMap((Object2ShortSortedMap<Object>)this.sortedMap.subMap(from, to), this.sync);
        }
        
        @Override
        public Object2ShortSortedMap<K> headMap(final K to) {
            return new SynchronizedSortedMap((Object2ShortSortedMap<Object>)this.sortedMap.headMap(to), this.sync);
        }
        
        @Override
        public Object2ShortSortedMap<K> tailMap(final K from) {
            return new SynchronizedSortedMap((Object2ShortSortedMap<Object>)this.sortedMap.tailMap(from), this.sync);
        }
    ...
    public static class UnmodifiableSortedMap<K> extends Object2ShortMaps.UnmodifiableMap<K> implements Object2ShortSortedMap<K>, Serializable {
        ...
        public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Object2ShortMap.Entry<K>>unmodifiable(this.sortedMap.object2ShortEntrySet());
            }
            return (ObjectSortedSet<Object2ShortMap.Entry<K>>)(ObjectSortedSet)this.entries;
        }
        ...
        @Override
        public Object2ShortSortedMap<K> subMap(final K from, final K to) {
            return new UnmodifiableSortedMap((Object2ShortSortedMap<Object>)this.sortedMap.subMap(from, to));
        }
        
        @Override
        public Object2ShortSortedMap<K> headMap(final K to) {
            return new UnmodifiableSortedMap((Object2ShortSortedMap<Object>)this.sortedMap.headMap(to));
        }
        
        @Override
        public Object2ShortSortedMap<K> tailMap(final K from) {
            return new UnmodifiableSortedMap((Object2ShortSortedMap<Object>)this.sortedMap.tailMap(from));
        }
