        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() {
                ...
                public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(final Object2BooleanMap.Entry<K> from, final Object2BooleanMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2BooleanMap.Entry<K>>)Object2BooleanRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2BooleanEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(final Object2BooleanMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2BooleanMap.Entry<K>>)Object2BooleanRBTreeMap.this.headMap(to.getKey()).object2BooleanEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(final Object2BooleanMap.Entry<K> from) {
                    return (ObjectSortedSet<Object2BooleanMap.Entry<K>>)Object2BooleanRBTreeMap.this.tailMap(from.getKey()).object2BooleanEntrySet();
                }
            };
        }
        return this.entries;
