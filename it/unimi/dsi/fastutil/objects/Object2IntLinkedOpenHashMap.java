...
public class Object2IntLinkedOpenHashMap<K> extends AbstractObject2IntSortedMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Object2IntMap.Entry<K>, Map.Entry<K, Integer> {
        ...
        public boolean equals(final Object o) {
            ...
            return Objects.equals(Object2IntLinkedOpenHashMap.this.key[this.index], e.getKey()) && Object2IntLinkedOpenHashMap.this.value[this.index] == (int)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Object2IntLinkedOpenHashMap.this.key[this.index]).append("=>").append(Object2IntLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Object2IntMap.Entry<K>> implements Object2IntSortedMap.FastSortedEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Object2IntMap.Entry<K>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Object2IntLinkedOpenHashMap.this.key[curr], Object2IntLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractObjectSortedSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2IntLinkedOpenHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
