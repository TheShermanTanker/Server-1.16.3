...
public final class Object2IntSortedMaps {
    ...
    public static class Singleton<K> extends Object2IntMaps.Singleton<K> implements Object2IntSortedMap<K>, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractObject2IntMap.BasicEntry<K>(this.key, this.value), (java.util.Comparator<? super AbstractObject2IntMap.BasicEntry<K>>)Object2IntSortedMaps.entryComparator((java.util.Comparator<? super Object>)this.comparator));
            }
    ...
    public static class SynchronizedSortedMap<K> extends Object2IntMaps.SynchronizedMap<K> implements Object2IntSortedMap<K>, Serializable {
        ...
        public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Object2IntMap.Entry<K>>synchronize(this.sortedMap.object2IntEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Object2IntMap.Entry<K>>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class UnmodifiableSortedMap<K> extends Object2IntMaps.UnmodifiableMap<K> implements Object2IntSortedMap<K>, Serializable {
        ...
        public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Object2IntMap.Entry<K>>unmodifiable(this.sortedMap.object2IntEntrySet());
            }
            return (ObjectSortedSet<Object2IntMap.Entry<K>>)(ObjectSortedSet)this.entries;
        }
