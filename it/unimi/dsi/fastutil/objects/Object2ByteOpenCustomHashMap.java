...
public class Object2ByteOpenCustomHashMap<K> extends AbstractObject2ByteMap<K> implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractByteCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n]);
                    }
                    int pos = Object2ByteOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Object2ByteOpenCustomHashMap.this.key[pos] != null) {
                            consumer.accept((int)Object2ByteOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Object2ByteMap.Entry<K>, Map.Entry<K, Byte> {
        ...
        public boolean equals(final Object o) {
            ...
            return Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[this.index], (K)e.getKey()) && Object2ByteOpenCustomHashMap.this.value[this.index] == (byte)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Object2ByteOpenCustomHashMap.this.key[this.index]).append("=>").append((int)Object2ByteOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Object2ByteMap.Entry<K>> implements Object2ByteMap.FastEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Object2ByteMap.Entry<K>> consumer) {
            if (Object2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Object2ByteOpenCustomHashMap.this.key[Object2ByteOpenCustomHashMap.this.n], Object2ByteOpenCustomHashMap.this.value[Object2ByteOpenCustomHashMap.this.n]));
            }
            int pos = Object2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Object2ByteOpenCustomHashMap.this.key[pos] != null) {
                    consumer.accept(new BasicEntry(Object2ByteOpenCustomHashMap.this.key[pos], Object2ByteOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractObjectSet<K> {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            int pos = Object2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final K k = Object2ByteOpenCustomHashMap.this.key[pos];
                if (k != null) {
                    consumer.accept(k);
                }
            }
