...
public class Object2IntOpenHashMap<K> extends AbstractObject2IntMap<K> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Object2IntMap.Entry<K>, Map.Entry<K, Integer> {
        ...
        public boolean equals(final Object o) {
            ...
            return Objects.equals(Object2IntOpenHashMap.this.key[this.index], e.getKey()) && Object2IntOpenHashMap.this.value[this.index] == (int)e.getValue();
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry<K>> implements Object2IntMap.FastEntrySet<K> {
        ...
        public void forEach(final Consumer<? super Object2IntMap.Entry<K>> consumer) {
            if (Object2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Object2IntOpenHashMap.this.key[Object2IntOpenHashMap.this.n], Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.n]));
            }
            int pos = Object2IntOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Object2IntOpenHashMap.this.key[pos] != null) {
                    consumer.accept(new BasicEntry(Object2IntOpenHashMap.this.key[pos], Object2IntOpenHashMap.this.value[pos]));
                }
            }
        }
