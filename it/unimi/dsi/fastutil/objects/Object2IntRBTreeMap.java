...
public class Object2IntRBTreeMap<K> extends AbstractObject2IntSortedMap<K> implements Serializable, Cloneable {
    ...
    public Object2IntRBTreeMap(final SortedMap<K, Integer> m) {
        this(m.comparator());
        this.putAll((java.util.Map<? extends K, ? extends Integer>)m);
    }
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<K> f = (Entry<K>)Object2IntRBTreeMap.this.findKey(e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(final Object2IntMap.Entry<K> from, final Object2IntMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2IntMap.Entry<K>>)Object2IntRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2IntEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(final Object2IntMap.Entry<K> to) {
                    return (ObjectSortedSet<Object2IntMap.Entry<K>>)Object2IntRBTreeMap.this.headMap(to.getKey()).object2IntEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(final Object2IntMap.Entry<K> from) {
                    return (ObjectSortedSet<Object2IntMap.Entry<K>>)Object2IntRBTreeMap.this.tailMap(from.getKey()).object2IntEntrySet();
                }
            };
        }
        return this.entries;
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection() {
                ...
                public boolean contains(final int k) {
                    ...
                    // Original Bytecode:
                    // 
                    //     1: getfield        it/unimi/dsi/fastutil/objects/Object2IntRBTreeMap$2.this$0:Lit/unimi/dsi/fastutil/objects/Object2IntRBTreeMap;
                    //     4: iload_1         /* k */
                    //     5: invokevirtual   it/unimi/dsi/fastutil/objects/Object2IntRBTreeMap.containsValue:(I)Z
                    //     8: ireturn        
                    //    MethodParameters:
                    //  Name  Flags  
                    //  ----  -----
    ...
    private static final class Entry<K> extends BasicEntry<K> implements Cloneable {
        ...
        public boolean equals(final Object o) {
            ...
            return Objects.equals(this.key, e.getKey()) && this.value == (int)e.getValue();
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final K k) {
            this.index = 0;
            final Entry<K> locateKey = Object2IntRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractObject2IntSortedMap<K> implements Serializable {
        ...
        protected transient ObjectSortedSet<K> keys;
        protected transient IntCollection values;
        final /* synthetic */ Object2IntRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Object2IntRBTreeMap.Entry<K> f = (Object2IntRBTreeMap.Entry<K>)Object2IntRBTreeMap.this.findKey(e.getKey());
                    ...
                    @Override
                    public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(final Object2IntMap.Entry<K> from, final Object2IntMap.Entry<K> to) {
                        return (ObjectSortedSet<Object2IntMap.Entry<K>>)Submap.this.subMap(from.getKey(), to.getKey()).object2IntEntrySet();
                    }
                    
                    @Override
                    public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(final Object2IntMap.Entry<K> to) {
                        return (ObjectSortedSet<Object2IntMap.Entry<K>>)Submap.this.headMap(to.getKey()).object2IntEntrySet();
                    }
                    
                    @Override
                    public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(final Object2IntMap.Entry<K> from) {
                        return (ObjectSortedSet<Object2IntMap.Entry<K>>)Submap.this.tailMap(from.getKey()).object2IntEntrySet();
                    }
                };
            }
            return this.entries;
        ...
        public K firstKey() {
            final Object2IntRBTreeMap.Entry<K> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public K lastKey() {
            final Object2IntRBTreeMap.Entry<K> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final K k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Object2IntRBTreeMap this$0 = submap.this$0;
                            final Object2IntRBTreeMap.Entry<K> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
