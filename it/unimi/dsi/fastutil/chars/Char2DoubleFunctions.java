...
public final class Char2DoubleFunctions {
    ...
    public static Char2DoubleFunction singleton(final char key, final double value) {
    ...
    public static Char2DoubleFunction primitive(final Function<? super Character, ? extends Double> f) {
    ...
    public static class PrimitiveFunction implements Char2DoubleFunction {
        ...
        protected PrimitiveFunction(final java.util.function.Function<? super Character, ? extends Double> function) {
