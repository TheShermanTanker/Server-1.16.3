...
public class CharLinkedOpenCustomHashSet extends AbstractCharSortedSet implements Serializable, Cloneable, Hash {
    ...
    public CharLinkedOpenCustomHashSet(final int expected, final float f, final CharHash.Strategy strategy) {
        this.first = -1;
        this.last = -1;
    ...
    public CharLinkedOpenCustomHashSet(final int expected, final CharHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public CharLinkedOpenCustomHashSet(final CharHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public CharLinkedOpenCustomHashSet(final Collection<? extends Character> c, final float f, final CharHash.Strategy strategy) {
        this(c.size(), f, strategy);
        this.addAll(c);
    }
    
    public CharLinkedOpenCustomHashSet(final Collection<? extends Character> c, final CharHash.Strategy strategy) {
        this(c, 0.75f, strategy);
    }
    
    public CharLinkedOpenCustomHashSet(final CharCollection c, final float f, final CharHash.Strategy strategy) {
        this(c.size(), f, strategy);
        this.addAll(c);
    }
    
    public CharLinkedOpenCustomHashSet(final CharCollection c, final CharHash.Strategy strategy) {
        this(c, 0.75f, strategy);
    }
    
    public CharLinkedOpenCustomHashSet(final CharIterator i, final float f, final CharHash.Strategy strategy) {
        this(16, f, strategy);
        while (i.hasNext()) {
            this.add(i.nextChar());
        }
    ...
    public CharLinkedOpenCustomHashSet(final CharIterator i, final CharHash.Strategy strategy) {
        this(i, 0.75f, strategy);
    }
    
    public CharLinkedOpenCustomHashSet(final Iterator<?> i, final float f, final CharHash.Strategy strategy) {
        this(CharIterators.asCharIterator(i), f, strategy);
    }
    
    public CharLinkedOpenCustomHashSet(final Iterator<?> i, final CharHash.Strategy strategy) {
        this(CharIterators.asCharIterator(i), strategy);
    }
    
    public CharLinkedOpenCustomHashSet(final char[] a, final int offset, final int length, final float f, final CharHash.Strategy strategy) {
    ...
    public CharLinkedOpenCustomHashSet(final char[] a, final int offset, final int length, final CharHash.Strategy strategy) {
        this(a, offset, length, 0.75f, strategy);
    }
    
    public CharLinkedOpenCustomHashSet(final char[] a, final float f, final CharHash.Strategy strategy) {
        this(a, 0, a.length, f, strategy);
    }
    
    public CharLinkedOpenCustomHashSet(final char[] a, final CharHash.Strategy strategy) {
    ...
    private class SetIterator implements CharListIterator {
        ...
        SetIterator(final char from) {
            ...
            if (CharLinkedOpenCustomHashSet.this.strategy.equals(from, '\0')) {
                ...
                for (int pos = HashCommon.mix(CharLinkedOpenCustomHashSet.this.strategy.hashCode(from)) & CharLinkedOpenCustomHashSet.this.mask; key[pos] != '\0'; pos = (pos + 1 & CharLinkedOpenCustomHashSet.this.mask)) {
        ...
        public void remove() {
            ...
            final CharLinkedOpenCustomHashSet this$0 = CharLinkedOpenCustomHashSet.this;
            --this$0.size;
            if (this.prev == -1) {
                CharLinkedOpenCustomHashSet.this.first = this.next;
            }
            else {
                final long[] link = CharLinkedOpenCustomHashSet.this.link;
                final int prev = this.prev;
                link[prev] ^= ((CharLinkedOpenCustomHashSet.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                CharLinkedOpenCustomHashSet.this.last = this.prev;
            }
            else {
                final long[] link2 = CharLinkedOpenCustomHashSet.this.link;
                final int next = this.next;
                link2[next] ^= ((CharLinkedOpenCustomHashSet.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & CharLinkedOpenCustomHashSet.this.mask);
                char curr;
                while ((curr = key[pos]) != '\0') {
                    final int slot = HashCommon.mix(CharLinkedOpenCustomHashSet.this.strategy.hashCode(curr)) & CharLinkedOpenCustomHashSet.this.mask;
                    Label_0382: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0382;
