...
public class Char2IntLinkedOpenHashMap extends AbstractChar2IntSortedMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Char2IntMap.Entry, Map.Entry<Character, Integer> {
        ...
        public int setValue(final int v) {
            final int oldValue = Char2IntLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Char2IntLinkedOpenHashMap.this.key[this.index] == (char)e.getKey() && Char2IntLinkedOpenHashMap.this.value[this.index] == (int)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Char2IntLinkedOpenHashMap.this.key[this.index]).append("=>").append(Char2IntLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final char from) {
            ...
            if (from == '\0') {
                ...
                for (int pos = HashCommon.mix(from) & Char2IntLinkedOpenHashMap.this.mask; Char2IntLinkedOpenHashMap.this.key[pos] != '\0'; pos = (pos + 1 & Char2IntLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Char2IntLinkedOpenHashMap this$0 = Char2IntLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Char2IntLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Char2IntLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Char2IntLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Char2IntLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Char2IntLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Char2IntLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Char2IntLinkedOpenHashMap.this.mask);
                char curr;
                while ((curr = key[pos]) != '\0') {
                    final int slot = HashCommon.mix(curr) & Char2IntLinkedOpenHashMap.this.mask;
                    Label_0354: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0354;
        ...
        public void set(final Char2IntMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
        
        public void add(final Char2IntMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Char2IntMap.Entry> implements Char2IntSortedMap.FastSortedEntrySet {
        ...
        @Override
        public ObjectSortedSet<Char2IntMap.Entry> subSet(final Char2IntMap.Entry fromElement, final Char2IntMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Char2IntMap.Entry> headSet(final Char2IntMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Char2IntMap.Entry> tailSet(final Char2IntMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractCharSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Char2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Char2IntLinkedOpenHashMap.this.key[Char2IntLinkedOpenHashMap.this.n]);
            }
            int pos = Char2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final char k = Char2IntLinkedOpenHashMap.this.key[pos];
                if (k != '\0') {
        ...
        public boolean remove(final char k) {
            final int oldSize = Char2IntLinkedOpenHashMap.this.size;
