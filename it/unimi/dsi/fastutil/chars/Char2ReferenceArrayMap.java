    ...
    public CharSet keySet() {
        return new AbstractCharSet() {
            ...
            public boolean remove(final char k) {
                ...
                final int tail = Char2ReferenceArrayMap.this.size - oldPos - 1;
            ...
            public CharIterator iterator() {
                return new CharIterator() {
                    ...
                    public void remove() {
                        ...
                        final int tail = Char2ReferenceArrayMap.this.size - this.pos;
        ...
        public ObjectIterator<Char2ReferenceMap.Entry<V>> iterator() {
            return new ObjectIterator<Char2ReferenceMap.Entry<V>>() {
                ...
                public Char2ReferenceMap.Entry<V> next() {
                    ...
                    final char[] access$100 = Char2ReferenceArrayMap.this.key;
                    final int next = this.next;
                    this.curr = next;
                    return new BasicEntry<V>(access$100[next], Char2ReferenceArrayMap.this.value[this.next++]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    final int tail = Char2ReferenceArrayMap.this.size-- - this.next--;
