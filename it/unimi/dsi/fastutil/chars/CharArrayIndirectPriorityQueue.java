...
public class CharArrayIndirectPriorityQueue implements CharIndirectPriorityQueue {
    ...
    public CharArrayIndirectPriorityQueue(final char[] refArray, final int capacity, final CharComparator c) {
    ...
    public CharArrayIndirectPriorityQueue(final char[] refArray, final int capacity) {
        this(refArray, capacity, null);
    }
    
    public CharArrayIndirectPriorityQueue(final char[] refArray, final CharComparator c) {
        this(refArray, refArray.length, c);
    }
    
    public CharArrayIndirectPriorityQueue(final char[] refArray) {
        this(refArray, refArray.length, null);
    }
    
    public CharArrayIndirectPriorityQueue(final char[] refArray, final int[] a, final int size, final CharComparator c) {
        this(refArray, 0, c);
        this.array = a;
        this.size = size;
    }
    ...
    public CharArrayIndirectPriorityQueue(final char[] refArray, final int[] a, final int size) {
    ...
    public int front(final int[] a) {
        final char top = this.refArray[this.array[this.findFirst()]];
        int i = this.size;
        int c = 0;
        while (i-- != 0) {
