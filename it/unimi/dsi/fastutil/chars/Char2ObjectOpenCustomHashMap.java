...
public class Char2ObjectOpenCustomHashMap<V> extends AbstractChar2ObjectMap<V> implements Serializable, Cloneable, Hash {
    ...
    public Char2ObjectOpenCustomHashMap(final int expected, final float f, final CharHash.Strategy strategy) {
    ...
    public Char2ObjectOpenCustomHashMap(final int expected, final CharHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Char2ObjectOpenCustomHashMap(final CharHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Char2ObjectOpenCustomHashMap(final Map<? extends Character, ? extends V> m, final float f, final CharHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Char2ObjectOpenCustomHashMap(final Map<? extends Character, ? extends V> m, final CharHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Char2ObjectOpenCustomHashMap(final Char2ObjectMap<V> m, final float f, final CharHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Char2ObjectOpenCustomHashMap(final Char2ObjectMap<V> m, final CharHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Char2ObjectOpenCustomHashMap(final char[] k, final V[] v, final float f, final CharHash.Strategy strategy) {
    ...
    public Char2ObjectOpenCustomHashMap(final char[] k, final V[] v, final CharHash.Strategy strategy) {
    ...
    final class MapEntry implements Char2ObjectMap.Entry<V>, Map.Entry<Character, V> {
        ...
        public V setValue(final V v) {
            final V oldValue = Char2ObjectOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Char2ObjectOpenCustomHashMap.this.strategy.equals(Char2ObjectOpenCustomHashMap.this.key[this.index], (char)e.getKey()) && Objects.equals(Char2ObjectOpenCustomHashMap.this.value[this.index], e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Char2ObjectOpenCustomHashMap.this.key[this.index]).append("=>").append(Char2ObjectOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            char k;
            int p;
            for (k = this.wrapped.getChar(-this.pos - 1), p = (HashCommon.mix(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ObjectOpenCustomHashMap.this.mask); !Char2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Char2ObjectOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Char2ObjectOpenCustomHashMap.this.mask);
                char curr;
                while ((curr = key[pos]) != '\0') {
                    final int slot = HashCommon.mix(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(curr)) & Char2ObjectOpenCustomHashMap.this.mask;
                    Label_0121: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0121;
        ...
        public void remove() {
            ...
            final Char2ObjectOpenCustomHashMap this$0 = Char2ObjectOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>> implements Char2ObjectMap.FastEntrySet<V> {
        ...
        public void forEach(final Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
            if (Char2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Char2ObjectOpenCustomHashMap.this.key[Char2ObjectOpenCustomHashMap.this.n], Char2ObjectOpenCustomHashMap.this.value[Char2ObjectOpenCustomHashMap.this.n]));
            }
            int pos = Char2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ObjectOpenCustomHashMap.this.key[pos] != '\0') {
                    consumer.accept(new BasicEntry(Char2ObjectOpenCustomHashMap.this.key[pos], Char2ObjectOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractCharSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Char2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Char2ObjectOpenCustomHashMap.this.key[Char2ObjectOpenCustomHashMap.this.n]);
            }
            int pos = Char2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final char k = Char2ObjectOpenCustomHashMap.this.key[pos];
                if (k != '\0') {
        ...
        public boolean remove(final char k) {
            final int oldSize = Char2ObjectOpenCustomHashMap.this.size;
