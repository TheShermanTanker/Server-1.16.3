...
public class Char2CharOpenCustomHashMap extends AbstractChar2CharMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractCharCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Char2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.n]);
                    }
                    int pos = Char2CharOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Char2CharOpenCustomHashMap.this.key[pos] != '\0') {
                            consumer.accept((int)Char2CharOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Char2CharMap.Entry, Map.Entry<Character, Character> {
        ...
        public boolean equals(final Object o) {
            ...
            return Char2CharOpenCustomHashMap.this.strategy.equals(Char2CharOpenCustomHashMap.this.key[this.index], (char)e.getKey()) && Char2CharOpenCustomHashMap.this.value[this.index] == (char)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Char2CharOpenCustomHashMap.this.key[this.index]).append("=>").append(Char2CharOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Char2CharMap.Entry> implements Char2CharMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Char2CharMap.Entry> consumer) {
            if (Char2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Char2CharOpenCustomHashMap.this.key[Char2CharOpenCustomHashMap.this.n], Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.n]));
            }
            int pos = Char2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2CharOpenCustomHashMap.this.key[pos] != '\0') {
    ...
    private final class KeySet extends AbstractCharSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Char2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Char2CharOpenCustomHashMap.this.key[Char2CharOpenCustomHashMap.this.n]);
            }
            int pos = Char2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final char k = Char2CharOpenCustomHashMap.this.key[pos];
                if (k != '\0') {
