...
public final class Char2ReferenceFunctions {
    ...
    public static <V> Char2ReferenceFunction<V> primitive(final Function<? super Character, ? extends V> f) {
        Objects.requireNonNull(f);
        if (f instanceof Char2ReferenceFunction) {
            return (Char2ReferenceFunction<V>)(Char2ReferenceFunction)f;
        }
        if (f instanceof IntFunction) {
            final IntFunction intFunction = (IntFunction)f;
            Objects.requireNonNull(intFunction);
            return (Char2ReferenceFunction<V>)intFunction::apply;
        }
