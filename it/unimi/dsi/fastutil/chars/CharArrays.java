...
public final class CharArrays {
    ...
    public static final Hash.Strategy<char[]> HASH_STRATEGY;
    ...
    public static char[] trim(final char[] array, final int length) {
        ...
        final char[] t = (length == 0) ? CharArrays.EMPTY_ARRAY : new char[length];
    ...
    public static char[] copy(final char[] array, final int offset, final int length) {
        ...
        final char[] a = (length == 0) ? CharArrays.EMPTY_ARRAY : new char[length];
    ...
    private static int med3(final char[] x, final int a, final int b, final int c, final CharComparator comp) {
    ...
    public static void mergeSort(final char[] a, final int from, final int to, final CharComparator comp, final char[] supp) {
        final int len = to - from;
        if (len < 16) {
    ...
    public static void mergeSort(final char[] a, final int from, final int to, final CharComparator comp) {
        mergeSort(a, from, to, comp, a.clone());
    }
    
    public static void mergeSort(final char[] a, final CharComparator comp) {
    ...
    public static void radixSort(final char[] a, final int from, final int to) {
        ...
        while (stackPos > 0) {
            ...
            while (i-- != first) {
                ...
                final int n = (a[i] >>> shift & 0xFF) ^ 0x0;
                ++array[n];
            }
            int lastUsed = -1;
            int j = 0;
            ...
            executorCompletionService.submit(() -> {
                ...
                while (true) {
                    if (queueSize.get() == 0) {
                        ...
                        while (i-- != 0) {
                            queue.add(CharArrays.POISON_PILL);
                        }
                    }
                    final Segment segment = (Segment)queue.take();
                    if (segment == CharArrays.POISON_PILL) {
                        break;
                    }
                    ...
                    while (j-- != first) {
                        final int[] array = count;
                        final int n = (a[j] >>> shift & 0xFF) ^ 0x0;
                        ++array[n];
                    }
                    int lastUsed = -1;
                    int k = 0;
    ...
    public static void radixSortIndirect(final int[] perm, final char[] a, final int from, final int to, final boolean stable) {
        ...
        while (stackPos > 0) {
            ...
            while (i-- != first) {
                final int[] array = count;
                final int n = (a[perm[i]] >>> shift & 0xFF) ^ 0x0;
                ++array[n];
            }
            int lastUsed = -1;
            int j = 0;
            ...
            if (stable) {
                ...
                while (j-- != first) {
                    ...
                    final int n2 = (a[perm[j]] >>> shift & 0xFF) ^ 0x0;
        ...
        while (j-- != 0) {
            executorCompletionService.submit(() -> {
                ...
                while (true) {
                    ...
                    while (j-- != first) {
                        final int[] array = count;
                        final int n = (a[perm[j]] >>> shift & 0xFF) ^ 0x0;
                        ++array[n];
                    }
                    int lastUsed = -1;
                    int k = 0;
                    ...
                    if (stable) {
                        ...
                        while (k-- != first) {
                            final int[] array2 = pos;
                            final int n2 = (a[perm[k]] >>> shift & 0xFF) ^ 0x0;
    ...
    public static void radixSort(final char[] a, final char[] b, final int from, final int to) {
        ...
        while (stackPos > 0) {
            ...
            while (i-- != first) {
                final int[] array = count;
                final int n = (k[i] >>> shift & 0xFF) ^ 0x0;
                ++array[n];
            }
            int lastUsed = -1;
            int j = 0;
    ...
    public static void radixSortIndirect(final int[] perm, final char[] a, final char[] b, final int from, final int to, final boolean stable) {
        ...
        while (stackPos > 0) {
            ...
            while (i-- != first) {
                final int[] array = count;
                final int n = (k[perm[i]] >>> shift & 0xFF) ^ 0x0;
                ++array[n];
            }
            int lastUsed = -1;
            int j = 0;
            ...
            if (stable) {
                ...
                while (j-- != first) {
                    final int[] array2 = support;
                    final int[] array3 = pos;
                    final int n2 = (k[perm[j]] >>> shift & 0xFF) ^ 0x0;
                    array2[--array3[n2]] = perm[j];
                }
                System.arraycopy(support, 0, perm, first, length);
                j = 0;
    ...
    static {
        ...
        DEFAULT_EMPTY_ARRAY = new char[0];
