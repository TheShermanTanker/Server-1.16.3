...
public class Char2LongAVLTreeMap extends AbstractChar2LongSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2LongMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Char2LongAVLTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Char2LongMap.Entry> subSet(final Char2LongMap.Entry from, final Char2LongMap.Entry to) {
                    return Char2LongAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Char2LongMap.Entry> headSet(final Char2LongMap.Entry to) {
                    return Char2LongAVLTreeMap.this.headMap(to.getCharKey()).char2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Char2LongMap.Entry> tailSet(final Char2LongMap.Entry from) {
    ...
    private static final class Entry extends BasicEntry implements Cloneable {
        ...
        public boolean equals(final Object o) {
            ...
            return this.key == (char)e.getKey() && this.value == (long)e.getValue();
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry locateKey = Char2LongAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2LongSortedMap implements Serializable {
        ...
        protected transient CharSortedSet keys;
        protected transient LongCollection values;
        final /* synthetic */ Char2LongAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2LongMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2LongAVLTreeMap.Entry f = Char2LongAVLTreeMap.this.findKey((char)e.getKey());
        ...
        public char firstCharKey() {
            final Char2LongAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public char lastCharKey() {
            final Char2LongAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2LongAVLTreeMap this$0 = submap.this$0;
                            final Char2LongAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
