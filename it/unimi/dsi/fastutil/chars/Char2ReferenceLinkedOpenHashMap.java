...
public class Char2ReferenceLinkedOpenHashMap<V> extends AbstractChar2ReferenceSortedMap<V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Char2ReferenceMap.Entry<V>, Map.Entry<Character, V> {
        ...
        public V setValue(final V v) {
            final V oldValue = Char2ReferenceLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Char2ReferenceLinkedOpenHashMap.this.key[this.index] == (char)e.getKey() && Char2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Char2ReferenceLinkedOpenHashMap.this.key[this.index]).append("=>").append(Char2ReferenceLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final char from) {
            ...
            if (from == '\0') {
                ...
                for (int pos = HashCommon.mix(from) & Char2ReferenceLinkedOpenHashMap.this.mask; Char2ReferenceLinkedOpenHashMap.this.key[pos] != '\0'; pos = (pos + 1 & Char2ReferenceLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Char2ReferenceLinkedOpenHashMap this$0 = Char2ReferenceLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Char2ReferenceLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Char2ReferenceLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Char2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Char2ReferenceLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Char2ReferenceLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Char2ReferenceLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Char2ReferenceLinkedOpenHashMap.this.mask);
                char curr;
                while ((curr = key[pos]) != '\0') {
                    final int slot = HashCommon.mix(curr) & Char2ReferenceLinkedOpenHashMap.this.mask;
                    Label_0380: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0380;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Char2ReferenceMap.Entry<V>> implements Char2ReferenceSortedMap.FastSortedEntrySet<V> {
        ...
        @Override
        public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(final Char2ReferenceMap.Entry<V> fromElement, final Char2ReferenceMap.Entry<V> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(final Char2ReferenceMap.Entry<V> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(final Char2ReferenceMap.Entry<V> fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public void forEach(final Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Char2ReferenceLinkedOpenHashMap.this.key[curr], Char2ReferenceLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractCharSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Char2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Char2ReferenceLinkedOpenHashMap.this.key[Char2ReferenceLinkedOpenHashMap.this.n]);
            }
            int pos = Char2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final char k = Char2ReferenceLinkedOpenHashMap.this.key[pos];
                if (k != '\0') {
        ...
        public boolean remove(final char k) {
            final int oldSize = Char2ReferenceLinkedOpenHashMap.this.size;
