...
public class Char2IntOpenCustomHashMap extends AbstractChar2IntMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Char2IntMap.Entry, Map.Entry<Character, Integer> {
        ...
        public boolean equals(final Object o) {
            ...
            return Char2IntOpenCustomHashMap.this.strategy.equals(Char2IntOpenCustomHashMap.this.key[this.index], (char)e.getKey()) && Char2IntOpenCustomHashMap.this.value[this.index] == (int)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Char2IntOpenCustomHashMap.this.key[this.index]).append("=>").append(Char2IntOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Char2IntMap.Entry> implements Char2IntMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Char2IntMap.Entry> consumer) {
            if (Char2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Char2IntOpenCustomHashMap.this.key[Char2IntOpenCustomHashMap.this.n], Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.n]));
            }
            int pos = Char2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2IntOpenCustomHashMap.this.key[pos] != '\0') {
                    consumer.accept(new BasicEntry(Char2IntOpenCustomHashMap.this.key[pos], Char2IntOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractCharSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Char2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Char2IntOpenCustomHashMap.this.key[Char2IntOpenCustomHashMap.this.n]);
            }
            int pos = Char2IntOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final char k = Char2IntOpenCustomHashMap.this.key[pos];
                if (k != '\0') {
