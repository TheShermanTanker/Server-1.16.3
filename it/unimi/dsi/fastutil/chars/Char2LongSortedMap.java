...
public interface Char2LongSortedMap extends Char2LongMap, SortedMap<Character, Long> {
    Char2LongSortedMap subMap(final char character1, final char character2);
    
    Char2LongSortedMap headMap(final char character);
    
    Char2LongSortedMap tailMap(final char character);
