...
public class CharAVLTreeSet extends AbstractCharSortedSet implements Serializable, Cloneable, CharSortedSet {
    ...
    private class SetIterator implements CharListIterator {
        ...
        SetIterator(final char k) {
            this.index = 0;
            final Entry locateKey = CharAVLTreeSet.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Subset extends AbstractCharSortedSet implements Serializable, CharSortedSet {
        ...
        boolean bottom;
        boolean top;
        final /* synthetic */ CharAVLTreeSet this$0;
        ...
        public boolean remove(final char k) {
            return this.in(k) && CharAVLTreeSet.this.remove(k);
        }
        ...
        private final class SubsetIterator extends SetIterator {
            ...
            SubsetIterator(final Subset subset, final char k) {
                this(subset);
                if (this.next != null) {
                    if (!subset.bottom && subset.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!subset.top) {
                            final CharAVLTreeSet this$0 = subset.this$0;
