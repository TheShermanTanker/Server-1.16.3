...
public final class Char2ShortSortedMaps {
    ...
    public static ObjectBidirectionalIterator<Char2ShortMap.Entry> fastIterator(final Char2ShortSortedMap map) {
    ...
    public static ObjectBidirectionalIterable<Char2ShortMap.Entry> fastIterable(final Char2ShortSortedMap map) {
        final ObjectSortedSet<Char2ShortMap.Entry> entries = map.char2ShortEntrySet();
        ObjectBidirectionalIterable<Char2ShortMap.Entry> objectBidirectionalIterable;
        if (entries instanceof Char2ShortSortedMap.FastSortedEntrySet) {
            final Char2ShortSortedMap.FastSortedEntrySet set = (Char2ShortSortedMap.FastSortedEntrySet)entries;
    ...
    public static class EmptySortedMap extends Char2ShortMaps.EmptyMap implements Char2ShortSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
            return (ObjectSortedSet<Char2ShortMap.Entry>)ObjectSortedSets.EMPTY_SET;
        }
        
        @Deprecated
        @Override
        public ObjectSortedSet<Map.Entry<Character, Short>> entrySet() {
            return (ObjectSortedSet<Map.Entry<Character, Short>>)ObjectSortedSets.EMPTY_SET;
        }
    ...
    public static class Singleton extends Char2ShortMaps.Singleton implements Char2ShortSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractChar2ShortMap.BasicEntry(this.key, this.value), (java.util.Comparator<? super AbstractChar2ShortMap.BasicEntry>)Char2ShortSortedMaps.entryComparator(this.comparator));
            }
            return (ObjectSortedSet<Char2ShortMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class SynchronizedSortedMap extends Char2ShortMaps.SynchronizedMap implements Char2ShortSortedMap, Serializable {
        ...
        public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Char2ShortMap.Entry>synchronize(this.sortedMap.char2ShortEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Char2ShortMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class UnmodifiableSortedMap extends Char2ShortMaps.UnmodifiableMap implements Char2ShortSortedMap, Serializable {
        ...
        public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Char2ShortMap.Entry>unmodifiable(this.sortedMap.char2ShortEntrySet());
            }
            return (ObjectSortedSet<Char2ShortMap.Entry>)(ObjectSortedSet)this.entries;
        }
