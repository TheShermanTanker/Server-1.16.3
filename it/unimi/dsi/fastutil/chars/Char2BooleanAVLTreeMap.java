...
public class Char2BooleanAVLTreeMap extends AbstractChar2BooleanSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Char2BooleanAVLTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry locateKey = Char2BooleanAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2BooleanSortedMap implements Serializable {
        ...
        protected transient CharSortedSet keys;
        protected transient BooleanCollection values;
        final /* synthetic */ Char2BooleanAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2BooleanAVLTreeMap.Entry f = Char2BooleanAVLTreeMap.this.findKey((char)e.getKey());
        ...
        public char firstCharKey() {
            final Char2BooleanAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public char lastCharKey() {
            final Char2BooleanAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2BooleanAVLTreeMap this$0 = submap.this$0;
                            final Char2BooleanAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
