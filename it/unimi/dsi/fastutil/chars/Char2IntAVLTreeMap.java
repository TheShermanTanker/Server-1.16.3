...
public class Char2IntAVLTreeMap extends AbstractChar2IntSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2IntMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Char2IntAVLTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Char2IntMap.Entry> subSet(final Char2IntMap.Entry from, final Char2IntMap.Entry to) {
                    return Char2IntAVLTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2IntEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Char2IntMap.Entry> headSet(final Char2IntMap.Entry to) {
                    return Char2IntAVLTreeMap.this.headMap(to.getCharKey()).char2IntEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Char2IntMap.Entry> tailSet(final Char2IntMap.Entry from) {
    ...
    private static final class Entry extends BasicEntry implements Cloneable {
        ...
        public boolean equals(final Object o) {
            ...
            return this.key == (char)e.getKey() && this.value == (int)e.getValue();
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry locateKey = Char2IntAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2IntSortedMap implements Serializable {
        ...
        protected transient CharSortedSet keys;
        protected transient IntCollection values;
        final /* synthetic */ Char2IntAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2IntMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey((char)e.getKey());
        ...
        public char firstCharKey() {
            final Char2IntAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public char lastCharKey() {
            final Char2IntAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2IntAVLTreeMap this$0 = submap.this$0;
                            final Char2IntAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
