...
public class Char2ShortRBTreeMap extends AbstractChar2ShortSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Char2ShortRBTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Char2ShortMap.Entry> subSet(final Char2ShortMap.Entry from, final Char2ShortMap.Entry to) {
                    return Char2ShortRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2ShortEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Char2ShortMap.Entry> headSet(final Char2ShortMap.Entry to) {
                    return Char2ShortRBTreeMap.this.headMap(to.getCharKey()).char2ShortEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Char2ShortMap.Entry> tailSet(final Char2ShortMap.Entry from) {
    ...
    private static final class Entry extends BasicEntry implements Cloneable {
        ...
        public boolean equals(final Object o) {
            ...
            return this.key == (char)e.getKey() && this.value == (short)e.getValue();
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry locateKey = Char2ShortRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2ShortSortedMap implements Serializable {
        ...
        protected transient CharSortedSet keys;
        protected transient ShortCollection values;
        final /* synthetic */ Char2ShortRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2ShortRBTreeMap.Entry f = Char2ShortRBTreeMap.this.findKey((char)e.getKey());
        ...
        public char firstCharKey() {
            final Char2ShortRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public char lastCharKey() {
            final Char2ShortRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2ShortRBTreeMap this$0 = submap.this$0;
                            final Char2ShortRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
