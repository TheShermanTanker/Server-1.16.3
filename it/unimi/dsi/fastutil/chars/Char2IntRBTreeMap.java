...
public class Char2IntRBTreeMap extends AbstractChar2IntSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2IntMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Char2IntRBTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry locateKey = Char2IntRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2IntSortedMap implements Serializable {
        ...
        protected transient CharSortedSet keys;
        protected transient IntCollection values;
        final /* synthetic */ Char2IntRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2IntMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2IntRBTreeMap.Entry f = Char2IntRBTreeMap.this.findKey((char)e.getKey());
        ...
        public char firstCharKey() {
            final Char2IntRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public char lastCharKey() {
            final Char2IntRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2IntRBTreeMap this$0 = submap.this$0;
                            final Char2IntRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
