...
public final class Char2LongFunctions {
    ...
    public static Char2LongFunction primitive(final Function<? super Character, ? extends Long> f) {
    ...
    public static class PrimitiveFunction implements Char2LongFunction {
        ...
        protected PrimitiveFunction(final java.util.function.Function<? super Character, ? extends Long> function) {
