...
public class Char2DoubleRBTreeMap extends AbstractChar2DoubleSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2DoubleMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Char2DoubleRBTreeMap.this.findKey((char)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Char2DoubleMap.Entry> subSet(final Char2DoubleMap.Entry from, final Char2DoubleMap.Entry to) {
                    return Char2DoubleRBTreeMap.this.subMap(from.getCharKey(), to.getCharKey()).char2DoubleEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Char2DoubleMap.Entry> headSet(final Char2DoubleMap.Entry to) {
                    return Char2DoubleRBTreeMap.this.headMap(to.getCharKey()).char2DoubleEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(final Char2DoubleMap.Entry from) {
    ...
    private static final class Entry extends BasicEntry implements Cloneable {
        ...
        public boolean equals(final Object o) {
            ...
            return this.key == (char)e.getKey() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits((double)e.getValue());
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final char k) {
            this.index = 0;
            final Entry locateKey = Char2DoubleRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractChar2DoubleSortedMap implements Serializable {
        ...
        protected transient CharSortedSet keys;
        protected transient DoubleCollection values;
        final /* synthetic */ Char2DoubleRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2DoubleMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Char2DoubleRBTreeMap.Entry f = Char2DoubleRBTreeMap.this.findKey((char)e.getKey());
        ...
        public char firstCharKey() {
            final Char2DoubleRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public char lastCharKey() {
            final Char2DoubleRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final char k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Char2DoubleRBTreeMap this$0 = submap.this$0;
                            final Char2DoubleRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
