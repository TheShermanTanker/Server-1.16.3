...
public class Char2DoubleOpenCustomHashMap extends AbstractChar2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    public Char2DoubleOpenCustomHashMap(final int expected, final float f, final CharHash.Strategy strategy) {
    ...
    public Char2DoubleOpenCustomHashMap(final int expected, final CharHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Char2DoubleOpenCustomHashMap(final CharHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Char2DoubleOpenCustomHashMap(final Map<? extends Character, ? extends Double> m, final float f, final CharHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Char2DoubleOpenCustomHashMap(final Map<? extends Character, ? extends Double> m, final CharHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Char2DoubleOpenCustomHashMap(final Char2DoubleMap m, final float f, final CharHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Char2DoubleOpenCustomHashMap(final Char2DoubleMap m, final CharHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Char2DoubleOpenCustomHashMap(final char[] k, final double[] v, final float f, final CharHash.Strategy strategy) {
    ...
    public Char2DoubleOpenCustomHashMap(final char[] k, final double[] v, final CharHash.Strategy strategy) {
    ...
    final class MapEntry implements Char2DoubleMap.Entry, Map.Entry<Character, Double> {
        ...
        public double setValue(final double v) {
            final double oldValue = Char2DoubleOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Char2DoubleOpenCustomHashMap.this.strategy.equals(Char2DoubleOpenCustomHashMap.this.key[this.index], (char)e.getKey()) && Double.doubleToLongBits(Char2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits((double)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Char2DoubleOpenCustomHashMap.this.key[this.index]).append("=>").append(Char2DoubleOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            char k;
            int p;
            for (k = this.wrapped.getChar(-this.pos - 1), p = (HashCommon.mix(Char2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Char2DoubleOpenCustomHashMap.this.mask); !Char2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Char2DoubleOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Char2DoubleOpenCustomHashMap.this.mask);
                char curr;
                while ((curr = key[pos]) != '\0') {
                    final int slot = HashCommon.mix(Char2DoubleOpenCustomHashMap.this.strategy.hashCode(curr)) & Char2DoubleOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Char2DoubleOpenCustomHashMap this$0 = Char2DoubleOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Char2DoubleMap.Entry> implements Char2DoubleMap.FastEntrySet {
        ...
        public boolean remove(final Object o) {
            ...
            if (Char2DoubleOpenCustomHashMap.this.strategy.equals(k, '\0')) {
                ...
                if (!Char2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Char2DoubleOpenCustomHashMap.this.mask)]) != '\0') {
                        if (Char2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && Double.doubleToLongBits(Char2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
        ...
        public void forEach(final Consumer<? super Char2DoubleMap.Entry> consumer) {
            if (Char2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Char2DoubleOpenCustomHashMap.this.key[Char2DoubleOpenCustomHashMap.this.n], Char2DoubleOpenCustomHashMap.this.value[Char2DoubleOpenCustomHashMap.this.n]));
            }
            int pos = Char2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2DoubleOpenCustomHashMap.this.key[pos] != '\0') {
    ...
    private final class KeySet extends AbstractCharSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Char2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Char2DoubleOpenCustomHashMap.this.key[Char2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Char2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final char k = Char2DoubleOpenCustomHashMap.this.key[pos];
                if (k != '\0') {
        ...
        public boolean remove(final char k) {
            final int oldSize = Char2DoubleOpenCustomHashMap.this.size;
