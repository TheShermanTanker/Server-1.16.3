...
public class Char2CharOpenHashMap extends AbstractChar2CharMap implements Serializable, Cloneable, Hash {
    ...
    public char computeIfAbsent(final char k, final IntUnaryOperator mappingFunction) {
    ...
    public char computeIfAbsentNullable(final char k, final IntFunction<? extends Character> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int pos = this.find(k);
        if (pos >= 0) {
            return this.value[pos];
    ...
    public char computeIfPresent(final char k, final BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
    ...
    public char compute(final char k, final BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
    ...
    public char merge(final char k, final char v, final BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
        if (pos < 0) {
            this.insert(-pos - 1, k, v);
            ...
            this.values = new AbstractCharCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Char2CharOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Char2CharOpenHashMap.this.value[Char2CharOpenHashMap.this.n]);
                    }
                    int pos = Char2CharOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Char2CharOpenHashMap.this.key[pos] != '\0') {
                            consumer.accept((int)Char2CharOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Char2CharMap.Entry, Map.Entry<Character, Character> {
        ...
        public char setValue(final char v) {
            final char oldValue = Char2CharOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Char2CharOpenHashMap.this.key[this.index] == (char)e.getKey() && Char2CharOpenHashMap.this.value[this.index] == (char)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Char2CharOpenHashMap.this.key[this.index]).append("=>").append(Char2CharOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            char k;
            int p;
            for (k = this.wrapped.getChar(-this.pos - 1), p = (HashCommon.mix(k) & Char2CharOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Char2CharOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Char2CharOpenHashMap.this.mask);
                char curr;
                while ((curr = key[pos]) != '\0') {
                    final int slot = HashCommon.mix(curr) & Char2CharOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Char2CharOpenHashMap this$0 = Char2CharOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractCharSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Char2CharOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Char2CharOpenHashMap.this.key[Char2CharOpenHashMap.this.n]);
            }
            int pos = Char2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                final char k = Char2CharOpenHashMap.this.key[pos];
                if (k != '\0') {
        ...
        public boolean remove(final char k) {
            final int oldSize = Char2CharOpenHashMap.this.size;
