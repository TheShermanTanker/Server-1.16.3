...
public class Char2ShortOpenCustomHashMap extends AbstractChar2ShortMap implements Serializable, Cloneable, Hash {
    ...
    public Char2ShortOpenCustomHashMap(final int expected, final float f, final CharHash.Strategy strategy) {
    ...
    public Char2ShortOpenCustomHashMap(final int expected, final CharHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Char2ShortOpenCustomHashMap(final CharHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Char2ShortOpenCustomHashMap(final Map<? extends Character, ? extends Short> m, final float f, final CharHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Char2ShortOpenCustomHashMap(final Map<? extends Character, ? extends Short> m, final CharHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Char2ShortOpenCustomHashMap(final Char2ShortMap m, final float f, final CharHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Char2ShortOpenCustomHashMap(final Char2ShortMap m, final CharHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Char2ShortOpenCustomHashMap(final char[] k, final short[] v, final float f, final CharHash.Strategy strategy) {
    ...
    public Char2ShortOpenCustomHashMap(final char[] k, final short[] v, final CharHash.Strategy strategy) {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Char2ShortOpenCustomHashMap.this.value[Char2ShortOpenCustomHashMap.this.n]);
                    }
                    int pos = Char2ShortOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Char2ShortOpenCustomHashMap.this.key[pos] != '\0') {
                            consumer.accept((int)Char2ShortOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Char2ShortMap.Entry, Map.Entry<Character, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Char2ShortOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Char2ShortOpenCustomHashMap.this.strategy.equals(Char2ShortOpenCustomHashMap.this.key[this.index], (char)e.getKey()) && Char2ShortOpenCustomHashMap.this.value[this.index] == (short)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Char2ShortOpenCustomHashMap.this.key[this.index]).append("=>").append((int)Char2ShortOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            char k;
            int p;
            for (k = this.wrapped.getChar(-this.pos - 1), p = (HashCommon.mix(Char2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ShortOpenCustomHashMap.this.mask); !Char2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Char2ShortOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Char2ShortOpenCustomHashMap.this.mask);
                char curr;
                while ((curr = key[pos]) != '\0') {
                    final int slot = HashCommon.mix(Char2ShortOpenCustomHashMap.this.strategy.hashCode(curr)) & Char2ShortOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Char2ShortOpenCustomHashMap this$0 = Char2ShortOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Char2ShortMap.Entry> implements Char2ShortMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Char2ShortMap.Entry> consumer) {
            if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Char2ShortOpenCustomHashMap.this.key[Char2ShortOpenCustomHashMap.this.n], Char2ShortOpenCustomHashMap.this.value[Char2ShortOpenCustomHashMap.this.n]));
            }
            int pos = Char2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ShortOpenCustomHashMap.this.key[pos] != '\0') {
    ...
    private final class KeySet extends AbstractCharSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Char2ShortOpenCustomHashMap.this.key[Char2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Char2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final char k = Char2ShortOpenCustomHashMap.this.key[pos];
                if (k != '\0') {
        ...
        public boolean remove(final char k) {
            final int oldSize = Char2ShortOpenCustomHashMap.this.size;
