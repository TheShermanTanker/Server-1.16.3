...
public class Char2ObjectOpenHashMap<V> extends AbstractChar2ObjectMap<V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Char2ObjectMap.Entry<V>, Map.Entry<Character, V> {
        ...
        public boolean equals(final Object o) {
            ...
            return Char2ObjectOpenHashMap.this.key[this.index] == (char)e.getKey() && Objects.equals(Char2ObjectOpenHashMap.this.value[this.index], e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Char2ObjectOpenHashMap.this.key[this.index]).append("=>").append(Char2ObjectOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>> implements Char2ObjectMap.FastEntrySet<V> {
        ...
        public void forEach(final Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
            if (Char2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Char2ObjectOpenHashMap.this.key[Char2ObjectOpenHashMap.this.n], Char2ObjectOpenHashMap.this.value[Char2ObjectOpenHashMap.this.n]));
            }
            int pos = Char2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Char2ObjectOpenHashMap.this.key[pos] != '\0') {
    ...
    private final class KeySet extends AbstractCharSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Char2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Char2ObjectOpenHashMap.this.key[Char2ObjectOpenHashMap.this.n]);
            }
            int pos = Char2ObjectOpenHashMap.this.n;
            while (pos-- != 0) {
                final char k = Char2ObjectOpenHashMap.this.key[pos];
                if (k != '\0') {
