...
public class Double2ByteLinkedOpenHashMap extends AbstractDouble2ByteSortedMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractByteCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Double2ByteLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Double2ByteLinkedOpenHashMap.this.value[Double2ByteLinkedOpenHashMap.this.n]);
                    }
                    int pos = Double2ByteLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2ByteLinkedOpenHashMap.this.key[pos]) != 0L) {
                            consumer.accept((int)Double2ByteLinkedOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Double2ByteMap.Entry, Map.Entry<Double, Byte> {
        ...
        public String toString() {
            return new StringBuilder().append(Double2ByteLinkedOpenHashMap.this.key[this.index]).append("=>").append((int)Double2ByteLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractDoubleSortedSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2ByteLinkedOpenHashMap.this.key[pos];
                if (Double.doubleToLongBits(k) != 0L) {
                    consumer.accept(k);
                }
            }
