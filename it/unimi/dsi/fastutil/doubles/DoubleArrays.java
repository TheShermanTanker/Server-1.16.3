...
public final class DoubleArrays {
    ...
    public static void parallelRadixSort(final double[] a, final int from, final int to) {
        ...
        //    10: iload_1         /* from */
        //    11: iload_2         /* to */
        //    12: invokestatic    it/unimi/dsi/fastutil/doubles/DoubleArrays.quickSort:([DII)V
        //    15: return         
        //    16: bipush          7
        //    18: istore_3        /* maxLevel */
        //    19: new             Ljava/util/concurrent/LinkedBlockingQueue;
        //    22: dup            
        //    23: invokespecial   java/util/concurrent/LinkedBlockingQueue.<init>:()V
        //    26: astore          queue
        //    28: aload           queue
        //    30: new             Lit/unimi/dsi/fastutil/doubles/DoubleArrays$Segment;
        //    33: dup            
        //    34: iload_1         /* from */
        //    35: iload_2         /* to */
        //    36: iload_1         /* from */
        //    37: isub           
        //    38: iconst_0       
        //    39: invokespecial   it/unimi/dsi/fastutil/doubles/DoubleArrays$Segment.<init>:(III)V
        //    42: invokevirtual   java/util/concurrent/LinkedBlockingQueue.add:(Ljava/lang/Object;)Z
        //    45: pop            
        //    46: new             Ljava/util/concurrent/atomic/AtomicInteger;
        //    49: dup            
        //    50: iconst_1       
        //    51: invokespecial   java/util/concurrent/atomic/AtomicInteger.<init>:(I)V
        //    54: astore          queueSize
        //    56: invokestatic    java/lang/Runtime.getRuntime:()Ljava/lang/Runtime;
        //    59: invokevirtual   java/lang/Runtime.availableProcessors:()I
        //    62: istore          numberOfThreads
        //    64: iload           numberOfThreads
        //    66: invokestatic    java/util/concurrent/Executors.defaultThreadFactory:()Ljava/util/concurrent/ThreadFactory;
        //    69: invokestatic    java/util/concurrent/Executors.newFixedThreadPool:(ILjava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;
        //    72: astore          executorService
        //    74: new             Ljava/util/concurrent/ExecutorCompletionService;
        //    77: dup            
        //    78: aload           executorService
        //    80: invokespecial   java/util/concurrent/ExecutorCompletionService.<init>:(Ljava/util/concurrent/Executor;)V
        //    83: astore          executorCompletionService
        //    85: iload           numberOfThreads
        //    87: istore          j
        //    89: iload           j
        //    91: iinc            j, -1
        //    94: ifeq            118
        //    97: aload           executorCompletionService
        //    99: aload           queueSize
        //   101: iload           numberOfThreads
        //   103: aload           queue
        //   105: aload_0         /* a */
        //   106: invokedynamic   BootstrapMethod #0, call:(Ljava/util/concurrent/atomic/AtomicInteger;ILjava/util/concurrent/LinkedBlockingQueue;[D)Ljava/util/concurrent/Callable;
        //   111: invokevirtual   java/util/concurrent/ExecutorCompletionService.submit:(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
        //   114: pop            
        //   115: goto            89
        //   118: aconst_null    
        //   119: astore          problem
        //   121: iload           numberOfThreads
        //   123: istore          i
        //   125: iload           i
        //   127: iinc            i, -1
        //   130: ifeq            159
        //   133: aload           executorCompletionService
        //   135: invokevirtual   java/util/concurrent/ExecutorCompletionService.take:()Ljava/util/concurrent/Future;
        //   138: invokeinterface java/util/concurrent/Future.get:()Ljava/lang/Object;
        //   143: pop            
        //   144: goto            125
        //   147: astore          e
        //   149: aload           e
        //   151: invokevirtual   java/lang/Exception.getCause:()Ljava/lang/Throwable;
        //   154: astore          problem
        //   156: goto            125
        //   159: aload           executorService
        //   161: invokeinterface java/util/concurrent/ExecutorService.shutdown:()V
        //   166: aload           problem
        //   168: ifnull          197
        //   171: aload           problem
        //   173: instanceof      Ljava/lang/RuntimeException;
        //   176: ifeq            187
        //   179: aload           problem
        //   181: checkcast       Ljava/lang/RuntimeException;
        //   184: goto            196
        //   187: new             Ljava/lang/RuntimeException;
        //   190: dup            
        //   191: aload           problem
        //   193: invokespecial   java/lang/RuntimeException.<init>:(Ljava/lang/Throwable;)V
        //   196: athrow         
        //   197: return         
        //    MethodParameters:
        //  Name  Flags  
        ...
        //  from  
        //  to    
        //    StackMapTable: 00 09 10 FF 00 48 00 0A 07 00 54 01 01 01 07 01 7D 07 01 86 01 07 01 98 07 01 93 01 00 00 FA 00 1C FD 00 06 07 01 B1 01 55 07 01 7B FA 00 0B 1B 48 07 01 C1 00
        //    Exceptions:
        //  Try           Handler
        //  Start  End    Start  End    Type                 
        //  -----  -----  -----  -----  ---------------------
        //  133    144    147    159    Ljava/lang/Exception;
        // 
    ...
    static {
        ...
        DEFAULT_EMPTY_ARRAY = new double[0];
