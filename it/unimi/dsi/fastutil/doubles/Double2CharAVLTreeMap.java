...
public class Double2CharAVLTreeMap extends AbstractDouble2CharSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2CharMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Double2CharAVLTreeMap.this.findKey((double)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final double k) {
            this.index = 0;
            final Entry locateKey = Double2CharAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractDouble2CharSortedMap implements Serializable {
        ...
        protected transient DoubleSortedSet keys;
        protected transient CharCollection values;
        final /* synthetic */ Double2CharAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2CharMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Double2CharAVLTreeMap.Entry f = Double2CharAVLTreeMap.this.findKey((double)e.getKey());
        ...
        public double firstDoubleKey() {
            final Double2CharAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public double lastDoubleKey() {
            final Double2CharAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final double k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Double2CharAVLTreeMap this$0 = submap.this$0;
                            final Double2CharAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
