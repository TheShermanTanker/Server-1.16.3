...
public class Double2ShortRBTreeMap extends AbstractDouble2ShortSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Double2ShortRBTreeMap.this.findKey((double)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Double2ShortMap.Entry> subSet(final Double2ShortMap.Entry from, final Double2ShortMap.Entry to) {
                    return Double2ShortRBTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ShortEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Double2ShortMap.Entry> headSet(final Double2ShortMap.Entry to) {
                    return Double2ShortRBTreeMap.this.headMap(to.getDoubleKey()).double2ShortEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Double2ShortMap.Entry> tailSet(final Double2ShortMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final double k) {
            this.index = 0;
            final Entry locateKey = Double2ShortRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractDouble2ShortSortedMap implements Serializable {
        ...
        protected transient DoubleSortedSet keys;
        protected transient ShortCollection values;
        final /* synthetic */ Double2ShortRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ShortMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Double2ShortRBTreeMap.Entry f = Double2ShortRBTreeMap.this.findKey((double)e.getKey());
        ...
        public double firstDoubleKey() {
            final Double2ShortRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public double lastDoubleKey() {
            final Double2ShortRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final double k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Double2ShortRBTreeMap this$0 = submap.this$0;
                            final Double2ShortRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
