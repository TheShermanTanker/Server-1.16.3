...
public class Double2ObjectLinkedOpenHashMap<V> extends AbstractDouble2ObjectSortedMap<V> implements Serializable, Cloneable, Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>() {
                ...
                public void forEach(final Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2ObjectLinkedOpenHashMap.this.key[pos]) != 0L) {
    ...
    final class MapEntry implements Double2ObjectMap.Entry<V>, Map.Entry<Double, V> {
        ...
        public String toString() {
            return new StringBuilder().append(Double2ObjectLinkedOpenHashMap.this.key[this.index]).append("=>").append(Double2ObjectLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Double2ObjectMap.Entry<V>> implements Double2ObjectSortedMap.FastSortedEntrySet<V> {
        ...
        public void forEach(final Consumer<? super Double2ObjectMap.Entry<V>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Double2ObjectLinkedOpenHashMap.this.key[curr], Double2ObjectLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractDoubleSortedSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2ObjectLinkedOpenHashMap.this.key[pos];
                if (Double.doubleToLongBits(k) != 0L) {
                    consumer.accept(k);
                }
            }
