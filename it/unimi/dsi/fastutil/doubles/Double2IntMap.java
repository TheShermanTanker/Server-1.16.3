...
public interface Double2IntMap extends Double2IntFunction, Map<Double, Integer> {
    ...
    default int computeIfAbsent(final double key, final DoubleToIntFunction mappingFunction) {
    ...
    default int computeIfAbsentNullable(final double key, final DoubleFunction<? extends Integer> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int v = this.get(key);
        final int drv = this.defaultReturnValue();
        if (v != drv || this.containsKey(key)) {
    ...
    default int computeIfPresent(final double key, final BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction) {
    ...
    default int compute(final double key, final BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int oldValue = this.get(key);
        final int drv = this.defaultReturnValue();
    ...
    default int merge(final double key, final int value, final BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int oldValue = this.get(key);
        final int drv = this.defaultReturnValue();
        int newValue;
    ...
    @Deprecated
    default Integer computeIfPresent(final Double key, final BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction) {
        return (Integer)super.computeIfPresent(key, (BiFunction)remappingFunction);
    }
    
    @Deprecated
    default Integer compute(final Double key, final BiFunction<? super Double, ? super Integer, ? extends Integer> remappingFunction) {
        return (Integer)super.compute(key, (BiFunction)remappingFunction);
    }
    
    @Deprecated
    default Integer merge(final Double key, final Integer value, final BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
