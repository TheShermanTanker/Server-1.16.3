...
public class Double2ShortOpenHashMap extends AbstractDouble2ShortMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Double2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.n]);
                    }
                    int pos = Double2ShortOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[pos]) != 0L) {
                            consumer.accept((int)Double2ShortOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Double2ShortMap.Entry, Map.Entry<Double, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Double2ShortOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Double2ShortOpenHashMap.this.key[this.index]).append("=>").append((int)Double2ShortOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            double k;
            int p;
            for (k = this.wrapped.getDouble(-this.pos - 1), p = ((int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ShortOpenHashMap.this.mask); Double.doubleToLongBits(k) != Double.doubleToLongBits(key[p]); p = (p + 1 & Double2ShortOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Double2ShortOpenHashMap.this.mask);
                double curr;
                while (Double.doubleToLongBits(curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(Double.doubleToRawLongBits(curr)) & Double2ShortOpenHashMap.this.mask;
                    Label_0108: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0108;
        ...
        public void remove() {
            ...
            final Double2ShortOpenHashMap this$0 = Double2ShortOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Double2ShortMap.Entry> implements Double2ShortMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Double2ShortMap.Entry> consumer) {
            if (Double2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Double2ShortOpenHashMap.this.key[Double2ShortOpenHashMap.this.n], Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.n]));
            }
            int pos = Double2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[pos]) != 0L) {
    ...
    private final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2ShortOpenHashMap.this.key[pos];
                if (Double.doubleToLongBits(k) != 0L) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final double k) {
            final int oldSize = Double2ShortOpenHashMap.this.size;
