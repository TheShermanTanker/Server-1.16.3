...
public class Double2ByteAVLTreeMap extends AbstractDouble2ByteSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Double2ByteAVLTreeMap.this.findKey((double)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Double2ByteMap.Entry> subSet(final Double2ByteMap.Entry from, final Double2ByteMap.Entry to) {
                    return Double2ByteAVLTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2ByteEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Double2ByteMap.Entry> headSet(final Double2ByteMap.Entry to) {
                    return Double2ByteAVLTreeMap.this.headMap(to.getDoubleKey()).double2ByteEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Double2ByteMap.Entry> tailSet(final Double2ByteMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final double k) {
            this.index = 0;
            final Entry locateKey = Double2ByteAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractDouble2ByteSortedMap implements Serializable {
        ...
        protected transient DoubleSortedSet keys;
        protected transient ByteCollection values;
        final /* synthetic */ Double2ByteAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Double2ByteAVLTreeMap.Entry f = Double2ByteAVLTreeMap.this.findKey((double)e.getKey());
        ...
        public double firstDoubleKey() {
            final Double2ByteAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public double lastDoubleKey() {
            final Double2ByteAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final double k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Double2ByteAVLTreeMap this$0 = submap.this$0;
                            final Double2ByteAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
