...
public class Double2ByteOpenHashMap extends AbstractDouble2ByteMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractByteCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Double2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n]);
                    }
                    int pos = Double2ByteOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[pos]) != 0L) {
                            consumer.accept((int)Double2ByteOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Double2ByteMap.Entry, Map.Entry<Double, Byte> {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Double2ByteOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Double2ByteOpenHashMap.this.key[this.index]).append("=>").append((int)Double2ByteOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            double k;
            int p;
            for (k = this.wrapped.getDouble(-this.pos - 1), p = ((int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2ByteOpenHashMap.this.mask); Double.doubleToLongBits(k) != Double.doubleToLongBits(key[p]); p = (p + 1 & Double2ByteOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Double2ByteOpenHashMap.this.mask);
                double curr;
                while (Double.doubleToLongBits(curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(Double.doubleToRawLongBits(curr)) & Double2ByteOpenHashMap.this.mask;
                    Label_0108: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0108;
        ...
        public void remove() {
            ...
            final Double2ByteOpenHashMap this$0 = Double2ByteOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Double2ByteMap.Entry> implements Double2ByteMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Double2ByteMap.Entry> consumer) {
            if (Double2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.n], Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.n]));
            }
            int pos = Double2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ByteOpenHashMap.this.key[pos]) != 0L) {
                    consumer.accept(new BasicEntry(Double2ByteOpenHashMap.this.key[pos], Double2ByteOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2ByteOpenHashMap.this.key[pos];
                if (Double.doubleToLongBits(k) != 0L) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final double k) {
            final int oldSize = Double2ByteOpenHashMap.this.size;
