...
public class Double2BooleanLinkedOpenHashMap extends AbstractDouble2BooleanSortedMap implements Serializable, Cloneable, Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() {
                ...
                public void forEach(final BooleanConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2BooleanLinkedOpenHashMap.this.key[pos]) != 0L) {
    ...
    final class MapEntry implements Double2BooleanMap.Entry, Map.Entry<Double, Boolean> {
        ...
        public String toString() {
            return new StringBuilder().append(Double2BooleanLinkedOpenHashMap.this.key[this.index]).append("=>").append(Double2BooleanLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Double2BooleanMap.Entry> implements Double2BooleanSortedMap.FastSortedEntrySet {
        ...
        public void forEach(final Consumer<? super Double2BooleanMap.Entry> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Double2BooleanLinkedOpenHashMap.this.key[curr], Double2BooleanLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractDoubleSortedSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2BooleanLinkedOpenHashMap.this.key[pos];
                if (Double.doubleToLongBits(k) != 0L) {
                    consumer.accept(k);
                }
            }
