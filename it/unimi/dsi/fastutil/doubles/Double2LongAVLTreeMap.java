...
public class Double2LongAVLTreeMap extends AbstractDouble2LongSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2LongMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Double2LongAVLTreeMap.this.findKey((double)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Double2LongMap.Entry> subSet(final Double2LongMap.Entry from, final Double2LongMap.Entry to) {
                    return Double2LongAVLTreeMap.this.subMap(from.getDoubleKey(), to.getDoubleKey()).double2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Double2LongMap.Entry> headSet(final Double2LongMap.Entry to) {
                    return Double2LongAVLTreeMap.this.headMap(to.getDoubleKey()).double2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Double2LongMap.Entry> tailSet(final Double2LongMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final double k) {
            this.index = 0;
            final Entry locateKey = Double2LongAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private class EntryIterator extends TreeIterator implements ObjectListIterator<Double2LongMap.Entry> {
        ...
        @Override
        public void set(final Double2LongMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public void add(final Double2LongMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class Submap extends AbstractDouble2LongSortedMap implements Serializable {
        ...
        protected transient DoubleSortedSet keys;
        protected transient LongCollection values;
        final /* synthetic */ Double2LongAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2LongMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Double2LongAVLTreeMap.Entry f = Double2LongAVLTreeMap.this.findKey((double)e.getKey());
        ...
        public double firstDoubleKey() {
            final Double2LongAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public double lastDoubleKey() {
            final Double2LongAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final double k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Double2LongAVLTreeMap this$0 = submap.this$0;
                            final Double2LongAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
