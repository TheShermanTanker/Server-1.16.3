...
public class Double2FloatOpenCustomHashMap extends AbstractDouble2FloatMap implements Serializable, Cloneable, Hash {
    ...
    public Double2FloatOpenCustomHashMap(final int expected, final float f, final DoubleHash.Strategy strategy) {
    ...
    public Double2FloatOpenCustomHashMap(final int expected, final DoubleHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Double2FloatOpenCustomHashMap(final DoubleHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Double2FloatOpenCustomHashMap(final Map<? extends Double, ? extends Float> m, final float f, final DoubleHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Double2FloatOpenCustomHashMap(final Map<? extends Double, ? extends Float> m, final DoubleHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Double2FloatOpenCustomHashMap(final Double2FloatMap m, final float f, final DoubleHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Double2FloatOpenCustomHashMap(final Double2FloatMap m, final DoubleHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Double2FloatOpenCustomHashMap(final double[] k, final float[] v, final float f, final DoubleHash.Strategy strategy) {
    ...
    public Double2FloatOpenCustomHashMap(final double[] k, final float[] v, final DoubleHash.Strategy strategy) {
            ...
            this.values = new AbstractFloatCollection() {
                ...
                public void forEach(final DoubleConsumer consumer) {
                    if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((double)Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]);
                    }
                    int pos = Double2FloatOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2FloatOpenCustomHashMap.this.key[pos]) != 0L) {
                            consumer.accept((double)Double2FloatOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Double2FloatMap.Entry, Map.Entry<Double, Float> {
        ...
        public float setValue(final float v) {
            final float oldValue = Double2FloatOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Double2FloatOpenCustomHashMap.this.strategy.equals(Double2FloatOpenCustomHashMap.this.key[this.index], (double)e.getKey()) && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((float)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Double2FloatOpenCustomHashMap.this.key[this.index]).append("=>").append(Double2FloatOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            double k;
            int p;
            for (k = this.wrapped.getDouble(-this.pos - 1), p = (HashCommon.mix(Double2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Double2FloatOpenCustomHashMap.this.mask); !Double2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Double2FloatOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Double2FloatOpenCustomHashMap.this.mask);
                double curr;
                while (Double.doubleToLongBits(curr = key[pos]) != 0L) {
                    final int slot = HashCommon.mix(Double2FloatOpenCustomHashMap.this.strategy.hashCode(curr)) & Double2FloatOpenCustomHashMap.this.mask;
                    Label_0116: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0116;
        ...
        public void remove() {
            ...
            final Double2FloatOpenCustomHashMap this$0 = Double2FloatOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Double2FloatMap.Entry> implements Double2FloatMap.FastEntrySet {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            double curr;
            if (Double.doubleToLongBits(curr = key[pos = (HashCommon.mix(Double2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Double2FloatOpenCustomHashMap.this.mask)]) == 0L) {
                return false;
            }
        ...
        public boolean remove(final Object o) {
            ...
            if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                ...
                if (!Double2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (Double.doubleToLongBits(curr = key[pos = (pos + 1 & Double2FloatOpenCustomHashMap.this.mask)]) != 0L) {
                        if (Double2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
        ...
        public void forEach(final Consumer<? super Double2FloatMap.Entry> consumer) {
            if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Double2FloatOpenCustomHashMap.this.key[Double2FloatOpenCustomHashMap.this.n], Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]));
            }
            int pos = Double2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2FloatOpenCustomHashMap.this.key[pos]) != 0L) {
                    consumer.accept(new BasicEntry(Double2FloatOpenCustomHashMap.this.key[pos], Double2FloatOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2FloatOpenCustomHashMap.this.key[pos];
        ...
        public boolean remove(final double k) {
            final int oldSize = Double2FloatOpenCustomHashMap.this.size;
