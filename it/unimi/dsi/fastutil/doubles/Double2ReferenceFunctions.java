...
public final class Double2ReferenceFunctions {
    ...
    public static <V> Double2ReferenceFunction<V> primitive(final Function<? super Double, ? extends V> f) {
        Objects.requireNonNull(f);
        if (f instanceof Double2ReferenceFunction) {
            return (Double2ReferenceFunction<V>)(Double2ReferenceFunction)f;
        }
        if (f instanceof DoubleFunction) {
            final DoubleFunction doubleFunction = (DoubleFunction)f;
            Objects.requireNonNull(doubleFunction);
            return (Double2ReferenceFunction<V>)doubleFunction::apply;
        }
