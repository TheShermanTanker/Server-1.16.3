...
public class DoubleRBTreeSet extends AbstractDoubleSortedSet implements Serializable, Cloneable, DoubleSortedSet {
    ...
    private class SetIterator implements DoubleListIterator {
        ...
        SetIterator(final double k) {
            this.index = 0;
            final Entry locateKey = DoubleRBTreeSet.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Subset extends AbstractDoubleSortedSet implements Serializable, DoubleSortedSet {
        ...
        boolean bottom;
        boolean top;
        final /* synthetic */ DoubleRBTreeSet this$0;
        ...
        public boolean remove(final double k) {
            return this.in(k) && DoubleRBTreeSet.this.remove(k);
        }
            ...
            SubsetIterator(final Subset subset, final double k) {
                ...
                if (this.next != null) {
                    if (!subset.bottom && subset.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!subset.top) {
                            final DoubleRBTreeSet this$0 = subset.this$0;
