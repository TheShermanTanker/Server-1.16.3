...
public class Double2ShortLinkedOpenHashMap extends AbstractDouble2ShortSortedMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Double2ShortLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Double2ShortLinkedOpenHashMap.this.value[Double2ShortLinkedOpenHashMap.this.n]);
                    }
                    int pos = Double2ShortLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2ShortLinkedOpenHashMap.this.key[pos]) != 0L) {
                            consumer.accept((int)Double2ShortLinkedOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Double2ShortMap.Entry, Map.Entry<Double, Short> {
        ...
        public String toString() {
            return new StringBuilder().append(Double2ShortLinkedOpenHashMap.this.key[this.index]).append("=>").append((int)Double2ShortLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractDoubleSortedSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2ShortLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2ShortLinkedOpenHashMap.this.key[pos];
                if (Double.doubleToLongBits(k) != 0L) {
                    consumer.accept(k);
                }
            }
