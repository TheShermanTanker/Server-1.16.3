...
public final class Double2FloatMaps {
    ...
    public static ObjectIterator<Double2FloatMap.Entry> fastIterator(final Double2FloatMap map) {
    ...
    public static void fastForEach(final Double2FloatMap map, final Consumer<? super Double2FloatMap.Entry> consumer) {
        final ObjectSet<Double2FloatMap.Entry> entries = map.double2FloatEntrySet();
    ...
    public static ObjectIterable<Double2FloatMap.Entry> fastIterable(final Double2FloatMap map) {
        final ObjectSet<Double2FloatMap.Entry> entries = map.double2FloatEntrySet();
    ...
    public static class SynchronizedMap extends Double2FloatFunctions.SynchronizedFunction implements Double2FloatMap, Serializable {
        ...
        public ObjectSet<Entry> double2FloatEntrySet() {
            synchronized (this.sync) {
                if (this.entries == null) {
                    this.entries = ObjectSets.<Entry>synchronize(this.map.double2FloatEntrySet(), this.sync);
                }
                return this.entries;
            }
        }
        ...
        public void forEach(final BiConsumer<? super Double, ? super Float> action) {
            synchronized (this.sync) {
                this.map.forEach((BiConsumer)action);
            }
        }
        
        public void replaceAll(final BiFunction<? super Double, ? super Float, ? extends Float> function) {
            synchronized (this.sync) {
        ...
        @Override
        public float computeIfAbsent(final double key, final DoubleUnaryOperator mappingFunction) {
            synchronized (this.sync) {
        ...
        @Override
        public float computeIfAbsentNullable(final double key, final DoubleFunction<? extends Float> mappingFunction) {
            synchronized (this.sync) {
        ...
        @Override
        public float computeIfPresent(final double key, final BiFunction<? super Double, ? super Float, ? extends Float> remappingFunction) {
            synchronized (this.sync) {
        ...
        @Override
        public float compute(final double key, final BiFunction<? super Double, ? super Float, ? extends Float> remappingFunction) {
            synchronized (this.sync) {
        ...
        @Override
        public float merge(final double key, final float value, final BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
            synchronized (this.sync) {
    ...
    public static class UnmodifiableMap extends Double2FloatFunctions.UnmodifiableFunction implements Double2FloatMap, Serializable {
        ...
        public ObjectSet<Entry> double2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSets.<Entry>unmodifiable(this.map.double2FloatEntrySet());
            }
            return this.entries;
        }
