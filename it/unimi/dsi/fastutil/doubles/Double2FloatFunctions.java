...
public final class Double2FloatFunctions {
    ...
    public static Double2FloatFunction primitive(final Function<? super Double, ? extends Float> f) {
        Objects.requireNonNull(f);
        if (f instanceof Double2FloatFunction) {
            return (Double2FloatFunction)f;
        }
        if (f instanceof DoubleUnaryOperator) {
            return key -> SafeMath.safeDoubleToFloat(((DoubleUnaryOperator)f).applyAsDouble(key));
        }
    ...
    public static class PrimitiveFunction implements Double2FloatFunction {
        ...
        protected PrimitiveFunction(final java.util.function.Function<? super Double, ? extends Float> function) {
