...
public class Double2CharLinkedOpenHashMap extends AbstractDouble2CharSortedMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractCharCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Double2CharLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Double2CharLinkedOpenHashMap.this.value[Double2CharLinkedOpenHashMap.this.n]);
                    }
                    int pos = Double2CharLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2CharLinkedOpenHashMap.this.key[pos]) != 0L) {
                            consumer.accept((int)Double2CharLinkedOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Double2CharMap.Entry, Map.Entry<Double, Character> {
        ...
        public boolean equals(final Object o) {
            ...
            return Double.doubleToLongBits(Double2CharLinkedOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((double)e.getKey()) && Double2CharLinkedOpenHashMap.this.value[this.index] == (char)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Double2CharLinkedOpenHashMap.this.key[this.index]).append("=>").append(Double2CharLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractDoubleSortedSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2CharLinkedOpenHashMap.this.key[pos];
                if (Double.doubleToLongBits(k) != 0L) {
                    consumer.accept(k);
                }
            }
