...
public class Double2CharOpenCustomHashMap extends AbstractDouble2CharMap implements Serializable, Cloneable, Hash {
    ...
    public Double2CharOpenCustomHashMap(final int expected, final float f, final DoubleHash.Strategy strategy) {
    ...
    public Double2CharOpenCustomHashMap(final int expected, final DoubleHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Double2CharOpenCustomHashMap(final DoubleHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Double2CharOpenCustomHashMap(final Map<? extends Double, ? extends Character> m, final float f, final DoubleHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Double2CharOpenCustomHashMap(final Map<? extends Double, ? extends Character> m, final DoubleHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Double2CharOpenCustomHashMap(final Double2CharMap m, final float f, final DoubleHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Double2CharOpenCustomHashMap(final Double2CharMap m, final DoubleHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Double2CharOpenCustomHashMap(final double[] k, final char[] v, final float f, final DoubleHash.Strategy strategy) {
    ...
    public Double2CharOpenCustomHashMap(final double[] k, final char[] v, final DoubleHash.Strategy strategy) {
    ...
    public char computeIfAbsent(final double k, final DoubleToIntFunction mappingFunction) {
    ...
    public char computeIfAbsentNullable(final double k, final DoubleFunction<? extends Character> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int pos = this.find(k);
        if (pos >= 0) {
            return this.value[pos];
    ...
    public char computeIfPresent(final double k, final BiFunction<? super Double, ? super Character, ? extends Character> remappingFunction) {
    ...
    public char compute(final double k, final BiFunction<? super Double, ? super Character, ? extends Character> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
    ...
    public char merge(final double k, final char v, final BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
        if (pos < 0) {
            this.insert(-pos - 1, k, v);
            ...
            this.values = new AbstractCharCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Double2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Double2CharOpenCustomHashMap.this.value[Double2CharOpenCustomHashMap.this.n]);
                    }
                    int pos = Double2CharOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2CharOpenCustomHashMap.this.key[pos]) != 0L) {
                            consumer.accept((int)Double2CharOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Double2CharMap.Entry, Map.Entry<Double, Character> {
        ...
        public char setValue(final char v) {
            final char oldValue = Double2CharOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Double2CharOpenCustomHashMap.this.strategy.equals(Double2CharOpenCustomHashMap.this.key[this.index], (double)e.getKey()) && Double2CharOpenCustomHashMap.this.value[this.index] == (char)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Double2CharOpenCustomHashMap.this.key[this.index]).append("=>").append(Double2CharOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            double k;
            int p;
            for (k = this.wrapped.getDouble(-this.pos - 1), p = (HashCommon.mix(Double2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Double2CharOpenCustomHashMap.this.mask); !Double2CharOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Double2CharOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Double2CharOpenCustomHashMap.this.mask);
                double curr;
                while (Double.doubleToLongBits(curr = key[pos]) != 0L) {
                    final int slot = HashCommon.mix(Double2CharOpenCustomHashMap.this.strategy.hashCode(curr)) & Double2CharOpenCustomHashMap.this.mask;
                    Label_0116: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0116;
        ...
        public void remove() {
            ...
            final Double2CharOpenCustomHashMap this$0 = Double2CharOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Double2CharMap.Entry> implements Double2CharMap.FastEntrySet {
        ...
        public boolean contains(final Object o) {
            ...
            int pos;
            double curr;
            if (Double.doubleToLongBits(curr = key[pos = (HashCommon.mix(Double2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Double2CharOpenCustomHashMap.this.mask)]) == 0L) {
                return false;
            }
        ...
        public void forEach(final Consumer<? super Double2CharMap.Entry> consumer) {
            if (Double2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Double2CharOpenCustomHashMap.this.key[Double2CharOpenCustomHashMap.this.n], Double2CharOpenCustomHashMap.this.value[Double2CharOpenCustomHashMap.this.n]));
            }
            int pos = Double2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2CharOpenCustomHashMap.this.key[pos]) != 0L) {
    ...
    private final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2CharOpenCustomHashMap.this.key[pos];
        ...
        public boolean remove(final double k) {
            final int oldSize = Double2CharOpenCustomHashMap.this.size;
