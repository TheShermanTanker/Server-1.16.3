...
public class Double2DoubleOpenCustomHashMap extends AbstractDouble2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Double2DoubleMap.Entry, Map.Entry<Double, Double> {
        ...
        public String toString() {
            return new StringBuilder().append(Double2DoubleOpenCustomHashMap.this.key[this.index]).append("=>").append(Double2DoubleOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Double2DoubleMap.Entry> implements Double2DoubleMap.FastEntrySet {
        ...
        public boolean remove(final Object o) {
            ...
            if (Double2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                ...
                if (!Double2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (Double.doubleToLongBits(curr = key[pos = (pos + 1 & Double2DoubleOpenCustomHashMap.this.mask)]) != 0L) {
                        if (Double2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && Double.doubleToLongBits(Double2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
        ...
        public void forEach(final Consumer<? super Double2DoubleMap.Entry> consumer) {
            if (Double2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Double2DoubleOpenCustomHashMap.this.key[Double2DoubleOpenCustomHashMap.this.n], Double2DoubleOpenCustomHashMap.this.value[Double2DoubleOpenCustomHashMap.this.n]));
            }
            int pos = Double2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2DoubleOpenCustomHashMap.this.key[pos]) != 0L) {
    ...
    private final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2DoubleOpenCustomHashMap.this.key[pos];
