...
public class Double2IntLinkedOpenHashMap extends AbstractDouble2IntSortedMap implements Serializable, Cloneable, Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Double.doubleToLongBits(Double2IntLinkedOpenHashMap.this.key[pos]) != 0L) {
    ...
    final class MapEntry implements Double2IntMap.Entry, Map.Entry<Double, Integer> {
        ...
        public boolean equals(final Object o) {
            ...
            return Double.doubleToLongBits(Double2IntLinkedOpenHashMap.this.key[this.index]) == Double.doubleToLongBits((double)e.getKey()) && Double2IntLinkedOpenHashMap.this.value[this.index] == (int)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Double2IntLinkedOpenHashMap.this.key[this.index]).append("=>").append(Double2IntLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Double2IntLinkedOpenHashMap.this.mask);
                double curr;
                while (Double.doubleToLongBits(curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(Double.doubleToRawLongBits(curr)) & Double2IntLinkedOpenHashMap.this.mask;
                    Label_0363: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0363;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Double2IntMap.Entry> implements Double2IntSortedMap.FastSortedEntrySet {
        ...
        public void forEach(final Consumer<? super Double2IntMap.Entry> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Double2IntLinkedOpenHashMap.this.key[curr], Double2IntLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractDoubleSortedSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2IntLinkedOpenHashMap.this.key[pos];
                if (Double.doubleToLongBits(k) != 0L) {
                    consumer.accept(k);
                }
            }
