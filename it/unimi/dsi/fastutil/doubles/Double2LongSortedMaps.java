...
public final class Double2LongSortedMaps {
    ...
    public static ObjectBidirectionalIterator<Double2LongMap.Entry> fastIterator(final Double2LongSortedMap map) {
    ...
    public static ObjectBidirectionalIterable<Double2LongMap.Entry> fastIterable(final Double2LongSortedMap map) {
        final ObjectSortedSet<Double2LongMap.Entry> entries = map.double2LongEntrySet();
        ObjectBidirectionalIterable<Double2LongMap.Entry> objectBidirectionalIterable;
        if (entries instanceof Double2LongSortedMap.FastSortedEntrySet) {
            final Double2LongSortedMap.FastSortedEntrySet set = (Double2LongSortedMap.FastSortedEntrySet)entries;
    ...
    public static class EmptySortedMap extends Double2LongMaps.EmptyMap implements Double2LongSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
            return (ObjectSortedSet<Double2LongMap.Entry>)ObjectSortedSets.EMPTY_SET;
        }
        
        @Deprecated
        @Override
        public ObjectSortedSet<Map.Entry<Double, Long>> entrySet() {
            return (ObjectSortedSet<Map.Entry<Double, Long>>)ObjectSortedSets.EMPTY_SET;
        }
    ...
    public static class Singleton extends Double2LongMaps.Singleton implements Double2LongSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractDouble2LongMap.BasicEntry(this.key, this.value), (java.util.Comparator<? super AbstractDouble2LongMap.BasicEntry>)Double2LongSortedMaps.entryComparator(this.comparator));
            }
            return (ObjectSortedSet<Double2LongMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class SynchronizedSortedMap extends Double2LongMaps.SynchronizedMap implements Double2LongSortedMap, Serializable {
        ...
        public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Double2LongMap.Entry>synchronize(this.sortedMap.double2LongEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Double2LongMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class UnmodifiableSortedMap extends Double2LongMaps.UnmodifiableMap implements Double2LongSortedMap, Serializable {
        ...
        public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Double2LongMap.Entry>unmodifiable(this.sortedMap.double2LongEntrySet());
            }
            return (ObjectSortedSet<Double2LongMap.Entry>)(ObjectSortedSet)this.entries;
        }
