...
public class Double2ReferenceOpenCustomHashMap<V> extends AbstractDouble2ReferenceMap<V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Double2ReferenceMap.Entry<V>, Map.Entry<Double, V> {
        ...
        public String toString() {
            return new StringBuilder().append(Double2ReferenceOpenCustomHashMap.this.key[this.index]).append("=>").append(Double2ReferenceOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Double2ReferenceMap.Entry<V>> implements Double2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(final Consumer<? super Double2ReferenceMap.Entry<V>> consumer) {
            if (Double2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Double2ReferenceOpenCustomHashMap.this.key[Double2ReferenceOpenCustomHashMap.this.n], Double2ReferenceOpenCustomHashMap.this.value[Double2ReferenceOpenCustomHashMap.this.n]));
            }
            int pos = Double2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2ReferenceOpenCustomHashMap.this.key[pos]) != 0L) {
    ...
    private final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2ReferenceOpenCustomHashMap.this.key[pos];
