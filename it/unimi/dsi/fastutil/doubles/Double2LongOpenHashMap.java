...
public class Double2LongOpenHashMap extends AbstractDouble2LongMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Double2LongMap.Entry, Map.Entry<Double, Long> {
        ...
        public long setValue(final long v) {
            final long oldValue = Double2LongOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Double2LongOpenHashMap.this.key[this.index]).append("=>").append(Double2LongOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            double k;
            int p;
            for (k = this.wrapped.getDouble(-this.pos - 1), p = ((int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2LongOpenHashMap.this.mask); Double.doubleToLongBits(k) != Double.doubleToLongBits(key[p]); p = (p + 1 & Double2LongOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Double2LongOpenHashMap.this.mask);
                double curr;
                while (Double.doubleToLongBits(curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(Double.doubleToRawLongBits(curr)) & Double2LongOpenHashMap.this.mask;
                    Label_0108: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0108;
        ...
        public void remove() {
            ...
            final Double2LongOpenHashMap this$0 = Double2LongOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Double2LongMap.Entry> implements Double2LongMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Double2LongMap.Entry> consumer) {
            if (Double2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Double2LongOpenHashMap.this.key[Double2LongOpenHashMap.this.n], Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.n]));
            }
            int pos = Double2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Double.doubleToLongBits(Double2LongOpenHashMap.this.key[pos]) != 0L) {
                    consumer.accept(new BasicEntry(Double2LongOpenHashMap.this.key[pos], Double2LongOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(final DoubleConsumer consumer) {
            ...
            int pos = Double2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                final double k = Double2LongOpenHashMap.this.key[pos];
                if (Double.doubleToLongBits(k) != 0L) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final double k) {
            final int oldSize = Double2LongOpenHashMap.this.size;
