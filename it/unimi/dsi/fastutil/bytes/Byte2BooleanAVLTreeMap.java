...
public class Byte2BooleanAVLTreeMap extends AbstractByte2BooleanSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2BooleanMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Byte2BooleanAVLTreeMap.this.findKey((byte)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final byte k) {
            this.index = 0;
            final Entry locateKey = Byte2BooleanAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractByte2BooleanSortedMap implements Serializable {
        ...
        protected transient ByteSortedSet keys;
        protected transient BooleanCollection values;
        final /* synthetic */ Byte2BooleanAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2BooleanMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Byte2BooleanAVLTreeMap.Entry f = Byte2BooleanAVLTreeMap.this.findKey((byte)e.getKey());
        ...
        public byte firstByteKey() {
            final Byte2BooleanAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public byte lastByteKey() {
            final Byte2BooleanAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final byte k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Byte2BooleanAVLTreeMap this$0 = submap.this$0;
                            final Byte2BooleanAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
