...
public final class ByteArrays {
    ...
    public static byte[] trim(final byte[] array, final int length) {
        ...
        final byte[] t = (length == 0) ? ByteArrays.EMPTY_ARRAY : new byte[length];
    ...
    public static byte[] copy(final byte[] array, final int offset, final int length) {
        ...
        final byte[] a = (length == 0) ? ByteArrays.EMPTY_ARRAY : new byte[length];
    ...
    private static int med3(final byte[] x, final int a, final int b, final int c, final ByteComparator comp) {
    ...
    public static void mergeSort(final byte[] a, final int from, final int to, final ByteComparator comp, final byte[] supp) {
        final int len = to - from;
        if (len < 16) {
    ...
    public static void mergeSort(final byte[] a, final int from, final int to, final ByteComparator comp) {
        mergeSort(a, from, to, comp, a.clone());
    }
    
    public static void mergeSort(final byte[] a, final ByteComparator comp) {
    ...
    public static void radixSort(final byte[] a, final int from, final int to) {
        ...
        int stackPos = 0;
        final int[] offsetStack = { 0 };
        final int[] lengthStack = { 0 };
            ...
            executorCompletionService.submit(() -> {
                ...
                while (true) {
                    if (queueSize.get() == 0) {
                        ...
                        while (i-- != 0) {
                            queue.add(ByteArrays.POISON_PILL);
                        }
                    }
    ...
    public static void radixSort(final byte[][] a, final int from, final int to) {
        ...
        final int stackSize = 255 * (layers * 1 - 1) + 1;
        int stackPos = 0;
    ...
    static {
        ...
        DEFAULT_EMPTY_ARRAY = new byte[0];
