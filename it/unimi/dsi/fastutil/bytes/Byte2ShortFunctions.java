...
public final class Byte2ShortFunctions {
    ...
    public static Byte2ShortFunction primitive(final Function<? super Byte, ? extends Short> f) {
    ...
    public static class PrimitiveFunction implements Byte2ShortFunction {
        ...
        protected PrimitiveFunction(final java.util.function.Function<? super Byte, ? extends Short> function) {
