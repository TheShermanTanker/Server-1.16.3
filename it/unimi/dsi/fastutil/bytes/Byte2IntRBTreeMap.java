...
public class Byte2IntRBTreeMap extends AbstractByte2IntSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Byte2IntRBTreeMap.this.findKey((byte)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Byte2IntMap.Entry> subSet(final Byte2IntMap.Entry from, final Byte2IntMap.Entry to) {
                    return Byte2IntRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2IntEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Byte2IntMap.Entry> headSet(final Byte2IntMap.Entry to) {
                    return Byte2IntRBTreeMap.this.headMap(to.getByteKey()).byte2IntEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Byte2IntMap.Entry> tailSet(final Byte2IntMap.Entry from) {
    ...
    private static final class Entry extends BasicEntry implements Cloneable {
        ...
        public boolean equals(final Object o) {
            ...
            return this.key == (byte)e.getKey() && this.value == (int)e.getValue();
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final byte k) {
            this.index = 0;
            final Entry locateKey = Byte2IntRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractByte2IntSortedMap implements Serializable {
        ...
        protected transient ByteSortedSet keys;
        protected transient IntCollection values;
        final /* synthetic */ Byte2IntRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2IntMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Byte2IntRBTreeMap.Entry f = Byte2IntRBTreeMap.this.findKey((byte)e.getKey());
        ...
        public byte firstByteKey() {
            final Byte2IntRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public byte lastByteKey() {
            final Byte2IntRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final byte k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Byte2IntRBTreeMap this$0 = submap.this$0;
                            final Byte2IntRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
