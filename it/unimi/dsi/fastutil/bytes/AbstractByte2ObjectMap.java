...
public abstract class AbstractByte2ObjectMap<V> extends AbstractByte2ObjectFunction<V> implements Byte2ObjectMap<V>, Serializable {
    ...
    public boolean containsKey(final byte k) {
        final ObjectIterator<Entry<V>> i = this.byte2ObjectEntrySet().iterator();
        while (i.hasNext()) {
        ...
        return new AbstractByteSet() {
            ...
            public ByteIterator iterator() {
                return new ByteIterator() {
                    private final ObjectIterator<Entry<V>> i = Byte2ObjectMaps.<V>fastIterator((Byte2ObjectMap<V>)AbstractByte2ObjectMap.this);
    ...
    public void putAll(final Map<? extends Byte, ? extends V> m) {
        if (m instanceof Byte2ObjectMap) {
            final ObjectIterator<Entry<V>> i = Byte2ObjectMaps.<V>fastIterator((Byte2ObjectMap<V>)(Byte2ObjectMap)m);
            while (i.hasNext()) {
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry<V>> i = Byte2ObjectMaps.<V>fastIterator((Byte2ObjectMap<V>)this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.byte2ObjectEntrySet().containsAll((Collection)m.entrySet());
    }
