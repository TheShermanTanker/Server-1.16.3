...
public final class Byte2ReferenceFunctions {
    ...
    public static <V> Byte2ReferenceFunction<V> primitive(final Function<? super Byte, ? extends V> f) {
        Objects.requireNonNull(f);
        if (f instanceof Byte2ReferenceFunction) {
            return (Byte2ReferenceFunction<V>)(Byte2ReferenceFunction)f;
        }
        if (f instanceof IntFunction) {
            final IntFunction intFunction = (IntFunction)f;
            Objects.requireNonNull(intFunction);
            return (Byte2ReferenceFunction<V>)intFunction::apply;
        }
