...
public class Byte2ReferenceLinkedOpenHashMap<V> extends AbstractByte2ReferenceSortedMap<V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Byte2ReferenceMap.Entry<V>, Map.Entry<Byte, V> {
        ...
        public V setValue(final V v) {
            final V oldValue = Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Byte2ReferenceLinkedOpenHashMap.this.key[this.index]).append("=>").append(Byte2ReferenceLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final byte from) {
            ...
            if (from == 0) {
                ...
                for (int pos = HashCommon.mix(from) & Byte2ReferenceLinkedOpenHashMap.this.mask; Byte2ReferenceLinkedOpenHashMap.this.key[pos] != 0; pos = (pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Byte2ReferenceLinkedOpenHashMap this$0 = Byte2ReferenceLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Byte2ReferenceLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Byte2ReferenceLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Byte2ReferenceLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Byte2ReferenceLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Byte2ReferenceLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0280:
            while (true) {
                pos = ((last = pos) + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask);
                byte curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Byte2ReferenceLinkedOpenHashMap.this.mask;
                    Label_0380: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0380;
        ...
        public void set(final Byte2ReferenceMap.Entry<V> ok) {
            throw new UnsupportedOperationException();
        }
        
        public void add(final Byte2ReferenceMap.Entry<V> ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>> implements Byte2ReferenceSortedMap.FastSortedEntrySet<V> {
        ...
        @Override
        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(final Byte2ReferenceMap.Entry<V> fromElement, final Byte2ReferenceMap.Entry<V> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(final Byte2ReferenceMap.Entry<V> toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(final Byte2ReferenceMap.Entry<V> fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public void forEach(final Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Byte2ReferenceLinkedOpenHashMap.this.key[curr], Byte2ReferenceLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractByteSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Byte2ReferenceLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.n]);
            }
            int pos = Byte2ReferenceLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final byte k = Byte2ReferenceLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final byte k) {
            final int oldSize = Byte2ReferenceLinkedOpenHashMap.this.size;
