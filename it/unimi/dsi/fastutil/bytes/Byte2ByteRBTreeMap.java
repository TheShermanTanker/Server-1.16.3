...
public class Byte2ByteRBTreeMap extends AbstractByte2ByteSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Byte2ByteRBTreeMap.this.findKey((byte)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Byte2ByteMap.Entry> subSet(final Byte2ByteMap.Entry from, final Byte2ByteMap.Entry to) {
                    return Byte2ByteRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ByteEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Byte2ByteMap.Entry> headSet(final Byte2ByteMap.Entry to) {
                    return Byte2ByteRBTreeMap.this.headMap(to.getByteKey()).byte2ByteEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(final Byte2ByteMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final byte k) {
            this.index = 0;
            final Entry locateKey = Byte2ByteRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractByte2ByteSortedMap implements Serializable {
        ...
        protected transient ByteSortedSet keys;
        protected transient ByteCollection values;
        final /* synthetic */ Byte2ByteRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey((byte)e.getKey());
        ...
        public byte firstByteKey() {
            final Byte2ByteRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public byte lastByteKey() {
            final Byte2ByteRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final byte k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Byte2ByteRBTreeMap this$0 = submap.this$0;
                            final Byte2ByteRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
