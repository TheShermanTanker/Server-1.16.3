...
public class Byte2BooleanOpenHashMap extends AbstractByte2BooleanMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Byte2BooleanMap.Entry, Map.Entry<Byte, Boolean> {
        ...
        public boolean setValue(final boolean v) {
            final boolean oldValue = Byte2BooleanOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Byte2BooleanOpenHashMap.this.key[this.index]).append("=>").append(Byte2BooleanOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            byte k;
            int p;
            for (k = this.wrapped.getByte(-this.pos - 1), p = (HashCommon.mix(k) & Byte2BooleanOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Byte2BooleanOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Byte2BooleanOpenHashMap.this.mask);
                byte curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Byte2BooleanOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Byte2BooleanOpenHashMap this$0 = Byte2BooleanOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry> implements Byte2BooleanMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Byte2BooleanMap.Entry> consumer) {
            if (Byte2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Byte2BooleanOpenHashMap.this.key[Byte2BooleanOpenHashMap.this.n], Byte2BooleanOpenHashMap.this.value[Byte2BooleanOpenHashMap.this.n]));
            }
            int pos = Byte2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2BooleanOpenHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractByteSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Byte2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Byte2BooleanOpenHashMap.this.key[Byte2BooleanOpenHashMap.this.n]);
            }
            int pos = Byte2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                final byte k = Byte2BooleanOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        @Override
        public boolean remove(final byte k) {
            final int oldSize = Byte2BooleanOpenHashMap.this.size;
