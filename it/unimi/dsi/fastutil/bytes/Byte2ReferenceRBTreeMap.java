...
public class Byte2ReferenceRBTreeMap<V> extends AbstractByte2ReferenceSortedMap<V> implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey((byte)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(final Byte2ReferenceMap.Entry<V> from, final Byte2ReferenceMap.Entry<V> to) {
                    return Byte2ReferenceRBTreeMap.this.subMap(from.getByteKey(), to.getByteKey()).byte2ReferenceEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(final Byte2ReferenceMap.Entry<V> to) {
                    return Byte2ReferenceRBTreeMap.this.headMap(to.getByteKey()).byte2ReferenceEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(final Byte2ReferenceMap.Entry<V> from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final byte k) {
            this.index = 0;
            final Entry<V> locateKey = Byte2ReferenceRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractByte2ReferenceSortedMap<V> implements Serializable {
        ...
        protected transient ByteSortedSet keys;
        protected transient ReferenceCollection<V> values;
        final /* synthetic */ Byte2ReferenceRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey((byte)e.getKey());
        ...
        public byte firstByteKey() {
            final Byte2ReferenceRBTreeMap.Entry<V> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public byte lastByteKey() {
            final Byte2ReferenceRBTreeMap.Entry<V> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final byte k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Byte2ReferenceRBTreeMap this$0 = submap.this$0;
                            final Byte2ReferenceRBTreeMap.Entry<V> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
