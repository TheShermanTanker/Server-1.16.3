...
public class Byte2FloatOpenCustomHashMap extends AbstractByte2FloatMap implements Serializable, Cloneable, Hash {
    ...
    public Byte2FloatOpenCustomHashMap(final int expected, final float f, final ByteHash.Strategy strategy) {
    ...
    public Byte2FloatOpenCustomHashMap(final int expected, final ByteHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Byte2FloatOpenCustomHashMap(final ByteHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Byte2FloatOpenCustomHashMap(final Map<? extends Byte, ? extends Float> m, final float f, final ByteHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Byte2FloatOpenCustomHashMap(final Map<? extends Byte, ? extends Float> m, final ByteHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Byte2FloatOpenCustomHashMap(final Byte2FloatMap m, final float f, final ByteHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Byte2FloatOpenCustomHashMap(final Byte2FloatMap m, final ByteHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Byte2FloatOpenCustomHashMap(final byte[] k, final float[] v, final float f, final ByteHash.Strategy strategy) {
    ...
    public Byte2FloatOpenCustomHashMap(final byte[] k, final float[] v, final ByteHash.Strategy strategy) {
    ...
    final class MapEntry implements Byte2FloatMap.Entry, Map.Entry<Byte, Float> {
        ...
        public float setValue(final float v) {
            final float oldValue = Byte2FloatOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[this.index], (byte)e.getKey()) && Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((float)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append((int)Byte2FloatOpenCustomHashMap.this.key[this.index]).append("=>").append(Byte2FloatOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            byte k;
            int p;
            for (k = this.wrapped.getByte(-this.pos - 1), p = (HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2FloatOpenCustomHashMap.this.mask); !Byte2FloatOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Byte2FloatOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Byte2FloatOpenCustomHashMap.this.mask);
                byte curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(curr)) & Byte2FloatOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Byte2FloatOpenCustomHashMap this$0 = Byte2FloatOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Byte2FloatMap.Entry> implements Byte2FloatMap.FastEntrySet {
        ...
        public boolean remove(final Object o) {
            ...
            if (Byte2FloatOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                ...
                if (!Byte2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Byte2FloatOpenCustomHashMap.this.mask)]) != 0) {
                        if (Byte2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
        ...
        public void forEach(final Consumer<? super Byte2FloatMap.Entry> consumer) {
            if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Byte2FloatOpenCustomHashMap.this.key[Byte2FloatOpenCustomHashMap.this.n], Byte2FloatOpenCustomHashMap.this.value[Byte2FloatOpenCustomHashMap.this.n]));
            }
            int pos = Byte2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2FloatOpenCustomHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractByteSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Byte2FloatOpenCustomHashMap.this.key[Byte2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Byte2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final byte k = Byte2FloatOpenCustomHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final byte k) {
            final int oldSize = Byte2FloatOpenCustomHashMap.this.size;
