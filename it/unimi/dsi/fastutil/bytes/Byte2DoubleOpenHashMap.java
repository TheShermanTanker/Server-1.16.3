...
public class Byte2DoubleOpenHashMap extends AbstractByte2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Byte2DoubleMap.Entry, Map.Entry<Byte, Double> {
        ...
        public String toString() {
            return new StringBuilder().append((int)Byte2DoubleOpenHashMap.this.key[this.index]).append("=>").append(Byte2DoubleOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry> implements Byte2DoubleMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Byte2DoubleMap.Entry> consumer) {
            if (Byte2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Byte2DoubleOpenHashMap.this.key[Byte2DoubleOpenHashMap.this.n], Byte2DoubleOpenHashMap.this.value[Byte2DoubleOpenHashMap.this.n]));
            }
            int pos = Byte2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2DoubleOpenHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractByteSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Byte2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Byte2DoubleOpenHashMap.this.key[Byte2DoubleOpenHashMap.this.n]);
            }
            int pos = Byte2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                final byte k = Byte2DoubleOpenHashMap.this.key[pos];
                if (k != 0) {
