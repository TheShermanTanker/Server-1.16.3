...
public class Byte2LongOpenCustomHashMap extends AbstractByte2LongMap implements Serializable, Cloneable, Hash {
    ...
    public Byte2LongOpenCustomHashMap(final int expected, final float f, final ByteHash.Strategy strategy) {
    ...
    public Byte2LongOpenCustomHashMap(final int expected, final ByteHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Byte2LongOpenCustomHashMap(final ByteHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Byte2LongOpenCustomHashMap(final Map<? extends Byte, ? extends Long> m, final float f, final ByteHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Byte2LongOpenCustomHashMap(final Map<? extends Byte, ? extends Long> m, final ByteHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Byte2LongOpenCustomHashMap(final Byte2LongMap m, final float f, final ByteHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Byte2LongOpenCustomHashMap(final Byte2LongMap m, final ByteHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Byte2LongOpenCustomHashMap(final byte[] k, final long[] v, final float f, final ByteHash.Strategy strategy) {
    ...
    public Byte2LongOpenCustomHashMap(final byte[] k, final long[] v, final ByteHash.Strategy strategy) {
    ...
    final class MapEntry implements Byte2LongMap.Entry, Map.Entry<Byte, Long> {
        ...
        public long setValue(final long v) {
            final long oldValue = Byte2LongOpenCustomHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Byte2LongOpenCustomHashMap.this.key[this.index]).append("=>").append(Byte2LongOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            byte k;
            int p;
            for (k = this.wrapped.getByte(-this.pos - 1), p = (HashCommon.mix(Byte2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2LongOpenCustomHashMap.this.mask); !Byte2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Byte2LongOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Byte2LongOpenCustomHashMap.this.mask);
                byte curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Byte2LongOpenCustomHashMap.this.strategy.hashCode(curr)) & Byte2LongOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Byte2LongOpenCustomHashMap this$0 = Byte2LongOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Byte2LongMap.Entry> implements Byte2LongMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Byte2LongMap.Entry> consumer) {
            if (Byte2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Byte2LongOpenCustomHashMap.this.key[Byte2LongOpenCustomHashMap.this.n], Byte2LongOpenCustomHashMap.this.value[Byte2LongOpenCustomHashMap.this.n]));
            }
            int pos = Byte2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2LongOpenCustomHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractByteSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Byte2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Byte2LongOpenCustomHashMap.this.key[Byte2LongOpenCustomHashMap.this.n]);
            }
            int pos = Byte2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final byte k = Byte2LongOpenCustomHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final byte k) {
            final int oldSize = Byte2LongOpenCustomHashMap.this.size;
