...
public class Byte2ByteOpenHashMap extends AbstractByte2ByteMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractByteCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Byte2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n]);
                    }
                    int pos = Byte2ByteOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Byte2ByteOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Byte2ByteOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Byte2ByteMap.Entry, Map.Entry<Byte, Byte> {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Byte2ByteOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Byte2ByteOpenHashMap.this.key[this.index]).append("=>").append((int)Byte2ByteOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            byte k;
            int p;
            for (k = this.wrapped.getByte(-this.pos - 1), p = (HashCommon.mix(k) & Byte2ByteOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Byte2ByteOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Byte2ByteOpenHashMap.this.mask);
                byte curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Byte2ByteOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Byte2ByteOpenHashMap this$0 = Byte2ByteOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Byte2ByteMap.Entry> implements Byte2ByteMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Byte2ByteMap.Entry> consumer) {
            if (Byte2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.n], Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.n]));
            }
            int pos = Byte2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ByteOpenHashMap.this.key[pos] != 0) {
                    consumer.accept(new BasicEntry(Byte2ByteOpenHashMap.this.key[pos], Byte2ByteOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractByteSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Byte2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.n]);
            }
            int pos = Byte2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                final byte k = Byte2ByteOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final byte k) {
            final int oldSize = Byte2ByteOpenHashMap.this.size;
