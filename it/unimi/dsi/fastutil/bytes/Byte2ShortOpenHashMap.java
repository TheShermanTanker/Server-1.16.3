...
public class Byte2ShortOpenHashMap extends AbstractByte2ShortMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Byte2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Byte2ShortOpenHashMap.this.value[Byte2ShortOpenHashMap.this.n]);
                    }
                    int pos = Byte2ShortOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Byte2ShortOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Byte2ShortOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Byte2ShortMap.Entry, Map.Entry<Byte, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Byte2ShortOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Byte2ShortOpenHashMap.this.key[this.index]).append("=>").append((int)Byte2ShortOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            byte k;
            int p;
            for (k = this.wrapped.getByte(-this.pos - 1), p = (HashCommon.mix(k) & Byte2ShortOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Byte2ShortOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Byte2ShortOpenHashMap.this.mask);
                byte curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Byte2ShortOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Byte2ShortOpenHashMap this$0 = Byte2ShortOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Byte2ShortMap.Entry> implements Byte2ShortMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Byte2ShortMap.Entry> consumer) {
            if (Byte2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Byte2ShortOpenHashMap.this.key[Byte2ShortOpenHashMap.this.n], Byte2ShortOpenHashMap.this.value[Byte2ShortOpenHashMap.this.n]));
            }
            int pos = Byte2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Byte2ShortOpenHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractByteSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Byte2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Byte2ShortOpenHashMap.this.key[Byte2ShortOpenHashMap.this.n]);
            }
            int pos = Byte2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                final byte k = Byte2ShortOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final byte k) {
            final int oldSize = Byte2ShortOpenHashMap.this.size;
