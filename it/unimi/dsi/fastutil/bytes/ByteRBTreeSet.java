...
public class ByteRBTreeSet extends AbstractByteSortedSet implements Serializable, Cloneable, ByteSortedSet {
    ...
    private class SetIterator implements ByteListIterator {
        ...
        SetIterator(final byte k) {
            this.index = 0;
            final Entry locateKey = ByteRBTreeSet.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Subset extends AbstractByteSortedSet implements Serializable, ByteSortedSet {
        ...
        boolean bottom;
        boolean top;
        final /* synthetic */ ByteRBTreeSet this$0;
        ...
        public Subset(final byte from, final boolean bottom, final byte to, final boolean top) {
            if (!bottom && !top && ByteRBTreeSet.this.compare(from, to) > 0) {
                throw new IllegalArgumentException(new StringBuilder().append("Start element (").append((int)from).append(") is larger than end element (").append((int)to).append(")").toString());
            }
            this.from = from;
            this.bottom = bottom;
            this.to = to;
        ...
        public boolean remove(final byte k) {
            return this.in(k) && ByteRBTreeSet.this.remove(k);
        }
            ...
            SubsetIterator(final Subset subset, final byte k) {
                ...
                if (this.next != null) {
                    if (!subset.bottom && subset.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!subset.top) {
                            final ByteRBTreeSet this$0 = subset.this$0;
