...
public class Byte2BooleanLinkedOpenHashMap extends AbstractByte2BooleanSortedMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Byte2BooleanMap.Entry, Map.Entry<Byte, Boolean> {
        ...
        public boolean setValue(final boolean v) {
            final boolean oldValue = Byte2BooleanLinkedOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Byte2BooleanLinkedOpenHashMap.this.key[this.index]).append("=>").append(Byte2BooleanLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final byte from) {
            ...
            if (from == 0) {
                ...
                for (int pos = HashCommon.mix(from) & Byte2BooleanLinkedOpenHashMap.this.mask; Byte2BooleanLinkedOpenHashMap.this.key[pos] != 0; pos = (pos + 1 & Byte2BooleanLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Byte2BooleanLinkedOpenHashMap this$0 = Byte2BooleanLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Byte2BooleanLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Byte2BooleanLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Byte2BooleanLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Byte2BooleanLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Byte2BooleanLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Byte2BooleanLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Byte2BooleanLinkedOpenHashMap.this.mask);
                byte curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Byte2BooleanLinkedOpenHashMap.this.mask;
                    Label_0354: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0354;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Byte2BooleanMap.Entry> implements Byte2BooleanSortedMap.FastSortedEntrySet {
        ...
        @Override
        public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(final Byte2BooleanMap.Entry fromElement, final Byte2BooleanMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(final Byte2BooleanMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(final Byte2BooleanMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractByteSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Byte2BooleanLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Byte2BooleanLinkedOpenHashMap.this.key[Byte2BooleanLinkedOpenHashMap.this.n]);
            }
            int pos = Byte2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final byte k = Byte2BooleanLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        @Override
        public boolean remove(final byte k) {
            final int oldSize = Byte2BooleanLinkedOpenHashMap.this.size;
