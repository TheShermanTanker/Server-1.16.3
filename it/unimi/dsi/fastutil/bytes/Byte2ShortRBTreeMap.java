...
public class Byte2ShortRBTreeMap extends AbstractByte2ShortSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ShortMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Byte2ShortRBTreeMap.this.findKey((byte)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final byte k) {
            this.index = 0;
            final Entry locateKey = Byte2ShortRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractByte2ShortSortedMap implements Serializable {
        ...
        protected transient ByteSortedSet keys;
        protected transient ShortCollection values;
        final /* synthetic */ Byte2ShortRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ShortMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Byte2ShortRBTreeMap.Entry f = Byte2ShortRBTreeMap.this.findKey((byte)e.getKey());
        ...
        public byte firstByteKey() {
            final Byte2ShortRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public byte lastByteKey() {
            final Byte2ShortRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final byte k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Byte2ShortRBTreeMap this$0 = submap.this$0;
                            final Byte2ShortRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
