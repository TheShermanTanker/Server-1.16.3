...
public class IntRBTreeSet extends AbstractIntSortedSet implements Serializable, Cloneable, IntSortedSet {
    ...
    private class SetIterator implements IntListIterator {
        ...
        SetIterator(final int k) {
            this.index = 0;
            final Entry locateKey = IntRBTreeSet.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Subset extends AbstractIntSortedSet implements Serializable, IntSortedSet {
        ...
        boolean bottom;
        boolean top;
        final /* synthetic */ IntRBTreeSet this$0;
        ...
        public boolean remove(final int k) {
            return this.in(k) && IntRBTreeSet.this.remove(k);
        }
        ...
        public IntSortedSet headSet(final int to) {
            ...
            // Original Bytecode:
            // 
            //     1: getfield        it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.top:Z
            //     4: ifeq            29
            //     7: new             Lit/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset;
            //    10: dup            
            //    11: aload_0         /* this */
            //    12: getfield        it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.this$0:Lit/unimi/dsi/fastutil/ints/IntRBTreeSet;
            //    15: aload_0         /* this */
            //    16: getfield        it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.from:I
            //    19: aload_0         /* this */
            //    20: getfield        it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.bottom:Z
            //    23: iload_1         /* to */
            //    24: iconst_0       
            //    25: invokespecial   it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.<init>:(Lit/unimi/dsi/fastutil/ints/IntRBTreeSet;IZIZ)V
            //    28: areturn        
            //    29: aload_0         /* this */
            //    30: getfield        it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.this$0:Lit/unimi/dsi/fastutil/ints/IntRBTreeSet;
            //    33: iload_1         /* to */
            //    34: aload_0         /* this */
            //    35: getfield        it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.to:I
            //    38: invokevirtual   it/unimi/dsi/fastutil/ints/IntRBTreeSet.compare:(II)I
            //    41: ifge            68
            //    44: new             Lit/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset;
            //    47: dup            
            //    48: aload_0         /* this */
            //    49: getfield        it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.this$0:Lit/unimi/dsi/fastutil/ints/IntRBTreeSet;
            //    52: aload_0         /* this */
            //    53: getfield        it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.from:I
            //    56: aload_0         /* this */
            //    57: getfield        it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.bottom:Z
            //    60: iload_1         /* to */
            //    61: iconst_0       
            //    62: invokespecial   it/unimi/dsi/fastutil/ints/IntRBTreeSet$Subset.<init>:(Lit/unimi/dsi/fastutil/ints/IntRBTreeSet;IZIZ)V
            //    65: goto            69
            //    68: aload_0         /* this */
            //    69: areturn        
            //    MethodParameters:
            ...
            //  ----  -----
            //  to    
            //    StackMapTable: 00 03 1D 26 40 07 00 08
            // 
            ...
            SubsetIterator(final Subset subset, final int k) {
                ...
                if (this.next != null) {
                    if (!subset.bottom && subset.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!subset.top) {
                            final IntRBTreeSet this$0 = subset.this$0;
