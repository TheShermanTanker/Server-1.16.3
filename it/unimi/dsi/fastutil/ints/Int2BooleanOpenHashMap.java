...
public class Int2BooleanOpenHashMap extends AbstractInt2BooleanMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Int2BooleanMap.Entry, Map.Entry<Integer, Boolean> {
        ...
        public boolean equals(final Object o) {
            ...
            return Int2BooleanOpenHashMap.this.key[this.index] == (int)e.getKey() && Int2BooleanOpenHashMap.this.value[this.index] == (boolean)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2BooleanOpenHashMap.this.key[this.index]).append("=>").append(Int2BooleanOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Int2BooleanMap.Entry> implements Int2BooleanMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Int2BooleanMap.Entry> consumer) {
            if (Int2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Int2BooleanOpenHashMap.this.key[Int2BooleanOpenHashMap.this.n], Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.n]));
            }
            int pos = Int2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Int2BooleanOpenHashMap.this.key[pos] != 0) {
                    consumer.accept(new BasicEntry(Int2BooleanOpenHashMap.this.key[pos], Int2BooleanOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2BooleanOpenHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
