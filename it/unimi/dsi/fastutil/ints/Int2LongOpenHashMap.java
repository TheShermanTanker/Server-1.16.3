...
public class Int2LongOpenHashMap extends AbstractInt2LongMap implements Serializable, Cloneable, Hash {
    ...
    public long computeIfAbsent(final int k, final IntToLongFunction mappingFunction) {
    ...
    public long computeIfAbsentNullable(final int k, final IntFunction<? extends Long> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int pos = this.find(k);
        if (pos >= 0) {
            return this.value[pos];
    ...
    public long computeIfPresent(final int k, final BiFunction<? super Integer, ? super Long, ? extends Long> remappingFunction) {
    ...
    public long compute(final int k, final BiFunction<? super Integer, ? super Long, ? extends Long> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
    ...
    public long merge(final int k, final long v, final BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
        if (pos < 0) {
            this.insert(-pos - 1, k, v);
    ...
    final class MapEntry implements Int2LongMap.Entry, Map.Entry<Integer, Long> {
        ...
        public long setValue(final long v) {
            final long oldValue = Int2LongOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Int2LongOpenHashMap.this.key[this.index] == (int)e.getKey() && Int2LongOpenHashMap.this.value[this.index] == (long)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2LongOpenHashMap.this.key[this.index]).append("=>").append(Int2LongOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            int k;
            int p;
            for (k = this.wrapped.getInt(-this.pos - 1), p = (HashCommon.mix(k) & Int2LongOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Int2LongOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Int2LongOpenHashMap.this.mask);
                int curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Int2LongOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Int2LongOpenHashMap this$0 = Int2LongOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2LongOpenHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final int k) {
            final int oldSize = Int2LongOpenHashMap.this.size;
