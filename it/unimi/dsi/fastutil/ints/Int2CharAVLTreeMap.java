...
public class Int2CharAVLTreeMap extends AbstractInt2CharSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2CharMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Int2CharAVLTreeMap.this.findKey((int)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final int k) {
            this.index = 0;
            final Entry locateKey = Int2CharAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private class EntryIterator extends TreeIterator implements ObjectListIterator<Int2CharMap.Entry> {
        ...
        @Override
        public void set(final Int2CharMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public void add(final Int2CharMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class Submap extends AbstractInt2CharSortedMap implements Serializable {
        ...
        protected transient IntSortedSet keys;
        protected transient CharCollection values;
        final /* synthetic */ Int2CharAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2CharMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Int2CharAVLTreeMap.Entry f = Int2CharAVLTreeMap.this.findKey((int)e.getKey());
        ...
        public int firstIntKey() {
            final Int2CharAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public int lastIntKey() {
            final Int2CharAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final int k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Int2CharAVLTreeMap this$0 = submap.this$0;
                            final Int2CharAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
