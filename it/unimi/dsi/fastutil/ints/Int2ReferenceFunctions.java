...
public final class Int2ReferenceFunctions {
    ...
    public static <V> Int2ReferenceFunction<V> primitive(final Function<? super Integer, ? extends V> f) {
        Objects.requireNonNull(f);
        if (f instanceof Int2ReferenceFunction) {
            return (Int2ReferenceFunction<V>)(Int2ReferenceFunction)f;
        }
        if (f instanceof IntFunction) {
            final IntFunction intFunction = (IntFunction)f;
            Objects.requireNonNull(intFunction);
            return (Int2ReferenceFunction<V>)intFunction::apply;
        }
