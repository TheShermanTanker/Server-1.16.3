...
public class Int2ByteAVLTreeMap extends AbstractInt2ByteSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Int2ByteAVLTreeMap.this.findKey((int)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final int k) {
            this.index = 0;
            final Entry locateKey = Int2ByteAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractInt2ByteSortedMap implements Serializable {
        ...
        protected transient IntSortedSet keys;
        protected transient ByteCollection values;
        final /* synthetic */ Int2ByteAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2ByteMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey((int)e.getKey());
        ...
        public int firstIntKey() {
            final Int2ByteAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public int lastIntKey() {
            final Int2ByteAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final int k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Int2ByteAVLTreeMap this$0 = submap.this$0;
                            final Int2ByteAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
