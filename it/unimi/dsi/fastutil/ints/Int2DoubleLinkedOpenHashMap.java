...
public class Int2DoubleLinkedOpenHashMap extends AbstractInt2DoubleSortedMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Int2DoubleMap.Entry, Map.Entry<Integer, Double> {
        ...
        public boolean equals(final Object o) {
            ...
            return Int2DoubleLinkedOpenHashMap.this.key[this.index] == (int)e.getKey() && Double.doubleToLongBits(Int2DoubleLinkedOpenHashMap.this.value[this.index]) == Double.doubleToLongBits((double)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2DoubleLinkedOpenHashMap.this.key[this.index]).append("=>").append(Int2DoubleLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractIntSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2DoubleLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
