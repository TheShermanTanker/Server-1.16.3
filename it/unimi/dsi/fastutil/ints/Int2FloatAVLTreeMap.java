...
public class Int2FloatAVLTreeMap extends AbstractInt2FloatSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Int2FloatAVLTreeMap.this.findKey((int)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final int k) {
            this.index = 0;
            final Entry locateKey = Int2FloatAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractInt2FloatSortedMap implements Serializable {
        ...
        protected transient IntSortedSet keys;
        protected transient FloatCollection values;
        final /* synthetic */ Int2FloatAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey((int)e.getKey());
        ...
        public int firstIntKey() {
            final Int2FloatAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public int lastIntKey() {
            final Int2FloatAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final int k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Int2FloatAVLTreeMap this$0 = submap.this$0;
                            final Int2FloatAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
