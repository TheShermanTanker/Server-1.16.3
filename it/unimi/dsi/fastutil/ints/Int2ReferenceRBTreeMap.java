...
public class Int2ReferenceRBTreeMap<V> extends AbstractInt2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
        ...
        // Original Bytecode:
        // 
        //     1: getfield        it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap.entries:Lit/unimi/dsi/fastutil/objects/ObjectSortedSet;
        //     4: ifnonnull       19
        //     7: aload_0         /* this */
        //     8: new             Lit/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$1;
        //    11: dup            
        //    12: aload_0         /* this */
        //    13: invokespecial   it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$1.<init>:(Lit/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap;)V
        //    16: putfield        it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap.entries:Lit/unimi/dsi/fastutil/objects/ObjectSortedSet;
        //    19: aload_0         /* this */
        //    20: getfield        it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap.entries:Lit/unimi/dsi/fastutil/objects/ObjectSortedSet;
        //    23: areturn        
        //    Signature:
        //  ()Lit/unimi/dsi/fastutil/objects/ObjectSortedSet<Lit/unimi/dsi/fastutil/ints/Int2ReferenceMap$Entry<TV;>;>;
    ...
    private class TreeIterator {
        ...
        TreeIterator(final int k) {
            this.index = 0;
            final Entry<V> locateKey = Int2ReferenceRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractInt2ReferenceSortedMap<V> implements Serializable {
        ...
        protected transient IntSortedSet keys;
        protected transient ReferenceCollection<V> values;
        final /* synthetic */ Int2ReferenceRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Int2ReferenceRBTreeMap.Entry<V> f = Int2ReferenceRBTreeMap.this.findKey((int)e.getKey());
        ...
        public int firstIntKey() {
            final Int2ReferenceRBTreeMap.Entry<V> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public int lastIntKey() {
            final Int2ReferenceRBTreeMap.Entry<V> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final int k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Int2ReferenceRBTreeMap this$0 = submap.this$0;
                            final Int2ReferenceRBTreeMap.Entry<V> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
