...
public class Int2BooleanLinkedOpenHashMap extends AbstractInt2BooleanSortedMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Int2BooleanMap.Entry, Map.Entry<Integer, Boolean> {
        ...
        public boolean equals(final Object o) {
            ...
            return Int2BooleanLinkedOpenHashMap.this.key[this.index] == (int)e.getKey() && Int2BooleanLinkedOpenHashMap.this.value[this.index] == (boolean)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2BooleanLinkedOpenHashMap.this.key[this.index]).append("=>").append(Int2BooleanLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractIntSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2BooleanLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2BooleanLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
