...
public final class Int2ShortSortedMaps {
    ...
    public static ObjectBidirectionalIterator<Int2ShortMap.Entry> fastIterator(final Int2ShortSortedMap map) {
    ...
    public static ObjectBidirectionalIterable<Int2ShortMap.Entry> fastIterable(final Int2ShortSortedMap map) {
        final ObjectSortedSet<Int2ShortMap.Entry> entries = map.int2ShortEntrySet();
        ObjectBidirectionalIterable<Int2ShortMap.Entry> objectBidirectionalIterable;
        if (entries instanceof Int2ShortSortedMap.FastSortedEntrySet) {
            final Int2ShortSortedMap.FastSortedEntrySet set = (Int2ShortSortedMap.FastSortedEntrySet)entries;
    ...
    public static class EmptySortedMap extends Int2ShortMaps.EmptyMap implements Int2ShortSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
            return (ObjectSortedSet<Int2ShortMap.Entry>)ObjectSortedSets.EMPTY_SET;
        }
        
        @Deprecated
        @Override
        public ObjectSortedSet<Map.Entry<Integer, Short>> entrySet() {
            return (ObjectSortedSet<Map.Entry<Integer, Short>>)ObjectSortedSets.EMPTY_SET;
        }
    ...
    public static class Singleton extends Int2ShortMaps.Singleton implements Int2ShortSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractInt2ShortMap.BasicEntry(this.key, this.value), (java.util.Comparator<? super AbstractInt2ShortMap.BasicEntry>)Int2ShortSortedMaps.entryComparator(this.comparator));
            }
            return (ObjectSortedSet<Int2ShortMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class SynchronizedSortedMap extends Int2ShortMaps.SynchronizedMap implements Int2ShortSortedMap, Serializable {
        ...
        public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Int2ShortMap.Entry>synchronize(this.sortedMap.int2ShortEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Int2ShortMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class UnmodifiableSortedMap extends Int2ShortMaps.UnmodifiableMap implements Int2ShortSortedMap, Serializable {
        ...
        public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Int2ShortMap.Entry>unmodifiable(this.sortedMap.int2ShortEntrySet());
            }
            return (ObjectSortedSet<Int2ShortMap.Entry>)(ObjectSortedSet)this.entries;
        }
