...
public class Int2ShortOpenCustomHashMap extends AbstractInt2ShortMap implements Serializable, Cloneable, Hash {
    ...
    public Int2ShortOpenCustomHashMap(final int expected, final float f, final IntHash.Strategy strategy) {
    ...
    public Int2ShortOpenCustomHashMap(final int expected, final IntHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Int2ShortOpenCustomHashMap(final IntHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Int2ShortOpenCustomHashMap(final Map<? extends Integer, ? extends Short> m, final float f, final IntHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Int2ShortOpenCustomHashMap(final Map<? extends Integer, ? extends Short> m, final IntHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Int2ShortOpenCustomHashMap(final Int2ShortMap m, final float f, final IntHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Int2ShortOpenCustomHashMap(final Int2ShortMap m, final IntHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Int2ShortOpenCustomHashMap(final int[] k, final short[] v, final float f, final IntHash.Strategy strategy) {
    ...
    public Int2ShortOpenCustomHashMap(final int[] k, final short[] v, final IntHash.Strategy strategy) {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Int2ShortOpenCustomHashMap.this.value[Int2ShortOpenCustomHashMap.this.n]);
                    }
                    int pos = Int2ShortOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Int2ShortOpenCustomHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Int2ShortOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Int2ShortMap.Entry, Map.Entry<Integer, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Int2ShortOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Int2ShortOpenCustomHashMap.this.strategy.equals(Int2ShortOpenCustomHashMap.this.key[this.index], (int)e.getKey()) && Int2ShortOpenCustomHashMap.this.value[this.index] == (short)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2ShortOpenCustomHashMap.this.key[this.index]).append("=>").append((int)Int2ShortOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            int k;
            int p;
            for (k = this.wrapped.getInt(-this.pos - 1), p = (HashCommon.mix(Int2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ShortOpenCustomHashMap.this.mask); !Int2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Int2ShortOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Int2ShortOpenCustomHashMap.this.mask);
                int curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Int2ShortOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2ShortOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Int2ShortOpenCustomHashMap this$0 = Int2ShortOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Int2ShortMap.Entry> implements Int2ShortMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Int2ShortMap.Entry> consumer) {
            if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Int2ShortOpenCustomHashMap.this.key[Int2ShortOpenCustomHashMap.this.n], Int2ShortOpenCustomHashMap.this.value[Int2ShortOpenCustomHashMap.this.n]));
            }
            int pos = Int2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ShortOpenCustomHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2ShortOpenCustomHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final int k) {
            final int oldSize = Int2ShortOpenCustomHashMap.this.size;
