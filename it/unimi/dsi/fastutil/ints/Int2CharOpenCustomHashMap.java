...
public class Int2CharOpenCustomHashMap extends AbstractInt2CharMap implements Serializable, Cloneable, Hash {
    ...
    public Int2CharOpenCustomHashMap(final int expected, final float f, final IntHash.Strategy strategy) {
    ...
    public Int2CharOpenCustomHashMap(final int expected, final IntHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Int2CharOpenCustomHashMap(final IntHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Int2CharOpenCustomHashMap(final Map<? extends Integer, ? extends Character> m, final float f, final IntHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Int2CharOpenCustomHashMap(final Map<? extends Integer, ? extends Character> m, final IntHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Int2CharOpenCustomHashMap(final Int2CharMap m, final float f, final IntHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Int2CharOpenCustomHashMap(final Int2CharMap m, final IntHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Int2CharOpenCustomHashMap(final int[] k, final char[] v, final float f, final IntHash.Strategy strategy) {
    ...
    public Int2CharOpenCustomHashMap(final int[] k, final char[] v, final IntHash.Strategy strategy) {
            ...
            this.values = new AbstractCharCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Int2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.n]);
                    }
                    int pos = Int2CharOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Int2CharOpenCustomHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Int2CharOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Int2CharMap.Entry, Map.Entry<Integer, Character> {
        ...
        public char setValue(final char v) {
            final char oldValue = Int2CharOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Int2CharOpenCustomHashMap.this.strategy.equals(Int2CharOpenCustomHashMap.this.key[this.index], (int)e.getKey()) && Int2CharOpenCustomHashMap.this.value[this.index] == (char)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2CharOpenCustomHashMap.this.key[this.index]).append("=>").append(Int2CharOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            int k;
            int p;
            for (k = this.wrapped.getInt(-this.pos - 1), p = (HashCommon.mix(Int2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Int2CharOpenCustomHashMap.this.mask); !Int2CharOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Int2CharOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Int2CharOpenCustomHashMap.this.mask);
                int curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Int2CharOpenCustomHashMap.this.strategy.hashCode(curr)) & Int2CharOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Int2CharOpenCustomHashMap this$0 = Int2CharOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Int2CharMap.Entry> implements Int2CharMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Int2CharMap.Entry> consumer) {
            if (Int2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Int2CharOpenCustomHashMap.this.key[Int2CharOpenCustomHashMap.this.n], Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.n]));
            }
            int pos = Int2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2CharOpenCustomHashMap.this.key[pos] != 0) {
                    consumer.accept(new BasicEntry(Int2CharOpenCustomHashMap.this.key[pos], Int2CharOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2CharOpenCustomHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final int k) {
            final int oldSize = Int2CharOpenCustomHashMap.this.size;
