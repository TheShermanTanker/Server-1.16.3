...
public class Int2CharArrayMap extends AbstractInt2CharMap implements Serializable, Cloneable {
    ...
    public IntSet keySet() {
        return new AbstractIntSet() {
            ...
            public boolean remove(final int k) {
                ...
                final int tail = Int2CharArrayMap.this.size - oldPos - 1;
            ...
            public IntIterator iterator() {
                return new IntIterator() {
                    ...
                    public void remove() {
                        ...
                        final int tail = Int2CharArrayMap.this.size - this.pos;
    ...
    private final class EntrySet extends AbstractObjectSet<Int2CharMap.Entry> implements Int2CharMap.FastEntrySet {
        ...
        public ObjectIterator<Int2CharMap.Entry> iterator() {
            return new ObjectIterator<Int2CharMap.Entry>() {
                ...
                public Int2CharMap.Entry next() {
                    ...
                    final int[] access$100 = Int2CharArrayMap.this.key;
                    final int next = this.next;
                    this.curr = next;
                    return new BasicEntry(access$100[next], Int2CharArrayMap.this.value[this.next++]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    final int tail = Int2CharArrayMap.this.size-- - this.next--;
        ...
        public boolean contains(final Object o) {
            ...
            return Int2CharArrayMap.this.containsKey(k) && Int2CharArrayMap.this.get(k) == (char)e.getValue();
        }
