...
public class Int2IntOpenHashMap extends AbstractInt2IntMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Int2IntMap.Entry, Map.Entry<Integer, Integer> {
        ...
        public boolean equals(final Object o) {
            ...
            return Int2IntOpenHashMap.this.key[this.index] == (int)e.getKey() && Int2IntOpenHashMap.this.value[this.index] == (int)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2IntOpenHashMap.this.key[this.index]).append("=>").append(Int2IntOpenHashMap.this.value[this.index]).toString();
        }
    }
