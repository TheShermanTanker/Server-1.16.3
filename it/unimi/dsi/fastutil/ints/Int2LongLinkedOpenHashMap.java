...
public class Int2LongLinkedOpenHashMap extends AbstractInt2LongSortedMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Int2LongMap.Entry, Map.Entry<Integer, Long> {
        ...
        public boolean equals(final Object o) {
            ...
            return Int2LongLinkedOpenHashMap.this.key[this.index] == (int)e.getKey() && Int2LongLinkedOpenHashMap.this.value[this.index] == (long)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2LongLinkedOpenHashMap.this.key[this.index]).append("=>").append(Int2LongLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractIntSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2LongLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2LongLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
