...
public class Int2LongOpenCustomHashMap extends AbstractInt2LongMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Int2LongMap.Entry, Map.Entry<Integer, Long> {
        ...
        public boolean equals(final Object o) {
            ...
            return Int2LongOpenCustomHashMap.this.strategy.equals(Int2LongOpenCustomHashMap.this.key[this.index], (int)e.getKey()) && Int2LongOpenCustomHashMap.this.value[this.index] == (long)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2LongOpenCustomHashMap.this.key[this.index]).append("=>").append(Int2LongOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Int2LongMap.Entry> implements Int2LongMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Int2LongMap.Entry> consumer) {
            if (Int2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Int2LongOpenCustomHashMap.this.key[Int2LongOpenCustomHashMap.this.n], Int2LongOpenCustomHashMap.this.value[Int2LongOpenCustomHashMap.this.n]));
            }
            int pos = Int2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2LongOpenCustomHashMap.this.key[pos] != 0) {
                    consumer.accept(new BasicEntry(Int2LongOpenCustomHashMap.this.key[pos], Int2LongOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2LongOpenCustomHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
