...
public class Int2FloatOpenHashMap extends AbstractInt2FloatMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Int2FloatMap.Entry, Map.Entry<Integer, Float> {
        ...
        public float setValue(final float v) {
            final float oldValue = Int2FloatOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Int2FloatOpenHashMap.this.key[this.index] == (int)e.getKey() && Float.floatToIntBits(Int2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits((float)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2FloatOpenHashMap.this.key[this.index]).append("=>").append(Int2FloatOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            int k;
            int p;
            for (k = this.wrapped.getInt(-this.pos - 1), p = (HashCommon.mix(k) & Int2FloatOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Int2FloatOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Int2FloatOpenHashMap.this.mask);
                int curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Int2FloatOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Int2FloatOpenHashMap this$0 = Int2FloatOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2FloatOpenHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final int k) {
            final int oldSize = Int2FloatOpenHashMap.this.size;
