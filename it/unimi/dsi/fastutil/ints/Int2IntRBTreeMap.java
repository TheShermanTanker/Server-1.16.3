...
public class Int2IntRBTreeMap extends AbstractInt2IntSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Int2IntRBTreeMap.this.findKey((int)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Int2IntMap.Entry> subSet(final Int2IntMap.Entry from, final Int2IntMap.Entry to) {
                    return Int2IntRBTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2IntEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Int2IntMap.Entry> headSet(final Int2IntMap.Entry to) {
                    return Int2IntRBTreeMap.this.headMap(to.getIntKey()).int2IntEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Int2IntMap.Entry> tailSet(final Int2IntMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final int k) {
            this.index = 0;
            final Entry locateKey = Int2IntRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractInt2IntSortedMap implements Serializable {
        ...
        protected transient IntSortedSet keys;
        protected transient IntCollection values;
        final /* synthetic */ Int2IntRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Int2IntRBTreeMap.Entry f = Int2IntRBTreeMap.this.findKey((int)e.getKey());
        ...
        public int firstIntKey() {
            final Int2IntRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public int lastIntKey() {
            final Int2IntRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final int k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Int2IntRBTreeMap this$0 = submap.this$0;
                            final Int2IntRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
