...
public class Int2ByteOpenHashMap extends AbstractInt2ByteMap implements Serializable, Cloneable, Hash {
    ...
    public byte computeIfAbsent(final int k, final IntUnaryOperator mappingFunction) {
    ...
    public byte computeIfAbsentNullable(final int k, final IntFunction<? extends Byte> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int pos = this.find(k);
        if (pos >= 0) {
            return this.value[pos];
    ...
    public byte computeIfPresent(final int k, final BiFunction<? super Integer, ? super Byte, ? extends Byte> remappingFunction) {
    ...
    public byte compute(final int k, final BiFunction<? super Integer, ? super Byte, ? extends Byte> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
    ...
    public byte merge(final int k, final byte v, final BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
        if (pos < 0) {
            this.insert(-pos - 1, k, v);
            ...
            this.values = new AbstractByteCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Int2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Int2ByteOpenHashMap.this.value[Int2ByteOpenHashMap.this.n]);
                    }
                    int pos = Int2ByteOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Int2ByteOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Int2ByteOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Int2ByteMap.Entry, Map.Entry<Integer, Byte> {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Int2ByteOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Int2ByteOpenHashMap.this.key[this.index] == (int)e.getKey() && Int2ByteOpenHashMap.this.value[this.index] == (byte)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2ByteOpenHashMap.this.key[this.index]).append("=>").append((int)Int2ByteOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            int k;
            int p;
            for (k = this.wrapped.getInt(-this.pos - 1), p = (HashCommon.mix(k) & Int2ByteOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Int2ByteOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Int2ByteOpenHashMap.this.mask);
                int curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Int2ByteOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Int2ByteOpenHashMap this$0 = Int2ByteOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2ByteOpenHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final int k) {
            final int oldSize = Int2ByteOpenHashMap.this.size;
