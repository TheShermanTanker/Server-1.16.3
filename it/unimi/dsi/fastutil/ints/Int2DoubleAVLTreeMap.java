...
public class Int2DoubleAVLTreeMap extends AbstractInt2DoubleSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Int2DoubleAVLTreeMap.this.findKey((int)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Int2DoubleMap.Entry> subSet(final Int2DoubleMap.Entry from, final Int2DoubleMap.Entry to) {
                    return Int2DoubleAVLTreeMap.this.subMap(from.getIntKey(), to.getIntKey()).int2DoubleEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Int2DoubleMap.Entry> headSet(final Int2DoubleMap.Entry to) {
                    return Int2DoubleAVLTreeMap.this.headMap(to.getIntKey()).int2DoubleEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(final Int2DoubleMap.Entry from) {
    ...
    private static final class Entry extends BasicEntry implements Cloneable {
        ...
        public boolean equals(final Object o) {
            ...
            return this.key == (int)e.getKey() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits((double)e.getValue());
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final int k) {
            this.index = 0;
            final Entry locateKey = Int2DoubleAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractInt2DoubleSortedMap implements Serializable {
        ...
        protected transient IntSortedSet keys;
        protected transient DoubleCollection values;
        final /* synthetic */ Int2DoubleAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2DoubleMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey((int)e.getKey());
        ...
        public int firstIntKey() {
            final Int2DoubleAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public int lastIntKey() {
            final Int2DoubleAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final int k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Int2DoubleAVLTreeMap this$0 = submap.this$0;
                            final Int2DoubleAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
