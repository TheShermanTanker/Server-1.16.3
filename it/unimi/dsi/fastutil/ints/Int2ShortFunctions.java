...
public final class Int2ShortFunctions {
    ...
    public static Int2ShortFunction primitive(final Function<? super Integer, ? extends Short> f) {
        Objects.requireNonNull(f);
        if (f instanceof Int2ShortFunction) {
            return (Int2ShortFunction)f;
        }
        if (f instanceof IntUnaryOperator) {
            return key -> SafeMath.safeIntToShort(((IntUnaryOperator)f).applyAsInt(key));
        }
    ...
    public static class PrimitiveFunction implements Int2ShortFunction {
        ...
        protected PrimitiveFunction(final java.util.function.Function<? super Integer, ? extends Short> function) {
