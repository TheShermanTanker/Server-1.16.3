...
public class Int2ReferenceOpenCustomHashMap<V> extends AbstractInt2ReferenceMap<V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Int2ReferenceMap.Entry<V>, Map.Entry<Integer, V> {
        ...
        public boolean equals(final Object o) {
            ...
            return Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[this.index], (int)e.getKey()) && Int2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Int2ReferenceOpenCustomHashMap.this.key[this.index]).append("=>").append(Int2ReferenceOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry<V>> implements Int2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(final Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
            if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Int2ReferenceOpenCustomHashMap.this.key[Int2ReferenceOpenCustomHashMap.this.n], Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n]));
            }
            int pos = Int2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Int2ReferenceOpenCustomHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractIntSet {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2ReferenceOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2ReferenceOpenCustomHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
