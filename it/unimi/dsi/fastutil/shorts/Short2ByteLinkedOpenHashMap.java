...
public class Short2ByteLinkedOpenHashMap extends AbstractShort2ByteSortedMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractByteCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Short2ByteLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Short2ByteLinkedOpenHashMap.this.value[Short2ByteLinkedOpenHashMap.this.n]);
                    }
                    int pos = Short2ByteLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2ByteLinkedOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Short2ByteLinkedOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Short2ByteMap.Entry, Map.Entry<Short, Byte> {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Short2ByteLinkedOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2ByteLinkedOpenHashMap.this.key[this.index]).append("=>").append((int)Short2ByteLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final short from) {
            ...
            if (from == 0) {
                ...
                for (int pos = HashCommon.mix(from) & Short2ByteLinkedOpenHashMap.this.mask; Short2ByteLinkedOpenHashMap.this.key[pos] != 0; pos = (pos + 1 & Short2ByteLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Short2ByteLinkedOpenHashMap this$0 = Short2ByteLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Short2ByteLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Short2ByteLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Short2ByteLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Short2ByteLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Short2ByteLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Short2ByteLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Short2ByteLinkedOpenHashMap.this.mask);
                short curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Short2ByteLinkedOpenHashMap.this.mask;
                    Label_0354: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0354;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Short2ByteMap.Entry> implements Short2ByteSortedMap.FastSortedEntrySet {
        ...
        @Override
        public ObjectSortedSet<Short2ByteMap.Entry> subSet(final Short2ByteMap.Entry fromElement, final Short2ByteMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Short2ByteMap.Entry> headSet(final Short2ByteMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Short2ByteMap.Entry> tailSet(final Short2ByteMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
    ...
    private final class KeySet extends AbstractShortSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2ByteLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2ByteLinkedOpenHashMap.this.key[Short2ByteLinkedOpenHashMap.this.n]);
            }
            int pos = Short2ByteLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2ByteLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final short k) {
            final int oldSize = Short2ByteLinkedOpenHashMap.this.size;
