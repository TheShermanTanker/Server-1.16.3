...
public class Short2FloatOpenHashMap extends AbstractShort2FloatMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractFloatCollection() {
                ...
                public void forEach(final DoubleConsumer consumer) {
                    if (Short2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept((double)Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]);
                    }
                    int pos = Short2FloatOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2FloatOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((double)Short2FloatOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Short2FloatMap.Entry, Map.Entry<Short, Float> {
        ...
        public boolean equals(final Object o) {
            ...
            return Short2FloatOpenHashMap.this.key[this.index] == (short)e.getKey() && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits((float)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2FloatOpenHashMap.this.key[this.index]).append("=>").append(Short2FloatOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2FloatMap.Entry> implements Short2FloatMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Short2FloatMap.Entry> consumer) {
            if (Short2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2FloatOpenHashMap.this.key[Short2FloatOpenHashMap.this.n], Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]));
            }
            int pos = Short2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2FloatOpenHashMap.this.key[pos] != 0) {
                    consumer.accept(new BasicEntry(Short2FloatOpenHashMap.this.key[pos], Short2FloatOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2FloatOpenHashMap.this.key[Short2FloatOpenHashMap.this.n]);
            }
            int pos = Short2FloatOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2FloatOpenHashMap.this.key[pos];
                if (k != 0) {
