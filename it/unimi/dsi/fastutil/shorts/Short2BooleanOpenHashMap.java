...
public class Short2BooleanOpenHashMap extends AbstractShort2BooleanMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Short2BooleanMap.Entry, Map.Entry<Short, Boolean> {
        ...
        public boolean setValue(final boolean v) {
            final boolean oldValue = Short2BooleanOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2BooleanOpenHashMap.this.key[this.index]).append("=>").append(Short2BooleanOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            short k;
            int p;
            for (k = this.wrapped.getShort(-this.pos - 1), p = (HashCommon.mix(k) & Short2BooleanOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Short2BooleanOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Short2BooleanOpenHashMap.this.mask);
                short curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Short2BooleanOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Short2BooleanOpenHashMap this$0 = Short2BooleanOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements Short2BooleanMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Short2BooleanMap.Entry> consumer) {
            if (Short2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2BooleanOpenHashMap.this.key[Short2BooleanOpenHashMap.this.n], Short2BooleanOpenHashMap.this.value[Short2BooleanOpenHashMap.this.n]));
            }
            int pos = Short2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2BooleanOpenHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2BooleanOpenHashMap.this.key[Short2BooleanOpenHashMap.this.n]);
            }
            int pos = Short2BooleanOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2BooleanOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        @Override
        public boolean remove(final short k) {
            final int oldSize = Short2BooleanOpenHashMap.this.size;
