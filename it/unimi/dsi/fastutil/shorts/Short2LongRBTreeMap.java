...
public class Short2LongRBTreeMap extends AbstractShort2LongSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Short2LongRBTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Short2LongMap.Entry> subSet(final Short2LongMap.Entry from, final Short2LongMap.Entry to) {
                    return Short2LongRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Short2LongMap.Entry> headSet(final Short2LongMap.Entry to) {
                    return Short2LongRBTreeMap.this.headMap(to.getShortKey()).short2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Short2LongMap.Entry> tailSet(final Short2LongMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry locateKey = Short2LongRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2LongSortedMap implements Serializable {
        ...
        protected transient ShortSortedSet keys;
        protected transient LongCollection values;
        final /* synthetic */ Short2LongRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2LongRBTreeMap.Entry f = Short2LongRBTreeMap.this.findKey((short)e.getKey());
        ...
        public short firstShortKey() {
            final Short2LongRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public short lastShortKey() {
            final Short2LongRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2LongRBTreeMap this$0 = submap.this$0;
                            final Short2LongRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
