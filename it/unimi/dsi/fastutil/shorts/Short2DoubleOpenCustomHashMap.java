...
public class Short2DoubleOpenCustomHashMap extends AbstractShort2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Short2DoubleMap.Entry, Map.Entry<Short, Double> {
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2DoubleOpenCustomHashMap.this.key[this.index]).append("=>").append(Short2DoubleOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry> implements Short2DoubleMap.FastEntrySet {
        ...
        public boolean remove(final Object o) {
            ...
            if (Short2DoubleOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
                ...
                if (!Short2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Short2DoubleOpenCustomHashMap.this.mask)]) != 0) {
                        if (Short2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && Double.doubleToLongBits(Short2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
        ...
        public void forEach(final Consumer<? super Short2DoubleMap.Entry> consumer) {
            if (Short2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2DoubleOpenCustomHashMap.this.key[Short2DoubleOpenCustomHashMap.this.n], Short2DoubleOpenCustomHashMap.this.value[Short2DoubleOpenCustomHashMap.this.n]));
            }
            int pos = Short2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2DoubleOpenCustomHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Short2DoubleOpenCustomHashMap.this.key[Short2DoubleOpenCustomHashMap.this.n]);
            }
            int pos = Short2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2DoubleOpenCustomHashMap.this.key[pos];
                if (k != 0) {
