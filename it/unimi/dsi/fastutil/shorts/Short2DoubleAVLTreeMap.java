...
public class Short2DoubleAVLTreeMap extends AbstractShort2DoubleSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Short2DoubleAVLTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Short2DoubleMap.Entry> subSet(final Short2DoubleMap.Entry from, final Short2DoubleMap.Entry to) {
                    return Short2DoubleAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2DoubleEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Short2DoubleMap.Entry> headSet(final Short2DoubleMap.Entry to) {
                    return Short2DoubleAVLTreeMap.this.headMap(to.getShortKey()).short2DoubleEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(final Short2DoubleMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry locateKey = Short2DoubleAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2DoubleSortedMap implements Serializable {
        ...
        protected transient ShortSortedSet keys;
        protected transient DoubleCollection values;
        final /* synthetic */ Short2DoubleAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2DoubleMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2DoubleAVLTreeMap.Entry f = Short2DoubleAVLTreeMap.this.findKey((short)e.getKey());
        ...
        public short firstShortKey() {
            final Short2DoubleAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public short lastShortKey() {
            final Short2DoubleAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2DoubleAVLTreeMap this$0 = submap.this$0;
                            final Short2DoubleAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
