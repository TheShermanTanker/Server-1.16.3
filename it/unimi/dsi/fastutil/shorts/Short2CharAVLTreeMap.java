...
public class Short2CharAVLTreeMap extends AbstractShort2CharSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Short2CharAVLTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Short2CharMap.Entry> subSet(final Short2CharMap.Entry from, final Short2CharMap.Entry to) {
                    return Short2CharAVLTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2CharEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Short2CharMap.Entry> headSet(final Short2CharMap.Entry to) {
                    return Short2CharAVLTreeMap.this.headMap(to.getShortKey()).short2CharEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Short2CharMap.Entry> tailSet(final Short2CharMap.Entry from) {
    ...
    private static final class Entry extends BasicEntry implements Cloneable {
        ...
        public boolean equals(final Object o) {
            ...
            return this.key == (short)e.getKey() && this.value == (char)e.getValue();
        }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry locateKey = Short2CharAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2CharSortedMap implements Serializable {
        ...
        protected transient ShortSortedSet keys;
        protected transient CharCollection values;
        final /* synthetic */ Short2CharAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2CharAVLTreeMap.Entry f = Short2CharAVLTreeMap.this.findKey((short)e.getKey());
        ...
        public short firstShortKey() {
            final Short2CharAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public short lastShortKey() {
            final Short2CharAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2CharAVLTreeMap this$0 = submap.this$0;
                            final Short2CharAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
