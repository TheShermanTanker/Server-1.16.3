...
public class Short2CharOpenHashMap extends AbstractShort2CharMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractCharCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Short2CharOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Short2CharOpenHashMap.this.value[Short2CharOpenHashMap.this.n]);
                    }
                    int pos = Short2CharOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2CharOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Short2CharOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Short2CharMap.Entry, Map.Entry<Short, Character> {
        ...
        public char setValue(final char v) {
            final char oldValue = Short2CharOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Short2CharOpenHashMap.this.key[this.index] == (short)e.getKey() && Short2CharOpenHashMap.this.value[this.index] == (char)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2CharOpenHashMap.this.key[this.index]).append("=>").append(Short2CharOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            short k;
            int p;
            for (k = this.wrapped.getShort(-this.pos - 1), p = (HashCommon.mix(k) & Short2CharOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Short2CharOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Short2CharOpenHashMap.this.mask);
                short curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Short2CharOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Short2CharOpenHashMap this$0 = Short2CharOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Short2CharMap.Entry> consumer) {
            if (Short2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2CharOpenHashMap.this.key[Short2CharOpenHashMap.this.n], Short2CharOpenHashMap.this.value[Short2CharOpenHashMap.this.n]));
            }
            int pos = Short2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2CharOpenHashMap.this.key[pos] != 0) {
                    consumer.accept(new BasicEntry(Short2CharOpenHashMap.this.key[pos], Short2CharOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2CharOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2CharOpenHashMap.this.key[Short2CharOpenHashMap.this.n]);
            }
            int pos = Short2CharOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2CharOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final short k) {
            final int oldSize = Short2CharOpenHashMap.this.size;
