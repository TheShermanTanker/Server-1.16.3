...
public class ShortArrayIndirectPriorityQueue implements ShortIndirectPriorityQueue {
    ...
    public ShortArrayIndirectPriorityQueue(final short[] refArray, final int capacity, final ShortComparator c) {
    ...
    public ShortArrayIndirectPriorityQueue(final short[] refArray, final int capacity) {
        this(refArray, capacity, null);
    }
    
    public ShortArrayIndirectPriorityQueue(final short[] refArray, final ShortComparator c) {
        this(refArray, refArray.length, c);
    }
    
    public ShortArrayIndirectPriorityQueue(final short[] refArray) {
        this(refArray, refArray.length, null);
    }
    
    public ShortArrayIndirectPriorityQueue(final short[] refArray, final int[] a, final int size, final ShortComparator c) {
        this(refArray, 0, c);
        this.array = a;
        this.size = size;
    }
    ...
    public ShortArrayIndirectPriorityQueue(final short[] refArray, final int[] a, final int size) {
    ...
    public int front(final int[] a) {
        final short top = this.refArray[this.array[this.findFirst()]];
        int i = this.size;
        int c = 0;
        while (i-- != 0) {
