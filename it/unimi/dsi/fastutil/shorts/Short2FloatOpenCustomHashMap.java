...
public class Short2FloatOpenCustomHashMap extends AbstractShort2FloatMap implements Serializable, Cloneable, Hash {
    ...
    public float computeIfAbsent(final short k, final IntToDoubleFunction mappingFunction) {
    ...
    public float computeIfAbsentNullable(final short k, final IntFunction<? extends Float> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int pos = this.find(k);
        if (pos >= 0) {
            return this.value[pos];
    ...
    public float computeIfPresent(final short k, final BiFunction<? super Short, ? super Float, ? extends Float> remappingFunction) {
    ...
    public float compute(final short k, final BiFunction<? super Short, ? super Float, ? extends Float> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
    ...
    public float merge(final short k, final float v, final BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
        if (pos < 0) {
            this.insert(-pos - 1, k, v);
    ...
    final class MapEntry implements Short2FloatMap.Entry, Map.Entry<Short, Float> {
        ...
        public boolean equals(final Object o) {
            ...
            return Short2FloatOpenCustomHashMap.this.strategy.equals(Short2FloatOpenCustomHashMap.this.key[this.index], (short)e.getKey()) && Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits((float)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2FloatOpenCustomHashMap.this.key[this.index]).append("=>").append(Short2FloatOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2FloatMap.Entry> implements Short2FloatMap.FastEntrySet {
        ...
        public boolean remove(final Object o) {
            ...
            if (Short2FloatOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
                ...
                if (!Short2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Short2FloatOpenCustomHashMap.this.mask)]) != 0) {
                        if (Short2FloatOpenCustomHashMap.this.strategy.equals(curr, k) && Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
        ...
        public void forEach(final Consumer<? super Short2FloatMap.Entry> consumer) {
            if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2FloatOpenCustomHashMap.this.key[Short2FloatOpenCustomHashMap.this.n], Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.n]));
            }
            int pos = Short2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2FloatOpenCustomHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Short2FloatOpenCustomHashMap.this.key[Short2FloatOpenCustomHashMap.this.n]);
            }
            int pos = Short2FloatOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2FloatOpenCustomHashMap.this.key[pos];
                if (k != 0) {
