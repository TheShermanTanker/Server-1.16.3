...
public class Short2CharOpenCustomHashMap extends AbstractShort2CharMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractCharCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Short2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.n]);
                    }
                    int pos = Short2CharOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2CharOpenCustomHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Short2CharOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Short2CharMap.Entry, Map.Entry<Short, Character> {
        ...
        public boolean equals(final Object o) {
            ...
            return Short2CharOpenCustomHashMap.this.strategy.equals(Short2CharOpenCustomHashMap.this.key[this.index], (short)e.getKey()) && Short2CharOpenCustomHashMap.this.value[this.index] == (char)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2CharOpenCustomHashMap.this.key[this.index]).append("=>").append(Short2CharOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Short2CharMap.Entry> consumer) {
            if (Short2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2CharOpenCustomHashMap.this.key[Short2CharOpenCustomHashMap.this.n], Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.n]));
            }
            int pos = Short2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2CharOpenCustomHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Short2CharOpenCustomHashMap.this.key[Short2CharOpenCustomHashMap.this.n]);
            }
            int pos = Short2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2CharOpenCustomHashMap.this.key[pos];
                if (k != 0) {
