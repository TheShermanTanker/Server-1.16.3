    ...
    public ShortSet keySet() {
        return new AbstractShortSet() {
            ...
            public boolean remove(final short k) {
                ...
                final int tail = Short2LongArrayMap.this.size - oldPos - 1;
            ...
            public ShortIterator iterator() {
                return new ShortIterator() {
                    ...
                    public void remove() {
                        ...
                        final int tail = Short2LongArrayMap.this.size - this.pos;
        ...
        public ObjectIterator<Short2LongMap.Entry> iterator() {
            return new ObjectIterator<Short2LongMap.Entry>() {
                ...
                public Short2LongMap.Entry next() {
                    ...
                    final short[] access$100 = Short2LongArrayMap.this.key;
                    final int next = this.next;
                    this.curr = next;
                    return new BasicEntry(access$100[next], Short2LongArrayMap.this.value[this.next++]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    final int tail = Short2LongArrayMap.this.size-- - this.next--;
