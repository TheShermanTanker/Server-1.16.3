...
public class Short2BooleanRBTreeMap extends AbstractShort2BooleanSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Short2BooleanRBTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Short2BooleanMap.Entry> subSet(final Short2BooleanMap.Entry from, final Short2BooleanMap.Entry to) {
                    return Short2BooleanRBTreeMap.this.subMap(from.getShortKey(), to.getShortKey()).short2BooleanEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Short2BooleanMap.Entry> headSet(final Short2BooleanMap.Entry to) {
                    return Short2BooleanRBTreeMap.this.headMap(to.getShortKey()).short2BooleanEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(final Short2BooleanMap.Entry from) {
    ...
    private static final class Entry extends BasicEntry implements Cloneable {
        ...
        public Entry clone() {
            ...
            //     4: checkcast       Lit/unimi/dsi/fastutil/shorts/Short2BooleanRBTreeMap$Entry;
            //     7: astore_1        /* c */
            //     8: goto            20
            ...
            //    20: aload_1         /* c */
            //    21: aload_0         /* this */
            //    22: getfield        it/unimi/dsi/fastutil/shorts/Short2BooleanRBTreeMap$Entry.key:S
            //    25: putfield        it/unimi/dsi/fastutil/shorts/Short2BooleanRBTreeMap$Entry.key:S
            //    28: aload_1         /* c */
            //    29: aload_0         /* this */
            //    30: getfield        it/unimi/dsi/fastutil/shorts/Short2BooleanRBTreeMap$Entry.value:Z
            //    33: putfield        it/unimi/dsi/fastutil/shorts/Short2BooleanRBTreeMap$Entry.value:Z
            //    36: aload_1         /* c */
            //    37: aload_0         /* this */
            //    38: getfield        it/unimi/dsi/fastutil/shorts/Short2BooleanRBTreeMap$Entry.info:I
            //    41: putfield        it/unimi/dsi/fastutil/shorts/Short2BooleanRBTreeMap$Entry.info:I
            //    44: aload_1         /* c */
            //    45: areturn        
            //    StackMapTable: 00 02 4B 07 00 41 FC 00 08 07 00 02
            //    Exceptions:
            //  Try           Handler
    ...
    private class TreeIterator {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry locateKey = Short2BooleanRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2BooleanSortedMap implements Serializable {
        ...
        protected transient ShortSortedSet keys;
        protected transient BooleanCollection values;
        final /* synthetic */ Short2BooleanRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2BooleanRBTreeMap.Entry f = Short2BooleanRBTreeMap.this.findKey((short)e.getKey());
        ...
        public short firstShortKey() {
            final Short2BooleanRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public short lastShortKey() {
            final Short2BooleanRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2BooleanRBTreeMap this$0 = submap.this$0;
                            final Short2BooleanRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
