...
public class Short2ShortOpenHashMap extends AbstractShort2ShortMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Short2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Short2ShortOpenHashMap.this.value[Short2ShortOpenHashMap.this.n]);
                    }
                    int pos = Short2ShortOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2ShortOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Short2ShortOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Short2ShortMap.Entry, Map.Entry<Short, Short> {
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2ShortOpenHashMap.this.key[this.index]).append("=>").append((int)Short2ShortOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements Short2ShortMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Short2ShortMap.Entry> consumer) {
            if (Short2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2ShortOpenHashMap.this.key[Short2ShortOpenHashMap.this.n], Short2ShortOpenHashMap.this.value[Short2ShortOpenHashMap.this.n]));
            }
            int pos = Short2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ShortOpenHashMap.this.key[pos] != 0) {
                    consumer.accept(new BasicEntry(Short2ShortOpenHashMap.this.key[pos], Short2ShortOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2ShortOpenHashMap.this.key[Short2ShortOpenHashMap.this.n]);
            }
            int pos = Short2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2ShortOpenHashMap.this.key[pos];
                if (k != 0) {
