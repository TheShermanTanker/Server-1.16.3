...
public class Short2LongOpenCustomHashMap extends AbstractShort2LongMap implements Serializable, Cloneable, Hash {
    ...
    public Short2LongOpenCustomHashMap(final int expected, final float f, final ShortHash.Strategy strategy) {
    ...
    public Short2LongOpenCustomHashMap(final int expected, final ShortHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Short2LongOpenCustomHashMap(final ShortHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Short2LongOpenCustomHashMap(final Map<? extends Short, ? extends Long> m, final float f, final ShortHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Short2LongOpenCustomHashMap(final Map<? extends Short, ? extends Long> m, final ShortHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Short2LongOpenCustomHashMap(final Short2LongMap m, final float f, final ShortHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Short2LongOpenCustomHashMap(final Short2LongMap m, final ShortHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Short2LongOpenCustomHashMap(final short[] k, final long[] v, final float f, final ShortHash.Strategy strategy) {
    ...
    public Short2LongOpenCustomHashMap(final short[] k, final long[] v, final ShortHash.Strategy strategy) {
    ...
    public long computeIfAbsent(final short k, final IntToLongFunction mappingFunction) {
    ...
    public long computeIfAbsentNullable(final short k, final IntFunction<? extends Long> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int pos = this.find(k);
        if (pos >= 0) {
            return this.value[pos];
    ...
    public long computeIfPresent(final short k, final BiFunction<? super Short, ? super Long, ? extends Long> remappingFunction) {
    ...
    public long compute(final short k, final BiFunction<? super Short, ? super Long, ? extends Long> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
    ...
    public long merge(final short k, final long v, final BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
        if (pos < 0) {
            this.insert(-pos - 1, k, v);
    ...
    final class MapEntry implements Short2LongMap.Entry, Map.Entry<Short, Long> {
        ...
        public long setValue(final long v) {
            final long oldValue = Short2LongOpenCustomHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2LongOpenCustomHashMap.this.key[this.index]).append("=>").append(Short2LongOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            short k;
            int p;
            for (k = this.wrapped.getShort(-this.pos - 1), p = (HashCommon.mix(Short2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Short2LongOpenCustomHashMap.this.mask); !Short2LongOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Short2LongOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Short2LongOpenCustomHashMap.this.mask);
                short curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Short2LongOpenCustomHashMap.this.strategy.hashCode(curr)) & Short2LongOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Short2LongOpenCustomHashMap this$0 = Short2LongOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2LongMap.Entry> implements Short2LongMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Short2LongMap.Entry> consumer) {
            if (Short2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2LongOpenCustomHashMap.this.key[Short2LongOpenCustomHashMap.this.n], Short2LongOpenCustomHashMap.this.value[Short2LongOpenCustomHashMap.this.n]));
            }
            int pos = Short2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2LongOpenCustomHashMap.this.key[pos] != 0) {
                    consumer.accept(new BasicEntry(Short2LongOpenCustomHashMap.this.key[pos], Short2LongOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Short2LongOpenCustomHashMap.this.key[Short2LongOpenCustomHashMap.this.n]);
            }
            int pos = Short2LongOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2LongOpenCustomHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final short k) {
            final int oldSize = Short2LongOpenCustomHashMap.this.size;
