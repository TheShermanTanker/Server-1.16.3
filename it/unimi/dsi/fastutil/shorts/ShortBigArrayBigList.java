...
public class ShortBigArrayBigList extends AbstractShortBigList implements RandomAccess, Cloneable, Serializable {
    ...
    public static ShortBigArrayBigList wrap(final short[][] a, final long length) {
        if (length > ShortBigArrays.length(a)) {
            throw new IllegalArgumentException(new StringBuilder().append("The specified length (").append(length).append(") is greater than the array size (").append(ShortBigArrays.length(a)).append(")").toString());
        }
    ...
    public void ensureCapacity(final long capacity) {
        if (capacity <= this.a.length || this.a == ShortBigArrays.DEFAULT_EMPTY_BIG_ARRAY) {
            return;
        }
    ...
    private void grow(long capacity) {
        final long oldLength = ShortBigArrays.length(this.a);
    ...
    private void writeObject(final ObjectOutputStream s) throws IOException {
        ...
        for (int i = 0; i < this.size; ++i) {
            s.writeShort((int)ShortBigArrays.get(this.a, i));
        }
    }
