...
public class Short2ShortOpenCustomHashMap extends AbstractShort2ShortMap implements Serializable, Cloneable, Hash {
    ...
    public Short2ShortOpenCustomHashMap(final int expected, final float f, final ShortHash.Strategy strategy) {
    ...
    public Short2ShortOpenCustomHashMap(final int expected, final ShortHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Short2ShortOpenCustomHashMap(final ShortHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Short2ShortOpenCustomHashMap(final Map<? extends Short, ? extends Short> m, final float f, final ShortHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Short2ShortOpenCustomHashMap(final Map<? extends Short, ? extends Short> m, final ShortHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Short2ShortOpenCustomHashMap(final Short2ShortMap m, final float f, final ShortHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Short2ShortOpenCustomHashMap(final Short2ShortMap m, final ShortHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Short2ShortOpenCustomHashMap(final short[] k, final short[] v, final float f, final ShortHash.Strategy strategy) {
    ...
    public Short2ShortOpenCustomHashMap(final short[] k, final short[] v, final ShortHash.Strategy strategy) {
    ...
    public short computeIfAbsent(final short k, final IntUnaryOperator mappingFunction) {
    ...
    public short computeIfAbsentNullable(final short k, final IntFunction<? extends Short> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int pos = this.find(k);
        if (pos >= 0) {
            return this.value[pos];
    ...
    public short computeIfPresent(final short k, final BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
    ...
    public short compute(final short k, final BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
    ...
    public short merge(final short k, final short v, final BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
        if (pos < 0) {
            this.insert(-pos - 1, k, v);
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.n]);
                    }
                    int pos = Short2ShortOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2ShortOpenCustomHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Short2ShortOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Short2ShortMap.Entry, Map.Entry<Short, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Short2ShortOpenCustomHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2ShortOpenCustomHashMap.this.key[this.index]).append("=>").append((int)Short2ShortOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            short k;
            int p;
            for (k = this.wrapped.getShort(-this.pos - 1), p = (HashCommon.mix(Short2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ShortOpenCustomHashMap.this.mask); !Short2ShortOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Short2ShortOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Short2ShortOpenCustomHashMap.this.mask);
                short curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(Short2ShortOpenCustomHashMap.this.strategy.hashCode(curr)) & Short2ShortOpenCustomHashMap.this.mask;
                    Label_0111: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0111;
        ...
        public void remove() {
            ...
            final Short2ShortOpenCustomHashMap this$0 = Short2ShortOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements Short2ShortMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Short2ShortMap.Entry> consumer) {
            if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2ShortOpenCustomHashMap.this.key[Short2ShortOpenCustomHashMap.this.n], Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.n]));
            }
            int pos = Short2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ShortOpenCustomHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((int)Short2ShortOpenCustomHashMap.this.key[Short2ShortOpenCustomHashMap.this.n]);
            }
            int pos = Short2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2ShortOpenCustomHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final short k) {
            final int oldSize = Short2ShortOpenCustomHashMap.this.size;
