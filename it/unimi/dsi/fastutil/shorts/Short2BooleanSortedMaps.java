...
public final class Short2BooleanSortedMaps {
    ...
    public static ObjectBidirectionalIterator<Short2BooleanMap.Entry> fastIterator(final Short2BooleanSortedMap map) {
    ...
    public static ObjectBidirectionalIterable<Short2BooleanMap.Entry> fastIterable(final Short2BooleanSortedMap map) {
        final ObjectSortedSet<Short2BooleanMap.Entry> entries = map.short2BooleanEntrySet();
        ObjectBidirectionalIterable<Short2BooleanMap.Entry> objectBidirectionalIterable;
        if (entries instanceof Short2BooleanSortedMap.FastSortedEntrySet) {
            final Short2BooleanSortedMap.FastSortedEntrySet set = (Short2BooleanSortedMap.FastSortedEntrySet)entries;
    ...
    public static Short2BooleanSortedMap singleton(final Short key, final Boolean value, final ShortComparator comparator) {
    ...
    public static class EmptySortedMap extends Short2BooleanMaps.EmptyMap implements Short2BooleanSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
            return (ObjectSortedSet<Short2BooleanMap.Entry>)ObjectSortedSets.EMPTY_SET;
        }
        
        @Deprecated
        @Override
        public ObjectSortedSet<Map.Entry<Short, Boolean>> entrySet() {
            return (ObjectSortedSet<Map.Entry<Short, Boolean>>)ObjectSortedSets.EMPTY_SET;
        }
        ...
        @Deprecated
        @Override
        public Short2BooleanSortedMap headMap(final Short oto) {
            return this.headMap((short)oto);
        }
        
        @Deprecated
        @Override
        public Short2BooleanSortedMap tailMap(final Short ofrom) {
            return this.tailMap((short)ofrom);
        }
        
        @Deprecated
        @Override
        public Short2BooleanSortedMap subMap(final Short ofrom, final Short oto) {
    ...
    public static class Singleton extends Short2BooleanMaps.Singleton implements Short2BooleanSortedMap, Serializable, Cloneable {
        ...
        protected Singleton(final short key, final boolean value, final ShortComparator comparator) {
            super(key, value);
        ...
        public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractShort2BooleanMap.BasicEntry(this.key, this.value), (java.util.Comparator<? super AbstractShort2BooleanMap.BasicEntry>)Short2BooleanSortedMaps.entryComparator(this.comparator));
            }
            return (ObjectSortedSet<Short2BooleanMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class SynchronizedSortedMap extends Short2BooleanMaps.SynchronizedMap implements Short2BooleanSortedMap, Serializable {
        ...
        public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Short2BooleanMap.Entry>synchronize(this.sortedMap.short2BooleanEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Short2BooleanMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class UnmodifiableSortedMap extends Short2BooleanMaps.UnmodifiableMap implements Short2BooleanSortedMap, Serializable {
        ...
        public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Short2BooleanMap.Entry>unmodifiable(this.sortedMap.short2BooleanEntrySet());
            }
            return (ObjectSortedSet<Short2BooleanMap.Entry>)(ObjectSortedSet)this.entries;
        }
