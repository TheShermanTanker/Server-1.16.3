...
public class Short2LongOpenHashMap extends AbstractShort2LongMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Short2LongMap.Entry, Map.Entry<Short, Long> {
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2LongOpenHashMap.this.key[this.index]).append("=>").append(Short2LongOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2LongMap.Entry> implements Short2LongMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Short2LongMap.Entry> consumer) {
            if (Short2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2LongOpenHashMap.this.key[Short2LongOpenHashMap.this.n], Short2LongOpenHashMap.this.value[Short2LongOpenHashMap.this.n]));
            }
            int pos = Short2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2LongOpenHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2LongOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2LongOpenHashMap.this.key[Short2LongOpenHashMap.this.n]);
            }
            int pos = Short2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2LongOpenHashMap.this.key[pos];
                if (k != 0) {
