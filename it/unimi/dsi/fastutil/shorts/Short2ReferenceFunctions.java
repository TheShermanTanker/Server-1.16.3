...
public final class Short2ReferenceFunctions {
    ...
    public static <V> Short2ReferenceFunction<V> primitive(final Function<? super Short, ? extends V> f) {
        Objects.requireNonNull(f);
        if (f instanceof Short2ReferenceFunction) {
            return (Short2ReferenceFunction<V>)(Short2ReferenceFunction)f;
        }
        if (f instanceof IntFunction) {
            final IntFunction intFunction = (IntFunction)f;
            Objects.requireNonNull(intFunction);
            return (Short2ReferenceFunction<V>)intFunction::apply;
        }
