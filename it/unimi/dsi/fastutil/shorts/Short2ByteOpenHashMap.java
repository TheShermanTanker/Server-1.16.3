...
public class Short2ByteOpenHashMap extends AbstractShort2ByteMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractByteCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Short2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Short2ByteOpenHashMap.this.value[Short2ByteOpenHashMap.this.n]);
                    }
                    int pos = Short2ByteOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2ByteOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Short2ByteOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Short2ByteMap.Entry, Map.Entry<Short, Byte> {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Short2ByteOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2ByteOpenHashMap.this.key[this.index]).append("=>").append((int)Short2ByteOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            short k;
            int p;
            for (k = this.wrapped.getShort(-this.pos - 1), p = (HashCommon.mix(k) & Short2ByteOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Short2ByteOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Short2ByteOpenHashMap.this.mask);
                short curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Short2ByteOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Short2ByteOpenHashMap this$0 = Short2ByteOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2ByteMap.Entry> implements Short2ByteMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Short2ByteMap.Entry> consumer) {
            if (Short2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2ByteOpenHashMap.this.key[Short2ByteOpenHashMap.this.n], Short2ByteOpenHashMap.this.value[Short2ByteOpenHashMap.this.n]));
            }
            int pos = Short2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2ByteOpenHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2ByteOpenHashMap.this.key[Short2ByteOpenHashMap.this.n]);
            }
            int pos = Short2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2ByteOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final short k) {
            final int oldSize = Short2ByteOpenHashMap.this.size;
