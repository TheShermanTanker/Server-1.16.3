...
public class Short2DoubleLinkedOpenHashMap extends AbstractShort2DoubleSortedMap implements Serializable, Cloneable, Hash {
    ...
    public double computeIfAbsent(final short k, final IntToDoubleFunction mappingFunction) {
    ...
    public double computeIfAbsentNullable(final short k, final IntFunction<? extends Double> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final int pos = this.find(k);
        if (pos >= 0) {
            return this.value[pos];
    ...
    public double computeIfPresent(final short k, final BiFunction<? super Short, ? super Double, ? extends Double> remappingFunction) {
    ...
    public double compute(final short k, final BiFunction<? super Short, ? super Double, ? extends Double> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
    ...
    public double merge(final short k, final double v, final BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final int pos = this.find(k);
        if (pos < 0) {
            this.insert(-pos - 1, k, v);
    ...
    final class MapEntry implements Short2DoubleMap.Entry, Map.Entry<Short, Double> {
        ...
        public double setValue(final double v) {
            final double oldValue = Short2DoubleLinkedOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2DoubleLinkedOpenHashMap.this.key[this.index]).append("=>").append(Short2DoubleLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final short from) {
            ...
            if (from == 0) {
                ...
                for (int pos = HashCommon.mix(from) & Short2DoubleLinkedOpenHashMap.this.mask; Short2DoubleLinkedOpenHashMap.this.key[pos] != 0; pos = (pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Short2DoubleLinkedOpenHashMap this$0 = Short2DoubleLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Short2DoubleLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Short2DoubleLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Short2DoubleLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Short2DoubleLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Short2DoubleLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Short2DoubleLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Short2DoubleLinkedOpenHashMap.this.mask);
                short curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Short2DoubleLinkedOpenHashMap.this.mask;
                    Label_0354: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0354;
        ...
        public void set(final Short2DoubleMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
        
        public void add(final Short2DoubleMap.Entry ok) {
            throw new UnsupportedOperationException();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Short2DoubleMap.Entry> implements Short2DoubleSortedMap.FastSortedEntrySet {
        ...
        @Override
        public ObjectSortedSet<Short2DoubleMap.Entry> subSet(final Short2DoubleMap.Entry fromElement, final Short2DoubleMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Short2DoubleMap.Entry> headSet(final Short2DoubleMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(final Short2DoubleMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public void forEach(final Consumer<? super Short2DoubleMap.Entry> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Short2DoubleLinkedOpenHashMap.this.key[curr], Short2DoubleLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractShortSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2DoubleLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.n]);
            }
            int pos = Short2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2DoubleLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final short k) {
            final int oldSize = Short2DoubleLinkedOpenHashMap.this.size;
