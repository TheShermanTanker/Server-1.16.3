...
public class Short2DoubleOpenHashMap extends AbstractShort2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Short2DoubleMap.Entry, Map.Entry<Short, Double> {
        ...
        public double setValue(final double v) {
            final double oldValue = Short2DoubleOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2DoubleOpenHashMap.this.key[this.index]).append("=>").append(Short2DoubleOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            short k;
            int p;
            for (k = this.wrapped.getShort(-this.pos - 1), p = (HashCommon.mix(k) & Short2DoubleOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Short2DoubleOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Short2DoubleOpenHashMap.this.mask);
                short curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Short2DoubleOpenHashMap.this.mask;
                    Label_0099: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0099;
        ...
        public void remove() {
            ...
            final Short2DoubleOpenHashMap this$0 = Short2DoubleOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry> implements Short2DoubleMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Short2DoubleMap.Entry> consumer) {
            if (Short2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Short2DoubleOpenHashMap.this.key[Short2DoubleOpenHashMap.this.n], Short2DoubleOpenHashMap.this.value[Short2DoubleOpenHashMap.this.n]));
            }
            int pos = Short2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Short2DoubleOpenHashMap.this.key[pos] != 0) {
    ...
    private final class KeySet extends AbstractShortSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2DoubleOpenHashMap.this.key[Short2DoubleOpenHashMap.this.n]);
            }
            int pos = Short2DoubleOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2DoubleOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final short k) {
            final int oldSize = Short2DoubleOpenHashMap.this.size;
