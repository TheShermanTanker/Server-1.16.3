...
public class Short2IntLinkedOpenHashMap extends AbstractShort2IntSortedMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Short2IntMap.Entry, Map.Entry<Short, Integer> {
        ...
        public int setValue(final int v) {
            final int oldValue = Short2IntLinkedOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Short2IntLinkedOpenHashMap.this.key[this.index] == (short)e.getKey() && Short2IntLinkedOpenHashMap.this.value[this.index] == (int)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2IntLinkedOpenHashMap.this.key[this.index]).append("=>").append(Short2IntLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        private MapIterator(final short from) {
            ...
            if (from == 0) {
                ...
                for (int pos = HashCommon.mix(from) & Short2IntLinkedOpenHashMap.this.mask; Short2IntLinkedOpenHashMap.this.key[pos] != 0; pos = (pos + 1 & Short2IntLinkedOpenHashMap.this.mask)) {
        ...
        public void remove() {
            ...
            final Short2IntLinkedOpenHashMap this$0 = Short2IntLinkedOpenHashMap.this;
            --this$0.size;
            if (this.prev == -1) {
                Short2IntLinkedOpenHashMap.this.first = this.next;
            }
            else {
                final long[] link = Short2IntLinkedOpenHashMap.this.link;
                final int prev = this.prev;
                link[prev] ^= ((Short2IntLinkedOpenHashMap.this.link[this.prev] ^ ((long)this.next & 0xFFFFFFFFL)) & 0xFFFFFFFFL);
            }
            if (this.next == -1) {
                Short2IntLinkedOpenHashMap.this.last = this.prev;
            }
            else {
                final long[] link2 = Short2IntLinkedOpenHashMap.this.link;
                final int next = this.next;
                link2[next] ^= ((Short2IntLinkedOpenHashMap.this.link[this.next] ^ ((long)this.prev & 0xFFFFFFFFL) << 32) & 0xFFFFFFFF00000000L);
            }
            int pos = this.curr;
            this.curr = -1;
        ...
        Label_0264:
            while (true) {
                pos = ((last = pos) + 1 & Short2IntLinkedOpenHashMap.this.mask);
                short curr;
                while ((curr = key[pos]) != 0) {
                    final int slot = HashCommon.mix(curr) & Short2IntLinkedOpenHashMap.this.mask;
                    Label_0354: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0354;
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Short2IntMap.Entry> implements Short2IntSortedMap.FastSortedEntrySet {
        ...
        @Override
        public ObjectSortedSet<Short2IntMap.Entry> subSet(final Short2IntMap.Entry fromElement, final Short2IntMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Short2IntMap.Entry> headSet(final Short2IntMap.Entry toElement) {
            throw new UnsupportedOperationException();
        }
        
        @Override
        public ObjectSortedSet<Short2IntMap.Entry> tailSet(final Short2IntMap.Entry fromElement) {
            throw new UnsupportedOperationException();
        }
        ...
        public void forEach(final Consumer<? super Short2IntMap.Entry> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Short2IntLinkedOpenHashMap.this.key[curr], Short2IntLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractShortSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2IntLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2IntLinkedOpenHashMap.this.key[Short2IntLinkedOpenHashMap.this.n]);
            }
            int pos = Short2IntLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2IntLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
        ...
        public boolean remove(final short k) {
            final int oldSize = Short2IntLinkedOpenHashMap.this.size;
