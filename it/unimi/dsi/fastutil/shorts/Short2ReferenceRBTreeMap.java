...
public class Short2ReferenceRBTreeMap<V> extends AbstractShort2ReferenceSortedMap<V> implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry<V> f = Short2ReferenceRBTreeMap.this.findKey((short)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final short k) {
            this.index = 0;
            final Entry<V> locateKey = Short2ReferenceRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractShort2ReferenceSortedMap<V> implements Serializable {
        ...
        protected transient ShortSortedSet keys;
        protected transient ReferenceCollection<V> values;
        final /* synthetic */ Short2ReferenceRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Short2ReferenceRBTreeMap.Entry<V> f = Short2ReferenceRBTreeMap.this.findKey((short)e.getKey());
        ...
        public short firstShortKey() {
            final Short2ReferenceRBTreeMap.Entry<V> e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public short lastShortKey() {
            final Short2ReferenceRBTreeMap.Entry<V> e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final short k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Short2ReferenceRBTreeMap this$0 = submap.this$0;
                            final Short2ReferenceRBTreeMap.Entry<V> lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
