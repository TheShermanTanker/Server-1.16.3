...
public class Short2FloatLinkedOpenHashMap extends AbstractShort2FloatSortedMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Short2FloatMap.Entry, Map.Entry<Short, Float> {
        ...
        public boolean equals(final Object o) {
            ...
            return Short2FloatLinkedOpenHashMap.this.key[this.index] == (short)e.getKey() && Float.floatToIntBits(Short2FloatLinkedOpenHashMap.this.value[this.index]) == Float.floatToIntBits((float)e.getValue());
        }
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2FloatLinkedOpenHashMap.this.key[this.index]).append("=>").append(Short2FloatLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractShortSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2FloatLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2FloatLinkedOpenHashMap.this.key[Short2FloatLinkedOpenHashMap.this.n]);
            }
            int pos = Short2FloatLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2FloatLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
