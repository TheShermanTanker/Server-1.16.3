...
public class Short2ShortLinkedOpenHashMap extends AbstractShort2ShortSortedMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Short2ShortLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Short2ShortLinkedOpenHashMap.this.value[Short2ShortLinkedOpenHashMap.this.n]);
                    }
                    int pos = Short2ShortLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Short2ShortLinkedOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((int)Short2ShortLinkedOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Short2ShortMap.Entry, Map.Entry<Short, Short> {
        ...
        public String toString() {
            return new StringBuilder().append((int)Short2ShortLinkedOpenHashMap.this.key[this.index]).append("=>").append((int)Short2ShortLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractShortSortedSet {
        ...
        public void forEach(final IntConsumer consumer) {
            if (Short2ShortLinkedOpenHashMap.this.containsNullKey) {
                consumer.accept((int)Short2ShortLinkedOpenHashMap.this.key[Short2ShortLinkedOpenHashMap.this.n]);
            }
            int pos = Short2ShortLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final short k = Short2ShortLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
