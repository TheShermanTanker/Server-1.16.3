...
public class BinIO {
    ...
    public static void storeObject(final Object o, final File file) throws IOException {
        final ObjectOutputStream oos = new ObjectOutputStream((OutputStream)new FastBufferedOutputStream((OutputStream)new FileOutputStream(file)));
        oos.writeObject(o);
        oos.close();
    }
    ...
    public static Object loadObject(final File file) throws IOException, ClassNotFoundException {
        final ObjectInputStream ois = new ObjectInputStream((InputStream)new FastBufferedInputStream((InputStream)new FileInputStream(file)));
    ...
    public static void storeObject(final Object o, final OutputStream s) throws IOException {
        final ObjectOutputStream oos = new ObjectOutputStream((OutputStream)new FastBufferedOutputStream(s));
        oos.writeObject(o);
        oos.flush();
    }
    
    public static Object loadObject(final InputStream s) throws IOException, ClassNotFoundException {
        final ObjectInputStream ois = new ObjectInputStream((InputStream)new FastBufferedInputStream(s));
        final Object result = ois.readObject();
        return result;
    }
    ...
    private static long read(final InputStream is, final byte[][] a, final long offset, final long length) throws IOException {
        ...
        do {
            final int result = is.read(a[segment], displacement, (int)Math.min((long)(a[segment].length - displacement), Math.min(length - read, 1048576L)));
            if (result < 0) {
                return read;
            }
            read += result;
    ...
    private static void write(final OutputStream outputStream, final byte[][] a, final long offset, final long length) throws IOException {
        ...
        int displacement = BigArrays.displacement(offset);
        do {
            final int toWrite = (int)Math.min((long)(a[segment].length - displacement), Math.min(length - written, 1048576L));
    ...
    public static int loadBytes(final File file, final byte[] array, final int offset, final int length) throws IOException {
        ...
        final int result = read((InputStream)fis, array, offset, length);
        fis.close();
        return result;
    }
    ...
    public static int loadBytes(final File file, final byte[] array) throws IOException {
        final FileInputStream fis = new FileInputStream(file);
        final int result = read((InputStream)fis, array, 0, array.length);
        fis.close();
        return result;
    }
    ...
    public static byte[] loadBytes(final File file) throws IOException {
        ...
        if (length > 2147483647L) {
            fis.close();
            throw new IllegalArgumentException(new StringBuilder().append("File too long: ").append(fis.getChannel().size()).append(" bytes (").append(length).append(" elements)").toString());
        }
        final byte[] array = new byte[(int)length];
        if (read((InputStream)fis, array, 0, (int)length) < length) {
    ...
    public static void storeBytes(final byte[] array, final int offset, final int length, final File file) throws IOException {
        ByteArrays.ensureOffsetLength(array, offset, length);
        final OutputStream os = new FastBufferedOutputStream((OutputStream)new FileOutputStream(file));
    ...
    public static long loadBytes(final DataInput dataInput, final byte[][] array, final long offset, final long length) throws IOException {
        ...
        try {
            for (int i = BigArrays.segment(offset); i < BigArrays.segment(offset + length + 134217727L); ++i) {
                ...
                for (int l = (int)Math.min((long)t.length, offset + length - BigArrays.start(i)), d = (int)Math.max(0L, offset - BigArrays.start(i)); d < l; ++d) {
    ...
    public static long loadBytes(final File file, final byte[][] array, final long offset, final long length) throws IOException {
        ByteBigArrays.ensureOffsetLength(array, offset, length);
        final FileInputStream fis = new FileInputStream(file);
        final long result = read((InputStream)fis, array, offset, length);
        fis.close();
        return result;
    }
    ...
    public static long loadBytes(final File file, final byte[][] array) throws IOException {
        final FileInputStream fis = new FileInputStream(file);
        final long result = read((InputStream)fis, array, 0L, ByteBigArrays.length(array));
        fis.close();
        return result;
    }
    ...
    public static byte[][] loadBytesBig(final File file) throws IOException {
        ...
        if (read((InputStream)fis, array, 0L, length) < length) {
            throw new EOFException();
        }
        fis.close();
        return array;
    ...
    public static void storeBytes(final ByteIterator i, final DataOutput dataOutput) throws IOException {
        while (i.hasNext()) {
            dataOutput.writeByte((int)i.nextByte());
        }
    }
    
    public static void storeBytes(final ByteIterator i, final File file) throws IOException {
        final DataOutputStream dos = new DataOutputStream((OutputStream)new FastBufferedOutputStream((OutputStream)new FileOutputStream(file)));
        while (i.hasNext()) {
            dos.writeByte((int)i.nextByte());
        }
        dos.close();
    }
    ...
    public static ByteIterator asByteIterator(final File file) throws IOException {
        return new ByteDataInputWrapper((DataInput)new DataInputStream((InputStream)new FastBufferedInputStream((InputStream)new FileInputStream(file))));
    }
    ...
    public static int loadInts(final File file, final int[] array, final int offset, final int length) throws IOException {
        IntArrays.ensureOffsetLength(array, offset, length);
        final FileInputStream fis = new FileInputStream(file);
        final DataInputStream dis = new DataInputStream((InputStream)new FastBufferedInputStream((InputStream)fis));
        int i = 0;
        try {
            for (i = 0; i < length; ++i) {
    ...
    public static IntIterator asIntIterator(final File file) throws IOException {
        return new IntDataInputWrapper((DataInput)new DataInputStream((InputStream)new FastBufferedInputStream((InputStream)new FileInputStream(file))));
    }
    ...
    public static LongIterator asLongIterator(final File file) throws IOException {
        return new LongDataInputWrapper((DataInput)new DataInputStream((InputStream)new FastBufferedInputStream((InputStream)new FileInputStream(file))));
    }
    ...
    public static DoubleIterator asDoubleIterator(final File file) throws IOException {
        return new DoubleDataInputWrapper((DataInput)new DataInputStream((InputStream)new FastBufferedInputStream((InputStream)new FileInputStream(file))));
    }
    ...
    public static BooleanIterator asBooleanIterator(final File file) throws IOException {
        return new BooleanDataInputWrapper((DataInput)new DataInputStream((InputStream)new FastBufferedInputStream((InputStream)new FileInputStream(file))));
    }
    ...
    public static void storeShorts(final short[] array, final int offset, final int length, final File file) throws IOException {
        ...
        final DataOutputStream dos = new DataOutputStream((OutputStream)new FastBufferedOutputStream((OutputStream)new FileOutputStream(file)));
        for (int i = 0; i < length; ++i) {
            dos.writeShort((int)array[offset + i]);
        }
        dos.close();
    }
    ...
    public static void storeShorts(final ShortIterator i, final DataOutput dataOutput) throws IOException {
        while (i.hasNext()) {
            dataOutput.writeShort((int)i.nextShort());
        }
    }
    ...
    public static void storeShorts(final ShortIterator i, final File file) throws IOException {
        final DataOutputStream dos = new DataOutputStream((OutputStream)new FastBufferedOutputStream((OutputStream)new FileOutputStream(file)));
        while (i.hasNext()) {
            dos.writeShort((int)i.nextShort());
        }
        dos.close();
    }
    ...
    public static ShortIterator asShortIterator(final File file) throws IOException {
        return new ShortDataInputWrapper((DataInput)new DataInputStream((InputStream)new FastBufferedInputStream((InputStream)new FileInputStream(file))));
    }
    ...
    public static void storeChars(final char[] array, final int offset, final int length, final File file) throws IOException {
        ...
        final DataOutputStream dos = new DataOutputStream((OutputStream)new FastBufferedOutputStream((OutputStream)new FileOutputStream(file)));
        for (int i = 0; i < length; ++i) {
            dos.writeChar((int)array[offset + i]);
        }
        dos.close();
    }
    ...
    public static void storeChars(final CharIterator i, final DataOutput dataOutput) throws IOException {
        while (i.hasNext()) {
            dataOutput.writeChar((int)i.nextChar());
        }
    }
    ...
    public static CharIterator asCharIterator(final File file) throws IOException {
        return new CharDataInputWrapper((DataInput)new DataInputStream((InputStream)new FastBufferedInputStream((InputStream)new FileInputStream(file))));
    }
    ...
    public static FloatIterator asFloatIterator(final File file) throws IOException {
        return new FloatDataInputWrapper((DataInput)new DataInputStream((InputStream)new FastBufferedInputStream((InputStream)new FileInputStream(file))));
    }
    ...
    private static final class ByteDataInputWrapper implements ByteIterator {
        ...
        public boolean hasNext() {
            ...
            try {
                ...
                throw new RuntimeException((Throwable)rethrow);
            }
            return !this.endOfProcess;
        }
