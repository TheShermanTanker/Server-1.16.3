...
public class Long2CharLinkedOpenHashMap extends AbstractLong2CharSortedMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractCharCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Long2CharLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Long2CharLinkedOpenHashMap.this.value[Long2CharLinkedOpenHashMap.this.n]);
                    }
                    int pos = Long2CharLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Long2CharLinkedOpenHashMap.this.key[pos] != 0L) {
                            consumer.accept((int)Long2CharLinkedOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Long2CharMap.Entry, Map.Entry<Long, Character> {
        ...
        public boolean equals(final Object o) {
            ...
            return Long2CharLinkedOpenHashMap.this.key[this.index] == (long)e.getKey() && Long2CharLinkedOpenHashMap.this.value[this.index] == (char)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Long2CharLinkedOpenHashMap.this.key[this.index]).append("=>").append(Long2CharLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractLongSortedSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2CharLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2CharLinkedOpenHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
