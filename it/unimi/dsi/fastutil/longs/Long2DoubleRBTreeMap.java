...
public class Long2DoubleRBTreeMap extends AbstractLong2DoubleSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Long2DoubleRBTreeMap.this.findKey((long)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final long k) {
            this.index = 0;
            final Entry locateKey = Long2DoubleRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractLong2DoubleSortedMap implements Serializable {
        ...
        protected transient LongSortedSet keys;
        protected transient DoubleCollection values;
        final /* synthetic */ Long2DoubleRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Long2DoubleRBTreeMap.Entry f = Long2DoubleRBTreeMap.this.findKey((long)e.getKey());
        ...
        public long firstLongKey() {
            final Long2DoubleRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public long lastLongKey() {
            final Long2DoubleRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final long k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Long2DoubleRBTreeMap this$0 = submap.this$0;
                            final Long2DoubleRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
