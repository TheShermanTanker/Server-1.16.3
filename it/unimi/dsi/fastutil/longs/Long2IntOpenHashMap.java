...
public class Long2IntOpenHashMap extends AbstractLong2IntMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Long2IntMap.Entry, Map.Entry<Long, Integer> {
        ...
        public int setValue(final int v) {
            final int oldValue = Long2IntOpenHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Long2IntOpenHashMap.this.key[this.index] == (long)e.getKey() && Long2IntOpenHashMap.this.value[this.index] == (int)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Long2IntOpenHashMap.this.key[this.index]).append("=>").append(Long2IntOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            long k;
            int p;
            for (k = this.wrapped.getLong(-this.pos - 1), p = ((int)HashCommon.mix(k) & Long2IntOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Long2IntOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Long2IntOpenHashMap.this.mask);
                long curr;
                while ((curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(curr) & Long2IntOpenHashMap.this.mask;
                    Label_0102: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0102;
        ...
        public void remove() {
            ...
            final Long2IntOpenHashMap this$0 = Long2IntOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Long2IntMap.Entry> implements Long2IntMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Long2IntMap.Entry> consumer) {
            if (Long2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Long2IntOpenHashMap.this.key[Long2IntOpenHashMap.this.n], Long2IntOpenHashMap.this.value[Long2IntOpenHashMap.this.n]));
            }
            int pos = Long2IntOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2IntOpenHashMap.this.key[pos] != 0L) {
                    consumer.accept(new BasicEntry(Long2IntOpenHashMap.this.key[pos], Long2IntOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2IntOpenHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2IntOpenHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final long k) {
            final int oldSize = Long2IntOpenHashMap.this.size;
