...
public interface Long2CharMap extends Long2CharFunction, Map<Long, Character> {
    ...
    default char computeIfAbsent(final long key, final LongToIntFunction mappingFunction) {
    ...
    default char computeIfAbsentNullable(final long key, final LongFunction<? extends Character> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        final char v = this.get(key);
        final char drv = this.defaultReturnValue();
        if (v != drv || this.containsKey(key)) {
    ...
    default char computeIfPresent(final long key, final BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
    ...
    default char compute(final long key, final BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final char oldValue = this.get(key);
        final char drv = this.defaultReturnValue();
    ...
    default char merge(final long key, final char value, final BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
        final char oldValue = this.get(key);
        final char drv = this.defaultReturnValue();
        char newValue;
    ...
    @Deprecated
    default Character computeIfPresent(final Long key, final BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
        return (Character)super.computeIfPresent(key, (BiFunction)remappingFunction);
    }
    
    @Deprecated
    default Character compute(final Long key, final BiFunction<? super Long, ? super Character, ? extends Character> remappingFunction) {
        return (Character)super.compute(key, (BiFunction)remappingFunction);
    }
    
    @Deprecated
    default Character merge(final Long key, final Character value, final BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
