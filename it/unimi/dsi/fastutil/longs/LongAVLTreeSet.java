...
public class LongAVLTreeSet extends AbstractLongSortedSet implements Serializable, Cloneable, LongSortedSet {
    ...
    private class SetIterator implements LongListIterator {
        ...
        SetIterator(final long k) {
            this.index = 0;
            final Entry locateKey = LongAVLTreeSet.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Subset extends AbstractLongSortedSet implements Serializable, LongSortedSet {
        ...
        boolean bottom;
        boolean top;
        final /* synthetic */ LongAVLTreeSet this$0;
        ...
        public boolean remove(final long k) {
            return this.in(k) && LongAVLTreeSet.this.remove(k);
        }
            ...
            SubsetIterator(final Subset subset, final long k) {
                ...
                if (this.next != null) {
                    if (!subset.bottom && subset.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!subset.top) {
                            final LongAVLTreeSet this$0 = subset.this$0;
