...
public class Long2ShortOpenCustomHashMap extends AbstractLong2ShortMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Long2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Long2ShortOpenCustomHashMap.this.value[Long2ShortOpenCustomHashMap.this.n]);
                    }
                    int pos = Long2ShortOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Long2ShortOpenCustomHashMap.this.key[pos] != 0L) {
                            consumer.accept((int)Long2ShortOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Long2ShortMap.Entry, Map.Entry<Long, Short> {
        ...
        public String toString() {
            return new StringBuilder().append(Long2ShortOpenCustomHashMap.this.key[this.index]).append("=>").append((int)Long2ShortOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Long2ShortMap.Entry> implements Long2ShortMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Long2ShortMap.Entry> consumer) {
            if (Long2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Long2ShortOpenCustomHashMap.this.key[Long2ShortOpenCustomHashMap.this.n], Long2ShortOpenCustomHashMap.this.value[Long2ShortOpenCustomHashMap.this.n]));
            }
            int pos = Long2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ShortOpenCustomHashMap.this.key[pos] != 0L) {
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2ShortOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2ShortOpenCustomHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
