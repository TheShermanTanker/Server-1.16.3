...
public class Long2ByteOpenHashMap extends AbstractLong2ByteMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractByteCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Long2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Long2ByteOpenHashMap.this.value[Long2ByteOpenHashMap.this.n]);
                    }
                    int pos = Long2ByteOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Long2ByteOpenHashMap.this.key[pos] != 0L) {
                            consumer.accept((int)Long2ByteOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Long2ByteMap.Entry, Map.Entry<Long, Byte> {
        ...
        public byte setValue(final byte v) {
            final byte oldValue = Long2ByteOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Long2ByteOpenHashMap.this.key[this.index]).append("=>").append((int)Long2ByteOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            long k;
            int p;
            for (k = this.wrapped.getLong(-this.pos - 1), p = ((int)HashCommon.mix(k) & Long2ByteOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Long2ByteOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Long2ByteOpenHashMap.this.mask);
                long curr;
                while ((curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(curr) & Long2ByteOpenHashMap.this.mask;
                    Label_0102: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0102;
        ...
        public void remove() {
            ...
            final Long2ByteOpenHashMap this$0 = Long2ByteOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2ByteOpenHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2ByteOpenHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final long k) {
            final int oldSize = Long2ByteOpenHashMap.this.size;
