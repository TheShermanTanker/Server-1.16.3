...
public class LongOpenHashSet extends AbstractLongSet implements Serializable, Cloneable, Hash {
    ...
    private class SetIterator implements LongIterator {
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & LongOpenHashSet.this.mask);
                long curr;
                while ((curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(curr) & LongOpenHashSet.this.mask;
                    Label_0102: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0102;
        ...
        public void remove() {
            ...
            final LongOpenHashSet this$0 = LongOpenHashSet.this;
            --this$0.size;
            this.last = -1;
        }
    }
