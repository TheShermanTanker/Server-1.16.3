...
public class Long2ByteOpenCustomHashMap extends AbstractLong2ByteMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractByteCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.n]);
                    }
                    int pos = Long2ByteOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Long2ByteOpenCustomHashMap.this.key[pos] != 0L) {
                            consumer.accept((int)Long2ByteOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Long2ByteMap.Entry, Map.Entry<Long, Byte> {
        ...
        public String toString() {
            return new StringBuilder().append(Long2ByteOpenCustomHashMap.this.key[this.index]).append("=>").append((int)Long2ByteOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Long2ByteMap.Entry> implements Long2ByteMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Long2ByteMap.Entry> consumer) {
            if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Long2ByteOpenCustomHashMap.this.key[Long2ByteOpenCustomHashMap.this.n], Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.n]));
            }
            int pos = Long2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ByteOpenCustomHashMap.this.key[pos] != 0L) {
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2ByteOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2ByteOpenCustomHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
