...
public class Long2ShortAVLTreeMap extends AbstractLong2ShortSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Long2ShortAVLTreeMap.this.findKey((long)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Long2ShortMap.Entry> subSet(final Long2ShortMap.Entry from, final Long2ShortMap.Entry to) {
                    return Long2ShortAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2ShortEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Long2ShortMap.Entry> headSet(final Long2ShortMap.Entry to) {
                    return Long2ShortAVLTreeMap.this.headMap(to.getLongKey()).long2ShortEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Long2ShortMap.Entry> tailSet(final Long2ShortMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final long k) {
            this.index = 0;
            final Entry locateKey = Long2ShortAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractLong2ShortSortedMap implements Serializable {
        ...
        protected transient LongSortedSet keys;
        protected transient ShortCollection values;
        final /* synthetic */ Long2ShortAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Long2ShortAVLTreeMap.Entry f = Long2ShortAVLTreeMap.this.findKey((long)e.getKey());
        ...
        public long firstLongKey() {
            final Long2ShortAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public long lastLongKey() {
            final Long2ShortAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final long k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Long2ShortAVLTreeMap this$0 = submap.this$0;
                            final Long2ShortAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
