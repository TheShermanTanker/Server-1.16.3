...
public class Long2CharOpenCustomHashMap extends AbstractLong2CharMap implements Serializable, Cloneable, Hash {
    ...
    public Long2CharOpenCustomHashMap(final int expected, final float f, final LongHash.Strategy strategy) {
    ...
    public Long2CharOpenCustomHashMap(final int expected, final LongHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Long2CharOpenCustomHashMap(final LongHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Long2CharOpenCustomHashMap(final Map<? extends Long, ? extends Character> m, final float f, final LongHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Long2CharOpenCustomHashMap(final Map<? extends Long, ? extends Character> m, final LongHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Long2CharOpenCustomHashMap(final Long2CharMap m, final float f, final LongHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Long2CharOpenCustomHashMap(final Long2CharMap m, final LongHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Long2CharOpenCustomHashMap(final long[] k, final char[] v, final float f, final LongHash.Strategy strategy) {
    ...
    public Long2CharOpenCustomHashMap(final long[] k, final char[] v, final LongHash.Strategy strategy) {
            ...
            this.values = new AbstractCharCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Long2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((int)Long2CharOpenCustomHashMap.this.value[Long2CharOpenCustomHashMap.this.n]);
                    }
                    int pos = Long2CharOpenCustomHashMap.this.n;
                    while (pos-- != 0) {
                        if (Long2CharOpenCustomHashMap.this.key[pos] != 0L) {
                            consumer.accept((int)Long2CharOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Long2CharMap.Entry, Map.Entry<Long, Character> {
        ...
        public char setValue(final char v) {
            final char oldValue = Long2CharOpenCustomHashMap.this.value[this.index];
        ...
        public boolean equals(final Object o) {
            ...
            return Long2CharOpenCustomHashMap.this.strategy.equals(Long2CharOpenCustomHashMap.this.key[this.index], (long)e.getKey()) && Long2CharOpenCustomHashMap.this.value[this.index] == (char)e.getValue();
        }
        ...
        public String toString() {
            return new StringBuilder().append(Long2CharOpenCustomHashMap.this.key[this.index]).append("=>").append(Long2CharOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            long k;
            int p;
            for (k = this.wrapped.getLong(-this.pos - 1), p = (HashCommon.mix(Long2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Long2CharOpenCustomHashMap.this.mask); !Long2CharOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Long2CharOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Long2CharOpenCustomHashMap.this.mask);
                long curr;
                while ((curr = key[pos]) != 0L) {
                    final int slot = HashCommon.mix(Long2CharOpenCustomHashMap.this.strategy.hashCode(curr)) & Long2CharOpenCustomHashMap.this.mask;
                    Label_0113: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0113;
        ...
        public void remove() {
            ...
            final Long2CharOpenCustomHashMap this$0 = Long2CharOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Long2CharMap.Entry> implements Long2CharMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Long2CharMap.Entry> consumer) {
            if (Long2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Long2CharOpenCustomHashMap.this.key[Long2CharOpenCustomHashMap.this.n], Long2CharOpenCustomHashMap.this.value[Long2CharOpenCustomHashMap.this.n]));
            }
            int pos = Long2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2CharOpenCustomHashMap.this.key[pos] != 0L) {
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2CharOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2CharOpenCustomHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final long k) {
            final int oldSize = Long2CharOpenCustomHashMap.this.size;
