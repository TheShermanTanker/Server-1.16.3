...
public abstract class AbstractLong2FloatMap extends AbstractLong2FloatFunction implements Long2FloatMap, Serializable {
    ...
    public boolean containsKey(final long k) {
        final ObjectIterator<Entry> i = this.long2FloatEntrySet().iterator();
        while (i.hasNext()) {
    ...
    public void putAll(final Map<? extends Long, ? extends Float> m) {
        if (m instanceof Long2FloatMap) {
            final ObjectIterator<Entry> i = Long2FloatMaps.fastIterator((Long2FloatMap)m);
            while (i.hasNext()) {
            ...
            int n = m.size();
            final Iterator<? extends Map.Entry<? extends Long, ? extends Float>> j = m.entrySet().iterator();
            while (n-- != 0) {
                final Map.Entry<? extends Long, ? extends Float> e2 = j.next();
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry> i = Long2FloatMaps.fastIterator(this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.long2FloatEntrySet().containsAll((Collection)m.entrySet());
    }
    ...
    public static class BasicEntry implements Entry {
        ...
        public boolean equals(final Object o) {
            ...
            return value != null && value instanceof Float && this.key == (long)key && Float.floatToIntBits(this.value) == Float.floatToIntBits((float)value);
        }
