...
public class Long2LongOpenHashMap extends AbstractLong2LongMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Long2LongMap.Entry, Map.Entry<Long, Long> {
        ...
        public long setValue(final long v) {
            final long oldValue = Long2LongOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Long2LongOpenHashMap.this.key[this.index]).append("=>").append(Long2LongOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            long k;
            int p;
            for (k = this.wrapped.getLong(-this.pos - 1), p = ((int)HashCommon.mix(k) & Long2LongOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Long2LongOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Long2LongOpenHashMap.this.mask);
                long curr;
                while ((curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(curr) & Long2LongOpenHashMap.this.mask;
                    Label_0102: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0102;
        ...
        public void remove() {
            ...
            final Long2LongOpenHashMap this$0 = Long2LongOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2LongOpenHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2LongOpenHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final long k) {
            final int oldSize = Long2LongOpenHashMap.this.size;
