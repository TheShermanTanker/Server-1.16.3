...
public class Long2DoubleLinkedOpenHashMap extends AbstractLong2DoubleSortedMap implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Long2DoubleMap.Entry, Map.Entry<Long, Double> {
        ...
        public String toString() {
            return new StringBuilder().append(Long2DoubleLinkedOpenHashMap.this.key[this.index]).append("=>").append(Long2DoubleLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class KeySet extends AbstractLongSortedSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2DoubleLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2DoubleLinkedOpenHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
