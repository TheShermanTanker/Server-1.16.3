...
public final class Long2ReferenceFunctions {
    ...
    public static <V> Long2ReferenceFunction<V> primitive(final Function<? super Long, ? extends V> f) {
        Objects.requireNonNull(f);
        if (f instanceof Long2ReferenceFunction) {
            return (Long2ReferenceFunction<V>)(Long2ReferenceFunction)f;
        }
        if (f instanceof LongFunction) {
            final LongFunction longFunction = (LongFunction)f;
            Objects.requireNonNull(longFunction);
            return (Long2ReferenceFunction<V>)longFunction::apply;
        }
