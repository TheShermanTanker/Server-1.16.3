...
public class Long2ByteRBTreeMap extends AbstractLong2ByteSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Long2ByteRBTreeMap.this.findKey((long)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final long k) {
            this.index = 0;
            final Entry locateKey = Long2ByteRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractLong2ByteSortedMap implements Serializable {
        ...
        protected transient LongSortedSet keys;
        protected transient ByteCollection values;
        final /* synthetic */ Long2ByteRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Long2ByteRBTreeMap.Entry f = Long2ByteRBTreeMap.this.findKey((long)e.getKey());
        ...
        public long firstLongKey() {
            final Long2ByteRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public long lastLongKey() {
            final Long2ByteRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final long k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Long2ByteRBTreeMap this$0 = submap.this$0;
                            final Long2ByteRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
