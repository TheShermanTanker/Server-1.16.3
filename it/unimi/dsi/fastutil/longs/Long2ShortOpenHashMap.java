...
public class Long2ShortOpenHashMap extends AbstractLong2ShortMap implements Serializable, Cloneable, Hash {
            ...
            this.values = new AbstractShortCollection() {
                ...
                public void forEach(final IntConsumer consumer) {
                    if (Long2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept((int)Long2ShortOpenHashMap.this.value[Long2ShortOpenHashMap.this.n]);
                    }
                    int pos = Long2ShortOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Long2ShortOpenHashMap.this.key[pos] != 0L) {
                            consumer.accept((int)Long2ShortOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    final class MapEntry implements Long2ShortMap.Entry, Map.Entry<Long, Short> {
        ...
        public short setValue(final short v) {
            final short oldValue = Long2ShortOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Long2ShortOpenHashMap.this.key[this.index]).append("=>").append((int)Long2ShortOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            long k;
            int p;
            for (k = this.wrapped.getLong(-this.pos - 1), p = ((int)HashCommon.mix(k) & Long2ShortOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Long2ShortOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Long2ShortOpenHashMap.this.mask);
                long curr;
                while ((curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(curr) & Long2ShortOpenHashMap.this.mask;
                    Label_0102: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0102;
        ...
        public void remove() {
            ...
            final Long2ShortOpenHashMap this$0 = Long2ShortOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Long2ShortMap.Entry> implements Long2ShortMap.FastEntrySet {
        ...
        public void forEach(final Consumer<? super Long2ShortMap.Entry> consumer) {
            if (Long2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Long2ShortOpenHashMap.this.key[Long2ShortOpenHashMap.this.n], Long2ShortOpenHashMap.this.value[Long2ShortOpenHashMap.this.n]));
            }
            int pos = Long2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ShortOpenHashMap.this.key[pos] != 0L) {
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2ShortOpenHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2ShortOpenHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final long k) {
            final int oldSize = Long2ShortOpenHashMap.this.size;
