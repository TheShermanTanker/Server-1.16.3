...
public class Long2DoubleAVLTreeMap extends AbstractLong2DoubleSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Long2DoubleAVLTreeMap.this.findKey((long)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Long2DoubleMap.Entry> subSet(final Long2DoubleMap.Entry from, final Long2DoubleMap.Entry to) {
                    return Long2DoubleAVLTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2DoubleEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Long2DoubleMap.Entry> headSet(final Long2DoubleMap.Entry to) {
                    return Long2DoubleAVLTreeMap.this.headMap(to.getLongKey()).long2DoubleEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(final Long2DoubleMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final long k) {
            this.index = 0;
            final Entry locateKey = Long2DoubleAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractLong2DoubleSortedMap implements Serializable {
        ...
        protected transient LongSortedSet keys;
        protected transient DoubleCollection values;
        final /* synthetic */ Long2DoubleAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey((long)e.getKey());
        ...
        public long firstLongKey() {
            final Long2DoubleAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public long lastLongKey() {
            final Long2DoubleAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final long k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Long2DoubleAVLTreeMap this$0 = submap.this$0;
                            final Long2DoubleAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
