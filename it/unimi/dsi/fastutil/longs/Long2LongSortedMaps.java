...
public final class Long2LongSortedMaps {
    ...
    public static ObjectBidirectionalIterator<Long2LongMap.Entry> fastIterator(final Long2LongSortedMap map) {
    ...
    public static ObjectBidirectionalIterable<Long2LongMap.Entry> fastIterable(final Long2LongSortedMap map) {
        final ObjectSortedSet<Long2LongMap.Entry> entries = map.long2LongEntrySet();
        ObjectBidirectionalIterable<Long2LongMap.Entry> objectBidirectionalIterable;
        if (entries instanceof Long2LongSortedMap.FastSortedEntrySet) {
            final Long2LongSortedMap.FastSortedEntrySet set = (Long2LongSortedMap.FastSortedEntrySet)entries;
    ...
    public static Long2LongSortedMap singleton(final Long key, final Long value, final LongComparator comparator) {
    ...
    public static class EmptySortedMap extends Long2LongMaps.EmptyMap implements Long2LongSortedMap, Serializable, Cloneable {
        ...
        public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
            return (ObjectSortedSet<Long2LongMap.Entry>)ObjectSortedSets.EMPTY_SET;
        }
        
        @Deprecated
        @Override
        public ObjectSortedSet<Map.Entry<Long, Long>> entrySet() {
            return (ObjectSortedSet<Map.Entry<Long, Long>>)ObjectSortedSets.EMPTY_SET;
        }
        ...
        @Deprecated
        @Override
        public Long2LongSortedMap headMap(final Long oto) {
            return this.headMap((long)oto);
        }
        
        @Deprecated
        @Override
        public Long2LongSortedMap tailMap(final Long ofrom) {
            return this.tailMap((long)ofrom);
        }
        
        @Deprecated
        @Override
        public Long2LongSortedMap subMap(final Long ofrom, final Long oto) {
    ...
    public static class Singleton extends Long2LongMaps.Singleton implements Long2LongSortedMap, Serializable, Cloneable {
        ...
        protected Singleton(final long key, final long value, final LongComparator comparator) {
            super(key, value);
        ...
        public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.singleton(new AbstractLong2LongMap.BasicEntry(this.key, this.value), (java.util.Comparator<? super AbstractLong2LongMap.BasicEntry>)Long2LongSortedMaps.entryComparator(this.comparator));
            }
            return (ObjectSortedSet<Long2LongMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class SynchronizedSortedMap extends Long2LongMaps.SynchronizedMap implements Long2LongSortedMap, Serializable {
        ...
        public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Long2LongMap.Entry>synchronize(this.sortedMap.long2LongEntrySet(), this.sync);
            }
            return (ObjectSortedSet<Long2LongMap.Entry>)(ObjectSortedSet)this.entries;
        }
    ...
    public static class UnmodifiableSortedMap extends Long2LongMaps.UnmodifiableMap implements Long2LongSortedMap, Serializable {
        ...
        public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
            if (this.entries == null) {
                this.entries = ObjectSortedSets.<Long2LongMap.Entry>unmodifiable(this.sortedMap.long2LongEntrySet());
            }
            return (ObjectSortedSet<Long2LongMap.Entry>)(ObjectSortedSet)this.entries;
        }
