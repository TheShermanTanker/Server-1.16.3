...
public class Long2CharAVLTreeMap extends AbstractLong2CharSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Long2CharAVLTreeMap.this.findKey((long)e.getKey());
                    return e.equals(f);
                }
    ...
    private class TreeIterator {
        ...
        TreeIterator(final long k) {
            this.index = 0;
            final Entry locateKey = Long2CharAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractLong2CharSortedMap implements Serializable {
        ...
        protected transient LongSortedSet keys;
        protected transient CharCollection values;
        final /* synthetic */ Long2CharAVLTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2CharMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Long2CharAVLTreeMap.Entry f = Long2CharAVLTreeMap.this.findKey((long)e.getKey());
        ...
        public long firstLongKey() {
            final Long2CharAVLTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public long lastLongKey() {
            final Long2CharAVLTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final long k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Long2CharAVLTreeMap this$0 = submap.this$0;
                            final Long2CharAVLTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
