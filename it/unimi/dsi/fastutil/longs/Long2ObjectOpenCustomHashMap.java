...
public class Long2ObjectOpenCustomHashMap<V> extends AbstractLong2ObjectMap<V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Long2ObjectMap.Entry<V>, Map.Entry<Long, V> {
        ...
        public String toString() {
            return new StringBuilder().append(Long2ObjectOpenCustomHashMap.this.key[this.index]).append("=>").append(Long2ObjectOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Long2ObjectMap.Entry<V>> implements Long2ObjectMap.FastEntrySet<V> {
        ...
        public void forEach(final Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
            if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Long2ObjectOpenCustomHashMap.this.key[Long2ObjectOpenCustomHashMap.this.n], Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n]));
            }
            int pos = Long2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ObjectOpenCustomHashMap.this.key[pos] != 0L) {
                    consumer.accept(new BasicEntry(Long2ObjectOpenCustomHashMap.this.key[pos], Long2ObjectOpenCustomHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2ObjectOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2ObjectOpenCustomHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
