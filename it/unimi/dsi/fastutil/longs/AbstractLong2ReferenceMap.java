...
public abstract class AbstractLong2ReferenceMap<V> extends AbstractLong2ReferenceFunction<V> implements Long2ReferenceMap<V>, Serializable {
    ...
    public boolean containsKey(final long k) {
        final ObjectIterator<Entry<V>> i = this.long2ReferenceEntrySet().iterator();
        while (i.hasNext()) {
        ...
        return new AbstractLongSet() {
            ...
            public LongIterator iterator() {
                return new LongIterator() {
                    private final ObjectIterator<Entry<V>> i = Long2ReferenceMaps.<V>fastIterator((Long2ReferenceMap<V>)AbstractLong2ReferenceMap.this);
    ...
    public void putAll(final Map<? extends Long, ? extends V> m) {
        if (m instanceof Long2ReferenceMap) {
            final ObjectIterator<Entry<V>> i = Long2ReferenceMaps.<V>fastIterator((Long2ReferenceMap<V>)(Long2ReferenceMap)m);
            while (i.hasNext()) {
    ...
    public int hashCode() {
        int h = 0;
        int n = this.size();
        final ObjectIterator<Entry<V>> i = Long2ReferenceMaps.<V>fastIterator((Long2ReferenceMap<V>)this);
        while (n-- != 0) {
    ...
    public boolean equals(final Object o) {
        ...
        final Map<?, ?> m = o;
        return m.size() == this.size() && this.long2ReferenceEntrySet().containsAll((Collection)m.entrySet());
    }
