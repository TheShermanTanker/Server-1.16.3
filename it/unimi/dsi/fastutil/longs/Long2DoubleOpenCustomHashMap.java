...
public class Long2DoubleOpenCustomHashMap extends AbstractLong2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    public Long2DoubleOpenCustomHashMap(final int expected, final float f, final LongHash.Strategy strategy) {
    ...
    public Long2DoubleOpenCustomHashMap(final int expected, final LongHash.Strategy strategy) {
        this(expected, 0.75f, strategy);
    }
    
    public Long2DoubleOpenCustomHashMap(final LongHash.Strategy strategy) {
        this(16, 0.75f, strategy);
    }
    
    public Long2DoubleOpenCustomHashMap(final Map<? extends Long, ? extends Double> m, final float f, final LongHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Long2DoubleOpenCustomHashMap(final Map<? extends Long, ? extends Double> m, final LongHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Long2DoubleOpenCustomHashMap(final Long2DoubleMap m, final float f, final LongHash.Strategy strategy) {
        this(m.size(), f, strategy);
        this.putAll(m);
    }
    
    public Long2DoubleOpenCustomHashMap(final Long2DoubleMap m, final LongHash.Strategy strategy) {
        this(m, 0.75f, strategy);
    }
    
    public Long2DoubleOpenCustomHashMap(final long[] k, final double[] v, final float f, final LongHash.Strategy strategy) {
    ...
    public Long2DoubleOpenCustomHashMap(final long[] k, final double[] v, final LongHash.Strategy strategy) {
    ...
    final class MapEntry implements Long2DoubleMap.Entry, Map.Entry<Long, Double> {
        ...
        public double setValue(final double v) {
            final double oldValue = Long2DoubleOpenCustomHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Long2DoubleOpenCustomHashMap.this.key[this.index]).append("=>").append(Long2DoubleOpenCustomHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            long k;
            int p;
            for (k = this.wrapped.getLong(-this.pos - 1), p = (HashCommon.mix(Long2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Long2DoubleOpenCustomHashMap.this.mask); !Long2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p]); p = (p + 1 & Long2DoubleOpenCustomHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                pos = ((last = pos) + 1 & Long2DoubleOpenCustomHashMap.this.mask);
                long curr;
                while ((curr = key[pos]) != 0L) {
                    final int slot = HashCommon.mix(Long2DoubleOpenCustomHashMap.this.strategy.hashCode(curr)) & Long2DoubleOpenCustomHashMap.this.mask;
                    Label_0113: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0113;
        ...
        public void remove() {
            ...
            final Long2DoubleOpenCustomHashMap this$0 = Long2DoubleOpenCustomHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Long2DoubleMap.Entry> implements Long2DoubleMap.FastEntrySet {
        ...
        public boolean remove(final Object o) {
            ...
            if (Long2DoubleOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                ...
                if (!Long2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while ((curr = key[pos = (pos + 1 & Long2DoubleOpenCustomHashMap.this.mask)]) != 0L) {
                        if (Long2DoubleOpenCustomHashMap.this.strategy.equals(curr, k) && Double.doubleToLongBits(Long2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
        ...
        public void forEach(final Consumer<? super Long2DoubleMap.Entry> consumer) {
            if (Long2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Long2DoubleOpenCustomHashMap.this.key[Long2DoubleOpenCustomHashMap.this.n], Long2DoubleOpenCustomHashMap.this.value[Long2DoubleOpenCustomHashMap.this.n]));
            }
            int pos = Long2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                if (Long2DoubleOpenCustomHashMap.this.key[pos] != 0L) {
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2DoubleOpenCustomHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2DoubleOpenCustomHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final long k) {
            final int oldSize = Long2DoubleOpenCustomHashMap.this.size;
