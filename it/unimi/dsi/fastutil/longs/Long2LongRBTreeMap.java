...
public class Long2LongRBTreeMap extends AbstractLong2LongSortedMap implements Serializable, Cloneable {
        ...
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2LongMap.Entry>() {
                ...
                public boolean contains(final Object o) {
                    ...
                    final Entry f = Long2LongRBTreeMap.this.findKey((long)e.getKey());
                    return e.equals(f);
                }
                ...
                @Override
                public ObjectSortedSet<Long2LongMap.Entry> subSet(final Long2LongMap.Entry from, final Long2LongMap.Entry to) {
                    return Long2LongRBTreeMap.this.subMap(from.getLongKey(), to.getLongKey()).long2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Long2LongMap.Entry> headSet(final Long2LongMap.Entry to) {
                    return Long2LongRBTreeMap.this.headMap(to.getLongKey()).long2LongEntrySet();
                }
                
                @Override
                public ObjectSortedSet<Long2LongMap.Entry> tailSet(final Long2LongMap.Entry from) {
    ...
    private class TreeIterator {
        ...
        TreeIterator(final long k) {
            this.index = 0;
            final Entry locateKey = Long2LongRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey != null) {
    ...
    private final class Submap extends AbstractLong2LongSortedMap implements Serializable {
        ...
        protected transient LongSortedSet keys;
        protected transient LongCollection values;
        final /* synthetic */ Long2LongRBTreeMap this$0;
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2LongMap.Entry>() {
                    ...
                    public boolean contains(final Object o) {
                        ...
                        final Long2LongRBTreeMap.Entry f = Long2LongRBTreeMap.this.findKey((long)e.getKey());
        ...
        public long firstLongKey() {
            final Long2LongRBTreeMap.Entry e = this.firstEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
        ...
        public long lastLongKey() {
            final Long2LongRBTreeMap.Entry e = this.lastEntry();
            if (e == null) {
                throw new NoSuchElementException();
            }
            return e.key;
            ...
            SubmapIterator(final Submap submap, final long k) {
                ...
                if (this.next != null) {
                    if (!submap.bottom && submap.this$0.compare(k, this.next.key) < 0) {
                        ...
                        if (!submap.top) {
                            final Long2LongRBTreeMap this$0 = submap.this$0;
                            final Long2LongRBTreeMap.Entry lastEntry = submap.lastEntry();
                            this.prev = lastEntry;
