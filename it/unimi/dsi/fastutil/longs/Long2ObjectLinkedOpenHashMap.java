...
public class Long2ObjectLinkedOpenHashMap<V> extends AbstractLong2ObjectSortedMap<V> implements Serializable, Cloneable, Hash {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>() {
                ...
                public void forEach(final Consumer<? super V> consumer) {
                    ...
                    while (pos-- != 0) {
                        if (Long2ObjectLinkedOpenHashMap.this.key[pos] != 0L) {
    ...
    final class MapEntry implements Long2ObjectMap.Entry<V>, Map.Entry<Long, V> {
        ...
        public String toString() {
            return new StringBuilder().append(Long2ObjectLinkedOpenHashMap.this.key[this.index]).append("=>").append(Long2ObjectLinkedOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private final class MapEntrySet extends AbstractObjectSortedSet<Long2ObjectMap.Entry<V>> implements Long2ObjectSortedMap.FastSortedEntrySet<V> {
        ...
        public void forEach(final Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
            ...
            while (i-- != 0) {
                ...
                consumer.accept(new BasicEntry(Long2ObjectLinkedOpenHashMap.this.key[curr], Long2ObjectLinkedOpenHashMap.this.value[curr]));
            }
        }
    ...
    private final class KeySet extends AbstractLongSortedSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2ObjectLinkedOpenHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
