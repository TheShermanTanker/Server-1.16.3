...
public class Long2ReferenceOpenHashMap<V> extends AbstractLong2ReferenceMap<V> implements Serializable, Cloneable, Hash {
    ...
    final class MapEntry implements Long2ReferenceMap.Entry<V>, Map.Entry<Long, V> {
        ...
        public V setValue(final V v) {
            final V oldValue = Long2ReferenceOpenHashMap.this.value[this.index];
        ...
        public String toString() {
            return new StringBuilder().append(Long2ReferenceOpenHashMap.this.key[this.index]).append("=>").append(Long2ReferenceOpenHashMap.this.value[this.index]).toString();
        }
    }
    ...
    private class MapIterator {
        ...
        public int nextEntry() {
            ...
            long k;
            int p;
            for (k = this.wrapped.getLong(-this.pos - 1), p = ((int)HashCommon.mix(k) & Long2ReferenceOpenHashMap.this.mask); k != key[p]; p = (p + 1 & Long2ReferenceOpenHashMap.this.mask)) {}
            return p;
        }
        ...
        Label_0009:
            while (true) {
                ...
                long curr;
                while ((curr = key[pos]) != 0L) {
                    final int slot = (int)HashCommon.mix(curr) & Long2ReferenceOpenHashMap.this.mask;
                    Label_0112: {
                        if (last <= pos) {
                            if (last >= slot) {
                                break Label_0112;
        ...
        public void remove() {
            ...
            final Long2ReferenceOpenHashMap this$0 = Long2ReferenceOpenHashMap.this;
            --this$0.size;
            this.last = -1;
        }
    ...
    private final class MapEntrySet extends AbstractObjectSet<Long2ReferenceMap.Entry<V>> implements Long2ReferenceMap.FastEntrySet<V> {
        ...
        public void forEach(final Consumer<? super Long2ReferenceMap.Entry<V>> consumer) {
            if (Long2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new BasicEntry(Long2ReferenceOpenHashMap.this.key[Long2ReferenceOpenHashMap.this.n], Long2ReferenceOpenHashMap.this.value[Long2ReferenceOpenHashMap.this.n]));
            }
            int pos = Long2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                if (Long2ReferenceOpenHashMap.this.key[pos] != 0L) {
                    consumer.accept(new BasicEntry(Long2ReferenceOpenHashMap.this.key[pos], Long2ReferenceOpenHashMap.this.value[pos]));
                }
            }
        }
    ...
    private final class KeySet extends AbstractLongSet {
        ...
        public void forEach(final LongConsumer consumer) {
            ...
            int pos = Long2ReferenceOpenHashMap.this.n;
            while (pos-- != 0) {
                final long k = Long2ReferenceOpenHashMap.this.key[pos];
                if (k != 0L) {
                    consumer.accept(k);
                }
            }
        ...
        public boolean remove(final long k) {
            final int oldSize = Long2ReferenceOpenHashMap.this.size;
