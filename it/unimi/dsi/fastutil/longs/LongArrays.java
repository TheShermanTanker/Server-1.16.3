...
public final class LongArrays {
    ...
    public static void radixSort(final long[] a, final int from, final int to) {
        ...
        while (stackPos > 0) {
            ...
            while (i-- != first) {
                ...
                final int n = (int)((a[i] >>> shift & 0xFFL) ^ (long)signMask);
                ++array[n];
            }
            int lastUsed = -1;
            int j = 0;
            ...
            executorCompletionService.submit(() -> {
                ...
                while (true) {
                    if (queueSize.get() == 0) {
                        ...
                        while (i-- != 0) {
                            queue.add(LongArrays.POISON_PILL);
                        }
                    }
                    final Segment segment = (Segment)queue.take();
                    if (segment == LongArrays.POISON_PILL) {
                        break;
                    }
                    ...
                    while (j-- != first) {
                        final int[] array = count;
                        final int n = (int)((a[j] >>> shift & 0xFFL) ^ (long)signMask);
                        ++array[n];
                    }
                    int lastUsed = -1;
                    int k = 0;
    ...
    public static void radixSortIndirect(final int[] perm, final long[] a, final int from, final int to, final boolean stable) {
        ...
        while (stackPos > 0) {
            ...
            while (i-- != first) {
                final int[] array = count;
                final int n = (int)((a[perm[i]] >>> shift & 0xFFL) ^ (long)signMask);
                ++array[n];
            }
            int lastUsed = -1;
            int j = 0;
            ...
            if (stable) {
                ...
                while (j-- != first) {
                    ...
                    final int n2 = (int)((a[perm[j]] >>> shift & 0xFFL) ^ (long)signMask);
        ...
        while (j-- != 0) {
            executorCompletionService.submit(() -> {
                ...
                while (true) {
                    ...
                    while (j-- != first) {
                        final int[] array = count;
                        final int n = (int)((a[perm[j]] >>> shift & 0xFFL) ^ (long)signMask);
                        ++array[n];
                    }
                    int lastUsed = -1;
                    int k = 0;
                    ...
                    if (stable) {
                        ...
                        while (k-- != first) {
                            final int[] array2 = pos;
                            final int n2 = (int)((a[perm[k]] >>> shift & 0xFFL) ^ (long)signMask);
    ...
    public static void radixSort(final long[] a, final long[] b, final int from, final int to) {
        ...
        while (stackPos > 0) {
            ...
            while (i-- != first) {
                final int[] array = count;
                final int n = (int)((k[i] >>> shift & 0xFFL) ^ (long)signMask);
                ++array[n];
            }
            int lastUsed = -1;
            int j = 0;
            ...
            for (int end = first + length - count[lastUsed], l = first, c = -1; l <= end; l += count[c], count[c] = 0) {
                long t = a[l];
                long u = b[l];
                c = (int)((k[l] >>> shift & 0xFFL) ^ (long)signMask);
                if (l < end) {
                    while (true) {
                        final int[] array2 = pos;
                        final int n2 = c;
        ...
        while (j-- != 0) {
            executorCompletionService.submit(() -> {
                ...
                while (true) {
                    ...
                    while (j-- != first) {
                        final int[] array = count;
                        final int n = (int)((k[j] >>> shift & 0xFFL) ^ (long)signMask);
                        ++array[n];
                    }
                    int lastUsed = -1;
                    int l = 0;
                    ...
                    for (int end = first + length - count[lastUsed], m = first, c = -1; m <= end; m += count[c], count[c] = 0) {
                        long t = a[m];
                        long u = b[m];
                        c = (int)((k[m] >>> shift & 0xFFL) ^ (long)signMask);
                        if (m < end) {
                            while (true) {
                                final int[] array2 = pos;
                                final int n2 = c;
    ...
    public static void radixSortIndirect(final int[] perm, final long[] a, final long[] b, final int from, final int to, final boolean stable) {
        ...
        while (stackPos > 0) {
            ...
            while (i-- != first) {
                final int[] array = count;
                final int n = (int)((k[perm[i]] >>> shift & 0xFFL) ^ (long)signMask);
                ++array[n];
            }
            int lastUsed = -1;
            int j = 0;
            ...
            if (stable) {
                ...
                while (j-- != first) {
                    final int[] array2 = support;
                    final int[] array3 = pos;
                    final int n2 = (int)((k[perm[j]] >>> shift & 0xFFL) ^ (long)signMask);
                    array2[--array3[n2]] = perm[j];
                }
                System.arraycopy(support, 0, perm, first, length);
                j = 0;
