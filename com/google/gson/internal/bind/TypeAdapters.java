...
public final class TypeAdapters {
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(final Class<T1> clazz, final TypeAdapter<T1> typeAdapter) {
        return new TypeAdapterFactory() {
            public <T2> TypeAdapter<T2> create(final Gson gson, final TypeToken<T2> typeToken) {
                ...
                if (!clazz.isAssignableFrom((Class)requestedType)) {
                    return null;
                }
    ...
    static {
        ...
        CLASS_FACTORY = TypeAdapters.<Class>newFactory(Class.class, TypeAdapters.CLASS);
                ...
                for (JsonToken tokenType = in.peek(); tokenType != JsonToken.END_ARRAY; tokenType = in.peek()) {
                    ...
                    switch (tokenType) {
                        ...
                        case STRING: {
                            ...
                            throw new JsonSyntaxException(new StringBuilder().append("Invalid bitset value type: ").append(tokenType).toString());
                        }
                    }
                    if (set) {
                        bitset.set(i);
        ...
        BIT_SET_FACTORY = TypeAdapters.<BitSet>newFactory(BitSet.class, TypeAdapters.BIT_SET);
        ...
        BOOLEAN_FACTORY = TypeAdapters.<Boolean>newFactory((java.lang.Class<Boolean>)Boolean.TYPE, Boolean.class, TypeAdapters.BOOLEAN);
        ...
        BYTE_FACTORY = TypeAdapters.<Byte>newFactory((java.lang.Class<Byte>)Byte.TYPE, Byte.class, TypeAdapters.BYTE);
        ...
        SHORT_FACTORY = TypeAdapters.<Short>newFactory((java.lang.Class<Short>)Short.TYPE, Short.class, TypeAdapters.SHORT);
        ...
        INTEGER_FACTORY = TypeAdapters.<Integer>newFactory((java.lang.Class<Integer>)Integer.TYPE, Integer.class, TypeAdapters.INTEGER);
        ...
        ATOMIC_INTEGER_FACTORY = TypeAdapters.<AtomicInteger>newFactory(AtomicInteger.class, TypeAdapters.ATOMIC_INTEGER);
        ...
        ATOMIC_BOOLEAN_FACTORY = TypeAdapters.<AtomicBoolean>newFactory(AtomicBoolean.class, TypeAdapters.ATOMIC_BOOLEAN);
        ...
        ATOMIC_INTEGER_ARRAY_FACTORY = TypeAdapters.<AtomicIntegerArray>newFactory(AtomicIntegerArray.class, TypeAdapters.ATOMIC_INTEGER_ARRAY);
        ...
        NUMBER_FACTORY = TypeAdapters.<Number>newFactory(Number.class, TypeAdapters.NUMBER);
        ...
        CHARACTER_FACTORY = TypeAdapters.<Character>newFactory((java.lang.Class<Character>)Character.TYPE, Character.class, TypeAdapters.CHARACTER);
        ...
        STRING_FACTORY = TypeAdapters.<String>newFactory(String.class, TypeAdapters.STRING);
        ...
        STRING_BUILDER_FACTORY = TypeAdapters.<StringBuilder>newFactory(StringBuilder.class, TypeAdapters.STRING_BUILDER);
        ...
        STRING_BUFFER_FACTORY = TypeAdapters.<StringBuffer>newFactory(StringBuffer.class, TypeAdapters.STRING_BUFFER);
        ...
        URL_FACTORY = TypeAdapters.<URL>newFactory(URL.class, TypeAdapters.URL);
        ...
        URI_FACTORY = TypeAdapters.<URI>newFactory(URI.class, TypeAdapters.URI);
        ...
        INET_ADDRESS_FACTORY = TypeAdapters.<InetAddress>newTypeHierarchyFactory(InetAddress.class, TypeAdapters.INET_ADDRESS);
        ...
        UUID_FACTORY = TypeAdapters.<UUID>newFactory(UUID.class, TypeAdapters.UUID);
        ...
        CURRENCY_FACTORY = TypeAdapters.<Currency>newFactory(Currency.class, TypeAdapters.CURRENCY);
        ...
        CALENDAR = new TypeAdapter<Calendar>() {
            ...
            public Calendar read(final JsonReader in) throws IOException {
                ...
                in.endObject();
                return (Calendar)new GregorianCalendar(year, month, dayOfMonth, hourOfDay, minute, second);
            }
        ...
        CALENDAR_FACTORY = TypeAdapters.<Calendar>newFactoryForMultipleTypes(Calendar.class, (java.lang.Class<? extends Calendar>)GregorianCalendar.class, TypeAdapters.CALENDAR);
        ...
        LOCALE_FACTORY = TypeAdapters.<Locale>newFactory(Locale.class, TypeAdapters.LOCALE);
            ...
            public void write(final JsonWriter out, final JsonElement value) throws IOException {
                if (value == null || value.isJsonNull()) {
                    ...
                    if (!value.isJsonObject()) {
                        throw new IllegalArgumentException(new StringBuilder().append("Couldn't write ").append(value.getClass()).toString());
                    }
                    out.beginObject();
                    for (final Map.Entry<String, JsonElement> e2 : value.getAsJsonObject().entrySet()) {
                        out.name((String)e2.getKey());
                        this.write(out, (JsonElement)e2.getValue());
                    }
                    out.endObject();
                }
            }
        };
        JSON_ELEMENT_FACTORY = TypeAdapters.<JsonElement>newTypeHierarchyFactory(JsonElement.class, TypeAdapters.JSON_ELEMENT);
        ENUM_FACTORY = new TypeAdapterFactory() {
            public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> typeToken) {
                Class<? super T> rawType = typeToken.getRawType();
                if (!Enum.class.isAssignableFrom((Class)rawType) || rawType == Enum.class) {
                    return null;
                }
                if (!rawType.isEnum()) {
                    rawType = rawType.getSuperclass();
                }
                return new EnumTypeAdapter<T>((java.lang.Class<T>)rawType);
            }
        };
    }
    ...
    private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public EnumTypeAdapter(final Class<T> classOfT) {
            this.nameToConstant = (Map<String, T>)new HashMap();
            this.constantToName = (Map<T, String>)new HashMap();
            try {
                for (final T constant : (Enum[])classOfT.getEnumConstants()) {
                    String name = constant.name();
                    final SerializedName annotation = (SerializedName)classOfT.getField(name).getAnnotation((Class)SerializedName.class);
                    if (annotation != null) {
