...
public final class JsonTreeWriter extends JsonWriter {
    ...
    public JsonTreeWriter() {
        ...
        this.stack = (List<JsonElement>)new ArrayList();
        this.product = JsonNull.INSTANCE;
    }
    
    public JsonElement get() {
        if (!this.stack.isEmpty()) {
            throw new IllegalStateException(new StringBuilder().append("Expected one JSON element but was ").append(this.stack).toString());
        }
        return this.product;
    }
    ...
    public JsonWriter value(final double value) throws IOException {
        if (!this.isLenient() && (Double.isNaN(value) || Double.isInfinite(value))) {
            throw new IllegalArgumentException(new StringBuilder().append("JSON forbids NaN and infinities: ").append(value).toString());
        }
        this.put(new JsonPrimitive(value));
        return this;
    }
