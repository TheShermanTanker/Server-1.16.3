...
public final class ArrayTypeAdapter<E> extends TypeAdapter<Object> {
    ...
    public Object read(final JsonReader in) throws IOException {
        ...
        final List<E> list = (List<E>)new ArrayList();
        in.beginArray();
        while (in.hasNext()) {
        ...
        in.endArray();
        final Object array = Array.newInstance((Class)this.componentType, list.size());
    ...
    static {
        FACTORY = new TypeAdapterFactory() {
            public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> typeToken) {
                ...
                return (TypeAdapter<T>)new ArrayTypeAdapter(gson, (TypeAdapter<Object>)componentTypeAdapter, (java.lang.Class<Object>)$Gson$Types.getRawType(componentType));
            }
        };
    }
}
