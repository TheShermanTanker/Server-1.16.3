...
public final class TreeTypeAdapter<T> extends TypeAdapter<T> {
    ...
    private static final class SingleTypeFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> type) {
            final boolean matches = (this.exactType != null) ? (this.exactType.equals(type) || (this.matchRawType && this.exactType.getType() == type.getRawType())) : this.hierarchyType.isAssignableFrom((Class)type.getRawType());
    ...
    private final class GsonContextImpl implements JsonSerializationContext, JsonDeserializationContext {
        ...
        public <R> R deserialize(final JsonElement json, final Type typeOfT) throws JsonParseException {
            return TreeTypeAdapter.this.gson.<R>fromJson(json, typeOfT);
        }
    }
}
