...
public class ISO8601Utils {
    ...
    public static String format(final Date date, final boolean millis, final TimeZone tz) {
        final Calendar calendar = (Calendar)new GregorianCalendar(tz, Locale.US);
    ...
    public static Date parse(final String date, final ParsePosition pos) throws ParseException {
        ...
        try {
            ...
            if (!hasT && date.length() <= offset) {
                final Calendar calendar = (Calendar)new GregorianCalendar(year, month - 1, day);
                pos.setIndex(offset);
            ...
            if (timezoneIndicator == 'Z') {
                ...
                if (timezoneIndicator != '+' && timezoneIndicator != '-') {
                    throw new IndexOutOfBoundsException(new StringBuilder().append("Invalid time zone indicator '").append(timezoneIndicator).append("'").toString());
                }
            ...
            final Calendar calendar2 = (Calendar)new GregorianCalendar(timezone);
