...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        ...
        return (Set<Map.Entry<K, V>>)((result != null) ? result : (this.entrySet = new EntrySet()));
    }
    
    public Set<K> keySet() {
        final KeySet result = this.keySet;
        return (Set<K>)((result != null) ? result : (this.keySet = new KeySet()));
    }
    
    private void doubleCapacity() {
        this.table = LinkedHashTreeMap.<K, V>doubleCapacity(this.table);
        this.threshold = this.table.length / 2 + this.table.length / 4;
    }
    ...
    static {
        NATURAL_ORDER = (Comparator)new Comparator<Comparable>() {
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            return (Iterator<Map.Entry<K, V>>)new LinkedTreeMapIterator<Map.Entry<K, V>>() {
                public Map.Entry<K, V> next() {
                    return (Map.Entry<K, V>)this.nextNode();
                }
            };
        }
        
        public boolean contains(final Object o) {
            return o instanceof Map.Entry && LinkedHashTreeMap.this.findByEntry(o) != null;
        }
        ...
        public boolean remove(final Object o) {
            ...
            final Node<K, V> node = LinkedHashTreeMap.this.findByEntry(o);
            if (node == null) {
                return false;
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public Iterator<K> iterator() {
            return (Iterator<K>)new LinkedTreeMapIterator<K>() {
                public K next() {
