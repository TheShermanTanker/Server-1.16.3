...
public class JsonWriter implements Closeable, Flushable {
    ...
    public JsonWriter value(final double value) throws IOException {
        if (Double.isNaN(value) || Double.isInfinite(value)) {
            throw new IllegalArgumentException(new StringBuilder().append("Numeric values must be finite, but was ").append(value).toString());
        }
        this.writeDeferredName();
        this.beforeValue();
    ...
    static {
        ...
        for (int i = 0; i <= 31; ++i) {
            JsonWriter.REPLACEMENT_CHARS[i] = String.format("\\u%04x", new Object[] { i });
        }
