...
public class JsonReader implements Closeable {
    ...
    public void beginArray() throws IOException {
        ...
        throw new IllegalStateException(new StringBuilder().append("Expected BEGIN_ARRAY but was ").append(this.peek()).append(this.locationString()).toString());
    }
    ...
    public void endArray() throws IOException {
        ...
        throw new IllegalStateException(new StringBuilder().append("Expected END_ARRAY but was ").append(this.peek()).append(this.locationString()).toString());
    }
    ...
    public void beginObject() throws IOException {
        ...
        throw new IllegalStateException(new StringBuilder().append("Expected BEGIN_OBJECT but was ").append(this.peek()).append(this.locationString()).toString());
    }
    ...
    public void endObject() throws IOException {
        ...
        throw new IllegalStateException(new StringBuilder().append("Expected END_OBJECT but was ").append(this.peek()).append(this.locationString()).toString());
    }
    ...
    public String nextName() throws IOException {
        ...
        if (p == 14) {
            ...
            if (p != 13) {
                throw new IllegalStateException(new StringBuilder().append("Expected a name but was ").append(this.peek()).append(this.locationString()).toString());
            }
            result = this.nextQuotedValue('\"');
        }
        this.peeked = 0;
    ...
    public String nextString() throws IOException {
        ...
        if (p == 10) {
            ...
            if (p != 16) {
                throw new IllegalStateException(new StringBuilder().append("Expected a string but was ").append(this.peek()).append(this.locationString()).toString());
            }
    ...
    public boolean nextBoolean() throws IOException {
        ...
        throw new IllegalStateException(new StringBuilder().append("Expected a boolean but was ").append(this.peek()).append(this.locationString()).toString());
    }
    ...
    public void nextNull() throws IOException {
        ...
        throw new IllegalStateException(new StringBuilder().append("Expected null but was ").append(this.peek()).append(this.locationString()).toString());
    }
    ...
    public double nextDouble() throws IOException {
        ...
        if (p == 16) {
            ...
            throw new IllegalStateException(new StringBuilder().append("Expected a double but was ").append(this.peek()).append(this.locationString()).toString());
        }
        this.peeked = 11;
        final double result = Double.parseDouble(this.peekedString);
        if (!this.lenient && (Double.isNaN(result) || Double.isInfinite(result))) {
            throw new MalformedJsonException(new StringBuilder().append("JSON forbids NaN and infinities: ").append(result).append(this.locationString()).toString());
        }
        this.peekedString = null;
        this.peeked = 0;
        final int[] pathIndices2 = this.pathIndices;
    ...
    public long nextLong() throws IOException {
        ...
        Label_0218: {
            if (p != 16) {
                ...
                throw new IllegalStateException(new StringBuilder().append("Expected a long but was ").append(this.peek()).append(this.locationString()).toString());
            }
            this.peekedString = new String(this.buffer, this.pos, this.peekedNumberLength);
            this.pos += this.peekedNumberLength;
        }
    ...
    public int nextInt() throws IOException {
        ...
        if (p == 15) {
            ...
            if (this.peekedLong != result) {
                throw new NumberFormatException(new StringBuilder().append("Expected an int but was ").append(this.peekedLong).append(this.locationString()).toString());
            }
            this.peeked = 0;
            final int[] pathIndices = this.pathIndices;
            final int n = this.stackSize - 1;
            ...
            Label_0269: {
                if (p != 16) {
                    ...
                    throw new IllegalStateException(new StringBuilder().append("Expected an int but was ").append(this.peek()).append(this.locationString()).toString());
                }
                this.peekedString = new String(this.buffer, this.pos, this.peekedNumberLength);
                this.pos += this.peekedNumberLength;
            }
    ...
    private String locationString() {
        ...
        return new StringBuilder().append(" at line ").append(line).append(" column ").append(column).append(" path ").append(this.getPath()).toString();
    }
        ...
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() {
            ...
            public void promoteNameToValue(final JsonReader reader) throws IOException {
                ...
                if (p == 13) {
                    ...
                    if (p != 14) {
                        throw new IllegalStateException(new StringBuilder().append("Expected a name but was ").append(reader.peek()).append(reader.locationString()).toString());
                    }
                    reader.peeked = 10;
                }
            }
