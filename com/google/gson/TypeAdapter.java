...
public abstract class TypeAdapter<T> {
    public abstract void write(final JsonWriter jsonWriter, final T object) throws IOException;
    ...
    public abstract T read(final JsonReader jsonReader) throws IOException;
