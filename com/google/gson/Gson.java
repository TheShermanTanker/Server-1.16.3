...
public final class Gson {
    ...
    public Gson() {
        this(Excluder.DEFAULT, FieldNamingPolicy.IDENTITY, (Map<Type, InstanceCreator<?>>)Collections.emptyMap(), false, false, false, true, false, false, false, LongSerializationPolicy.DEFAULT, (List<TypeAdapterFactory>)Collections.emptyList());
    }
    ...
    Gson(final Excluder excluder, final FieldNamingStrategy fieldNamingStrategy, final Map<Type, InstanceCreator<?>> instanceCreators, final boolean serializeNulls, final boolean complexMapKeySerialization, final boolean generateNonExecutableGson, final boolean htmlSafe, final boolean prettyPrinting, final boolean lenient, final boolean serializeSpecialFloatingPointValues, final LongSerializationPolicy longSerializationPolicy, final List<TypeAdapterFactory> typeAdapterFactories) {
        ...
        factories.addAll((Collection)typeAdapterFactories);
        ...
        factories.add(TypeAdapters.<Long>newFactory((java.lang.Class<Long>)Long.TYPE, Long.class, longAdapter));
        factories.add(TypeAdapters.<Double>newFactory((java.lang.Class<Double>)Double.TYPE, Double.class, this.doubleAdapter(serializeSpecialFloatingPointValues)));
        factories.add(TypeAdapters.<Float>newFactory((java.lang.Class<Float>)Float.TYPE, Float.class, this.floatAdapter(serializeSpecialFloatingPointValues)));
        factories.add(TypeAdapters.NUMBER_FACTORY);
        factories.add(TypeAdapters.ATOMIC_INTEGER_FACTORY);
        factories.add(TypeAdapters.ATOMIC_BOOLEAN_FACTORY);
        factories.add(TypeAdapters.<AtomicLong>newFactory(AtomicLong.class, atomicLongAdapter(longAdapter)));
        factories.add(TypeAdapters.<AtomicLongArray>newFactory(AtomicLongArray.class, atomicLongArrayAdapter(longAdapter)));
    ...
    static void checkValidFloatingPoint(final double value) {
        if (Double.isNaN(value) || Double.isInfinite(value)) {
            throw new IllegalArgumentException(new StringBuilder().append(value).append(" is not a valid double value as per JSON specification. To override this behavior, use GsonBuilder.serializeSpecialFloatingPointValues() method.").toString());
        }
    }
    ...
    public <T> TypeAdapter<T> getAdapter(final TypeToken<T> type) {
        ...
        try {
            ...
            for (final TypeAdapterFactory factory : this.factories) {
                final TypeAdapter<T> candidate = factory.<T>create(this, type);
                if (candidate != null) {
            ...
            throw new IllegalArgumentException(new StringBuilder().append("GSON cannot handle ").append(type).toString());
        }
        finally {
    ...
    public <T> TypeAdapter<T> getDelegateAdapter(TypeAdapterFactory skipPast, final TypeToken<T> type) {
        ...
        throw new IllegalArgumentException(new StringBuilder().append("GSON cannot serialize ").append(type).toString());
    }
    
    public <T> TypeAdapter<T> getAdapter(final Class<T> type) {
        return this.<T>getAdapter(TypeToken.get((java.lang.Class<T>)type));
    }
    ...
    public <T> T fromJson(final String json, final Class<T> classOfT) throws JsonSyntaxException {
        ...
        return (T)Primitives.<T>wrap(classOfT).cast(object);
    }
    ...
    public <T> T fromJson(final String json, final Type typeOfT) throws JsonSyntaxException {
        ...
        final T target = this.<T>fromJson((Reader)reader, typeOfT);
        return target;
    }
    ...
    public <T> T fromJson(final Reader json, final Type typeOfT) throws JsonIOException, JsonSyntaxException {
        final JsonReader jsonReader = this.newJsonReader(json);
        final T object = this.<T>fromJson(jsonReader, typeOfT);
        assertFullConsumption(object, jsonReader);
        return object;
    }
    ...
    public <T> T fromJson(final JsonReader reader, final Type typeOfT) throws JsonIOException, JsonSyntaxException {
        ...
        try {
            ...
            final TypeAdapter<T> typeAdapter = this.<T>getAdapter(typeToken);
    ...
    public <T> T fromJson(final JsonElement json, final Type typeOfT) throws JsonSyntaxException {
        ...
        return this.<T>fromJson(new JsonTreeReader(json), typeOfT);
    }
