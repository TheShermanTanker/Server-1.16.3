...
public final class JsonStreamParser implements Iterator<JsonElement> {
    ...
    public JsonElement next() throws JsonParseException {
        ...
        try {
            ...
            throw new JsonParseException("Failed parsing JSON source to Json", (Throwable)e);
        }
        catch (OutOfMemoryError e2) {
            throw new JsonParseException("Failed parsing JSON source to Json", (Throwable)e2);
        }
