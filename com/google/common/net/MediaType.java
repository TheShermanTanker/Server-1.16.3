...
public final class MediaType {
    ...
    private Map<String, ImmutableMultiset<String>> parametersAsMap() {
        return Maps.<String, Object, ImmutableMultiset<String>>transformValues((java.util.Map<String, Object>)this.parameters.asMap(), new Function<Collection<String>, ImmutableMultiset<String>>() {
            public ImmutableMultiset<String> apply(final Collection<String> input) {
                return ImmutableMultiset.<String>copyOf((java.lang.Iterable<? extends String>)input);
            }
        });
    }
    
    public Optional<Charset> charset() {
        final ImmutableSet<String> charsetValues = ImmutableSet.<String>copyOf((java.util.Collection<? extends String>)this.parameters.get("charset"));
        switch (charsetValues.size()) {
            case 0: {
                return Optional.<Charset>absent();
            }
            case 1: {
                return Optional.<Charset>of(Charset.forName((String)Iterables.<String>getOnlyElement((java.lang.Iterable<String>)charsetValues)));
            }
            default: {
                throw new IllegalStateException(new StringBuilder().append("Multiple charset values defined: ").append(charsetValues).toString());
            }
        }
    }
    ...
    public MediaType withParameter(final String attribute, final String value) {
        Preconditions.<String>checkNotNull(attribute);
        Preconditions.<String>checkNotNull(value);
        final String normalizedAttribute = normalizeToken(attribute);
        final ImmutableListMultimap.Builder<String, String> builder = ImmutableListMultimap.<String, String>builder();
        ...
        return MoreObjects.<MediaType>firstNonNull(MediaType.KNOWN_TYPES.get(mediaType), mediaType);
    }
    ...
    private static MediaType create(final String type, final String subtype, final Multimap<String, String> parameters) {
        Preconditions.<String>checkNotNull(type);
        Preconditions.<String>checkNotNull(subtype);
        Preconditions.<Multimap<String, String>>checkNotNull(parameters);
        ...
        for (final Map.Entry<String, String> entry : parameters.entries()) {
            final String attribute = normalizeToken((String)entry.getKey());
    ...
    private static String normalizeToken(final String token) {
        Preconditions.checkArgument(MediaType.TOKEN_MATCHER.matchesAllOf((CharSequence)token));
    ...
    public static MediaType parse(final String input) {
        Preconditions.<String>checkNotNull(input);
        ...
        try {
            ...
            final ImmutableListMultimap.Builder<String, String> parameters = ImmutableListMultimap.<String, String>builder();
            ...
            throw new IllegalArgumentException("Could not parse '" + input + "'", (Throwable)e);
        }
    }
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            builder.append("; ");
            final Multimap<String, String> quotedParameters = Multimaps.transformValues(this.parameters, new Function<String, String>() {
                public String apply(final String value) {
                    return MediaType.TOKEN_MATCHER.matchesAllOf((CharSequence)value) ? value : escapeAndQuote(value);
                }
            });
            MediaType.PARAMETER_JOINER.appendTo(builder, quotedParameters.entries());
        }
    ...
    static {
        UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.<String, String>of("charset", Ascii.toLowerCase(Charsets.UTF_8.name()));
        ...
        KNOWN_TYPES = (Map)Maps.newHashMap();
    ...
    private static final class Tokenizer {
        ...
        String consumeTokenIfPresent(final CharMatcher matcher) {
            ...
            this.position = matcher.negate().indexIn((CharSequence)this.input, startPosition);
