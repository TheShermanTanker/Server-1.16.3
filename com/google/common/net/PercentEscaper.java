...
public final class PercentEscaper extends UnicodeEscaper {
    ...
    public PercentEscaper(String safeChars, final boolean plusForSpace) {
        Preconditions.<String>checkNotNull(safeChars);
    ...
    protected char[] escape(int cp) {
        ...
        throw new IllegalArgumentException(new StringBuilder().append("Invalid unicode character value ").append(cp).toString());
    }
