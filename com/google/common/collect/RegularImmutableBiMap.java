...
class RegularImmutableBiMap<K, V> extends ImmutableBiMap<K, V> {
    ...
    static <K, V> RegularImmutableBiMap<K, V> fromEntries(final Map.Entry<K, V>... entries) {
        return RegularImmutableBiMap.<K, V>fromEntryArray(entries.length, entries);
    }
    ...
    static <K, V> RegularImmutableBiMap<K, V> fromEntryArray(final int n, final Map.Entry<K, V>[] entryArray) {
        ...
        final ImmutableMapEntry<K, V>[] keyTable = ImmutableMapEntry.<K, V>createEntryArray(tableSize);
        final ImmutableMapEntry<K, V>[] valueTable = ImmutableMapEntry.<K, V>createEntryArray(tableSize);
        ...
        for (int i = 0; i < n; ++i) {
            ...
            entries[i] = (Map.Entry<K, V>)(valueTable[valueBucket] = newEntry);
    ...
    public V get(@Nullable final Object key) {
        return (this.keyTable == null) ? null : RegularImmutableMap.<V>get(key, this.keyTable, this.mask);
    }
    
    @Override
    ImmutableSet<Map.Entry<K, V>> createEntrySet() {
        return (ImmutableSet<Map.Entry<K, V>>)(this.isEmpty() ? ImmutableSet.<Map.Entry<K, V>>of() : new ImmutableMapEntrySet.RegularEntrySet((ImmutableMap<Object, Object>)this, (Map.Entry<Object, Object>[])this.entries));
    }
