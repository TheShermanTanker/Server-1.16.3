...
final class CollectPreconditions {
    static void checkEntryNotNull(final Object key, final Object value) {
        if (key == null) {
            throw new NullPointerException(new StringBuilder().append("null key in entry: null=").append(value).toString());
        }
        if (value == null) {
            throw new NullPointerException(new StringBuilder().append("null value in entry: ").append(key).append("=null").toString());
        }
    }
