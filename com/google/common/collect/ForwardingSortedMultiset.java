...
public abstract class ForwardingSortedMultiset<E> extends ForwardingMultiset<E> implements SortedMultiset<E> {
    ...
    protected Multiset.Entry<E> standardFirstEntry() {
        final Iterator<Multiset.Entry<E>> entryIterator = (Iterator<Multiset.Entry<E>>)this.entrySet().iterator();
        if (!entryIterator.hasNext()) {
            return null;
        }
        final Multiset.Entry<E> entry = (Multiset.Entry<E>)entryIterator.next();
        return Multisets.<E>immutableEntry(entry.getElement(), entry.getCount());
    }
    ...
    protected Multiset.Entry<E> standardPollFirstEntry() {
        ...
        Multiset.Entry<E> entry = (Multiset.Entry<E>)entryIterator.next();
        entry = Multisets.<E>immutableEntry(entry.getElement(), entry.getCount());
