...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
    ...
    public static <E extends Comparable<E>> MinMaxPriorityQueue<E> create() {
        return (MinMaxPriorityQueue<E>)new Builder((Comparator)Ordering.<Comparable>natural()).create();
    }
    
    public static <E extends Comparable<E>> MinMaxPriorityQueue<E> create(final Iterable<? extends E> initialContents) {
        return (MinMaxPriorityQueue<E>)new Builder((Comparator)Ordering.<Comparable>natural()).create((Iterable)initialContents);
    }
    ...
    public static Builder<Comparable> expectedSize(final int expectedSize) {
        return new Builder<Comparable>((Comparator)Ordering.<Comparable>natural()).expectedSize(expectedSize);
    }
    
    public static Builder<Comparable> maximumSize(final int maximumSize) {
        return new Builder<Comparable>((Comparator)Ordering.<Comparable>natural()).maximumSize(maximumSize);
    }
    ...
    private MinMaxPriorityQueue(final Builder<? super E> builder, final int queueSize) {
        ...
        this.maxHeap = new Heap(ordering.<E>reverse());
    ...
    MoveDesc<E> removeAt(final int index) {
        ...
        final int lastElementAt = this.heapForIndex(this.size).swapWithConceptuallyLastElement(actualLastElement);
    ...
    public static final class Builder<B> {
        ...
        private Builder(final Comparator<B> comparator) {
            ...
            this.comparator = Preconditions.<Comparator<B>>checkNotNull(comparator);
        }
        ...
        public <T extends B> MinMaxPriorityQueue<T> create() {
            return this.<T>create((java.lang.Iterable<? extends T>)Collections.emptySet());
        }
        ...
        private <T extends B> Ordering<T> ordering() {
            return Ordering.<T>from((java.util.Comparator<T>)this.comparator);
        }
    }
    ...
    private class Heap {
        ...
        int swapWithConceptuallyLastElement(final E actualLastElement) {
    ...
    private class QueueIterator implements Iterator<E> {
        ...
        public void remove() {
            ...
            if (this.cursor < MinMaxPriorityQueue.this.size()) {
                ...
                if (moved != null) {
                    if (this.forgetMeNot == null) {
                        this.forgetMeNot = (Queue<E>)new ArrayDeque();
                        this.skipMe = (List<E>)new ArrayList(3);
                    }
                    if (!this.foundAndRemovedExactReference((Iterable<E>)this.skipMe, moved.toTrickle)) {
                        this.forgetMeNot.add(moved.toTrickle);
                    }
                    if (!this.foundAndRemovedExactReference((Iterable<E>)this.forgetMeNot, moved.replaced)) {
        ...
        private boolean foundAndRemovedExactReference(final Iterable<E> elements, final E target) {
            final Iterator<E> it = (Iterator<E>)elements.iterator();
            while (it.hasNext()) {
                final E element = (E)it.next();
                if (element == target) {
                    it.remove();
                    return true;
                }
        ...
        private boolean removeExact(final Object target) {
        ...
        private void nextNotInSkipMe(int c) {
            if (this.nextCursor < c) {
                if (this.skipMe != null) {
                    while (c < MinMaxPriorityQueue.this.size() && this.foundAndRemovedExactReference((Iterable<E>)this.skipMe, MinMaxPriorityQueue.this.elementData(c))) {
                        ++c;
                    }
                }
                this.nextCursor = c;
