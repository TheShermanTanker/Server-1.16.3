...
final class UnmodifiableSortedMultiset<E> extends Multisets.UnmodifiableMultiset<E> implements SortedMultiset<E> {
    ...
    NavigableSet<E> createElementSet() {
        return Sets.<E>unmodifiableNavigableSet(this.delegate().elementSet());
    }
    ...
    public SortedMultiset<E> headMultiset(final E upperBound, final BoundType boundType) {
        return Multisets.<E>unmodifiableSortedMultiset(this.delegate().headMultiset(upperBound, boundType));
    }
    ...
    public SortedMultiset<E> subMultiset(final E lowerBound, final BoundType lowerBoundType, final E upperBound, final BoundType upperBoundType) {
        return Multisets.<E>unmodifiableSortedMultiset(this.delegate().subMultiset(lowerBound, lowerBoundType, upperBound, upperBoundType));
    }
    
    @Override
    public SortedMultiset<E> tailMultiset(final E lowerBound, final BoundType boundType) {
        return Multisets.<E>unmodifiableSortedMultiset(this.delegate().tailMultiset(lowerBound, boundType));
    }
}
