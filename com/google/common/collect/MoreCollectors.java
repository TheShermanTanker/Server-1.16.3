...
public final class MoreCollectors {
    ...
    public static <T> Collector<T, ?, Optional<T>> toOptional() {
        return MoreCollectors.TO_OPTIONAL;
    }
    
    public static <T> Collector<T, ?, T> onlyElement() {
        return MoreCollectors.ONLY_ELEMENT;
    }
    ...
    static {
        TO_OPTIONAL = Collector.of(ToOptionalState::new, ToOptionalState::add, ToOptionalState::combine, ToOptionalState::getOptional, new Collector.Characteristics[] { Collector.Characteristics.UNORDERED });
        ...
        ONLY_ELEMENT = Collector.of(ToOptionalState::new, (state, o) -> state.add((o == null) ? MoreCollectors.NULL_PLACEHOLDER : o), ToOptionalState::combine, state -> {
            final Object result = state.getElement();
    ...
    private static final class ToOptionalState {
        ...
        void add(final Object o) {
            ...
            if (this.element == null) {
                ...
                (this.extras = (List<Object>)new ArrayList(4)).add(o);
            }
            else {
        ...
        ToOptionalState combine(final ToOptionalState other) {
            ...
            if (this.extras == null) {
                this.extras = (List<Object>)new ArrayList();
            }
            this.extras.add(other.element);
            if (other.extras != null) {
                this.extras.addAll((Collection)other.extras);
            }
            if (this.extras.size() > 4) {
        ...
        Optional<Object> getOptional() {
            if (this.extras == null) {
                return (Optional<Object>)Optional.ofNullable(this.element);
            }
