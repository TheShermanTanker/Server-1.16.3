...
final class GeneralRange<T> implements Serializable {
    ...
    static <T extends Comparable> GeneralRange<T> from(final Range<T> range) {
        ...
        return new GeneralRange<T>((java.util.Comparator<? super T>)Ordering.<Comparable>natural(), range.hasLowerBound(), lowerEndpoint, lowerBoundType, range.hasUpperBound(), upperEndpoint, upperBoundType);
    }
    ...
    private GeneralRange(final Comparator<? super T> comparator, final boolean hasLowerBound, @Nullable final T lowerEndpoint, final BoundType lowerBoundType, final boolean hasUpperBound, @Nullable final T upperEndpoint, final BoundType upperBoundType) {
        this.comparator = Preconditions.<Comparator<? super T>>checkNotNull(comparator);
        this.hasLowerBound = hasLowerBound;
        this.hasUpperBound = hasUpperBound;
        this.lowerEndpoint = lowerEndpoint;
        this.lowerBoundType = Preconditions.<BoundType>checkNotNull(lowerBoundType);
        this.upperEndpoint = upperEndpoint;
        this.upperBoundType = Preconditions.<BoundType>checkNotNull(upperBoundType);
        if (hasLowerBound) {
        ...
        if (hasLowerBound && hasUpperBound) {
            final int cmp = comparator.compare(lowerEndpoint, upperEndpoint);
    ...
    boolean tooLow(@Nullable final T t) {
        ...
        final int cmp = this.comparator.compare(t, lbound);
    ...
    boolean tooHigh(@Nullable final T t) {
        ...
        final int cmp = this.comparator.compare(t, ubound);
    ...
    GeneralRange<T> intersect(final GeneralRange<T> other) {
        Preconditions.<GeneralRange<T>>checkNotNull(other);
        ...
        if (!this.hasLowerBound()) {
            ...
            final int cmp = this.comparator.compare(this.getLowerEndpoint(), other.getLowerEndpoint());
        ...
        if (!this.hasUpperBound()) {
            ...
            final int cmp2 = this.comparator.compare(this.getUpperEndpoint(), other.getUpperEndpoint());
        ...
        if (hasLowBound && hasUpBound) {
            final int cmp2 = this.comparator.compare(lowEnd, upEnd);
    ...
    public String toString() {
        return new StringBuilder().append(this.comparator).append(":").append((this.lowerBoundType == BoundType.CLOSED) ? '[' : '(').append(this.hasLowerBound ? this.lowerEndpoint : "-\u221e").append(',').append(this.hasUpperBound ? this.upperEndpoint : "\u221e").append((this.upperBoundType == BoundType.CLOSED) ? ']' : ')').toString();
    }
