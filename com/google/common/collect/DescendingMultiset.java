...
abstract class DescendingMultiset<E> extends ForwardingMultiset<E> implements SortedMultiset<E> {
    ...
    public NavigableSet<E> elementSet() {
        ...
        if (result == null) {
            return this.elementSet = (NavigableSet<E>)new SortedMultisets.NavigableElementSet((SortedMultiset<Object>)this);
        }
        return result;
    }
    ...
    Set<Multiset.Entry<E>> createEntrySet() {
        ...
        return (Set<Multiset.Entry<E>>)new 1EntrySetImpl();
    }
    
    @Override
    public Iterator<E> iterator() {
        return Multisets.<E>iteratorImpl((Multiset<E>)this);
    }
