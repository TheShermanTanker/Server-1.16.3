...
class MapMakerInternalMap<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    static <K, V> MapMakerInternalMap<K, V, ? extends InternalEntry<K, V, ?>, ?> create(final MapMaker builder) {
        if (builder.getKeyStrength() == Strength.STRONG && builder.getValueStrength() == Strength.STRONG) {
            return new MapMakerInternalMap<K, V, InternalEntry<K, V, ?>, Object>(builder, StrongKeyStrongValueEntry.Helper.instance());
        }
        if (builder.getKeyStrength() == Strength.STRONG && builder.getValueStrength() == Strength.WEAK) {
            return new MapMakerInternalMap<K, V, InternalEntry<K, V, ?>, Object>(builder, StrongKeyWeakValueEntry.Helper.instance());
        }
        if (builder.getKeyStrength() == Strength.WEAK && builder.getValueStrength() == Strength.STRONG) {
            return new MapMakerInternalMap<K, V, InternalEntry<K, V, ?>, Object>(builder, WeakKeyStrongValueEntry.Helper.instance());
        }
        if (builder.getKeyStrength() == Strength.WEAK && builder.getValueStrength() == Strength.WEAK) {
            return new MapMakerInternalMap<K, V, InternalEntry<K, V, ?>, Object>(builder, WeakKeyWeakValueEntry.Helper.instance());
        }
    ...
    E getEntry(@Nullable final Object key) {
        if (key == null) {
            return null;
        }
        final int hash = this.hash(key);
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            for (final Segment<K, V, E, S> segment : segments) {
                ...
                for (int j = 0; j < table.length(); ++j) {
                    for (E e = (E)table.get(j); e != null; e = ((InternalEntry<K, V, E>)e).getNext()) {
    ...
    public Set<K> keySet() {
        ...
        return (ks != null) ? ks : (this.keySet = (Set<K>)new KeySet());
    }
    
    public Collection<V> values() {
        final Collection<V> vs = this.values;
        return (vs != null) ? vs : (this.values = (Collection<V>)new Values());
    }
    ...
    Object writeReplace() {
        return new SerializationProxy(this.entryHelper.keyStrength(), this.entryHelper.valueStrength(), this.keyEquivalence, this.entryHelper.valueStrength().defaultEquivalence(), this.concurrencyLevel, (java.util.concurrent.ConcurrentMap<Object, Object>)this);
    }
    ...
    abstract static class AbstractStrongKeyEntry<K, V, E extends InternalEntry<K, V, E>> implements InternalEntry<K, V, E> {
        ...
        AbstractStrongKeyEntry(final K key, final int hash, @Nullable final E next) {
            this.key = key;
            this.hash = hash;
            this.next = next;
        }
    ...
    static final class StrongKeyStrongValueEntry<K, V> extends AbstractStrongKeyEntry<K, V, StrongKeyStrongValueEntry<K, V>> implements StrongValueEntry<K, V, StrongKeyStrongValueEntry<K, V>> {
        ...
        StrongKeyStrongValueEntry(final K key, final int hash, @Nullable final StrongKeyStrongValueEntry<K, V> next) {
            super(key, hash, next);
            this.value = null;
        }
        ...
        static final class Helper<K, V> implements InternalEntryHelper<K, V, StrongKeyStrongValueEntry<K, V>, StrongKeyStrongValueSegment<K, V>> {
            ...
            public StrongKeyStrongValueEntry<K, V> copy(final StrongKeyStrongValueSegment<K, V> segment, final StrongKeyStrongValueEntry<K, V> entry, @Nullable final StrongKeyStrongValueEntry<K, V> newNext) {
            ...
            public StrongKeyStrongValueEntry<K, V> newEntry(final StrongKeyStrongValueSegment<K, V> segment, final K key, final int hash, @Nullable final StrongKeyStrongValueEntry<K, V> next) {
    ...
    static final class StrongKeyWeakValueEntry<K, V> extends AbstractStrongKeyEntry<K, V, StrongKeyWeakValueEntry<K, V>> implements WeakValueEntry<K, V, StrongKeyWeakValueEntry<K, V>> {
        ...
        StrongKeyWeakValueEntry(final K key, final int hash, @Nullable final StrongKeyWeakValueEntry<K, V> next) {
            super(key, hash, next);
            this.valueReference = MapMakerInternalMap.<K, V, StrongKeyWeakValueEntry<K, V>>unsetWeakValueReference();
        }
        ...
        static final class Helper<K, V> implements InternalEntryHelper<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> {
            ...
            public StrongKeyWeakValueEntry<K, V> copy(final StrongKeyWeakValueSegment<K, V> segment, final StrongKeyWeakValueEntry<K, V> entry, @Nullable final StrongKeyWeakValueEntry<K, V> newNext) {
                if (Segment.<Object, Object, StrongKeyWeakValueEntry<K, V>>isCollected(entry)) {
                    return null;
                }
                return entry.copy((java.lang.ref.ReferenceQueue<V>)((StrongKeyWeakValueSegment<Object, Object>)segment).queueForValues, newNext);
            }
            
            public void setValue(final StrongKeyWeakValueSegment<K, V> segment, final StrongKeyWeakValueEntry<K, V> entry, final V value) {
                entry.setValue(value, (java.lang.ref.ReferenceQueue<V>)((StrongKeyWeakValueSegment<Object, Object>)segment).queueForValues);
            }
            
            public StrongKeyWeakValueEntry<K, V> newEntry(final StrongKeyWeakValueSegment<K, V> segment, final K key, final int hash, @Nullable final StrongKeyWeakValueEntry<K, V> next) {
    ...
    abstract static class AbstractWeakKeyEntry<K, V, E extends InternalEntry<K, V, E>> extends WeakReference<K> implements InternalEntry<K, V, E> {
        ...
        AbstractWeakKeyEntry(final ReferenceQueue<K> queue, final K key, final int hash, @Nullable final E next) {
    ...
    static final class WeakKeyStrongValueEntry<K, V> extends AbstractWeakKeyEntry<K, V, WeakKeyStrongValueEntry<K, V>> implements StrongValueEntry<K, V, WeakKeyStrongValueEntry<K, V>> {
        ...
        WeakKeyStrongValueEntry(final ReferenceQueue<K> queue, final K key, final int hash, @Nullable final WeakKeyStrongValueEntry<K, V> next) {
        ...
        static final class Helper<K, V> implements InternalEntryHelper<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> {
            ...
            public WeakKeyStrongValueEntry<K, V> copy(final WeakKeyStrongValueSegment<K, V> segment, final WeakKeyStrongValueEntry<K, V> entry, @Nullable final WeakKeyStrongValueEntry<K, V> newNext) {
                if (entry.getKey() == null) {
                    return null;
                }
                return entry.copy((java.lang.ref.ReferenceQueue<K>)((WeakKeyStrongValueSegment<Object, Object>)segment).queueForKeys, newNext);
            }
            ...
            public WeakKeyStrongValueEntry<K, V> newEntry(final WeakKeyStrongValueSegment<K, V> segment, final K key, final int hash, @Nullable final WeakKeyStrongValueEntry<K, V> next) {
                return new WeakKeyStrongValueEntry<K, V>((java.lang.ref.ReferenceQueue<K>)((WeakKeyStrongValueSegment<Object, Object>)segment).queueForKeys, key, hash, next);
            }
    ...
    static final class WeakKeyWeakValueEntry<K, V> extends AbstractWeakKeyEntry<K, V, WeakKeyWeakValueEntry<K, V>> implements WeakValueEntry<K, V, WeakKeyWeakValueEntry<K, V>> {
        ...
        WeakKeyWeakValueEntry(final ReferenceQueue<K> queue, final K key, final int hash, @Nullable final WeakKeyWeakValueEntry<K, V> next) {
            super(queue, key, hash, next);
            this.valueReference = MapMakerInternalMap.<K, V, WeakKeyWeakValueEntry<K, V>>unsetWeakValueReference();
        }
        ...
        static final class Helper<K, V> implements InternalEntryHelper<K, V, WeakKeyWeakValueEntry<K, V>, WeakKeyWeakValueSegment<K, V>> {
            ...
            public WeakKeyWeakValueEntry<K, V> copy(final WeakKeyWeakValueSegment<K, V> segment, final WeakKeyWeakValueEntry<K, V> entry, @Nullable final WeakKeyWeakValueEntry<K, V> newNext) {
                if (entry.getKey() == null) {
                    return null;
                }
                if (Segment.<Object, Object, WeakKeyWeakValueEntry<K, V>>isCollected(entry)) {
                    return null;
                }
                return entry.copy((java.lang.ref.ReferenceQueue<K>)((WeakKeyWeakValueSegment<Object, Object>)segment).queueForKeys, (java.lang.ref.ReferenceQueue<V>)((WeakKeyWeakValueSegment<Object, Object>)segment).queueForValues, newNext);
            }
            
            public void setValue(final WeakKeyWeakValueSegment<K, V> segment, final WeakKeyWeakValueEntry<K, V> entry, final V value) {
                entry.setValue(value, (java.lang.ref.ReferenceQueue<V>)((WeakKeyWeakValueSegment<Object, Object>)segment).queueForValues);
            }
            
            public WeakKeyWeakValueEntry<K, V> newEntry(final WeakKeyWeakValueSegment<K, V> segment, final K key, final int hash, @Nullable final WeakKeyWeakValueEntry<K, V> next) {
                return new WeakKeyWeakValueEntry<K, V>((java.lang.ref.ReferenceQueue<K>)((WeakKeyWeakValueSegment<Object, Object>)segment).queueForKeys, key, hash, next);
            }
    ...
    static final class WeakValueReferenceImpl<K, V, E extends InternalEntry<K, V, E>> extends WeakReference<V> implements WeakValueReference<K, V, E> {
        ...
        public WeakValueReference<K, V, E> copyFor(final ReferenceQueue<V> queue, final E entry) {
            return new WeakValueReferenceImpl((java.lang.ref.ReferenceQueue<Object>)queue, this.get(), entry);
        }
    }
    ...
    abstract static class Segment<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends ReentrantLock {
        ...
        AtomicReferenceArray<E> newEntryArray(final int size) {
            return (AtomicReferenceArray<E>)new AtomicReferenceArray(size);
        }
        ...
        abstract E castForTesting(final InternalEntry<K, V, ?> internalEntry);
        ...
        E copyForTesting(final InternalEntry<K, V, ?> entry, @Nullable final InternalEntry<K, V, ?> newNext) {
        ...
        E newEntryForTesting(final K key, final int hash, @Nullable final InternalEntry<K, V, ?> next) {
            ...
            try {
                if (this.count != 0) {
                    ...
                    for (int length = table.length(), i = 0; i < length; ++i) {
                        for (E e = (E)table.get(i); e != null; e = ((InternalEntry<K, V, E>)e).getNext()) {
        ...
        V put(final K key, final int hash, final V value, final boolean onlyIfAbsent) {
            ...
            try {
                ...
                E e;
                final E first = e = (E)table.get(index);
                while (e != null) {
                    final K entryKey = ((InternalEntry<K, V, E>)e).getKey();
        ...
        void expand() {
            ...
            for (int oldIndex = 0; oldIndex < oldCapacity; ++oldIndex) {
                final E head = (E)oldTable.get(oldIndex);
                if (head != null) {
                    ...
                    if (next == null) {
                        ...
                        for (E e = head; e != tail; e = ((InternalEntry<K, V, E>)e).getNext()) {
                            final int newIndex = e.getHash() & newMask;
                            final E newNext = (E)newTable.get(newIndex);
            ...
            try {
                ...
                while (e != null) {
                    ...
                    if (e.getHash() == hash && entryKey != null && this.map.keyEquivalence.equivalent(key, entryKey)) {
                        final V entryValue = ((InternalEntry<K, V, E>)e).getValue();
                        if (entryValue == null) {
                            if (Segment.<Object, Object, E>isCollected(e)) {
                                int newCount = this.count - 1;
                                ++this.modCount;
        ...
        V remove(final Object key, final int hash) {
            ...
            try {
                ...
                final int index = hash & table.length() - 1;
                E e;
                for (E first = e = (E)table.get(index); e != null; e = ((InternalEntry<K, V, E>)e).getNext()) {
                    final K entryKey = ((InternalEntry<K, V, E>)e).getKey();
                    if (e.getHash() == hash && entryKey != null && this.map.keyEquivalence.equivalent(key, entryKey)) {
                        final V entryValue = ((InternalEntry<K, V, E>)e).getValue();
                        if (entryValue == null) {
            ...
            try {
                ...
                for (E first = e = (E)table.get(index); e != null; e = ((InternalEntry<K, V, E>)e).getNext()) {
                    ...
                    if (e.getHash() == hash && entryKey != null && this.map.keyEquivalence.equivalent(key, entryKey)) {
                        ...
                        else if (!Segment.<Object, Object, E>isCollected(e)) {
                            return false;
                        }
                        ++this.modCount;
                        final E newFirst = this.removeFromChain(first, e);
    ...
    static final class StrongKeyWeakValueSegment<K, V> extends Segment<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> {
        ...
        StrongKeyWeakValueSegment(final MapMakerInternalMap<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> map, final int initialCapacity, final int maxSegmentSize) {
            super(map, initialCapacity, maxSegmentSize);
            this.queueForValues = (ReferenceQueue<V>)new ReferenceQueue();
        }
        ...
        @Override
        void maybeClearReferenceQueues() {
            this.<V>clearReferenceQueue(this.queueForValues);
        }
    }
    ...
    static final class WeakKeyStrongValueSegment<K, V> extends Segment<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> {
        ...
        WeakKeyStrongValueSegment(final MapMakerInternalMap<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> map, final int initialCapacity, final int maxSegmentSize) {
            super(map, initialCapacity, maxSegmentSize);
            this.queueForKeys = (ReferenceQueue<K>)new ReferenceQueue();
        }
        ...
        @Override
        void maybeClearReferenceQueues() {
            this.<K>clearReferenceQueue(this.queueForKeys);
        }
    }
    ...
    static final class WeakKeyStrongValueSegment<K, V> extends Segment<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> {
        ...
        WeakKeyStrongValueSegment(final MapMakerInternalMap<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> map, final int initialCapacity, final int maxSegmentSize) {
            super(map, initialCapacity, maxSegmentSize);
            this.queueForKeys = (java.lang.ref.ReferenceQueue<K>)new ReferenceQueue();
        }
    ...
    static final class CleanupMapTask implements Runnable {
        ...
        public CleanupMapTask(final MapMakerInternalMap<?, ?, ?, ?> map) {
            this.mapReference = (WeakReference<MapMakerInternalMap<?, ?, ?, ?>>)new WeakReference(map);
        }
    ...
    abstract class HashIterator<T> implements Iterator<T> {
        ...
        boolean nextInTable() {
            while (this.nextTableIndex >= 0) {
                final InternalEntry nextEntry = (InternalEntry)this.currentTable.get(this.nextTableIndex--);
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public Object[] toArray() {
            return MapMakerInternalMap.toArrayList((java.util.Collection<Object>)this).toArray();
        }
        
        public <E> E[] toArray(final E[] a) {
            return (E[])MapMakerInternalMap.toArrayList((java.util.Collection<Object>)this).toArray((Object[])a);
        }
    }
    ...
    private static final class SerializationProxy<K, V> extends AbstractSerializationProxy<K, V> {
        ...
        private void readObject(final ObjectInputStream in) throws IOException, ClassNotFoundException {
            ...
            this.delegate = (java.util.concurrent.ConcurrentMap<K, V>)mapMaker.<K, V>makeMap();
            this.readEntries(in);
        }
    ...
    interface WeakValueReference<K, V, E extends InternalEntry<K, V, E>> {
        ...
        WeakValueReference<K, V, E> copyFor(final ReferenceQueue<V> referenceQueue, final E internalEntry);
    }
    ...
    interface InternalEntryHelper<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> {
        ...
        S newSegment(final MapMakerInternalMap<K, V, E, S> mapMakerInternalMap, final int integer2, final int integer3);
        
        E newEntry(final S segment, final K object, final int integer, @Nullable final E internalEntry);
        
        E copy(final S segment, final E internalEntry2, @Nullable final E internalEntry3);
        
        void setValue(final S segment, final E internalEntry, final V object);
    }
}
