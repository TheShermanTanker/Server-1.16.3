...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
    ...
    public static <E> Collector<E, ?, ImmutableSet<E>> toImmutableSet() {
        return CollectCollectors.<E>toImmutableSet();
    }
    ...
    public static <E> ImmutableSet<E> of(final E e1, final E e2, final E e3, final E e4, final E e5, final E e6, final E... others) {
        ...
        return ImmutableSet.<E>construct(elements.length, elements);
    }
    ...
    public static <E> ImmutableSet<E> copyOf(final Iterable<? extends E> elements) {
        return (elements instanceof Collection) ? ImmutableSet.<E>copyOf((java.util.Collection<? extends E>)elements) : ImmutableSet.<E>copyOf((java.util.Iterator<? extends E>)elements.iterator());
    }
    ...
    public static <E> ImmutableSet<E> copyOf(final E[] elements) {
        switch (elements.length) {
            ...
            case 1: {
                return ImmutableSet.<E>of(elements[0]);
            }
            default: {
                return ImmutableSet.<E>construct(elements.length, (Object[])elements.clone());
            }
        }
    }
    ...
    abstract static class Indexed<E> extends ImmutableSet<E> {
        abstract E get(final int integer);
        ...
        public Spliterator<E> spliterator() {
            return CollectSpliterators.<E>indexed(this.size(), 1297, (java.util.function.IntFunction<E>)this::get);
        }
    ...
    public static class Builder<E> extends ArrayBasedBuilder<E> {
        ...
        public ImmutableSet<E> build() {
            final ImmutableSet<E> result = ImmutableSet.construct(this.size, this.contents);
