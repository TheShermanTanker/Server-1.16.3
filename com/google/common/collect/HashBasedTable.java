...
public class HashBasedTable<R, C, V> extends StandardTable<R, C, V> {
    ...
    public static <R, C, V> HashBasedTable<R, C, V> create() {
        return new HashBasedTable<R, C, V>((java.util.Map<R, java.util.Map<C, V>>)new LinkedHashMap(), new Factory<C, V>(0));
    }
    ...
    public static <R, C, V> HashBasedTable<R, C, V> create(final int expectedRows, final int expectedCellsPerRow) {
        ...
        final Map<R, Map<C, V>> backingMap = Maps.newLinkedHashMapWithExpectedSize(expectedRows);
    ...
    public static <R, C, V> HashBasedTable<R, C, V> create(final Table<? extends R, ? extends C, ? extends V> table) {
        final HashBasedTable<R, C, V> result = HashBasedTable.<R, C, V>create();
        result.putAll(table);
        return result;
    }
