...
final class RegularImmutableSet<E> extends Indexed<E> {
    ...
    public Spliterator<E> spliterator() {
        return (Spliterator<E>)Spliterators.spliterator(this.elements, 1297);
    }
    ...
    ImmutableList<E> createAsList() {
        return (this.table == null) ? ImmutableList.<E>of() : new RegularImmutableAsList<E>(this, this.elements);
    }
