...
public abstract class DiscreteDomain<C extends Comparable> {
    ...
    public abstract C next(final C comparable);
    
    public abstract C previous(final C comparable);
    
    public abstract long distance(final C comparable1, final C comparable2);
