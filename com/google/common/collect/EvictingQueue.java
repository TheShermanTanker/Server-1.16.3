...
public final class EvictingQueue<E> extends ForwardingQueue<E> implements Serializable {
    ...
    private EvictingQueue(final int maxSize) {
        ...
        this.delegate = (Queue<E>)new ArrayDeque(maxSize);
    ...
    public boolean addAll(final Collection<? extends E> collection) {
        ...
        if (size >= this.maxSize) {
            this.clear();
            return Iterables.addAll((java.util.Collection<Object>)this, Iterables.skip((java.lang.Iterable<? extends T>)collection, size - this.maxSize));
        }
