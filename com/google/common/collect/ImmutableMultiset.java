...
public abstract class ImmutableMultiset<E> extends ImmutableCollection<E> implements Multiset<E> {
    ...
    public static <E> Collector<E, ?, ImmutableMultiset<E>> toImmutableMultiset() {
        return ImmutableMultiset.<E, E>toImmutableMultiset((java.util.function.Function<? super E, ? extends E>)Function.identity(), (java.util.function.ToIntFunction<? super E>)(e -> 1));
    }
    ...
    private static <T, E> Collector<T, ?, ImmutableMultiset<E>> toImmutableMultiset(final Function<? super T, ? extends E> elementFunction, final ToIntFunction<? super T> countFunction) {
        ...
        return Collector.of(LinkedHashMultiset::create, (multiset, t) -> multiset.add(elementFunction.apply(t), countFunction.applyAsInt(t)), (multiset1, multiset2) -> {
            ...
            return multiset1;
        }, multiset -> ImmutableMultiset.copyFromEntries((java.util.Collection<? extends Entry<?>>)multiset.entrySet()), new Collector.Characteristics[0]);
    }
    ...
    public static <E> ImmutableMultiset<E> copyOf(final Iterable<? extends E> elements) {
        ...
        final Multiset<? extends E> multiset = ((elements instanceof Multiset) ? Multisets.cast(elements) : LinkedHashMultiset.create((java.lang.Iterable<?>)elements));
        return ImmutableMultiset.<E>copyFromEntries((java.util.Collection<? extends Entry<? extends E>>)multiset.entrySet());
    }
    
    private static <E> ImmutableMultiset<E> copyFromElements(final E... elements) {
        final Multiset<E> multiset = LinkedHashMultiset.create();
        Collections.addAll((Collection)multiset, (Object[])elements);
        return ImmutableMultiset.<E>copyFromEntries((java.util.Collection<? extends Entry<? extends E>>)multiset.entrySet());
    }
    ...
    public static <E> ImmutableMultiset<E> copyOf(final Iterator<? extends E> elements) {
        final Multiset<E> multiset = LinkedHashMultiset.create();
        Iterators.addAll((java.util.Collection<Object>)multiset, elements);
        return ImmutableMultiset.<E>copyFromEntries((java.util.Collection<? extends Entry<? extends E>>)multiset.entrySet());
    }
    ...
    public UnmodifiableIterator<E> iterator() {
        final Iterator<Entry<E>> entryIterator = (Iterator<Entry<E>>)this.entrySet().iterator();
        return new UnmodifiableIterator<E>() {
            ...
            public E next() {
                if (this.remaining <= 0) {
                    final Entry<E> entry = (Entry<E>)entryIterator.next();
    ...
    abstract Entry<E> getEntry(final int integer);
    ...
    private static class SerializedForm implements Serializable {
        ...
        Object readResolve() {
            ...
            return ImmutableMultiset.copyOf((java.lang.Iterable<?>)multiset);
        }
    }
    ...
    public static class Builder<E> extends ImmutableCollection.Builder<E> {
        ...
        public Builder<E> add(final E element) {
            this.contents.add(Preconditions.<E>checkNotNull(element));
            return this;
        }
        
        @CanIgnoreReturnValue
        public Builder<E> addCopies(final E element, final int occurrences) {
            this.contents.add(Preconditions.<E>checkNotNull(element), occurrences);
            return this;
        }
        
        @CanIgnoreReturnValue
        public Builder<E> setCount(final E element, final int count) {
            this.contents.setCount(Preconditions.<E>checkNotNull(element), count);
            return this;
        }
        ...
        public ImmutableMultiset<E> build() {
            return ImmutableMultiset.<E>copyOf((java.lang.Iterable<? extends E>)this.contents);
        }
    }
}
