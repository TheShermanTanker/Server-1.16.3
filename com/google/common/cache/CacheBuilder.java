...
public final class CacheBuilder<K, V> {
    ...
    CacheBuilder<K, V> keyEquivalence(final Equivalence<Object> equivalence) {
        ...
        this.keyEquivalence = Preconditions.<Equivalence<Object>>checkNotNull(equivalence);
        return this;
    }
    
    Equivalence<Object> getKeyEquivalence() {
        return MoreObjects.<Equivalence<Object>>firstNonNull(this.keyEquivalence, this.getKeyStrength().defaultEquivalence());
    }
    ...
    CacheBuilder<K, V> valueEquivalence(final Equivalence<Object> equivalence) {
        ...
        this.valueEquivalence = Preconditions.<Equivalence<Object>>checkNotNull(equivalence);
        return this;
    }
    
    Equivalence<Object> getValueEquivalence() {
        return MoreObjects.<Equivalence<Object>>firstNonNull(this.valueEquivalence, this.getValueStrength().defaultEquivalence());
    }
    ...
    public <K1 extends K, V1 extends V> CacheBuilder<K1, V1> weigher(final Weigher<? super K1, ? super V1> weigher) {
        ...
        me.weigher = Preconditions.<Weigher<? super K, ? super V>>checkNotNull(weigher);
        return me;
    }
    ...
    long getMaximumWeight() {
     ...
     <K1 extends K, V1 extends V> Weigher<K1, V1> getWeigher() {
        return MoreObjects.<Weigher<K1, V1>>firstNonNull((Weigher<K1, V1>)this.weigher, (Weigher<K1, V1>)OneWeigher.INSTANCE);
    }
    ...
    CacheBuilder<K, V> setKeyStrength(final LocalCache.Strength strength) {
        ...
        this.keyStrength = Preconditions.<LocalCache.Strength>checkNotNull(strength);
        return this;
    }
    
    LocalCache.Strength getKeyStrength() {
        return MoreObjects.<LocalCache.Strength>firstNonNull(this.keyStrength, LocalCache.Strength.STRONG);
    }
    ...
    CacheBuilder<K, V> setValueStrength(final LocalCache.Strength strength) {
        ...
        this.valueStrength = Preconditions.<LocalCache.Strength>checkNotNull(strength);
        return this;
    }
    
    LocalCache.Strength getValueStrength() {
        return MoreObjects.<LocalCache.Strength>firstNonNull(this.valueStrength, LocalCache.Strength.STRONG);
    }
    ...
    public <K1 extends K, V1 extends V> CacheBuilder<K1, V1> removalListener(final RemovalListener<? super K1, ? super V1> listener) {
        ...
        final CacheBuilder<K1, V1> me = (CacheBuilder<K1, V1>)this;
        me.removalListener = Preconditions.<RemovalListener<? super K, ? super V>>checkNotNull(listener);
        return me;
    }
    
     <K1 extends K, V1 extends V> RemovalListener<K1, V1> getRemovalListener() {
        return MoreObjects.<RemovalListener<K1, V1>>firstNonNull((RemovalListener<K1, V1>)this.removalListener, (RemovalListener<K1, V1>)NullListener.INSTANCE);
    }
    ...
    public String toString() {
        ...
        if (this.expireAfterWriteNanos != -1L) {
            s.add("expireAfterWrite", new StringBuilder().append(this.expireAfterWriteNanos).append("ns").toString());
        }
        if (this.expireAfterAccessNanos != -1L) {
            s.add("expireAfterAccess", new StringBuilder().append(this.expireAfterAccessNanos).append("ns").toString());
        }
