...
public final class CacheBuilderSpec {
    ...
    public static CacheBuilderSpec parse(final String cacheBuilderSpecification) {
        ...
        if (!cacheBuilderSpecification.isEmpty()) {
            for (final String keyValuePair : CacheBuilderSpec.KEYS_SPLITTER.split((CharSequence)cacheBuilderSpecification)) {
                final List<String> keyAndValue = ImmutableList.copyOf((java.lang.Iterable<?>)CacheBuilderSpec.KEY_VALUE_SPLITTER.split((CharSequence)keyValuePair));
                ...
                final String key = (String)keyAndValue.get(0);
                ...
                final String value = (keyAndValue.size() == 1) ? null : ((String)keyAndValue.get(1));
    ...
    abstract static class IntegerParser implements ValueParser {
        ...
        public void parse(final CacheBuilderSpec spec, final String key, final String value) {
            ...
            try {
                ...
                throw new IllegalArgumentException(format("key %s value set to %s, must be integer", key, value), (Throwable)e);
            }
        }
    }
    
    abstract static class LongParser implements ValueParser {
        protected abstract void parseLong(final CacheBuilderSpec cacheBuilderSpec, final long long2);
    ...
    abstract static class DurationParser implements ValueParser {
        protected abstract void parseDuration(final CacheBuilderSpec cacheBuilderSpec, final long long2, final TimeUnit timeUnit);
    ...
    private interface ValueParser {
        void parse(final CacheBuilderSpec cacheBuilderSpec, final String string2, @Nullable final String string3);
    }
}
