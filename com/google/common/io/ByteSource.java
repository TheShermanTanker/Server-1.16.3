...
public abstract class ByteSource {
    ...
    public InputStream openBufferedStream() throws IOException {
        ...
        return (InputStream)((in instanceof BufferedInputStream) ? in : new BufferedInputStream(in));
    }
    ...
    public boolean isEmpty() throws IOException {
        ...
        try {
            final InputStream in = closer.<InputStream>register(this.openStream());
            return in.read() == -1;
        }
        catch (Throwable e) {
    ...
    public long copyTo(final OutputStream output) throws IOException {
        Preconditions.<OutputStream>checkNotNull(output);
        final Closer closer = Closer.create();
        try {
            final InputStream in = closer.<InputStream>register(this.openStream());
    ...
    public long copyTo(final ByteSink sink) throws IOException {
        Preconditions.<ByteSink>checkNotNull(sink);
        final Closer closer = Closer.create();
        try {
            final InputStream in = closer.<InputStream>register(this.openStream());
            final OutputStream out = closer.<OutputStream>register(sink.openStream());
    ...
    public <T> T read(final ByteProcessor<T> processor) throws IOException {
        ...
        try {
            final InputStream in = closer.<InputStream>register(this.openStream());
            return ByteStreams.<T>readBytes(in, processor);
        }
        catch (Throwable e) {
            throw closer.rethrow(e);
        }
    ...
    public boolean contentEquals(final ByteSource other) throws IOException {
        Preconditions.<ByteSource>checkNotNull(other);
        final byte[] buf1 = ByteStreams.createBuffer();
        final byte[] buf2 = ByteStreams.createBuffer();
        final Closer closer = Closer.create();
        try {
            final InputStream in1 = closer.<InputStream>register(this.openStream());
            final InputStream in2 = closer.<InputStream>register(other.openStream());
            while (true) {
    ...
    public static ByteSource concat(final ByteSource... sources) {
        return concat(ImmutableList.<ByteSource>copyOf(sources));
    }
    ...
    private final class AsCharSource extends CharSource {
        ...
        public Reader openStream() throws IOException {
            return (Reader)new InputStreamReader(ByteSource.this.openStream(), this.charset);
        }
    ...
    private final class SlicedByteSource extends ByteSource {
        ...
        private InputStream sliceStream(final InputStream in) throws IOException {
            if (this.offset > 0L) {
                ...
                try {
                    ...
                    final Closer closer = Closer.create();
                    closer.<InputStream>register(in);
                    try {
                        throw closer.rethrow(e);
                    }
                    finally {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            if (optionalUnslicedSize.isPresent()) {
                ...
                return Optional.<Long>of(Math.min(this.length, unslicedSize - off));
            }
            return Optional.<Long>absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        public InputStream openStream() {
            return (InputStream)new ByteArrayInputStream(this.bytes, this.offset, this.length);
        }
        ...
        @Override
        public Optional<Long> sizeIfKnown() {
            return Optional.<Long>of((long)this.length);
        }
        ...
        public String toString() {
            return "ByteSource.wrap(" + Ascii.truncate((CharSequence)BaseEncoding.base16().encode(this.bytes, this.offset, this.length), 30, "...") + ")";
        }
    }
    ...
    private static final class ConcatenatedByteSource extends ByteSource {
        ...
        ConcatenatedByteSource(final Iterable<? extends ByteSource> sources) {
            this.sources = Preconditions.<Iterable<? extends ByteSource>>checkNotNull(sources);
        }
        ...
        public String toString() {
            return new StringBuilder().append("ByteSource.concat(").append(this.sources).append(")").toString();
        }
    }
}
