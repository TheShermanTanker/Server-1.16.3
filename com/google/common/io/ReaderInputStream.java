...
final class ReaderInputStream extends InputStream {
    ...
    ReaderInputStream(final Reader reader, final CharsetEncoder encoder, final int bufferSize) {
        ...
        this.reader = Preconditions.<Reader>checkNotNull(reader);
        this.encoder = Preconditions.<CharsetEncoder>checkNotNull(encoder);
    ...
    private void readMoreChars() throws IOException {
        if (availableCapacity((Buffer)this.charBuffer) == 0) {
        ...
        final int numChars = this.reader.read(this.charBuffer.array(), limit, availableCapacity((Buffer)this.charBuffer));
        if (numChars == -1) {
