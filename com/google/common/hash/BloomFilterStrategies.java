...
enum BloomFilterStrategies implements BloomFilter.Strategy {
    MURMUR128_MITZ_32 {
        public <T> boolean put(final T object, final Funnel<? super T> funnel, final int numHashFunctions, final BitArray bits) {
            ...
            final long hash64 = Hashing.murmur3_128().<T>hashObject(object, funnel).asLong();
    ...
    MURMUR128_MITZ_64 {
        public <T> boolean put(final T object, final Funnel<? super T> funnel, final int numHashFunctions, final BitArray bits) {
            final long bitSize = bits.bitSize();
            final byte[] bytes = Hashing.murmur3_128().<T>hashObject(object, funnel).getBytesInternal();
