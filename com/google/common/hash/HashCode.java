...
public abstract class HashCode {
    ...
    abstract void writeBytesToImpl(final byte[] arr, final int integer2, final int integer3);
    
    byte[] getBytesInternal() {
        return this.asBytes();
    }
    
    abstract boolean equalsSameBits(final HashCode hashCode);
    ...
    public final int hashCode() {
        ...
        final byte[] bytes = this.getBytesInternal();
    ...
    private static final class BytesHashCode extends HashCode implements Serializable {
        ...
        BytesHashCode(final byte[] bytes) {
            this.bytes = Preconditions.<byte[]>checkNotNull(bytes);
        }
