...
public final class Funnels {
    ...
    private static class SequentialFunnel<E> implements Funnel<Iterable<? extends E>>, Serializable {
        ...
        SequentialFunnel(final Funnel<E> elementFunnel) {
            this.elementFunnel = Preconditions.<Funnel<E>>checkNotNull(elementFunnel);
        }
        ...
        public String toString() {
            return new StringBuilder().append("Funnels.sequentialFunnel(").append(this.elementFunnel).append(")").toString();
        }
        
        public boolean equals(@Nullable final Object o) {
            if (o instanceof SequentialFunnel) {
                final SequentialFunnel<?> funnel = o;
    ...
    private static class SinkAsStream extends OutputStream {
        ...
        SinkAsStream(final PrimitiveSink sink) {
            this.sink = Preconditions.<PrimitiveSink>checkNotNull(sink);
        }
        ...
        public String toString() {
            return new StringBuilder().append("Funnels.asOutputStream(").append(this.sink).append(")").toString();
        }
    }
}
