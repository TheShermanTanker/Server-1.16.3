...
public final class Doubles {
    ...
    public static int indexOf(final double[] array, final double[] target) {
        Preconditions.<double[]>checkNotNull(array, "array");
        Preconditions.<double[]>checkNotNull(target, "target");
        if (target.length == 0) {
            return 0;
        }
        int i = 0;
    ...
    public static double[] toArray(final Collection<? extends Number> collection) {
        ...
        for (int i = 0; i < len; ++i) {
            array[i] = Preconditions.<Number>checkNotNull(boxedArray[i]).doubleValue();
        }
        return array;
    }
    ...
    public static List<Double> asList(final double... backingArray) {
        if (backingArray.length == 0) {
            return (List<Double>)Collections.emptyList();
        }
    ...
    private static class DoubleArrayAsList extends AbstractList<Double> implements RandomAccess, Serializable {
        ...
        public Double set(final int index, final Double element) {
            ...
            this.array[this.start + index] = Preconditions.<Double>checkNotNull(element);
            return oldValue;
        }
        ...
        public List<Double> subList(final int fromIndex, final int toIndex) {
            ...
            return (List<Double>)new DoubleArrayAsList(this.array, this.start + fromIndex, this.start + toIndex);
        }
