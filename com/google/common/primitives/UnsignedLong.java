...
public final class UnsignedLong extends Number implements Comparable<UnsignedLong>, Serializable {
    ...
    public UnsignedLong plus(final UnsignedLong val) {
        return fromLongBits(this.value + Preconditions.<UnsignedLong>checkNotNull(val).value);
    }
    ...
    public UnsignedLong dividedBy(final UnsignedLong val) {
        return fromLongBits(UnsignedLongs.divide(this.value, Preconditions.<UnsignedLong>checkNotNull(val).value));
    }
    
    public UnsignedLong mod(final UnsignedLong val) {
        return fromLongBits(UnsignedLongs.remainder(this.value, Preconditions.<UnsignedLong>checkNotNull(val).value));
    }
    ...
    public int compareTo(final UnsignedLong o) {
        Preconditions.<UnsignedLong>checkNotNull(o);
