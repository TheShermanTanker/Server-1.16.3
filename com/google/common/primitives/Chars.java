...
public final class Chars {
    ...
    public static int indexOf(final char[] array, final char[] target) {
        Preconditions.<char[]>checkNotNull(array, "array");
        Preconditions.<char[]>checkNotNull(target, "target");
        if (target.length == 0) {
            return 0;
        }
        int i = 0;
    ...
    public static Comparator<char[]> lexicographicalComparator() {
        return (Comparator<char[]>)LexicographicalComparator.INSTANCE;
    }
    ...
    public static char[] toArray(final Collection<Character> collection) {
        ...
        for (int i = 0; i < len; ++i) {
            array[i] = Preconditions.<Character>checkNotNull(boxedArray[i]);
        }
        return array;
    }
    ...
    public static List<Character> asList(final char... backingArray) {
        if (backingArray.length == 0) {
            return (List<Character>)Collections.emptyList();
        }
        return (List<Character>)new CharArrayAsList(backingArray);
    }
    ...
    private static class CharArrayAsList extends AbstractList<Character> implements RandomAccess, Serializable {
        ...
        public Character set(final int index, final Character element) {
            ...
            this.array[this.start + index] = Preconditions.<Character>checkNotNull(element);
            return oldValue;
        }
        ...
        public List<Character> subList(final int fromIndex, final int toIndex) {
            ...
            return (List<Character>)new CharArrayAsList(this.array, this.start + fromIndex, this.start + toIndex);
        }
