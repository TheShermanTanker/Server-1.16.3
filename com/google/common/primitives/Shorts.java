...
public final class Shorts {
    ...
    public static int indexOf(final short[] array, final short[] target) {
        Preconditions.<short[]>checkNotNull(array, "array");
        Preconditions.<short[]>checkNotNull(target, "target");
        if (target.length == 0) {
            return 0;
        }
        int i = 0;
    ...
    public static Comparator<short[]> lexicographicalComparator() {
        return (Comparator<short[]>)LexicographicalComparator.INSTANCE;
    }
    ...
    public static short[] toArray(final Collection<? extends Number> collection) {
        ...
        for (int i = 0; i < len; ++i) {
            array[i] = Preconditions.<Number>checkNotNull(boxedArray[i]).shortValue();
        }
        return array;
    }
    ...
    public static List<Short> asList(final short... backingArray) {
        if (backingArray.length == 0) {
            return (List<Short>)Collections.emptyList();
        }
        return (List<Short>)new ShortArrayAsList(backingArray);
    }
    ...
    private static class ShortArrayAsList extends AbstractList<Short> implements RandomAccess, Serializable {
        ...
        public Short set(final int index, final Short element) {
            ...
            this.array[this.start + index] = Preconditions.<Short>checkNotNull(element);
            return oldValue;
        }
        ...
        public List<Short> subList(final int fromIndex, final int toIndex) {
            ...
            return (List<Short>)new ShortArrayAsList(this.array, this.start + fromIndex, this.start + toIndex);
        }
