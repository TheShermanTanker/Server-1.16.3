...
public final class Ints {
    ...
    public static int indexOf(final int[] array, final int[] target) {
        Preconditions.<int[]>checkNotNull(array, "array");
        Preconditions.<int[]>checkNotNull(target, "target");
        if (target.length == 0) {
            return 0;
        }
        int i = 0;
    ...
    public static int[] toArray(final Collection<? extends Number> collection) {
        ...
        for (int i = 0; i < len; ++i) {
            array[i] = Preconditions.<Number>checkNotNull(boxedArray[i]).intValue();
        }
        return array;
    }
    ...
    public static List<Integer> asList(final int... backingArray) {
        if (backingArray.length == 0) {
            return (List<Integer>)Collections.emptyList();
        }
    ...
    private static class IntArrayAsList extends AbstractList<Integer> implements RandomAccess, Serializable {
        ...
        public Integer set(final int index, final Integer element) {
            ...
            this.array[this.start + index] = Preconditions.<Integer>checkNotNull(element);
            return oldValue;
        }
        ...
        public List<Integer> subList(final int fromIndex, final int toIndex) {
            ...
            return (List<Integer>)new IntArrayAsList(this.array, this.start + fromIndex, this.start + toIndex);
        }
