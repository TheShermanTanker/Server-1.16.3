...
public final class LongMath {
    ...
    public static long ceilingPowerOfTwo(final long x) {
        ...
        if (x > 4611686018427387904L) {
            throw new ArithmeticException(new StringBuilder().append("ceilingPowerOfTwo(").append(x).append(") is not representable as a long").toString());
        }
    ...
    private enum MillerRabinTester {
        ...
        abstract long mulMod(final long long1, final long long2, final long long3);
        
        abstract long squareMod(final long long1, final long long2);
