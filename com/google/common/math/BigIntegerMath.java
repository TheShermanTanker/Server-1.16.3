...
public final class BigIntegerMath {
    ...
    public static boolean isPowerOfTwo(final BigInteger x) {
        Preconditions.<BigInteger>checkNotNull(x);
        return x.signum() > 0 && x.getLowestSetBit() == x.bitLength() - 1;
    }
    
    public static int log2(final BigInteger x, final RoundingMode mode) {
        MathPreconditions.checkPositive("x", (BigInteger)Preconditions.<BigInteger>checkNotNull(x));
    ...
    public static BigInteger factorial(final int n) {
        ...
        final ArrayList<BigInteger> bignums = (ArrayList<BigInteger>)new ArrayList(approxSize);
        ...
        return listProduct((List<BigInteger>)bignums).shiftLeft(shift);
    }
