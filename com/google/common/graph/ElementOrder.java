...
public final class ElementOrder<T> {
    ...
    private ElementOrder(final Type type, @Nullable final Comparator<T> comparator) {
        this.type = Preconditions.<Type>checkNotNull(type);
    ...
    public static <S extends Comparable<? super S>> ElementOrder<S> natural() {
        return new ElementOrder<S>(Type.SORTED, (java.util.Comparator<S>)Ordering.<Comparable>natural());
    }
