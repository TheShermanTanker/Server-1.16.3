...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addNode(final N node) {
        Preconditions.<N>checkNotNull(node, "node");
    ...
    public boolean addEdge(final N nodeU, final N nodeV, final E edge) {
        Preconditions.<N>checkNotNull(nodeU, "nodeU");
        Preconditions.<N>checkNotNull(nodeV, "nodeV");
        Preconditions.<E>checkNotNull(edge, "edge");
        if (this.containsEdge(edge)) {
            final EndpointPair<N> existingIncidentNodes = this.incidentNodes(edge);
            final EndpointPair<N> newIncidentNodes = EndpointPair.<N>of(this, nodeU, nodeV);
    ...
    public boolean removeNode(final Object node) {
        ...
        for (final E edge : ImmutableList.copyOf((java.util.Collection<?>)connections.incidentEdges())) {
