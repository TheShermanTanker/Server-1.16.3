...
public abstract class AbstractValueGraph<N, V> extends AbstractGraph<N> implements ValueGraph<N, V> {
    ...
    public String toString() {
        ...
        return String.format("%s, nodes: %s, edges: %s", new Object[] { propertiesString, this.nodes(), this.edgeValueMap() });
    }
    ...
    private Map<EndpointPair<N>, V> edgeValueMap() {
        ...
        return Maps.<EndpointPair<N>, V>asMap(this.edges(), edgeToValueFn);
    }
}
