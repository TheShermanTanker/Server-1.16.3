...
abstract class AggregateFuture<InputT, OutputT> extends TrustedFuture<OutputT> {
    ...
    abstract class RunningState extends AggregateFutureState implements Runnable {
        ...
        RunningState(final ImmutableCollection<? extends ListenableFuture<? extends InputT>> futures, final boolean allMustSucceed, final boolean collectsValues) {
            super(futures.size());
            this.futures = Preconditions.<ImmutableCollection<? extends ListenableFuture<? extends InputT>>>checkNotNull(futures);
        ...
        private void init() {
            ...
            if (this.allMustSucceed) {
                ...
                for (final ListenableFuture<? extends InputT> listenable2 : this.futures) {
                    listenable2.addListener((Runnable)this, MoreExecutors.directExecutor());
                }
            }
        }
            ...
            try {
                ...
                if (this.allMustSucceed) {
                    if (future.isCancelled()) {
                        ...
                        final InputT result = Futures.<InputT>getDone((java.util.concurrent.Future<InputT>)future);
                    ...
                    this.collectOneValue(this.allMustSucceed, index, Futures.<InputT>getDone((java.util.concurrent.Future<InputT>)future));
                }
            }
        ...
        abstract void collectOneValue(final boolean boolean1, final int integer, @Nullable final InputT object);
