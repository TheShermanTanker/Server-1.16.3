...
public final class ExecutionList {
    ...
    public void add(final Runnable runnable, final Executor executor) {
        Preconditions.<Runnable>checkNotNull(runnable, "Runnable was null.");
    ...
    private static void executeListener(final Runnable runnable, final Executor executor) {
        try {
            ...
            ExecutionList.log.log(Level.SEVERE, new StringBuilder().append("RuntimeException while executing runnable ").append(runnable).append(" with executor ").append(executor).toString(), (Throwable)e);
        }
    }
