...
abstract class SmoothRateLimiter extends RateLimiter {
    ...
    abstract void doSetRate(final double double1, final double double2);
    ...
    final long reserveEarliestAvailable(final int requiredPermits, final long nowMicros) {
        ...
        final double storedPermitsToSpend = Math.min((double)requiredPermits, this.storedPermits);
    ...
    abstract long storedPermitsToWaitTime(final double double1, final double double2);
