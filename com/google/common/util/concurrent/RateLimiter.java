...
public abstract class RateLimiter {
    ...
    RateLimiter(final SleepingStopwatch stopwatch) {
        this.stopwatch = Preconditions.<SleepingStopwatch>checkNotNull(stopwatch);
    }
    ...
    abstract void doSetRate(final double double1, final long long2);
    ...
    abstract long queryEarliestAvailable(final long long1);
    
    abstract long reserveEarliestAvailable(final int integer, final long long2);
    
    public String toString() {
        return String.format(Locale.ROOT, "RateLimiter[stableRate=%3.1fqps]", new Object[] { this.getRate() });
    }
    ...
    abstract static class SleepingStopwatch {
        ...
        protected abstract void sleepMicrosUninterruptibly(final long long1);
