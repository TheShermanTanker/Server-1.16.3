...
final class SerializingExecutor implements Executor {
    ...
    public SerializingExecutor(final Executor executor) {
        this.queue = (Deque<Runnable>)new ArrayDeque();
    ...
    private void startQueueWorker() {
        ...
        try {
            this.executor.execute((Runnable)new QueueWorker());
        ...
        private void workOnQueue() {
            while (true) {
                ...
                try {
                    ...
                    SerializingExecutor.log.log(Level.SEVERE, new StringBuilder().append("Exception while executing runnable ").append(task).toString(), (Throwable)e);
                }
            }
        }
    }
