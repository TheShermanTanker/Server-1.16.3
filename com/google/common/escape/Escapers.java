...
public final class Escapers {
    ...
    static UnicodeEscaper asUnicodeEscaper(final Escaper escaper) {
        Preconditions.<Escaper>checkNotNull(escaper);
    ...
    static {
        NULL_ESCAPER = new CharEscaper() {
            ...
            public String escape(final String string) {
                return Preconditions.<String>checkNotNull(string);
            }
    ...
    public static final class Builder {
        ...
        private Builder() {
            this.replacementMap = (Map<Character, String>)new HashMap();
            this.safeMin = '\0';
            this.safeMax = '\uffff';
        ...
        public Builder addEscape(final char c, final String replacement) {
            Preconditions.<String>checkNotNull(replacement);
