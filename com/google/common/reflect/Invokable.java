...
public abstract class Invokable<T, R> extends Element implements GenericDeclaration {
     <M extends AccessibleObject> Invokable(final M member) {
        super(member);
    }
    ...
    public static <T> Invokable<T, T> from(final Constructor<T> constructor) {
        return (Invokable<T, T>)new ConstructorInvokable(constructor);
    }
    ...
    public final R invoke(@Nullable final T receiver, final Object... args) throws InvocationTargetException, IllegalAccessException {
        return (R)this.invokeInternal(receiver, Preconditions.<Object[]>checkNotNull(args));
    }
    ...
    public final ImmutableList<Parameter> getParameters() {
        ...
        final ImmutableList.Builder<Parameter> builder = ImmutableList.<Parameter>builder();
    ...
    public final ImmutableList<TypeToken<? extends Throwable>> getExceptionTypes() {
        final ImmutableList.Builder<TypeToken<? extends Throwable>> builder = ImmutableList.<TypeToken<? extends Throwable>>builder();
        for (final Type type : this.getGenericExceptionTypes()) {
            final TypeToken<? extends Throwable> exceptionType = TypeToken.of(type);
    ...
    public final <R1 extends R> Invokable<T, R1> returning(final Class<R1> returnType) {
        return this.<R1>returning(TypeToken.of((java.lang.Class<R1>)returnType));
    }
    ...
    public final <R1 extends R> Invokable<T, R1> returning(final TypeToken<R1> returnType) {
        if (!returnType.isSupertypeOf(this.getReturnType())) {
            throw new IllegalArgumentException(new StringBuilder().append("Invokable is known to return ").append(this.getReturnType()).append(", not ").append(returnType).toString());
        }
    ...
    public TypeToken<T> getOwnerType() {
        return TypeToken.<T>of(this.getDeclaringClass());
    }
    
    abstract Object invokeInternal(@Nullable final Object object, final Object[] arr) throws InvocationTargetException, IllegalAccessException;
    ...
    static class ConstructorInvokable<T> extends Invokable<T, T> {
        ...
        final Object invokeInternal(@Nullable final Object receiver, final Object[] args) throws InvocationTargetException, IllegalAccessException {
            try {
                ...
                throw new RuntimeException(new StringBuilder().append(this.constructor).append(" failed.").toString(), (Throwable)e);
            }
        }
        ...
        Type getGenericReturnType() {
            ...
            if (typeParams.length > 0) {
                return (Type)Types.newParameterizedType(declaringClass, (Type[])typeParams);
            }
        ...
        Type[] getGenericParameterTypes() {
            ...
            if (types.length > 0 && this.mayNeedHiddenThis()) {
                ...
                if (types.length == rawParamTypes.length && rawParamTypes[0] == this.getDeclaringClass().getEnclosingClass()) {
                    return (Type[])Arrays.copyOfRange((Object[])types, 1, types.length);
                }
            }
            return types;
        }
