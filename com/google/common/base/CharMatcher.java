...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public String replaceFrom(final CharSequence sequence, final char replacement) {
        final String string = sequence.toString();
        final int pos = this.indexIn((CharSequence)string);
        if (pos == -1) {
            return string;
        }
        final char[] chars = string.toCharArray();
    ...
    public String replaceFrom(final CharSequence sequence, final CharSequence replacement) {
        ...
        do {
            ...
            oldpos = pos + 1;
            pos = this.indexIn((CharSequence)string, oldpos);
        } while (pos != -1);
    ...
    private static final class Any extends NamedFastMatcher {
        ...
        @Override
        public boolean matchesAllOf(final CharSequence sequence) {
            Preconditions.<CharSequence>checkNotNull(sequence);
            return true;
        }
        ...
        @Override
        public CharMatcher or(final CharMatcher other) {
            Preconditions.<CharMatcher>checkNotNull(other);
            return this;
        }
    ...
    private static final class None extends NamedFastMatcher {
        ...
        @Override
        public String replaceFrom(final CharSequence sequence, final CharSequence replacement) {
            Preconditions.<CharSequence>checkNotNull(replacement);
            return sequence.toString();
        }
    ...
    private static class Negated extends CharMatcher {
        ...
        @Override
        public String toString() {
            return new StringBuilder().append(this.original).append(".negate()").toString();
        }
    }
    ...
    private static final class And extends CharMatcher {
        ...
        @Override
        public String toString() {
            return new StringBuilder().append("CharMatcher.and(").append(this.first).append(", ").append(this.second).append(")").toString();
        }
    }
    ...
    private static final class Or extends CharMatcher {
        ...
        @Override
        public String toString() {
            return new StringBuilder().append("CharMatcher.or(").append(this.first).append(", ").append(this.second).append(")").toString();
        }
    }
    ...
    private static final class IsEither extends FastMatcher {
        ...
        @Override
        void setBits(final BitSet table) {
            table.set((int)this.match1);
            table.set((int)this.match2);
        }
    ...
    private static final class ForPredicate extends CharMatcher {
        ...
        @Override
        public boolean apply(final Character character) {
            return this.predicate.apply(Preconditions.<Character>checkNotNull(character));
        }
        
        @Override
        public String toString() {
            return new StringBuilder().append("CharMatcher.forPredicate(").append(this.predicate).append(")").toString();
        }
    }
}
