...
public final class Strings {
    ...
    public static String repeat(final String string, final int count) {
        ...
        if (size != longSize) {
            throw new ArrayIndexOutOfBoundsException(new StringBuilder().append("Required array size too large: ").append(longSize).toString());
        }
    ...
    public static String commonPrefix(final CharSequence a, final CharSequence b) {
        Preconditions.<CharSequence>checkNotNull(a);
        Preconditions.<CharSequence>checkNotNull(b);
        int maxPrefixLength;
        int p;
