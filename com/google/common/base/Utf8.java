...
public final class Utf8 {
    public static int encodedLength(final CharSequence sequence) {
        ...
        if (utf8Length < utf16Length) {
            throw new IllegalArgumentException(new StringBuilder().append("UTF-8 length does not fit in int: ").append(utf8Length + 4294967296L).toString());
        }
        return utf8Length;
    }
