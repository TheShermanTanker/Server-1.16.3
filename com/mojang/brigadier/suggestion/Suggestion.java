...
public class Suggestion implements Comparable<Suggestion> {
    ...
    public String toString() {
        return new StringBuilder().append("Suggestion{range=").append(this.range).append(", text='").append(this.text).append('\'').append(", tooltip='").append(this.tooltip).append('\'').append('}').toString();
    }
