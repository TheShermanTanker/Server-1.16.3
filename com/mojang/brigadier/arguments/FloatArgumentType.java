...
public class FloatArgumentType implements ArgumentType<Float> {
    ...
    public static float getFloat(final CommandContext<?> context, final String name) {
        return context.<Float>getArgument(name, Float.class);
    }
    ...
    public String toString() {
        ...
        if (this.maximum == Float.MAX_VALUE) {
            return new StringBuilder().append("float(").append(this.minimum).append(")").toString();
        }
        return new StringBuilder().append("float(").append(this.minimum).append(", ").append(this.maximum).append(")").toString();
    }
