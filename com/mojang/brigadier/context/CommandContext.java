...
public class CommandContext<S> {
    ...
    public <V> V getArgument(final String name, final Class<V> clazz) {
        ...
        if (((Class)CommandContext.PRIMITIVE_TO_WRAPPER.getOrDefault(clazz, clazz)).isAssignableFrom(result.getClass())) {
            return (V)result;
        }
    ...
    static {
        (PRIMITIVE_TO_WRAPPER = (Map)new HashMap()).put(Boolean.TYPE, Boolean.class);
