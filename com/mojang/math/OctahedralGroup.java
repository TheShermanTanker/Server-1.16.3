...
public enum OctahedralGroup implements StringRepresentable {
    ...
    static {
        cayleyTable = Util.<OctahedralGroup[][]>make(new OctahedralGroup[values().length][values().length], (java.util.function.Consumer<OctahedralGroup[][]>)(arr -> {
            final Map<Pair<SymmetricGroup3, BooleanList>, OctahedralGroup> map2 = (Map<Pair<SymmetricGroup3, BooleanList>, OctahedralGroup>)Arrays.stream((Object[])values()).collect(Collectors.toMap(c -> Pair.<SymmetricGroup3, BooleanList>of(c.permutation, c.packInversions()), c -> c));
            for (final OctahedralGroup c6 : values()) {
                for (final OctahedralGroup c7 : values()) {
                    ...
                    arr[c6.ordinal()][c7.ordinal()] = (OctahedralGroup)map2.get(Pair.<SymmetricGroup3, BooleanArrayList>of(e13, booleanArrayList14));
                }
            }
        }));
