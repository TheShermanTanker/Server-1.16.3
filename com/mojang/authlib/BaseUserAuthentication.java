...
public abstract class BaseUserAuthentication implements UserAuthentication {
    ...
    public Map<String, Object> saveForStorage() {
        final Map<String, Object> result = (Map<String, Object>)new HashMap();
        ...
        if (!this.getUserProperties().isEmpty()) {
            final List<Map<String, String>> properties = (List<Map<String, String>>)new ArrayList();
            for (final Property userProperty : this.getUserProperties().values()) {
                final Map<String, String> property = (Map<String, String>)new HashMap();
        ...
        if (selectedProfile != null) {
            ...
            final List<Map<String, String>> properties2 = (List<Map<String, String>>)new ArrayList();
            for (final Property profileProperty : selectedProfile.getProperties().values()) {
                final Map<String, String> property2 = (Map<String, String>)new HashMap();
