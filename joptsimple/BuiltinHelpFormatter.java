...
public class BuiltinHelpFormatter implements HelpFormatter {
    ...
    public String format(final Map<String, ? extends OptionDescriptor> options) {
        ...
        final Comparator<OptionDescriptor> comparator = (Comparator<OptionDescriptor>)new Comparator<OptionDescriptor>() {
        ...
        final Set<OptionDescriptor> sorted = (Set<OptionDescriptor>)new TreeSet((Comparator)comparator);
    ...
    protected String createOptionDisplay(final OptionDescriptor descriptor) {
        ...
        final Iterator<String> i = (Iterator<String>)descriptor.options().iterator();
        while (i.hasNext()) {
            final String option = (String)i.next();
