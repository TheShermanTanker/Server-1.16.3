...
public class AbbreviationMap<V> implements OptionNameMap<V> {
    ...
    public AbbreviationMap() {
        this.children = (Map<Character, AbbreviationMap<V>>)new TreeMap();
    }
    ...
    private boolean remove(final char[] aKey, final int offset, final int length) {
        ...
        final AbbreviationMap<V> child = (AbbreviationMap<V>)this.children.get(nextChar);
    ...
    private void setValueToThatOfOnlyChild() {
        final Map.Entry<Character, AbbreviationMap<V>> entry = (Map.Entry<Character, AbbreviationMap<V>>)this.children.entrySet().iterator().next();
        final AbbreviationMap<V> onlyChild = (AbbreviationMap<V>)entry.getValue();
    ...
    public Map<String, V> toJavaUtilMap() {
        final Map<String, V> mappings = (Map<String, V>)new TreeMap();
