...
public class FilledProfileResults implements ProfileResults {
    ...
    public List<ResultField> getTimes(String string) {
        ...
        final List<ResultField> list12 = Lists.newArrayList();
        if (!string.isEmpty()) {
            string += '\u001e';
        }
        long long8 = 0L;
    ...
    private Map<String, CounterCollector> getCounterValues() {
        final Map<String, CounterCollector> map2 = Maps.newTreeMap();
        this.entries.forEach((string, anu) -> {
            final Object2LongMap<String> object2LongMap4 = anu.getCounters();
            if (!object2LongMap4.isEmpty()) {
                final List<String> list5 = FilledProfileResults.SPLITTER.splitToList((CharSequence)string);
    ...
    private void appendProfilerResults(final int integer, final String string, final StringBuilder stringBuilder) {
        ...
        final Object2LongMap<String> object2LongMap6 = ObjectUtils.<ProfilerPathEntry>firstNonNull((ProfilerPathEntry)this.entries.get(string), FilledProfileResults.EMPTY).getCounters();
    ...
    static {
        ...
        EMPTY = new ProfilerPathEntry() {
            ...
            public Object2LongMap<String> getCounters() {
                return Object2LongMaps.<String>emptyMap();
            }
        };
