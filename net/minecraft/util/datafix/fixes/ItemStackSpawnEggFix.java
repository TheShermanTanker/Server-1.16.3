...
public class ItemStackSpawnEggFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        final OpticFinder<String> opticFinder4 = DSL.<String>fieldFinder("id", NamespacedSchema.namespacedString());
        final OpticFinder<?> opticFinder5 = type2.findField("tag");
        final OpticFinder<?> opticFinder6 = opticFinder5.type().findField("EntityTag");
        return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", type2, (Function<Typed<?>, Typed<?>>)(typed -> {
            final Optional<Pair<String, String>> optional6 = typed.<Pair<String, String>>getOptional(opticFinder3);
            if (optional6.isPresent() && Objects.equals(((Pair)optional6.get()).getSecond(), "minecraft:spawn_egg")) {
                ...
                final Optional<String> optional7 = typed3.<String>getOptional(opticFinder4);
                if (optional7.isPresent()) {
                    return typed.<Pair<String, Object>>set(opticFinder3, Pair.<String, Object>of(References.ITEM_NAME.typeName(), ItemStackSpawnEggFix.MAP.getOrDefault(optional7.get(), "minecraft:pig_spawn_egg")));
                }
            }
            return typed;
        }));
