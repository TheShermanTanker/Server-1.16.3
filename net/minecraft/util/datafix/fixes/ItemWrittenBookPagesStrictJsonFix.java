...
public class ItemWrittenBookPagesStrictJsonFix extends DataFix {
    ...
    public Dynamic<?> fixTag(final Dynamic<?> dynamic) {
        return dynamic.update("pages", (Function<Dynamic<?>, Dynamic<?>>)(dynamic2 -> DataFixUtils.<Dynamic>orElse(dynamic2.asStreamOpt().map(stream -> stream.map(dynamic -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemWrittenBookPagesStrictJsonFix", type2, (Function<Typed<?>, Typed<?>>)(typed -> typed.updateTyped(opticFinder3, typed -> typed.<Dynamic<?>>update(DSL.remainderFinder(), this::fixTag))));
    }
}
