...
public class ChunkStatusFix2 extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ChunkStatusFix2", type2, this.getOutputSchema().getType(References.CHUNK), (Function<Typed<?>, Typed<?>>)(typed -> typed.updateTyped(opticFinder4, typed -> {
            final Dynamic<?> dynamic2 = typed.<Dynamic<?>>get(DSL.remainderFinder());
            ...
            return typed.<Dynamic<?>>set(DSL.remainderFinder(), dynamic2.set("Status", dynamic2.createString(string4)));
        })));
    }
    ...
    static {
        ...
        //    31: ldc             "liquid_carved"
        //    33: ldc             "liquid_carvers"
        ...
        //    73: invokevirtual   com/google/common/collect/ImmutableMap$Builder.build:()Lcom/google/common/collect/ImmutableMap;
        //    76: putstatic       net/minecraft/util/datafix/fixes/ChunkStatusFix2.RENAMES_AND_DOWNGRADES:Ljava/util/Map;
        //    79: return         
        // 
        ...
        //     at com.strobel.decompiler.ast.TypeAnalysis$AddMappingsForArgumentVisitor.visitParameterizedType(TypeAnalysis.java:3225)
