...
public class ItemSpawnEggFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        final OpticFinder<Pair<String, String>> opticFinder4 = DSL.<Pair<String, String>>fieldFinder("id", DSL.<String>named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString()));
        final OpticFinder<String> opticFinder5 = DSL.<String>fieldFinder("id", DSL.string());
        ...
        return this.fixTypeEverywhereTyped("ItemSpawnEggFix", type3, (Function<Typed<?>, Typed<?>>)(typed -> {
            final Optional<Pair<String, String>> optional8 = typed.<Pair<String, String>>getOptional(opticFinder4);
            if (optional8.isPresent() && Objects.equals(((Pair)optional8.get()).getSecond(), "minecraft:spawn_egg")) {
                Dynamic<?> dynamic9 = typed.<Dynamic<?>>get(DSL.remainderFinder());
                ...
                if (string16 != null && (!optional12.isPresent() || !Objects.equals(optional12.get(), string16))) {
                    ...
                    final Typed<?> typed6 = ((Pair)typed5.write().flatMap((java.util.function.Function<? super Dynamic<?>, ? extends DataResult<Object>>)(dynamic4 -> type4.readTyped(dynamic4.set("id", (Dynamic)dynamic10.createString(string16))))).result().orElseThrow(() -> new IllegalStateException("Could not parse new entity"))).getFirst();
                    typed2 = typed2.set(opticFinder6, typed3.set(opticFinder7, typed4.set(opticFinder8, typed6)));
                }
                if (short10 != 0) {
                    dynamic9 = dynamic9.set("Damage", dynamic9.createShort((short)0));
                    typed2 = typed2.<Dynamic<?>>set(DSL.remainderFinder(), dynamic9);
                }
                return typed2;
            }
            return typed;
    ...
    static {
        ID_TO_ENTITY = DataFixUtils.<String[]>make(new String[256], (java.util.function.Consumer<String[]>)(arr -> {
            arr[1] = "Item";
            arr[2] = "XPOrb";
            arr[7] = "ThrownEgg";
            arr[8] = "LeashKnot";
