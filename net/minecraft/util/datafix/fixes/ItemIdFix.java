...
public class ItemIdFix extends DataFix {
    ...
    public ItemIdFix(final Schema schema, final boolean boolean2) {
        super(schema, boolean2);
    }
    
    public static String getItem(final int integer) {
        return ItemIdFix.ITEM_NAMES.get(integer);
    }
    
    public TypeRewriteRule makeRule() {
        final Type<Either<Integer, Pair<String, String>>> type2 = DSL.<Integer, Pair<String, String>>or(DSL.intType(), DSL.<String>named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString()));
        final Type<Pair<String, String>> type3 = DSL.<String>named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString());
        final OpticFinder<Either<Integer, Pair<String, String>>> opticFinder4 = DSL.<Either<Integer, Pair<String, String>>>fieldFinder("id", type2);
        return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), (Function<Typed<?>, Typed<?>>)(typed -> typed.update(opticFinder4, type3, either -> either.<Pair>map(integer -> Pair.<String, String>of(References.ITEM_NAME.typeName(), getItem(integer)), pair -> pair))));
    }
    
    static {
        ITEM_NAMES = DataFixUtils.<Int2ObjectOpenHashMap<String>>make(new Int2ObjectOpenHashMap<String>(), (java.util.function.Consumer<Int2ObjectOpenHashMap<String>>)(int2ObjectOpenHashMap -> {
