...
public class ItemBannerColorFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemBannerColorFix", type2, (Function<Typed<?>, Typed<?>>)(typed -> {
            ...
            if (optional5.isPresent() && Objects.equals(((Pair)optional5.get()).getSecond(), "minecraft:banner")) {
                Dynamic<?> dynamic6 = typed.<Dynamic<?>>get(DSL.remainderFinder());
                ...
                if (optional6.isPresent()) {
                    ...
                    if (optional7.isPresent()) {
                        ...
                        final Dynamic<?> dynamic7 = typed2.<Dynamic<?>>get(DSL.remainderFinder());
                        final Dynamic<?> dynamic8 = typed3.<Dynamic<?>>getOrCreate(DSL.remainderFinder());
                        if (dynamic8.get("Base").asNumber().result().isPresent()) {
                            ...
                            if (optional8.isPresent()) {
                                ...
                                final Dynamic<?> dynamic10 = dynamic9.createMap(ImmutableMap.<Dynamic<Object>, Dynamic<Object>>of(dynamic9.createString("Lore"), dynamic9.createList(Stream.of(dynamic9.createString("(+NBT")))));
                                if (Objects.equals(dynamic9, dynamic10)) {
                                    return typed.<Dynamic<?>>set(DSL.remainderFinder(), dynamic6);
                                }
                            }
                            dynamic8.remove("Base");
                            return typed.<Dynamic<?>>set(DSL.remainderFinder(), dynamic6).set(opticFinder4, typed2.set(opticFinder5, typed3.<Dynamic<?>>set(DSL.remainderFinder(), dynamic8)));
                        }
                    }
                }
                return typed.<Dynamic<?>>set(DSL.remainderFinder(), dynamic6);
