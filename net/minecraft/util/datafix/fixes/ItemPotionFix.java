...
public class ItemPotionFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemPotionFix", type2, (Function<Typed<?>, Typed<?>>)(typed -> {
            ...
            if (optional4.isPresent() && Objects.equals(((Pair)optional4.get()).getSecond(), "minecraft:potion")) {
                Dynamic<?> dynamic5 = typed.<Dynamic<?>>get(DSL.remainderFinder());
                final Optional<? extends Typed<?>> optional5 = typed.getOptionalTyped(opticFinder4);
                final short short7 = dynamic5.get("Damage").asShort((short)0);
                if (optional5.isPresent()) {
                    Typed<?> typed2 = typed;
                    final Dynamic<?> dynamic6 = ((Typed)optional5.get()).<Dynamic<?>>get(DSL.remainderFinder());
                    final Optional<String> optional6 = dynamic6.get("Potion").asString().result();
                    if (!optional6.isPresent()) {
                        final String string11 = ItemPotionFix.POTIONS[short7 & 0x7F];
                        final Typed<?> typed3 = ((Typed)optional5.get()).<Dynamic<?>>set(DSL.remainderFinder(), dynamic6.set("Potion", dynamic6.createString((string11 == null) ? "minecraft:water" : string11)));
                        typed2 = typed2.set(opticFinder4, typed3);
                        if ((short7 & 0x4000) == 0x4000) {
                            typed2 = typed2.<Pair<String, String>>set(opticFinder3, Pair.<String, String>of(References.ITEM_NAME.typeName(), "minecraft:splash_potion"));
                        }
                    }
                    if (short7 != 0) {
                        dynamic5 = dynamic5.set("Damage", dynamic5.createShort((short)0));
                    }
                    return typed2.<Dynamic<?>>set(DSL.remainderFinder(), dynamic5);
                }
            }
            return typed;
        }));
    ...
    static {
        POTIONS = DataFixUtils.<String[]>make(new String[128], (java.util.function.Consumer<String[]>)(arr -> {
