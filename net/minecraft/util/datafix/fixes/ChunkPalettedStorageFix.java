...
public class ChunkPalettedStorageFix extends DataFix {
    ...
    private Dynamic<?> fix(final Dynamic<?> dynamic) {
        ...
        if (optional3.isPresent() && ((Dynamic)optional3.get()).get("Sections").asStreamOpt().result().isPresent()) {
            return dynamic.set("Level", new UpgradeChunk(optional3.get()).write());
        }
        return dynamic;
    }
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.writeFixAndRead("ChunkPalettedStorageFix", type2, type3, (Function<Dynamic<?>, Dynamic<?>>)this::fix);
    }
    ...
    static {
        ...
        FLOWER_POT_MAP = DataFixUtils.<Map>make((Map)Maps.newHashMap(), (java.util.function.Consumer<Map>)(hashMap -> {
        ...
        SKULL_MAP = DataFixUtils.<Map>make((Map)Maps.newHashMap(), (java.util.function.Consumer<Map>)(hashMap -> {
        ...
        DOOR_MAP = DataFixUtils.<Map>make((Map)Maps.newHashMap(), (java.util.function.Consumer<Map>)(hashMap -> {
        ...
        NOTE_BLOCK_MAP = DataFixUtils.<Map>make((Map)Maps.newHashMap(), (java.util.function.Consumer<Map>)(hashMap -> {
        ...
        DYE_COLOR_MAP = DataFixUtils.<Int2ObjectOpenHashMap<String>>make(new Int2ObjectOpenHashMap<String>(), (java.util.function.Consumer<Int2ObjectOpenHashMap<String>>)(int2ObjectOpenHashMap -> {
        ...
        BED_BLOCK_MAP = DataFixUtils.<Map>make((Map)Maps.newHashMap(), (java.util.function.Consumer<Map>)(hashMap -> {
        ...
        BANNER_BLOCK_MAP = DataFixUtils.<Map>make((Map)Maps.newHashMap(), (java.util.function.Consumer<Map>)(hashMap -> {
            for (final Int2ObjectMap.Entry<String> entry3 : ChunkPalettedStorageFix.DYE_COLOR_MAP.int2ObjectEntrySet()) {
    ...
    static class Section {
        ...
        public Section(final Dynamic<?> dynamic) {
            ...
            this.toFix = new Int2ObjectLinkedOpenHashMap<IntList>();
            this.update = new IntArrayList();
        ...
        public int upgrade(int integer) {
            ...
            final DataLayer a4 = (DataLayer)this.section.get("Data").asByteBufferOpt().map((java.util.function.Function<? super ByteBuffer, ?>)(byteBuffer -> new DataLayer(DataFixUtils.toArray(byteBuffer)))).result().orElseGet(DataLayer::new);
            final DataLayer a5 = (DataLayer)this.section.get("Add").asByteBufferOpt().map((java.util.function.Function<? super ByteBuffer, ?>)(byteBuffer -> new DataLayer(DataFixUtils.toArray(byteBuffer)))).result().orElseGet(DataLayer::new);
        ...
        private void addFix(final int integer1, final int integer2) {
            IntList intList4 = this.toFix.get(integer1);
            if (intList4 == null) {
    ...
    static final class UpgradeChunk {
        ...
        public UpgradeChunk(final Dynamic<?> dynamic) {
            ...
            this.blockEntities = new Int2ObjectLinkedOpenHashMap<Dynamic<?>>(16);
            this.level = dynamic;
        ...
        public Dynamic<?> write() {
            ...
            final List<Dynamic<?>> list4 = Lists.newArrayList();
            ...
            dynamic4 = dynamic4.set("Indices", dynamic3);
            return dynamic2.set("UpgradeData", dynamic4).set("Sections", dynamic4.createList(list4.stream()));
        }
    }
