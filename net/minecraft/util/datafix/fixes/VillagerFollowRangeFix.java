...
public class VillagerFollowRangeFix extends NamedEntityFix {
    ...
    protected Typed<?> fix(final Typed<?> typed) {
        return typed.<Dynamic<?>>update(DSL.remainderFinder(), (java.util.function.Function<Dynamic<?>, Dynamic<?>>)VillagerFollowRangeFix::fixValue);
    }
    
    private static Dynamic<?> fixValue(final Dynamic<?> dynamic) {
        return dynamic.update("Attributes", (Function<Dynamic<?>, Dynamic<?>>)(dynamic2 -> dynamic.createList(dynamic2.asStream().map(dynamic -> {
