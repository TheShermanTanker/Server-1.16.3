...
public abstract class BlockRenameFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        final Type<Pair<String, String>> type3 = DSL.<String>named(References.BLOCK_NAME.typeName(), NamespacedSchema.namespacedString());
        if (!Objects.equals(type2, type3)) {
            throw new IllegalStateException("block type is not what was expected.");
        }
        final TypeRewriteRule typeRewriteRule4 = this.<Pair<String, String>>fixTypeEverywhere(this.name + " for block", type3, (java.util.function.Function<DynamicOps<?>, java.util.function.Function<Pair<String, String>, Pair<String, String>>>)(dynamicOps -> pair -> pair.mapSecond(this::fixBlock)));
        final TypeRewriteRule typeRewriteRule5 = this.fixTypeEverywhereTyped(this.name + " for block_state", this.getInputSchema().getType(References.BLOCK_STATE), (Function<Typed<?>, Typed<?>>)(typed -> typed.<Dynamic<?>>update(DSL.remainderFinder(), dynamic -> {
