...
public class RedstoneWireConnectionsFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("RedstoneConnectionsFix", schema2.getType(References.BLOCK_STATE), (Function<Typed<?>, Typed<?>>)(typed -> typed.<Dynamic<?>>update(DSL.remainderFinder(), this::updateRedstoneConnections)));
    }
