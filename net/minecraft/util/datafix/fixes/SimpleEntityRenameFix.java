...
public abstract class SimpleEntityRenameFix extends EntityRenameFix {
    ...
    protected Pair<String, Typed<?>> fix(final String string, final Typed<?> typed) {
        final Pair<String, Dynamic<?>> pair4 = this.getNewNameAndTag(string, typed.<Dynamic<?>>getOrCreate(DSL.remainderFinder()));
        return Pair.<String, Typed<?>>of(pair4.getFirst(), typed.<Dynamic<?>>set(DSL.remainderFinder(), pair4.getSecond()));
    }
