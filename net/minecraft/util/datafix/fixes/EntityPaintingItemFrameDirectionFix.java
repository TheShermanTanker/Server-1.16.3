...
public class EntityPaintingItemFrameDirectionFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        final OpticFinder<?> opticFinder3 = DSL.namedChoice("Painting", type2);
        final Type<?> type3 = this.getInputSchema().getChoiceType(References.ENTITY, "ItemFrame");
        final OpticFinder<?> opticFinder4 = DSL.namedChoice("ItemFrame", type3);
        final Type<?> type4 = this.getInputSchema().getType(References.ENTITY);
        final TypeRewriteRule typeRewriteRule7 = this.fixTypeEverywhereTyped("EntityPaintingFix", type4, (Function<Typed<?>, Typed<?>>)(typed -> typed.updateTyped(opticFinder3, type2, typed -> typed.<Dynamic<?>>update(DSL.remainderFinder(), dynamic -> this.doFix(dynamic, true, false)))));
        final TypeRewriteRule typeRewriteRule8 = this.fixTypeEverywhereTyped("EntityItemFrameFix", type4, (Function<Typed<?>, Typed<?>>)(typed -> typed.updateTyped(opticFinder4, type3, typed -> typed.<Dynamic<?>>update(DSL.remainderFinder(), dynamic -> this.doFix(dynamic, false, true)))));
