...
public class EntityMinecartIdentifiersFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.<String, String>fixTypeEverywhere("EntityMinecartIdentifiersFix", (Type<String>)taggedChoiceType2, (Type<String>)taggedChoiceType3, (java.util.function.Function<DynamicOps<?>, java.util.function.Function<String, String>>)(dynamicOps -> pair -> {
            if (Objects.equals(pair.getFirst(), "Minecart")) {
                ...
                final Dynamic<?> dynamic6 = typed5.<Dynamic<?>>getOrCreate(DSL.remainderFinder());
                ...
                return Pair.<String, Object>of(string7, typed5.write().map((java.util.function.Function<? super Dynamic<?>, ?>)(dynamic -> ((Type)taggedChoiceType3.types().get(string7)).read(dynamic))).result().orElseThrow(() -> new IllegalStateException("Could not read the new minecart.")));
            }
            return pair;
        }));
    }
    ...
    static {
        MINECART_BY_ID = (List)Lists.<String>newArrayList(new String[] { "MinecartRideable", "MinecartChest", "MinecartFurnace" });
    }
}
