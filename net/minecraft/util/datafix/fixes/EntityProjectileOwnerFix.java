...
public class EntityProjectileOwnerFix extends DataFix {
    ...
    protected TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("EntityProjectileOwner", schema2.getType(References.ENTITY), (Function<Typed<?>, Typed<?>>)this::updateProjectiles);
    }
    ...
    private Typed<?> updateEntity(final Typed<?> typed, final String string, final Function<Dynamic<?>, Dynamic<?>> function) {
        ...
        return typed.updateTyped(DSL.namedChoice(string, type5), type6, (Function<Typed<?>, Typed<?>>)(typed -> typed.<Dynamic<?>>update(DSL.remainderFinder(), function)));
    }
}
