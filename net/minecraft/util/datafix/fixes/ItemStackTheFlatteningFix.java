...
public class ItemStackTheFlatteningFix extends DataFix {
    ...
    public ItemStackTheFlatteningFix(final Schema schema, final boolean boolean2) {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type2, (Function<Typed<?>, Typed<?>>)(typed -> {
            ...
            final int integer7 = dynamic6.get("Damage").asInt(0);
            final String string8 = updateItem(((Pair)optional4.get()).getSecond(), integer7);
            if (string8 != null) {
                typed2 = typed2.<Pair<String, String>>set(opticFinder3, Pair.<String, String>of(References.ITEM_NAME.typeName(), string8));
            }
            if (ItemStackTheFlatteningFix.DAMAGE_IDS.contains(((Pair)optional4.get()).getSecond())) {
                final Typed<?> typed3 = typed.getOrCreateTyped(opticFinder4);
                Dynamic<?> dynamic7 = typed3.<Dynamic<?>>get(DSL.remainderFinder());
                dynamic7 = dynamic7.set("Damage", dynamic7.createInt(integer7));
                typed2 = typed2.set(opticFinder4, typed3.<Dynamic<?>>set(DSL.remainderFinder(), dynamic7));
            }
            typed2 = typed2.<Dynamic<?>>set(DSL.remainderFinder(), dynamic6.remove("Damage"));
            return typed2;
        }));
    }
    
    @Nullable
    public static String updateItem(@Nullable final String string, final int integer) {
        if (ItemStackTheFlatteningFix.IDS.contains(string)) {
            final String string2 = (String)ItemStackTheFlatteningFix.MAP.get((string + '.' + integer));
            return (String)((string2 == null) ? ItemStackTheFlatteningFix.MAP.get((string + ".0")) : string2);
        }
        return null;
    }
