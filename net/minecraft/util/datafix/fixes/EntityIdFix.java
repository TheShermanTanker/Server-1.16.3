...
public class EntityIdFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        final Type<?> type4 = this.getInputSchema().getType(References.ITEM_STACK);
        final Type<?> type5 = this.getOutputSchema().getType(References.ITEM_STACK);
        return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", type4, type5), this.<String, String>fixTypeEverywhere("EntityIdFix", (Type<String>)taggedChoiceType2, (Type<String>)taggedChoiceType3, (java.util.function.Function<DynamicOps<?>, java.util.function.Function<String, String>>)(dynamicOps -> pair -> pair.mapFirst(string -> (String)EntityIdFix.ID_MAP.getOrDefault(string, string)))));
    }
