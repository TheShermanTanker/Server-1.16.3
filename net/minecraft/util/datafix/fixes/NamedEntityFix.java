...
public abstract class NamedEntityFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped(this.name, this.getInputSchema().getType(this.type), this.getOutputSchema().getType(this.type), (Function<Typed<?>, Typed<?>>)(typed -> typed.updateTyped(opticFinder2, this.getOutputSchema().getChoiceType(this.type, this.entityName), this::fix)));
    }
