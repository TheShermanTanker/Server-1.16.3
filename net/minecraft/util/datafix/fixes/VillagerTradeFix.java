...
public class VillagerTradeFix extends NamedEntityFix {
    ...
    protected Typed<?> fix(final Typed<?> typed) {
        ...
        final List.ListType<?> listType6 = (List.ListType)type5;
        final Type<?> type6 = listType6.getElement();
        final OpticFinder<?> opticFinder5 = DSL.typeFinder(type6);
        ...
        final OpticFinder<Pair<String, String>> opticFinder9 = DSL.<Pair<String, String>>fieldFinder("id", DSL.<String>named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString()));
        final Function<Typed<?>, Typed<?>> function13 = (Function<Typed<?>, Typed<?>>)(typed -> this.updateItemStack(opticFinder9, typed));
        return typed.updateTyped(opticFinder3, (Function<Typed<?>, Typed<?>>)(typed -> typed.updateTyped(opticFinder4, typed -> typed.updateTyped(opticFinder5, typed -> typed.updateTyped(opticFinder6, function13).updateTyped(opticFinder7, function13).updateTyped(opticFinder8, function13)))));
    }
    
    private Typed<?> updateItemStack(final OpticFinder<Pair<String, String>> opticFinder, final Typed<?> typed) {
        return typed.<Pair<String, String>>update(opticFinder, (java.util.function.Function<Pair<String, String>, Pair<String, String>>)(pair -> pair.mapSecond(string -> Objects.equals(string, "minecraft:carved_pumpkin") ? "minecraft:pumpkin" : string)));
    }
}
