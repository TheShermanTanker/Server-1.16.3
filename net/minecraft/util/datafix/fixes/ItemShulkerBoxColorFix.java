...
public class ItemShulkerBoxColorFix extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemShulkerBoxColorFix", type2, (Function<Typed<?>, Typed<?>>)(typed -> {
            ...
            if (optional5.isPresent() && Objects.equals(((Pair)optional5.get()).getSecond(), "minecraft:shulker_box")) {
                ...
                if (optional6.isPresent()) {
                    ...
                    if (optional7.isPresent()) {
                        ...
                        final Dynamic<?> dynamic10 = typed3.<Dynamic<?>>get(DSL.remainderFinder());
                        final int integer11 = dynamic10.get("Color").asInt(0);
                        dynamic10.remove("Color");
                        return typed.set(opticFinder4, typed2.set(opticFinder5, typed3.<Dynamic<?>>set(DSL.remainderFinder(), dynamic10))).<Pair<String, String>>set(opticFinder3, Pair.<String, String>of(References.ITEM_NAME.typeName(), ItemShulkerBoxColorFix.NAMES_BY_COLOR[integer11 % 16]));
                    }
                }
            }
            return typed;
