...
public class EntityTheRenameningFix extends SimplestEntityRenameFix {
    ...
    public EntityTheRenameningFix(final Schema schema, final boolean boolean2) {
        super("EntityTheRenameningBlock", schema, boolean2);
    }
