...
public class ClassInstanceMultiMap<T> extends AbstractCollection<T> {
    ...
    public Iterator<T> iterator() {
        ...
        return Iterators.unmodifiableIterator((java.util.Iterator<?>)this.allInstances.iterator());
    }
    
    public List<T> getAllInstances() {
        return ImmutableList.copyOf((java.util.Collection<?>)this.allInstances);
    }
