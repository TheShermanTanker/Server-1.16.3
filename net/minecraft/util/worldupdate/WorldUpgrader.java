...
public class WorldUpgrader {
    ...
    public WorldUpgrader(final LevelStorageSource.LevelStorageAccess a, final DataFixer dataFixer, final ImmutableSet<ResourceKey<Level>> immutableSet, final boolean boolean4) {
        this.running = true;
        this.progressMap = Object2FloatMaps.<ResourceKey<Level>>synchronize(new Object2FloatOpenCustomHashMap<ResourceKey<Level>>(Util.<ResourceKey<Level>>identityStrategy()));
    ...
    private void work() {
        this.totalChunks = 0;
        final ImmutableMap.Builder<ResourceKey<Level>, ListIterator<ChunkPos>> builder2 = ImmutableMap.<ResourceKey<Level>, ListIterator<ChunkPos>>builder();
        for (final ResourceKey<Level> vj4 : this.levels) {
            final List<ChunkPos> list5 = this.getAllChunkPos(vj4);
            builder2.put(vj4, (ListIterator<ChunkPos>)list5.listIterator());
        ...
        final ImmutableMap<ResourceKey<Level>, ListIterator<ChunkPos>> immutableMap4 = builder2.build();
        final ImmutableMap.Builder<ResourceKey<Level>, ChunkStorage> builder3 = ImmutableMap.<ResourceKey<Level>, ChunkStorage>builder();
        ...
        final ImmutableMap<ResourceKey<Level>, ChunkStorage> immutableMap5 = builder3.build();
        ...
        while (this.running) {
            ...
            for (final ResourceKey<Level> vj6 : this.levels) {
                final ListIterator<ChunkPos> listIterator13 = immutableMap4.get(vj6);
                final ChunkStorage cgr14 = immutableMap5.get(vj6);
