...
public class BitStorage {
    ...
    public BitStorage(final int integer1, final int integer2, @Nullable final long[] arr) {
        Validate.inclusiveBetween(1L, 32L, integer1);
        this.size = integer2;
        this.bits = integer1;
    ...
    public int getAndSet(final int integer1, final int integer2) {
        Validate.inclusiveBetween(0L, this.size - 1, integer1);
        Validate.inclusiveBetween(0L, this.mask, integer2);
    ...
    public int get(final int integer) {
        Validate.inclusiveBetween(0L, this.size - 1, integer);
