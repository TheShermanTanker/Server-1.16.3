...
public class StaticTagHelper<T> {
    ...
    public Set<ResourceLocation> getMissingTags(final TagContainer ael) {
        ...
        final ImmutableSet<ResourceLocation> immutableSet5 = ImmutableSet.<ResourceLocation>copyOf((java.util.Collection<? extends ResourceLocation>)aek3.getAvailableTags());
        return Sets.difference(set4, immutableSet5);
    }
