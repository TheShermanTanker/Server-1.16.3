...
public class StaticTags {
    ...
    public static Multimap<ResourceLocation, ResourceLocation> getAllMissingTags(final TagContainer ael) {
        final Multimap<ResourceLocation, ResourceLocation> multimap2 = HashMultimap.create();
        StaticTags.HELPERS.forEach((vk, aeh) -> multimap2.putAll(vk, (java.lang.Iterable<?>)aeh.getMissingTags(ael)));
        return multimap2;
    }
