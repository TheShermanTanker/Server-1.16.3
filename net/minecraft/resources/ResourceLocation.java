...
public class ResourceLocation implements Comparable<ResourceLocation> {
    ...
    private static DataResult<ResourceLocation> read(final String string) {
        try {
            return DataResult.<ResourceLocation>success(new ResourceLocation(string));
        }
        catch (ResourceLocationException v2) {
            return DataResult.<ResourceLocation>error("Not a valid resource location: " + string + " " + v2.getMessage());
        }
    }
    ...
    public static ResourceLocation read(final StringReader stringReader) throws CommandSyntaxException {
        ...
        try {
            ...
            throw ResourceLocation.ERROR_INVALID.createWithContext(stringReader);
        }
    }
    ...
    static {
        CODEC = Codec.STRING.<ResourceLocation>comapFlatMap((java.util.function.Function<? super Object, ? extends DataResult<? extends ResourceLocation>>)ResourceLocation::read, (java.util.function.Function<? super ResourceLocation, ?>)ResourceLocation::toString).stable();
    ...
    public static class Serializer implements JsonDeserializer<ResourceLocation>, JsonSerializer<ResourceLocation> {
        ...
        public JsonElement serialize(final ResourceLocation vk, final Type type, final JsonSerializationContext jsonSerializationContext) {
            return new JsonPrimitive(vk.toString());
        }
    }
}
