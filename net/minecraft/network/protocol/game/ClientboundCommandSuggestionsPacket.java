...
public class ClientboundCommandSuggestionsPacket implements Packet<ClientGamePacketListener> {
    ...
    public void read(final FriendlyByteBuf nf) throws IOException {
        ...
        final List<Suggestion> list7 = Lists.newArrayListWithCapacity(integer5);
        for (int integer6 = 0; integer6 < integer5; ++integer6) {
            ...
            list7.add(new Suggestion(stringRange5, string9, nr10));
        }
        this.suggestions = new Suggestions(stringRange5, list7);
    }
