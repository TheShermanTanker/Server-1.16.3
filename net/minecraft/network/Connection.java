...
public class Connection extends SimpleChannelInboundHandler<Packet<?>> {
    ...
    public void setProtocol(final ConnectionProtocol ne) {
        this.channel.<ConnectionProtocol>attr(Connection.ATTRIBUTE_PROTOCOL).set(ne);
    ...
    public void setListener(final PacketListener ni) {
        Validate.<PacketListener>notNull(ni, "packetListener", new Object[0]);
    ...
    private void sendPacket(final Packet<?> oj, @Nullable final GenericFutureListener<? extends Future<? super Void>> genericFutureListener) {
        ...
        final ConnectionProtocol ne5 = this.channel.<ConnectionProtocol>attr(Connection.ATTRIBUTE_PROTOCOL).get();
        ++this.sentPackets;
        if (ne5 != ne4) {
    ...
    static {
        ...
        ATTRIBUTE_PROTOCOL = AttributeKey.<ConnectionProtocol>valueOf("protocol");
