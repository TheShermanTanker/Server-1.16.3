...
public class HoverEvent {
    ...
    public static class Action<T> {
        ...
        static {
            ...
            LOOKUP = (Map)Stream.of((Object[])new Action[] { Action.SHOW_TEXT, Action.SHOW_ITEM, Action.SHOW_ENTITY }).collect((Collector)ImmutableMap.toImmutableMap((java.util.function.Function<? super Object, ?>)Action::getName, (java.util.function.Function<? super Object, ?>)(a -> a)));
        }
    }
}
