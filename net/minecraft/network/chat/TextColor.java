...
public final class TextColor {
    ...
    static {
        LEGACY_FORMAT_TO_COLOR = (Map)Stream.of((Object[])ChatFormatting.values()).filter(ChatFormatting::isColor).collect((Collector)ImmutableMap.toImmutableMap((java.util.function.Function<? super Object, ?>)Function.identity(), (java.util.function.Function<? super Object, ?>)(k -> new TextColor(k.getColor(), k.getName()))));
        NAMED_COLORS = (Map)TextColor.LEGACY_FORMAT_TO_COLOR.values().stream().collect((Collector)ImmutableMap.toImmutableMap((java.util.function.Function<? super Object, ?>)(od -> od.name), (java.util.function.Function<? super Object, ?>)Function.identity()));
    }
}
