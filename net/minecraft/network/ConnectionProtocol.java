...
public enum ConnectionProtocol {
    ...
    static class PacketSet<T extends PacketListener> {
        ...
        private PacketSet() {
            this.classToId = Util.<Object2IntOpenHashMap<Class<? extends Packet<T>>>>make(new Object2IntOpenHashMap<Class<? extends Packet<T>>>(), (java.util.function.Consumer<Object2IntOpenHashMap<Class<? extends Packet<T>>>>)(object2IntOpenHashMap -> object2IntOpenHashMap.defaultReturnValue(-1)));
        ...
        public Iterable<Class<? extends Packet<?>>> getAllPackets() {
            return Iterables.<Class<? extends Packet<?>>>unmodifiableIterable((java.lang.Iterable<? extends Class<? extends Packet<?>>>)this.classToId.keySet());
        }
    }
