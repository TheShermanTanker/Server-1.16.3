...
public class DeserializationContext {
    ...
    public final LootItemCondition[] deserializeConditions(final JsonArray jsonArray, final String string, final LootContextParamSet dax) {
        final LootItemCondition[] arr5 = this.predicateGson.<LootItemCondition[]>fromJson(jsonArray, LootItemCondition[].class);
        ...
        for (final LootItemCondition dbl10 : arr5) {
            dbl10.validate(czd6);
            czd6.getProblems().forEach((java.util.function.BiConsumer<? super String, ? super String>)((string2, string3) -> DeserializationContext.LOGGER.warn("Found validation problem in advancement trigger {}/{}: {}", string, string2, string3)));
        }
        return arr5;
    }
