...
public class LocationPredicate {
    ...
    public JsonElement serializeToJson() {
        ...
        if (this.dimension != null) {
            Level.RESOURCE_KEY_CODEC.encodeStart((DynamicOps<Object>)JsonOps.INSTANCE, this.dimension).resultOrPartial((Consumer<String>)LocationPredicate.LOGGER::error).ifPresent(jsonElement -> jsonObject2.add("dimension", jsonElement));
        }
    ...
    public static LocationPredicate fromJson(@Nullable final JsonElement jsonElement) {
        ...
        final ResourceKey<Level> vj7 = (ResourceKey<Level>)(jsonObject2.has("dimension") ? ((ResourceKey)ResourceLocation.CODEC.<JsonElement>parse((DynamicOps<JsonElement>)JsonOps.INSTANCE, jsonObject2.get("dimension")).resultOrPartial((Consumer<String>)LocationPredicate.LOGGER::error).map(vk -> ResourceKey.create(Registry.DIMENSION_REGISTRY, vk)).orElse(null)) : null);
