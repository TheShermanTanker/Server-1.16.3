...
public class Timeline {
    ...
    public Timeline() {
        this.keyframes = Lists.newArrayList();
    }
    ...
    private void sortAndDeduplicateKeyframes() {
        final Int2ObjectSortedMap<Keyframe> int2ObjectSortedMap2 = new Int2ObjectAVLTreeMap<Keyframe>();
        this.keyframes.forEach(bhd -> {
            final Keyframe keyframe = int2ObjectSortedMap2.put(bhd.getTimeStamp(), bhd);
        });
