...
public class VillagerData {
    ...
    static {
        ...
        CODEC = RecordCodecBuilder.<VillagerData>create((java.util.function.Function<RecordCodecBuilder.Instance<VillagerData>, ? extends App<RecordCodecBuilder.Mu<VillagerData>, VillagerData>>)(instance -> instance.<VillagerType, VillagerProfession, Integer>group(Registry.VILLAGER_TYPE.fieldOf("type").orElseGet((java.util.function.Supplier<?>)(() -> VillagerType.PLAINS)).forGetter((java.util.function.Function<Object, Object>)(bfh -> bfh.type)), Registry.VILLAGER_PROFESSION.fieldOf("profession").orElseGet((java.util.function.Supplier<?>)(() -> VillagerProfession.NONE)).forGetter((java.util.function.Function<Object, Object>)(bfh -> bfh.profession)), Codec.INT.fieldOf("level").orElse(1).forGetter((java.util.function.Function<Object, Integer>)(bfh -> bfh.level))).<VillagerData>apply(instance, VillagerData::new)));
    }
}
