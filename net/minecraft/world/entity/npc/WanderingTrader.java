...
public class WanderingTrader extends AbstractVillager {
    ...
    protected void updateTrades() {
        final VillagerTrades.ItemListing[] arr2 = VillagerTrades.WANDERING_TRADER_TRADES.get(1);
        final VillagerTrades.ItemListing[] arr3 = VillagerTrades.WANDERING_TRADER_TRADES.get(2);
