...
public class VillagerProfession {
    ...
    static VillagerProfession register(final String string, final PoiType azo, @Nullable final SoundEvent adn) {
        return register(string, azo, ImmutableSet.<Item>of(), ImmutableSet.<Block>of(), adn);
    }
    ...
    static {
        ...
        FARMER = register("farmer", PoiType.FARMER, ImmutableSet.<Item>of(Items.WHEAT, Items.WHEAT_SEEDS, Items.BEETROOT_SEEDS, Items.BONE_MEAL), ImmutableSet.<Block>of(Blocks.FARMLAND), SoundEvents.VILLAGER_WORK_FARMER);
