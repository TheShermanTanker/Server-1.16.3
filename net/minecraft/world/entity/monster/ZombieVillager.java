...
public class ZombieVillager extends Zombie implements VillagerDataHolder {
    ...
    public void addAdditionalSaveData(final CompoundTag md) {
        ...
        VillagerData.CODEC.encodeStart((DynamicOps<Object>)NbtOps.INSTANCE, this.getVillagerData()).resultOrPartial((Consumer<String>)ZombieVillager.LOGGER::error).ifPresent(mt -> md.put("VillagerData", mt));
    ...
    public void readAdditionalSaveData(final CompoundTag md) {
        ...
        if (md.contains("VillagerData", 10)) {
            ...
            dataResult3.resultOrPartial((Consumer<String>)ZombieVillager.LOGGER::error).ifPresent(this::setVillagerData);
        }
