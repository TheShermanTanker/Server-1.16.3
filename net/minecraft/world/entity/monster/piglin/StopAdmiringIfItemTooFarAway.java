...
public class StopAdmiringIfItemTooFarAway<E extends Piglin> extends Behavior<E> {
    ...
    public StopAdmiringIfItemTooFarAway(final int integer) {
        super((Map)ImmutableMap.<MemoryModuleType<Boolean>, MemoryStatus>of(MemoryModuleType.ADMIRING_ITEM, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<Boolean>)MemoryModuleType.NEAREST_VISIBLE_WANTED_ITEM, MemoryStatus.REGISTERED));
