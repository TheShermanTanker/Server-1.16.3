...
public class StartHuntingHoglin<E extends Piglin> extends Behavior<E> {
    public StartHuntingHoglin() {
        super((Map)ImmutableMap.<MemoryModuleType<Hoglin>, MemoryStatus>of(MemoryModuleType.NEAREST_VISIBLE_HUNTABLE_HOGLIN, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<Hoglin>)MemoryModuleType.ANGRY_AT, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<Hoglin>)MemoryModuleType.HUNTED_RECENTLY, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<Hoglin>)MemoryModuleType.NEAREST_VISIBLE_ADULT_PIGLINS, MemoryStatus.REGISTERED));
    }
