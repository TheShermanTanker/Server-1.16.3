...
public class StartAdmiringItemIfSeen<E extends Piglin> extends Behavior<E> {
    ...
    public StartAdmiringItemIfSeen(final int integer) {
        super((Map)ImmutableMap.<MemoryModuleType<ItemEntity>, MemoryStatus>of(MemoryModuleType.NEAREST_VISIBLE_WANTED_ITEM, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<ItemEntity>)MemoryModuleType.ADMIRING_ITEM, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<ItemEntity>)MemoryModuleType.ADMIRING_DISABLED, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<ItemEntity>)MemoryModuleType.DISABLE_WALK_TO_ADMIRE_ITEM, MemoryStatus.VALUE_ABSENT));
