...
public class PiglinBruteSpecificSensor extends Sensor<LivingEntity> {
    ...
    public Set<MemoryModuleType<?>> requires() {
        return ImmutableSet.of(MemoryModuleType.VISIBLE_LIVING_ENTITIES, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.NEAREST_VISIBLE_NEMESIS, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.NEARBY_ADULT_PIGLINS);
    }
    ...
    protected void doTick(final ServerLevel aag, final LivingEntity aqj) {
        ...
        final List<AbstractPiglin> list6 = Lists.newArrayList();
