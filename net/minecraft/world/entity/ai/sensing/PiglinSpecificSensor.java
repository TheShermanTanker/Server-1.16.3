...
public class PiglinSpecificSensor extends Sensor<LivingEntity> {
    ...
    public Set<MemoryModuleType<?>> requires() {
        return ImmutableSet.of(MemoryModuleType.VISIBLE_LIVING_ENTITIES, MemoryModuleType.LIVING_ENTITIES, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.NEAREST_VISIBLE_NEMESIS, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.NEAREST_TARGETABLE_PLAYER_NOT_WEARING_GOLD, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.NEAREST_PLAYER_HOLDING_WANTED_ITEM, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.NEAREST_VISIBLE_HUNTABLE_HOGLIN, MemoryModuleType.NEAREST_VISIBLE_BABY_HOGLIN, MemoryModuleType.NEAREST_VISIBLE_ADULT_PIGLINS, MemoryModuleType.NEARBY_ADULT_PIGLINS, MemoryModuleType.VISIBLE_ADULT_PIGLIN_COUNT, MemoryModuleType.VISIBLE_ADULT_HOGLIN_COUNT, MemoryModuleType.NEAREST_REPELLENT);
    }
    ...
    protected void doTick(final ServerLevel aag, final LivingEntity aqj) {
        ...
        int integer12 = 0;
        final List<AbstractPiglin> list13 = Lists.newArrayList();
        final List<AbstractPiglin> list14 = Lists.newArrayList();
