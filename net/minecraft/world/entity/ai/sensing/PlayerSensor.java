...
public class PlayerSensor extends Sensor<LivingEntity> {
    ...
    public Set<MemoryModuleType<?>> requires() {
        return ImmutableSet.of(MemoryModuleType.NEAREST_PLAYERS, (MemoryModuleType<List<Player>>)MemoryModuleType.NEAREST_VISIBLE_PLAYER, (MemoryModuleType<List<Player>>)MemoryModuleType.NEAREST_VISIBLE_TARGETABLE_PLAYER);
    }
