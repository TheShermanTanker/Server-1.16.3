...
public class HoglinSpecificSensor extends Sensor<Hoglin> {
    ...
    public Set<MemoryModuleType<?>> requires() {
        return ImmutableSet.of(MemoryModuleType.VISIBLE_LIVING_ENTITIES, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.NEAREST_REPELLENT, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.NEAREST_VISIBLE_ADULT_PIGLIN, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.NEAREST_VISIBLE_ADULT_HOGLINS, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.VISIBLE_ADULT_PIGLIN_COUNT, (MemoryModuleType<List<LivingEntity>>)MemoryModuleType.VISIBLE_ADULT_HOGLIN_COUNT, new MemoryModuleType[0]);
    }
    ...
    protected void doTick(final ServerLevel aag, final Hoglin bej) {
        ...
        int integer6 = 0;
        final List<Hoglin> list7 = Lists.newArrayList();
