...
public class VillagerHostilesSensor extends Sensor<LivingEntity> {
    ...
    private boolean isClose(final LivingEntity aqj1, final LivingEntity aqj2) {
        final float float4 = VillagerHostilesSensor.ACCEPTABLE_DISTANCE_FROM_HOSTILES.get(aqj2.getType());
    ...
    static {
        ACCEPTABLE_DISTANCE_FROM_HOSTILES = ImmutableMap.<EntityType<Drowned>, Float>builder().put(EntityType.DROWNED, 8.0f).put((EntityType<Drowned>)EntityType.EVOKER, 12.0f).put((EntityType<Drowned>)EntityType.HUSK, 8.0f).put((EntityType<Drowned>)EntityType.ILLUSIONER, 12.0f).put((EntityType<Drowned>)EntityType.PILLAGER, 15.0f).put((EntityType<Drowned>)EntityType.RAVAGER, 12.0f).put((EntityType<Drowned>)EntityType.VEX, 8.0f).put((EntityType<Drowned>)EntityType.VINDICATOR, 10.0f).put((EntityType<Drowned>)EntityType.ZOGLIN, 10.0f).put((EntityType<Drowned>)EntityType.ZOMBIE, 8.0f).put((EntityType<Drowned>)EntityType.ZOMBIE_VILLAGER, 8.0f).build();
    }
}
