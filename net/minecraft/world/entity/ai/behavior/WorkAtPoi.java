...
public class WorkAtPoi extends Behavior<Villager> {
    ...
    public WorkAtPoi() {
        super((Map)ImmutableMap.<MemoryModuleType<GlobalPos>, MemoryStatus>of(MemoryModuleType.JOB_SITE, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<GlobalPos>)MemoryModuleType.LOOK_TARGET, MemoryStatus.REGISTERED));
    }
