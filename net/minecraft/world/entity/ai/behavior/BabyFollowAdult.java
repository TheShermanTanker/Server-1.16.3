...
public class BabyFollowAdult<E extends AgableMob> extends Behavior<E> {
    ...
    public BabyFollowAdult(final IntRange afe, final float float2) {
        super((Map)ImmutableMap.<MemoryModuleType<AgableMob>, MemoryStatus>of(MemoryModuleType.NEAREST_VISIBLE_ADULT, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<AgableMob>)MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_ABSENT));
