...
public class JumpOnBed extends Behavior<Mob> {
    ...
    public JumpOnBed(final float float1) {
        super((Map)ImmutableMap.<MemoryModuleType<BlockPos>, MemoryStatus>of(MemoryModuleType.NEAREST_BED, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<BlockPos>)MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_ABSENT));
