...
public class StartAttacking<E extends Mob> extends Behavior<E> {
    ...
    public StartAttacking(final Predicate<E> predicate, final Function<E, Optional<? extends LivingEntity>> function) {
        super((Map)ImmutableMap.<MemoryModuleType<LivingEntity>, MemoryStatus>of(MemoryModuleType.ATTACK_TARGET, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<LivingEntity>)MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryStatus.REGISTERED));
