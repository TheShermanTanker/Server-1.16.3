...
public class PoiCompetitorScan extends Behavior<Villager> {
    ...
    public PoiCompetitorScan(final VillagerProfession bfj) {
        super((Map)ImmutableMap.<MemoryModuleType<GlobalPos>, MemoryStatus>of(MemoryModuleType.JOB_SITE, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<GlobalPos>)MemoryModuleType.LIVING_ENTITIES, MemoryStatus.VALUE_PRESENT));
        this.profession = bfj;
    }
