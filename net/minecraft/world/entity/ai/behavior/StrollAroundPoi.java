...
public class StrollAroundPoi extends Behavior<PathfinderMob> {
    ...
    public StrollAroundPoi(final MemoryModuleType<GlobalPos> aya, final float float2, final int integer) {
        super((Map)ImmutableMap.<MemoryModuleType<WalkTarget>, MemoryStatus>of(MemoryModuleType.WALK_TARGET, MemoryStatus.REGISTERED, (MemoryModuleType<WalkTarget>)aya, MemoryStatus.VALUE_PRESENT));
        this.memoryType = aya;
