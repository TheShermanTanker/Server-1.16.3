...
public class SetWalkTargetFromLookTarget extends Behavior<LivingEntity> {
    ...
    public SetWalkTargetFromLookTarget(final float float1, final int integer) {
        super((Map)ImmutableMap.<MemoryModuleType<WalkTarget>, MemoryStatus>of(MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<WalkTarget>)MemoryModuleType.LOOK_TARGET, MemoryStatus.VALUE_PRESENT));
