...
public class StopAttackingIfTargetInvalid<E extends Mob> extends Behavior<E> {
    ...
    public StopAttackingIfTargetInvalid(final Predicate<LivingEntity> predicate) {
        super((Map)ImmutableMap.<MemoryModuleType<LivingEntity>, MemoryStatus>of(MemoryModuleType.ATTACK_TARGET, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<LivingEntity>)MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryStatus.REGISTERED));
