...
public class SetWalkTargetFromAttackTargetIfTargetOutOfReach extends Behavior<Mob> {
    ...
    public SetWalkTargetFromAttackTargetIfTargetOutOfReach(final float float1) {
        super((Map)ImmutableMap.<MemoryModuleType<WalkTarget>, MemoryStatus>of(MemoryModuleType.WALK_TARGET, MemoryStatus.REGISTERED, (MemoryModuleType<WalkTarget>)MemoryModuleType.LOOK_TARGET, MemoryStatus.REGISTERED, (MemoryModuleType<WalkTarget>)MemoryModuleType.ATTACK_TARGET, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<WalkTarget>)MemoryModuleType.VISIBLE_LIVING_ENTITIES, MemoryStatus.REGISTERED));
