...
public class SleepInBed extends Behavior<LivingEntity> {
    ...
    public SleepInBed() {
        super((Map)ImmutableMap.<MemoryModuleType<GlobalPos>, MemoryStatus>of(MemoryModuleType.HOME, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<GlobalPos>)MemoryModuleType.LAST_WOKEN, MemoryStatus.REGISTERED));
    }
