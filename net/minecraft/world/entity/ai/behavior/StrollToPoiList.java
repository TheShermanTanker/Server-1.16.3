...
public class StrollToPoiList extends Behavior<Villager> {
    ...
    public StrollToPoiList(final MemoryModuleType<List<GlobalPos>> aya1, final float float2, final int integer3, final int integer4, final MemoryModuleType<GlobalPos> aya5) {
        super((Map)ImmutableMap.<MemoryModuleType<WalkTarget>, MemoryStatus>of(MemoryModuleType.WALK_TARGET, MemoryStatus.REGISTERED, (MemoryModuleType<WalkTarget>)aya1, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<WalkTarget>)aya5, MemoryStatus.VALUE_PRESENT));
