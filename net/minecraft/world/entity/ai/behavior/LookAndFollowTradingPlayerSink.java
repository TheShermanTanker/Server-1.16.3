...
public class LookAndFollowTradingPlayerSink extends Behavior<Villager> {
    ...
    public LookAndFollowTradingPlayerSink(final float float1) {
        super((Map)ImmutableMap.<MemoryModuleType<WalkTarget>, MemoryStatus>of(MemoryModuleType.WALK_TARGET, MemoryStatus.REGISTERED, (MemoryModuleType<WalkTarget>)MemoryModuleType.LOOK_TARGET, MemoryStatus.REGISTERED), Integer.MAX_VALUE);
