...
public class SetClosestHomeAsWalkTarget extends Behavior<LivingEntity> {
    ...
    public SetClosestHomeAsWalkTarget(final float float1) {
        super((Map)ImmutableMap.<MemoryModuleType<WalkTarget>, MemoryStatus>of(MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<WalkTarget>)MemoryModuleType.HOME, MemoryStatus.VALUE_ABSENT));
