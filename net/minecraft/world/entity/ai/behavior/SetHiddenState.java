...
public class SetHiddenState extends Behavior<LivingEntity> {
    ...
    public SetHiddenState(final int integer1, final int integer2) {
        super((Map)ImmutableMap.<MemoryModuleType<GlobalPos>, MemoryStatus>of(MemoryModuleType.HIDING_PLACE, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<GlobalPos>)MemoryModuleType.HEARD_BELL_TIME, MemoryStatus.VALUE_PRESENT));
