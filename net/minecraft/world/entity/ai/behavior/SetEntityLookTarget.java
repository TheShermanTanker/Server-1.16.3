...
public class SetEntityLookTarget extends Behavior<LivingEntity> {
    ...
    public SetEntityLookTarget(final Predicate<LivingEntity> predicate, final float float2) {
        super((Map)ImmutableMap.<MemoryModuleType<PositionTracker>, MemoryStatus>of(MemoryModuleType.LOOK_TARGET, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<PositionTracker>)MemoryModuleType.VISIBLE_LIVING_ENTITIES, MemoryStatus.VALUE_PRESENT));
