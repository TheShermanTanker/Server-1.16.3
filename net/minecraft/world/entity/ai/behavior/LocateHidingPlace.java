...
public class LocateHidingPlace extends Behavior<LivingEntity> {
    ...
    public LocateHidingPlace(final int integer1, final float float2, final int integer3) {
        super((Map)ImmutableMap.<MemoryModuleType<WalkTarget>, MemoryStatus>of(MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<WalkTarget>)MemoryModuleType.HOME, MemoryStatus.REGISTERED, (MemoryModuleType<WalkTarget>)MemoryModuleType.HIDING_PLACE, MemoryStatus.REGISTERED));
