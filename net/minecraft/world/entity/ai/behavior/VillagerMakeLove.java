...
public class VillagerMakeLove extends Behavior<Villager> {
    ...
    public VillagerMakeLove() {
        super((Map)ImmutableMap.<MemoryModuleType<AgableMob>, MemoryStatus>of(MemoryModuleType.BREED_TARGET, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<AgableMob>)MemoryModuleType.VISIBLE_LIVING_ENTITIES, MemoryStatus.VALUE_PRESENT), 350, 350);
    }
