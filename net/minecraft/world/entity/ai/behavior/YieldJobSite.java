...
public class YieldJobSite extends Behavior<Villager> {
    ...
    public YieldJobSite(final float float1) {
        super((Map)ImmutableMap.<MemoryModuleType<GlobalPos>, MemoryStatus>of(MemoryModuleType.POTENTIAL_JOB_SITE, MemoryStatus.VALUE_PRESENT, MemoryModuleType.JOB_SITE, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<GlobalPos>)MemoryModuleType.LIVING_ENTITIES, MemoryStatus.VALUE_PRESENT));
