...
public class ShowTradesToPlayer extends Behavior<Villager> {
    ...
    public ShowTradesToPlayer(final int integer1, final int integer2) {
        super((Map)ImmutableMap.<MemoryModuleType<LivingEntity>, MemoryStatus>of(MemoryModuleType.INTERACTION_TARGET, MemoryStatus.VALUE_PRESENT), integer1, integer2);
    ...
    public void tick(final ServerLevel aag, final Villager bfg, final long long3) {
