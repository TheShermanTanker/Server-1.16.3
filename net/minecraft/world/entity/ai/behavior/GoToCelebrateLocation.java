...
public class GoToCelebrateLocation<E extends Mob> extends Behavior<E> {
    ...
    public GoToCelebrateLocation(final int integer, final float float2) {
        super((Map)ImmutableMap.<MemoryModuleType<BlockPos>, MemoryStatus>of(MemoryModuleType.CELEBRATE_LOCATION, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<BlockPos>)MemoryModuleType.ATTACK_TARGET, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<BlockPos>)MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<BlockPos>)MemoryModuleType.LOOK_TARGET, MemoryStatus.REGISTERED));
