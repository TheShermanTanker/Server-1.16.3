...
public class StartCelebratingIfTargetDead extends Behavior<LivingEntity> {
    ...
    public StartCelebratingIfTargetDead(final int integer, final BiPredicate<LivingEntity, LivingEntity> biPredicate) {
        super((Map)ImmutableMap.<MemoryModuleType<LivingEntity>, MemoryStatus>of(MemoryModuleType.ATTACK_TARGET, MemoryStatus.VALUE_PRESENT, (MemoryModuleType<LivingEntity>)MemoryModuleType.ANGRY_AT, MemoryStatus.REGISTERED, (MemoryModuleType<LivingEntity>)MemoryModuleType.CELEBRATE_LOCATION, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<LivingEntity>)MemoryModuleType.DANCING, MemoryStatus.REGISTERED));
