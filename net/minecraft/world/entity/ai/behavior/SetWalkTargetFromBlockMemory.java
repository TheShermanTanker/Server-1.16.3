...
public class SetWalkTargetFromBlockMemory extends Behavior<Villager> {
    ...
    public SetWalkTargetFromBlockMemory(final MemoryModuleType<GlobalPos> aya, final float float2, final int integer3, final int integer4, final int integer5) {
        super((Map)ImmutableMap.<MemoryModuleType<Long>, MemoryStatus>of(MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryStatus.REGISTERED, (MemoryModuleType<Long>)MemoryModuleType.WALK_TARGET, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<Long>)aya, MemoryStatus.VALUE_PRESENT));
        this.memoryType = aya;
