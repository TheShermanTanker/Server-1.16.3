...
public class BecomePassiveIfMemoryPresent extends Behavior<LivingEntity> {
    ...
    public BecomePassiveIfMemoryPresent(final MemoryModuleType<?> aya, final int integer) {
        super((Map)ImmutableMap.<MemoryModuleType<LivingEntity>, MemoryStatus>of(MemoryModuleType.ATTACK_TARGET, MemoryStatus.REGISTERED, (MemoryModuleType<LivingEntity>)MemoryModuleType.PACIFIED, MemoryStatus.VALUE_ABSENT, (MemoryModuleType<LivingEntity>)aya, MemoryStatus.VALUE_PRESENT));
