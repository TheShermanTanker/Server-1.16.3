...
public enum GossipType {
    ...
    static {
        BY_ID = (Map)Stream.of((Object[])values()).collect((Collector)ImmutableMap.toImmutableMap((java.util.function.Function<? super Object, ?>)(axx -> axx.id), (java.util.function.Function<? super Object, ?>)Function.identity()));
    }
}
