...
public class PoiManager extends SectionStorage<PoiSection> {
    ...
    final class DistanceTracker extends SectionTracker {
        ...
        protected DistanceTracker() {
            super(7, 16, 256);
            (this.levels = new Long2ByteOpenHashMap()).defaultReturnValue((byte)7);
        }
