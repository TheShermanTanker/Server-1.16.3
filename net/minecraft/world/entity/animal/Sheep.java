...
public class Sheep extends Animal implements Shearable {
    ...
    static {
        ...
        ITEM_BY_DYE = Util.<Map>make((Map)Maps.<DyeColor, Object>newEnumMap(DyeColor.class), (java.util.function.Consumer<Map>)(enumMap -> {
        ...
        COLORARRAY_BY_COLOR = (Map)Maps.<Enum, Object>newEnumMap((java.util.Map<Enum, ?>)Arrays.stream((Object[])DyeColor.values()).collect(Collectors.toMap(bku -> bku, Sheep::createSheepColor)));
    }
}
