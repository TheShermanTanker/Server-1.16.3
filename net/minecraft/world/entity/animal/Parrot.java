...
public class Parrot extends ShoulderRidingEntity implements FlyingAnimal {
    ...
    public static SoundEvent getAmbient(final Level bru, final Random random) {
        if (bru.getDifficulty() != Difficulty.PEACEFUL && random.nextInt(1000) == 0) {
            final List<EntityType<?>> list3 = Lists.newArrayList((java.lang.Iterable<?>)Parrot.MOB_SOUND_MAP.keySet());
    ...
    static {
        ...
        TAME_FOOD = (Set)Sets.<Item>newHashSet(Items.WHEAT_SEEDS, Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.BEETROOT_SEEDS);
