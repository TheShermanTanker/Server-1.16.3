...
public abstract class AbstractMinecart extends Entity {
    ...
    public Vec3 getDismountLocationForPassenger(final LivingEntity aqj) {
        ...
        for (final Pose aqu9 : immutableList7) {
            ...
            for (final int integer13 : AbstractMinecart.POSE_DISMOUNT_HEIGHTS.get(aqu9)) {
    ...
    protected void moveAlongTrack(final BlockPos fx, final BlockState cee) {
        ...
        final Vec3i gr19 = pair18.getFirst();
        final Vec3i gr20 = pair18.getSecond();
    ...
    public Vec3 getPos(double double1, double double2, double double3) {
        ...
        if (BaseRailBlock.isRail(cee11)) {
            ...
            final Vec3i gr14 = pair13.getFirst();
            final Vec3i gr15 = pair13.getSecond();
    ...
    static {
        ...
        POSE_DISMOUNT_HEIGHTS = ImmutableMap.<Pose, ImmutableList<Integer>>of(Pose.STANDING, ImmutableList.<Integer>of(0, 1, -1), Pose.CROUCHING, ImmutableList.<Integer>of(0, 1, -1), Pose.SWIMMING, ImmutableList.<Integer>of(0, 1));
        EXITS = Util.<Map>make((Map)Maps.<RailShape, Object>newEnumMap(RailShape.class), (java.util.function.Consumer<Map>)(enumMap -> {
            ...
            enumMap.put((Enum)RailShape.NORTH_SOUTH, Pair.<Vec3i, Vec3i>of(gr4, gr5));
            enumMap.put((Enum)RailShape.EAST_WEST, Pair.<Vec3i, Vec3i>of(gr2, gr3));
            enumMap.put((Enum)RailShape.ASCENDING_EAST, Pair.<Vec3i, Vec3i>of(gr6, gr3));
            enumMap.put((Enum)RailShape.ASCENDING_WEST, Pair.<Vec3i, Vec3i>of(gr2, gr7));
            enumMap.put((Enum)RailShape.ASCENDING_NORTH, Pair.<Vec3i, Vec3i>of(gr4, gr9));
            enumMap.put((Enum)RailShape.ASCENDING_SOUTH, Pair.<Vec3i, Vec3i>of(gr8, gr5));
            enumMap.put((Enum)RailShape.SOUTH_EAST, Pair.<Vec3i, Vec3i>of(gr5, gr3));
            enumMap.put((Enum)RailShape.SOUTH_WEST, Pair.<Vec3i, Vec3i>of(gr5, gr2));
            enumMap.put((Enum)RailShape.NORTH_WEST, Pair.<Vec3i, Vec3i>of(gr4, gr2));
            enumMap.put((Enum)RailShape.NORTH_EAST, Pair.<Vec3i, Vec3i>of(gr4, gr3));
        }));
    }
