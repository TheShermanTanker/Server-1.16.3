...
public class MobEffectInstance implements Comparable<MobEffectInstance> {
    ...
    public int compareTo(final MobEffectInstance apr) {
        ...
        if ((this.getDuration() > 32147 && apr.getDuration() > 32147) || (this.isAmbient() && apr.isAmbient())) {
            return ComparisonChain.start().compare(this.isAmbient(), apr.isAmbient()).compare(this.getEffect().getColor(), apr.getEffect().getColor()).result();
        }
        return ComparisonChain.start().compare(this.isAmbient(), apr.isAmbient()).compare(this.getDuration(), apr.getDuration()).compare(this.getEffect().getColor(), apr.getEffect().getColor()).result();
    }
