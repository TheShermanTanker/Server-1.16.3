...
public final class ArrayVoxelShape extends VoxelShape {
    ...
    protected ArrayVoxelShape(final DiscreteVoxelShape dct, final double[] arr2, final double[] arr3, final double[] arr4) {
        this(dct, DoubleArrayList.wrap(Arrays.copyOf(arr2, dct.getXSize() + 1)), DoubleArrayList.wrap(Arrays.copyOf(arr3, dct.getYSize() + 1)), DoubleArrayList.wrap(Arrays.copyOf(arr4, dct.getZSize() + 1)));
    }
