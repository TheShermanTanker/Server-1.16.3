...
public abstract class VoxelShape {
    ...
    public VoxelShape move(final double double1, final double double2, final double double3) {
        ...
        return new ArrayVoxelShape(this.shape, new OffsetDoubleList(this.getCoords(Direction.Axis.X), double1), new OffsetDoubleList(this.getCoords(Direction.Axis.Y), double2), new OffsetDoubleList(this.getCoords(Direction.Axis.Z), double3));
    }
    ...
    public List<AABB> toAabbs() {
        final List<AABB> list2 = Lists.newArrayList();
