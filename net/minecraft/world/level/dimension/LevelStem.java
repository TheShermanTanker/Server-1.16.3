...
public final class LevelStem {
    ...
    public static boolean stable(final long long1, final MappedRegistry<LevelStem> gi) {
        final List<Map.Entry<ResourceKey<LevelStem>, LevelStem>> list4 = Lists.newArrayList((java.lang.Iterable<?>)gi.entrySet());
    ...
    static {
        CODEC = RecordCodecBuilder.<LevelStem>create((java.util.function.Function<RecordCodecBuilder.Instance<LevelStem>, ? extends App<RecordCodecBuilder.Mu<LevelStem>, LevelStem>>)(instance -> instance.<Supplier<DimensionType>, ChunkGenerator>group(DimensionType.CODEC.fieldOf("type").forGetter((java.util.function.Function<Object, Supplier<DimensionType>>)LevelStem::typeSupplier), ChunkGenerator.CODEC.fieldOf("generator").forGetter((java.util.function.Function<Object, ChunkGenerator>)LevelStem::generator)).apply(instance, instance.stable(LevelStem::new))));
        ...
        BUILTIN_ORDER = Sets.<ResourceKey<LevelStem>>newLinkedHashSet((java.lang.Iterable<? extends ResourceKey<LevelStem>>)ImmutableList.<ResourceKey<LevelStem>>of(LevelStem.OVERWORLD, LevelStem.NETHER, LevelStem.END));
    }
}
