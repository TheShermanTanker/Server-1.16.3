...
public class GameRules {
    ...
    public GameRules() {
        this.rules = (Map<Key<?>, Value<?>>)GameRules.GAME_RULE_TYPES.entrySet().stream().collect((Collector)ImmutableMap.toImmutableMap((java.util.function.Function<? super Object, ?>)Map.Entry::getKey, (java.util.function.Function<? super Object, ?>)(entry -> ((Type)entry.getValue()).createRule())));
    }
    ...
    public GameRules copy() {
        return new GameRules((Map<Key<?>, Value<?>>)this.rules.entrySet().stream().collect((Collector)ImmutableMap.toImmutableMap((java.util.function.Function<? super Object, ?>)Map.Entry::getKey, (java.util.function.Function<? super Object, ?>)(entry -> ((Value)entry.getValue()).copy()))));
    }
    ...
    static {
        ...
        GAME_RULE_TYPES = (Map)Maps.newTreeMap((java.util.Comparator<Object>)Comparator.comparing(e -> e.id));
