...
public abstract class FlowingFluid extends Fluid {
    ...
    public FlowingFluid() {
        this.shapes = Maps.newIdentityHashMap();
    }
    ...
    protected int getSlopeDistance(final LevelReader brw, final BlockPos fx2, final int integer, final Direction gc, final BlockState cee, final BlockPos fx6, final Short2ObjectMap<Pair<BlockState, FluidState>> short2ObjectMap, final Short2BooleanMap short2BooleanMap) {
        ...
        for (final Direction gc2 : Direction.Plane.HORIZONTAL) {
            ...
            final Pair<BlockState, FluidState> pair15 = short2ObjectMap.computeIfAbsent(short14, (java.util.function.IntFunction<? extends Pair<BlockState, FluidState>>)(integer -> {
                final BlockState cee4 = brw.getBlockState(fx7);
                return Pair.<BlockState, FluidState>of(cee4, cee4.getFluidState());
            }));
            final BlockState cee2 = pair15.getFirst();
            final FluidState cuu17 = pair15.getSecond();
    ...
    protected Map<Direction, FluidState> getSpread(final LevelReader brw, final BlockPos fx, final BlockState cee) {
        int integer5 = 1000;
        final Map<Direction, FluidState> map6 = Maps.newEnumMap(Direction.class);
        final Short2ObjectMap<Pair<BlockState, FluidState>> short2ObjectMap7 = new Short2ObjectOpenHashMap<Pair<BlockState, FluidState>>();
        final Short2BooleanMap short2BooleanMap8 = new Short2BooleanOpenHashMap();
        for (final Direction gc10 : Direction.Plane.HORIZONTAL) {
            final BlockPos fx2 = fx.relative(gc10);
            final short short12 = getCacheKey(fx, fx2);
            final Pair<BlockState, FluidState> pair13 = short2ObjectMap7.computeIfAbsent(short12, (java.util.function.IntFunction<? extends Pair<BlockState, FluidState>>)(integer -> {
                final BlockState cee4 = brw.getBlockState(fx2);
                return Pair.<BlockState, FluidState>of(cee4, cee4.getFluidState());
            }));
            final BlockState cee2 = pair13.getFirst();
            final FluidState cuu15 = pair13.getSecond();
