...
public final class NoiseBasedChunkGenerator extends ChunkGenerator {
    ...
    public void fillFromNoise(final LevelAccessor brv, final StructureFeatureManager bsk, final ChunkAccess cft) {
        final ObjectList<StructurePiece> objectList5 = new ObjectArrayList<StructurePiece>(10);
        final ObjectList<JigsawJunction> objectList6 = new ObjectArrayList<JigsawJunction>(32);
        ...
        final ObjectListIterator<StructurePiece> objectListIterator17 = objectList5.iterator();
        final ObjectListIterator<JigsawJunction> objectListIterator18 = objectList6.iterator();
    ...
    static {
        CODEC = RecordCodecBuilder.<NoiseBasedChunkGenerator>create((java.util.function.Function<RecordCodecBuilder.Instance<NoiseBasedChunkGenerator>, ? extends App<RecordCodecBuilder.Mu<NoiseBasedChunkGenerator>, NoiseBasedChunkGenerator>>)(instance -> instance.<BiomeSource, Object, Supplier<NoiseGeneratorSettings>>group(BiomeSource.CODEC.fieldOf("biome_source").forGetter((java.util.function.Function<Object, BiomeSource>)(chl -> chl.biomeSource)), Codec.LONG.fieldOf("seed").stable().forGetter((java.util.function.Function<Object, Object>)(chl -> chl.seed)), NoiseGeneratorSettings.CODEC.fieldOf("settings").forGetter((java.util.function.Function<Object, Supplier<NoiseGeneratorSettings>>)(chl -> chl.settings))).apply(instance, instance.stable(NoiseBasedChunkGenerator::new))));
