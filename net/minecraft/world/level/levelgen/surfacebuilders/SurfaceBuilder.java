...
public abstract class SurfaceBuilder<C extends SurfaceBuilderConfiguration> {
    ...
    public SurfaceBuilder(final Codec<C> codec) {
        this.configuredCodec = codec.fieldOf("config").<ConfiguredSurfaceBuilder<C>>xmap((java.util.function.Function<? super C, ? extends ConfiguredSurfaceBuilder<C>>)this::configured, (java.util.function.Function<? super ConfiguredSurfaceBuilder<C>, ? extends C>)ConfiguredSurfaceBuilder::config).codec();
    }
