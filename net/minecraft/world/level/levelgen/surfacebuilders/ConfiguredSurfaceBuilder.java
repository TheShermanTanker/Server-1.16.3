...
public class ConfiguredSurfaceBuilder<SC extends SurfaceBuilderConfiguration> {
    ...
    static {
        DIRECT_CODEC = Registry.SURFACE_BUILDER.<ConfiguredSurfaceBuilder<?>>dispatch((java.util.function.Function<? super ConfiguredSurfaceBuilder<?>, ?>)(ctd -> ctd.surfaceBuilder), (java.util.function.Function<? super Object, ? extends Codec<? extends ConfiguredSurfaceBuilder<?>>>)SurfaceBuilder::configuredCodec);
        CODEC = RegistryFileCodec.<ConfiguredSurfaceBuilder<?>>create(Registry.CONFIGURED_SURFACE_BUILDER_REGISTRY, ConfiguredSurfaceBuilder.DIRECT_CODEC);
    }
}
