...
public class DebugLevelSource extends ChunkGenerator {
    ...
    static {
        CODEC = RegistryLookupCodec.create(Registry.BIOME_REGISTRY).<DebugLevelSource>xmap((java.util.function.Function<? super Object, ? extends DebugLevelSource>)DebugLevelSource::new, (java.util.function.Function<? super DebugLevelSource, ?>)DebugLevelSource::biomes).stable().codec();
