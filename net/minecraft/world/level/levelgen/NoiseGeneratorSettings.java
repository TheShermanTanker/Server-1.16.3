...
public final class NoiseGeneratorSettings {
    ...
    private static NoiseGeneratorSettings nether(final StructureSettings chs, final BlockState cee2, final BlockState cee3, final ResourceLocation vk) {
        final Map<StructureFeature<?>, StructureFeatureConfiguration> map5 = Maps.newHashMap((java.util.Map<?, ?>)StructureSettings.DEFAULTS);
    ...
    static {
        DIRECT_CODEC = RecordCodecBuilder.<NoiseGeneratorSettings>create((java.util.function.Function<RecordCodecBuilder.Instance<NoiseGeneratorSettings>, ? extends App<RecordCodecBuilder.Mu<NoiseGeneratorSettings>, NoiseGeneratorSettings>>)(instance -> instance.<StructureSettings, NoiseSettings, BlockState, BlockState, Integer, Integer, Integer, Boolean>group(StructureSettings.CODEC.fieldOf("structures").forGetter((java.util.function.Function<Object, StructureSettings>)NoiseGeneratorSettings::structureSettings), NoiseSettings.CODEC.fieldOf("noise").forGetter((java.util.function.Function<Object, NoiseSettings>)NoiseGeneratorSettings::noiseSettings), BlockState.CODEC.fieldOf("default_block").forGetter((java.util.function.Function<Object, BlockState>)NoiseGeneratorSettings::getDefaultBlock), BlockState.CODEC.fieldOf("default_fluid").forGetter((java.util.function.Function<Object, BlockState>)NoiseGeneratorSettings::getDefaultFluid), Codec.intRange(-20, 276).fieldOf("bedrock_roof_position").forGetter((java.util.function.Function<Object, Integer>)NoiseGeneratorSettings::getBedrockRoofPosition), Codec.intRange(-20, 276).fieldOf("bedrock_floor_position").forGetter((java.util.function.Function<Object, Integer>)NoiseGeneratorSettings::getBedrockFloorPosition), Codec.intRange(0, 255).fieldOf("sea_level").forGetter((java.util.function.Function<Object, Integer>)NoiseGeneratorSettings::seaLevel), Codec.BOOL.fieldOf("disable_mob_generation").forGetter((java.util.function.Function<Object, Object>)NoiseGeneratorSettings::disableMobGeneration)).<NoiseGeneratorSettings>apply(instance, NoiseGeneratorSettings::new)));
        CODEC = RegistryFileCodec.<NoiseGeneratorSettings>create(Registry.NOISE_GENERATOR_SETTINGS_REGISTRY, NoiseGeneratorSettings.DIRECT_CODEC);
