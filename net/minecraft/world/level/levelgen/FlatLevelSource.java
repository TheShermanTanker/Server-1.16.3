...
public class FlatLevelSource extends ChunkGenerator {
    ...
    static {
        CODEC = FlatLevelGeneratorSettings.CODEC.fieldOf("settings").<FlatLevelSource>xmap((java.util.function.Function<? super FlatLevelGeneratorSettings, ? extends FlatLevelSource>)FlatLevelSource::new, (java.util.function.Function<? super FlatLevelSource, ? extends FlatLevelGeneratorSettings>)FlatLevelSource::settings).codec();
    }
}
