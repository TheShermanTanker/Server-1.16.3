...
public class AcaciaFoliagePlacer extends FoliagePlacer {
    ...
    static {
        CODEC = RecordCodecBuilder.<AcaciaFoliagePlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<AcaciaFoliagePlacer>, ? extends App<RecordCodecBuilder.Mu<AcaciaFoliagePlacer>, AcaciaFoliagePlacer>>)(instance -> FoliagePlacer.<FoliagePlacer>foliagePlacerParts((RecordCodecBuilder.Instance<FoliagePlacer>)instance).apply(instance, (java.util.function.BiFunction<UniformInt, UniformInt, Object>)AcaciaFoliagePlacer::new)));
    }
}
