...
public class SpruceFoliagePlacer extends FoliagePlacer {
    ...
    static {
        CODEC = RecordCodecBuilder.<SpruceFoliagePlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<SpruceFoliagePlacer>, ? extends App<RecordCodecBuilder.Mu<SpruceFoliagePlacer>, SpruceFoliagePlacer>>)(instance -> FoliagePlacer.<FoliagePlacer>foliagePlacerParts((RecordCodecBuilder.Instance<FoliagePlacer>)instance).<UniformInt>and(UniformInt.codec(0, 16, 8).fieldOf("trunk_height").forGetter((java.util.function.Function<Object, UniformInt>)(cnn -> cnn.trunkHeight))).<SpruceFoliagePlacer>apply(instance, SpruceFoliagePlacer::new)));
    }
}
