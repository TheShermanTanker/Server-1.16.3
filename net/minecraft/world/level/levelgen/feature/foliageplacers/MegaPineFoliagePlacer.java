...
public class MegaPineFoliagePlacer extends FoliagePlacer {
    ...
    static {
        CODEC = RecordCodecBuilder.<MegaPineFoliagePlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<MegaPineFoliagePlacer>, ? extends App<RecordCodecBuilder.Mu<MegaPineFoliagePlacer>, MegaPineFoliagePlacer>>)(instance -> FoliagePlacer.<FoliagePlacer>foliagePlacerParts((RecordCodecBuilder.Instance<FoliagePlacer>)instance).<UniformInt>and(UniformInt.codec(0, 16, 8).fieldOf("crown_height").forGetter((java.util.function.Function<Object, UniformInt>)(cnl -> cnl.crownHeight))).<MegaPineFoliagePlacer>apply(instance, MegaPineFoliagePlacer::new)));
    }
}
