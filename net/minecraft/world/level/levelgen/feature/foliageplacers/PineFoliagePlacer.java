...
public class PineFoliagePlacer extends FoliagePlacer {
    ...
    static {
        CODEC = RecordCodecBuilder.<PineFoliagePlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<PineFoliagePlacer>, ? extends App<RecordCodecBuilder.Mu<PineFoliagePlacer>, PineFoliagePlacer>>)(instance -> FoliagePlacer.<FoliagePlacer>foliagePlacerParts((RecordCodecBuilder.Instance<FoliagePlacer>)instance).<UniformInt>and(UniformInt.codec(0, 16, 8).fieldOf("height").forGetter((java.util.function.Function<Object, UniformInt>)(cnm -> cnm.height))).<PineFoliagePlacer>apply(instance, PineFoliagePlacer::new)));
    }
}
