...
public class MegaJungleFoliagePlacer extends FoliagePlacer {
    ...
    static {
        CODEC = RecordCodecBuilder.<MegaJungleFoliagePlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<MegaJungleFoliagePlacer>, ? extends App<RecordCodecBuilder.Mu<MegaJungleFoliagePlacer>, MegaJungleFoliagePlacer>>)(instance -> FoliagePlacer.<FoliagePlacer>foliagePlacerParts((RecordCodecBuilder.Instance<FoliagePlacer>)instance).<Integer>and(Codec.intRange(0, 16).fieldOf("height").forGetter((java.util.function.Function<Object, Integer>)(cnk -> cnk.height))).<MegaJungleFoliagePlacer>apply(instance, MegaJungleFoliagePlacer::new)));
    }
}
