...
public class FancyFoliagePlacer extends BlobFoliagePlacer {
    ...
    static {
        CODEC = RecordCodecBuilder.<FancyFoliagePlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<FancyFoliagePlacer>, ? extends App<RecordCodecBuilder.Mu<FancyFoliagePlacer>, FancyFoliagePlacer>>)(instance -> BlobFoliagePlacer.<BlobFoliagePlacer>blobParts((RecordCodecBuilder.Instance<BlobFoliagePlacer>)instance).<FancyFoliagePlacer>apply(instance, FancyFoliagePlacer::new)));
    }
}
