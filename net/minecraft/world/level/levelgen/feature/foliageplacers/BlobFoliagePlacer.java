...
public class BlobFoliagePlacer extends FoliagePlacer {
    ...
    protected static <P extends BlobFoliagePlacer> Products.P3<RecordCodecBuilder.Mu<P>, UniformInt, UniformInt, Integer> blobParts(final RecordCodecBuilder.Instance<P> instance) {
        return FoliagePlacer.<P>foliagePlacerParts(instance).<Integer>and(Codec.intRange(0, 16).fieldOf("height").forGetter((java.util.function.Function<Object, Integer>)(cne -> cne.height)));
    }
    ...
    static {
        CODEC = RecordCodecBuilder.<BlobFoliagePlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<BlobFoliagePlacer>, ? extends App<RecordCodecBuilder.Mu<BlobFoliagePlacer>, BlobFoliagePlacer>>)(instance -> BlobFoliagePlacer.<BlobFoliagePlacer>blobParts((RecordCodecBuilder.Instance<BlobFoliagePlacer>)instance).<BlobFoliagePlacer>apply(instance, BlobFoliagePlacer::new)));
    }
}
