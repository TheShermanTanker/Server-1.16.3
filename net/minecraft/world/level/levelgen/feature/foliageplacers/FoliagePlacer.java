...
public abstract class FoliagePlacer {
    ...
    protected static <P extends FoliagePlacer> Products.P2<RecordCodecBuilder.Mu<P>, UniformInt, UniformInt> foliagePlacerParts(final RecordCodecBuilder.Instance<P> instance) {
        return instance.<UniformInt, UniformInt>group(UniformInt.codec(0, 8, 8).fieldOf("radius").forGetter((java.util.function.Function<Object, UniformInt>)(cni -> cni.radius)), UniformInt.codec(0, 8, 8).fieldOf("offset").forGetter((java.util.function.Function<Object, UniformInt>)(cni -> cni.offset)));
    }
    ...
    static {
        CODEC = Registry.FOLIAGE_PLACER_TYPES.<FoliagePlacer>dispatch((java.util.function.Function<? super FoliagePlacer, ?>)FoliagePlacer::type, (java.util.function.Function<? super Object, ? extends Codec<? extends FoliagePlacer>>)FoliagePlacerType::codec);
    }
