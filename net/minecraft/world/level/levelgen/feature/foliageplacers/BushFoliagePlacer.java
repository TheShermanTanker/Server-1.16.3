...
public class BushFoliagePlacer extends BlobFoliagePlacer {
    ...
    static {
        CODEC = RecordCodecBuilder.<BushFoliagePlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<BushFoliagePlacer>, ? extends App<RecordCodecBuilder.Mu<BushFoliagePlacer>, BushFoliagePlacer>>)(instance -> BlobFoliagePlacer.<BlobFoliagePlacer>blobParts((RecordCodecBuilder.Instance<BlobFoliagePlacer>)instance).<BushFoliagePlacer>apply(instance, BushFoliagePlacer::new)));
    }
}
