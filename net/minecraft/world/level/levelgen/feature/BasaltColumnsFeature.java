...
public class BasaltColumnsFeature extends Feature<ColumnFeatureConfiguration> {
    ...
    static {
        CANNOT_PLACE_ON = ImmutableList.<Block>of(Blocks.LAVA, Blocks.BEDROCK, Blocks.MAGMA_BLOCK, Blocks.SOUL_SAND, Blocks.NETHER_BRICKS, Blocks.NETHER_BRICK_FENCE, Blocks.NETHER_BRICK_STAIRS, Blocks.NETHER_WART, Blocks.CHEST, Blocks.SPAWNER);
    }
}
