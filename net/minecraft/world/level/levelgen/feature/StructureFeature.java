...
public abstract class StructureFeature<C extends FeatureConfiguration> {
    ...
    public StructureFeature(final Codec<C> codec) {
        this.configuredStructureCodec = codec.fieldOf("config").<ConfiguredStructureFeature<C, StructureFeature<C>>>xmap((java.util.function.Function<? super C, ? extends ConfiguredStructureFeature<C, StructureFeature<C>>>)(clx -> new ConfiguredStructureFeature((F)this, (FC)clx)), (java.util.function.Function<? super ConfiguredStructureFeature<C, StructureFeature<C>>, ? extends C>)(cit -> cit.config)).codec();
    }
    ...
    static {
        STRUCTURES_REGISTRY = HashBiMap.create();
