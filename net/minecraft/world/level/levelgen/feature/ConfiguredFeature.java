...
public class ConfiguredFeature<FC extends FeatureConfiguration, F extends Feature<FC>> implements Decoratable<ConfiguredFeature<?, ?>> {
    ...
    static {
        DIRECT_CODEC = Registry.FEATURE.<ConfiguredFeature<?, ?>>dispatch((java.util.function.Function<? super ConfiguredFeature<?, ?>, ?>)(cis -> cis.feature), (java.util.function.Function<? super Object, ? extends Codec<? extends ConfiguredFeature<?, ?>>>)Feature::configuredCodec);
        CODEC = RegistryFileCodec.<ConfiguredFeature<?, ?>>create(Registry.CONFIGURED_FEATURE_REGISTRY, ConfiguredFeature.DIRECT_CODEC);
