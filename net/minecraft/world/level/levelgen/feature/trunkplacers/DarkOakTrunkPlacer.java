...
public class DarkOakTrunkPlacer extends TrunkPlacer {
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(final LevelSimulatedRW bry, final Random random, final int integer, final BlockPos fx, final Set<BlockPos> set, final BoundingBox cqx, final TreeConfiguration cmw) {
        final List<FoliagePlacer.FoliageAttachment> list9 = Lists.newArrayList();
    ...
    static {
        CODEC = RecordCodecBuilder.<DarkOakTrunkPlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<DarkOakTrunkPlacer>, ? extends App<RecordCodecBuilder.Mu<DarkOakTrunkPlacer>, DarkOakTrunkPlacer>>)(instance -> TrunkPlacer.<TrunkPlacer>trunkPlacerParts((RecordCodecBuilder.Instance<TrunkPlacer>)instance).<DarkOakTrunkPlacer>apply(instance, DarkOakTrunkPlacer::new)));
    }
}
