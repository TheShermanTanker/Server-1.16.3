...
public class GiantTrunkPlacer extends TrunkPlacer {
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(final LevelSimulatedRW bry, final Random random, final int integer, final BlockPos fx, final Set<BlockPos> set, final BoundingBox cqx, final TreeConfiguration cmw) {
        ...
        return ImmutableList.of(new FoliagePlacer.FoliageAttachment(fx.above(integer), 0, true));
    }
    ...
    static {
        CODEC = RecordCodecBuilder.<GiantTrunkPlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<GiantTrunkPlacer>, ? extends App<RecordCodecBuilder.Mu<GiantTrunkPlacer>, GiantTrunkPlacer>>)(instance -> TrunkPlacer.<TrunkPlacer>trunkPlacerParts((RecordCodecBuilder.Instance<TrunkPlacer>)instance).<GiantTrunkPlacer>apply(instance, GiantTrunkPlacer::new)));
    }
}
