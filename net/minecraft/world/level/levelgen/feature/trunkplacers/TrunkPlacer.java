...
public abstract class TrunkPlacer {
    ...
    protected static <P extends TrunkPlacer> Products.P3<RecordCodecBuilder.Mu<P>, Integer, Integer, Integer> trunkPlacerParts(final RecordCodecBuilder.Instance<P> instance) {
        return instance.<Integer, Integer, Integer>group(Codec.intRange(0, 32).fieldOf("base_height").forGetter((java.util.function.Function<Object, Integer>)(coy -> coy.baseHeight)), Codec.intRange(0, 24).fieldOf("height_rand_a").forGetter((java.util.function.Function<Object, Integer>)(coy -> coy.heightRandA)), Codec.intRange(0, 24).fieldOf("height_rand_b").forGetter((java.util.function.Function<Object, Integer>)(coy -> coy.heightRandB)));
    }
    ...
    static {
        CODEC = Registry.TRUNK_PLACER_TYPES.<TrunkPlacer>dispatch((java.util.function.Function<? super TrunkPlacer, ?>)TrunkPlacer::type, (java.util.function.Function<? super Object, ? extends Codec<? extends TrunkPlacer>>)TrunkPlacerType::codec);
    }
}
