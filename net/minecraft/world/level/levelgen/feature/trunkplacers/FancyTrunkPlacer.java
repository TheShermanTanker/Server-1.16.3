...
public class FancyTrunkPlacer extends TrunkPlacer {
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(final LevelSimulatedRW bry, final Random random, final int integer, final BlockPos fx, final Set<BlockPos> set, final BoundingBox cqx, final TreeConfiguration cmw) {
        ...
        final List<FoliageCoords> list17 = Lists.newArrayList();
        ...
        final List<FoliagePlacer.FoliageAttachment> list18 = Lists.newArrayList();
    ...
    static {
        CODEC = RecordCodecBuilder.<FancyTrunkPlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<FancyTrunkPlacer>, ? extends App<RecordCodecBuilder.Mu<FancyTrunkPlacer>, FancyTrunkPlacer>>)(instance -> TrunkPlacer.<TrunkPlacer>trunkPlacerParts((RecordCodecBuilder.Instance<TrunkPlacer>)instance).<FancyTrunkPlacer>apply(instance, FancyTrunkPlacer::new)));
    }
