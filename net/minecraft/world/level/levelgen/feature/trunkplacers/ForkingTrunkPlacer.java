...
public class ForkingTrunkPlacer extends TrunkPlacer {
    ...
    static {
        CODEC = RecordCodecBuilder.<ForkingTrunkPlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<ForkingTrunkPlacer>, ? extends App<RecordCodecBuilder.Mu<ForkingTrunkPlacer>, ForkingTrunkPlacer>>)(instance -> TrunkPlacer.<TrunkPlacer>trunkPlacerParts((RecordCodecBuilder.Instance<TrunkPlacer>)instance).<ForkingTrunkPlacer>apply(instance, ForkingTrunkPlacer::new)));
    }
}
