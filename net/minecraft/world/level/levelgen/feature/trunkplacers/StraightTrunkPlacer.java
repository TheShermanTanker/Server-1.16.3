...
public class StraightTrunkPlacer extends TrunkPlacer {
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(final LevelSimulatedRW bry, final Random random, final int integer, final BlockPos fx, final Set<BlockPos> set, final BoundingBox cqx, final TreeConfiguration cmw) {
        ...
        return ImmutableList.of(new FoliagePlacer.FoliageAttachment(fx.above(integer), 0, false));
    }
    
    static {
        CODEC = RecordCodecBuilder.<StraightTrunkPlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<StraightTrunkPlacer>, ? extends App<RecordCodecBuilder.Mu<StraightTrunkPlacer>, StraightTrunkPlacer>>)(instance -> TrunkPlacer.<TrunkPlacer>trunkPlacerParts((RecordCodecBuilder.Instance<TrunkPlacer>)instance).<StraightTrunkPlacer>apply(instance, StraightTrunkPlacer::new)));
    }
}
