...
public class MegaJungleTrunkPlacer extends GiantTrunkPlacer {
    ...
    static {
        CODEC = RecordCodecBuilder.<MegaJungleTrunkPlacer>create((java.util.function.Function<RecordCodecBuilder.Instance<MegaJungleTrunkPlacer>, ? extends App<RecordCodecBuilder.Mu<MegaJungleTrunkPlacer>, MegaJungleTrunkPlacer>>)(instance -> TrunkPlacer.<TrunkPlacer>trunkPlacerParts((RecordCodecBuilder.Instance<TrunkPlacer>)instance).<MegaJungleTrunkPlacer>apply(instance, MegaJungleTrunkPlacer::new)));
    }
}
