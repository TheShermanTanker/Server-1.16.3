...
public class ConfiguredStructureFeature<FC extends FeatureConfiguration, F extends StructureFeature<FC>> {
    ...
    static {
        DIRECT_CODEC = Registry.STRUCTURE_FEATURE.<ConfiguredStructureFeature<?, ?>>dispatch((java.util.function.Function<? super ConfiguredStructureFeature<?, ?>, ?>)(cit -> cit.feature), (java.util.function.Function<? super Object, ? extends Codec<? extends ConfiguredStructureFeature<?, ?>>>)StructureFeature::configuredStructureCodec);
        CODEC = RegistryFileCodec.<ConfiguredStructureFeature<?, ?>>create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, ConfiguredStructureFeature.DIRECT_CODEC);
