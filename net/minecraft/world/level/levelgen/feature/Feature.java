...
public abstract class Feature<FC extends FeatureConfiguration> {
    ...
    public Feature(final Codec<FC> codec) {
        this.configuredCodec = codec.fieldOf("config").<ConfiguredFeature<FC, Feature<FC>>>xmap((java.util.function.Function<? super FC, ? extends ConfiguredFeature<FC, Feature<FC>>>)(clx -> new ConfiguredFeature((F)this, (FC)clx)), (java.util.function.Function<? super ConfiguredFeature<FC, Feature<FC>>, ? extends FC>)(cis -> cis.config)).codec();
    }
