...
public class SpikeFeature extends Feature<SpikeConfiguration> {
    ...
    public static List<EndSpike> getSpikesForLevel(final WorldGenLevel bso) {
        ...
        return SpikeFeature.SPIKE_CACHE.getUnchecked(long3);
    }
    ...
    static {
        SPIKE_CACHE = CacheBuilder.newBuilder().expireAfterWrite(5L, TimeUnit.MINUTES).<Long, List<EndSpike>>build(new SpikeCacheLoader());
    }
    ...
    public static class EndSpike {
        ...
        static {
            CODEC = RecordCodecBuilder.<EndSpike>create((java.util.function.Function<RecordCodecBuilder.Instance<EndSpike>, ? extends App<RecordCodecBuilder.Mu<EndSpike>, EndSpike>>)(instance -> instance.<Integer, Integer, Integer, Integer, Boolean>group(Codec.INT.fieldOf("centerX").orElse(0).forGetter((java.util.function.Function<Object, Integer>)(a -> a.centerX)), Codec.INT.fieldOf("centerZ").orElse(0).forGetter((java.util.function.Function<Object, Integer>)(a -> a.centerZ)), Codec.INT.fieldOf("radius").orElse(0).forGetter((java.util.function.Function<Object, Integer>)(a -> a.radius)), Codec.INT.fieldOf("height").orElse(0).forGetter((java.util.function.Function<Object, Integer>)(a -> a.height)), Codec.BOOL.fieldOf("guarded").orElse(false).forGetter((java.util.function.Function<Object, Boolean>)(a -> a.guarded))).<EndSpike>apply(instance, EndSpike::new)));
        }
    }
    ...
    static class SpikeCacheLoader extends CacheLoader<Long, List<EndSpike>> {
        ...
        public List<EndSpike> load(final Long long1) {
            ...
            final List<EndSpike> list4 = Lists.newArrayList();
