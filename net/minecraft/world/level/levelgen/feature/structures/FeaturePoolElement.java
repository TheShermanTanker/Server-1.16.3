...
public class FeaturePoolElement extends StructurePoolElement {
    ...
    public List<StructureTemplate.StructureBlockInfo> getShuffledJigsawBlocks(final StructureManager cst, final BlockPos fx, final Rotation bzj, final Random random) {
        final List<StructureTemplate.StructureBlockInfo> list6 = Lists.newArrayList();
    ...
    static {
        CODEC = RecordCodecBuilder.<FeaturePoolElement>create((java.util.function.Function<RecordCodecBuilder.Instance<FeaturePoolElement>, ? extends App<RecordCodecBuilder.Mu<FeaturePoolElement>, FeaturePoolElement>>)(instance -> instance.<Supplier<ConfiguredFeature<?, ?>>, StructureTemplatePool.Projection>group(ConfiguredFeature.CODEC.fieldOf("feature").forGetter((java.util.function.Function<Object, Supplier<ConfiguredFeature<?, ?>>>)(cnz -> cnz.feature)), StructurePoolElement.projectionCodec()).apply(instance, (java.util.function.BiFunction<Supplier<ConfiguredFeature<?, ?>>, StructureTemplatePool.Projection, Object>)FeaturePoolElement::new)));
    }
}
