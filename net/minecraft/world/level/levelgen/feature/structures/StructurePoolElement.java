...
public abstract class StructurePoolElement {
    ...
    protected static <E extends StructurePoolElement> RecordCodecBuilder<E, StructureTemplatePool.Projection> projectionCodec() {
        return StructureTemplatePool.Projection.CODEC.fieldOf("projection").<E>forGetter((java.util.function.Function<E, StructureTemplatePool.Projection>)StructurePoolElement::getProjection);
    }
    ...
    public static Function<StructureTemplatePool.Projection, LegacySinglePoolElement> legacy(final String string) {
        return (Function<StructureTemplatePool.Projection, LegacySinglePoolElement>)(a -> new LegacySinglePoolElement(Either.<ResourceLocation, StructureTemplate>left(new ResourceLocation(string)), (Supplier<StructureProcessorList>)(() -> ProcessorLists.EMPTY), a));
    }
    ...
    public static Function<StructureTemplatePool.Projection, LegacySinglePoolElement> legacy(final String string, final StructureProcessorList csw) {
        return (Function<StructureTemplatePool.Projection, LegacySinglePoolElement>)(a -> new LegacySinglePoolElement(Either.<ResourceLocation, StructureTemplate>left(new ResourceLocation(string)), (Supplier<StructureProcessorList>)(() -> csw), a));
    }
    
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(final String string) {
        return (Function<StructureTemplatePool.Projection, SinglePoolElement>)(a -> new SinglePoolElement(Either.<ResourceLocation, StructureTemplate>left(new ResourceLocation(string)), (Supplier<StructureProcessorList>)(() -> ProcessorLists.EMPTY), a));
    }
    ...
    public static Function<StructureTemplatePool.Projection, SinglePoolElement> single(final String string, final StructureProcessorList csw) {
        return (Function<StructureTemplatePool.Projection, SinglePoolElement>)(a -> new SinglePoolElement(Either.<ResourceLocation, StructureTemplate>left(new ResourceLocation(string)), (Supplier<StructureProcessorList>)(() -> csw), a));
    }
    ...
    static {
        CODEC = Registry.STRUCTURE_POOL_ELEMENT.<StructurePoolElement>dispatch("element_type", (java.util.function.Function<? super StructurePoolElement, ?>)StructurePoolElement::getType, (java.util.function.Function<? super Object, ? extends Codec<? extends StructurePoolElement>>)StructurePoolElementType::codec);
    }
}
