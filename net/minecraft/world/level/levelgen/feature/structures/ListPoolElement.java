...
public class ListPoolElement extends StructurePoolElement {
    ...
    static {
        CODEC = RecordCodecBuilder.<ListPoolElement>create((java.util.function.Function<RecordCodecBuilder.Instance<ListPoolElement>, ? extends App<RecordCodecBuilder.Mu<ListPoolElement>, ListPoolElement>>)(instance -> instance.<java.util.List<StructurePoolElement>, StructureTemplatePool.Projection>group(StructurePoolElement.CODEC.listOf().fieldOf("elements").forGetter((java.util.function.Function<Object, java.util.List<StructurePoolElement>>)(cod -> cod.elements)), StructurePoolElement.projectionCodec()).apply(instance, (java.util.function.BiFunction<java.util.List<StructurePoolElement>, StructureTemplatePool.Projection, Object>)ListPoolElement::new)));
    }
}
