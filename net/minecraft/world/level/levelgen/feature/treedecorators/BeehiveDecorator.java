...
public class BeehiveDecorator extends TreeDecorator {
    ...
    static {
        CODEC = Codec.floatRange(0.0f, 1.0f).fieldOf("probability").<BeehiveDecorator>xmap((java.util.function.Function<? super Float, ? extends BeehiveDecorator>)BeehiveDecorator::new, (java.util.function.Function<? super BeehiveDecorator, ? extends Float>)(cok -> cok.probability)).codec();
    }
}
