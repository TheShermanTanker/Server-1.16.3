...
public class AlterGroundDecorator extends TreeDecorator {
    ...
    static {
        CODEC = BlockStateProvider.CODEC.fieldOf("provider").<AlterGroundDecorator>xmap((java.util.function.Function<? super BlockStateProvider, ? extends AlterGroundDecorator>)AlterGroundDecorator::new, (java.util.function.Function<? super AlterGroundDecorator, ? extends BlockStateProvider>)(coj -> coj.provider)).codec();
    }
}
