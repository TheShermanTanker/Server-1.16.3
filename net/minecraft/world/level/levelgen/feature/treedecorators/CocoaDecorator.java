...
public class CocoaDecorator extends TreeDecorator {
    ...
    static {
        CODEC = Codec.floatRange(0.0f, 1.0f).fieldOf("probability").<CocoaDecorator>xmap((java.util.function.Function<? super Float, ? extends CocoaDecorator>)CocoaDecorator::new, (java.util.function.Function<? super CocoaDecorator, ? extends Float>)(col -> col.probability)).codec();
    }
}
