...
public class SwamplandHutFeature extends StructureFeature<NoneFeatureConfiguration> {
    ...
    static {
        SWAMPHUT_ENEMIES = (List)ImmutableList.<MobSpawnSettings.SpawnerData>of(new MobSpawnSettings.SpawnerData(EntityType.WITCH, 1, 1, 1));
        SWAMPHUT_ANIMALS = (List)ImmutableList.<MobSpawnSettings.SpawnerData>of(new MobSpawnSettings.SpawnerData(EntityType.CAT, 1, 1, 1));
    }
