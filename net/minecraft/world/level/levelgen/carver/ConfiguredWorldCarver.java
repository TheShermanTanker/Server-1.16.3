...
public class ConfiguredWorldCarver<WC extends CarverConfiguration> {
    ...
    static {
        DIRECT_CODEC = Registry.CARVER.<ConfiguredWorldCarver<?>>dispatch((java.util.function.Function<? super ConfiguredWorldCarver<?>, ?>)(chy -> chy.worldCarver), (java.util.function.Function<? super Object, ? extends Codec<? extends ConfiguredWorldCarver<?>>>)WorldCarver::configuredCodec);
        CODEC = RegistryFileCodec.<ConfiguredWorldCarver<?>>create(Registry.CONFIGURED_CARVER_REGISTRY, ConfiguredWorldCarver.DIRECT_CODEC);
