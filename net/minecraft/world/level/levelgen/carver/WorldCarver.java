...
public abstract class WorldCarver<C extends CarverConfiguration> {
    ...
    public WorldCarver(final Codec<C> codec, final int integer) {
        ...
        this.configuredCodec = codec.fieldOf("config").<ConfiguredWorldCarver<C>>xmap((java.util.function.Function<? super C, ? extends ConfiguredWorldCarver<C>>)this::configured, (java.util.function.Function<? super ConfiguredWorldCarver<C>, ? extends C>)ConfiguredWorldCarver::config).codec();
    }
