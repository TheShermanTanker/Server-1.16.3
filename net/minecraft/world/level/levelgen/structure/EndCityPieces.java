...
public class EndCityPieces {
    ...
    private static EndCityPiece addPiece(final StructureManager cst, final EndCityPiece a, final BlockPos fx, final String string, final Rotation bzj, final boolean boolean6) {
        ...
        //     5: aload_3         /* string */
        //     6: aload_1         /* a */
        //     7: getfield        net/minecraft/world/level/levelgen/structure/EndCityPieces$EndCityPiece.templatePosition:Lnet/minecraft/core/BlockPos;
        //    10: aload           bzj
        //    12: iload           boolean6
        //    14: invokespecial   net/minecraft/world/level/levelgen/structure/EndCityPieces$EndCityPiece.<init>:(Lnet/minecraft/world/level/levelgen/structure/templatesystem/StructureManager;Ljava/lang/String;Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/level/block/Rotation;Z)V
        //    17: astore          a7
        //    19: aload_1         /* a */
        //    20: getfield        net/minecraft/world/level/levelgen/structure/EndCityPieces$EndCityPiece.template:Lnet/minecraft/world/level/levelgen/structure/templatesystem/StructureTemplate;
        //    23: aload_1         /* a */
        //    24: getfield        net/minecraft/world/level/levelgen/structure/EndCityPieces$EndCityPiece.placeSettings:Lnet/minecraft/world/level/levelgen/structure/templatesystem/StructurePlaceSettings;
        //    27: aload_2         /* fx */
        //    28: aload           a7
        //    30: getfield        net/minecraft/world/level/levelgen/structure/EndCityPieces$EndCityPiece.placeSettings:Lnet/minecraft/world/level/levelgen/structure/templatesystem/StructurePlaceSettings;
        //    33: getstatic       net/minecraft/core/BlockPos.ZERO:Lnet/minecraft/core/BlockPos;
        //    36: invokevirtual   net/minecraft/world/level/levelgen/structure/templatesystem/StructureTemplate.calculateConnectedPosition:(Lnet/minecraft/world/level/levelgen/structure/templatesystem/StructurePlaceSettings;Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/level/levelgen/structure/templatesystem/StructurePlaceSettings;Lnet/minecraft/core/BlockPos;)Lnet/minecraft/core/BlockPos;
        //    39: astore          fx8
        //    41: aload           a7
        //    43: aload           fx8
        //    45: invokevirtual   net/minecraft/core/BlockPos.getX:()I
        //    48: aload           fx8
        //    50: invokevirtual   net/minecraft/core/BlockPos.getY:()I
        //    53: aload           fx8
        //    55: invokevirtual   net/minecraft/core/BlockPos.getZ:()I
        //    58: invokevirtual   net/minecraft/world/level/levelgen/structure/EndCityPieces$EndCityPiece.move:(III)V
        //    61: aload           a7
        //    63: areturn        
        //    MethodParameters:
        //  Name      Flags  
    ...
    private static boolean recursiveChildren(final StructureManager cst, final SectionGenerator b, final int integer, final EndCityPiece a, final BlockPos fx, final List<StructurePiece> list, final Random random) {
        ...
        final List<StructurePiece> list2 = Lists.newArrayList();
    ...
    static {
        ...
        TOWER_BRIDGES = (List)Lists.<Tuple>newArrayList(new Tuple((A)Rotation.NONE, (B)new BlockPos(1, -1, 0)), new Tuple((A)Rotation.CLOCKWISE_90, (B)new BlockPos(6, -1, 1)), new Tuple((A)Rotation.COUNTERCLOCKWISE_90, (B)new BlockPos(0, -1, 5)), new Tuple((A)Rotation.CLOCKWISE_180, (B)new BlockPos(5, -1, 6)));
        ...
        FAT_TOWER_BRIDGES = (List)Lists.<Tuple>newArrayList(new Tuple((A)Rotation.NONE, (B)new BlockPos(4, -1, 0)), new Tuple((A)Rotation.CLOCKWISE_90, (B)new BlockPos(12, -1, 4)), new Tuple((A)Rotation.COUNTERCLOCKWISE_90, (B)new BlockPos(0, -1, 8)), new Tuple((A)Rotation.CLOCKWISE_180, (B)new BlockPos(8, -1, 12)));
