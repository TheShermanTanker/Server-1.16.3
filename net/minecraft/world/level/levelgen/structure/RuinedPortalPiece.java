...
public class RuinedPortalPiece extends TemplateStructurePiece {
    ...
    public RuinedPortalPiece(final StructureManager cst, final CompoundTag md) {
        ...
        this.properties = Properties.CODEC.<Tag>parse(new Dynamic<Tag>(NbtOps.INSTANCE, md.get("Properties"))).getOrThrow(true, (Consumer<String>)RuinedPortalPiece.LOGGER::error);
    ...
    protected void addAdditionalSaveData(final CompoundTag md) {
        ...
        Properties.CODEC.encodeStart((DynamicOps<Object>)NbtOps.INSTANCE, this.properties).resultOrPartial((Consumer<String>)RuinedPortalPiece.LOGGER::error).ifPresent(mt -> md.put("Properties", mt));
    }
    ...
    private void loadTemplate(final StructureTemplate csy, final BlockPos fx) {
        ...
        final List<ProcessorRule> list5 = Lists.newArrayList();
    ...
    public static class Properties {
        ...
        static {
            CODEC = RecordCodecBuilder.<Properties>create((java.util.function.Function<RecordCodecBuilder.Instance<Properties>, ? extends App<RecordCodecBuilder.Mu<Properties>, Properties>>)(instance -> instance.<Boolean, Float, Boolean, Boolean, Boolean, Boolean>group(Codec.BOOL.fieldOf("cold").forGetter((java.util.function.Function<Object, Object>)(a -> a.cold)), Codec.FLOAT.fieldOf("mossiness").forGetter((java.util.function.Function<Object, Object>)(a -> a.mossiness)), Codec.BOOL.fieldOf("air_pocket").forGetter((java.util.function.Function<Object, Object>)(a -> a.airPocket)), Codec.BOOL.fieldOf("overgrown").forGetter((java.util.function.Function<Object, Object>)(a -> a.overgrown)), Codec.BOOL.fieldOf("vines").forGetter((java.util.function.Function<Object, Object>)(a -> a.vines)), Codec.BOOL.fieldOf("replace_with_blackstone").forGetter((java.util.function.Function<Object, Object>)(a -> a.replaceWithBlackstone))).<Properties>apply(instance, Properties::new)));
        }
    }
