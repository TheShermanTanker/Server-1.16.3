...
public class BlockAgeProcessor extends StructureProcessor {
    ...
    static {
        CODEC = Codec.FLOAT.fieldOf("mossiness").<BlockAgeProcessor>xmap((java.util.function.Function<? super Object, ? extends BlockAgeProcessor>)BlockAgeProcessor::new, (java.util.function.Function<? super BlockAgeProcessor, ?>)(csa -> csa.mossiness)).codec();
    }
}
