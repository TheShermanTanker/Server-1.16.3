...
public class BlockRotProcessor extends StructureProcessor {
    ...
    static {
        CODEC = Codec.FLOAT.fieldOf("integrity").orElse(1.0f).<BlockRotProcessor>xmap((java.util.function.Function<? super Float, ? extends BlockRotProcessor>)BlockRotProcessor::new, (java.util.function.Function<? super BlockRotProcessor, ? extends Float>)(csd -> csd.integrity)).codec();
    }
}
