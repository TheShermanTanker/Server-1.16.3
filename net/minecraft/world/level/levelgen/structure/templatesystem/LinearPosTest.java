...
public class LinearPosTest extends PosRuleTest {
    ...
    static {
        CODEC = RecordCodecBuilder.<LinearPosTest>create((java.util.function.Function<RecordCodecBuilder.Instance<LinearPosTest>, ? extends App<RecordCodecBuilder.Mu<LinearPosTest>, LinearPosTest>>)(instance -> instance.<Float, Float, Integer, Integer>group(Codec.FLOAT.fieldOf("min_chance").orElse(0.0f).forGetter((java.util.function.Function<Object, Float>)(csi -> csi.minChance)), Codec.FLOAT.fieldOf("max_chance").orElse(0.0f).forGetter((java.util.function.Function<Object, Float>)(csi -> csi.maxChance)), Codec.INT.fieldOf("min_dist").orElse(0).forGetter((java.util.function.Function<Object, Integer>)(csi -> csi.minDist)), Codec.INT.fieldOf("max_dist").orElse(0).forGetter((java.util.function.Function<Object, Integer>)(csi -> csi.maxDist))).<LinearPosTest>apply(instance, LinearPosTest::new)));
    }
}
