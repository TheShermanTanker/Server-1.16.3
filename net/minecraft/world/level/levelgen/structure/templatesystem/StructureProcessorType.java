...
public interface StructureProcessorType<P extends StructureProcessor> {
    ...
    public static final Codec<StructureProcessor> SINGLE_CODEC = Registry.STRUCTURE_PROCESSOR.<StructureProcessor>dispatch("processor_type", (java.util.function.Function<? super StructureProcessor, ?>)StructureProcessor::getType, (java.util.function.Function<? super Object, ? extends Codec<? extends StructureProcessor>>)StructureProcessorType::codec);
    public static final Codec<StructureProcessorList> LIST_OBJECT_CODEC = StructureProcessorType.SINGLE_CODEC.listOf().<StructureProcessorList>xmap((java.util.function.Function<? super java.util.List<StructureProcessor>, ? extends StructureProcessorList>)StructureProcessorList::new, (java.util.function.Function<? super StructureProcessorList, ? extends java.util.List<StructureProcessor>>)StructureProcessorList::list);
    public static final Codec<StructureProcessorList> DIRECT_CODEC = Codec.<StructureProcessorList, StructureProcessorList>either(StructureProcessorType.LIST_OBJECT_CODEC.fieldOf("processors").codec(), StructureProcessorType.LIST_OBJECT_CODEC).<StructureProcessorList>xmap((java.util.function.Function<? super Either<StructureProcessorList, StructureProcessorList>, ? extends StructureProcessorList>)(either -> either.<StructureProcessorList>map(csw -> csw, csw -> csw)), (java.util.function.Function<? super StructureProcessorList, ? extends Either<StructureProcessorList, StructureProcessorList>>)Either::left);
