...
public class AxisAlignedLinearPosTest extends PosRuleTest {
    ...
    static {
        CODEC = RecordCodecBuilder.<AxisAlignedLinearPosTest>create((java.util.function.Function<RecordCodecBuilder.Instance<AxisAlignedLinearPosTest>, ? extends App<RecordCodecBuilder.Mu<AxisAlignedLinearPosTest>, AxisAlignedLinearPosTest>>)(instance -> instance.<Float, Float, Integer, Integer, Direction.Axis>group(Codec.FLOAT.fieldOf("min_chance").orElse(0.0f).forGetter((java.util.function.Function<Object, Float>)(cry -> cry.minChance)), Codec.FLOAT.fieldOf("max_chance").orElse(0.0f).forGetter((java.util.function.Function<Object, Float>)(cry -> cry.maxChance)), Codec.INT.fieldOf("min_dist").orElse(0).forGetter((java.util.function.Function<Object, Integer>)(cry -> cry.minDist)), Codec.INT.fieldOf("max_dist").orElse(0).forGetter((java.util.function.Function<Object, Integer>)(cry -> cry.maxDist)), Direction.Axis.CODEC.fieldOf("axis").orElse(Direction.Axis.Y).forGetter((java.util.function.Function<Object, Direction.Axis>)(cry -> cry.axis))).<AxisAlignedLinearPosTest>apply(instance, AxisAlignedLinearPosTest::new)));
    }
}
