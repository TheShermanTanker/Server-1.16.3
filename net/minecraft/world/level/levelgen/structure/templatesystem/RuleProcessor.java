...
public class RuleProcessor extends StructureProcessor {
    ...
    public RuleProcessor(final List<? extends ProcessorRule> list) {
        this.rules = ImmutableList.<ProcessorRule>copyOf((java.util.Collection<? extends ProcessorRule>)list);
    }
    ...
    static {
        CODEC = ProcessorRule.CODEC.listOf().fieldOf("rules").<RuleProcessor>xmap((java.util.function.Function<? super java.util.List<ProcessorRule>, ? extends RuleProcessor>)RuleProcessor::new, (java.util.function.Function<? super RuleProcessor, ? extends java.util.List<ProcessorRule>>)(csq -> csq.rules)).codec();
    }
}
