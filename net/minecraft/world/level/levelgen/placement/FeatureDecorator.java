...
public abstract class FeatureDecorator<DC extends DecoratorConfiguration> {
    ...
    public FeatureDecorator(final Codec<DC> codec) {
        this.configuredCodec = codec.fieldOf("config").<ConfiguredDecorator<DC>>xmap((java.util.function.Function<? super DC, ? extends ConfiguredDecorator<DC>>)(clt -> new ConfiguredDecorator((FeatureDecorator<DC>)this, (DC)clt)), (java.util.function.Function<? super ConfiguredDecorator<DC>, ? extends DC>)ConfiguredDecorator::config).codec();
    }
