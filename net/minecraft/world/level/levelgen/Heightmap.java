...
public class Heightmap {
    ...
    public static void primeHeightmaps(final ChunkAccess cft, final Set<Types> set) {
        ...
        final ObjectList<Heightmap> objectList4 = new ObjectArrayList<Heightmap>(integer3);
        final ObjectListIterator<Heightmap> objectListIterator5 = objectList4.iterator();
