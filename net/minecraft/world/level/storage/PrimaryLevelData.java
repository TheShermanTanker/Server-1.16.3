...
public class PrimaryLevelData implements ServerLevelData, WorldData {
    ...
    public PrimaryLevelData(final LevelSettings brx, final WorldGenSettings cht, final Lifecycle lifecycle) {
        this(null, SharedConstants.getCurrentVersion().getWorldVersion(), null, false, 0, 0, 0, 0.0f, 0L, 0L, 19133, 0, 0, false, 0, false, false, false, WorldBorder.DEFAULT_SETTINGS, 0, 0, null, Sets.<String>newLinkedHashSet(), new TimerQueue<MinecraftServer>(TimerCallbacks.SERVER_CALLBACKS), null, new CompoundTag(), brx.copy(), cht, lifecycle);
    }
    ...
    private void setTagData(final RegistryAccess gn, final CompoundTag md2, @Nullable final CompoundTag md3) {
        ...
        final RegistryWriteOps<Tag> vi7 = RegistryWriteOps.<Tag>create((DynamicOps<Tag>)NbtOps.INSTANCE, gn);
        WorldGenSettings.CODEC.<Tag>encodeStart(vi7, this.worldGenSettings).resultOrPartial(Util.prefix("WorldGenSettings: ", (Consumer<String>)PrimaryLevelData.LOGGER::error)).ifPresent(mt -> md2.put("WorldGenSettings", mt));
        ...
        DataPackConfig.CODEC.encodeStart((DynamicOps<Object>)NbtOps.INSTANCE, this.settings.getDataPackConfig()).result().ifPresent(mt -> md2.put("DataPacks", mt));
    ...
    public Set<String> getKnownServerBrands() {
        return ImmutableSet.copyOf((java.util.Collection<?>)this.knownServerBrands);
    }
