...
public class McRegionUpgrader {
    ...
    static boolean convertLevel(final LevelStorageSource.LevelStorageAccess a, final ProgressListener afk) {
        ...
        final List<File> list4 = Lists.newArrayList();
        ...
        final RegistryReadOps<Tag> vh11 = RegistryReadOps.<Tag>create((DynamicOps<Tag>)NbtOps.INSTANCE, ResourceManager.Empty.INSTANCE, b10);
        final WorldData cyk12 = a.getDataTag(vh11, DataPackConfig.DEFAULT);
