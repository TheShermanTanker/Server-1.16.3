...
public class SetLoreFunction extends LootItemConditionalFunction {
    ...
    public SetLoreFunction(final LootItemCondition[] arr, final boolean boolean2, final List<Component> list, @Nullable final LootContext.EntityTarget c) {
        ...
        this.lore = ImmutableList.copyOf((java.util.Collection<?>)list);
    ...
    public Set<LootContextParam<?>> getReferencedContextParams() {
        return (Set<LootContextParam<?>>)((this.resolutionContext != null) ? ImmutableSet.<LootContextParam<? extends Entity>>of(this.resolutionContext.getParam()) : ImmutableSet.<LootContextParam<? extends Entity>>of());
    }
    ...
    public static class Serializer extends LootItemConditionalFunction.Serializer<SetLoreFunction> {
        ...
        public SetLoreFunction deserialize(final JsonObject jsonObject, final JsonDeserializationContext jsonDeserializationContext, final LootItemCondition[] arr) {
            ...
            final List<Component> list6 = (List<Component>)Streams.stream((java.lang.Iterable<Object>)GsonHelper.getAsJsonArray(jsonObject, "lore")).map(Component.Serializer::fromJson).collect((Collector)ImmutableList.toImmutableList());
