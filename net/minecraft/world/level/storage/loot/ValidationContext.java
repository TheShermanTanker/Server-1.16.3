...
public class ValidationContext {
    ...
    public ValidationContext(final LootContextParamSet dax, final Function<ResourceLocation, LootItemCondition> function2, final Function<ResourceLocation, LootTable> function3) {
        this(HashMultimap.create(), (Supplier<String>)(() -> ""), dax, function2, ImmutableSet.of(), function3, ImmutableSet.of());
    }
    ...
    public ValidationContext enterTable(final String string, final ResourceLocation vk) {
        final ImmutableSet<ResourceLocation> immutableSet4 = ImmutableSet.<ResourceLocation>builder().addAll((java.lang.Iterable<? extends ResourceLocation>)this.visitedTables).add(vk).build();
    ...
    public ValidationContext enterCondition(final String string, final ResourceLocation vk) {
        final ImmutableSet<ResourceLocation> immutableSet4 = ImmutableSet.<ResourceLocation>builder().addAll((java.lang.Iterable<? extends ResourceLocation>)this.visitedConditions).add(vk).build();
