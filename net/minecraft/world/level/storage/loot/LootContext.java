...
public class LootContext {
    ...
    private LootContext(final Random random, final float float2, final ServerLevel aag, final Function<ResourceLocation, LootTable> function4, final Function<ResourceLocation, LootItemCondition> function5, final Map<LootContextParam<?>, Object> map6, final Map<ResourceLocation, DynamicDrop> map7) {
        ...
        this.params = ImmutableMap.copyOf((java.util.Map<?, ?>)map6);
        this.dynamicDrops = ImmutableMap.copyOf((java.util.Map<?, ?>)map7);
    }
    ...
    public static class Builder {
        ...
        public Builder(final ServerLevel aag) {
            this.params = Maps.newIdentityHashMap();
            this.dynamicDrops = Maps.newHashMap();
            this.level = aag;
        }
        ...
        public LootContext create(final LootContextParamSet dax) {
            final Set<LootContextParam<?>> set3 = Sets.difference((java.util.Set<Object>)this.params.keySet(), dax.getAllowed());
            if (!set3.isEmpty()) {
            ...
            final Set<LootContextParam<?>> set4 = Sets.difference(dax.getRequired(), this.params.keySet());
            if (!set4.isEmpty()) {
