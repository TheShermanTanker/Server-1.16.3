...
public class LootTables extends SimpleJsonResourceReloadListener {
    ...
    protected void apply(final Map<ResourceLocation, JsonElement> map, final ResourceManager acf, final ProfilerFiller ant) {
        final ImmutableMap.Builder<ResourceLocation, LootTable> builder5 = ImmutableMap.<ResourceLocation, LootTable>builder();
        ...
        map.forEach((vk, jsonElement) -> {
            try {
                final LootTable cyv4 = LootTables.GSON.<LootTable>fromJson(jsonElement, LootTable.class);
        ...
        final ImmutableMap<ResourceLocation, LootTable> immutableMap7 = builder5.build();
        ...
        czd8.getProblems().forEach((java.util.function.BiConsumer<? super String, ? super String>)((string1, string2) -> LootTables.LOGGER.warn("Found validation problem in " + string1 + ": " + string2)));
