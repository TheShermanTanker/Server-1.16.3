...
public class WalkNodeEvaluator extends NodeEvaluator {
    ...
    public WalkNodeEvaluator() {
        this.pathTypesByPosCache = new Long2ObjectOpenHashMap<BlockPathTypes>();
        this.collisionCache = new Object2BooleanOpenHashMap<AABB>();
    }
    ...
    private BlockPathTypes getCachedBlockType(final Mob aqk, final int integer2, final int integer3, final int integer4) {
        return this.pathTypesByPosCache.computeIfAbsent(BlockPos.asLong(integer2, integer3, integer4), (java.util.function.LongFunction<? extends BlockPathTypes>)(long5 -> this.getBlockPathType(this.level, integer2, integer3, integer4, aqk, this.entityWidth, this.entityHeight, this.entityDepth, this.canOpenDoors(), this.canPassDoors())));
    }
