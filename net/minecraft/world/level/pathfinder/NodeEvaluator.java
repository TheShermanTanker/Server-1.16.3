...
public abstract class NodeEvaluator {
    ...
    public NodeEvaluator() {
        this.nodes = new Int2ObjectOpenHashMap<Node>();
    }
    ...
    protected Node getNode(final int integer1, final int integer2, final int integer3) {
        return this.nodes.computeIfAbsent(Node.createHash(integer1, integer2, integer3), (java.util.function.IntFunction<? extends Node>)(integer4 -> new Node(integer1, integer2, integer3)));
    }
