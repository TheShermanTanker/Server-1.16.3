...
public class RespawnAnchorBlock extends Block {
    ...
    static {
        ...
        RESPAWN_HORIZONTAL_OFFSETS = ImmutableList.<Vec3i>of(new Vec3i(0, 0, -1), new Vec3i(-1, 0, 0), new Vec3i(0, 0, 1), new Vec3i(1, 0, 0), new Vec3i(-1, 0, -1), new Vec3i(1, 0, -1), new Vec3i(-1, 0, 1), new Vec3i(1, 0, 1));
        RESPAWN_OFFSETS = new ImmutableList.Builder<Vec3i>().addAll((java.lang.Iterable<? extends Vec3i>)RespawnAnchorBlock.RESPAWN_HORIZONTAL_OFFSETS).addAll((java.util.Iterator<? extends Vec3i>)RespawnAnchorBlock.RESPAWN_HORIZONTAL_OFFSETS.stream().map(Vec3i::below).iterator()).addAll((java.util.Iterator<? extends Vec3i>)RespawnAnchorBlock.RESPAWN_HORIZONTAL_OFFSETS.stream().map(Vec3i::above).iterator()).add(new Vec3i(0, 1, 0)).build();
    }
}
