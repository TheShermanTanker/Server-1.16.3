...
public class VineBlock extends Block {
    ...
    public VineBlock(final Properties c) {
        ...
        this.shapesCache = ImmutableMap.copyOf((java.util.Map<?, ?>)this.stateDefinition.getPossibleStates().stream().collect(Collectors.toMap(Function.identity(), VineBlock::calculateShape)));
    }
