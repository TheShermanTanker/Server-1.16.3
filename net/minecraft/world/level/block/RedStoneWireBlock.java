...
public class RedStoneWireBlock extends Block {
    ...
    static {
        ...
        PROPERTY_BY_DIRECTION = (Map)Maps.<Enum, Object>newEnumMap((java.util.Map<Enum, ?>)ImmutableMap.<Direction, EnumProperty<RedstoneSide>>of(Direction.NORTH, RedStoneWireBlock.NORTH, Direction.EAST, RedStoneWireBlock.EAST, Direction.SOUTH, RedStoneWireBlock.SOUTH, Direction.WEST, RedStoneWireBlock.WEST));
        SHAPE_DOT = Block.box(3.0, 0.0, 3.0, 13.0, 1.0, 13.0);
        SHAPES_FLOOR = (Map)Maps.<Enum, Object>newEnumMap((java.util.Map<Enum, ?>)ImmutableMap.<Direction, VoxelShape>of(Direction.NORTH, Block.box(3.0, 0.0, 0.0, 13.0, 1.0, 13.0), Direction.SOUTH, Block.box(3.0, 0.0, 3.0, 13.0, 1.0, 16.0), Direction.EAST, Block.box(3.0, 0.0, 3.0, 16.0, 1.0, 13.0), Direction.WEST, Block.box(0.0, 0.0, 3.0, 13.0, 1.0, 13.0)));
        SHAPES_UP = (Map)Maps.<Enum, Object>newEnumMap((java.util.Map<Enum, ?>)ImmutableMap.<Direction, VoxelShape>of(Direction.NORTH, Shapes.or((VoxelShape)RedStoneWireBlock.SHAPES_FLOOR.get(Direction.NORTH), Block.box(3.0, 0.0, 0.0, 13.0, 16.0, 1.0)), Direction.SOUTH, Shapes.or((VoxelShape)RedStoneWireBlock.SHAPES_FLOOR.get(Direction.SOUTH), Block.box(3.0, 0.0, 15.0, 13.0, 16.0, 16.0)), Direction.EAST, Shapes.or((VoxelShape)RedStoneWireBlock.SHAPES_FLOOR.get(Direction.EAST), Block.box(15.0, 0.0, 3.0, 16.0, 16.0, 13.0)), Direction.WEST, Shapes.or((VoxelShape)RedStoneWireBlock.SHAPES_FLOOR.get(Direction.WEST), Block.box(0.0, 0.0, 3.0, 1.0, 16.0, 13.0))));
