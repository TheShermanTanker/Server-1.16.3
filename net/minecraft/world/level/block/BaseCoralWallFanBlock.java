...
public class BaseCoralWallFanBlock extends BaseCoralFanBlock {
    ...
    static {
        ...
        SHAPES = (Map)Maps.<Enum, Object>newEnumMap((java.util.Map<Enum, ?>)ImmutableMap.<Direction, VoxelShape>of(Direction.NORTH, Block.box(0.0, 4.0, 5.0, 16.0, 12.0, 16.0), Direction.SOUTH, Block.box(0.0, 4.0, 0.0, 16.0, 12.0, 11.0), Direction.WEST, Block.box(5.0, 4.0, 0.0, 16.0, 12.0, 16.0), Direction.EAST, Block.box(0.0, 4.0, 0.0, 11.0, 12.0, 16.0)));
    }
}
