...
public class Explosion {
    ...
    public void finalizeExplosion(final boolean boolean1) {
        ...
        if (boolean2) {
            final ObjectArrayList<Pair<ItemStack, BlockPos>> objectArrayList4 = new ObjectArrayList<Pair<ItemStack, BlockPos>>();
            ...
            for (final Pair<ItemStack, BlockPos> pair6 : objectArrayList4) {
                Block.popResource(this.level, pair6.getSecond(), pair6.getFirst());
            }
        }
        if (this.fire) {
    ...
    private static void addBlockDrops(final ObjectArrayList<Pair<ItemStack, BlockPos>> objectArrayList, final ItemStack bly, final BlockPos fx) {
        for (int integer4 = objectArrayList.size(), integer5 = 0; integer5 < integer4; ++integer5) {
            final Pair<ItemStack, BlockPos> pair6 = objectArrayList.get(integer5);
            final ItemStack bly2 = pair6.getFirst();
            if (ItemEntity.areMergable(bly2, bly)) {
                final ItemStack bly3 = ItemEntity.merge(bly2, bly, 16);
                objectArrayList.set(integer5, Pair.<ItemStack, BlockPos>of(bly3, pair6.getSecond()));
                if (bly.isEmpty()) {
                    return;
                }
            }
        }
        objectArrayList.add(Pair.<ItemStack, BlockPos>of(bly, fx));
    }
