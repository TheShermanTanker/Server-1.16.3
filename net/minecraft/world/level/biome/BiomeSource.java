...
public abstract class BiomeSource implements BiomeManager.NoiseBiomeSource {
    ...
    protected BiomeSource(final Stream<Supplier<Biome>> stream) {
        this((List<Biome>)stream.map(Supplier::get).collect((Collector)ImmutableList.toImmutableList()));
    }
    ...
    static {
        ...
        CODEC = Registry.BIOME_SOURCE.<BiomeSource>dispatchStable((java.util.function.Function<? super BiomeSource, ?>)BiomeSource::codec, (java.util.function.Function<? super Object, ? extends Codec<? extends BiomeSource>>)Function.identity());
    }
}
