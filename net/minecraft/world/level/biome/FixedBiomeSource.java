...
public class FixedBiomeSource extends BiomeSource {
    ...
    public Set<Biome> getBiomesWithin(final int integer1, final int integer2, final int integer3, final int integer4) {
        return Sets.newHashSet((Biome)this.biome.get());
    }
    
    static {
        CODEC = Biome.CODEC.fieldOf("biome").<FixedBiomeSource>xmap((java.util.function.Function<? super Supplier<Biome>, ? extends FixedBiomeSource>)FixedBiomeSource::new, (java.util.function.Function<? super FixedBiomeSource, ? extends Supplier<Biome>>)(bta -> bta.biome)).stable().codec();
    }
}
