...
public class TheEndBiomeSource extends BiomeSource {
    ...
    private TheEndBiomeSource(final Registry<Biome> gm, final long long2, final Biome bss3, final Biome bss4, final Biome bss5, final Biome bss6, final Biome bss7) {
        super(ImmutableList.of(bss3, bss4, bss5, bss6, bss7));
        this.biomes = gm;
        this.seed = long2;
        this.end = bss3;
        this.highlands = bss4;
    ...
    static {
        CODEC = RecordCodecBuilder.<TheEndBiomeSource>create((java.util.function.Function<RecordCodecBuilder.Instance<TheEndBiomeSource>, ? extends App<RecordCodecBuilder.Mu<TheEndBiomeSource>, TheEndBiomeSource>>)(instance -> instance.<Registry<Object>, Object>group(RegistryLookupCodec.create(Registry.BIOME_REGISTRY).forGetter((java.util.function.Function<Object, Registry<Object>>)(bth -> bth.biomes)), Codec.LONG.fieldOf("seed").stable().forGetter((java.util.function.Function<Object, Object>)(bth -> bth.seed))).apply(instance, instance.stable(TheEndBiomeSource::new))));
    }
}
