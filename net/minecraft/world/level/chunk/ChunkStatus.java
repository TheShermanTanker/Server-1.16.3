...
public class ChunkStatus {
    ...
    static {
        ...
        PASSTHROUGH_LOAD_TASK = ((cfx, aag, cst, aaj, function, cft) -> {
            ...
            return (CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>>)CompletableFuture.completedFuture(Either.<ProtoChunk, Object>left(cft));
        });
        ...
        STATUS_BY_RANGE = (List)ImmutableList.<ChunkStatus>of(ChunkStatus.FULL, ChunkStatus.FEATURES, ChunkStatus.LIQUID_CARVERS, ChunkStatus.STRUCTURE_STARTS, ChunkStatus.STRUCTURE_STARTS, ChunkStatus.STRUCTURE_STARTS, ChunkStatus.STRUCTURE_STARTS, ChunkStatus.STRUCTURE_STARTS, ChunkStatus.STRUCTURE_STARTS, ChunkStatus.STRUCTURE_STARTS, ChunkStatus.STRUCTURE_STARTS);
        RANGE_BY_STATUS = Util.<IntArrayList>make(new IntArrayList(getStatusList().size()), (java.util.function.Consumer<IntArrayList>)(intArrayList -> {
            int integer2 = 0;
    ...
    interface SimpleGenerationTask extends GenerationTask {
        default CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> doWork(final ChunkStatus cfx, final ServerLevel aag, final ChunkGenerator cfv, final StructureManager cst, final ThreadedLevelLightEngine aaj, final Function<ChunkAccess, CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>>> function, final List<ChunkAccess> list, final ChunkAccess cft) {
            ...
            return (CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>>)CompletableFuture.completedFuture(Either.<ChunkAccess, Object>left(cft));
        }
