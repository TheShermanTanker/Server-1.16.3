...
public abstract class ChunkGenerator {
    ...
    private void generateStrongholds() {
        ...
        final List<Biome> list3 = Lists.newArrayList();
    ...
    static {
        ...
        CODEC = Registry.CHUNK_GENERATOR.<ChunkGenerator>dispatchStable((java.util.function.Function<? super ChunkGenerator, ?>)ChunkGenerator::codec, (java.util.function.Function<? super Object, ? extends Codec<? extends ChunkGenerator>>)Function.identity());
    }
}
