...
public class LevelChunk implements ChunkAccess {
    ...
    public Set<BlockPos> getBlockEntitiesPos() {
        final Set<BlockPos> set2 = Sets.newHashSet((java.lang.Iterable<?>)this.pendingBlockEntities.keySet());
    ...
    public Stream<BlockPos> getLights() {
        ...
        // Original Bytecode:
        // 
        //     1: getfield        net/minecraft/world/level/chunk/LevelChunk.chunkPos:Lnet/minecraft/world/level/ChunkPos;
        //     4: invokevirtual   net/minecraft/world/level/ChunkPos.getMinBlockX:()I
        //     7: iconst_0       
        //     8: aload_0         /* this */
        //     9: getfield        net/minecraft/world/level/chunk/LevelChunk.chunkPos:Lnet/minecraft/world/level/ChunkPos;
        //    12: invokevirtual   net/minecraft/world/level/ChunkPos.getMinBlockZ:()I
        //    15: aload_0         /* this */
        //    16: getfield        net/minecraft/world/level/chunk/LevelChunk.chunkPos:Lnet/minecraft/world/level/ChunkPos;
        //    19: invokevirtual   net/minecraft/world/level/ChunkPos.getMaxBlockX:()I
        //    22: sipush          255
        //    25: aload_0         /* this */
        //    26: getfield        net/minecraft/world/level/chunk/LevelChunk.chunkPos:Lnet/minecraft/world/level/ChunkPos;
        //    29: invokevirtual   net/minecraft/world/level/ChunkPos.getMaxBlockZ:()I
        //    32: invokestatic    net/minecraft/core/BlockPos.betweenClosed:(IIIIII)Ljava/lang/Iterable;
        //    35: invokeinterface java/lang/Iterable.spliterator:()Ljava/util/Spliterator;
        //    40: iconst_0       
        //    41: invokestatic    java/util/stream/StreamSupport.stream:(Ljava/util/Spliterator;Z)Ljava/util/stream/Stream;
        //    44: aload_0         /* this */
        //    45: invokedynamic   BootstrapMethod #4, test:(Lnet/minecraft/world/level/chunk/LevelChunk;)Ljava/util/function/Predicate;
        //    50: invokeinterface java/util/stream/Stream.filter:(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;
        //    55: areturn        
        //    Signature:
        //  ()Ljava/util/stream/Stream<Lnet/minecraft/core/BlockPos;>;
        // 
    ...
    public void postProcessGeneration() {
        ...
        this.unpackTicks();
        for (final BlockPos fx7 : Sets.newHashSet((java.lang.Iterable<?>)this.pendingBlockEntities.keySet())) {
