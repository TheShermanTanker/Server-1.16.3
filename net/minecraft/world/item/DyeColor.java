...
public enum DyeColor implements StringRepresentable {
    ...
    static {
        ...
        BY_FIREWORK_COLOR = new Int2ObjectOpenHashMap<DyeColor>((java.util.Map<? extends Integer, ? extends DyeColor>)Arrays.stream((Object[])values()).collect(Collectors.toMap(bku -> bku.fireworkColor, bku -> bku)));
    }
}
