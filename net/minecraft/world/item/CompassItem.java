...
public class CompassItem extends Item implements Vanishable {
    ...
    public static Optional<ResourceKey<Level>> getLodestoneDimension(final CompoundTag md) {
        return Level.RESOURCE_KEY_CODEC.<Tag>parse(NbtOps.INSTANCE, md.get("LodestoneDimension")).result();
    }
    ...
    private void addLodestoneTags(final ResourceKey<Level> vj, final BlockPos fx, final CompoundTag md) {
        ...
        Level.RESOURCE_KEY_CODEC.encodeStart((DynamicOps<Object>)NbtOps.INSTANCE, vj).resultOrPartial((Consumer<String>)CompassItem.LOGGER::error).ifPresent(mt -> md.put("LodestoneDimension", mt));
