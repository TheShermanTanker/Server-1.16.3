                    ...
                    if (integer11 >= 0 && integer12 >= -1 && integer11 < 128) {
                        if (integer12 < 128) {
                            ...
                            if (!cge23.isEmpty()) {
                                ...
                                final MaterialColor cuy33 = Iterables.<MaterialColor>getFirst((java.lang.Iterable<? extends MaterialColor>)Multisets.<MaterialColor>copyHighestCountFirst(multiset22), MaterialColor.NONE);
