...
public class RecipeManager extends SimpleJsonResourceReloadListener {
    ...
    protected void apply(final Map<ResourceLocation, JsonElement> map, final ResourceManager acf, final ProfilerFiller ant) {
        ...
        final Map<RecipeType<?>, ImmutableMap.Builder<ResourceLocation, Recipe<?>>> map2 = Maps.newHashMap();
        ...
        this.recipes = (Map<RecipeType<?>, Map<ResourceLocation, Recipe<?>>>)map2.entrySet().stream().collect((Collector)ImmutableMap.toImmutableMap((java.util.function.Function<? super Object, ?>)Map.Entry::getKey, (java.util.function.Function<? super Object, ?>)(entry -> ((ImmutableMap.Builder)entry.getValue()).build())));
