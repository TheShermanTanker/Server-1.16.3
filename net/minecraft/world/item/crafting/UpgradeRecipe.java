...
public class UpgradeRecipe implements Recipe<Container> {
    ...
    public static class Serializer implements RecipeSerializer<UpgradeRecipe> {
        public UpgradeRecipe fromJson(final ResourceLocation vk, final JsonObject jsonObject) {
            final Ingredient bok4 = Ingredient.fromJson(GsonHelper.getAsJsonObject(jsonObject, "base"));
            final Ingredient bok5 = Ingredient.fromJson(GsonHelper.getAsJsonObject(jsonObject, "addition"));
