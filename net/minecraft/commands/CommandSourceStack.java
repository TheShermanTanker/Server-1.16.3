...
public class CommandSourceStack implements SharedSuggestionProvider {
    ...
    public CommandSourceStack(final CommandSource da, final Vec3 dck, final Vec2 dcj, final ServerLevel aag, final int integer, final String string, final Component nr, final MinecraftServer minecraftServer, @Nullable final Entity apx) {
        this(da, dck, dcj, aag, integer, string, nr, minecraftServer, apx, false, (commandContext, boolean2, integer) -> {}, EntityAnchorArgument.Anchor.FEET);
    }
    ...
    public void onCommandComplete(final CommandContext<CommandSourceStack> commandContext, final boolean boolean2, final int integer) {
        if (this.consumer != null) {
            this.consumer.onCommandComplete(commandContext, boolean2, integer);
        }
    }
    ...
    static {
        ERROR_NOT_PLAYER = new SimpleCommandExceptionType(new TranslatableComponent("permissions.requires.player"));
        ERROR_NOT_ENTITY = new SimpleCommandExceptionType(new TranslatableComponent("permissions.requires.entity"));
    }
}
