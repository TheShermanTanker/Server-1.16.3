...
public class EntitySummonArgument implements ArgumentType<ResourceLocation> {
    ...
    public static ResourceLocation getSummonableEntity(final CommandContext<CommandSourceStack> commandContext, final String string) throws CommandSyntaxException {
        return verifyCanSummon(commandContext.<ResourceLocation>getArgument(string, ResourceLocation.class));
    }
    ...
    static {
        ...
        ERROR_UNKNOWN_ENTITY = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("entity.notFound", new Object[] { object })));
    }
}
