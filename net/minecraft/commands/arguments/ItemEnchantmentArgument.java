...
public class ItemEnchantmentArgument implements ArgumentType<Enchantment> {
    ...
    public static Enchantment getEnchantment(final CommandContext<CommandSourceStack> commandContext, final String string) {
        return commandContext.<Enchantment>getArgument(string, Enchantment.class);
    }
    ...
    static {
        ...
        ERROR_UNKNOWN_ENCHANTMENT = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("enchantment.unknown", new Object[] { object })));
    }
}
