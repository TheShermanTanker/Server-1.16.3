...
public class NbtPathArgument implements ArgumentType<NbtPath> {
    ...
    public static NbtPath getPath(final CommandContext<CommandSourceStack> commandContext, final String string) {
        return commandContext.<NbtPath>getArgument(string, NbtPath.class);
    }
    
    public NbtPath parse(final StringReader stringReader) throws CommandSyntaxException {
        final List<Node> list3 = Lists.newArrayList();
        final int integer4 = stringReader.getCursor();
        final Object2IntMap<Node> object2IntMap5 = new Object2IntOpenHashMap<Node>();
    ...
    private static Node parseNode(final StringReader stringReader, final boolean boolean2) throws CommandSyntaxException {
        switch (stringReader.peek()) {
            case '{': {
                if (!boolean2) {
                    throw NbtPathArgument.ERROR_INVALID_NODE.createWithContext(stringReader);
                }
    ...
    static {
        ...
        ERROR_INVALID_NODE = new SimpleCommandExceptionType(new TranslatableComponent("arguments.nbtpath.node.invalid"));
        ERROR_NOTHING_FOUND = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("arguments.nbtpath.nothing_found", new Object[] { object })));
    }
    ...
    public static class NbtPath {
        ...
        public int countMatching(final Tag mt) {
            ...
            // Original Bytecode:
            // 
            //     1: invokestatic    java/util/Collections.singletonList:(Ljava/lang/Object;)Ljava/util/List;
            //     4: astore_2        /* list3 */
            //     5: aload_0         /* this */
            //     6: getfield        net/minecraft/commands/arguments/NbtPathArgument$NbtPath.nodes:[Lnet/minecraft/commands/arguments/NbtPathArgument$Node;
            //     9: astore_3       
            //    10: aload_3        
            //    11: arraylength    
            //    12: istore          4
            ...
            //    30: aload           i7
            //    32: aload_2         /* list3 */
            //    33: invokeinterface net/minecraft/commands/arguments/NbtPathArgument$Node.get:(Ljava/util/List;)Ljava/util/List;
            //    38: astore_2        /* list3 */
            //    39: aload_2         /* list3 */
            ...
            //  ----  -----
            //  mt    
            //    StackMapTable: 00 03 FF 00 11 00 06 00 00 07 00 36 07 00 37 01 01 00 00 20 F8 00 05
            // 
    ...
    interface Node {
        ...
        default List<Tag> collect(final List<Tag> list, final BiConsumer<Tag, List<Tag>> biConsumer) {
            final List<Tag> list2 = Lists.newArrayList();
