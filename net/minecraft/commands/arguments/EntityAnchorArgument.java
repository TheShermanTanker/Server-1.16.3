...
public class EntityAnchorArgument implements ArgumentType<Anchor> {
    ...
    public static Anchor getAnchor(final CommandContext<CommandSourceStack> commandContext, final String string) {
        return commandContext.<Anchor>getArgument(string, Anchor.class);
    }
    ...
    public Anchor parse(final StringReader stringReader) throws CommandSyntaxException {
        ...
        if (a5 == null) {
            ...
            throw EntityAnchorArgument.ERROR_INVALID.createWithContext(stringReader, string4);
        }
        return a5;
    }
    ...
    static {
        ...
        ERROR_INVALID = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.anchor.invalid", new Object[] { object })));
    }
