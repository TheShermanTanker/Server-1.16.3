...
public class WorldCoordinate {
    ...
    public static WorldCoordinate parseInt(final StringReader stringReader) throws CommandSyntaxException {
        ...
        if (!stringReader.canRead()) {
            throw WorldCoordinate.ERROR_EXPECTED_INT.createWithContext(stringReader);
        }
    ...
    static {
        ERROR_EXPECTED_DOUBLE = new SimpleCommandExceptionType(new TranslatableComponent("argument.pos.missing.double"));
        ERROR_EXPECTED_INT = new SimpleCommandExceptionType(new TranslatableComponent("argument.pos.missing.int"));
    }
}
