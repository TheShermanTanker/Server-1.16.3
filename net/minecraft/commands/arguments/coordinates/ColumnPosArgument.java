...
public class ColumnPosArgument implements ArgumentType<Coordinates> {
    ...
    public Coordinates parse(final StringReader stringReader) throws CommandSyntaxException {
        ...
        if (!stringReader.canRead()) {
            throw ColumnPosArgument.ERROR_NOT_COMPLETE.createWithContext(stringReader);
        }
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(final CommandContext<S> commandContext, final SuggestionsBuilder suggestionsBuilder) {
        if (commandContext.getSource() instanceof SharedSuggestionProvider) {
            ...
            return SharedSuggestionProvider.suggest2DCoordinates(string4, collection5, suggestionsBuilder, Commands.createValidator(this::a));
        }
    ...
    static {
        ...
        ERROR_NOT_COMPLETE = new SimpleCommandExceptionType(new TranslatableComponent("argument.pos2d.incomplete"));
    }
}
