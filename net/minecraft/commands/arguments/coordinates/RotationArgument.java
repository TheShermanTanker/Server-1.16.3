...
public class RotationArgument implements ArgumentType<Coordinates> {
    ...
    public Coordinates parse(final StringReader stringReader) throws CommandSyntaxException {
        ...
        if (!stringReader.canRead()) {
            throw RotationArgument.ERROR_NOT_COMPLETE.createWithContext(stringReader);
        }
    ...
    static {
        ...
        ERROR_NOT_COMPLETE = new SimpleCommandExceptionType(new TranslatableComponent("argument.rotation.incomplete"));
    }
}
