...
public class Vec3Argument implements ArgumentType<Coordinates> {
    ...
    public static Coordinates getCoordinates(final CommandContext<CommandSourceStack> commandContext, final String string) {
        return commandContext.<Coordinates>getArgument(string, Coordinates.class);
    }
    ...
    static {
        ...
        ERROR_NOT_COMPLETE = new SimpleCommandExceptionType(new TranslatableComponent("argument.pos3d.incomplete"));
        ERROR_MIXED_TYPE = new SimpleCommandExceptionType(new TranslatableComponent("argument.pos.mixed"));
    }
}
