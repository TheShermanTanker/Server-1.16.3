...
public class ColorArgument implements ArgumentType<ChatFormatting> {
    ...
    public static ChatFormatting getColor(final CommandContext<CommandSourceStack> commandContext, final String string) {
        return commandContext.<ChatFormatting>getArgument(string, ChatFormatting.class);
    }
    ...
    static {
        ...
        ERROR_INVALID_VALUE = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.color.invalid", new Object[] { object })));
    }
}
