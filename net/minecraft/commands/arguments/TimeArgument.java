...
public class TimeArgument implements ArgumentType<Integer> {
    ...
    static {
        ...
        ERROR_INVALID_UNIT = new SimpleCommandExceptionType(new TranslatableComponent("argument.time.invalid_unit"));
        ERROR_INVALID_TICK_COUNT = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.time.invalid_tick_count", new Object[] { object })));
        (UNITS = new Object2IntOpenHashMap<String>()).put("d", 24000);
