...
public class UuidArgument implements ArgumentType<UUID> {
    ...
    public static UUID getUuid(final CommandContext<CommandSourceStack> commandContext, final String string) {
        return commandContext.<UUID>getArgument(string, UUID.class);
    }
    ...
    static {
        ERROR_INVALID_UUID = new SimpleCommandExceptionType(new TranslatableComponent("argument.uuid.invalid"));
