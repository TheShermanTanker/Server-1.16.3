...
public class ObjectiveCriteriaArgument implements ArgumentType<ObjectiveCriteria> {
    ...
    public static ObjectiveCriteria getCriteria(final CommandContext<CommandSourceStack> commandContext, final String string) {
        return commandContext.<ObjectiveCriteria>getArgument(string, ObjectiveCriteria.class);
    }
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(final CommandContext<S> commandContext, final SuggestionsBuilder suggestionsBuilder) {
        final List<String> list4 = Lists.newArrayList((java.lang.Iterable<?>)ObjectiveCriteria.CRITERIA_BY_NAME.keySet());
    ...
    static {
        ...
        ERROR_INVALID_VALUE = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.criteria.invalid", new Object[] { object })));
    }
}
