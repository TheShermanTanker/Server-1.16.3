...
public class ScoreboardSlotArgument implements ArgumentType<Integer> {
    ...
    static {
        ...
        ERROR_INVALID_VALUE = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.scoreboardDisplaySlot.invalid", new Object[] { object })));
    }
}
