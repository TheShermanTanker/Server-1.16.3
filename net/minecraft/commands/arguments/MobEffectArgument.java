...
public class MobEffectArgument implements ArgumentType<MobEffect> {
    ...
    public static MobEffect getEffect(final CommandContext<CommandSourceStack> commandContext, final String string) throws CommandSyntaxException {
        return commandContext.<MobEffect>getArgument(string, MobEffect.class);
    }
    ...
    static {
        ...
        ERROR_UNKNOWN_EFFECT = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("effect.effectNotFound", new Object[] { object })));
    }
}
