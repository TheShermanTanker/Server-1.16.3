...
public class ComponentArgument implements ArgumentType<Component> {
    ...
    public static Component getComponent(final CommandContext<CommandSourceStack> commandContext, final String string) {
        return commandContext.<Component>getArgument(string, Component.class);
    }
    ...
    public Component parse(final StringReader stringReader) throws CommandSyntaxException {
        try {
            ...
            throw ComponentArgument.ERROR_INVALID_JSON.createWithContext(stringReader, string4);
        }
    }
    ...
    static {
        ...
        ERROR_INVALID_JSON = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.component.invalid", new Object[] { object })));
    }
}
