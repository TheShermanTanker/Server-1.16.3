...
public class BlockPredicateArgument implements ArgumentType<Result> {
    ...
    public static Predicate<BlockInWorld> getBlockPredicate(final CommandContext<CommandSourceStack> commandContext, final String string) throws CommandSyntaxException {
        return commandContext.<Result>getArgument(string, Result.class).create(commandContext.getSource().getServer().getTags());
    }
    ...
    static {
        ...
        ERROR_UNKNOWN_TAG = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("arguments.block.tag.unknown", new Object[] { object })));
    }
