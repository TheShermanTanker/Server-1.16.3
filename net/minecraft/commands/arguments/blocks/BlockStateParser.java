...
public class BlockStateParser {
    ...
    public void readProperties() throws CommandSyntaxException {
        ...
        while (this.reader.canRead() && this.reader.peek() != ']') {
            ...
            if (cfg4 == null) {
                this.reader.setCursor(integer2);
                throw BlockStateParser.ERROR_UNKNOWN_PROPERTY.createWithContext(this.reader, this.id.toString(), string3);
            }
            if (this.properties.containsKey(cfg4)) {
                this.reader.setCursor(integer2);
                throw BlockStateParser.ERROR_DUPLICATE_PROPERTY.createWithContext(this.reader, this.id.toString(), string3);
            }
            this.reader.skipWhitespace();
            this.suggestions = (BiFunction<SuggestionsBuilder, TagCollection<Block>, CompletableFuture<Suggestions>>)this::suggestEquals;
            if (!this.reader.canRead() || this.reader.peek() != '=') {
                throw BlockStateParser.ERROR_EXPECTED_VALUE.createWithContext(this.reader, this.id.toString(), string3);
            }
            this.reader.skip();
            this.reader.skipWhitespace();
    ...
    public void readVagueProperties() throws CommandSyntaxException {
        ...
        while (this.reader.canRead() && this.reader.peek() != ']') {
            ...
            if (this.vagueProperties.containsKey(string4)) {
                ...
                throw BlockStateParser.ERROR_DUPLICATE_PROPERTY.createWithContext(this.reader, this.id.toString(), string4);
            }
            this.reader.skipWhitespace();
            if (!this.reader.canRead() || this.reader.peek() != '=') {
                this.reader.setCursor(integer3);
                throw BlockStateParser.ERROR_EXPECTED_VALUE.createWithContext(this.reader, this.id.toString(), string4);
            }
            this.reader.skip();
            this.reader.skipWhitespace();
    ...
    private <T extends Comparable<T>> void setValue(final Property<T> cfg, final String string, final int integer) throws CommandSyntaxException {
        ...
        throw BlockStateParser.ERROR_INVALID_VALUE.createWithContext(this.reader, this.id.toString(), cfg.getName(), string);
    }
    ...
    static {
        ERROR_NO_TAGS_ALLOWED = new SimpleCommandExceptionType(new TranslatableComponent("argument.block.tag.disallowed"));
        ERROR_UNKNOWN_BLOCK = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.block.id.invalid", new Object[] { object })));
        final TranslatableComponent translatableComponent;
        ERROR_UNKNOWN_PROPERTY = new Dynamic2CommandExceptionType((object1, object2) -> {
            new TranslatableComponent("argument.block.property.unknown", new Object[] { object1, object2 });
            return translatableComponent;
        });
        final TranslatableComponent translatableComponent2;
        ERROR_DUPLICATE_PROPERTY = new Dynamic2CommandExceptionType((object1, object2) -> {
            new TranslatableComponent("argument.block.property.duplicate", new Object[] { object2, object1 });
            return translatableComponent2;
        });
        final TranslatableComponent translatableComponent3;
        ERROR_INVALID_VALUE = new Dynamic3CommandExceptionType((object1, object2, object3) -> {
            new TranslatableComponent("argument.block.property.invalid", new Object[] { object1, object3, object2 });
            return translatableComponent3;
        });
        final TranslatableComponent translatableComponent4;
        ERROR_EXPECTED_VALUE = new Dynamic2CommandExceptionType((object1, object2) -> {
            new TranslatableComponent("argument.block.property.novalue", new Object[] { object1, object2 });
            return translatableComponent4;
        });
        ERROR_EXPECTED_END_OF_PROPERTIES = new SimpleCommandExceptionType(new TranslatableComponent("argument.block.property.unclosed"));
