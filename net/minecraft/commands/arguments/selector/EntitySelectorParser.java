...
public class EntitySelectorParser {
    ...
    protected void parseSelector() throws CommandSyntaxException {
        ...
        if (character3 == 'p') {
            ...
            if (character3 != 'e') {
                ...
                throw EntitySelectorParser.ERROR_UNKNOWN_SELECTOR_TYPE.createWithContext(this.reader, '@' + String.valueOf(character3));
            }
            this.maxResults = Integer.MAX_VALUE;
            this.includesEntities = true;
            this.order = EntitySelectorParser.ORDER_ARBITRARY;
    ...
    protected void parseOptions() throws CommandSyntaxException {
        ...
        while (this.reader.canRead() && this.reader.peek() != ']') {
            ...
            if (!this.reader.canRead() || this.reader.peek() != '=') {
                this.reader.setCursor(integer2);
                throw EntitySelectorParser.ERROR_EXPECTED_OPTION_VALUE.createWithContext(this.reader, string3);
            }
            this.reader.skip();
            this.reader.skipWhitespace();
            this.suggestions = EntitySelectorParser.SUGGEST_NOTHING;
    ...
    static {
        ERROR_INVALID_NAME_OR_UUID = new SimpleCommandExceptionType(new TranslatableComponent("argument.entity.invalid"));
        ERROR_UNKNOWN_SELECTOR_TYPE = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.entity.selector.unknown", new Object[] { object })));
        ERROR_SELECTORS_NOT_ALLOWED = new SimpleCommandExceptionType(new TranslatableComponent("argument.entity.selector.not_allowed"));
        ERROR_MISSING_SELECTOR_TYPE = new SimpleCommandExceptionType(new TranslatableComponent("argument.entity.selector.missing"));
        ERROR_EXPECTED_END_OF_OPTIONS = new SimpleCommandExceptionType(new TranslatableComponent("argument.entity.options.unterminated"));
        ERROR_EXPECTED_OPTION_VALUE = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.entity.options.valueless", new Object[] { object })));
