...
public class EntitySelectorOptions {
    ...
    public static Modifier get(final EntitySelectorParser fd, final String string, final int integer) throws CommandSyntaxException {
        ...
        if (b4 == null) {
            ...
            throw EntitySelectorOptions.ERROR_UNKNOWN_OPTION.createWithContext(fd.getReader(), string);
        }
        if (b4.predicate.test(fd)) {
            return b4.modifier;
        }
        throw EntitySelectorOptions.ERROR_INAPPLICABLE_OPTION.createWithContext(fd.getReader(), string);
    }
    ...
    public static void suggestNames(final EntitySelectorParser fd, final SuggestionsBuilder suggestionsBuilder) {
        ...
        for (final Map.Entry<String, Option> entry5 : EntitySelectorOptions.OPTIONS.entrySet()) {
            if (((Option)entry5.getValue()).predicate.test(fd) && ((String)entry5.getKey()).toLowerCase(Locale.ROOT).startsWith(string3)) {
                suggestionsBuilder.suggest((String)entry5.getKey() + '=', ((Option)entry5.getValue()).description);
            }
        }
    }
    ...
    static {
        ...
        ERROR_UNKNOWN_OPTION = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.entity.options.unknown", new Object[] { object })));
        ERROR_INAPPLICABLE_OPTION = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.entity.options.inapplicable", new Object[] { object })));
        ERROR_RANGE_NEGATIVE = new SimpleCommandExceptionType(new TranslatableComponent("argument.entity.options.distance.negative"));
        ERROR_LEVEL_NEGATIVE = new SimpleCommandExceptionType(new TranslatableComponent("argument.entity.options.level.negative"));
        ERROR_LIMIT_TOO_SMALL = new SimpleCommandExceptionType(new TranslatableComponent("argument.entity.options.limit.toosmall"));
        ERROR_SORT_UNKNOWN = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.entity.options.sort.irreversible", new Object[] { object })));
        ERROR_GAME_MODE_INVALID = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.entity.options.mode.invalid", new Object[] { object })));
        ERROR_ENTITY_TYPE_INVALID = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.entity.options.type.invalid", new Object[] { object })));
    }
