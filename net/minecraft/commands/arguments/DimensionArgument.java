...
public class DimensionArgument implements ArgumentType<ResourceLocation> {
    ...
    public static ServerLevel getDimension(final CommandContext<CommandSourceStack> commandContext, final String string) throws CommandSyntaxException {
        final ResourceLocation vk3 = commandContext.<ResourceLocation>getArgument(string, ResourceLocation.class);
        final ResourceKey<Level> vj4 = ResourceKey.<Level>create(Registry.DIMENSION_REGISTRY, vk3);
        final ServerLevel aag5 = commandContext.getSource().getServer().getLevel(vj4);
        if (aag5 == null) {
    ...
    static {
        ...
        ERROR_INVALID_VALUE = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.dimension.invalid", new Object[] { object })));
    }
}
