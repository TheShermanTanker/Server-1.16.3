...
public class FunctionArgument implements ArgumentType<Result> {
    ...
    public Result parse(final StringReader stringReader) throws CommandSyntaxException {
        if (stringReader.canRead() && stringReader.peek() == '#') {
            ...
            return new Result() {
                ...
                public Pair<ResourceLocation, Either<CommandFunction, Tag<CommandFunction>>> unwrap(final CommandContext<CommandSourceStack> commandContext) throws CommandSyntaxException {
                    return Pair.<ResourceLocation, Either<CommandFunction, Tag<CommandFunction>>>of(vk3, Either.<CommandFunction, Tag<CommandFunction>>right(getFunctionTag(commandContext, vk3)));
                }
            };
        }
        final ResourceLocation vk3 = ResourceLocation.read(stringReader);
        return new Result() {
            ...
            public Pair<ResourceLocation, Either<CommandFunction, Tag<CommandFunction>>> unwrap(final CommandContext<CommandSourceStack> commandContext) throws CommandSyntaxException {
                return Pair.<ResourceLocation, Either<CommandFunction, Tag<CommandFunction>>>of(vk3, Either.<CommandFunction, Tag<CommandFunction>>left(getFunction(commandContext, vk3)));
            }
        };
    }
    ...
    private static CommandFunction getFunction(final CommandContext<CommandSourceStack> commandContext, final ResourceLocation vk) throws CommandSyntaxException {
        return (CommandFunction)commandContext.getSource().getServer().getFunctions().get(vk).orElseThrow(() -> FunctionArgument.ERROR_UNKNOWN_FUNCTION.create(vk.toString()));
    }
    ...
    private static Tag<CommandFunction> getFunctionTag(final CommandContext<CommandSourceStack> commandContext, final ResourceLocation vk) throws CommandSyntaxException {
        final Tag<CommandFunction> aej3 = commandContext.getSource().getServer().getFunctions().getTag(vk);
        if (aej3 == null) {
    ...
    public static Collection<CommandFunction> getFunctions(final CommandContext<CommandSourceStack> commandContext, final String string) throws CommandSyntaxException {
        return commandContext.<Result>getArgument(string, Result.class).create(commandContext);
    }
    ...
    public static Pair<ResourceLocation, Either<CommandFunction, Tag<CommandFunction>>> getFunctionOrTag(final CommandContext<CommandSourceStack> commandContext, final String string) throws CommandSyntaxException {
        return commandContext.<Result>getArgument(string, Result.class).unwrap(commandContext);
    }
    ...
    static {
        ...
        ERROR_UNKNOWN_TAG = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("arguments.function.tag.unknown", new Object[] { object })));
        ERROR_UNKNOWN_FUNCTION = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("arguments.function.unknown", new Object[] { object })));
    }
