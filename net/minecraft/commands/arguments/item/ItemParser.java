...
public class ItemParser {
    ...
    public void readItem() throws CommandSyntaxException {
        ...
        this.item = (Item)Registry.ITEM.getOptional(vk3).orElseThrow(() -> {
            ...
            return ItemParser.ERROR_UNKNOWN_ITEM.createWithContext(this.reader, vk3.toString());
        });
    }
    ...
    static {
        ERROR_NO_TAGS_ALLOWED = new SimpleCommandExceptionType(new TranslatableComponent("argument.item.tag.disallowed"));
        ERROR_UNKNOWN_ITEM = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("argument.item.id.invalid", new Object[] { object })));
