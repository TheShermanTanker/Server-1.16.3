...
public class ItemPredicateArgument implements ArgumentType<Result> {
    ...
    public Result parse(final StringReader stringReader) throws CommandSyntaxException {
        ...
        return commandContext -> {
            aej4 = commandContext.getSource().getServer().getTags().getItems().getTag(vk5);
            if (aej4 == null) {
    ...
    static {
        ...
        ERROR_UNKNOWN_TAG = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("arguments.item.tag.unknown", new Object[] { object })));
    }
