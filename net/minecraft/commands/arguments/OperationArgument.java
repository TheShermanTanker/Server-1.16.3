...
public class OperationArgument implements ArgumentType<Operation> {
    ...
    public static Operation getOperation(final CommandContext<CommandSourceStack> commandContext, final String string) throws CommandSyntaxException {
        return commandContext.<Operation>getArgument(string, Operation.class);
    }
    ...
    static {
        ...
        ERROR_INVALID_OPERATION = new SimpleCommandExceptionType(new TranslatableComponent("arguments.operation.invalid"));
        ERROR_DIVIDE_BY_ZERO = new SimpleCommandExceptionType(new TranslatableComponent("arguments.operation.div0"));
    }
