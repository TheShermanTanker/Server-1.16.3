...
public class ParticleArgument implements ArgumentType<ParticleOptions> {
    ...
    public static ParticleOptions getParticle(final CommandContext<CommandSourceStack> commandContext, final String string) {
        return commandContext.<ParticleOptions>getArgument(string, ParticleOptions.class);
    }
    ...
    static {
        ...
        ERROR_UNKNOWN_PARTICLE = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("particle.notFound", new Object[] { object })));
    }
}
