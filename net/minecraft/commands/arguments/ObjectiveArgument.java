...
public class ObjectiveArgument implements ArgumentType<String> {
    ...
    public static Objective getObjective(final CommandContext<CommandSourceStack> commandContext, final String string) throws CommandSyntaxException {
        final String string2 = commandContext.<String>getArgument(string, String.class);
        final Scoreboard ddk4 = commandContext.getSource().getServer().getScoreboard();
    ...
    static {
        ...
        ERROR_OBJECTIVE_NOT_FOUND = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("arguments.objective.notFound", new Object[] { object })));
        ERROR_OBJECTIVE_READ_ONLY = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("arguments.objective.readonly", new Object[] { object })));
        ERROR_OBJECTIVE_NAME_TOO_LONG = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("commands.scoreboard.objectives.add.longName", new Object[] { object })));
    }
}
