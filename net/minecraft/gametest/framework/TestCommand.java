...
public class TestCommand {
    public static void register(final CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder<CommandSourceStack>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("test").then(Commands.literal("runthis").executes(commandContext -> runNearbyTest(commandContext.getSource()))).then(Commands.literal("runthese").executes(commandContext -> runAllNearbyTests(commandContext.getSource())))).then(Commands.literal("runfailed").executes(commandContext -> runLastFailedTests(commandContext.getSource(), false, 0, 8)).then(Commands.argument("onlyRequiredTests", (ArgumentType<Object>)BoolArgumentType.bool()).executes(commandContext -> runLastFailedTests(commandContext.getSource(), BoolArgumentType.getBool(commandContext, "onlyRequiredTests"), 0, 8)).then(Commands.argument("rotationSteps", (ArgumentType<Object>)IntegerArgumentType.integer()).executes(commandContext -> runLastFailedTests(commandContext.getSource(), BoolArgumentType.getBool(commandContext, "onlyRequiredTests"), IntegerArgumentType.getInteger(commandContext, "rotationSteps"), 8)).then(Commands.argument("testsPerRow", (ArgumentType<Object>)IntegerArgumentType.integer()).executes(commandContext -> runLastFailedTests(commandContext.getSource(), BoolArgumentType.getBool(commandContext, "onlyRequiredTests"), IntegerArgumentType.getInteger(commandContext, "rotationSteps"), IntegerArgumentType.getInteger(commandContext, "testsPerRow")))))))).then(Commands.literal("run").then(Commands.argument("testName", (ArgumentType<Object>)TestFunctionArgument.testFunctionArgument()).executes(commandContext -> runTest(commandContext.getSource(), TestFunctionArgument.getTestFunction(commandContext, "testName"), 0)).then(Commands.argument("rotationSteps", (ArgumentType<Object>)IntegerArgumentType.integer()).executes(commandContext -> runTest(commandContext.getSource(), TestFunctionArgument.getTestFunction(commandContext, "testName"), IntegerArgumentType.getInteger(commandContext, "rotationSteps"))))))).then(((LiteralArgumentBuilder)Commands.literal("runall").executes(commandContext -> runAllTests(commandContext.getSource(), 0, 8)).then(Commands.argument("testClassName", (ArgumentType<Object>)TestClassNameArgument.testClassName()).executes(commandContext -> runAllTestsInClass(commandContext.getSource(), TestClassNameArgument.getTestClassName(commandContext, "testClassName"), 0, 8)).then(Commands.argument("rotationSteps", (ArgumentType<Object>)IntegerArgumentType.integer()).executes(commandContext -> runAllTestsInClass(commandContext.getSource(), TestClassNameArgument.getTestClassName(commandContext, "testClassName"), IntegerArgumentType.getInteger(commandContext, "rotationSteps"), 8)).then(Commands.argument("testsPerRow", (ArgumentType<Object>)IntegerArgumentType.integer()).executes(commandContext -> runAllTestsInClass(commandContext.getSource(), TestClassNameArgument.getTestClassName(commandContext, "testClassName"), IntegerArgumentType.getInteger(commandContext, "rotationSteps"), IntegerArgumentType.getInteger(commandContext, "testsPerRow"))))))).then(Commands.argument("rotationSteps", (ArgumentType<Object>)IntegerArgumentType.integer()).executes(commandContext -> runAllTests(commandContext.getSource(), IntegerArgumentType.getInteger(commandContext, "rotationSteps"), 8)).then(Commands.argument("testsPerRow", (ArgumentType<Object>)IntegerArgumentType.integer()).executes(commandContext -> runAllTests(commandContext.getSource(), IntegerArgumentType.getInteger(commandContext, "rotationSteps"), IntegerArgumentType.getInteger(commandContext, "testsPerRow"))))))).then(Commands.literal("export").then(Commands.argument("testName", (ArgumentType<Object>)StringArgumentType.word()).executes(commandContext -> exportTestStructure(commandContext.getSource(), StringArgumentType.getString(commandContext, "testName")))))).then(Commands.literal("exportthis").executes(commandContext -> exportNearestTestStructure(commandContext.getSource())))).then(Commands.literal("import").then(Commands.argument("testName", (ArgumentType<Object>)StringArgumentType.word()).executes(commandContext -> importTestStructure(commandContext.getSource(), StringArgumentType.getString(commandContext, "testName")))))).then(Commands.literal("pos").executes(commandContext -> showPos((CommandSourceStack)commandContext.getSource(), "pos")).then(Commands.argument("var", (ArgumentType<Object>)StringArgumentType.word()).executes(commandContext -> showPos(commandContext.getSource(), StringArgumentType.getString(commandContext, "var")))))).then(Commands.literal("create").then(Commands.argument("testName", (ArgumentType<Object>)StringArgumentType.word()).executes(commandContext -> createNewStructure(commandContext.getSource(), StringArgumentType.getString(commandContext, "testName"), 5, 5, 5)).then(Commands.argument("width", (ArgumentType<Object>)IntegerArgumentType.integer()).executes(commandContext -> createNewStructure(commandContext.getSource(), StringArgumentType.getString(commandContext, "testName"), IntegerArgumentType.getInteger(commandContext, "width"), IntegerArgumentType.getInteger(commandContext, "width"), IntegerArgumentType.getInteger(commandContext, "width"))).then(Commands.argument("height", (ArgumentType<Object>)IntegerArgumentType.integer()).then(Commands.argument("depth", (ArgumentType<Object>)IntegerArgumentType.integer()).executes(commandContext -> createNewStructure(commandContext.getSource(), StringArgumentType.getString(commandContext, "testName"), IntegerArgumentType.getInteger(commandContext, "width"), IntegerArgumentType.getInteger(commandContext, "height"), IntegerArgumentType.getInteger(commandContext, "depth"))))))))).then(Commands.literal("clearall").executes(commandContext -> clearAllTests(commandContext.getSource(), 200)).then(Commands.argument("radius", (ArgumentType<Object>)IntegerArgumentType.integer()).executes(commandContext -> clearAllTests(commandContext.getSource(), IntegerArgumentType.getInteger(commandContext, "radius"))))));
    }
