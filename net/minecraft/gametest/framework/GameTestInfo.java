...
public class GameTestInfo {
    ...
    public GameTestInfo(final TestFunction lu, final Rotation bzj, final ServerLevel aag) {
        ...
        this.runAtTickTimeMap = new Object2LongOpenHashMap<Runnable>();
        this.started = false;
    ...
    public void tick() {
        ...
        final ObjectIterator<Object2LongMap.Entry<Runnable>> objectIterator2 = this.runAtTickTimeMap.object2LongEntrySet().iterator();
