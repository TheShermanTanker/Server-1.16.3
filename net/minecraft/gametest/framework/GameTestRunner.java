...
public class GameTestRunner {
    ...
    public static Collection<GameTestBatch> groupTestsIntoBatches(final Collection<TestFunction> collection) {
        final Map<String, Collection<TestFunction>> map2 = Maps.newHashMap();
        ...
        return (Collection<GameTestBatch>)map2.keySet().stream().flatMap(string -> {
            ...
            return Streams.<java.util.List<Object>>stream(Iterables.partition((java.lang.Iterable<Object>)collection3, 100)).map2(list -> new GameTestBatch(string + ":" + mutableInt5.incrementAndGet(), collection3, consumer4));
