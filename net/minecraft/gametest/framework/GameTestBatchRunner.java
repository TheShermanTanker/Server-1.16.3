...
public class GameTestBatchRunner {
    ...
    public GameTestBatchRunner(final Collection<GameTestBatch> collection, final BlockPos fx, final Rotation bzj, final ServerLevel aag, final GameTestTicker ll, final int integer) {
        ...
        this.northWestCorners = Maps.newHashMap();
        ...
        collection.forEach(la -> {
            final Collection<GameTestInfo> collection5 = Lists.newArrayList();
            ...
            this.batches.add(Pair.<GameTestBatch, Collection<GameTestInfo>>of(la, collection5));
        });
    }
    ...
    private void runBatch(final int integer) {
        ...
        final GameTestBatch la4 = pair3.getFirst();
        final Collection<GameTestInfo> collection5 = pair3.getSecond();
