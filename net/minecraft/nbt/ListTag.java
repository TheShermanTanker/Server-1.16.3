...
public class ListTag extends CollectionTag<Tag> {
    ...
    public ListTag copy() {
        final Iterable<Tag> iterable2 = (Iterable<Tag>)(TagTypes.getType(this.type).isValue() ? this.list : Iterables.transform((java.lang.Iterable<Object>)this.list, Tag::copy));
        final List<Tag> list3 = Lists.newArrayList((java.lang.Iterable<?>)iterable2);
    ...
    static {
        ...
        INLINE_ELEMENT_TYPES = new ByteOpenHashSet(Arrays.asList((Object[])new Byte[] { 1, 2, 3, 4, 5, 6 }));
    }
}
