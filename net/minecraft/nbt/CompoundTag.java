...
public class CompoundTag implements Tag {
    ...
    public String toString() {
        ...
        if (CompoundTag.LOGGER.isDebugEnabled()) {
            final List<String> list4 = Lists.newArrayList((java.lang.Iterable<?>)this.tags.keySet());
    ...
    public CompoundTag copy() {
        final Map<String, Tag> map2 = Maps.newHashMap((java.util.Map<?, ?>)Maps.transformValues((java.util.Map<? extends K, Tag>)this.tags, Tag::copy));
    ...
    public Component getPrettyDisplay(final String string, final int integer) {
        ...
        if (CompoundTag.LOGGER.isDebugEnabled()) {
            final List<String> list6 = Lists.newArrayList((java.lang.Iterable<?>)this.tags.keySet());
    ...
    static {
        CODEC = Codec.PASSTHROUGH.<CompoundTag>comapFlatMap((java.util.function.Function<? super Dynamic<?>, ? extends DataResult<? extends CompoundTag>>)(dynamic -> {
            final Tag mt2 = dynamic.<Tag>convert(NbtOps.INSTANCE).getValue();
            if (mt2 instanceof CompoundTag) {
                return DataResult.<CompoundTag>success(mt2);
            }
            return DataResult.error(new StringBuilder().append("Not a compound tag: ").append(mt2).toString());
        }), (java.util.function.Function<? super CompoundTag, ? extends Dynamic<?>>)(md -> new Dynamic((DynamicOps<T>)NbtOps.INSTANCE, (T)md)));
