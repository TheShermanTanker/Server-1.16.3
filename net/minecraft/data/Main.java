...
public class Main {
    public static void main(final String[] arr) throws IOException {
        ...
        final DataGenerator hl20 = createStandardGenerator(path13, (Collection<Path>)optionSet12.<String>valuesOf(optionSpec11).stream().map(string -> Paths.get(string, new String[0])).collect(Collectors.toList()), boolean15, boolean16, boolean17, boolean18, boolean19);
        hl20.run();
    }
