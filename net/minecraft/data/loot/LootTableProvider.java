...
public class LootTableProvider implements DataProvider {
    ...
    public LootTableProvider(final DataGenerator hl) {
        this.subProviders = ImmutableList.of(Pair.<Object, LootContextParamSet>of(FishingLoot::new, LootContextParamSets.FISHING), Pair.<Object, LootContextParamSet>of(ChestLoot::new, LootContextParamSets.CHEST), Pair.<Object, LootContextParamSet>of(EntityLoot::new, LootContextParamSets.ENTITY), Pair.<Object, LootContextParamSet>of(BlockLoot::new, LootContextParamSets.BLOCK), Pair.<Object, LootContextParamSet>of(PiglinBarterLoot::new, LootContextParamSets.PIGLIN_BARTER), Pair.<Object, LootContextParamSet>of(GiftLoot::new, LootContextParamSets.GIFT));
        this.generator = hl;
    }
    
    public void run(final HashCache hn) {
        final Path path3 = this.generator.getOutputFolder();
        final Map<ResourceLocation, LootTable> map4 = Maps.newHashMap();
        this.subProviders.forEach(pair -> ((Consumer)pair.getFirst().get()).accept(((vk, a) -> {
            if (map4.put((Object)vk, (Object)a.setParamSet(pair.getSecond()).build()) != null) {
        ...
        final Set<ResourceLocation> set6 = Sets.difference(BuiltInLootTables.all(), map4.keySet());
        ...
        if (!multimap7.isEmpty()) {
            multimap7.forEach((java.util.function.BiConsumer<? super String, ? super String>)((string1, string2) -> LootTableProvider.LOGGER.warn("Found validation problem in " + string1 + ": " + string2)));
