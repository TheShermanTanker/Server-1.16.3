...
public class EntityLoot implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
    ...
    public void accept(final BiConsumer<ResourceLocation, LootTable.Builder> biConsumer) {
        ...
        //  1486: invokevirtual   net/minecraft/world/level/storage/loot/LootPool$Builder.when:(Lnet/minecraft/world/level/storage/loot/predicates/LootItemCondition$Builder;)invokevirtual  !!! ERROR
        //  1489: ldc_w           0.025
        //  1492: ldc_w           0.01
    ...
    static {
        ...
        SPECIAL_LOOT_TABLE_TYPES = (Set)ImmutableSet.<EntityType<Player>>of(EntityType.PLAYER, (EntityType<Player>)EntityType.ARMOR_STAND, (EntityType<Player>)EntityType.IRON_GOLEM, (EntityType<Player>)EntityType.SNOW_GOLEM, (EntityType<Player>)EntityType.VILLAGER);
    }
}
