...
public class ModelTemplate {
    ...
    public ModelTemplate(final Optional<ResourceLocation> optional1, final Optional<String> optional2, final TextureSlot... arr) {
        ...
        this.requiredSlots = ImmutableSet.copyOf(arr);
    }
    ...
    private Map<TextureSlot, ResourceLocation> createMap(final TextureMapping iz) {
        return (Map<TextureSlot, ResourceLocation>)Streams.concat((java.util.stream.Stream<?>[])new Stream[] { this.requiredSlots.stream(), iz.getForced() }).collect((Collector)ImmutableMap.toImmutableMap((java.util.function.Function<? super Object, ?>)Function.identity(), (java.util.function.Function<? super Object, ?>)iz::get));
    }
}
