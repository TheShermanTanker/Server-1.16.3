...
public class ModelProvider implements DataProvider {
    ...
    public void run(final HashCache hn) {
        ...
        final Map<Block, BlockStateGenerator> map4 = Maps.newHashMap();
        ...
        final Map<ResourceLocation, Supplier<JsonElement>> map5 = Maps.newHashMap();
        final Set<Item> set7 = Sets.newHashSet();
