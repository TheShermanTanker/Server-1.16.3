...
public final class Selector {
    ...
    public Selector extend(final Property.Value<?> a) {
        return new Selector((List<Property.Value<?>>)ImmutableList.<Property.Value<?>>builder().addAll((java.lang.Iterable<? extends Property.Value<?>>)this.values).add(a).build());
    }
    
    public Selector extend(final Selector iq) {
        return new Selector((List<Property.Value<?>>)ImmutableList.builder().addAll((java.lang.Iterable<?>)this.values).addAll((java.lang.Iterable<?>)iq.values).build());
    }
    ...
    public static Selector of(final Property.Value<?>... arr) {
        return new Selector(ImmutableList.copyOf(arr));
    }
    ...
    static {
        EMPTY = new Selector(ImmutableList.of());
