...
public class VariantProperties {
    ...
    static {
        X_ROT = new VariantProperty<Rotation>("x", (java.util.function.Function<Rotation, JsonElement>)(a -> new JsonPrimitive(a.value)));
        Y_ROT = new VariantProperty<Rotation>("y", (java.util.function.Function<Rotation, JsonElement>)(a -> new JsonPrimitive(a.value)));
