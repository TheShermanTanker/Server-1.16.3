...
public class BiomeReport implements DataProvider {
    ...
    public void run(final HashCache hn) {
        ...
        for (final Map.Entry<ResourceKey<Biome>, Biome> entry5 : BuiltinRegistries.BIOME.entrySet()) {
            ...
            final Function<Supplier<Biome>, DataResult<JsonElement>> function8 = JsonOps.INSTANCE.<Supplier<Biome>>withEncoder(Biome.CODEC);
            try {
                final Optional<JsonElement> optional9 = ((DataResult)function8.apply((() -> bss7))).result();
