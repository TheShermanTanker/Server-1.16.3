...
public class AdvancementProvider implements DataProvider {
    ...
    public AdvancementProvider(final DataGenerator hl) {
        this.tabs = ImmutableList.of(new TheEndAdvancements(), new HusbandryAdvancements(), new AdventureAdvancements(), new NetherAdvancements(), new StoryAdvancements());
        this.generator = hl;
    }
    ...
    public void run(final HashCache hn) throws IOException {
        ...
        final Consumer<Advancement> consumer5 = (Consumer<Advancement>)(y -> {
            ...
            try {
                DataProvider.save(AdvancementProvider.GSON, hn, y.deconstruct().serializeToJson(), path2);
            }
