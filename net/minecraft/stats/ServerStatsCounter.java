...
public class ServerStatsCounter extends StatsCounter {
    ...
    private Set<Stat<?>> getDirty() {
        final Set<Stat<?>> set2 = Sets.newHashSet((java.lang.Iterable<?>)this.dirty);
        this.dirty.clear();
        return set2;
    }
    ...
    protected String toJson() {
        final Map<StatType<?>, JsonObject> map2 = Maps.newHashMap();
        for (final Object2IntMap.Entry<Stat<?>> entry4 : this.stats.object2IntEntrySet()) {
            final Stat<?> adv5 = entry4.getKey();
            ((JsonObject)map2.computeIfAbsent(adv5.getType(), adx -> new JsonObject())).addProperty(ServerStatsCounter.getKey(adv5).toString(), entry4.getIntValue());
        }
    ...
    public void sendStats(final ServerPlayer aah) {
        ...
        final Object2IntMap<Stat<?>> object2IntMap4 = new Object2IntOpenHashMap<Stat<?>>();
