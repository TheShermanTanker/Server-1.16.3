...
public final class RecipeBookSettings {
    ...
    public RecipeBookSettings() {
        this(Util.make((Map)Maps.<RecipeBookType, Object>newEnumMap(RecipeBookType.class), (java.util.function.Consumer<Map>)(enumMap -> {
    ...
    public static RecipeBookSettings read(final FriendlyByteBuf nf) {
        final Map<RecipeBookType, TypeSettings> map2 = Maps.newEnumMap(RecipeBookType.class);
    ...
    public static RecipeBookSettings read(final CompoundTag md) {
        ...
        RecipeBookSettings.TAG_FIELDS.forEach((bjh, pair) -> {
            final boolean boolean5 = md.getBoolean(pair.getFirst());
    ...
    public void write(final CompoundTag md) {
        RecipeBookSettings.TAG_FIELDS.forEach((bjh, pair) -> {
            ...
            md.putBoolean(pair.getFirst(), a5.open);
    ...
    static {
        TAG_FIELDS = (Map)ImmutableMap.<RecipeBookType, Pair<String, String>>of(RecipeBookType.CRAFTING, Pair.<String, String>of("isGuiOpen", "isFilteringCraftable"), RecipeBookType.FURNACE, Pair.<String, String>of("isFurnaceGuiOpen", "isFurnaceFilteringCraftable"), RecipeBookType.BLAST_FURNACE, Pair.<String, String>of("isBlastingFurnaceGuiOpen", "isBlastingFurnaceFilteringCraftable"), RecipeBookType.SMOKER, Pair.<String, String>of("isSmokerGuiOpen", "isSmokerFilteringCraftable"));
    }
