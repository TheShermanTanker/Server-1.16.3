...
public class BlockPos extends Vec3i {
    ...
    public BlockPos m(final int integer) {
    ...
    public BlockPos l(final int integer) {
    ...
    public static Iterable<MutableBlockPos> spiralAround(final BlockPos fx, final int integer, final Direction gc3, final Direction gc4) {
        Validate.validState(gc3.getAxis() != gc4.getAxis(), "The two directions cannot be on the same axis");
    ...
    static {
        CODEC = Codec.INT_STREAM.<BlockPos>comapFlatMap((java.util.function.Function<? super Object, ? extends DataResult<? extends BlockPos>>)(intStream -> Util.fixedSize(intStream, 3).map((java.util.function.Function<? super int[], ?>)(arr -> new BlockPos(arr[0], arr[1], arr[2])))), (java.util.function.Function<? super BlockPos, ?>)(fx -> IntStream.of(new int[] { fx.getX(), fx.getY(), fx.getZ() }))).stable();
