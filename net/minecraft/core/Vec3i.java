...
public class Vec3i implements Comparable<Vec3i> {
    ...
    static {
        CODEC = Codec.INT_STREAM.<Vec3i>comapFlatMap((java.util.function.Function<? super Object, ? extends DataResult<? extends Vec3i>>)(intStream -> Util.fixedSize(intStream, 3).map((java.util.function.Function<? super int[], ?>)(arr -> new Vec3i(arr[0], arr[1], arr[2])))), (java.util.function.Function<? super Vec3i, ?>)(gr -> IntStream.of(new int[] { gr.getX(), gr.getY(), gr.getZ() })));
