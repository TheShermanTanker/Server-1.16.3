...
public final class SerializableUUID {
    ...
    static {
        CODEC = Codec.INT_STREAM.<UUID>comapFlatMap((java.util.function.Function<? super Object, ? extends DataResult<? extends UUID>>)(intStream -> Util.fixedSize(intStream, 4).map((java.util.function.Function<? super int[], ?>)SerializableUUID::uuidFromIntArray)), (java.util.function.Function<? super UUID, ?>)(uUID -> Arrays.stream(uuidToIntArray(uUID))));
    }
}
