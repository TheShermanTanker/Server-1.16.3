...
public abstract class RegistryAccess {
    ...
    private static <E> void put(final ImmutableMap.Builder<ResourceKey<? extends Registry<?>>, RegistryData<?>> builder, final ResourceKey<? extends Registry<E>> vj, final Codec<E> codec) {
        builder.put(vj, new RegistryData<>(vj, (Codec<Object>)codec, null));
    }
    ...
    private static <E> void put(final ImmutableMap.Builder<ResourceKey<? extends Registry<?>>, RegistryData<?>> builder, final ResourceKey<? extends Registry<E>> vj, final Codec<E> codec3, final Codec<E> codec4) {
        builder.put(vj, new RegistryData<>(vj, (Codec<Object>)codec3, (Codec<Object>)codec4));
    }
    ...
    public static RegistryHolder builtin() {
        ...
        RegistryReadOps.create((DynamicOps<Object>)JsonOps.INSTANCE, a2, b1);
        return b1;
    }
    ...
    private static <E> void addBuiltinElements(final RegistryHolder b, final RegistryReadOps.ResourceAccess.MemoryMap a, final RegistryData<E> a) {
        ...
        for (final Map.Entry<ResourceKey<E>, E> entry9 : gm6.entrySet()) {
            ...
            if (boolean5) {
                a.<E>add(RegistryAccess.BUILTIN, (ResourceKey<E>)entry9.getKey(), a.codec(), gm6.getId(object10), object10, gm6.lifecycle(object10));
            }
            else {
    ...
    static {
        ...
        REGISTRIES = Util.<Map>make((java.util.function.Supplier<Map>)(() -> {
            final ImmutableMap.Builder<ResourceKey<? extends Registry<?>>, RegistryData<?>> builder1 = ImmutableMap.<ResourceKey<? extends Registry<?>>, RegistryData<?>>builder();
    ...
    public static final class RegistryHolder extends RegistryAccess {
        ...
        private static <E> Codec<RegistryHolder> makeNetworkCodec() {
            final Codec<ResourceKey<? extends Registry<E>>> codec1 = ResourceLocation.CODEC.<ResourceKey<? extends Registry<E>>>xmap((java.util.function.Function<? super ResourceLocation, ? extends ResourceKey<? extends Registry<E>>>)ResourceKey::createRegistryKey, (java.util.function.Function<? super ResourceKey<? extends Registry<E>>, ? extends ResourceLocation>)ResourceKey::location);
            final Codec<MappedRegistry<E>> codec2 = codec1.<MappedRegistry<E>>partialDispatch("type", (java.util.function.Function<? super MappedRegistry<E>, ? extends DataResult<? extends ResourceKey<? extends Registry<E>>>>)(gi -> DataResult.<ResourceKey>success(gi.key())), (java.util.function.Function<? super ResourceKey<? extends Registry<E>>, ? extends DataResult<? extends Codec<? extends MappedRegistry<E>>>>)(vj -> RegistryHolder.getNetworkCodec(vj).map((java.util.function.Function<? super Codec<Object>, ?>)(codec -> MappedRegistry.networkCodec(vj, Lifecycle.experimental(), (Codec<Object>)codec)))));
            final UnboundedMapCodec<? extends ResourceKey<? extends Registry<?>>, ? extends MappedRegistry<?>> unboundedMapCodec3 = Codec.unboundedMap(codec1, codec2);
        ...
        private static <K extends ResourceKey<? extends Registry<?>>, V extends MappedRegistry<?>> Codec<RegistryHolder> captureMap(final UnboundedMapCodec<K, V> unboundedMapCodec) {
            return unboundedMapCodec.<RegistryHolder>xmap((java.util.function.Function<? super Object, ? extends RegistryHolder>)RegistryHolder::new, (java.util.function.Function<? super RegistryHolder, ?>)(b -> (ImmutableMap)b.registries.entrySet().stream().filter(entry -> ((RegistryData)RegistryAccess.REGISTRIES.get(entry.getKey())).sendToClient()).collect((Collector)ImmutableMap.toImmutableMap((java.util.function.Function<? super Object, ?>)Map.Entry::getKey, (java.util.function.Function<? super Object, ?>)Map.Entry::getValue))));
        }
