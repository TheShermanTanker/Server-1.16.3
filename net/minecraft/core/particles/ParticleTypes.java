...
public class ParticleTypes {
    ...
    static {
        ...
        BLOCK = ParticleTypes.<BlockParticleOption>register("block", BlockParticleOption.DESERIALIZER, (java.util.function.Function<ParticleType<BlockParticleOption>, Codec<BlockParticleOption>>)BlockParticleOption::codec);
        ...
        DUST = ParticleTypes.<DustParticleOptions>register("dust", DustParticleOptions.DESERIALIZER, (java.util.function.Function<ParticleType<DustParticleOptions>, Codec<DustParticleOptions>>)(hg -> DustParticleOptions.CODEC));
        ...
        FALLING_DUST = ParticleTypes.<BlockParticleOption>register("falling_dust", BlockParticleOption.DESERIALIZER, (java.util.function.Function<ParticleType<BlockParticleOption>, Codec<BlockParticleOption>>)BlockParticleOption::codec);
        ...
        ITEM = ParticleTypes.<ItemParticleOption>register("item", ItemParticleOption.DESERIALIZER, (java.util.function.Function<ParticleType<ItemParticleOption>, Codec<ItemParticleOption>>)ItemParticleOption::codec);
        ...
        CODEC = Registry.PARTICLE_TYPE.<ParticleOptions>dispatch("type", (java.util.function.Function<? super ParticleOptions, ?>)ParticleOptions::getType, (java.util.function.Function<? super Object, ? extends Codec<? extends ParticleOptions>>)ParticleType::codec);
    }
}
