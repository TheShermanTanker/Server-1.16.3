...
public class BlockParticleOption implements ParticleOptions {
    ...
    public static Codec<BlockParticleOption> codec(final ParticleType<BlockParticleOption> hg) {
        return BlockState.CODEC.<BlockParticleOption>xmap((java.util.function.Function<? super BlockState, ? extends BlockParticleOption>)(cee -> new BlockParticleOption(hg, cee)), (java.util.function.Function<? super BlockParticleOption, ? extends BlockState>)(hc -> hc.state));
    }
