...
public class ItemParticleOption implements ParticleOptions {
    ...
    public static Codec<ItemParticleOption> codec(final ParticleType<ItemParticleOption> hg) {
        return ItemStack.CODEC.<ItemParticleOption>xmap((java.util.function.Function<? super ItemStack, ? extends ItemParticleOption>)(bly -> new ItemParticleOption(hg, bly)), (java.util.function.Function<? super ItemParticleOption, ? extends ItemStack>)(he -> he.itemStack));
    }
