...
public class ListPlayersCommand {
    public static void register(final CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder<CommandSourceStack>)Commands.literal("list").executes(commandContext -> listPlayers(commandContext.getSource())).then(Commands.literal("uuids").executes(commandContext -> listPlayersWithUuids(commandContext.getSource()))));
    }
