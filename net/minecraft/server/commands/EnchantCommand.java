...
public class EnchantCommand {
    ...
    public static void register(final CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder<CommandSourceStack>)Commands.literal("enchant").requires((java.util.function.Predicate<CommandSourceStack>)(db -> db.hasPermission(2))).then(Commands.argument("targets", (ArgumentType<Object>)EntityArgument.entities()).then(Commands.argument("enchantment", (ArgumentType<Object>)ItemEnchantmentArgument.enchantment()).executes(commandContext -> enchant(commandContext.getSource(), EntityArgument.getEntities(commandContext, "targets"), ItemEnchantmentArgument.getEnchantment(commandContext, "enchantment"), 1)).then(Commands.argument("level", (ArgumentType<Object>)IntegerArgumentType.integer(0)).executes(commandContext -> enchant(commandContext.getSource(), EntityArgument.getEntities(commandContext, "targets"), ItemEnchantmentArgument.getEnchantment(commandContext, "enchantment"), IntegerArgumentType.getInteger(commandContext, "level")))))));
    }
    ...
    static {
        ERROR_NOT_LIVING_ENTITY = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("commands.enchant.failed.entity", new Object[] { object })));
        ERROR_NO_ITEM = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("commands.enchant.failed.itemless", new Object[] { object })));
        ERROR_INCOMPATIBLE = new DynamicCommandExceptionType((Function<Object, Message>)(object -> new TranslatableComponent("commands.enchant.failed.incompatible", new Object[] { object })));
        final TranslatableComponent translatableComponent;
        ERROR_LEVEL_TOO_HIGH = new Dynamic2CommandExceptionType((object1, object2) -> {
            new TranslatableComponent("commands.enchant.failed.level", new Object[] { object1, object2 });
            return translatableComponent;
        });
        ERROR_NOTHING_HAPPENED = new SimpleCommandExceptionType(new TranslatableComponent("commands.enchant.failed"));
    }
}
