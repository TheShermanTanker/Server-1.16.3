...
public class TeamMsgCommand {
    ...
    public static void register(final CommandDispatcher<CommandSourceStack> commandDispatcher) {
        final LiteralCommandNode<CommandSourceStack> literalCommandNode2 = commandDispatcher.register(Commands.literal("teammsg").then(Commands.argument("message", (ArgumentType<Object>)MessageArgument.message()).executes(commandContext -> sendMessage(commandContext.getSource(), MessageArgument.getMessage(commandContext, "message")))));
        commandDispatcher.register(Commands.literal("tm").redirect((CommandNode<CommandSourceStack>)literalCommandNode2));
    }
