...
public class AdvancementCommands {
    ...
    public static void register(final CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder<CommandSourceStack>)((LiteralArgumentBuilder)Commands.literal("advancement").requires((java.util.function.Predicate<CommandSourceStack>)(db -> db.hasPermission(2))).then(Commands.literal("grant").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("targets", (ArgumentType<Object>)EntityArgument.players()).then(Commands.literal("only").then(Commands.argument("advancement", (ArgumentType<Object>)ResourceLocationArgument.id()).suggests(AdvancementCommands.SUGGEST_ADVANCEMENTS).executes(commandContext -> perform(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.GRANT, (Collection<Advancement>)getAdvancements(ResourceLocationArgument.getAdvancement(commandContext, "advancement"), Mode.ONLY))).then(Commands.argument("criterion", (ArgumentType<Object>)StringArgumentType.greedyString()).suggests((commandContext, suggestionsBuilder) -> SharedSuggestionProvider.suggest((Iterable<String>)ResourceLocationArgument.getAdvancement(commandContext, "advancement").getCriteria().keySet(), suggestionsBuilder)).executes(commandContext -> performCriterion(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.GRANT, ResourceLocationArgument.getAdvancement(commandContext, "advancement"), StringArgumentType.getString(commandContext, "criterion")))))).then(Commands.literal("from").then(Commands.argument("advancement", (ArgumentType<Object>)ResourceLocationArgument.id()).suggests(AdvancementCommands.SUGGEST_ADVANCEMENTS).executes(commandContext -> perform(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.GRANT, (Collection<Advancement>)getAdvancements(ResourceLocationArgument.getAdvancement(commandContext, "advancement"), Mode.FROM)))))).then(Commands.literal("until").then(Commands.argument("advancement", (ArgumentType<Object>)ResourceLocationArgument.id()).suggests(AdvancementCommands.SUGGEST_ADVANCEMENTS).executes(commandContext -> perform(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.GRANT, (Collection<Advancement>)getAdvancements(ResourceLocationArgument.getAdvancement(commandContext, "advancement"), Mode.UNTIL)))))).then(Commands.literal("through").then(Commands.argument("advancement", (ArgumentType<Object>)ResourceLocationArgument.id()).suggests(AdvancementCommands.SUGGEST_ADVANCEMENTS).executes(commandContext -> perform(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.GRANT, (Collection<Advancement>)getAdvancements(ResourceLocationArgument.getAdvancement(commandContext, "advancement"), Mode.THROUGH)))))).then(Commands.literal("everything").executes(commandContext -> perform(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.GRANT, commandContext.getSource().getServer().getAdvancements().getAllAdvancements())))))).then(Commands.literal("revoke").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)Commands.argument("targets", (ArgumentType<Object>)EntityArgument.players()).then(Commands.literal("only").then(Commands.argument("advancement", (ArgumentType<Object>)ResourceLocationArgument.id()).suggests(AdvancementCommands.SUGGEST_ADVANCEMENTS).executes(commandContext -> perform(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.REVOKE, (Collection<Advancement>)getAdvancements(ResourceLocationArgument.getAdvancement(commandContext, "advancement"), Mode.ONLY))).then(Commands.argument("criterion", (ArgumentType<Object>)StringArgumentType.greedyString()).suggests((commandContext, suggestionsBuilder) -> SharedSuggestionProvider.suggest((Iterable<String>)ResourceLocationArgument.getAdvancement(commandContext, "advancement").getCriteria().keySet(), suggestionsBuilder)).executes(commandContext -> performCriterion(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.REVOKE, ResourceLocationArgument.getAdvancement(commandContext, "advancement"), StringArgumentType.getString(commandContext, "criterion")))))).then(Commands.literal("from").then(Commands.argument("advancement", (ArgumentType<Object>)ResourceLocationArgument.id()).suggests(AdvancementCommands.SUGGEST_ADVANCEMENTS).executes(commandContext -> perform(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.REVOKE, (Collection<Advancement>)getAdvancements(ResourceLocationArgument.getAdvancement(commandContext, "advancement"), Mode.FROM)))))).then(Commands.literal("until").then(Commands.argument("advancement", (ArgumentType<Object>)ResourceLocationArgument.id()).suggests(AdvancementCommands.SUGGEST_ADVANCEMENTS).executes(commandContext -> perform(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.REVOKE, (Collection<Advancement>)getAdvancements(ResourceLocationArgument.getAdvancement(commandContext, "advancement"), Mode.UNTIL)))))).then(Commands.literal("through").then(Commands.argument("advancement", (ArgumentType<Object>)ResourceLocationArgument.id()).suggests(AdvancementCommands.SUGGEST_ADVANCEMENTS).executes(commandContext -> perform(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.REVOKE, (Collection<Advancement>)getAdvancements(ResourceLocationArgument.getAdvancement(commandContext, "advancement"), Mode.THROUGH)))))).then(Commands.literal("everything").executes(commandContext -> perform(commandContext.getSource(), EntityArgument.getPlayers(commandContext, "targets"), Action.REVOKE, commandContext.getSource().getServer().getAdvancements().getAllAdvancements()))))));
    }
    ...
    static {
        final Collection<Advancement> collection3;
        SUGGEST_ADVANCEMENTS = ((commandContext, suggestionsBuilder) -> {
            collection3 = commandContext.getSource().getServer().getAdvancements().getAllAdvancements();
