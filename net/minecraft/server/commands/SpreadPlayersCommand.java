...
public class SpreadPlayersCommand {
    ...
    public static void register(final CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder<CommandSourceStack>)Commands.literal("spreadplayers").requires((java.util.function.Predicate<CommandSourceStack>)(db -> db.hasPermission(2))).then(Commands.argument("center", (ArgumentType<Object>)Vec2Argument.vec2()).then(Commands.argument("spreadDistance", (ArgumentType<Object>)FloatArgumentType.floatArg(0.0f)).then(Commands.argument("maxRange", (ArgumentType<Object>)FloatArgumentType.floatArg(1.0f)).then(Commands.argument("respectTeams", (ArgumentType<Object>)BoolArgumentType.bool()).then(Commands.argument("targets", (ArgumentType<Object>)EntityArgument.entities()).executes(commandContext -> spreadPlayers(commandContext.getSource(), Vec2Argument.getVec2(commandContext, "center"), FloatArgumentType.getFloat(commandContext, "spreadDistance"), FloatArgumentType.getFloat(commandContext, "maxRange"), 256, BoolArgumentType.getBool(commandContext, "respectTeams"), EntityArgument.getEntities(commandContext, "targets"))))).then(Commands.literal("under").then(Commands.argument("maxHeight", (ArgumentType<Object>)IntegerArgumentType.integer(0)).then(Commands.argument("respectTeams", (ArgumentType<Object>)BoolArgumentType.bool()).then(Commands.argument("targets", (ArgumentType<Object>)EntityArgument.entities()).executes(commandContext -> spreadPlayers(commandContext.getSource(), Vec2Argument.getVec2(commandContext, "center"), FloatArgumentType.getFloat(commandContext, "spreadDistance"), FloatArgumentType.getFloat(commandContext, "maxRange"), IntegerArgumentType.getInteger(commandContext, "maxHeight"), BoolArgumentType.getBool(commandContext, "respectTeams"), EntityArgument.getEntities(commandContext, "targets")))))))))));
    }
    ...
    private static int getNumberOfTeams(final Collection<? extends Entity> collection) {
        final Set<Team> set2 = Sets.newHashSet();
    ...
    private static double setPlayerPositions(final Collection<? extends Entity> collection, final ServerLevel aag, final Position[] arr, final int integer, final boolean boolean5) {
        double double6 = 0.0;
        int integer2 = 0;
        final Map<Team, Position> map9 = Maps.newHashMap();
    ...
    static {
        ...
        ERROR_FAILED_TO_SPREAD_TEAMS = new Dynamic4CommandExceptionType((object1, object2, object3, object4) -> {
            new TranslatableComponent("commands.spreadplayers.failed.teams", new Object[] { object1, object2, object3, object4 });
            return translatableComponent;
        });
        final TranslatableComponent translatableComponent2;
        ERROR_FAILED_TO_SPREAD_ENTITIES = new Dynamic4CommandExceptionType((object1, object2, object3, object4) -> {
            new TranslatableComponent("commands.spreadplayers.failed.entities", new Object[] { object1, object2, object3, object4 });
