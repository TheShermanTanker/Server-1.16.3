...
public class ForceLoadCommand {
    ...
    public static void register(final CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder<CommandSourceStack>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal("forceload").requires((java.util.function.Predicate<CommandSourceStack>)(db -> db.hasPermission(2))).then(Commands.literal("add").then(Commands.argument("from", (ArgumentType<Object>)ColumnPosArgument.columnPos()).executes(commandContext -> changeForceLoad(commandContext.getSource(), ColumnPosArgument.getColumnPos(commandContext, "from"), ColumnPosArgument.getColumnPos(commandContext, "from"), true)).then(Commands.argument("to", (ArgumentType<Object>)ColumnPosArgument.columnPos()).executes(commandContext -> changeForceLoad(commandContext.getSource(), ColumnPosArgument.getColumnPos(commandContext, "from"), ColumnPosArgument.getColumnPos(commandContext, "to"), true)))))).then(Commands.literal("remove").then(Commands.argument("from", (ArgumentType<Object>)ColumnPosArgument.columnPos()).executes(commandContext -> changeForceLoad(commandContext.getSource(), ColumnPosArgument.getColumnPos(commandContext, "from"), ColumnPosArgument.getColumnPos(commandContext, "from"), false)).then(Commands.argument("to", (ArgumentType<Object>)ColumnPosArgument.columnPos()).executes(commandContext -> changeForceLoad(commandContext.getSource(), ColumnPosArgument.getColumnPos(commandContext, "from"), ColumnPosArgument.getColumnPos(commandContext, "to"), false)))).then(Commands.literal("all").executes(commandContext -> removeAll(commandContext.getSource()))))).then(Commands.literal("query").executes(commandContext -> listForceLoad(commandContext.getSource())).then(Commands.argument("pos", (ArgumentType<Object>)ColumnPosArgument.columnPos()).executes(commandContext -> queryForceLoad(commandContext.getSource(), ColumnPosArgument.getColumnPos(commandContext, "pos"))))));
    }
    ...
    static {
        ...
        ERROR_TOO_MANY_CHUNKS = new Dynamic2CommandExceptionType((object1, object2) -> {
            new TranslatableComponent("commands.forceload.toobig", new Object[] { object1, object2 });
            return translatableComponent;
        });
        final TranslatableComponent translatableComponent2;
        ERROR_NOT_TICKING = new Dynamic2CommandExceptionType((object1, object2) -> {
            new TranslatableComponent("commands.forceload.query.failure", new Object[] { object1, object2 });
            return translatableComponent2;
        });
        ERROR_ALL_ADDED = new SimpleCommandExceptionType(new TranslatableComponent("commands.forceload.added.failure"));
        ERROR_NONE_REMOVED = new SimpleCommandExceptionType(new TranslatableComponent("commands.forceload.removed.failure"));
    }
}
