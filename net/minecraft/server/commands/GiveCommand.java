...
public class GiveCommand {
    public static void register(final CommandDispatcher<CommandSourceStack> commandDispatcher) {
        commandDispatcher.register((LiteralArgumentBuilder<CommandSourceStack>)Commands.literal("give").requires((java.util.function.Predicate<CommandSourceStack>)(db -> db.hasPermission(2))).then(Commands.argument("targets", (ArgumentType<Object>)EntityArgument.players()).then(Commands.argument("item", (ArgumentType<Object>)ItemArgument.item()).executes(commandContext -> giveItem(commandContext.getSource(), ItemArgument.getItem((CommandContext<Object>)commandContext, "item"), EntityArgument.getPlayers(commandContext, "targets"), 1)).then(Commands.argument("count", (ArgumentType<Object>)IntegerArgumentType.integer(1)).executes(commandContext -> giveItem(commandContext.getSource(), ItemArgument.getItem((CommandContext<Object>)commandContext, "item"), EntityArgument.getPlayers(commandContext, "targets"), IntegerArgumentType.getInteger(commandContext, "count")))))));
    }
