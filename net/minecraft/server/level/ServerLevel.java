...
public class ServerLevel extends Level implements WorldGenLevel {
    ...
    public ServerLevel(final MinecraftServer minecraftServer, final Executor executor, final LevelStorageSource.LevelStorageAccess a, final ServerLevelData cyj, final ResourceKey<Level> vj, final DimensionType cha, final ChunkProgressListener aap, final ChunkGenerator cfv, final boolean boolean9, final long long10, final List<CustomSpawner> list, final boolean boolean12) {
        ...
        this.entitiesById = new Int2ObjectLinkedOpenHashMap<Entity>();
        ...
        this.blockEvents = new ObjectLinkedOpenHashSet<BlockEventData>();
    ...
    public void tick(final BooleanSupplier booleanSupplier) {
        ...
        if (boolean7 || this.emptyTime++ < 300) {
            ...
            final ObjectIterator<Int2ObjectMap.Entry<Entity>> objectIterator6 = this.entitiesById.int2ObjectEntrySet().iterator();
    ...
    private void runBlockEvents() {
        ...
        // Original Bytecode:
        // 
        //     1: getfield        net/minecraft/server/level/ServerLevel.blockEvents:Lit/unimi/dsi/fastutil/objects/ObjectLinkedOpenHashSet;
        //     4: invokevirtual   it/unimi/dsi/fastutil/objects/ObjectLinkedOpenHashSet.isEmpty:()Z
        //     7: ifne            97
        //    10: aload_0         /* this */
        //    11: getfield        net/minecraft/server/level/ServerLevel.blockEvents:Lit/unimi/dsi/fastutil/objects/ObjectLinkedOpenHashSet;
        //    14: invokevirtual   it/unimi/dsi/fastutil/objects/ObjectLinkedOpenHashSet.removeFirst:()Ljava/lang/Object;
        //    17: checkcast       Lnet/minecraft/world/level/BlockEventData;
        //    20: astore_1        /* bqy2 */
        //    21: aload_0         /* this */
        //    22: aload_1         /* bqy2 */
        //    23: invokespecial   net/minecraft/server/level/ServerLevel.doBlockEvent:(Lnet/minecraft/world/level/BlockEventData;)Z
        //    26: ifeq            94
        //    29: aload_0         /* this */
        //    30: getfield        net/minecraft/server/level/ServerLevel.server:Lnet/minecraft/server/MinecraftServer;
        //    33: invokevirtual   net/minecraft/server/MinecraftServer.getPlayerList:()Lnet/minecraft/server/players/PlayerList;
        //    36: aconst_null    
        //    37: aload_1         /* bqy2 */
        //    38: invokevirtual   net/minecraft/world/level/BlockEventData.getPos:()Lnet/minecraft/core/BlockPos;
        //    41: invokevirtual   net/minecraft/core/BlockPos.getX:()I
        //    44: i2d            
        //    45: aload_1         /* bqy2 */
        //    46: invokevirtual   net/minecraft/world/level/BlockEventData.getPos:()Lnet/minecraft/core/BlockPos;
        //    49: invokevirtual   net/minecraft/core/BlockPos.getY:()I
        //    52: i2d            
        //    53: aload_1         /* bqy2 */
        //    54: invokevirtual   net/minecraft/world/level/BlockEventData.getPos:()Lnet/minecraft/core/BlockPos;
        //    57: invokevirtual   net/minecraft/core/BlockPos.getZ:()I
        //    60: i2d            
        //    61: ldc2_w          64.0
        //    64: aload_0         /* this */
        //    65: invokevirtual   net/minecraft/server/level/ServerLevel.dimension:()Lnet/minecraft/resources/ResourceKey;
        //    68: new             Lnet/minecraft/network/protocol/game/ClientboundBlockEventPacket;
        //    71: dup            
        //    72: aload_1         /* bqy2 */
        //    73: invokevirtual   net/minecraft/world/level/BlockEventData.getPos:()Lnet/minecraft/core/BlockPos;
        //    76: aload_1         /* bqy2 */
        //    77: invokevirtual   net/minecraft/world/level/BlockEventData.getBlock:()Lnet/minecraft/world/level/block/Block;
        //    80: aload_1         /* bqy2 */
        //    81: invokevirtual   net/minecraft/world/level/BlockEventData.getParamA:()I
        //    84: aload_1         /* bqy2 */
        //    85: invokevirtual   net/minecraft/world/level/BlockEventData.getParamB:()I
        //    88: invokespecial   net/minecraft/network/protocol/game/ClientboundBlockEventPacket.<init>:(Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/level/block/Block;II)V
        //    91: invokevirtual   net/minecraft/server/players/PlayerList.broadcast:(Lnet/minecraft/world/entity/player/Player;DDDDLnet/minecraft/resources/ResourceKey;Lnet/minecraft/network/protocol/Packet;)V
        //    94: goto            0
        //    97: return         
        //    StackMapTable: 00 03 00 FB 00 5D FA 00 02
        // 
    ...
    public Entity getEntity(final int integer) {
        return this.entitiesById.get(integer);
    }
    ...
    public LongSet getForcedChunks() {
        ...
        return (brp2 != null) ? LongSets.unmodifiable(brp2.getChunks()) : LongSets.EMPTY_SET;
    }
    ...
    public Iterable<Entity> getAllEntities() {
        return Iterables.<Entity>unmodifiableIterable((java.lang.Iterable<? extends Entity>)this.entitiesById.values());
    }
