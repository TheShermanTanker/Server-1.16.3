...
public abstract class DistanceManager {
    ...
    protected DistanceManager(final Executor executor1, final Executor executor2) {
        this.playersPerChunk = new Long2ObjectOpenHashMap<ObjectSet<ServerPlayer>>();
        this.tickets = new Long2ObjectOpenHashMap<SortedArraySet<Ticket<?>>>();
        ...
        this.ticketsToRelease = new LongOpenHashSet();
        ...
        final ChunkTaskPriorityQueueSorter zu5 = new ChunkTaskPriorityQueueSorter(ImmutableList.of(aoa4), executor1, 4);
    ...
    protected void purgeStaleTickets() {
        ...
        final ObjectIterator<Long2ObjectMap.Entry<SortedArraySet<Ticket<?>>>> objectIterator2 = this.tickets.long2ObjectEntrySet().fastIterator();
    ...
    private SortedArraySet<Ticket<?>> getTickets(final long long1) {
        return this.tickets.computeIfAbsent(long1, (java.util.function.LongFunction<? extends SortedArraySet<Ticket<?>>>)(long1 -> SortedArraySet.<Comparable>create(4)));
    }
    ...
    public void addPlayer(final SectionPos gp, final ServerPlayer aah) {
        ...
        this.playersPerChunk.computeIfAbsent(long4, (java.util.function.LongFunction<? extends ObjectSet<ServerPlayer>>)(long1 -> new ObjectOpenHashSet())).add(aah);
    ...
    public void removePlayer(final SectionPos gp, final ServerPlayer aah) {
        final long long4 = gp.chunk().toLong();
        final ObjectSet<ServerPlayer> objectSet6 = this.playersPerChunk.get(long4);
    ...
    protected String getTicketDebugString(final long long1) {
        final SortedArraySet<Ticket<?>> afn4 = this.tickets.get(long1);
        String string5;
    ...
    class ChunkTicketTracker extends ChunkTracker {
        ...
        @Override
        protected int getLevelFromSource(final long long1) {
            final SortedArraySet<Ticket<?>> afn4 = DistanceManager.this.tickets.get(long1);
            if (afn4 == null) {
