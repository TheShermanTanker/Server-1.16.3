        ...
        final Thread thread4 = new Thread(new StringBuilder().append("User Authenticator #").append(ServerLoginPacketListenerImpl.UNIQUE_THREAD_ID.incrementAndGet()).toString()) {
            public void run() {
                ...
                try {
                    ...
                    ServerLoginPacketListenerImpl.this.gameProfile = ServerLoginPacketListenerImpl.this.server.getSessionService().hasJoinedServer(new GameProfile(null, gameProfile2.getName()), string3, this.getAddress());
