...
public class Main {
    ...
    public static void main(final String[] arr) {
        ...
        final OptionSpec<Void> optionSpec9 = optionParser2.accepts("safeMode", "Loads level with vanilla datapack only");
        final OptionSpec<Void> optionSpec10 = optionParser2.accepts("help").forHelp();
        final OptionSpec<String> optionSpec11 = optionParser2.accepts("singleplayer").withRequiredArg();
        final OptionSpec<String> optionSpec12 = optionParser2.accepts("universe").withRequiredArg().defaultsTo(".", new String[0]);
        final OptionSpec<String> optionSpec13 = optionParser2.accepts("world").withRequiredArg();
        final OptionSpec<Integer> optionSpec14 = optionParser2.accepts("port").withRequiredArg().<Integer>ofType(Integer.class).defaultsTo(-1, new Integer[0]);
        final OptionSpec<String> optionSpec15 = optionParser2.accepts("serverId").withRequiredArg();
        final OptionSpec<String> optionSpec16 = optionParser2.nonOptions();
        try {
            ...
            final File file23 = new File((String)optionSet17.<String>valueOf(optionSpec12));
            ...
            final String string28 = (String)Optional.ofNullable(optionSet17.<String>valueOf(optionSpec13)).orElse(zi20.getProperties().levelName);
            ...
            final boolean boolean32 = optionSet17.has(optionSpec9);
            if (boolean32) {
            ...
            vz36.updateGlobals();
            final RegistryReadOps<Tag> vh37 = RegistryReadOps.<Tag>create((DynamicOps<Tag>)NbtOps.INSTANCE, vz36.getResourceManager(), b18);
            WorldData cyk38 = a30.getDataTag(vh37, brh32);
            if (cyk38 == null) {
                LevelSettings brx39;
                ...
                if (optionSet17.has(optionSpec5)) {
                    ...
                    cht40 = (optionSet17.has(optionSpec6) ? zh41.worldGenSettings.withBonusChest() : zh41.worldGenSettings);
                }
                cyk38 = new PrimaryLevelData(brx39, cht40, Lifecycle.stable());
            }
            if (optionSet17.has(optionSpec7)) {
                forceUpgrade(a30, DataFixers.getDataFixer(), optionSet17.has(optionSpec8), () -> true, cyk38.worldGenSettings().levels());
            }
            ...
            final DedicatedServer zg40 = MinecraftServer.<DedicatedServer>spin((java.util.function.Function<Thread, DedicatedServer>)(thread -> {
                ...
                zg18.setSingleplayerName(optionSet17.<String>valueOf(optionSpec11));
                zg18.setPort(optionSet17.<Integer>valueOf(optionSpec14));
                zg18.setDemo(optionSet17.has(optionSpec5));
                zg18.setId(optionSet17.<String>valueOf(optionSpec15));
                final boolean boolean19 = !optionSet17.has(optionSpec3) && !optionSet17.valuesOf((OptionSpec<Object>)optionSpec16).contains("nogui");
