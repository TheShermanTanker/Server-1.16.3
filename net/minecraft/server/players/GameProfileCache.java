...
public class GameProfileCache {
    ...
    public GameProfileCache(final GameProfileRepository gameProfileRepository, final File file) {
        ...
        this.file = file;
        Lists.<GameProfileInfo>reverse(this.load()).forEach(this::safeAdd);
    }
    ...
    private static GameProfile lookupGameProfile(final GameProfileRepository gameProfileRepository, final String string) {
        ...
        if (!usesAuthentication() && gameProfile5 == null) {
            final UUID uUID6 = Player.createPlayerUUID(new GameProfile(null, string));
    ...
    public List<GameProfileInfo> load() {
        final List<GameProfileInfo> list2 = Lists.newArrayList();
        try (final Reader reader3 = (Reader)Files.newReader(this.file, StandardCharsets.UTF_8)) {
            final JsonArray jsonArray5 = this.gson.<JsonArray>fromJson(reader3, JsonArray.class);
            if (jsonArray5 == null) {
                return list2;
            }
    ...
    public void save() {
        ...
        final String string4 = this.gson.toJson(jsonArray2);
    ...
    private Stream<GameProfileInfo> getTopMRUProfiles(final int integer) {
        return (Stream<GameProfileInfo>)ImmutableList.copyOf((java.util.Collection<?>)this.profilesByUUID.values()).stream().sorted(Comparator.comparing(GameProfileInfo::getLastAccess).reversed()).limit((long)integer);
    }
