...
public abstract class StoredUserList<K, V extends StoredUserEntry<K>> {
    ...
    private void removeExpired() {
        final List<K> list2 = Lists.newArrayList();
    ...
    public void save() throws IOException {
        ...
        try (final BufferedWriter bufferedWriter3 = Files.newWriter(this.file, StandardCharsets.UTF_8)) {
            StoredUserList.GSON.toJson(jsonArray2, (Appendable)bufferedWriter3);
        }
    }
    ...
    public void load() throws IOException {
        ...
        try (final BufferedReader bufferedReader2 = Files.newReader(this.file, StandardCharsets.UTF_8)) {
            final JsonArray jsonArray4 = StoredUserList.GSON.<JsonArray>fromJson((Reader)bufferedReader2, JsonArray.class);
            this.map.clear();
