...
final class ParameterFormatter {
    ...
    static String deepToString(final Object o) {
        ...
        final Set<String> dejaVu = (Set<String>)new HashSet();
    ...
    private static SimpleDateFormat getSimpleDateFormat() {
        SimpleDateFormat result = (SimpleDateFormat)ParameterFormatter.threadLocalSimpleDateFormat.get();
        if (result == null) {
        ...
        if (oClass == byte[].class) {
            ...
            if (dejaVu.contains(id)) {
                ...
                for (final Object current : oArray) {
                    ...
                    recursiveDeepToString(current, str, (Set<String>)new HashSet((Collection)dejaVu));
                }
                str.append(']');
            }
        }
    ...
    private static void appendMap(final Object o, final StringBuilder str, Set<String> dejaVu) {
        ...
        if (dejaVu.contains(id)) {
            ...
            for (final Object o2 : oMap.entrySet()) {
                ...
                recursiveDeepToString(key, str, (Set<String>)new HashSet((Collection)dejaVu));
                str.append('=');
                recursiveDeepToString(value, str, (Set<String>)new HashSet((Collection)dejaVu));
            }
            str.append('}');
        }
    }
    ...
    private static void appendCollection(final Object o, final StringBuilder str, Set<String> dejaVu) {
        ...
        if (dejaVu.contains(id)) {
            ...
            for (final Object anOCol : oCol) {
                ...
                recursiveDeepToString(anOCol, str, (Set<String>)new HashSet((Collection)dejaVu));
            }
            str.append(']');
        }
    }
    ...
    static {
        ParameterFormatter.threadLocalSimpleDateFormat = (ThreadLocal<SimpleDateFormat>)new ThreadLocal();
    }
}
