...
public class MapMessage implements MultiformatMessage, StringBuilderFormattable {
    ...
    public Map<String, String> getData() {
        final TreeMap<String, String> result = (TreeMap<String, String>)new TreeMap();
        for (int i = 0; i < this.data.size(); ++i) {
            result.put(this.data.getKeyAt(i), this.data.<String>getValueAt(i));
        }
        return (Map<String, String>)Collections.unmodifiableMap((Map)result);
    }
    ...
    public String get(final String key) {
        return this.data.<String>getValue(key);
    }
    
    public String remove(final String key) {
        final String result = this.data.<String>getValue(key);
    ...
    public String asString(final String format) {
        try {
            return this.format(EnglishEnums.<MapFormat>valueOf(MapFormat.class, format), new StringBuilder()).toString();
        }
