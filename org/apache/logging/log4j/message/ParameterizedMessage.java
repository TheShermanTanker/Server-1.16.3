...
public class ParameterizedMessage implements Message, StringBuilderFormattable {
    ...
    private static StringBuilder getThreadLocalStringBuilder() {
        StringBuilder buffer = (StringBuilder)ParameterizedMessage.threadLocalStringBuilder.get();
        if (buffer == null) {
    ...
    static {
        ParameterizedMessage.threadLocalStringBuilder = (ThreadLocal<StringBuilder>)new ThreadLocal();
    }
}
