...
public class Provider {
    ...
    public Provider(final Properties props, final URL url, final ClassLoader classLoader) {
        this.url = url;
        this.classLoader = (WeakReference<ClassLoader>)new WeakReference(classLoader);
    ...
    public Class<? extends LoggerContextFactory> loadLoggerContextFactory() {
        ...
        final ClassLoader loader = (ClassLoader)this.classLoader.get();
        if (loader == null) {
            return null;
        }
        try {
            final Class<?> clazz = loader.loadClass(this.className);
            if (LoggerContextFactory.class.isAssignableFrom((Class)clazz)) {
                return clazz.asSubclass((Class)LoggerContextFactory.class);
            }
        }
        catch (Exception e) {
    ...
    public Class<? extends ThreadContextMap> loadThreadContextMap() {
        ...
        try {
            ...
            if (ThreadContextMap.class.isAssignableFrom((Class)clazz)) {
                return clazz.asSubclass((Class)ThreadContextMap.class);
            }
        }
        catch (Exception e) {
