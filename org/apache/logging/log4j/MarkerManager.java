...
public final class MarkerManager {
    ...
    public static Marker getMarker(final String name) {
        Marker result = (Marker)MarkerManager.MARKERS.get(name);
        if (result == null) {
            MarkerManager.MARKERS.putIfAbsent(name, new Log4jMarker(name));
            result = (Marker)MarkerManager.MARKERS.get(name);
        }
        return result;
    }
    ...
    public static Marker getMarker(final String name, final String parent) {
        final Marker parentMarker = (Marker)MarkerManager.MARKERS.get(parent);
    ...
    static {
        MARKERS = (ConcurrentMap)new ConcurrentHashMap();
    }
    ...
    public static class Log4jMarker implements Marker, StringBuilderFormattable {
        ...
        public Marker[] getParents() {
            ...
            return (Marker[])Arrays.copyOf((Object[])this.parents, this.parents.length);
        }
