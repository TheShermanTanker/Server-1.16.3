...
public class StringBuilderEncoder implements Encoder<StringBuilder> {
    ...
    public StringBuilderEncoder(final Charset charset, final int charBufferSize, final int byteBufferSize) {
        this.charBufferThreadLocal = (ThreadLocal<CharBuffer>)new ThreadLocal();
        this.byteBufferThreadLocal = (ThreadLocal<ByteBuffer>)new ThreadLocal();
        this.charsetEncoderThreadLocal = (ThreadLocal<CharsetEncoder>)new ThreadLocal();
