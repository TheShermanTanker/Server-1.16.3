...
public abstract class AbstractStringLayout extends AbstractLayout<String> implements StringLayout {
    ...
    protected static StringBuilder getStringBuilder() {
        StringBuilder result = (StringBuilder)AbstractStringLayout.threadLocal.get();
        if (result == null) {
    ...
    protected byte[] getBytes(final String s) {
        if (this.useCustomEncoding) {
            return StringEncoder.encodeSingleByteChars((CharSequence)s);
        }
        try {
    ...
    protected String serializeToString(final Serializer serializer) {
        ...
        final LogEvent logEvent = this.getLogEventFactory().createEvent(rootLogger.getName(), (Marker)null, "", rootLogger.getLevel(), (Message)null, (List<Property>)null, (Throwable)null);
    ...
    public interface Serializer2 {
        StringBuilder toSerializable(final LogEvent logEvent, final StringBuilder stringBuilder);
    }
    
    public interface Serializer {
        String toSerializable(final LogEvent logEvent);
    }
}
