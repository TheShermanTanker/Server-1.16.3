...
public final class JsonLayout extends AbstractJacksonLayout {
    ...
    public String getContentType() {
        return new StringBuilder().append("application/json; charset=").append(this.getCharset()).toString();
    }
    ...
    public static JsonLayout createDefaultLayout() {
        return new JsonLayout((Configuration)new DefaultConfiguration(), false, false, false, false, false, false, "[", "]", StandardCharsets.UTF_8, true);
    }
