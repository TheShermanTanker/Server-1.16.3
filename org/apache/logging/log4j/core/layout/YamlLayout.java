...
public final class YamlLayout extends AbstractJacksonLayout {
    ...
    public String getContentType() {
        return new StringBuilder().append("application/yaml; charset=").append(this.getCharset()).toString();
    }
    ...
    public static AbstractJacksonLayout createDefaultLayout() {
        return new YamlLayout((Configuration)new DefaultConfiguration(), false, false, false, false, false, "", "", StandardCharsets.UTF_8, true);
    }
