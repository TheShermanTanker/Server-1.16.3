...
public enum AnsiEscape {
    ...
    public static Map<String, String> createMap(final String[] values, final String[] dontEscapeKeys) {
        ...
        final Map<String, String> map = (Map<String, String>)new HashMap();
        for (final String string : values) {
            ...
            if (keyValue.length > 1) {
                ...
                final boolean escape = Arrays.binarySearch((Object[])sortedIgnoreKeys, key) < 0;
    ...
    public static String createSequence(final String... names) {
        ...
        for (final String name : names) {
            try {
                final AnsiEscape escape = EnglishEnums.<AnsiEscape>valueOf(AnsiEscape.class, name.trim());
                if (!first) {
