...
public final class EncodingPatternConverter extends LogEventPatternConverter {
    ...
    public static EncodingPatternConverter newInstance(final Configuration config, final String[] options) {
        if (options.length != 1) {
            EncodingPatternConverter.LOGGER.error(new StringBuilder().append("Incorrect number of options on escape. Expected 1, received ").append(options.length).toString());
            return null;
        }
        if (options[0] == null) {
