...
public final class VariablesNotEmptyReplacementConverter extends LogEventPatternConverter {
    ...
    public static VariablesNotEmptyReplacementConverter newInstance(final Configuration config, final String[] options) {
        if (options.length != 1) {
            VariablesNotEmptyReplacementConverter.LOGGER.error(new StringBuilder().append("Incorrect number of options on varsNotEmpty. Expected 1 received ").append(options.length).toString());
            return null;
        }
        if (options[0] == null) {
