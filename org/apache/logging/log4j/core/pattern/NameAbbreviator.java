...
public abstract class NameAbbreviator {
    ...
    public static NameAbbreviator getAbbreviator(final String pattern) {
        ...
        final ArrayList<PatternAbbreviatorFragment> fragments = (ArrayList<PatternAbbreviatorFragment>)new ArrayList(5);
        ...
        return new PatternAbbreviator((List<PatternAbbreviatorFragment>)fragments);
    }
    ...
    public abstract void abbreviate(final String string, final StringBuilder stringBuilder);
        ...
        private enum Strategy {
            DROP(0) {
                ...
                void abbreviate(final int count, final String original, final StringBuilder destination) {
                    ...
                    destination.append((CharSequence)original, start, original.length());
                }
            }, 
            RETAIN(1) {
                @Override
                void abbreviate(final int count, final String original, final StringBuilder destination) {
                    ...
                    destination.append((CharSequence)original, end + 1, original.length());
                }
            };
            ...
            abstract void abbreviate(final int integer, final String string, final StringBuilder stringBuilder);
        }
    }
    ...
    private static class PatternAbbreviator extends NameAbbreviator {
        ...
        public PatternAbbreviator(final List<PatternAbbreviatorFragment> fragments) {
            ...
            fragments.toArray((Object[])(this.fragments = new PatternAbbreviatorFragment[fragments.size()]));
        }
