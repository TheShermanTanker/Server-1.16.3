...
public abstract class EqualsBaseReplacementConverter extends LogEventPatternConverter {
    ...
    public void format(final LogEvent event, final StringBuilder toAppendTo) {
        ...
        for (int i = 0; i < this.formatters.size(); ++i) {
            final PatternFormatter formatter = (PatternFormatter)this.formatters.get(i);
    ...
    protected abstract boolean equals(final String string, final StringBuilder stringBuilder, final int integer3, final int integer4);
    ...
    void parseSubstitution(final LogEvent event, final StringBuilder substitutionBuffer) {
        if (this.substitutionFormatters != null) {
            for (int i = 0; i < this.substitutionFormatters.size(); ++i) {
                final PatternFormatter formatter = (PatternFormatter)this.substitutionFormatters.get(i);
