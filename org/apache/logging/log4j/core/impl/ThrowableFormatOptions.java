...
public final class ThrowableFormatOptions {
    ...
    protected ThrowableFormatOptions(final int lines, final String separator, final List<String> ignorePackages, final TextRenderer textRenderer) {
        this.lines = lines;
                ...
                if (!option.isEmpty()) {
                    if (option.startsWith("separator(") && option.endsWith(")")) {
                        ...
                        if (filterStr.length() > 0) {
                            ...
                            if (array.length > 0) {
                                packages = (List<String>)new ArrayList(array.length);
