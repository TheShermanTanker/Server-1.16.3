...
public class Log4jLogEvent implements LogEvent {
    ...
    public Log4jLogEvent() {
        this("", (Marker)null, "", (Level)null, (Message)null, (Throwable)null, (ThrowableProxy)null, (StringMap)null, (ThreadContext.ContextStack)null, 0L, (String)null, 0, (StackTraceElement)null, Log4jLogEvent.CLOCK.currentTimeMillis(), Log4jLogEvent.nanoClock.nanoTime());
    }
    
    @Deprecated
    public Log4jLogEvent(final long timestamp) {
        this("", (Marker)null, "", (Level)null, (Message)null, (Throwable)null, (ThrowableProxy)null, (StringMap)null, (ThreadContext.ContextStack)null, 0L, (String)null, 0, (StackTraceElement)null, timestamp, Log4jLogEvent.nanoClock.nanoTime());
    }
    ...
    public Log4jLogEvent(final String loggerName, final Marker marker, final String loggerFQCN, final Level level, final Message message, final List<Property> properties, final Throwable t) {
        this(loggerName, marker, loggerFQCN, level, message, t, null, createContextData(properties), (ThreadContext.getDepth() == 0) ? null : ThreadContext.cloneStack(), 0L, null, 0, null, (message instanceof TimestampMessage) ? ((TimestampMessage)message).getTimestamp() : Log4jLogEvent.CLOCK.currentTimeMillis(), Log4jLogEvent.nanoClock.nanoTime());
    }
    ...
    public Log4jLogEvent(final String loggerName, final Marker marker, final String loggerFQCN, final Level level, final Message message, final Throwable t, final Map<String, String> mdc, final ThreadContext.ContextStack ndc, final String threadName, final StackTraceElement location, final long timestampMillis) {
        this(loggerName, marker, loggerFQCN, level, message, t, null, createContextData(mdc), ndc, 0L, threadName, 0, location, timestampMillis, Log4jLogEvent.nanoClock.nanoTime());
    }
    ...
    public static Log4jLogEvent createEvent(final String loggerName, final Marker marker, final String loggerFQCN, final Level level, final Message message, final Throwable thrown, final ThrowableProxy thrownProxy, final Map<String, String> mdc, final ThreadContext.ContextStack ndc, final String threadName, final StackTraceElement location, final long timestamp) {
        final Log4jLogEvent result = new Log4jLogEvent(loggerName, marker, loggerFQCN, level, message, thrown, thrownProxy, createContextData(mdc), ndc, 0L, threadName, 0, location, timestamp, Log4jLogEvent.nanoClock.nanoTime());
        return result;
    }
    ...
    public static Serializable serialize(final LogEvent event, final boolean includeLocation) {
        if (event instanceof Log4jLogEvent) {
            ...
            return (Serializable)new LogEventProxy((Log4jLogEvent)event, includeLocation);
        }
        return (Serializable)new LogEventProxy(event, includeLocation);
    }
    ...
    public static Log4jLogEvent deserialize(final Serializable event) {
        ...
        if (event instanceof LogEventProxy) {
            ...
            final Log4jLogEvent result = new Log4jLogEvent(proxy.loggerName, proxy.marker, proxy.loggerFQCN, proxy.level, proxy.message, proxy.thrown, proxy.thrownProxy, proxy.contextData, proxy.contextStack, proxy.threadId, proxy.threadName, proxy.threadPriority, proxy.source, proxy.timeMillis, proxy.nanoTime);
    ...
    public static class Builder implements org.apache.logging.log4j.core.util.Builder<LogEvent> {
        ...
        public Log4jLogEvent build() {
            final Log4jLogEvent result = new Log4jLogEvent(this.loggerName, this.marker, this.loggerFqcn, this.level, this.message, this.thrown, this.thrownProxy, this.contextData, this.contextStack, this.threadId, this.threadName, this.threadPriority, this.source, this.timeMillis, this.nanoTime, null);
    ...
    static class LogEventProxy implements Serializable {
        ...
        private static MarshalledObject<Message> marshall(final Message msg) {
            try {
                return (MarshalledObject<Message>)new MarshalledObject(msg);
            }
            catch (Exception ex) {
                return null;
            }
