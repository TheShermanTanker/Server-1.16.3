...
public class ThrowableProxy implements Serializable {
    ...
    private ThrowableProxy(final Throwable throwable, final Set<Throwable> visited) {
        ...
        final Map<String, CacheEntry> map = (Map<String, CacheEntry>)new HashMap();
        final Stack<Class<?>> stack = ReflectionUtil.getCurrentStackTrace();
        this.extendedStackTrace = this.toExtendedStackTrace(stack, map, null, throwable.getStackTrace());
        final Throwable throwableCause = throwable.getCause();
        final Set<Throwable> causeVisited = (Set<Throwable>)new HashSet(1);
    ...
    public boolean equals(final Object obj) {
        ...
        return Arrays.equals((Object[])this.extendedStackTrace, (Object[])other.extendedStackTrace) && Arrays.equals((Object[])this.suppressedProxies, (Object[])other.suppressedProxies);
    }
    ...
    ExtendedStackTraceElement[] toExtendedStackTrace(final Stack<Class<?>> stack, final Map<String, CacheEntry> map, final StackTraceElement[] rootTrace, final StackTraceElement[] stackTrace) {
        ...
        for (int i = stackLength - 1; i >= 0; --i) {
            ...
            if (clazz != null && className.equals(clazz.getName())) {
                ...
                final CacheEntry cacheEntry = (CacheEntry)map.get(className);
                if (cacheEntry != null) {
    ...
    private ThrowableProxy[] toSuppressedProxies(final Throwable thrown, Set<Throwable> suppressedVisited) {
        try {
            ...
            final List<ThrowableProxy> proxies = (List<ThrowableProxy>)new ArrayList(suppressed.length);
            if (suppressedVisited == null) {
                suppressedVisited = (Set<Throwable>)new HashSet(proxies.size());
            }
            ...
            return (ThrowableProxy[])proxies.toArray((Object[])new ThrowableProxy[proxies.size()]);
        }
        catch (Exception e) {
