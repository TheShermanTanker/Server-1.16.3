...
final class DisruptorUtil {
    ...
    static ExceptionHandler<RingBufferLogEvent> getAsyncLoggerExceptionHandler() {
        ...
        try {
            final Class<? extends ExceptionHandler<RingBufferLogEvent>> klass = LoaderUtil.loadClass(cls);
    ...
    static ExceptionHandler<AsyncLoggerConfigDisruptor.Log4jEventWrapper> getAsyncLoggerConfigExceptionHandler() {
        ...
        try {
            final Class<? extends ExceptionHandler<AsyncLoggerConfigDisruptor.Log4jEventWrapper>> klass = LoaderUtil.loadClass(cls);
    ...
    public static long getExecutorThreadId(final ExecutorService executor) {
        final Future<Long> result = (Future<Long>)executor.submit((Callable)new Callable<Long>() {
            public Long call() {
        ...
        try {
            ...
            throw new IllegalStateException("Could not obtain executor thread Id. Giving up to avoid the risk of application deadlock.", (Throwable)ex);
        }
    }
