...
public final class TypeConverters {
    ...
    public static <T> T convert(final String s, final Class<? extends T> clazz, final Object defaultValue) {
        final TypeConverter<T> converter = (TypeConverter<T>)TypeConverterRegistry.getInstance().findCompatibleConverter((Type)clazz);
        if (s == null) {
            return TypeConverters.<T>parseDefaultValue(converter, defaultValue);
        }
        try {
