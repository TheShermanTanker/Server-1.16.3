...
public final class ReliabilityStrategyFactory {
    ...
    public static ReliabilityStrategy getReliabilityStrategy(final LoggerConfig loggerConfig) {
        ...
        try {
            final Class<? extends ReliabilityStrategy> cls = LoaderUtil.loadClass(strategy).asSubclass((Class)ReliabilityStrategy.class);
            return (ReliabilityStrategy)cls.getConstructor(new Class[] { LoggerConfig.class }).newInstance(new Object[] { loggerConfig });
        }
