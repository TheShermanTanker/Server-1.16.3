...
public class BuiltConfiguration extends AbstractConfiguration {
    ...
    public void setPluginPackages(final String packages) {
        this.pluginPackages.addAll((Collection)Arrays.asList((Object[])packages.split(Patterns.COMMA_SEPARATOR)));
    }
    ...
    public void setMonitorInterval(final int intervalSeconds) {
        if (this instanceof Reconfigurable && intervalSeconds > 0) {
            final ConfigurationSource configSource = this.getConfigurationSource();
            if (configSource != null) {
                final File configFile = configSource.getFile();
                if (intervalSeconds > 0) {
                    this.getWatchManager().setIntervalSeconds(intervalSeconds);
                    if (configFile != null) {
                        final FileWatcher watcher = new ConfiguratonFileWatcher((Reconfigurable)this, this.listeners);
    ...
    protected Node convertToNode(final Node parent, final Component component) {
        ...
        node.getAttributes().putAll((Map)component.getAttributes());
