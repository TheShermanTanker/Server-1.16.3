...
public final class TypeUtil {
    ...
    public static List<Field> getAllDeclaredFields(Class<?> cls) {
        final List<Field> fields = (List<Field>)new ArrayList();
        while (cls != null) {
    ...
    public static boolean isAssignable(final Type lhs, final Type rhs) {
        ...
        if (lhs instanceof Class) {
            final Class<?> lhsClass = lhs;
            if (rhs instanceof Class) {
                final Class<?> rhsClass = rhs;
                return lhsClass.isAssignableFrom((Class)rhsClass);
            }
            ...
            if (lhsClass.isArray() && rhs instanceof GenericArrayType) {
                return isAssignable((Type)lhsClass.getComponentType(), ((GenericArrayType)rhs).getGenericComponentType());
            }
        }
        ...
        if (lhs instanceof GenericArrayType) {
            ...
            if (rhs instanceof Class) {
                final Class<?> rhsClass = rhs;
                if (rhsClass.isArray()) {
                    return isAssignable(lhsComponentType, (Type)rhsClass.getComponentType());
                }
            }
    ...
    private static Type[] getEffectiveUpperBounds(final WildcardType type) {
        ...
        return (upperBounds.length == 0) ? new Type[] { (Type)Object.class } : upperBounds;
    }
