...
public final class CronExpression {
    ...
    protected void buildExpression(final String expression) throws ParseException {
        ...
        try {
            if (this.seconds == null) {
                this.seconds = (TreeSet<Integer>)new TreeSet();
            }
            if (this.minutes == null) {
                this.minutes = (TreeSet<Integer>)new TreeSet();
            }
            if (this.hours == null) {
                this.hours = (TreeSet<Integer>)new TreeSet();
            }
            if (this.daysOfMonth == null) {
                this.daysOfMonth = (TreeSet<Integer>)new TreeSet();
            }
            if (this.months == null) {
                this.months = (TreeSet<Integer>)new TreeSet();
            }
            if (this.daysOfWeek == null) {
                this.daysOfWeek = (TreeSet<Integer>)new TreeSet();
            }
            if (this.years == null) {
                this.years = (TreeSet<Integer>)new TreeSet();
            }
            int exprOn = 0;
    ...
    protected int storeExpressionVals(final int pos, final String s, final int type) throws ParseException {
        ...
        if (c == '?') {
            if (++i + 1 < s.length() && s.charAt(i) != ' ' && s.charAt(i + 1) != '\t') {
                throw new ParseException(new StringBuilder().append("Illegal character after '?': ").append(s.charAt(i)).toString(), i);
            }
            if (type != 5 && type != 3) {
            ...
            if (c == '/') {
                ...
                if (incr > 59 && (type == 0 || type == 1)) {
                    throw new ParseException(new StringBuilder().append("Increment > 60 : ").append(incr).toString(), i);
                }
                if (incr > 23 && type == 2) {
                    throw new ParseException(new StringBuilder().append("Increment > 24 : ").append(incr).toString(), i);
                }
                if (incr > 31 && type == 3) {
                    throw new ParseException(new StringBuilder().append("Increment > 31 : ").append(incr).toString(), i);
                }
                if (incr > 7 && type == 5) {
                    throw new ParseException(new StringBuilder().append("Increment > 7 : ").append(incr).toString(), i);
                }
                if (incr > 12 && type == 4) {
                    throw new ParseException(new StringBuilder().append("Increment > 12 : ").append(incr).toString(), i);
                }
            }
            else {
                incr = 1;
    ...
    protected int checkNext(final int pos, final String s, final int val, final int type) throws ParseException {
        ...
        if (c == 'L') {
            if (type != 5) {
                throw new ParseException(new StringBuilder().append("'L' option is not valid here. (pos=").append(i).append(")").toString(), i);
            }
            if (val < 1 || val > 7) {
            ...
            if (type != 3) {
                throw new ParseException(new StringBuilder().append("'W' option is not valid here. (pos=").append(i).append(")").toString(), i);
            }
            this.nearestWeekday = true;
            if (val > 31) {
            ...
            if (type != 5) {
                throw new ParseException(new StringBuilder().append("'#' option is not valid here. (pos=").append(i).append(")").toString(), i);
            }
            ++i;
            try {
                this.nthdayOfWeek = Integer.parseInt(s.substring(i));
            ...
            throw new ParseException(new StringBuilder().append("Unexpected character '").append(c).append("' after '/'").toString(), i);
        }
    }
    ...
    public String getExpressionSummary() {
        ...
        buf.append("seconds: ");
        buf.append(this.getExpressionSetSummary((Set<Integer>)this.seconds));
        buf.append("\n");
        buf.append("minutes: ");
        buf.append(this.getExpressionSetSummary((Set<Integer>)this.minutes));
        buf.append("\n");
        buf.append("hours: ");
        buf.append(this.getExpressionSetSummary((Set<Integer>)this.hours));
        buf.append("\n");
        buf.append("daysOfMonth: ");
        buf.append(this.getExpressionSetSummary((Set<Integer>)this.daysOfMonth));
        buf.append("\n");
        buf.append("months: ");
        buf.append(this.getExpressionSetSummary((Set<Integer>)this.months));
        buf.append("\n");
        buf.append("daysOfWeek: ");
        buf.append(this.getExpressionSetSummary((Set<Integer>)this.daysOfWeek));
        buf.append("\n");
        ...
        buf.append("\n");
        buf.append("years: ");
        buf.append(this.getExpressionSetSummary((Set<Integer>)this.years));
        buf.append("\n");
        return buf.toString();
    }
    ...
    protected String getExpressionSetSummary(final Set<Integer> set) {
        ...
        final StringBuilder buf = new StringBuilder();
        final Iterator<Integer> itr = (Iterator<Integer>)set.iterator();
        boolean first = true;
        while (itr.hasNext()) {
    ...
    protected String getExpressionSetSummary(final ArrayList<Integer> list) {
        ...
        final StringBuilder buf = new StringBuilder();
        final Iterator<Integer> itr = (Iterator<Integer>)list.iterator();
        boolean first = true;
        while (itr.hasNext()) {
            final Integer iVal = (Integer)itr.next();
            final String val = iVal.toString();
    ...
    public Date getTimeAfter(Date afterTime) {
        final Calendar cl = (Calendar)new GregorianCalendar(this.getTimeZone());
        ...
        while (!gotOne) {
            ...
            int sec = cl.get(13);
            int min = cl.get(12);
            st = (SortedSet<Integer>)this.seconds.tailSet(sec);
            ...
            int hr = cl.get(11);
            t = -1;
            st = (SortedSet<Integer>)this.minutes.tailSet(min);
            if (st != null && st.size() != 0) {
                t = min;
                min = (int)st.first();
            }
            ...
            if (min != t) {
                ...
                int day = cl.get(5);
                t = -1;
                st = (SortedSet<Integer>)this.hours.tailSet(hr);
                if (st != null && st.size() != 0) {
                    t = hr;
                    hr = (int)st.first();
                }
                ...
                if (hr != t) {
                    ...
                    if (dayOfMSpec && !dayOfWSpec) {
                        st = (SortedSet<Integer>)this.daysOfMonth.tailSet(day);
                        ...
                        if (this.lastdayOfWeek) {
                            ...
                            st = (SortedSet<Integer>)this.daysOfWeek.tailSet(cDow2);
                            if (st != null && st.size() > 0) {
                                dow3 = (int)st.first();
                            }
                            int daysToAdd = 0;
                    ...
                    st = (SortedSet<Integer>)this.months.tailSet(mon);
                    if (st != null && st.size() != 0) {
                        t = mon;
                        mon = (int)st.first();
                    }
                    ...
                    if (mon != t) {
                        ...
                        year = cl.get(1);
                        t = -1;
                        st = (SortedSet<Integer>)this.years.tailSet(year);
                        if (st == null || st.size() == 0) {
                            return null;
                        }
                        t = year;
    ...
    protected int getLastDayOfMonth(final int monthNum, final int year) {
        switch (monthNum) {
            ...
            default: {
                throw new IllegalArgumentException(new StringBuilder().append("Illegal month number: ").append(monthNum).toString());
            }
        }
    }
    ...
    static {
        ALL_SPEC = 99;
        NO_SPEC = 98;
        monthMap = (Map)new HashMap(20);
        dayMap = (Map)new HashMap(60);
