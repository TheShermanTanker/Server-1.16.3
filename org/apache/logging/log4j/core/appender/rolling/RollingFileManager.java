...
public class RollingFileManager extends FileManager {
    ...
    protected RollingFileManager(final String fileName, final String pattern, final OutputStream os, final boolean append, final long size, final long time, final TriggeringPolicy triggeringPolicy, final RolloverStrategy rolloverStrategy, final String advertiseURI, final Layout<? extends Serializable> layout, final boolean writeHeader, final ByteBuffer buffer) {
        ...
        this.asyncExecutor = (ExecutorService)new ThreadPoolExecutor(0, Integer.MAX_VALUE, 0L, TimeUnit.MILLISECONDS, (BlockingQueue)new EmptyQueue(), (ThreadFactory)this.threadFactory);
        this.size = size;
    ...
    public static RollingFileManager getFileManager(final String fileName, final String pattern, final boolean append, final boolean bufferedIO, final TriggeringPolicy policy, final RolloverStrategy strategy, final String advertiseURI, final Layout<? extends Serializable> layout, final int bufferSize, final boolean immediateFlush, final boolean createOnDemand, final Configuration configuration) {
        ...
        return (RollingFileManager)OutputStreamManager.<FactoryData>getManager(name, new FactoryData(fileName, pattern, append, bufferedIO, policy, strategy, advertiseURI, layout, bufferSize, immediateFlush, createOnDemand, configuration), RollingFileManager.factory);
    }
    ...
    public boolean releaseSub(final long timeout, final TimeUnit timeUnit) {
        ...
        RollingFileManager.LOGGER.debug("RollingFileManager shutdown completed with status {}", status);
        return status;
    }
    ...
    public synchronized void rollover() {
        ...
        if (this.rollover(this.rolloverStrategy)) {
            try {
                ...
                this.logError("Failed to create file after rollover", (Throwable)e);
            }
        }
    }
    ...
    private boolean rollover(final RolloverStrategy strategy) {
        ...
        try {
            ...
            this.logError("Thread interrupted while attempting to check rollover", (Throwable)e);
            return false;
        }
            ...
            if (descriptor != null) {
                ...
                if (descriptor.getSynchronous() != null) {
                    ...
                    try {
                        ...
                        success = false;
                        this.logError("Caught error in synchronous task", (Throwable)ex);
                    }
                }
    ...
    static {
        ...
        triggeringPolicyUpdater = AtomicReferenceFieldUpdater.newUpdater((Class)RollingFileManager.class, (Class)TriggeringPolicy.class, "triggeringPolicy");
        rolloverStrategyUpdater = AtomicReferenceFieldUpdater.newUpdater((Class)RollingFileManager.class, (Class)RolloverStrategy.class, "rolloverStrategy");
    }
        ...
        public RollingFileManager createManager(final String name, final FactoryData data) {
            ...
            if (data.fileName != null) {
                ...
                try {
                    ...
                    RollingFileManager.LOGGER.error("Unable to create file " + name, (Throwable)ioe);
                    return null;
                }
            ...
            try {
                ...
                final OutputStream os = (OutputStream)((data.createOnDemand || data.fileName == null) ? null : new FileOutputStream(data.fileName, data.append));
                ...
                RollingFileManager.LOGGER.error("RollingFileManager (" + name + ") " + ex, (Throwable)ex);
                return null;
            }
        }
    }
