...
public final class CronTriggeringPolicy extends AbstractTriggeringPolicy {
    ...
    public void initialize(final RollingFileManager aManager) {
        ...
        this.future = scheduler.scheduleWithCron(this.cronExpression, now, (Runnable)new CronTrigger());
    ...
    private static CronExpression getSchedule(final String expression) {
        try {
            ...
            CronTriggeringPolicy.LOGGER.error("Invalid cron expression - " + expression, (Throwable)pe);
            return null;
        }
    }
    ...
    private void rollover() {
        ...
        final Date thisRoll = this.cronExpression.getPrevFireTime(new Date());
