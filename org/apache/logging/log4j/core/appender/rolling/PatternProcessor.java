...
public class PatternProcessor {
    ...
    public PatternProcessor(final String pattern) {
        ...
        this.patternFields = (FormattingInfo[])fields.toArray((Object[])infoArray);
        final ArrayPatternConverter[] converterArray = new ArrayPatternConverter[converters.size()];
        this.patternConverters = (ArrayPatternConverter[])converters.toArray((Object[])converterArray);
    ...
    public final void formatFileName(final StrSubstitutor subst, final StringBuilder buf, final boolean useCurrentTime, final Object obj) {
        final long time = (useCurrentTime && this.currentFileTime != 0L) ? this.currentFileTime : ((this.prevFileTime != 0L) ? this.prevFileTime : System.currentTimeMillis());
        this.formatFileName(buf, new Date(time), obj);
    ...
    private PatternParser createPatternParser() {
        return new PatternParser((Configuration)null, "FileConverter", null);
    }
    ...
    private boolean patternContains(final String pattern, final char character) {
        return pattern.indexOf((int)character) >= 0;
    }
