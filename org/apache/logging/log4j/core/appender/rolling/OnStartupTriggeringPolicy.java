...
public class OnStartupTriggeringPolicy extends AbstractTriggeringPolicy {
    ...
    private static long initStartTime() {
        try {
            ...
            final Method getRuntimeMXBean = factoryClass.getMethod("getRuntimeMXBean", new Class[0]);
            ...
            final Method getStartTime = runtimeMXBeanClass.getMethod("getStartTime", new Class[0]);
