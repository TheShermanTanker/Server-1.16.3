...
public class Duration implements Serializable, Comparable<Duration> {
        ...
        if (matcher.matches() && !"T".equals(matcher.group(2))) {
            ...
            if (dayMatch != null || hourMatch != null || minuteMatch != null || secondMatch != null) {
                ...
                try {
                    ...
                    throw new IllegalArgumentException(new StringBuilder().append("Text cannot be parsed to a Duration (overflow) ").append(text).toString(), (Throwable)ex);
                }
            }
        }
        throw new IllegalArgumentException(new StringBuilder().append("Text cannot be parsed to a Duration: ").append(text).toString());
    }
    ...
    private static long parseNumber(final CharSequence text, final String parsed, final int multiplier, final String errorText) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Text cannot be parsed to a Duration: " + errorText + " (in " + text + ")", (Throwable)ex);
        }
    }
