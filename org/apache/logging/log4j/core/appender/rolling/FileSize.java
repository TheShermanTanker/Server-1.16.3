...
public final class FileSize {
    ...
    public static long parse(final String string, final long defaultValue) {
        final Matcher matcher = FileSize.VALUE_PATTERN.matcher((CharSequence)string);
        if (matcher.matches()) {
            try {
                ...
                FileSize.LOGGER.error("FileSize unable to parse numeric part: " + string, (Throwable)e);
                return defaultValue;
            }
        }
