...
public class RandomAccessFileManager extends OutputStreamManager {
    ...
    public static RandomAccessFileManager getFileManager(final String fileName, final boolean append, final boolean isFlush, final int bufferSize, final String advertiseURI, final Layout<? extends Serializable> layout, final Configuration configuration) {
        return (RandomAccessFileManager)OutputStreamManager.<FactoryData>getManager(fileName, new FactoryData(append, isFlush, bufferSize, advertiseURI, layout, configuration), RandomAccessFileManager.FACTORY);
    }
    ...
    protected void writeToDestination(final byte[] bytes, final int offset, final int length) {
        try {
            ...
            throw new AppenderLoggingException(msg, (Throwable)ex);
        }
    }
    ...
    public synchronized boolean closeOutputStream() {
        ...
        try {
            ...
            this.logError("Unable to close RandomAccessFile", (Throwable)ex);
            return false;
        }
    }
