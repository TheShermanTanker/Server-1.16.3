...
public class KafkaManager extends AbstractManager {
    ...
    private void closeProducer(final long timeout, final TimeUnit timeUnit) {
        if (this.producer != null) {
            final Thread closeThread = new Log4jThread((Runnable)new Runnable() {
                public void run() {
    ...
    public void send(final byte[] msg) throws ExecutionException, InterruptedException, TimeoutException {
        if (this.producer != null) {
            final ProducerRecord<byte[], byte[]> newRecord = (ProducerRecord<byte[], byte[]>)new ProducerRecord(this.topic, msg);
            if (this.syncSend) {
