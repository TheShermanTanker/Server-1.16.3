...
public class JeroMqManager extends AbstractManager {
    ...
    static {
        ...
        JeroMqManager.LOGGER.trace("JeroMqManager creating ZMQ context with ioThreads = {}", ioThreads);
        ...
        if (enableShutdownHook) {
            ((ShutdownCallbackRegistry)LogManager.getFactory()).addShutdownCallback((Runnable)new Runnable() {
                public void run() {
    ...
    private static class JeroMqConfiguration {
        ...
        public String toString() {
            return new StringBuilder().append("JeroMqConfiguration{affinity=").append(this.affinity).append(", backlog=").append(this.backlog).append(", delayAttachOnConnect=").append(this.delayAttachOnConnect).append(", identity=").append(Arrays.toString(this.identity)).append(", ipv4Only=").append(this.ipv4Only).append(", linger=").append(this.linger).append(", maxMsgSize=").append(this.maxMsgSize).append(", rcvHwm=").append(this.rcvHwm).append(", receiveBufferSize=").append(this.receiveBufferSize).append(", receiveTimeOut=").append(this.receiveTimeOut).append(", reconnectIVL=").append(this.reconnectIVL).append(", reconnectIVLMax=").append(this.reconnectIVLMax).append(", sendBufferSize=").append(this.sendBufferSize).append(", sendTimeOut=").append(this.sendTimeOut).append(", sndHwm=").append(this.sndHwm).append(", tcpKeepAlive=").append(this.tcpKeepAlive).append(", tcpKeepAliveCount=").append(this.tcpKeepAliveCount).append(", tcpKeepAliveIdle=").append(this.tcpKeepAliveIdle).append(", tcpKeepAliveInterval=").append(this.tcpKeepAliveInterval).append(", xpubVerbose=").append(this.xpubVerbose).append(", endpoints=").append(this.endpoints).append('}').toString();
        }
    }
