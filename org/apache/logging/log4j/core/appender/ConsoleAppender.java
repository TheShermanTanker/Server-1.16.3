...
public final class ConsoleAppender extends AbstractOutputStreamAppender<OutputStreamManager> {
    ...
    public static ConsoleAppender createDefaultAppenderForLayout(final Layout<? extends Serializable> layout) {
        return new ConsoleAppender(new StringBuilder().append("DefaultConsole-").append(ConsoleAppender.COUNT.incrementAndGet()).toString(), layout, null, getDefaultManager(ConsoleAppender.DEFAULT_TARGET, false, false, layout), true, ConsoleAppender.DEFAULT_TARGET);
    }
    ...
    private static OutputStreamManager getDefaultManager(final Target target, final boolean follow, final boolean direct, final Layout<? extends Serializable> layout) {
        ...
        return OutputStreamManager.<FactoryData>getManager(managerName, new FactoryData(os, managerName, layout), ConsoleAppender.factory);
    }
    ...
    private static OutputStream getOutputStream(final boolean follow, final boolean direct, final Target target) {
        ...
        try {
            ...
            if (target == Target.SYSTEM_OUT) {
                if (direct) {
                    ...
                    o = new PrintStream((OutputStream)systemOutStream, true, enc);
                ...
                o = new FileOutputStream(FileDescriptor.err);
            }
            else if (follow) {
                final SystemErrStream systemErrStream;
                o = new PrintStream((OutputStream)systemErrStream, true, enc);
            ...
            throw new IllegalStateException("Unsupported default encoding " + enc, (Throwable)ex);
        }
        ...
        try {
            final Class<?> clazz = LoaderUtil.loadClass("org.fusesource.jansi.WindowsAnsiOutputStream");
            final Constructor<?> constructor = clazz.getConstructor(new Class[] { OutputStream.class });
            return new CloseShieldOutputStream((OutputStream)constructor.newInstance(new Object[] { outputStream }));
        }
    ...
    public static class Builder<B extends Builder<B>> extends AbstractOutputStreamAppender.Builder<B> implements org.apache.logging.log4j.core.util.Builder<ConsoleAppender> {
        ...
        public ConsoleAppender build() {
            ...
            return new ConsoleAppender(this.getName(), layout, this.getFilter(), getManager(this.target, this.follow, this.direct, layout), this.isIgnoreExceptions(), this.target, null);
        }
    }
