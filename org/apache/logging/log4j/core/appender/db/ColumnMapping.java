...
public class ColumnMapping {
    ...
    public static class Builder implements org.apache.logging.log4j.core.util.Builder<ColumnMapping> {
        ...
        public ColumnMapping build() {
            ...
            if (this.layout == null && this.literal == null && !Date.class.isAssignableFrom((Class)this.type) && !ReadOnlyStringMap.class.isAssignableFrom((Class)this.type) && !ThreadContextMap.class.isAssignableFrom((Class)this.type) && !ThreadContextStack.class.isAssignableFrom((Class)this.type)) {
