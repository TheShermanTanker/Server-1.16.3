...
public class ContextDataJsonAttributeConverter implements AttributeConverter<ReadOnlyStringMap, String> {
    ...
    public String convertToDatabaseColumn(final ReadOnlyStringMap contextData) {
        ...
        try {
            ...
            return ContextDataJsonAttributeConverter.OBJECT_MAPPER.writeValueAsString(root);
        }
        catch (Exception e) {
    ...
    public ReadOnlyStringMap convertToEntityAttribute(final String s) {
        ...
        try {
            ...
            final Iterator<Map.Entry<String, JsonNode>> entries = (Iterator<Map.Entry<String, JsonNode>>)root.fields();
            while (entries.hasNext()) {
                final Map.Entry<String, JsonNode> entry = (Map.Entry<String, JsonNode>)entries.next();
                final Object value = ((JsonNode)entry.getValue()).textValue();
