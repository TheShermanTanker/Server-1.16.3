...
public class SyslogAppender extends SocketAppender {
    ...
    public static class Builder<B extends Builder<B>> extends AbstractBuilder<B> implements org.apache.logging.log4j.core.util.Builder<SocketAppender> {
        ...
        public SyslogAppender build() {
            ...
            if (layout == null) {
                layout = ("RFC5424".equalsIgnoreCase(this.format) ? Rfc5424Layout.createLayout(this.facility, this.id, this.enterpriseNumber, this.includeMdc, this.mdcId, this.mdcPrefix, this.eventPrefix, this.newLine, this.escapeNL, this.appName, this.msgId, this.excludes, this.includes, this.required, this.exceptionPattern, useTlsMessageFormat, this.loggerFields, configuration) : SyslogLayout.<SyslogLayout.Builder<SyslogLayout.Builder<SyslogLayout.Builder>>>newBuilder().setFacility(this.facility).setIncludeNewLine(this.newLine).setEscapeNL(this.escapeNL).setCharset(this.charsetName).build());
            }
