...
public final class RollingFileAppender extends AbstractOutputStreamAppender<RollingFileManager> {
    ...
    public <T extends TriggeringPolicy> T getTriggeringPolicy() {
        return this.getManager().<T>getTriggeringPolicy();
    }
