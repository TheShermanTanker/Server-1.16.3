...
public class JndiManager extends AbstractManager {
    ...
    public static JndiManager getDefaultManager() {
        return AbstractManager.<JndiManager, Object>getManager(JndiManager.class.getName(), (ManagerFactory<JndiManager, Object>)JndiManager.FACTORY, null);
    }
    
    public static JndiManager getDefaultManager(final String name) {
        return AbstractManager.<JndiManager, Object>getManager(name, (ManagerFactory<JndiManager, Object>)JndiManager.FACTORY, null);
    }
    ...
    public static JndiManager getJndiManager(final String initialContextFactoryName, final String providerURL, final String urlPkgPrefixes, final String securityPrincipal, final String securityCredentials, final Properties additionalProperties) {
        ...
        return AbstractManager.<JndiManager, Properties>getManager(name, (ManagerFactory<JndiManager, Properties>)JndiManager.FACTORY, properties);
    }
    ...
    private static class JndiManagerFactory implements ManagerFactory<JndiManager, Properties> {
        public JndiManager createManager(final String name, final Properties data) {
            try {
                return new JndiManager(name, (Context)new InitialContext((Hashtable)data), null);
            }
            catch (NamingException e) {
                JndiManager.LOGGER.error("Error creating JNDI InitialContext.", (Throwable)e);
                return null;
            }
        }
    }
