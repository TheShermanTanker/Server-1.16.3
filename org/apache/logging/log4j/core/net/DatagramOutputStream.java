...
public class DatagramOutputStream extends OutputStream {
    ...
    public DatagramOutputStream(final String host, final int port, final byte[] header, final byte[] footer) {
        ...
        try {
            ...
            DatagramOutputStream.LOGGER.error(msg, (Throwable)ex);
        ...
        try {
            ...
            DatagramOutputStream.LOGGER.error(msg, (Throwable)ex2);
            throw new AppenderLoggingException(msg, (Throwable)ex2);
        }
    }
