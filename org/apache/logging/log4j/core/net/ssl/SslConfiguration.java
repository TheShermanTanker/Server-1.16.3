...
public class SslConfiguration {
    ...
    private SSLContext createDefaultSslContext() {
        try {
            ...
            SslConfiguration.LOGGER.error("Failed to create an SSLContext with default configuration", (Throwable)e);
            return null;
        }
    }
    ...
    private SSLContext createSslContext(final boolean loadDefaultKeyManagerFactory, final boolean loadDefaultTrustManagerFactory) throws KeyStoreConfigurationException, TrustStoreConfigurationException {
        try {
            ...
            SslConfiguration.LOGGER.error("No Provider supports a TrustManagerFactorySpi implementation for the specified protocol", (Throwable)e);
            throw new TrustStoreConfigurationException((Exception)e);
        }
        catch (KeyManagementException e2) {
            SslConfiguration.LOGGER.error("Failed to initialize the SSLContext", (Throwable)e2);
            throw new KeyStoreConfigurationException((Exception)e2);
        }
    }
    ...
    private TrustManagerFactory loadTrustManagerFactory() throws TrustStoreConfigurationException {
        ...
        try {
            ...
            SslConfiguration.LOGGER.error("The specified algorithm is not available from the specified provider", (Throwable)e);
            throw new TrustStoreConfigurationException((Exception)e);
        }
        catch (KeyStoreException e2) {
            SslConfiguration.LOGGER.error("Failed to initialize the TrustManagerFactory", (Throwable)e2);
            throw new TrustStoreConfigurationException((Exception)e2);
        }
    }
    ...
    private KeyManagerFactory loadKeyManagerFactory() throws KeyStoreConfigurationException {
        ...
        try {
            ...
            SslConfiguration.LOGGER.error("The specified algorithm is not available from the specified provider", (Throwable)e);
            throw new KeyStoreConfigurationException((Exception)e);
        }
        catch (KeyStoreException e2) {
            SslConfiguration.LOGGER.error("Failed to initialize the TrustManagerFactory", (Throwable)e2);
            throw new KeyStoreConfigurationException((Exception)e2);
            ...
            SslConfiguration.LOGGER.error("The key cannot be recovered (e.g. the given password is wrong)", (Throwable)e3);
            throw new KeyStoreConfigurationException((Exception)e3);
        }
    }
