...
public class SocketPerformancePreferences implements Builder<SocketPerformancePreferences>, Cloneable {
    ...
    public String toString() {
        return new StringBuilder().append("SocketPerformancePreferences [bandwidth=").append(this.bandwidth).append(", connectionTime=").append(this.connectionTime).append(", latency=").append(this.latency).append("]").toString();
    }
}
