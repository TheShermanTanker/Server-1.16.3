...
public final class BurstFilter extends AbstractFilter {
    ...
    private BurstFilter(final Level level, final float rate, final long maxBurst, final Filter.Result onMatch, final Filter.Result onMismatch) {
        ...
        this.history = (DelayQueue<LogDelay>)new DelayQueue();
        this.available = (Queue<LogDelay>)new ConcurrentLinkedQueue();
        this.level = level;
    ...
    private Filter.Result filter(final Level level) {
        ...
        LogDelay delay = (LogDelay)this.available.poll();
        if (delay != null) {
            delay.setDelay(this.burstInterval);
            this.history.add((Delayed)delay);
            return this.onMatch;
        }
    ...
    public static class Builder implements org.apache.logging.log4j.core.util.Builder<BurstFilter> {
        ...
        public Builder setOnMatch(final Filter.Result onMatch) {
            this.onMatch = onMatch;
            return this;
        }
        
        public Builder setOnMismatch(final Filter.Result onMismatch) {
