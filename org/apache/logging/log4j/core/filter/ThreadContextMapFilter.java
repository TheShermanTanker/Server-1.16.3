...
public class ThreadContextMapFilter extends MapFilter {
    ...
    public ThreadContextMapFilter(final Map<String, List<String>> pairs, final boolean oper, final Filter.Result onMatch, final Filter.Result onMismatch) {
        ...
        if (pairs.size() == 1) {
            final Iterator<Map.Entry<String, List<String>>> iter = (Iterator<Map.Entry<String, List<String>>>)pairs.entrySet().iterator();
            final Map.Entry<String, List<String>> entry = (Map.Entry<String, List<String>>)iter.next();
    ...
    private Filter.Result filter() {
        ...
        if (this.useMap) {
            ...
            for (int i = 0; i < map.size(); ++i) {
                ...
                final String toMatch = currentContextData.<String>getValue(map.getKeyAt(i));
