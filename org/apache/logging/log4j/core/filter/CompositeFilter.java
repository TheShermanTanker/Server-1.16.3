...
public final class CompositeFilter extends AbstractLifeCycle implements Iterable<Filter>, Filter {
    ...
    public CompositeFilter addFilter(final Filter filter) {
        ...
        if (filter instanceof CompositeFilter) {
            ...
            final Filter[] copy = (Filter[])Arrays.copyOf((Object[])this.filters, size);
        ...
        final Filter[] copy2 = (Filter[])Arrays.copyOf((Object[])this.filters, this.filters.length + 1);
    ...
    public CompositeFilter removeFilter(final Filter filter) {
        ...
        final List<Filter> filterList = (List<Filter>)new ArrayList((Collection)Arrays.asList((Object[])this.filters));
        if (filter instanceof CompositeFilter) {
            for (final Filter currentFilter : ((CompositeFilter)filter).filters) {
        ...
        return new CompositeFilter((Filter[])filterList.toArray((Object[])new Filter[this.filters.length - 1]));
    }
    ...
    public List<Filter> getFilters() {
        return (List<Filter>)Arrays.asList((Object[])this.filters);
    }
