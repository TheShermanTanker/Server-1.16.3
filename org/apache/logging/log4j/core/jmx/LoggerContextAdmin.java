...
public class LoggerContextAdmin extends NotificationBroadcasterSupport implements LoggerContextAdminMBean, PropertyChangeListener {
    ...
    public LoggerContextAdmin(final LoggerContext loggerContext, final Executor executor) {
        ...
        try {
            ...
            final String name = String.format("org.apache.logging.log4j2:type=%s", new Object[] { ctxName });
            this.objectName = new ObjectName(name);
        }
        catch (Exception e) {
            throw new IllegalStateException((Throwable)e);
        }
        loggerContext.addPropertyChangeListener((PropertyChangeListener)this);
    }
    ...
    public void propertyChange(final PropertyChangeEvent evt) {
        ...
        final Notification notif = new Notification("com.apache.logging.log4j.core.jmx.config.reconfigured", this.getObjectName(), this.nextSeqNo(), this.now(), (String)null);
    ...
    public String getConfigText(final String charsetName) throws IOException {
        try {
            ...
            ex.printStackTrace(new PrintWriter((Writer)sw));
            return sw.toString();
        }
    }
    ...
    public void setConfigText(final String configText, final String charsetName) {
        ...
        try {
            final InputStream in = (InputStream)new ByteArrayInputStream(configText.getBytes(charsetName));
            ...
            LoggerContextAdmin.LOGGER.error("Could not reconfigure from config text", (Throwable)ex);
            throw new IllegalArgumentException("Could not reconfigure from config text", (Throwable)ex);
        }
    }
