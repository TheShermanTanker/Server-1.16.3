...
public class SortedArrayStringMap implements IndexedStringMap {
    ...
    public SortedArrayStringMap(final int initialCapacity) {
        ...
        if (initialCapacity < 1) {
            throw new IllegalArgumentException(new StringBuilder().append("Initial capacity must be at least one but was ").append(initialCapacity).toString());
        }
    ...
    public SortedArrayStringMap(final ReadOnlyStringMap other) {
        ...
        if (other instanceof SortedArrayStringMap) {
            ...
            other.<Object, StringMap>forEach(SortedArrayStringMap.PUT_ALL, this);
        }
    }
    ...
    public void clear() {
        ...
        Arrays.fill((Object[])this.keys, 0, this.size, null);
    ...
    public Map<String, String> toMap() {
        final Map<String, String> result = (Map<String, String>)new HashMap(this.size());
    ...
    public void putAll(final ReadOnlyStringMap source) {
        ...
        if (source instanceof SortedArrayStringMap) {
            ...
            source.<Object, StringMap>forEach(SortedArrayStringMap.PUT_ALL, this);
        }
    }
    ...
    private void merge(final SortedArrayStringMap other) {
        ...
        Arrays.fill((Object[])this.keys, this.size, newSize, null);
        ...
        if (this.size > 0) {
            for (int i = 0; i < this.size; ++i) {
                ...
                try {
                    ...
                    this.handleSerializationException((Throwable)e, i, this.keys[i]);
                    s.writeObject(null);
                }
            }
        }
    ...
    private void readObject(final ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        if (capacity < 0) {
            throw new InvalidObjectException(new StringBuilder().append("Illegal capacity: ").append(capacity).toString());
        }
        final int mappings = s.readInt();
        if (mappings < 0) {
            throw new InvalidObjectException(new StringBuilder().append("Illegal mappings count: ").append(mappings).toString());
        }
        if (mappings > 0) {
    ...
    private void handleSerializationException(final Throwable t, final int i, final String key) {
        StatusLogger.getLogger().warn("Ignoring {} for key[{}] ('{}')", String.valueOf((Object)t), i, this.keys[i]);
    }
