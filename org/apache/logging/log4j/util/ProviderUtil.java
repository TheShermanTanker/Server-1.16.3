...
public final class ProviderUtil {
    ...
    public static Iterable<Provider> getProviders() {
        lazyInit();
        return (Iterable<Provider>)ProviderUtil.PROVIDERS;
    }
    ...
    protected static void lazyInit() {
        if (ProviderUtil.instance == null) {
            try {
                ...
                ProviderUtil.LOGGER.fatal("Interrupted before Log4j Providers could be loaded.", (Throwable)e);
    ...
    static {
        PROVIDERS = (Collection)new HashSet();
        STARTUP_LOCK = (Lock)new ReentrantLock();
