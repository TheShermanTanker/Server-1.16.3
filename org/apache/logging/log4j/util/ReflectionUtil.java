...
public final class ReflectionUtil {
    ...
    public static Class<?> getCallerClass(final int depth) {
        ...
        if (supportsFastReflection()) {
            try {
                return ReflectionUtil.GET_CALLER_CLASS.invoke(null, new Object[] { depth + 1 + ReflectionUtil.JDK_7u25_OFFSET });
            }
            catch (Exception e) {
                ReflectionUtil.LOGGER.error("Error in ReflectionUtil.getCallerClass({}).", depth, e);
                return null;
            }
        }
        ...
        try {
            ...
            ReflectionUtil.LOGGER.error("Could not find class in ReflectionUtil.getCallerClass({}).", depth, e2);
            return null;
        }
    }
    ...
    static StackTraceElement getEquivalentStackTraceElement(final int depth) {
        ...
        ReflectionUtil.LOGGER.error("Could not find an appropriate StackTraceElement at index {}", depth);
        throw new IndexOutOfBoundsException(Integer.toString(depth));
    }
    ...
    public static Stack<Class<?>> getCurrentStackTrace() {
        if (ReflectionUtil.SECURITY_MANAGER != null) {
            ...
            final Stack<Class<?>> classes = (Stack<Class<?>>)new Stack();
        ...
        if (supportsFastReflection()) {
            final Stack<Class<?>> classes2 = (Stack<Class<?>>)new Stack();
            Class<?> clazz2;
    ...
    static {
        ...
        try {
            ...
            getCallerClass = sunReflectionClass.getDeclaredMethod("getCallerClass", new Class[] { Integer.TYPE });
            Object o = getCallerClass.invoke(null, new Object[] { 0 });
            final Object test1 = getCallerClass.invoke(null, new Object[] { 0 });
            if (o == null || o != sunReflectionClass) {
                ...
                o = getCallerClass.invoke(null, new Object[] { 1 });
        ...
        try {
            ...
            if (sm != null) {
                sm.checkPermission((Permission)new RuntimePermission("createSecurityManager"));
            }
