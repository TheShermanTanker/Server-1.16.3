...
public class LogManager {
    ...
    static {
        ...
        if (factoryClassName != null) {
            try {
                LogManager.factory = LoaderUtil.<LoggerContextFactory>newCheckedInstanceOf(factoryClassName, LoggerContextFactory.class);
            }
        ...
        if (LogManager.factory == null) {
            final SortedMap<Integer, LoggerContextFactory> factories = (SortedMap<Integer, LoggerContextFactory>)new TreeMap();
            if (ProviderUtil.hasProviders()) {
                for (final Provider provider : ProviderUtil.getProviders()) {
                    ...
                    if (factoryClass != null) {
                        try {
                            ...
                            LogManager.LOGGER.error("Unable to create class {} specified in {}", factoryClass.getName(), provider.getUrl().toString(), e);
                        }
                    }
                }
                if (factories.isEmpty()) {
                    ...
                    LogManager.factory = (LoggerContextFactory)factories.get(factories.lastKey());
                }
                else {
