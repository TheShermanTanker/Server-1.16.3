...
public class UnixCrypt {
    ...
    public static String crypt(final byte[] original, String salt) {
        if (salt == null) {
            ...
            salt = new StringBuilder().append("").append(UnixCrypt.SALT_CHARS[randomGenerator.nextInt(numSaltChars)]).append(UnixCrypt.SALT_CHARS[randomGenerator.nextInt(numSaltChars)]).toString();
        }
