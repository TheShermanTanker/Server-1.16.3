...
public class Metaphone implements StringEncoder {
        ...
        while (code.length() < this.getMaxCodeLen() && n < wdsz) {
            ...
            if (symb != 'C' && this.isPreviousChar(local, n, symb)) {
                ...
                switch (symb) {
                    ...
                    case 'C': {
                        if (this.isPreviousChar(local, n, 'S') && !this.isLastChar(wdsz, n) && "EIY".indexOf((int)local.charAt(n + 1)) >= 0) {
                            break;
                        }
                        ...
                        if (!this.isLastChar(wdsz, n) && "EIY".indexOf((int)local.charAt(n + 1)) >= 0) {
                            code.append('S');
                            break;
                        }
                    ...
                    case 'D': {
                        if (!this.isLastChar(wdsz, n + 1) && this.isNextChar(local, n, 'G') && "EIY".indexOf((int)local.charAt(n + 2)) >= 0) {
                            code.append('J');
                            n += 2;
                            break;
                        }
                    ...
                    case 'G': {
                        ...
                        if (!this.isLastChar(wdsz, n) && "EIY".indexOf((int)local.charAt(n + 1)) >= 0 && !hard) {
                            code.append('J');
                            break;
                        }
                        code.append('K');
                    ...
                    case 'H': {
                        ...
                        if (n > 0 && "CSPTG".indexOf((int)local.charAt(n - 1)) >= 0) {
                            break;
                        }
    ...
    private boolean isVowel(final StringBuilder string, final int index) {
        return "AEIOU".indexOf((int)string.charAt(index)) >= 0;
    }
