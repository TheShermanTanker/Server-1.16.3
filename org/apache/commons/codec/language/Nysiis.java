...
public class Nysiis implements StringEncoder {
    ...
    public String nysiis(String str) {
        ...
        str = Nysiis.PAT_MAC.matcher((CharSequence)str).replaceFirst("MCC");
        str = Nysiis.PAT_KN.matcher((CharSequence)str).replaceFirst("NN");
        str = Nysiis.PAT_K.matcher((CharSequence)str).replaceFirst("C");
        str = Nysiis.PAT_PH_PF.matcher((CharSequence)str).replaceFirst("FF");
        str = Nysiis.PAT_SCH.matcher((CharSequence)str).replaceFirst("SSS");
        str = Nysiis.PAT_EE_IE.matcher((CharSequence)str).replaceFirst("Y");
        str = Nysiis.PAT_DT_ETC.matcher((CharSequence)str).replaceFirst("D");
