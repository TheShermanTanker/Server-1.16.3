...
public class Languages {
    ...
    public static Languages getInstance(final String languagesResourceName) {
        final Set<String> ls = (Set<String>)new HashSet();
        ...
        return new Languages((Set<String>)Collections.unmodifiableSet((Set)ls));
    }
    ...
    static {
        LANGUAGES = (Map)new EnumMap((Class)NameType.class);
    ...
    public abstract static class LanguageSet {
        ...
        public abstract LanguageSet restrictTo(final LanguageSet languageSet);
        
        abstract LanguageSet merge(final LanguageSet languageSet);
    }
    ...
    public static final class SomeLanguages extends LanguageSet {
        ...
        private SomeLanguages(final Set<String> languages) {
            this.languages = (Set<String>)Collections.unmodifiableSet((Set)languages);
        }
        ...
        public LanguageSet restrictTo(final LanguageSet other) {
            ...
            final Set<String> ls = (Set<String>)new HashSet(Math.min(this.languages.size(), sl.languages.size()));
        ...
        public LanguageSet merge(final LanguageSet other) {
            ...
            final SomeLanguages sl = (SomeLanguages)other;
            final Set<String> ls = (Set<String>)new HashSet((Collection)this.languages);
