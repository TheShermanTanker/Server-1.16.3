...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
    ...
    abstract void encode(final byte[] arr, final int integer2, final int integer3, final Context context);
    
    abstract void decode(final byte[] arr, final int integer2, final int integer3, final Context context);
    
    protected abstract boolean isInAlphabet(final byte byte1);
    ...
    static class Context {
        ...
        public String toString() {
            return String.format("%s[buffer=%s, currentLinePos=%s, eof=%s, ibitWorkArea=%s, lbitWorkArea=%s, modulus=%s, pos=%s, readPos=%s]", new Object[] { this.getClass().getSimpleName(), Arrays.toString(this.buffer), this.currentLinePos, this.eof, this.ibitWorkArea, this.lbitWorkArea, this.modulus, this.pos, this.readPos });
        }
    }
}
