...
public class EventUtils {
    ...
    public static <L> void bindEventsToMethod(final Object target, final String methodName, final Object eventSource, final Class<L> listenerType, final String... eventTypes) {
        final L listener = (L)listenerType.cast(Proxy.newProxyInstance(target.getClass().getClassLoader(), new Class[] { listenerType }, (InvocationHandler)new EventBindingInvocationHandler(target, methodName, eventTypes)));
        EventUtils.<L>addEventListener(eventSource, listenerType, listener);
    }
    ...
    private static class EventBindingInvocationHandler implements InvocationHandler {
        ...
        EventBindingInvocationHandler(final Object target, final String methodName, final String[] eventTypes) {
            ...
            this.eventTypes = (Set<String>)new HashSet((Collection)Arrays.asList((Object[])eventTypes));
        }
