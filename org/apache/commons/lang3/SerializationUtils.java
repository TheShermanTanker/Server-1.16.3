...
public class SerializationUtils {
    public static <T extends Serializable> T clone(final T object) {
        ...
        try {
            in = new ClassLoaderAwareObjectInputStream((InputStream)bais, object.getClass().getClassLoader());
            ...
            throw new SerializationException("IOException while reading cloned object data", (Throwable)ex2);
        }
        finally {
            try {
                if (in != null) {
                ...
                throw new SerializationException("IOException on closing cloned object data InputStream.", (Throwable)ex3);
            }
        }
    }
    
    public static <T extends Serializable> T roundtrip(final T msg) {
        return SerializationUtils.<T>deserialize(serialize(msg));
    }
    ...
    public static <T> T deserialize(final byte[] objectData) {
        ...
        return SerializationUtils.<T>deserialize((InputStream)new ByteArrayInputStream(objectData));
    }
    ...
    static class ClassLoaderAwareObjectInputStream extends ObjectInputStream {
        ...
        static {
            (primitiveTypes = (Map)new HashMap()).put("byte", Byte.TYPE);
