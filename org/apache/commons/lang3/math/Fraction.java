...
public final class Fraction extends Number implements Comparable<Fraction> {
    ...
    private Fraction addSub(final Fraction fraction, final boolean isAdd) {
        ...
        final BigInteger uvp2 = BigInteger.valueOf((long)this.numerator).multiply(BigInteger.valueOf((long)(fraction.denominator / d1)));
        final BigInteger upv2 = BigInteger.valueOf((long)fraction.numerator).multiply(BigInteger.valueOf((long)(this.denominator / d1)));
    ...
    public String toString() {
        if (this.toString == null) {
            this.toString = new StringBuilder().append(this.getNumerator()).append("/").append(this.getDenominator()).toString();
        }
        ...
        if (this.toProperString == null) {
            if (this.numerator == 0) {
                ...
                if (properNumerator == 0) {
                    ...
                    this.toProperString = new StringBuilder().append(this.getProperWhole()).append(" ").append(properNumerator).append("/").append(this.getDenominator()).toString();
                }
            }
            else {
                this.toProperString = new StringBuilder().append(this.getNumerator()).append("/").append(this.getDenominator()).toString();
            }
        }
