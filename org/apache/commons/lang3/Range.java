...
public final class Range<T> implements Serializable {
    ...
    private Range(final T element1, final T element2, final Comparator<T> comp) {
        if (element1 == null || element2 == null) {
            throw new IllegalArgumentException(new StringBuilder().append("Elements in a range must not be null: element1=").append(element1).append(", element2=").append(element2).toString());
        }
        if (comp == null) {
    ...
    public Range<T> intersectionWith(final Range<T> other) {
        ...
        return Range.<T>between(min, max, this.getComparator());
    }
    ...
    public String toString() {
        if (this.toString == null) {
            this.toString = new StringBuilder().append("[").append(this.minimum).append("..").append(this.maximum).append("]").toString();
        }
