...
public class ClassUtils {
    ...
    public static String getAbbreviatedName(final String className, final int len) {
        ...
        final int packageLevels = StringUtils.countMatches((CharSequence)className, '.');
    ...
    public static List<Class<?>> getAllSuperclasses(final Class<?> cls) {
        ...
        final List<Class<?>> classes = (List<Class<?>>)new ArrayList();
    ...
    public static List<Class<?>> getAllInterfaces(final Class<?> cls) {
        ...
        final LinkedHashSet<Class<?>> interfacesFound = (LinkedHashSet<Class<?>>)new LinkedHashSet();
        getAllInterfaces(cls, (HashSet<Class<?>>)interfacesFound);
        return (List<Class<?>>)new ArrayList((Collection)interfacesFound);
    }
    ...
    public static List<Class<?>> convertClassNamesToClasses(final List<String> classNames) {
        ...
        final List<Class<?>> classes = (List<Class<?>>)new ArrayList(classNames.size());
    ...
    public static List<String> convertClassesToClassNames(final List<Class<?>> classes) {
        ...
        final List<String> classNames = (List<String>)new ArrayList(classes.size());
    ...
    public static boolean isAssignable(Class<?> cls, final Class<?> toClass, final boolean autoboxing) {
        ...
        if (!cls.isPrimitive()) {
            return toClass.isAssignableFrom((Class)cls);
        }
    ...
    public static Method getPublicMethod(final Class<?> cls, final String methodName, final Class<?>... parameterTypes) throws SecurityException, NoSuchMethodException {
        ...
        final List<Class<?>> candidateClasses = (List<Class<?>>)new ArrayList();
        candidateClasses.addAll((Collection)getAllInterfaces(cls));
        candidateClasses.addAll((Collection)getAllSuperclasses(cls));
    ...
    public static Iterable<Class<?>> hierarchy(final Class<?> type, final Interfaces interfacesBehavior) {
        final Iterable<Class<?>> classes = (Iterable<Class<?>>)new Iterable<Class<?>>() {
            public Iterator<Class<?>> iterator() {
                final MutableObject<Class<?>> next = new MutableObject<Class<?>>(type);
                return (Iterator<Class<?>>)new Iterator<Class<?>>() {
        ...
        return (Iterable<Class<?>>)new Iterable<Class<?>>() {
            public Iterator<Class<?>> iterator() {
                final Set<Class<?>> seenInterfaces = (Set<Class<?>>)new HashSet();
                final Iterator<Class<?>> wrapped = (Iterator<Class<?>>)classes.iterator();
                return (Iterator<Class<?>>)new Iterator<Class<?>>() {
                    ...
                    public Class<?> next() {
                        ...
                        final Set<Class<?>> currentInterfaces = (Set<Class<?>>)new LinkedHashSet();
                        this.walkInterfaces(currentInterfaces, nextSuperclass);
                        this.interfaces = (Iterator<Class<?>>)currentInterfaces.iterator();
    ...
    static {
        ...
        (namePrimitiveMap = (Map)new HashMap()).put("boolean", Boolean.TYPE);
        ...
        (primitiveWrapperMap = (Map)new HashMap()).put(Boolean.TYPE, Boolean.class);
        ...
        wrapperPrimitiveMap = (Map)new HashMap();
        ...
        m.put("double", "D");
        m.put("char", "C");
        final Map<String, String> r = (Map<String, String>)new HashMap();
        for (final Map.Entry<String, String> e : m.entrySet()) {
            r.put(e.getValue(), e.getKey());
        }
        abbreviationMap = Collections.unmodifiableMap((Map)m);
        reverseAbbreviationMap = Collections.unmodifiableMap((Map)r);
    }
