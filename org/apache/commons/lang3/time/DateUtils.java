...
public class DateUtils {
    ...
    public static Date round(final Object date, final int field) {
        ...
        throw new ClassCastException(new StringBuilder().append("Could not round ").append(date).toString());
    }
    ...
    public static Date truncate(final Object date, final int field) {
        ...
        throw new ClassCastException(new StringBuilder().append("Could not truncate ").append(date).toString());
    }
    ...
    public static Date ceiling(final Object date, final int field) {
        ...
        throw new ClassCastException(new StringBuilder().append("Could not find ceiling of for type: ").append(date.getClass()).toString());
    }
    ...
    private static void modify(final Calendar val, final int field, final ModifyType modType) {
        ...
        throw new IllegalArgumentException(new StringBuilder().append("The field ").append(field).append(" is not supported").toString());
    }
    ...
    public static Iterator<Calendar> iterator(final Calendar focus, final int rangeStyle) {
        ...
        Label_0237: {
            switch (rangeStyle) {
                ...
                default: {
                    throw new IllegalArgumentException(new StringBuilder().append("The range style ").append(rangeStyle).append(" is not valid.").toString());
                }
            }
        }
        if (startCutoff < 1) {
    ...
    public static Iterator<?> iterator(final Object focus, final int rangeStyle) {
        ...
        throw new ClassCastException(new StringBuilder().append("Could not iterate based on ").append(focus).toString());
    }
    ...
    private static long getFragment(final Calendar calendar, final int fragment, final TimeUnit unit) {
        ...
        switch (fragment) {
            ...
            default: {
                throw new IllegalArgumentException(new StringBuilder().append("The fragment ").append(fragment).append(" is not supported").toString());
            }
        }
        return result;
    }
