...
public class ObjectUtils {
    ...
    public static void identityToString(final Appendable appendable, final Object object) throws IOException {
        ...
        appendable.append((CharSequence)object.getClass().getName()).append('@').append((CharSequence)Integer.toHexString(System.identityHashCode(object)));
    }
    ...
    public static <T extends Comparable<? super T>> T min(final T... values) {
        ...
        if (values != null) {
            for (final T value : values) {
                if (ObjectUtils.<T>compare(value, result, true) < 0) {
                    result = value;
                }
            }
        }
    ...
    public static <T extends Comparable<? super T>> T max(final T... values) {
        ...
        if (values != null) {
            for (final T value : values) {
                if (ObjectUtils.<T>compare(value, result, false) > 0) {
                    result = value;
                }
            }
        }
    ...
    public static <T extends Comparable<? super T>> int compare(final T c1, final T c2) {
        return ObjectUtils.<T>compare(c1, c2, false);
    }
    ...
    public static <T extends Comparable<? super T>> T median(final T... items) {
        Validate.<T>notEmpty(items);
        Validate.<T>noNullElements(items);
        final TreeSet<T> sort = (TreeSet<T>)new TreeSet();
        Collections.addAll((Collection)sort, (Object[])items);
        final T result = (T)sort.toArray()[(sort.size() - 1) / 2];
        return result;
    }
    
    public static <T> T median(final Comparator<T> comparator, final T... items) {
        Validate.<T>notEmpty(items, "null/empty items", new Object[0]);
        Validate.<T>noNullElements(items);
        Validate.<Comparator<T>>notNull(comparator, "null comparator", new Object[0]);
        final TreeSet<T> sort = (TreeSet<T>)new TreeSet((Comparator)comparator);
        Collections.addAll((Collection)sort, (Object[])items);
        final T result = (T)sort.toArray()[(sort.size() - 1) / 2];
        return result;
    }
    ...
    public static <T> T mode(final T... items) {
        if (ArrayUtils.<T>isNotEmpty(items)) {
            final HashMap<T, MutableInt> occurrences = (HashMap<T, MutableInt>)new HashMap(items.length);
            for (final T t : items) {
    ...
    public static <T> T cloneIfPossible(final T obj) {
        final T clone = (T)ObjectUtils.clone(obj);
    ...
    public static byte CONST_BYTE(final int v) throws IllegalArgumentException {
        if (v < -128 || v > 127) {
            throw new IllegalArgumentException(new StringBuilder().append("Supplied value must be a valid byte literal between -128 and 127: [").append(v).append("]").toString());
        }
        return (byte)v;
    }
    ...
    public static short CONST_SHORT(final int v) throws IllegalArgumentException {
        if (v < -32768 || v > 32767) {
            throw new IllegalArgumentException(new StringBuilder().append("Supplied value must be a valid byte literal between -32768 and 32767: [").append(v).append("]").toString());
        }
        return (short)v;
    }
