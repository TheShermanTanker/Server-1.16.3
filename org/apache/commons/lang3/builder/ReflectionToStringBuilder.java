...
public class ReflectionToStringBuilder extends ToStringBuilder {
    ...
    public static <T> String toString(final T object, final ToStringStyle style, final boolean outputTransients, final boolean outputStatics, final Class<? super T> reflectUpToClass) {
        return new ReflectionToStringBuilder((T)object, style, null, reflectUpToClass, outputTransients, outputStatics).toString();
    }
    ...
    static String[] toNoNullStringArray(final Object[] array) {
        final List<String> list = (List<String>)new ArrayList(array.length);
    ...
    protected boolean accept(final Field field) {
        return field.getName().indexOf(36) == -1 && (!Modifier.isTransient(field.getModifiers()) || this.isAppendTransients()) && (!Modifier.isStatic(field.getModifiers()) || this.isAppendStatics()) && (this.excludeFieldNames == null || Arrays.binarySearch((Object[])this.excludeFieldNames, field.getName()) < 0) && !field.isAnnotationPresent((Class)ToStringExclude.class);
    }
    ...
    public ReflectionToStringBuilder setExcludeFieldNames(final String... excludeFieldNamesParam) {
        if (excludeFieldNamesParam == null) {
            ...
            Arrays.sort((Object[])(this.excludeFieldNames = toNoNullStringArray(excludeFieldNamesParam)));
        }
        return this;
    }
