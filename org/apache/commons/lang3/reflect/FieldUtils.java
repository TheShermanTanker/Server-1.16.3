...
public class FieldUtils {
    ...
    public static Field getField(final Class<?> cls, final String fieldName, final boolean forceAccess) {
        ...
        Validate.isTrue(StringUtils.isNotBlank((CharSequence)fieldName), "The field name must not be blank/empty");
    ...
    public static Field[] getAllFields(final Class<?> cls) {
        ...
        return (Field[])allFieldsList.toArray((Object[])new Field[allFieldsList.size()]);
    }
    
    public static List<Field> getAllFieldsList(final Class<?> cls) {
        Validate.isTrue(cls != null, "The class must not be null");
        final List<Field> allFields = (List<Field>)new ArrayList();
        for (Class<?> currentClass = cls; currentClass != null; currentClass = currentClass.getSuperclass()) {
            final Field[] declaredFields2;
            final Field[] declaredFields = declaredFields2 = currentClass.getDeclaredFields();
    ...
    public static Field[] getFieldsWithAnnotation(final Class<?> cls, final Class<? extends Annotation> annotationCls) {
        ...
        return (Field[])annotatedFieldsList.toArray((Object[])new Field[annotatedFieldsList.size()]);
    }
    
    public static List<Field> getFieldsListWithAnnotation(final Class<?> cls, final Class<? extends Annotation> annotationCls) {
        Validate.isTrue(annotationCls != null, "The annotation class must not be null");
        final List<Field> allFields = getAllFieldsList(cls);
        final List<Field> annotatedFields = (List<Field>)new ArrayList();
        for (final Field field : allFields) {
            if (field.getAnnotation((Class)annotationCls) != null) {
