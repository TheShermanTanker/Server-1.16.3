...
public class Validate {
    ...
    public static void isTrue(final boolean expression, final String message, final long value) {
        if (!expression) {
            throw new IllegalArgumentException(String.format(message, new Object[] { value }));
        }
    }
    ...
    public static <T> T notNull(final T object) {
        return Validate.<T>notNull(object, "The validated object is null", new Object[0]);
    }
    ...
    public static <T> T[] notEmpty(final T[] array) {
        return Validate.<T>notEmpty(array, "The validated array is empty", new Object[0]);
    }
    ...
    public static <T extends Collection<?>> T notEmpty(final T collection) {
        return Validate.<T>notEmpty(collection, "The validated collection is empty", new Object[0]);
    }
    ...
    public static <T extends Map<?, ?>> T notEmpty(final T map) {
        return Validate.<T>notEmpty(map, "The validated map is empty", new Object[0]);
    }
    ...
    public static <T extends CharSequence> T notEmpty(final T chars) {
        return Validate.<T>notEmpty(chars, "The validated character sequence is empty", new Object[0]);
    }
    ...
    public static <T extends CharSequence> T notBlank(final T chars) {
        return Validate.<T>notBlank(chars, "The validated character sequence is blank", new Object[0]);
    }
    
    public static <T> T[] noNullElements(final T[] array, final String message, final Object... values) {
        Validate.<T[]>notNull(array);
    ...
    public static <T> T[] noNullElements(final T[] array) {
        return Validate.<T>noNullElements(array, "The validated array contains null element at index: %d", new Object[0]);
    }
    
    public static <T extends Iterable<?>> T noNullElements(final T iterable, final String message, final Object... values) {
        Validate.<T>notNull(iterable);
        int i = 0;
    ...
    public static <T extends Iterable<?>> T noNullElements(final T iterable) {
        return Validate.<T>noNullElements(iterable, "The validated collection contains null element at index: %d", new Object[0]);
    }
    ...
    public static <T> T[] validIndex(final T[] array, final int index) {
        return Validate.<T>validIndex(array, index, "The validated array index is invalid: %d", new Object[] { index });
    }
    ...
    public static <T extends Collection<?>> T validIndex(final T collection, final int index) {
        return Validate.<T>validIndex(collection, index, "The validated collection index is invalid: %d", new Object[] { index });
    }
    
    public static <T extends CharSequence> T validIndex(final T chars, final int index, final String message, final Object... values) {
        Validate.<T>notNull(chars);
    ...
    public static <T extends CharSequence> T validIndex(final T chars, final int index) {
        return Validate.<T>validIndex(chars, index, "The validated character sequence index is invalid: %d", new Object[] { index });
    }
