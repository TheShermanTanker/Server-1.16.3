...
public class StrSubstitutor {
    ...
    public static String replace(final Object source, final Properties valueProperties) {
        ...
        final Map<String, String> valueMap = (Map<String, String>)new HashMap();
        ...
        return StrSubstitutor.<String>replace(source, valueMap);
    }
    ...
    public <V> StrSubstitutor(final Map<String, V> valueMap) {
        this(StrLookup.<V>mapLookup(valueMap), StrSubstitutor.DEFAULT_PREFIX, StrSubstitutor.DEFAULT_SUFFIX, '$');
    }
    
    public <V> StrSubstitutor(final Map<String, V> valueMap, final String prefix, final String suffix) {
        this(StrLookup.<V>mapLookup(valueMap), prefix, suffix, '$');
    }
    
    public <V> StrSubstitutor(final Map<String, V> valueMap, final String prefix, final String suffix, final char escape) {
        this(StrLookup.<V>mapLookup(valueMap), prefix, suffix, escape);
    }
    ...
    public <V> StrSubstitutor(final Map<String, V> valueMap, final String prefix, final String suffix, final char escape, final String valueDelimiter) {
        this(StrLookup.<V>mapLookup(valueMap), prefix, suffix, escape, valueDelimiter);
    }
                        ...
                        if (endMatchLen == 0) {
                            ...
                            if (nestedVarCount == 0) {
                                ...
                                if (priorVariables == null) {
                                    priorVariables = (List<String>)new ArrayList();
