...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    public StrBuilder append(final char[] chars, final int startIndex, final int length) {
        ...
        if (startIndex < 0 || startIndex > chars.length) {
            throw new StringIndexOutOfBoundsException(new StringBuilder().append("Invalid startIndex: ").append(length).toString());
        }
        if (length < 0 || startIndex + length > chars.length) {
            throw new StringIndexOutOfBoundsException(new StringBuilder().append("Invalid length: ").append(length).toString());
        }
        if (length > 0) {
            final int len = this.length();
            this.ensureCapacity(len + length);
    ...
    public StrBuilder insert(final int index, final char[] chars, final int offset, final int length) {
        ...
        if (offset < 0 || offset > chars.length) {
            throw new StringIndexOutOfBoundsException(new StringBuilder().append("Invalid offset: ").append(offset).toString());
        }
    ...
    public CharSequence subSequence(final int startIndex, final int endIndex) {
        ...
        return (CharSequence)this.substring(startIndex, endIndex);
    }
