...
public class UnicodeEscaper extends CodePointTranslator {
    ...
    public boolean translate(final int codepoint, final Writer out) throws IOException {
        ...
        if (codepoint > 65535) {
            ...
            out.write("\\u");
            out.write((int)UnicodeEscaper.HEX_DIGITS[codepoint >> 12 & 0xF]);
            out.write((int)UnicodeEscaper.HEX_DIGITS[codepoint >> 8 & 0xF]);
            out.write((int)UnicodeEscaper.HEX_DIGITS[codepoint >> 4 & 0xF]);
            out.write((int)UnicodeEscaper.HEX_DIGITS[codepoint & 0xF]);
        }
        return true;
    }
