...
public class StrTokenizer implements ListIterator<String>, Cloneable {
    ...
    public List<String> getTokenList() {
        this.checkTokenized();
        final List<String> list = (List<String>)new ArrayList(this.tokens.length);
    ...
    protected List<String> tokenize(final char[] srcChars, final int offset, final int count) {
        ...
        final List<String> tokenList = (List<String>)new ArrayList();
        int pos = offset;
    ...
    public String toString() {
        ...
        return new StringBuilder().append("StrTokenizer").append(this.getTokenList()).toString();
    }
