...
public class ExceptionUtils {
    ...
    public static String[] getDefaultCauseMethodNames() {
        return ArrayUtils.<String>clone(ExceptionUtils.CAUSE_METHOD_NAMES);
    }
    ...
    public static List<Throwable> getThrowableList(Throwable throwable) {
        List<Throwable> list;
        for (list = (List<Throwable>)new ArrayList(); throwable != null && !list.contains(throwable); throwable = getCause(throwable)) {
            list.add(throwable);
        }
        return list;
    }
    ...
    public static String[] getRootCauseStackTrace(final Throwable throwable) {
        ...
        final List<String> frames = (List<String>)new ArrayList();
        ...
        return (String[])frames.toArray((Object[])new String[frames.size()]);
    }
    ...
    public static String getStackTrace(final Throwable throwable) {
        ...
        final PrintWriter pw = new PrintWriter((Writer)sw, true);
    ...
    public static <R> R rethrow(final Throwable throwable) {
        return (R)ExceptionUtils.<Object, Throwable>typeErasure(throwable);
    }
