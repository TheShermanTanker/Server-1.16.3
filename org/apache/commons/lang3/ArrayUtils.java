...
public class ArrayUtils {
    ...
    public static Map<Object, Object> toMap(final Object[] array) {
        ...
        final Map<Object, Object> map = (Map<Object, Object>)new HashMap((int)(array.length * 1.5));
    ...
    public static <T> T[] subarray(final T[] array, int startIndexInclusive, int endIndexExclusive) {
        ...
        if (newSize <= 0) {
            final T[] emptyArray = (T[])Array.newInstance((Class)type, 0);
            return emptyArray;
        }
        final T[] subarray = (T[])Array.newInstance((Class)type, newSize);
    ...
    public static <T> T[] addAll(final T[] array1, final T... array2) {
        if (array1 == null) {
            return ArrayUtils.<T>clone(array2);
        }
        if (array2 == null) {
            return ArrayUtils.<T>clone(array1);
        }
        final Class<?> type1 = array1.getClass().getComponentType();
        final T[] joinedArray = (T[])Array.newInstance((Class)type1, array1.length + array2.length);
        ...
        try {
            ...
            if (!type1.isAssignableFrom((Class)type2)) {
                throw new IllegalArgumentException("Cannot store " + type2.getName() + " in an array of " + type1.getName(), (Throwable)ase);
            }
            throw ase;
        }
        return joinedArray;
    ...
    private static Object copyArrayGrow1(final Object array, final Class<?> newArrayComponentType) {
        ...
        return Array.newInstance((Class)newArrayComponentType, 1);
    }
    ...
    private static Object add(final Object array, final int index, final Object element, final Class<?> clss) {
        if (array == null) {
            if (index != 0) {
                throw new IndexOutOfBoundsException(new StringBuilder().append("Index: ").append(index).append(", Length: 0").toString());
            }
            final Object joinedArray = Array.newInstance((Class)clss, 1);
            ...
            final Object result = Array.newInstance((Class)clss, length + 1);
    ...
    public static <T> T[] removeElement(final T[] array, final Object element) {
        ...
        if (index == -1) {
            return ArrayUtils.<T>clone(array);
        }
        return ArrayUtils.<T>remove(array, index);
    }
    ...
    public static <T> T[] removeElements(final T[] array, final T... values) {
        ...
        final HashMap<T, MutableInt> occurrences = (HashMap<T, MutableInt>)new HashMap(values.length);
    ...
    public static byte[] removeElements(final byte[] array, final byte... values) {
        ...
        final Map<Byte, MutableInt> occurrences = (Map<Byte, MutableInt>)new HashMap(values.length);
    ...
    public static short[] removeElements(final short[] array, final short... values) {
        ...
        final HashMap<Short, MutableInt> occurrences = (HashMap<Short, MutableInt>)new HashMap(values.length);
    ...
    public static int[] removeElements(final int[] array, final int... values) {
        ...
        final HashMap<Integer, MutableInt> occurrences = (HashMap<Integer, MutableInt>)new HashMap(values.length);
    ...
    public static char[] removeElements(final char[] array, final char... values) {
        ...
        final HashMap<Character, MutableInt> occurrences = (HashMap<Character, MutableInt>)new HashMap(values.length);
    ...
    public static long[] removeElements(final long[] array, final long... values) {
        ...
        final HashMap<Long, MutableInt> occurrences = (HashMap<Long, MutableInt>)new HashMap(values.length);
    ...
    public static float[] removeElements(final float[] array, final float... values) {
        ...
        final HashMap<Float, MutableInt> occurrences = (HashMap<Float, MutableInt>)new HashMap(values.length);
    ...
    public static double[] removeElements(final double[] array, final double... values) {
        ...
        final HashMap<Double, MutableInt> occurrences = (HashMap<Double, MutableInt>)new HashMap(values.length);
    ...
    public static boolean[] removeElements(final boolean[] array, final boolean... values) {
        ...
        final HashMap<Boolean, MutableInt> occurrences = (HashMap<Boolean, MutableInt>)new HashMap(2);
    ...
    public static <T extends Comparable<? super T>> boolean isSorted(final T[] array) {
        return ArrayUtils.<T>isSorted(array, (java.util.Comparator<T>)new Comparator<T>() {
    ...
    public static <T> T[] removeAllOccurences(final T[] array, final T element) {
        ...
        int count;
        for (count = 1; (index = indexOf(array, element, indices[count - 1] + 1)) != -1; indices[count++] = index) {}
        return ArrayUtils.<T>removeAll(array, Arrays.copyOf(indices, count));
    }
