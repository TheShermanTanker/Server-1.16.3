...
public class IOUtils {
    ...
    public static BufferedReader toBufferedReader(final Reader reader, final int size) {
        return (reader instanceof BufferedReader) ? reader : new BufferedReader(reader, size);
    }
    ...
    public static BufferedWriter buffer(final Writer writer, final int size) {
        return (writer instanceof BufferedWriter) ? writer : new BufferedWriter(writer, size);
    }
    ...
    public static BufferedOutputStream buffer(final OutputStream outputStream, final int size) {
        ...
        return (outputStream instanceof BufferedOutputStream) ? outputStream : new BufferedOutputStream(outputStream, size);
    }
    ...
    public static BufferedInputStream buffer(final InputStream inputStream, final int size) {
        ...
        return (inputStream instanceof BufferedInputStream) ? inputStream : new BufferedInputStream(inputStream, size);
    }
    ...
    public static LineIterator lineIterator(final InputStream input, final Charset encoding) throws IOException {
        return new LineIterator((Reader)new InputStreamReader(input, Charsets.toCharset(encoding)));
    }
    ...
    public static InputStream toInputStream(final String input, final Charset encoding) {
        return (InputStream)new ByteArrayInputStream(input.getBytes(Charsets.toCharset(encoding)));
    }
    ...
    public static long copyLarge(final InputStream input, final OutputStream output, final long inputOffset, final long length, final byte[] buffer) throws IOException {
        ...
        long totalRead;
        int read;
        for (totalRead = 0L; bytesToRead > 0 && -1 != (read = input.read(buffer, 0, bytesToRead)); bytesToRead = (int)Math.min(length - totalRead, (long)bufferLength)) {
    ...
    public static long copyLarge(final Reader input, final Writer output, final long inputOffset, final long length, final char[] buffer) throws IOException {
        ...
        long totalRead;
        int read;
        for (totalRead = 0L; bytesToRead > 0 && -1 != (read = input.read(buffer, 0, bytesToRead)); bytesToRead = (int)Math.min(length - totalRead, (long)buffer.length)) {
            output.write(buffer, 0, read);
            totalRead += read;
            if (length > 0L) {}
        }
    ...
    public static boolean contentEquals(InputStream input1, InputStream input2) throws IOException {
        ...
        if (!(input1 instanceof BufferedInputStream)) {
            input1 = (InputStream)new BufferedInputStream(input1);
        }
        if (!(input2 instanceof BufferedInputStream)) {
            input2 = (InputStream)new BufferedInputStream(input2);
        }
    ...
    public static boolean contentEquals(Reader input1, Reader input2) throws IOException {
        ...
        input1 = (Reader)toBufferedReader(input1);
        input2 = (Reader)toBufferedReader(input2);
        for (int ch = input1.read(); -1 != ch; ch = input1.read()) {
            final int ch2 = input2.read();
            if (ch != ch2) {
                return false;
    ...
    public static void readFully(final ReadableByteChannel input, final ByteBuffer buffer) throws IOException {
        ...
        if (actual != expected) {
            throw new EOFException(new StringBuilder().append("Length to read: ").append(expected).append(" actual: ").append(actual).toString());
        }
    }
    ...
    static {
        ...
        final PrintWriter out = new PrintWriter((Writer)buf);
        out.println();
