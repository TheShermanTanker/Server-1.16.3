...
public class ByteArrayOutputStream extends OutputStream {
    ...
    public ByteArrayOutputStream(final int size) {
        this.buffers = (List<byte[]>)new ArrayList();
    ...
    public synchronized InputStream toInputStream() {
        ...
        final List<ByteArrayInputStream> list = (List<ByteArrayInputStream>)new ArrayList(this.buffers.size());
        for (final byte[] buf : this.buffers) {
            final int c = Math.min(buf.length, remaining);
        ...
        return (InputStream)new SequenceInputStream(Collections.enumeration((Collection)list));
    }
