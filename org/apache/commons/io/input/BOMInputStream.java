...
public class BOMInputStream extends ProxyInputStream {
    ...
    public BOMInputStream(final InputStream delegate, final boolean include, final ByteOrderMark... boms) {
        ...
        Arrays.sort((Object[])boms, (Comparator)BOMInputStream.ByteOrderMarkLengthComparator);
        this.boms = (List<ByteOrderMark>)Arrays.asList((Object[])boms);
    }
    ...
    static {
        ByteOrderMarkLengthComparator = (Comparator)new Comparator<ByteOrderMark>() {
