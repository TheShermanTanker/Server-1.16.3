...
public class FileCleaningTracker {
    ...
    public FileCleaningTracker() {
        this.q = (ReferenceQueue<Object>)new ReferenceQueue();
        this.trackers = (Collection<Tracker>)Collections.synchronizedSet((Set)new HashSet());
        this.deleteFailures = (List<String>)Collections.synchronizedList((List)new ArrayList());
    ...
    private static final class Tracker extends PhantomReference<Object> {
        ...
        Tracker(final String path, final FileDeleteStrategy deleteStrategy, final Object marker, final ReferenceQueue<? super Object> queue) {
            super(marker, (ReferenceQueue)queue);
            this.path = path;
