...
public class SizeFileComparator extends AbstractFileComparator implements Serializable {
    ...
    static {
        ...
        SIZE_REVERSE = (Comparator)new ReverseComparator(SizeFileComparator.SIZE_COMPARATOR);
        SIZE_SUMDIR_COMPARATOR = (Comparator)new SizeFileComparator(true);
        SIZE_SUMDIR_REVERSE = (Comparator)new ReverseComparator(SizeFileComparator.SIZE_SUMDIR_COMPARATOR);
    }
}
