...
public class FileAlterationObserver implements Serializable {
    ...
    protected FileAlterationObserver(final FileEntry rootEntry, final FileFilter fileFilter, final IOCase caseSensitivity) {
        this.listeners = (List<FileAlterationListener>)new CopyOnWriteArrayList();
        if (rootEntry == null) {
    ...
    public Iterable<FileAlterationListener> getListeners() {
        return (Iterable<FileAlterationListener>)this.listeners;
    }
    ...
    private File[] listFiles(final File file) {
        ...
        if (this.comparator != null && children.length > 1) {
            Arrays.sort((Object[])children, (Comparator)this.comparator);
        }
        return children;
    }
