...
public final class FileAlterationMonitor implements Runnable {
    ...
    public FileAlterationMonitor(final long interval) {
        this.observers = (List<FileAlterationObserver>)new CopyOnWriteArrayList();
        this.thread = null;
        this.running = false;
    ...
    public Iterable<FileAlterationObserver> getObservers() {
        return (Iterable<FileAlterationObserver>)this.observers;
    }
    ...
    public synchronized void start() throws Exception {
        ...
        if (this.threadFactory != null) {
            this.thread = this.threadFactory.newThread((Runnable)this);
        }
        else {
