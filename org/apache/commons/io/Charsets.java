...
public class Charsets {
    ...
    public static SortedMap<String, Charset> requiredCharsets() {
        final TreeMap<String, Charset> m = (TreeMap<String, Charset>)new TreeMap(String.CASE_INSENSITIVE_ORDER);
        ...
        return (SortedMap<String, Charset>)Collections.unmodifiableSortedMap((SortedMap)m);
    }
