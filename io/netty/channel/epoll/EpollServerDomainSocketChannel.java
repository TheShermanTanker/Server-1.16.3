...
public final class EpollServerDomainSocketChannel extends AbstractEpollServerChannel implements ServerDomainSocketChannel {
    ...
    public EpollServerDomainSocketChannel(final int fd) {
        super(fd);
        this.config = new EpollServerChannelConfig(this);
    }
    
    EpollServerDomainSocketChannel(final LinuxSocket fd) {
        super(fd);
        this.config = new EpollServerChannelConfig(this);
    }
    
    EpollServerDomainSocketChannel(final LinuxSocket fd, final boolean active) {
        super(fd, active);
        this.config = new EpollServerChannelConfig(this);
    }
