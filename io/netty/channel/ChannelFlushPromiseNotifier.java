...
public final class ChannelFlushPromiseNotifier {
    ...
    public ChannelFlushPromiseNotifier(final boolean tryNotify) {
        this.flushCheckpoints = (Queue<FlushCheckpoint>)new ArrayDeque();
    ...
    public ChannelFlushPromiseNotifier add(final ChannelPromise promise, final long pendingDataSize) {
        ...
        if (pendingDataSize < 0L) {
            throw new IllegalArgumentException(new StringBuilder().append("pendingDataSize must be >= 0 but was ").append(pendingDataSize).toString());
        }
    ...
    public ChannelFlushPromiseNotifier increaseWriteCounter(final long delta) {
        if (delta < 0L) {
            throw new IllegalArgumentException(new StringBuilder().append("delta must be >= 0 but was ").append(delta).toString());
        }
    ...
    public ChannelFlushPromiseNotifier notifyPromises(final Throwable cause) {
        this.notifyPromises();
        while (true) {
            final FlushCheckpoint cp = (FlushCheckpoint)this.flushCheckpoints.poll();
            if (cp == null) {
                break;
            }
            if (this.tryNotify) {
    ...
    private void notifyPromises0(final Throwable cause) {
        ...
        while (true) {
            final FlushCheckpoint cp = (FlushCheckpoint)this.flushCheckpoints.peek();
            if (cp == null) {
                this.writeCounter = 0L;
                break;
            }
    ...
    interface FlushCheckpoint {
        ...
        void flushCheckpoint(final long long1);
