...
public class EmbeddedChannel extends AbstractChannel {
    ...
    public EmbeddedChannel(final ChannelId channelId, final boolean hasDisconnect, final ChannelConfig config, final ChannelHandler... handlers) {
        ...
        this.metadata = metadata(hasDisconnect);
        this.config = ObjectUtil.<ChannelConfig>checkNotNull(config, "config");
    ...
    private void setup(final boolean register, final ChannelHandler... handlers) {
        ObjectUtil.<ChannelHandler[]>checkNotNull(handlers, "handlers");
    ...
    public Queue<Object> inboundMessages() {
        if (this.inboundMessages == null) {
            this.inboundMessages = (Queue<Object>)new ArrayDeque();
        }
    ...
    public Queue<Object> outboundMessages() {
        if (this.outboundMessages == null) {
            this.outboundMessages = (Queue<Object>)new ArrayDeque();
        }
    ...
    public <T> T readInbound() {
        ...
        if (message != null) {
            ReferenceCountUtil.<T>touch(message, "Caller of readInbound() will handle the message from this point");
        }
        return message;
    }
    ...
    public <T> T readOutbound() {
        ...
        if (message != null) {
            ReferenceCountUtil.<T>touch(message, "Caller of readOutbound() will handle the message from this point.");
        }
        return message;
    }
    ...
    public boolean writeOutbound(final Object... msgs) {
        ...
        try {
            ...
            for (int size = futures.size(), i = 0; i < size; ++i) {
                final ChannelFuture future = (ChannelFuture)futures.get(i);
                if (future.isDone()) {
