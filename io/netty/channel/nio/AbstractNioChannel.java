...
public abstract class AbstractNioChannel extends AbstractChannel {
    ...
    protected AbstractNioChannel(final Channel parent, final SelectableChannel ch, final int readInterestOp) {
        super(parent);
        this.clearReadPendingRunnable = (Runnable)new Runnable() {
            public void run() {
        ...
        try {
            ...
            try {
                ...
                if (AbstractNioChannel.logger.isWarnEnabled()) {
                    AbstractNioChannel.logger.warn("Failed to close a partially initialized socket.", (Throwable)e2);
                }
            }
            throw new ChannelException("Failed to enter non-blocking mode.", (Throwable)e3);
        }
    }
    ...
    protected abstract boolean doConnect(final SocketAddress socketAddress1, final SocketAddress socketAddress2) throws Exception;
    ...
    protected void doClose() throws Exception {
        ...
        if (promise != null) {
            promise.tryFailure((Throwable)AbstractNioChannel.DO_CLOSE_CLOSED_CHANNEL_EXCEPTION);
    ...
    static {
        ...
        DO_CLOSE_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.<ClosedChannelException>unknownStackTrace(new ClosedChannelException(), AbstractNioChannel.class, "doClose()");
    }
