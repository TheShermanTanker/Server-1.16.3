...
public abstract class AbstractNioMessageChannel extends AbstractNioChannel {
    ...
    protected abstract int doReadMessages(final List<Object> list) throws Exception;
    
    protected abstract boolean doWriteMessage(final Object object, final ChannelOutboundBuffer channelOutboundBuffer) throws Exception;
    
    private final class NioMessageUnsafe extends AbstractNioUnsafe {
        private final List<Object> readBuf;
        
        private NioMessageUnsafe() {
            this.readBuf = (List<Object>)new ArrayList();
        }
