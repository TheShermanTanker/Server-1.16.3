...
public abstract class AbstractNioByteChannel extends AbstractNioChannel {
    ...
    protected abstract long doWriteFileRegion(final FileRegion fileRegion) throws Exception;
    
    protected abstract int doReadBytes(final ByteBuf byteBuf) throws Exception;
    
    protected abstract int doWriteBytes(final ByteBuf byteBuf) throws Exception;
