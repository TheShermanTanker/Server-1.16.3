...
public final class DefaultChannelId implements ChannelId {
    ...
    private static int defaultProcessId() {
        ...
        try {
            ...
            final Method getRuntimeMXBean = mgmtFactoryType.getMethod("getRuntimeMXBean", (Class[])EmptyArrays.EMPTY_CLASSES);
            final Object bean = getRuntimeMXBean.invoke(null, EmptyArrays.EMPTY_OBJECTS);
            final Method getName = runtimeMxBeanType.getMethod("getName", (Class[])EmptyArrays.EMPTY_CLASSES);
            ...
            try {
                ...
                final Method myPid = processType.getMethod("myPid", (Class[])EmptyArrays.EMPTY_CLASSES);
    ...
    static {
        ...
        if (customProcessId != null) {
            ...
            if (processId < 0) {
                ...
                DefaultChannelId.logger.debug("-Dio.netty.processId: {} (user-set)", processId);
            }
        }
        if (processId < 0) {
            processId = defaultProcessId();
            if (DefaultChannelId.logger.isDebugEnabled()) {
                DefaultChannelId.logger.debug("-Dio.netty.processId: {} (auto-detected)", processId);
            }
        }
