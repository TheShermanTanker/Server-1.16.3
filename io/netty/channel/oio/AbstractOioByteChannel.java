...
public abstract class AbstractOioByteChannel extends AbstractOioChannel {
    ...
    private void closeOnRead(final ChannelPipeline pipeline) {
        if (this.isOpen()) {
            if (Boolean.TRUE.equals(this.config().<Boolean>getOption(ChannelOption.ALLOW_HALF_CLOSURE))) {
                this.shutdownInput();
    ...
    protected void doWrite(final ChannelOutboundBuffer in) throws Exception {
        while (true) {
            ...
            if (msg instanceof ByteBuf) {
                ...
                in.remove((Throwable)new UnsupportedOperationException("unsupported message type: " + StringUtil.simpleClassName(msg)));
            }
        }
    }
    ...
    protected abstract int doReadBytes(final ByteBuf byteBuf) throws Exception;
    
    protected abstract void doWriteBytes(final ByteBuf byteBuf) throws Exception;
    
    protected abstract void doWriteFileRegion(final FileRegion fileRegion) throws Exception;
