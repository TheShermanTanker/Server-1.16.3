...
public class FileDescriptor {
    ...
    public String toString() {
        return new StringBuilder().append("FileDescriptor{fd=").append(this.fd).append('}').toString();
    }
    ...
    public static FileDescriptor from(final String path) throws IOException {
        ObjectUtil.<String>checkNotNull(path, "path");
    ...
    public static FileDescriptor from(final File file) throws IOException {
        return from(ObjectUtil.<File>checkNotNull(file, "file").getPath());
    }
    ...
    private static native int open(final String string);
    
    private static native int close(final int integer);
    
    private static native int write(final int integer1, final ByteBuffer byteBuffer, final int integer3, final int integer4);
    
    private static native int writeAddress(final int integer1, final long long2, final int integer3, final int integer4);
    
    private static native long writev(final int integer1, final ByteBuffer[] arr, final int integer3, final int integer4, final long long5);
    
    private static native long writevAddresses(final int integer1, final long long2, final int integer3);
    
    private static native int read(final int integer1, final ByteBuffer byteBuffer, final int integer3, final int integer4);
    
    private static native int readAddress(final int integer1, final long long2, final int integer3, final int integer4);
    
    private static native long newPipe();
    
    static {
        WRITE_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.<ClosedChannelException>unknownStackTrace(new ClosedChannelException(), FileDescriptor.class, "write(..)");
        WRITE_ADDRESS_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.<ClosedChannelException>unknownStackTrace(new ClosedChannelException(), FileDescriptor.class, "writeAddress(..)");
        WRITEV_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.<ClosedChannelException>unknownStackTrace(new ClosedChannelException(), FileDescriptor.class, "writev(..)");
        WRITEV_ADDRESSES_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.<ClosedChannelException>unknownStackTrace(new ClosedChannelException(), FileDescriptor.class, "writevAddresses(..)");
        READ_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.<ClosedChannelException>unknownStackTrace(new ClosedChannelException(), FileDescriptor.class, "read(..)");
        READ_ADDRESS_CLOSED_CHANNEL_EXCEPTION = ThrowableUtil.<ClosedChannelException>unknownStackTrace(new ClosedChannelException(), FileDescriptor.class, "readAddress(..)");
        WRITE_CONNECTION_RESET_EXCEPTION = ThrowableUtil.<Errors.NativeIoException>unknownStackTrace(Errors.newConnectionResetException("syscall:write", Errors.ERRNO_EPIPE_NEGATIVE), FileDescriptor.class, "write(..)");
        WRITE_ADDRESS_CONNECTION_RESET_EXCEPTION = ThrowableUtil.<Errors.NativeIoException>unknownStackTrace(Errors.newConnectionResetException("syscall:write", Errors.ERRNO_EPIPE_NEGATIVE), FileDescriptor.class, "writeAddress(..)");
        WRITEV_CONNECTION_RESET_EXCEPTION = ThrowableUtil.<Errors.NativeIoException>unknownStackTrace(Errors.newConnectionResetException("syscall:writev", Errors.ERRNO_EPIPE_NEGATIVE), FileDescriptor.class, "writev(..)");
        WRITEV_ADDRESSES_CONNECTION_RESET_EXCEPTION = ThrowableUtil.<Errors.NativeIoException>unknownStackTrace(Errors.newConnectionResetException("syscall:writev", Errors.ERRNO_EPIPE_NEGATIVE), FileDescriptor.class, "writeAddresses(..)");
        READ_CONNECTION_RESET_EXCEPTION = ThrowableUtil.<Errors.NativeIoException>unknownStackTrace(Errors.newConnectionResetException("syscall:read", Errors.ERRNO_ECONNRESET_NEGATIVE), FileDescriptor.class, "read(..)");
        READ_ADDRESS_CONNECTION_RESET_EXCEPTION = ThrowableUtil.<Errors.NativeIoException>unknownStackTrace(Errors.newConnectionResetException("syscall:read", Errors.ERRNO_ECONNRESET_NEGATIVE), FileDescriptor.class, "readAddress(..)");
        stateUpdater = AtomicIntegerFieldUpdater.newUpdater((Class)FileDescriptor.class, "state");
    }
}
