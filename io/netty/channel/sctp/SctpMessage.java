...
public final class SctpMessage extends DefaultByteBufHolder {
    ...
    public String toString() {
        return new StringBuilder().append("SctpFrame{streamIdentifier=").append(this.streamIdentifier).append(", protocolIdentifier=").append(this.protocolIdentifier).append(", unordered=").append(this.unordered).append(", data=").append(this.contentToString()).append('}').toString();
    }
}
