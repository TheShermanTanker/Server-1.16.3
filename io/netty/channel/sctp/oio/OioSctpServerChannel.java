...
public class OioSctpServerChannel extends AbstractOioMessageChannel implements SctpServerChannel {
        ...
        try {
            ...
            if (!success) {
                try {
                    ...
                    OioSctpServerChannel.logger.warn("Failed to close a sctp server channel.", (Throwable)e2);
                }
            }
        }
    }
    ...
    protected SocketAddress localAddress0() {
        try {
            final Iterator<SocketAddress> i = (Iterator<SocketAddress>)this.sch.getAllLocalAddresses().iterator();
            if (i.hasNext()) {
    ...
    public Set<InetSocketAddress> allLocalAddresses() {
        try {
            final Set<SocketAddress> allLocalAddresses = (Set<SocketAddress>)this.sch.getAllLocalAddresses();
    ...
    protected void doClose() throws Exception {
        try {
            ...
            OioSctpServerChannel.logger.warn("Failed to close a selector.", (Throwable)e);
        }
        this.sch.close();
    }
    ...
    protected int doReadMessages(final List<Object> buf) throws Exception {
        ...
        try {
            ...
            if (selectedKeys > 0) {
                final Iterator<SelectionKey> selectionKeys = (Iterator<SelectionKey>)this.selector.selectedKeys().iterator();
                do {
                    final SelectionKey key = (SelectionKey)selectionKeys.next();
