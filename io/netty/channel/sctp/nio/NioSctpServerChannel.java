...
public class NioSctpServerChannel extends AbstractNioMessageChannel implements SctpServerChannel {
    ...
    private static com.sun.nio.sctp.SctpServerChannel newSocket() {
        try {
            ...
            throw new ChannelException("Failed to open a server socket.", (Throwable)e);
        }
    }
    
    public NioSctpServerChannel() {
        super(null, (SelectableChannel)newSocket(), 16);
    ...
    public Set<InetSocketAddress> allLocalAddresses() {
        try {
            final Set<SocketAddress> allLocalAddresses = (Set<SocketAddress>)this.javaChannel().getAllLocalAddresses();
    ...
    protected SocketAddress localAddress0() {
        try {
            final Iterator<SocketAddress> i = (Iterator<SocketAddress>)this.javaChannel().getAllLocalAddresses().iterator();
            if (i.hasNext()) {
