...
public abstract class MultithreadEventLoopGroup extends MultithreadEventExecutorGroup implements EventLoopGroup {
    ...
    protected ThreadFactory newDefaultThreadFactory() {
        return (ThreadFactory)new DefaultThreadFactory(this.getClass(), 10);
    }
    ...
    @Override
    protected abstract EventLoop newChild(final Executor executor, final Object... arr) throws Exception;
    ...
    static {
        ...
        if (MultithreadEventLoopGroup.logger.isDebugEnabled()) {
            MultithreadEventLoopGroup.logger.debug("-Dio.netty.eventLoopThreads: {}", MultithreadEventLoopGroup.DEFAULT_EVENT_LOOP_THREADS);
        }
    }
}
