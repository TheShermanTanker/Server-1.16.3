...
public class KQueueChannelConfig extends DefaultChannelConfig {
    ...
    public KQueueChannelConfig setRecvByteBufAllocator(final RecvByteBufAllocator allocator) {
        if (!(allocator.newHandle() instanceof RecvByteBufAllocator.ExtendedHandle)) {
            throw new IllegalArgumentException(new StringBuilder().append("allocator.newHandle() must return an object of type: ").append(RecvByteBufAllocator.ExtendedHandle.class).toString());
        }
