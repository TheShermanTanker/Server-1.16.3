...
public class NioUdtByteConnectorChannel extends AbstractNioByteChannel implements UdtChannel {
        ...
        try {
            ...
            try {
                ...
                if (NioUdtByteConnectorChannel.logger.isWarnEnabled()) {
                    NioUdtByteConnectorChannel.logger.warn("Failed to close channel.", (Throwable)e2);
                }
            }
    ...
    protected ChannelFuture shutdownInput() {
        return this.newFailedFuture((Throwable)new UnsupportedOperationException("shutdownInput"));
    }
