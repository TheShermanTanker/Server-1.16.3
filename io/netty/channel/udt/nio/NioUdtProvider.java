...
public final class NioUdtProvider<T extends UdtChannel> implements ChannelFactory<T> {
    ...
    static ServerSocketChannelUDT newAcceptorChannelUDT(final TypeUDT type) {
        try {
            ...
            throw new ChannelException("failed to open a server socket channel", (Throwable)e);
        }
    }
    ...
    static SocketChannelUDT newConnectorChannelUDT(final TypeUDT type) {
        try {
            ...
            throw new ChannelException("failed to open a socket channel", (Throwable)e);
        }
    }
    ...
    static RendezvousChannelUDT newRendezvousChannelUDT(final TypeUDT type) {
        try {
            ...
            throw new ChannelException("failed to open a rendezvous channel", (Throwable)e);
        }
    }
        ...
        switch (this.kind) {
            case ACCEPTOR: {
                switch (this.type) {
                    ...
                    default: {
                        throw new IllegalStateException(new StringBuilder().append("wrong type=").append(this.type).toString());
                    }
                }
                break;
            }
            ...
            default: {
                throw new IllegalStateException(new StringBuilder().append("wrong kind=").append(this.kind).toString());
            }
        }
    }
