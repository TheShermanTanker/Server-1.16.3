...
public final class ShortCollections {
    ...
    private static final class EmptyMap implements ShortObjectMap<Object> {
        ...
        public Set<Short> keySet() {
            return (Set<Short>)Collections.emptySet();
        }
        ...
        public Set<Map.Entry<Short, Object>> entrySet() {
            return (Set<Map.Entry<Short, Object>>)Collections.emptySet();
        }
    }
    ...
    private static final class UnmodifiableMap<V> implements ShortObjectMap<V> {
        ...
        public Set<Short> keySet() {
            if (this.keySet == null) {
                this.keySet = (Set<Short>)Collections.unmodifiableSet(this.map.keySet());
            }
            return this.keySet;
        }
        ...
        public Set<Map.Entry<Short, V>> entrySet() {
            if (this.entrySet == null) {
                this.entrySet = (Set<Map.Entry<Short, V>>)Collections.unmodifiableSet(this.map.entrySet());
            }
