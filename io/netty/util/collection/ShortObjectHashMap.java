...
public class ShortObjectHashMap<V> implements ShortObjectMap<V> {
    ...
    public ShortObjectHashMap(final int initialCapacity, final float loadFactor) {
        this.keySet = (Set<Short>)new KeySet();
        this.entrySet = (Set<Map.Entry<Short, V>>)new EntrySet();
    ...
    private static <T> T toExternal(final T value) {
        ...
        return (value == ShortObjectHashMap.NULL_VALUE) ? null : value;
    }
    
    private static <T> T toInternal(final T value) {
        return (T)((value == null) ? ShortObjectHashMap.NULL_VALUE : value);
    }
    
    public V get(final short key) {
        final int index = this.indexOf(key);
        return (index == -1) ? null : ShortObjectHashMap.<V>toExternal(this.values[index]);
    }
    ...
    public V put(final short key, final V value) {
        ...
        while (this.values[index] != null) {
            if (this.keys[index] == key) {
                ...
                this.values[index] = ShortObjectHashMap.<V>toInternal(value);
                return ShortObjectHashMap.<V>toExternal(previousValue);
            }
    ...
    public void putAll(final Map<? extends Short, ? extends V> sourceMap) {
        if (sourceMap instanceof ShortObjectHashMap) {
            final ShortObjectHashMap<V> source = (ShortObjectHashMap)sourceMap;
        ...
        for (final Map.Entry<? extends Short, ? extends V> entry : sourceMap.entrySet()) {
    ...
    public V remove(final short key) {
        ...
        this.removeAt(index);
        return ShortObjectHashMap.<V>toExternal(prev);
    }
    ...
    public boolean containsValue(final Object value) {
        final V v1 = ShortObjectHashMap.<V>toInternal(value);
    ...
    public boolean equals(final Object obj) {
        ...
        final ShortObjectMap other = (ShortObjectMap)obj;
        ...
        for (int i = 0; i < this.values.length; ++i) {
            ...
            if (value != null) {
                final short key = this.keys[i];
                final Object otherValue = other.get(key);
                if (value == ShortObjectHashMap.NULL_VALUE) {
                    if (otherValue != null) {
                        return false;
                    }
                }
    ...
    private short objectToKey(final Object key) {
        return (short)key;
    }
    
    private int indexOf(final short key) {
        int index;
        final int startIndex = index = this.hashIndex(key);
        while (this.values[index] != null) {
    ...
    private int hashIndex(final short key) {
        return hashCode(key) & this.mask;
    }
    
    private static int hashCode(final short key) {
        return key;
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.values.length; ++i) {
            ...
            if (value != null) {
                ...
                sb.append(this.keyToString(this.keys[i])).append('=').append((value == this) ? "(this Map)" : ShortObjectHashMap.<V>toExternal(value));
                first = false;
            }
        }
    ...
    protected String keyToString(final short key) {
    ...
    private final class EntrySet extends AbstractSet<Map.Entry<Short, V>> {
        public Iterator<Map.Entry<Short, V>> iterator() {
            return (Iterator<Map.Entry<Short, V>>)new MapIterator();
        }
    ...
    private final class KeySet extends AbstractSet<Short> {
        ...
        public boolean retainAll(final Collection<?> retainedKeys) {
            ...
            final Iterator<PrimitiveEntry<V>> iter = (Iterator<PrimitiveEntry<V>>)ShortObjectHashMap.this.entries().iterator();
            while (iter.hasNext()) {
        ...
        public Iterator<Short> iterator() {
            return (Iterator<Short>)new Iterator<Short>() {
    ...
    private final class PrimitiveIterator implements Iterator<PrimitiveEntry<V>>, PrimitiveEntry<V> {
        ...
        public void setValue(final V value) {
            ShortObjectHashMap.this.values[this.entryIndex] = (V)ShortObjectHashMap.toInternal(value);
        }
    }
    ...
    private final class MapIterator implements Iterator<Map.Entry<Short, V>> {
        ...
        public Map.Entry<Short, V> next() {
            ...
            this.iter.next();
            return (Map.Entry<Short, V>)new MapEntry(this.iter.entryIndex);
        }
    ...
    final class MapEntry implements Map.Entry<Short, V> {
        ...
        public V setValue(final V value) {
            this.verifyExists();
            final V prevValue = (V)ShortObjectHashMap.toExternal(ShortObjectHashMap.this.values[this.entryIndex]);
            ShortObjectHashMap.this.values[this.entryIndex] = (V)ShortObjectHashMap.toInternal(value);
            return prevValue;
        }
