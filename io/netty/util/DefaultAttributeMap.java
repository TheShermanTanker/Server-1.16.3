...
public class DefaultAttributeMap implements AttributeMap {
    ...
    public <T> Attribute<T> attr(final AttributeKey<T> key) {
        ...
        if (attributes == null) {
            attributes = (AtomicReferenceArray<DefaultAttribute<?>>)new AtomicReferenceArray(4);
    ...
    static {
        updater = AtomicReferenceFieldUpdater.newUpdater((Class)DefaultAttributeMap.class, (Class)AtomicReferenceArray.class, "attributes");
    }
