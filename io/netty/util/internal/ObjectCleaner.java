...
public final class ObjectCleaner {
    ...
    public static void register(final Object object, final Runnable cleanupTask) {
        final AutomaticCleanerReference reference = new AutomaticCleanerReference(object, ObjectUtil.<Runnable>checkNotNull(cleanupTask, "cleanupTask"));
