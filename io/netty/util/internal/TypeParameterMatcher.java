...
public abstract class TypeParameterMatcher {
    ...
    public static TypeParameterMatcher find(final Object object, final Class<?> parametrizedSuperclass, final String typeParamName) {
        ...
        Map<String, TypeParameterMatcher> map = (Map<String, TypeParameterMatcher>)findCache.get(thisClass);
        if (map == null) {
            map = (Map<String, TypeParameterMatcher>)new HashMap();
    ...
    private static Class<?> find0(final Object object, Class<?> parametrizedSuperclass, String typeParamName) {
        ...
        while (true) {
            if (currentClass.getSuperclass() == parametrizedSuperclass) {
                ...
                final TypeVariable<?> v = actualTypeParam;
                currentClass = thisClass;
                if (!(v.getGenericDeclaration() instanceof Class)) {
                    return Object.class;
                }
                parametrizedSuperclass = v.getGenericDeclaration();
                typeParamName = v.getName();
                if (parametrizedSuperclass.isAssignableFrom((Class)thisClass)) {
                    continue;
                }
                return Object.class;
            }
    ...
    public abstract boolean match(final Object object);
