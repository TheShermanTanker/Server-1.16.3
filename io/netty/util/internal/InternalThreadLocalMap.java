...
public final class InternalThreadLocalMap extends UnpaddedInternalThreadLocalMap {
    ...
    public static InternalThreadLocalMap getIfSet() {
        ...
        return (InternalThreadLocalMap)InternalThreadLocalMap.slowThreadLocalMap.get();
    }
    ...
    public Map<Charset, CharsetEncoder> charsetEncoderCache() {
        ...
        if (cache == null) {
            cache = (this.charsetEncoderCache = (Map<Charset, CharsetEncoder>)new IdentityHashMap());
        }
        return cache;
    }
    ...
    public Map<Charset, CharsetDecoder> charsetDecoderCache() {
        ...
        if (cache == null) {
            cache = (this.charsetDecoderCache = (Map<Charset, CharsetDecoder>)new IdentityHashMap());
        }
        return cache;
    }
    
    public <E> ArrayList<E> arrayList() {
        return this.<E>arrayList(8);
    }
    
    public <E> ArrayList<E> arrayList(final int minCapacity) {
        final ArrayList<E> list = (ArrayList<E>)this.arrayList;
        if (list == null) {
            return (ArrayList<E>)(this.arrayList = (ArrayList<Object>)new ArrayList(minCapacity));
        }
        list.clear();
    ...
    public Map<Class<?>, TypeParameterMatcher> typeParameterMatcherGetCache() {
        ...
        if (cache == null) {
            cache = (this.typeParameterMatcherGetCache = (Map<Class<?>, TypeParameterMatcher>)new IdentityHashMap());
        }
        return cache;
    }
    ...
    public Map<Class<?>, Map<String, TypeParameterMatcher>> typeParameterMatcherFindCache() {
        ...
        if (cache == null) {
            cache = (this.typeParameterMatcherFindCache = (Map<Class<?>, Map<String, TypeParameterMatcher>>)new IdentityHashMap());
        }
        return cache;
    }
    ...
    public Map<Class<?>, Boolean> handlerSharableCache() {
        ...
        if (cache == null) {
            cache = (this.handlerSharableCache = (Map<Class<?>, Boolean>)new WeakHashMap(4));
        }
        return cache;
    }
    ...
    static {
        ...
        InternalThreadLocalMap.logger.debug("-Dio.netty.threadLocalMap.stringBuilder.initialSize: {}", InternalThreadLocalMap.STRING_BUILDER_INITIAL_SIZE);
        STRING_BUILDER_MAX_SIZE = SystemPropertyUtil.getInt("io.netty.threadLocalMap.stringBuilder.maxSize", 4096);
        InternalThreadLocalMap.logger.debug("-Dio.netty.threadLocalMap.stringBuilder.maxSize: {}", InternalThreadLocalMap.STRING_BUILDER_MAX_SIZE);
    }
}
