...
public final class Version {
    ...
    public static Map<String, Version> identify(ClassLoader classLoader) {
        ...
        try {
            final Enumeration<URL> resources = (Enumeration<URL>)classLoader.getResources("META-INF/io.netty.versions.properties");
        ...
        final Set<String> artifactIds = (Set<String>)new HashSet();
        ...
        final Map<String, Version> versions = (Map<String, Version>)new TreeMap();
