    ...
    static class AvailableProcessorsHolder {
        ...
        synchronized void setAvailableProcessors(final int availableProcessors) {
            ...
            if (this.availableProcessors != 0) {
                final String message = String.format(Locale.ROOT, "availableProcessors is already set to [%d], rejecting [%d]", new Object[] { this.availableProcessors, availableProcessors });
