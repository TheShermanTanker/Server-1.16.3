...
public class DefaultPromise<V> extends AbstractFuture<V> implements Promise<V> {
    ...
    public Promise<V> setFailure(final Throwable cause) {
        ...
        throw new IllegalStateException(new StringBuilder().append("complete already: ").append(this).toString(), cause);
    }
    ...
    public Promise<V> addListener(final GenericFutureListener<? extends Future<? super V>> listener) {
        ObjectUtil.<GenericFutureListener<? extends Future<? super V>>>checkNotNull(listener, "listener");
        synchronized (this) {
    ...
    public Promise<V> addListeners(final GenericFutureListener<? extends Future<? super V>>... listeners) {
        ObjectUtil.<GenericFutureListener[]>checkNotNull((GenericFutureListener[])listeners, "listeners");
        synchronized (this) {
    ...
    protected static void notifyListener(final EventExecutor eventExecutor, final Future<?> future, final GenericFutureListener<?> listener) {
        ObjectUtil.<EventExecutor>checkNotNull(eventExecutor, "eventExecutor");
        ObjectUtil.<Future<?>>checkNotNull(future, "future");
        ObjectUtil.<GenericFutureListener<?>>checkNotNull(listener, "listener");
    ...
    private void addListener0(final GenericFutureListener<? extends Future<? super V>> listener) {
        if (this.listeners == null) {
            ...
            this.listeners = new DefaultFutureListeners(this.listeners, listener);
        }
    }
    ...
    private boolean setFailure0(final Throwable cause) {
        return this.setValue0(new CauseHolder(ObjectUtil.<Throwable>checkNotNull(cause, "cause")));
    }
    ...
    void notifyProgressiveListeners(final long progress, final long total) {
        ...
        if (executor.inEventLoop()) {
            if (listeners instanceof GenericProgressiveFutureListener[]) {
                notifyProgressiveListeners0(self, listeners, progress, total);
            }
            else {
            ...
            final GenericProgressiveFutureListener<?>[] array = listeners;
            safeExecute(executor, (Runnable)new Runnable() {
                public void run() {
    ...
    static {
        ...
        RESULT_UPDATER = AtomicReferenceFieldUpdater.newUpdater((Class)DefaultPromise.class, (Class)Object.class, "result");
        SUCCESS = new Object();
        UNCANCELLABLE = new Object();
        CANCELLATION_CAUSE_HOLDER = new CauseHolder(ThrowableUtil.<Throwable>unknownStackTrace((Throwable)new CancellationException(), DefaultPromise.class, "cancel(...)"));
    }
