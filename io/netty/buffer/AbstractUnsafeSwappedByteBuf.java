...
abstract class AbstractUnsafeSwappedByteBuf extends SwappedByteBuf {
    ...
    protected abstract short _getShort(final AbstractByteBuf abstractByteBuf, final int integer);
    
    protected abstract int _getInt(final AbstractByteBuf abstractByteBuf, final int integer);
    
    protected abstract long _getLong(final AbstractByteBuf abstractByteBuf, final int integer);
    
    protected abstract void _setShort(final AbstractByteBuf abstractByteBuf, final int integer, final short short3);
    
    protected abstract void _setInt(final AbstractByteBuf abstractByteBuf, final int integer2, final int integer3);
    
    protected abstract void _setLong(final AbstractByteBuf abstractByteBuf, final int integer, final long long3);
}
