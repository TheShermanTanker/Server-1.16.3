...
public class UnpooledDirectByteBuf extends AbstractReferenceCountedByteBuf {
    ...
    public UnpooledDirectByteBuf(final ByteBufAllocator alloc, final int initialCapacity, final int maxCapacity) {
        ...
        if (initialCapacity < 0) {
            throw new IllegalArgumentException(new StringBuilder().append("initialCapacity: ").append(initialCapacity).toString());
        }
        if (maxCapacity < 0) {
            throw new IllegalArgumentException(new StringBuilder().append("maxCapacity: ").append(maxCapacity).toString());
        }
    ...
    public ByteBuf copy(final int index, final int length) {
        ...
        try {
            ...
            throw new IndexOutOfBoundsException(new StringBuilder().append("Too many bytes to read - Need ").append(index + length).toString());
        }
