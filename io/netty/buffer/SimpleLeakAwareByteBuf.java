...
class SimpleLeakAwareByteBuf extends WrappedByteBuf {
    ...
    SimpleLeakAwareByteBuf(final ByteBuf wrapped, final ByteBuf trackedByteBuf, final ResourceLeakTracker<ByteBuf> leak) {
        super(wrapped);
        this.trackedByteBuf = ObjectUtil.<ByteBuf>checkNotNull(trackedByteBuf, "trackedByteBuf");
        this.leak = ObjectUtil.<ResourceLeakTracker<ByteBuf>>checkNotNull(leak, "leak");
    }
