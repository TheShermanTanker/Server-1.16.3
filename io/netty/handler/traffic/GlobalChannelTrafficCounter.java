...
public class GlobalChannelTrafficCounter extends TrafficCounter {
    ...
    public synchronized void start() {
        ...
        if (localCheckInterval > 0L) {
            ...
            this.monitor = (Runnable)new MixedTrafficMonitoringTask((GlobalChannelTrafficShapingHandler)this.trafficShapingHandler, this);
    ...
    private static class MixedTrafficMonitoringTask implements Runnable {
        ...
        public void run() {
            ...
            this.counter.scheduledFuture = this.counter.executor.schedule((Runnable)this, this.counter.checkInterval.get(), TimeUnit.MILLISECONDS);
        }
    }
}
