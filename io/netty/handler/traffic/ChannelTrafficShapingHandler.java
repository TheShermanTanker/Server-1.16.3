...
public class ChannelTrafficShapingHandler extends AbstractTrafficShapingHandler {
    ...
    public ChannelTrafficShapingHandler(final long writeLimit, final long readLimit, final long checkInterval, final long maxTime) {
        ...
        this.messagesQueue = (ArrayDeque<ToSend>)new ArrayDeque();
    }
    ...
    public void handlerAdded(final ChannelHandlerContext ctx) throws Exception {
        final TrafficCounter trafficCounter = new TrafficCounter(this, (ScheduledExecutorService)ctx.executor(), new StringBuilder().append("ChannelTC").append(ctx.channel().hashCode()).toString(), this.checkInterval);
