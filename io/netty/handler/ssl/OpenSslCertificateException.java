...
public final class OpenSslCertificateException extends CertificateException {
    ...
    private static int checkErrorCode(final int errorCode) {
        if (!CertificateVerifier.isValid(errorCode)) {
            throw new IllegalArgumentException(new StringBuilder().append("errorCode '").append(errorCode).append("' invalid, see https://www.openssl.org/docs/man1.0.2/apps/verify.html.").toString());
        }
        return errorCode;
    }
}
