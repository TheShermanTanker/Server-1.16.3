...
class JdkBaseApplicationProtocolNegotiator implements JdkApplicationProtocolNegotiator {
    ...
    private JdkBaseApplicationProtocolNegotiator(final SslEngineWrapperFactory wrapperFactory, final ProtocolSelectorFactory selectorFactory, final ProtocolSelectionListenerFactory listenerFactory, final List<String> protocols) {
        this.wrapperFactory = ObjectUtil.<SslEngineWrapperFactory>checkNotNull(wrapperFactory, "wrapperFactory");
        this.selectorFactory = ObjectUtil.<ProtocolSelectorFactory>checkNotNull(selectorFactory, "selectorFactory");
        this.listenerFactory = ObjectUtil.<ProtocolSelectionListenerFactory>checkNotNull(listenerFactory, "listenerFactory");
        this.protocols = (List<String>)Collections.unmodifiableList((List)ObjectUtil.<List<String>>checkNotNull(protocols, "protocols"));
    }
