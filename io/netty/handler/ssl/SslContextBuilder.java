...
public final class SslContextBuilder {
    ...
    public SslContextBuilder trustManager(final File trustCertCollectionFile) {
        try {
            ...
            throw new IllegalArgumentException(new StringBuilder().append("File does not contain valid certificates: ").append(trustCertCollectionFile).toString(), (Throwable)e);
        }
    }
    ...
    public SslContextBuilder trustManager(final InputStream trustCertCollectionInputStream) {
        try {
            ...
            throw new IllegalArgumentException("Input stream does not contain valid certificates.", (Throwable)e);
        }
    }
    ...
    public SslContextBuilder keyManager(final File keyCertChainFile, final File keyFile, final String keyPassword) {
        ...
        try {
            ...
            throw new IllegalArgumentException(new StringBuilder().append("File does not contain valid certificates: ").append(keyCertChainFile).toString(), (Throwable)e);
        }
        PrivateKey key;
        try {
            ...
            throw new IllegalArgumentException(new StringBuilder().append("File does not contain valid private key: ").append(keyFile).toString(), (Throwable)e);
        }
    ...
    public SslContextBuilder keyManager(final InputStream keyCertChainInputStream, final InputStream keyInputStream, final String keyPassword) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Input stream not contain valid certificates.", (Throwable)e);
        }
        PrivateKey key;
        try {
            ...
            throw new IllegalArgumentException("Input stream does not contain valid private key.", (Throwable)e);
        }
        return this.keyManager(key, keyPassword, keyCertChain);
    }
    ...
    public SslContextBuilder keyManager(final PrivateKey key, final String keyPassword, final X509Certificate... keyCertChain) {
        if (this.forServer) {
            ObjectUtil.<X509Certificate[]>checkNotNull(keyCertChain, "keyCertChain required for servers");
            if (keyCertChain.length == 0) {
                throw new IllegalArgumentException("keyCertChain must be non-empty");
            }
            ObjectUtil.<PrivateKey>checkNotNull(key, "key required for servers");
        }
    ...
    public SslContextBuilder keyManager(final KeyManagerFactory keyManagerFactory) {
        if (this.forServer) {
            ObjectUtil.<KeyManagerFactory>checkNotNull(keyManagerFactory, "keyManagerFactory required for servers");
        }
        this.keyCertChain = null;
        this.key = null;
    ...
    public SslContextBuilder ciphers(final Iterable<String> ciphers, final CipherSuiteFilter cipherFilter) {
        ObjectUtil.<CipherSuiteFilter>checkNotNull(cipherFilter, "cipherFilter");
