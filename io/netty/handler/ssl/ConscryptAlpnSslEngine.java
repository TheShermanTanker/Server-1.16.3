...
abstract class ConscryptAlpnSslEngine extends JdkSslEngine {
    ...
    private ConscryptAlpnSslEngine(final SSLEngine engine, final ByteBufAllocator alloc, final List<String> protocols) {
        ...
        Conscrypt.setApplicationProtocols(engine, (String[])protocols.toArray((Object[])new String[protocols.size()]));
    }
    ...
    private static final class ClientEngine extends ConscryptAlpnSslEngine {
        ...
        ClientEngine(final SSLEngine engine, final ByteBufAllocator alloc, final JdkApplicationProtocolNegotiator applicationNegotiator) {
            ...
            this.protocolListener = ObjectUtil.<JdkApplicationProtocolNegotiator.ProtocolSelectionListener>checkNotNull(applicationNegotiator.protocolListenerFactory().newListener(this, applicationNegotiator.protocols()), "protocolListener");
        }
    ...
    private static final class ServerEngine extends ConscryptAlpnSslEngine {
        ...
        ServerEngine(final SSLEngine engine, final ByteBufAllocator alloc, final JdkApplicationProtocolNegotiator applicationNegotiator) {
            ...
            this.protocolSelector = ObjectUtil.<JdkApplicationProtocolNegotiator.ProtocolSelector>checkNotNull(applicationNegotiator.protocolSelectorFactory().newSelector(this, (Set<String>)new LinkedHashSet((Collection)applicationNegotiator.protocols())), "protocolSelector");
        }
        
        private void selectProtocol() throws SSLException {
            try {
                final String protocol = Conscrypt.getApplicationProtocol(this.getWrappedEngine());
                this.protocolSelector.select((List<String>)((protocol != null) ? Collections.singletonList(protocol) : Collections.emptyList()));
            }
            catch (Throwable e) {
                throw SslUtils.toSSLHandshakeException(e);
            }
