...
final class OpenJdkSelfSignedCertGenerator {
    static String[] generate(final String fqdn, final KeyPair keypair, final SecureRandom random, final Date notBefore, final Date notAfter) throws Exception {
        ...
        info.set("serialNumber", new CertificateSerialNumber(new BigInteger(64, (Random)random)));
        try {
        ...
        return SelfSignedCertificate.newSelfSignedCertificate(fqdn, key, (X509Certificate)cert);
    }
