...
public abstract class SimpleTrustManagerFactory extends TrustManagerFactory {
    ...
    protected SimpleTrustManagerFactory(final String name) {
        super((TrustManagerFactorySpi)SimpleTrustManagerFactory.CURRENT_SPI.get(), SimpleTrustManagerFactory.PROVIDER, name);
    ...
    protected abstract void engineInit(final KeyStore keyStore) throws Exception;
    
    protected abstract void engineInit(final ManagerFactoryParameters managerFactoryParameters) throws Exception;
    ...
    static final class SimpleTrustManagerFactorySpi extends TrustManagerFactorySpi {
        ...
        protected void engineInit(final ManagerFactoryParameters managerFactoryParameters) throws InvalidAlgorithmParameterException {
            try {
                ...
                throw new InvalidAlgorithmParameterException((Throwable)e2);
            }
        }
                ...
                if (PlatformDependent.javaVersion() >= 7) {
                    for (int i = 0; i < trustManagers.length; ++i) {
                        ...
                        if (tm instanceof X509TrustManager && !(tm instanceof X509ExtendedTrustManager)) {
                            trustManagers[i] = (TrustManager)new X509TrustManagerWrapper((X509TrustManager)tm);
                        }
                    }
                }
