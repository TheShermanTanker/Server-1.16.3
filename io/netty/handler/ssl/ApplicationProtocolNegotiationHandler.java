...
public abstract class ApplicationProtocolNegotiationHandler extends ChannelInboundHandlerAdapter {
    ...
    protected ApplicationProtocolNegotiationHandler(final String fallbackProtocol) {
        this.fallbackProtocol = ObjectUtil.<String>checkNotNull(fallbackProtocol, "fallbackProtocol");
    }
    ...
    public void userEventTriggered(final ChannelHandlerContext ctx, final Object evt) throws Exception {
        if (evt instanceof SslHandshakeCompletionEvent) {
            ...
            if (handshakeEvent.isSuccess()) {
                final SslHandler sslHandler = ctx.pipeline().<SslHandler>get(SslHandler.class);
                if (sslHandler == null) {
    ...
    protected abstract void configurePipeline(final ChannelHandlerContext channelHandlerContext, final String string) throws Exception;
