...
public interface Http2Headers extends Headers<CharSequence, CharSequence, Http2Headers> {
    ...
    Iterator<CharSequence> valueIterator(final CharSequence charSequence);
    
    Http2Headers method(final CharSequence charSequence);
    
    Http2Headers scheme(final CharSequence charSequence);
    
    Http2Headers authority(final CharSequence charSequence);
    
    Http2Headers path(final CharSequence charSequence);
    
    Http2Headers status(final CharSequence charSequence);
    ...
    public enum PseudoHeaderName {
        ...
        static {
            ...
            for (final PseudoHeaderName pseudoHeader : values()) {
                PseudoHeaderName.PSEUDO_HEADERS.add((CharSequence)pseudoHeader.value(), pseudoHeader);
            }
        }
    }
}
