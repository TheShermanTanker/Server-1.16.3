...
public interface Http2UnknownFrame extends Http2Frame, ByteBufHolder {
    ...
    Http2UnknownFrame stream(final Http2FrameStream http2FrameStream);
    ...
    Http2UnknownFrame replace(final ByteBuf byteBuf);
    
    Http2UnknownFrame retain();
    
    Http2UnknownFrame retain(final int integer);
    
    Http2UnknownFrame touch();
    
    Http2UnknownFrame touch(final Object object);
}
