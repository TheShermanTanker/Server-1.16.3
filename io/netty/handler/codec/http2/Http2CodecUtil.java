...
public final class Http2CodecUtil {
    ...
    public static void verifyPadding(final int padding) {
        if (padding < 0 || padding > 256) {
            throw new IllegalArgumentException(String.format("Invalid padding '%d'. Padding must be between 0 and %d (inclusive).", new Object[] { padding, 256 }));
        }
    }
    ...
    static {
        HTTP_UPGRADE_SETTINGS_HEADER = (CharSequence)AsciiString.cached("HTTP2-Settings");
