...
public final class Http2Settings extends CharObjectHashMap<Long> {
    ...
    public Http2Settings copyFrom(final Http2Settings settings) {
        this.clear();
        this.putAll((java.util.Map<? extends Character, ? extends Long>)settings);
        return this;
    }
    ...
    private static void verifyStandardSetting(final int key, final Long value) {
        ObjectUtil.<Long>checkNotNull(value, "value");
        switch (key) {
            case 1: {
                if (value < 0L || value > 4294967295L) {
                    throw new IllegalArgumentException(new StringBuilder().append("Setting HEADER_TABLE_SIZE is invalid: ").append(value).toString());
                }
                break;
            }
            case 2: {
                if (value != 0L && value != 1L) {
                    throw new IllegalArgumentException(new StringBuilder().append("Setting ENABLE_PUSH is invalid: ").append(value).toString());
                }
                break;
            }
            case 3: {
                if (value < 0L || value > 4294967295L) {
                    throw new IllegalArgumentException(new StringBuilder().append("Setting MAX_CONCURRENT_STREAMS is invalid: ").append(value).toString());
                }
                break;
            }
            case 4: {
                if (value < 0L || value > 2147483647L) {
                    throw new IllegalArgumentException(new StringBuilder().append("Setting INITIAL_WINDOW_SIZE is invalid: ").append(value).toString());
                }
                break;
            }
            case 5: {
                if (!Http2CodecUtil.isMaxFrameSizeValid(value.intValue())) {
                    throw new IllegalArgumentException(new StringBuilder().append("Setting MAX_FRAME_SIZE is invalid: ").append(value).toString());
                }
                break;
            }
            case 6: {
                if (value < 0L || value > 4294967295L) {
                    throw new IllegalArgumentException(new StringBuilder().append("Setting MAX_HEADER_LIST_SIZE is invalid: ").append(value).toString());
                }
                break;
            }
        }
