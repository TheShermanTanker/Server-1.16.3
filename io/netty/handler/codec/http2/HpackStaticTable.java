...
final class HpackStaticTable {
    ...
    static HpackHeaderField getEntry(final int index) {
        return (HpackHeaderField)HpackStaticTable.STATIC_TABLE.get(index - 1);
    }
    ...
    private static CharSequenceMap<Integer> createMap() {
        ...
        final CharSequenceMap<Integer> ret = new CharSequenceMap<Integer>(true, UnsupportedValueConverter.instance(), length);
