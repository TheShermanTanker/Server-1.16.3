...
public class ContextBoundUnmarshallerProvider extends DefaultUnmarshallerProvider {
    ...
    public Unmarshaller getUnmarshaller(final ChannelHandlerContext ctx) throws Exception {
        final Attribute<Unmarshaller> attr = ctx.channel().<Unmarshaller>attr(ContextBoundUnmarshallerProvider.UNMARSHALLER);
    ...
    static {
        UNMARSHALLER = AttributeKey.<Unmarshaller>valueOf(ContextBoundUnmarshallerProvider.class, "UNMARSHALLER");
    }
}
