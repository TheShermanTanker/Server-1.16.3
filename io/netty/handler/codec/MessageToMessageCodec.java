...
public abstract class MessageToMessageCodec<INBOUND_IN, OUTBOUND_IN> extends ChannelDuplexHandler {
    ...
    protected abstract void encode(final ChannelHandlerContext channelHandlerContext, final OUTBOUND_IN object, final List<Object> list) throws Exception;
    
    protected abstract void decode(final ChannelHandlerContext channelHandlerContext, final INBOUND_IN object, final List<Object> list) throws Exception;
}
