...
public class XmlElementStart extends XmlElement {
    ...
    public XmlElementStart(final String name, final String namespace, final String prefix) {
        ...
        this.attributes = (List<XmlAttribute>)new LinkedList();
    }
    ...
    public String toString() {
        return new StringBuilder().append("XmlElementStart{attributes=").append(this.attributes).append(super.toString()).append("} ").toString();
    }
}
