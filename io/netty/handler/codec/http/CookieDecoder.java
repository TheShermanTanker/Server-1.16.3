...
public final class CookieDecoder {
    ...
    private Set<Cookie> doDecode(final String header) {
        final List<String> names = (List<String>)new ArrayList(8);
        final List<String> values = (List<String>)new ArrayList(8);
        extractKeyValuePairs(header, names, values);
        if (names.isEmpty()) {
            return (Set<Cookie>)Collections.emptySet();
        }
        int version = 0;
        int i;
        ...
        final Set<Cookie> cookies = (Set<Cookie>)new TreeSet();
        while (i < names.size()) {
            ...
            final List<Integer> ports = (List<Integer>)new ArrayList(2);
