...
public class DefaultFullHttpResponse extends DefaultHttpResponse implements FullHttpResponse {
    ...
    public DefaultFullHttpResponse(final HttpVersion version, final HttpResponseStatus status, final ByteBuf content, final HttpHeaders headers, final HttpHeaders trailingHeaders) {
        ...
        this.content = ObjectUtil.<ByteBuf>checkNotNull(content, "content");
        this.trailingHeaders = ObjectUtil.<HttpHeaders>checkNotNull(trailingHeaders, "trailingHeaders");
    }
    ...
    public FullHttpResponse replace(final ByteBuf content) {
        final FullHttpResponse response = new DefaultFullHttpResponse(this.protocolVersion(), this.status(), content, this.headers().copy(), this.trailingHeaders().copy());
