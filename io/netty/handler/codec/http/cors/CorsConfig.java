...
public final class CorsConfig {
    ...
    CorsConfig(final CorsConfigBuilder builder) {
        this.origins = (Set<String>)new LinkedHashSet((Collection)builder.origins);
    ...
    public Set<String> exposedHeaders() {
        return (Set<String>)Collections.unmodifiableSet((Set)this.exposeHeaders);
    }
    ...
    public Set<HttpMethod> allowedRequestMethods() {
        return (Set<HttpMethod>)Collections.unmodifiableSet((Set)this.allowedRequestMethods);
    }
    
    public Set<String> allowedRequestHeaders() {
        return (Set<String>)Collections.unmodifiableSet((Set)this.allowedRequestHeaders);
    }
    ...
    public HttpHeaders preflightResponseHeaders() {
        ...
        for (final Map.Entry<CharSequence, Callable<?>> entry : this.preflightHeaders.entrySet()) {
            final Object value = CorsConfig.getValue((java.util.concurrent.Callable<Object>)entry.getValue());
    ...
    private static <T> T getValue(final Callable<T> callable) {
        try {
            ...
            throw new IllegalStateException(new StringBuilder().append("Could not generate value for callable [").append(callable).append(']').toString(), (Throwable)e);
        }
    }
    ...
    public static class Builder {
        ...
        public <T> Builder preflightResponseHeader(final CharSequence name, final Iterable<T> value) {
            this.builder.<T>preflightResponseHeader(name, value);
            return this;
        }
        
        @Deprecated
        public <T> Builder preflightResponseHeader(final String name, final Callable<T> valueGenerator) {
            this.builder.<T>preflightResponseHeader((CharSequence)name, valueGenerator);
            return this;
        }
