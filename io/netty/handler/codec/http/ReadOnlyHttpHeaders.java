...
public final class ReadOnlyHttpHeaders extends HttpHeaders {
    ...
    public String get(final String name) {
        final CharSequence value = this.get0((CharSequence)name);
    ...
    public List<String> getAll(final String name) {
        ...
        final int nameHash = AsciiString.hashCode((CharSequence)name);
        final List<String> values = (List<String>)new ArrayList(4);
        for (int i = 0; i < this.nameValuePairs.length; i += 2) {
            final CharSequence roName = this.nameValuePairs[i];
            if (AsciiString.hashCode(roName) == nameHash && AsciiString.contentEqualsIgnoreCase(roName, (CharSequence)name)) {
    ...
    public List<Map.Entry<String, String>> entries() {
        ...
        final List<Map.Entry<String, String>> entries = (List<Map.Entry<String, String>>)new ArrayList(this.size());
        for (int i = 0; i < this.nameValuePairs.length; i += 2) {
            entries.add(new AbstractMap.SimpleImmutableEntry((Object)this.nameValuePairs[i].toString(), (Object)this.nameValuePairs[i + 1].toString()));
        }
        return entries;
    }
    ...
    public boolean contains(final String name) {
        return this.get0((CharSequence)name) != null;
    }
    
    @Override
    public boolean contains(final String name, final String value, final boolean ignoreCase) {
        return this.containsValue((CharSequence)name, (CharSequence)value, ignoreCase);
    }
    ...
    public Iterator<String> valueStringIterator(final CharSequence name) {
        return (Iterator<String>)new ReadOnlyStringValueIterator(name);
    }
    ...
    public Iterator<Map.Entry<String, String>> iterator() {
        return (Iterator<Map.Entry<String, String>>)new ReadOnlyStringIterator();
    }
    ...
    public Set<String> names() {
        ...
        final Set<String> names = (Set<String>)new LinkedHashSet(this.size());
        for (int i = 0; i < this.nameValuePairs.length; i += 2) {
    ...
    private final class ReadOnlyStringIterator implements Map.Entry<String, String>, Iterator<Map.Entry<String, String>> {
        ...
        public Map.Entry<String, String> next() {
            ...
            this.nextNameIndex += 2;
            return (Map.Entry<String, String>)this;
        }
