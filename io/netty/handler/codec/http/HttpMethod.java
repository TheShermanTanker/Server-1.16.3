...
public class HttpMethod implements Comparable<HttpMethod> {
    ...
    static {
        ...
        methodMap = new EnumNameMap<HttpMethod>(new EnumNameMap.Node[] { new EnumNameMap.Node(HttpMethod.OPTIONS.toString(), (T)HttpMethod.OPTIONS), new EnumNameMap.Node(HttpMethod.GET.toString(), (T)HttpMethod.GET), new EnumNameMap.Node(HttpMethod.HEAD.toString(), (T)HttpMethod.HEAD), new EnumNameMap.Node(HttpMethod.POST.toString(), (T)HttpMethod.POST), new EnumNameMap.Node(HttpMethod.PUT.toString(), (T)HttpMethod.PUT), new EnumNameMap.Node(HttpMethod.PATCH.toString(), (T)HttpMethod.PATCH), new EnumNameMap.Node(HttpMethod.DELETE.toString(), (T)HttpMethod.DELETE), new EnumNameMap.Node(HttpMethod.TRACE.toString(), (T)HttpMethod.TRACE), new EnumNameMap.Node(HttpMethod.CONNECT.toString(), (T)HttpMethod.CONNECT) });
    }
        ...
        EnumNameMap(final Node<T>... nodes) {
            ...
            for (final Node<T> node : nodes) {
                ...
                if (this.values[i] != null) {
                    throw new IllegalArgumentException(new StringBuilder().append("index ").append(i).append(" collision between values: [").append(this.values[i].key).append(", ").append(node.key).append(']').toString());
                }
                this.values[i] = node;
            }
        }
