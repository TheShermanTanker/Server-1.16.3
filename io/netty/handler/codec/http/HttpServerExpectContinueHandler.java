...
public class HttpServerExpectContinueHandler extends ChannelInboundHandlerAdapter {
    ...
    static {
        ...
        HttpServerExpectContinueHandler.EXPECTATION_FAILED.headers().set((CharSequence)HttpHeaderNames.CONTENT_LENGTH, 0);
        HttpServerExpectContinueHandler.ACCEPT.headers().set((CharSequence)HttpHeaderNames.CONTENT_LENGTH, 0);
    }
}
