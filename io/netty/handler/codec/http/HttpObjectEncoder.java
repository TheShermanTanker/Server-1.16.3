...
public abstract class HttpObjectEncoder<H extends HttpMessage> extends MessageToMessageEncoder<Object> {
    ...
    protected void encodeHeaders(final HttpHeaders headers, final ByteBuf buf) {
        ...
        while (iter.hasNext()) {
            final Map.Entry<CharSequence, CharSequence> header = (Map.Entry<CharSequence, CharSequence>)iter.next();
    ...
    protected abstract void encodeInitialLine(final ByteBuf byteBuf, final H httpMessage) throws Exception;
