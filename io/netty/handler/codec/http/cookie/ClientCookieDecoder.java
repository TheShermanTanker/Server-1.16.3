...
public final class ClientCookieDecoder extends CookieDecoder {
    ...
    public Cookie decode(final String header) {
        final int headerLen = ObjectUtil.<String>checkNotNull(header, "header").length();
        if (headerLen == 0) {
            return null;
        }
    ...
    private static class CookieBuilder {
        ...
        private long mergeMaxAgeAndExpires() {
            ...
            if (isValueDefined(this.expiresStart, this.expiresEnd)) {
                final Date expiresDate = DateFormatter.parseHttpDate((CharSequence)this.header, this.expiresStart, this.expiresEnd);
                if (expiresDate != null) {
