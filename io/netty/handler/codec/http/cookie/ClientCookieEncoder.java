...
public final class ClientCookieEncoder extends CookieEncoder {
    ...
    public String encode(final Cookie cookie) {
        ...
        this.encode(buf, ObjectUtil.<Cookie>checkNotNull(cookie, "cookie"));
    ...
    public String encode(final Cookie... cookies) {
        ...
        if (this.strict) {
            if (cookies.length == 1) {
                ...
                final Cookie[] cookiesSorted = (Cookie[])Arrays.copyOf((Object[])cookies, cookies.length);
                Arrays.sort((Object[])cookiesSorted, (Comparator)ClientCookieEncoder.COOKIE_COMPARATOR);
    ...
    public String encode(final Collection<? extends Cookie> cookies) {
        ...
        if (this.strict) {
            if (cookies.size() == 1) {
                ...
                final Cookie[] cookiesSorted = (Cookie[])cookies.toArray((Object[])new Cookie[cookies.size()]);
                Arrays.sort((Object[])cookiesSorted, (Comparator)ClientCookieEncoder.COOKIE_COMPARATOR);
                for (final Cookie c : cookiesSorted) {
                    this.encode(buf, c);
                }
    ...
    public String encode(final Iterable<? extends Cookie> cookies) {
        ...
        if (this.strict) {
            ...
            if (!cookiesIt.hasNext()) {
                ...
                final Cookie[] cookiesSorted = (Cookie[])cookiesList.toArray((Object[])new Cookie[cookiesList.size()]);
                Arrays.sort((Object[])cookiesSorted, (Comparator)ClientCookieEncoder.COOKIE_COMPARATOR);
                for (final Cookie c : cookiesSorted) {
                    this.encode(buf, c);
                }
    ...
    static {
        ...
        COOKIE_COMPARATOR = (Comparator)new Comparator<Cookie>() {
