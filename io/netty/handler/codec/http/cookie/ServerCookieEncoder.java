...
public final class ServerCookieEncoder extends CookieEncoder {
    ...
    public String encode(final Cookie cookie) {
        final String name = ObjectUtil.<Cookie>checkNotNull(cookie, "cookie").name();
    ...
    private static List<String> dedup(final List<String> encoded, final Map<String, Integer> nameToLastIndex) {
        ...
        final List<String> dedupd = (List<String>)new ArrayList(nameToLastIndex.size());
    ...
    public List<String> encode(final Cookie... cookies) {
        if (ObjectUtil.<Cookie[]>checkNotNull(cookies, "cookies").length == 0) {
            return (List<String>)Collections.emptyList();
        }
        final List<String> encoded = (List<String>)new ArrayList(cookies.length);
        final Map<String, Integer> nameToIndex = (Map<String, Integer>)((this.strict && cookies.length > 1) ? new HashMap() : null);
    ...
    public List<String> encode(final Collection<? extends Cookie> cookies) {
        if (ObjectUtil.<Collection<? extends Cookie>>checkNotNull(cookies, "cookies").isEmpty()) {
            return (List<String>)Collections.emptyList();
        }
        final List<String> encoded = (List<String>)new ArrayList(cookies.size());
        final Map<String, Integer> nameToIndex = (Map<String, Integer>)((this.strict && cookies.size() > 1) ? new HashMap() : null);
        int i = 0;
        boolean hasDupdName = false;
    ...
    public List<String> encode(final Iterable<? extends Cookie> cookies) {
        final Iterator<? extends Cookie> cookiesIt = ObjectUtil.<Iterable<? extends Cookie>>checkNotNull(cookies, "cookies").iterator();
        if (!cookiesIt.hasNext()) {
            return (List<String>)Collections.emptyList();
        }
        final List<String> encoded = (List<String>)new ArrayList();
        final Cookie firstCookie = (Cookie)cookiesIt.next();
        final Map<String, Integer> nameToIndex = (Map<String, Integer>)((this.strict && cookiesIt.hasNext()) ? new HashMap() : null);
        int i = 0;
