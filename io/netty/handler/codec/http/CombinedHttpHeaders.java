...
public class CombinedHttpHeaders extends DefaultHttpHeaders {
    ...
    private static final class CombinedHttpHeadersImpl extends DefaultHeaders<CharSequence, CharSequence, CombinedHttpHeadersImpl> {
            ...
            if (this.objectEscaper == null) {
                this.objectEscaper = new CsvValueEscaper<Object>() {
                    public CharSequence escape(final Object value) {
                        return StringUtil.escapeCsv(DefaultHeaders.this.valueConverter().convertObject(value), true);
                    }
                };
            }
        ...
        public Iterator<CharSequence> valueIterator(final CharSequence name) {
            ...
            final Iterator<CharSequence> unescapedItr = (Iterator<CharSequence>)StringUtil.unescapeCsvFields((CharSequence)itr.next()).iterator();
            if (itr.hasNext()) {
        ...
        public CombinedHttpHeadersImpl add(final CharSequence name, final CharSequence... values) {
            return this.addEscapedValue(name, CombinedHttpHeadersImpl.<CharSequence>commaSeparate(this.charSequenceEscaper(), values));
        }
        ...
        public CombinedHttpHeadersImpl set(final CharSequence name, final CharSequence... values) {
            super.set(name, CombinedHttpHeadersImpl.<CharSequence>commaSeparate(this.charSequenceEscaper(), values));
            return this;
        }
        ...
        private static CharSequence commaSeparateEscapedValues(final CharSequence currentValue, final CharSequence value) {
            return (CharSequence)new StringBuilder(currentValue.length() + 1 + value.length()).append(currentValue).append(',').append(value);
        }
        
        private interface CsvValueEscaper<T> {
            CharSequence escape(final T object);
        }
    }
}
