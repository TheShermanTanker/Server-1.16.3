...
public class WebSocketServerProtocolHandler extends WebSocketProtocolHandler {
    ...
    public void handlerAdded(final ChannelHandlerContext ctx) {
        ...
        if (cp.<WebSocketServerProtocolHandshakeHandler>get(WebSocketServerProtocolHandshakeHandler.class) == null) {
        ...
        if (cp.<Utf8FrameValidator>get(Utf8FrameValidator.class) == null) {
    ...
    static WebSocketServerHandshaker getHandshaker(final Channel channel) {
        return channel.<WebSocketServerHandshaker>attr(WebSocketServerProtocolHandler.HANDSHAKER_ATTR_KEY).get();
    }
    
    static void setHandshaker(final Channel channel, final WebSocketServerHandshaker handshaker) {
        channel.<WebSocketServerHandshaker>attr(WebSocketServerProtocolHandler.HANDSHAKER_ATTR_KEY).set(handshaker);
    }
    ...
    static {
        HANDSHAKER_ATTR_KEY = AttributeKey.<WebSocketServerHandshaker>valueOf(WebSocketServerHandshaker.class, "HANDSHAKER");
    }
