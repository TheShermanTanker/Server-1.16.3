...
public class WebSocketClientHandshaker00 extends WebSocketClientHandshaker {
    ...
    protected FullHttpRequest newHandshakeRequest() {
        ...
        headers.add((CharSequence)HttpHeaderNames.UPGRADE, WebSocketClientHandshaker00.WEBSOCKET).add((CharSequence)HttpHeaderNames.CONNECTION, HttpHeaderValues.UPGRADE).add((CharSequence)HttpHeaderNames.HOST, WebSocketClientHandshaker.websocketHostValue(wsURL)).add((CharSequence)HttpHeaderNames.ORIGIN, WebSocketClientHandshaker.websocketOriginValue(wsURL)).add((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_KEY1, key1).add((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_KEY2, key2);
        ...
        headers.set((CharSequence)HttpHeaderNames.CONTENT_LENGTH, key3.length);
