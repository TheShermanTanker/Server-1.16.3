...
public class WebSocketServerHandshakerFactory {
    ...
    public WebSocketServerHandshaker newHandshaker(final HttpRequest req) {
        final CharSequence version = (CharSequence)req.headers().get((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_VERSION);
        if (version == null) {
    ...
    public static ChannelFuture sendUnsupportedVersionResponse(final Channel channel, final ChannelPromise promise) {
        ...
        res.headers().set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_VERSION, WebSocketVersion.V13.toHttpHeaderValue());
