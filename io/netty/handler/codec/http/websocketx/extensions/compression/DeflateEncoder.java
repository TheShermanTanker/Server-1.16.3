...
abstract class DeflateEncoder extends WebSocketExtensionEncoder {
    ...
    protected abstract int rsv(final WebSocketFrame webSocketFrame);
    
    protected abstract boolean removeFrameTail(final WebSocketFrame webSocketFrame);
    ...
    protected void encode(final ChannelHandlerContext ctx, final WebSocketFrame msg, final List<Object> out) throws Exception {
        ...
        while (true) {
            final ByteBuf partCompressedContent = this.encoder.<ByteBuf>readOutbound();
