...
public abstract class HttpContentDecoder extends MessageToMessageDecoder<HttpObject> {
    ...
    protected void decode(final ChannelHandlerContext ctx, final HttpObject msg, final List<Object> out) throws Exception {
        ...
        if (msg instanceof HttpMessage) {
            ...
            final CharSequence targetContentEncoding = (CharSequence)this.getTargetContentEncoding(contentEncoding);
    ...
    protected abstract EmbeddedChannel newContentDecoder(final String string) throws Exception;
    ...
    private void fetchDecoderOutput(final List<Object> out) {
        while (true) {
            final ByteBuf buf = this.decoder.<ByteBuf>readInbound();
            if (buf == null) {
                break;
            }
            if (!buf.isReadable()) {
