...
public abstract class HttpHeaders implements Iterable<Map.Entry<String, String>> {
    ...
    public static String getHeader(final HttpMessage message, final String name, final String defaultValue) {
        return message.headers().get((CharSequence)name, defaultValue);
    }
    ...
    public static int getIntHeader(final HttpMessage message, final CharSequence name) {
        ...
        if (value == null) {
            throw new NumberFormatException(new StringBuilder().append("header not found: ").append(name).toString());
        }
    ...
    public static int getIntHeader(final HttpMessage message, final String name, final int defaultValue) {
        return message.headers().getInt((CharSequence)name, defaultValue);
    }
    ...
    public static void setIntHeader(final HttpMessage message, final String name, final int value) {
        message.headers().setInt((CharSequence)name, value);
    }
    ...
    public static Date getDateHeader(final HttpMessage message, final CharSequence name) throws ParseException {
        final String value = message.headers().get(name);
        if (value == null) {
            throw new ParseException(new StringBuilder().append("header not found: ").append(name).toString(), 0);
        }
        final Date date = DateFormatter.parseHttpDate((CharSequence)value);
        if (date == null) {
    ...
    public static CharSequence newEntity(final String name) {
        return (CharSequence)new AsciiString((CharSequence)name);
    }
    ...
    public abstract Integer getInt(final CharSequence charSequence);
    
    public abstract int getInt(final CharSequence charSequence, final int integer);
    
    public abstract Short getShort(final CharSequence charSequence);
    
    public abstract short getShort(final CharSequence charSequence, final short short2);
    
    public abstract Long getTimeMillis(final CharSequence charSequence);
    
    public abstract long getTimeMillis(final CharSequence charSequence, final long long2);
    
    public abstract List<String> getAll(final String string);
    ...
    public abstract boolean contains(final String string);
    ...
    public Iterator<String> valueStringIterator(final CharSequence name) {
        return (Iterator<String>)this.getAll(name).iterator();
    }
    
    public Iterator<? extends CharSequence> valueCharSequenceIterator(final CharSequence name) {
    ...
    public abstract HttpHeaders add(final String string, final Object object);
    
    public HttpHeaders add(final CharSequence name, final Object value) {
        return this.add(name.toString(), value);
    }
    
    public abstract HttpHeaders add(final String string, final Iterable<?> iterable);
    ...
    public abstract HttpHeaders addInt(final CharSequence charSequence, final int integer);
    
    public abstract HttpHeaders addShort(final CharSequence charSequence, final short short2);
    
    public abstract HttpHeaders set(final String string, final Object object);
    
    public HttpHeaders set(final CharSequence name, final Object value) {
        return this.set(name.toString(), value);
    }
    
    public abstract HttpHeaders set(final String string, final Iterable<?> iterable);
    ...
    public HttpHeaders set(final HttpHeaders headers) {
        ObjectUtil.<HttpHeaders>checkNotNull(headers, "headers");
        this.clear();
        if (headers.isEmpty()) {
            return this;
        }
    ...
    public abstract HttpHeaders setInt(final CharSequence charSequence, final int integer);
    
    public abstract HttpHeaders setShort(final CharSequence charSequence, final short short2);
    
    public abstract HttpHeaders remove(final String string);
    ...
    public boolean contains(final String name, final String value, final boolean ignoreCase) {
        final Iterator<String> valueIterator = this.valueStringIterator((CharSequence)name);
        if (ignoreCase) {
    ...
    public boolean containsValue(final CharSequence name, final CharSequence value, final boolean ignoreCase) {
        final Iterator<? extends CharSequence> itr = this.valueCharSequenceIterator(name);
        while (itr.hasNext()) {
    ...
    private static boolean containsCommaSeparatedTrimmed(final CharSequence rawNext, final CharSequence expected, final boolean ignoreCase) {
        int begin = 0;
        if (ignoreCase) {
            int end;
            ...
            int end;
            if ((end = AsciiString.indexOf(rawNext, ',', begin)) != -1) {
                while (!AsciiString.contentEquals(AsciiString.trim(rawNext.subSequence(begin, end)), expected)) {
                    begin = end + 1;
                    if ((end = AsciiString.indexOf(rawNext, ',', begin)) == -1) {
    ...
    public String toString() {
        return HeadersUtils.<CharSequence, CharSequence>toString(this.getClass(), this.iteratorCharSequence(), this.size());
    }
