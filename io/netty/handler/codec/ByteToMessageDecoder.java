...
public abstract class ByteToMessageDecoder extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(final ChannelHandlerContext ctx, final Object msg) throws Exception {
        if (msg instanceof ByteBuf) {
            ...
            try {
                ...
                this.callDecode(ctx, this.cumulation, (List<Object>)out);
            }
    ...
    private void channelInputClosed(final ChannelHandlerContext ctx, final boolean callChannelInactive) throws Exception {
        final CodecOutputList out = CodecOutputList.newInstance();
        try {
            this.channelInputClosed(ctx, (List<Object>)out);
        }
        catch (DecoderException e) {
            throw e;
        }
    ...
    protected abstract void decode(final ChannelHandlerContext channelHandlerContext, final ByteBuf byteBuf, final List<Object> list) throws Exception;
    ...
    public interface Cumulator {
        ByteBuf cumulate(final ByteBufAllocator byteBufAllocator, final ByteBuf byteBuf2, final ByteBuf byteBuf3);
    }
}
