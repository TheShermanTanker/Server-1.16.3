...
public enum HAProxyProxiedProtocol {
    ...
    public static HAProxyProxiedProtocol valueOf(final byte tpafByte) {
        switch (tpafByte) {
            ...
            default: {
                throw new IllegalArgumentException(new StringBuilder().append("unknown transport protocol + address family: ").append(tpafByte & 0xFF).toString());
            }
        }
    }
    ...
    public enum AddressFamily {
        ...
        public static AddressFamily valueOf(final byte tpafByte) {
            ...
            switch ((byte)addressFamily) {
                ...
                default: {
                    throw new IllegalArgumentException(new StringBuilder().append("unknown address family: ").append(addressFamily).toString());
                }
            }
        }
    ...
    public enum TransportProtocol {
        ...
        public static TransportProtocol valueOf(final byte tpafByte) {
            ...
            switch ((byte)transportProtocol) {
                ...
                default: {
                    throw new IllegalArgumentException(new StringBuilder().append("unknown transport protocol: ").append(transportProtocol).toString());
                }
            }
        }
