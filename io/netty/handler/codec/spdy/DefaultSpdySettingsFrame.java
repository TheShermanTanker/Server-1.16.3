...
public class DefaultSpdySettingsFrame implements SpdySettingsFrame {
    ...
    public DefaultSpdySettingsFrame() {
        this.settingsMap = (Map<Integer, Setting>)new TreeMap();
    }
    
    public Set<Integer> ids() {
        return (Set<Integer>)this.settingsMap.keySet();
    }
    ...
    public int getValue(final int id) {
        final Setting setting = (Setting)this.settingsMap.get(id);
    ...
    public SpdySettingsFrame setValue(final int id, final int value, final boolean persistValue, final boolean persisted) {
        if (id < 0 || id > 16777215) {
            throw new IllegalArgumentException(new StringBuilder().append("Setting ID is not valid: ").append(id).toString());
        }
        final Integer key = id;
        final Setting setting = (Setting)this.settingsMap.get(key);
        if (setting != null) {
    ...
    public String toString() {
        final StringBuilder buf = new StringBuilder().append(StringUtil.simpleClassName(this)).append(StringUtil.NEWLINE);
