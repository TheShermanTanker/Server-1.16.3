...
final class SpdyCodecUtil {
    ...
    static void validateHeaderName(final CharSequence name) {
        if (name == null) {
        ...
        if (name.length() > 65535) {
            throw new IllegalArgumentException(new StringBuilder().append("name exceeds allowable length: ").append(name).toString());
        }
        for (int i = 0; i < name.length(); ++i) {
            final char c = name.charAt(i);
            if (c == '\0') {
                throw new IllegalArgumentException(new StringBuilder().append("name contains null character: ").append(name).toString());
            }
            if (c >= 'A' && c <= 'Z') {
    ...
    static void validateHeaderValue(final CharSequence value) {
        ...
        for (int i = 0; i < value.length(); ++i) {
            ...
            if (c == '\0') {
                throw new IllegalArgumentException(new StringBuilder().append("value contains null character: ").append(value).toString());
            }
        }
    }
