...
public class DefaultSpdyHeaders extends DefaultHeaders<CharSequence, CharSequence, SpdyHeaders> implements SpdyHeaders {
    private static final NameValidator<CharSequence> SpdyNameValidator;
    ...
    public DefaultSpdyHeaders(final boolean validate) {
        super(AsciiString.CASE_INSENSITIVE_HASHER, (ValueConverter<Object>)(validate ? HeaderValueConverterAndValidator.INSTANCE : CharSequenceValueConverter.INSTANCE), validate ? DefaultSpdyHeaders.SpdyNameValidator : NameValidator.NOT_NULL);
    }
    ...
    static {
        SpdyNameValidator = new NameValidator<CharSequence>() {
