...
public final class ZlibCodecFactory {
    ...
    static {
        ...
        ZlibCodecFactory.logger.debug("-Dio.netty.noJdkZlibDecoder: {}", ZlibCodecFactory.noJdkZlibDecoder);
        noJdkZlibEncoder = SystemPropertyUtil.getBoolean("io.netty.noJdkZlibEncoder", false);
        ZlibCodecFactory.logger.debug("-Dio.netty.noJdkZlibEncoder: {}", ZlibCodecFactory.noJdkZlibEncoder);
