...
public class LzfEncoder extends MessageToByteEncoder<ByteBuf> {
    ...
    public LzfEncoder(final boolean safeInstance, final int totalLength) {
        ...
        if (totalLength < 16 || totalLength > 65535) {
            throw new IllegalArgumentException(new StringBuilder().append("totalLength: ").append(totalLength).append(" (expected: ").append(16).append('-').append(65535).append(')').toString());
        }
