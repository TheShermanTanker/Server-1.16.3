...
public final class SmtpResponseDecoder extends LineBasedFrameDecoder {
    ...
    protected SmtpResponse decode(final ChannelHandlerContext ctx, final ByteBuf buffer) throws Exception {
        ...
        try {
            ...
            final CharSequence detail = (CharSequence)(frame.isReadable() ? frame.toString(CharsetUtil.US_ASCII) : null);
            ...
            switch (separator) {
                case 32: {
                    ...
                    if (details != null) {
                        ...
                        details = (List<CharSequence>)Collections.emptyList();
                    }
                    else {
                        details = (List<CharSequence>)Collections.singletonList(detail);
                    }
                ...
                case 45: {
                    if (detail != null) {
                        if (details == null) {
                            details = (this.details = (List<CharSequence>)new ArrayList(4));
                        }
                        details.add(detail);
                    }
                    break;
