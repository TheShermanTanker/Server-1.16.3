...
public final class FixedRedisMessagePool implements RedisMessagePool {
    ...
    private FixedRedisMessagePool() {
        this.byteBufToSimpleStrings = (Map<ByteBuf, SimpleStringRedisMessage>)new HashMap(FixedRedisMessagePool.DEFAULT_SIMPLE_STRINGS.length, 1.0f);
        this.stringToSimpleStrings = (Map<String, SimpleStringRedisMessage>)new HashMap(FixedRedisMessagePool.DEFAULT_SIMPLE_STRINGS.length, 1.0f);
        ...
        this.byteBufToErrors = (Map<ByteBuf, ErrorRedisMessage>)new HashMap(FixedRedisMessagePool.DEFAULT_ERRORS.length, 1.0f);
        this.stringToErrors = (Map<String, ErrorRedisMessage>)new HashMap(FixedRedisMessagePool.DEFAULT_ERRORS.length, 1.0f);
        ...
        this.byteBufToIntegers = (Map<ByteBuf, IntegerRedisMessage>)new HashMap(129, 1.0f);
