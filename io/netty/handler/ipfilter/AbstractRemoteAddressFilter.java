...
public abstract class AbstractRemoteAddressFilter<T extends SocketAddress> extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(final ChannelHandlerContext ctx) throws Exception {
        if (!this.handleNewChannel(ctx)) {
            throw new IllegalStateException(new StringBuilder().append("cannot determine to accept or reject a channel: ").append(ctx.channel()).toString());
        }
    ...
    protected abstract boolean accept(final ChannelHandlerContext channelHandlerContext, final T socketAddress) throws Exception;
