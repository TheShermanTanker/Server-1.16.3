...
public class IdleStateHandler extends ChannelDuplexHandler {
        ...
        switch (this.state) {
            ...
            default: {
                ...
                if (this.readerIdleTimeNanos > 0L) {
                    this.readerIdleTimeout = this.schedule(ctx, (Runnable)new ReaderIdleTimeoutTask(ctx), this.readerIdleTimeNanos, TimeUnit.NANOSECONDS);
                }
                if (this.writerIdleTimeNanos > 0L) {
                    this.writerIdleTimeout = this.schedule(ctx, (Runnable)new WriterIdleTimeoutTask(ctx), this.writerIdleTimeNanos, TimeUnit.NANOSECONDS);
                }
                if (this.allIdleTimeNanos > 0L) {
                    this.allIdleTimeout = this.schedule(ctx, (Runnable)new AllIdleTimeoutTask(ctx), this.allIdleTimeNanos, TimeUnit.NANOSECONDS);
                }
            }
        }
    }
    ...
    protected IdleStateEvent newIdleStateEvent(final IdleState state, final boolean first) {
        switch (state) {
            ...
            default: {
                throw new IllegalArgumentException(new StringBuilder().append("Unhandled: state=").append(state).append(", first=").append(first).toString());
            }
        }
    }
    ...
    private abstract static class AbstractIdleTask implements Runnable {
        ...
        protected abstract void run(final ChannelHandlerContext channelHandlerContext);
    }
    ...
    private final class ReaderIdleTimeoutTask extends AbstractIdleTask {
        ...
        protected void run(final ChannelHandlerContext ctx) {
            ...
            if (nextDelay <= 0L) {
                IdleStateHandler.this.readerIdleTimeout = IdleStateHandler.this.schedule(ctx, (Runnable)this, IdleStateHandler.this.readerIdleTimeNanos, TimeUnit.NANOSECONDS);
                ...
                IdleStateHandler.this.readerIdleTimeout = IdleStateHandler.this.schedule(ctx, (Runnable)this, nextDelay, TimeUnit.NANOSECONDS);
            }
        }
    }
    ...
    private final class WriterIdleTimeoutTask extends AbstractIdleTask {
        ...
        protected void run(final ChannelHandlerContext ctx) {
            ...
            if (nextDelay <= 0L) {
                IdleStateHandler.this.writerIdleTimeout = IdleStateHandler.this.schedule(ctx, (Runnable)this, IdleStateHandler.this.writerIdleTimeNanos, TimeUnit.NANOSECONDS);
                ...
                IdleStateHandler.this.writerIdleTimeout = IdleStateHandler.this.schedule(ctx, (Runnable)this, nextDelay, TimeUnit.NANOSECONDS);
            }
        }
    }
    ...
    private final class AllIdleTimeoutTask extends AbstractIdleTask {
        ...
        protected void run(final ChannelHandlerContext ctx) {
            ...
            if (nextDelay <= 0L) {
                IdleStateHandler.this.allIdleTimeout = IdleStateHandler.this.schedule(ctx, (Runnable)this, IdleStateHandler.this.allIdleTimeNanos, TimeUnit.NANOSECONDS);
                ...
                IdleStateHandler.this.allIdleTimeout = IdleStateHandler.this.schedule(ctx, (Runnable)this, nextDelay, TimeUnit.NANOSECONDS);
            }
        }
    }
}
