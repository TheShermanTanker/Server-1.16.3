...
public class Bootstrap extends AbstractBootstrap<Bootstrap, Channel> {
    ...
    public Bootstrap remoteAddress(final String inetHost, final int inetPort) {
        this.remoteAddress = (SocketAddress)InetSocketAddress.createUnresolved(inetHost, inetPort);
        return this;
    }
    
    public Bootstrap remoteAddress(final InetAddress inetHost, final int inetPort) {
        this.remoteAddress = (SocketAddress)new InetSocketAddress(inetHost, inetPort);
        return this;
    }
    ...
    public ChannelFuture connect(final String inetHost, final int inetPort) {
        return this.connect((SocketAddress)InetSocketAddress.createUnresolved(inetHost, inetPort));
    }
    
    public ChannelFuture connect(final InetAddress inetHost, final int inetPort) {
        return this.connect((SocketAddress)new InetSocketAddress(inetHost, inetPort));
    }
