...
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
    ...
    AbstractBootstrap(final AbstractBootstrap<B, C> bootstrap) {
        ...
        synchronized (bootstrap.options) {
            this.options.putAll((Map)bootstrap.options);
        }
        synchronized (bootstrap.attrs) {
            this.attrs.putAll((Map)bootstrap.attrs);
        }
    }
    ...
    public B channel(final Class<? extends C> channelClass) {
        ...
        return this.channelFactory(new ReflectiveChannelFactory<C>(channelClass));
    }
    ...
    public B localAddress(final int inetPort) {
        return this.localAddress((SocketAddress)new InetSocketAddress(inetPort));
    }
    
    public B localAddress(final String inetHost, final int inetPort) {
        return this.localAddress((SocketAddress)SocketUtils.socketAddress(inetHost, inetPort));
    }
    
    public B localAddress(final InetAddress inetHost, final int inetPort) {
        return this.localAddress((SocketAddress)new InetSocketAddress(inetHost, inetPort));
    }
    ...
    public ChannelFuture bind(final int inetPort) {
        return this.bind((SocketAddress)new InetSocketAddress(inetPort));
    }
    
    public ChannelFuture bind(final String inetHost, final int inetPort) {
        return this.bind((SocketAddress)SocketUtils.socketAddress(inetHost, inetPort));
    }
    
    public ChannelFuture bind(final InetAddress inetHost, final int inetPort) {
        return this.bind((SocketAddress)new InetSocketAddress(inetHost, inetPort));
    }
    ...
    abstract void init(final Channel channel) throws Exception;
    ...
    static <K, V> Map<K, V> copiedMap(final Map<K, V> map) {
        ...
        synchronized (map) {
            ...
            copied = (Map<K, V>)new LinkedHashMap((Map)map);
        }
        return (Map<K, V>)Collections.unmodifiableMap((Map)copied);
    }
    ...
    final Map<ChannelOption<?>, Object> options() {
        return AbstractBootstrap.<ChannelOption<?>, Object>copiedMap(this.options);
    }
    
    final Map<AttributeKey<?>, Object> attrs() {
        return AbstractBootstrap.<AttributeKey<?>, Object>copiedMap(this.attrs);
    }
